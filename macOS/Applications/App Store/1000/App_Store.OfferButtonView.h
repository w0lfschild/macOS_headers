...
@class NSArray, NSColor, NSImageView, NSString, NSView, _TtC9App_Store15OfferShapeLayer, _TtC9App_Store20DynamicTypeTextField;
...
@property(nonatomic, readonly) NSArray *accessibilityLockupCustomActions;
@property(nonatomic) BOOL accessibilityOfferIsImmediateBuy; // @synthesize accessibilityOfferIsImmediateBuy;
