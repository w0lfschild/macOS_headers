...
@class NSArray, NSMenuItem, NSWindow, _TtC9App_Store27PreferencesWindowController;
...
@property(nonatomic) BOOL presentingPrivacySplash; // @synthesize presentingPrivacySplash;
