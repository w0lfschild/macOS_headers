...
@property(nonatomic) BOOL _wantsPageAlignedVerticalAxis;
- (void)_setWantsPageAlignedHorizontalAxis:(BOOL)arg1;
@property(nonatomic) BOOL _wantsPageAlignedHorizontalAxis;
...
- (void)scrollViewBeganMomentum:(NSScrollView *)arg1 withVelocity:(struct CGPoint)arg2 targetContentOffset:(struct CGPoint *)arg3;
