...
@interface BAHController : NSObject <NSOpenSavePanelDelegate, NSFileManagerDelegate, NSApplicationDelegate>
{
    ...
    NSObject<OS_dispatch_queue> *_finalMoveQueue;
}

+ (void)initialize;
+ (id)sharedInstance;
- (void).cxx_destruct;
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *finalMoveQueue; // @synthesize finalMoveQueue=_finalMoveQueue;
