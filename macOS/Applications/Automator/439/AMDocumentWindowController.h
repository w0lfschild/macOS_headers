...
@interface AMDocumentWindowController : NSWindowController <NSToolbarDelegate, NSWindowDelegate, AMMediaPanelObserver, AMWorkflowControllerDelegatePrivate>
{
...
@property(retain) NSDictionary *blackTextAttributes; // @synthesize blackTextAttributes=_blackTextAttributes;
...
@property(retain, nonatomic) AMPersonalityChooserDisplayController *convertDisplayController; // @synthesize convertDisplayController=_convertDisplayController;
@property(retain, nonatomic) AMPersonalityChooserDisplayController *startingPointsDisplayController; // @synthesize startingPointsDisplayController=_startingPointsDisplayController;
