...
@class NSButton, NSLayoutConstraint, NSString, NSTextField, NSWindow;
...
@interface AMPluginCustomSaveWindowController : NSWindowController <NSTouchBarDelegate>
{
    ...
    NSTextField *__mainTextField;
    NSLayoutConstraint *__mainTextFieldWidthConstraint;
}

@property(nonatomic) __weak NSLayoutConstraint *_mainTextFieldWidthConstraint; // @synthesize _mainTextFieldWidthConstraint=__mainTextFieldWidthConstraint;
@property(nonatomic) __weak NSTextField *_mainTextField; // @synthesize _mainTextField=__mainTextField;
...
- (void)loadWindow;
- (void)_updateTextFieldWidthConstraintWithContentView:(id)arg1;
