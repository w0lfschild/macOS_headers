...
@class DBSHARINGFolderAction, DBSHARINGPermissionDeniedReason, NSNumber, NSString;

@interface DBSHARINGFolderPermission : NSObject <DBSerializable, NSCopying>
{
    DBSHARINGFolderAction *_action;
    NSNumber *_allow;
...
@property(readonly, nonatomic) DBSHARINGFolderAction *action; // @synthesize action=_action;
- (void).cxx_destruct;
- (BOOL)isEqualToFolderPermission:(id)arg1;
