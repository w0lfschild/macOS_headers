...
- (BOOL)isEqualToSharedLinkAccessFailureReason:(id)arg1;
...
- (id)initWithOther;
- (id)initWithOwnerOnly;
- (id)initWithTeamOnly;
- (id)initWithPasswordRequired;
- (id)initWithEmailVerifyRequired;
- (id)initWithLoginRequired;
