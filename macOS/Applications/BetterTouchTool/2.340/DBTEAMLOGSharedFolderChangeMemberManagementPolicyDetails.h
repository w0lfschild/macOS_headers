...
@class DBTEAMLOGSharedFolderMembershipManagementPolicy, NSNumber, NSString;
...
@interface DBTEAMLOGSharedFolderChangeMemberManagementPolicyDetails : NSObject <DBSerializable, NSCopying>
{
    ...
    DBTEAMLOGSharedFolderMembershipManagementPolicy *_dNewValue;
    DBTEAMLOGSharedFolderMembershipManagementPolicy *_previousValue;
}

+ (id)deserialize:(id)arg1;
+ (id)serialize:(id)arg1;
@property(readonly, nonatomic) DBTEAMLOGSharedFolderMembershipManagementPolicy *previousValue; // @synthesize previousValue=_previousValue;
@property(readonly, nonatomic) DBTEAMLOGSharedFolderMembershipManagementPolicy *dNewValue; // @synthesize dNewValue=_dNewValue;
...
- (void).cxx_destruct;
- (BOOL)isEqualToSharedFolderChangeMemberManagementPolicyDetails:(id)arg1;
