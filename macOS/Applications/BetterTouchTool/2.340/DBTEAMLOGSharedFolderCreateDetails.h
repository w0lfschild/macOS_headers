...
@interface DBTEAMLOGSharedFolderCreateDetails : NSObject <DBSerializable, NSCopying>
{
    ...
    NSString *_parentNsId;
}

+ (id)deserialize:(id)arg1;
+ (id)serialize:(id)arg1;
@property(readonly, copy, nonatomic) NSString *parentNsId; // @synthesize parentNsId=_parentNsId;
@property(readonly, nonatomic) NSNumber *targetIndex; // @synthesize targetIndex=_targetIndex;
- (void).cxx_destruct;
- (BOOL)isEqualToSharedFolderCreateDetails:(id)arg1;
- (BOOL)isEqual:(id)arg1;
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;
@property(readonly, copy) NSString *description;
- (id)initWithTargetIndex:(id)arg1;
- (id)initWithTargetIndex:(id)arg1 parentNsId:(id)arg2;
