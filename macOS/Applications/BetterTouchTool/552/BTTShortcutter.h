...
@class BTTActions, BTTHudWC, NSDictionary, NSMutableDictionary, NSString, NSTimer;
...
- (void)performActionReal:(long long)arg1 withInfo:(id)arg2;
...
- (id)mainFindGesturesWith:(long long)arg1 additionalString:(id)arg2 additionalNumber:(id)arg3 bezierPathName:(id)arg4 triggerOnDown:(long long)arg5 onlyGlobal:(long long)arg6;
...
- (BOOL)bringModifiersToNewFormat;
- (long long)currentEventModifiers;
- (BOOL)checkIfAnyOfTheGesturesAreUsedMT:(id)arg1 inApp:(id)arg2 andOnlyInThisApp:(BOOL)arg3;
...
- (BOOL)checkIfGestureIsUsedMT:(long long)arg1 inApp:(id)arg2 andOnlyInThisApp:(BOOL)arg3;
