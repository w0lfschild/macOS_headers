...
@property(readonly, nonatomic) NSArray *exceptions; // @synthesize exceptions=_exceptions;
@property(readonly, nonatomic) NSNumber *count; // @synthesize count=_count;
- (void).cxx_destruct;
- (BOOL)isEqualToAudienceExceptions:(id)arg1;
- (BOOL)isEqual:(id)arg1;
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;
@property(readonly, copy) NSString *description;
- (id)initWithCount:(id)arg1 exceptions:(id)arg2;
