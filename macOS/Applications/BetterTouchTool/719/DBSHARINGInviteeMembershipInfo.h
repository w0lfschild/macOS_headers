...
- (void).cxx_destruct;
- (BOOL)isEqualToInviteeMembershipInfo:(id)arg1;
- (BOOL)isEqual:(id)arg1;
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;
@property(readonly, copy) NSString *description;
- (id)initWithAccessType:(id)arg1 invitee:(id)arg2;
- (id)initWithAccessType:(id)arg1 invitee:(id)arg2 permissions:(id)arg3 initials:(id)arg4 isInherited:(id)arg5 user:(id)arg6;
