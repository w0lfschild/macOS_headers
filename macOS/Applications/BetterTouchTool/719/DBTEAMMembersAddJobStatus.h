...
- (void).cxx_destruct;
- (BOOL)isEqualToMembersAddJobStatus:(id)arg1;
...
- (BOOL)isComplete;
- (BOOL)isInProgress;
@property(readonly, copy, nonatomic) NSString *failed; // @synthesize failed=_failed;
@property(readonly, nonatomic) NSArray *complete; // @synthesize complete=_complete;
