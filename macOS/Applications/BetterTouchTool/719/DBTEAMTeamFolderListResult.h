...
@property(readonly, nonatomic) NSArray *teamFolders; // @synthesize teamFolders=_teamFolders;
- (void).cxx_destruct;
- (BOOL)isEqualToTeamFolderListResult:(id)arg1;
- (BOOL)isEqual:(id)arg1;
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;
@property(readonly, copy) NSString *description;
- (id)initWithTeamFolders:(id)arg1 cursor:(id)arg2 hasMore:(id)arg3;
