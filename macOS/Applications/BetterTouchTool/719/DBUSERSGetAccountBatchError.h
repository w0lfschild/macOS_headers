...
- (void).cxx_destruct;
- (BOOL)isEqualToGetAccountBatchError:(id)arg1;
...
- (BOOL)isOther;
- (BOOL)isNoAccount;
@property(readonly, copy, nonatomic) NSString *noAccount; // @synthesize noAccount=_noAccount;
- (id)initWithOther;
- (id)initWithNoAccount:(id)arg1;
