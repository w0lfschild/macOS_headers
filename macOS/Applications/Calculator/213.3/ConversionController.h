...
@class ConversionTouchBarController, NSArray, NSButton, NSDictionary, NSMutableArray, NSPopUpButton, NSString, NSTextField, NSTouchBar;
...
- (id)getPathForFinancialRatesJson;
- (void)browseRatesWebsite:(id)arg1;
- (void)writeJSONDataToDisk:(id)arg1;
- (void)updateConversionSheet;
...
- (void)updateCurrencyRatesWithLocalCopy;
