...
@class CALAutoSave, CALMigrationController, CALWindow, CalMemorySensor, CalUIInspectorManager, CalUIMigrationController, CalWindowController, EKUndoManager, NSArray, NSMenu, NSMenuItem, NSMutableArray, NSMutableDictionary, NSString;
...
- (void)setAllowInspectorStacking:(BOOL)arg1;
- (BOOL)allowInspectorStacking;
