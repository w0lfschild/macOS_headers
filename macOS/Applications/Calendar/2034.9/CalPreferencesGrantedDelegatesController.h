...
@class CALDelegateTextView, CALPreferencesDelegatesController, CalManagedAccount, NSButton, NSMutableArray, NSPanel, NSProgressIndicator, NSScrollView, NSString, NSTabView, NSTableView, NSTextField;
