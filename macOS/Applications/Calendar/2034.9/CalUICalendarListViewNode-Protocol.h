...
@protocol CalUICalendarListDataSourceContextEK, CalUICalendarListViewNode;
...
- (void)removeChildNodes:(NSArray *)arg1;
- (void)removeChildNode:(id <CalUICalendarListViewNode>)arg1;
...
- (BOOL)isRefreshable;
- (BOOL)isError;
- (id <CalUICalendarListDataSourceContextEK>)dataSourceContextForEditing;
