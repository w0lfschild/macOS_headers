...
@class CALayer, CalUIAllDayAreaViewController, CalUIDateBannerStringController, CalUITimeLineScrollView, CalUITimeLineView, CalUIViewController, EKEvent, InfiniteSwipeController, NSArray, NSDate, NSEvent, NSLayoutConstraint, NSMutableDictionary, NSObject, NSString, NSTextField, NSView;
