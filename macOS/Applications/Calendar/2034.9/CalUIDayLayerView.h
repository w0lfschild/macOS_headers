...
@class CalDateRange, CalUIDayCanvasController, CalUIDayLayerController, CalUIDayLayerGridlineView, NSArray, NSDate, NSLayoutConstraint, NSMutableDictionary, NSNumber, NSString, NSView;
