...
@property(retain) CalUIFontSmoothedTextField *weekNumberLabel; // @synthesize weekNumberLabel=_weekNumberLabel;
@property(retain) CalUIFontSmoothedTextField *lunarMonthLabel; // @synthesize lunarMonthLabel=_lunarMonthLabel;
