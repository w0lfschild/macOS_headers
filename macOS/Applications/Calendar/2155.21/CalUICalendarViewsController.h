...
@class CALMainController, CalUICalendarContainerView, CalUICalendarContentView, CalUIDayViewController, CalUIMonthViewController, CalUIViewController, CalUIWeekViewController, CalUIYearViewController, NSDate, NSMutableArray, NSString, NSTimer;
...
@property(retain) NSDate *lastUpdatedRealDate; // @synthesize lastUpdatedRealDate=_lastUpdatedRealDate;
