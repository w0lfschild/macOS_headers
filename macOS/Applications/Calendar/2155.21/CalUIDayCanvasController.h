...
@class CALayer, CalUIAllDayAreaViewController, CalUIDateBannerStringController, CalUITimeLineScrollView, CalUITimeLineView, CalUIViewController, EKEvent, InfiniteSwipeController, NSArray, NSDate, NSEvent, NSLayoutConstraint, NSMutableDictionary, NSString, NSTextField, NSTimer, NSView;
