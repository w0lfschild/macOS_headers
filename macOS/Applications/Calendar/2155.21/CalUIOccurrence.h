...
@interface CalUIOccurrence : CalUILayerBackedView <CalUICollectableOccurrence, NSImmediateActionGestureRecognizerDelegate, NSTextFieldDelegate, CalUIInspectableOccurrence, CalDateRangeProtocol>
{
...
@property char *UIAllDay; // @synthesize UIAllDay=_UIAllDay;
