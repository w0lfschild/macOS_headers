...
@class CalUIDayCanvasController, CalUIDayLayerController, CalUIDayLayerGridlineView, NSArray, NSDate, NSLayoutConstraint, NSMutableDictionary, NSNumber, NSString, NSView;
...
- (struct CGColor *)layerBackgroundColor;
- (void)dealloc;
- (id)init;
