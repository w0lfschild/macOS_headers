...
@interface CalUIOccurrence : CalUILayerBackedView <CalUICollectableOccurrence, NSImmediateActionGestureRecognizerDelegate, CalCMOccurrenceMenuDelegate, NSTextFieldDelegate, CalUIInspectableOccurrence, CalDateRangeProtocol>
{
    BOOL _UIAllDay;
    BOOL _capLeftSide;
    BOOL _capRightSide;
