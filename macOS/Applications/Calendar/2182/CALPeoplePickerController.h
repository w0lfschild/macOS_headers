...
@class ABPeoplePickerView, CalAutoCompleteOperation, NSArray, NSBox, NSMutableArray, NSProgressIndicator, NSSearchField, NSSplitView, NSString, NSTableView, NSTextField, NSView;
