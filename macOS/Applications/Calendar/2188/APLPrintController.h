...
@class APLImageView, APLLayout, APLModel, APLPresetsController, APLRangeController, APLView, CALMainController, CALNumericFormatter, NSArray, NSBox, NSButton, NSDictionary, NSMenu, NSMutableArray, NSMutableDictionary, NSPopUpButton, NSPrintInfo, NSSlider, NSString, NSTextField, NSView, NSWindow;
...
- (void)addOption:(id)arg1 inRect:(struct CGRect)arg2 withTag:(long long)arg3;
- (void)updateOptions;
