...
@class CalUIAXTextField, CalUIDateHeaderWeekNumberView, CalUILayerBackedView, CalUIMonthWeekView, CalUITodayDateStringView, NSColor, NSDate, NSLayoutConstraint, NSMutableArray, NSString, NSTextField;

@interface CalUIMonthDayView : CalUIMonthContentView <CALayerDelegate>
{
    BOOL _isToday;
    BOOL _isThisWeek;
...
+ (void)_warmUpFancyCacheImagesWithBackgroundColor:(id)arg1 dayStringColor:(id)arg2;
...
@property(retain) NSTextField *lunarDateField; // @synthesize lunarDateField=_lunarDateField;
