...
@class CALMainController, CalCustomAlertSegmentedControl, NSButton, NSGroupTouchBarItem, NSString, NSTextField, NSTouchBar, NSWindow;
...
@property(retain) NSGroupTouchBarItem *groupItem; // @synthesize groupItem=_groupItem;
