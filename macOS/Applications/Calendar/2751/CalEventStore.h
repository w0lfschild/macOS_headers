...
@class CUIKEditingManager, EKEventStore;
...
+ (void)registerForBadgeCountChanges:(id)arg1 selector:(SEL)arg2 inEventStore:(id)arg3;
...
+ (id)_openEditingContextForObjects:(id)arg1 inStore:(id)arg2;
+ (id)editingManagerForObjects:(id)arg1;
...
- (void)registerForBatchedEventChanges:(id)arg1 selector:(SEL)arg2;
- (void)registerForBadgeCountChanges:(id)arg1 selector:(SEL)arg2;
- (void)registerForEventChanges:(id)arg1 selector:(SEL)arg2;
