...
#import "CalUIEventProviderProtocol-Protocol.h"
...
@interface CalUIOccurrence : CalUILayerBackedView <CalUICollectableOccurrence, NSImmediateActionGestureRecognizerDelegate, CalCMOccurrenceMenuDelegate, NSTextFieldDelegate, CalUIInspectableOccurrence, CalDateRangeProtocol, CalUIEventProviderProtocol, NSFilePromiseProviderDelegate>
{
    BOOL _UIAllDay;
    BOOL _capLeftSide;
    BOOL _capRightSide;
