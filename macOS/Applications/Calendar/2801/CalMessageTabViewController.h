...
@interface CalMessageTabViewController : NSViewController
{
    ...
    CalMessageTableViewController *_selectedController;
}

- (void).cxx_destruct;
@property(retain) CalMessageTableViewController *selectedController; // @synthesize selectedController=_selectedController;
