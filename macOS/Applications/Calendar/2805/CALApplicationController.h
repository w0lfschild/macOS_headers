...
#import "CUIKCommitDelegate-Protocol.h"
#import "CalUIWindowDelegate-Protocol.h"
#import "ICSLoggingDelegate-Protocol.h"
#import "NSApplicationDelegate-Protocol.h"

@class ACUISetupManagerViewController, CALAutoSave, CALMigrationController, CALWindow, CUIKUndoManager, CalMemorySensor, CalUIInspectorManager, CalUIMigrationController, CalWindowController, NSArray, NSMenu, NSMenuItem, NSMutableArray, NSString;

@interface CALApplicationController : NSObject <NSApplicationDelegate, CalUIWindowDelegate, ICSLoggingDelegate, CUIKCommitDelegate>
{
    ...
    BOOL _launchedWithStateRestoration;
    BOOL _restoredMainWindow;
...
@property BOOL restoredMainWindow; // @synthesize restoredMainWindow=_restoredMainWindow;
@property BOOL launchedWithStateRestoration; // @synthesize launchedWithStateRestoration=_launchedWithStateRestoration;
@property BOOL isFinishedLaunching; // @synthesize isFinishedLaunching=_isFinishedLaunching;
@property(retain) CUIKUndoManager *undoManager; // @synthesize undoManager=_undoManager;
...
- (void)toggleAllDayAreaSnapping:(id)arg1;
...
- (id)controllerIDForWindow:(id)arg1;
...
- (void)_warmupDateLocalization;
- (void)reloadCalendarWidget:(id)arg1;
- (void)awakeFromNib;
...
- (void)toggleInboxAutoClose:(id)arg1;
...
- (id)windowControllerWithDelegate:(id)arg1;
- (id)mainWindow;
