...
@interface CALPreferencesManager : NSObject
{
    ...
    long long _observingDisabledCount;
    long long _cacheNumberOfHours;
    double _cacheStartShownMinute;
    long long _cacheHeatMapInYearView;
    long long _cacheShowWeekNumbers;
    long long _cacheShowMultiDayEventsAsAllDayEvents;
    long long _cacheTimeZoneSupportEnabled;
}

+ (void)showAlertForDisablingSiriSuggestionsCalendarInWindow:(id)arg1;
+ (id)defaultManager;
+ (void)initialize;
+ (id)getPrefix;
+ (id)getAppName;
+ (id)presencePortName;
- (void).cxx_destruct;
- (id)prefForKey:(id)arg1 delegateUID:(id)arg2;
- (void)setString:(id)arg1 forPref:(id)arg2;
- (void)setBool:(BOOL)arg1 forPref:(id)arg2;
- (void)setFloat:(double)arg1 forPref:(id)arg2 delegateUID:(id)arg3;
...
- (double)floatForPref:(id)arg1 delegateUID:(id)arg2;
...
- (BOOL)showPrefsForSource:(id)arg1;
