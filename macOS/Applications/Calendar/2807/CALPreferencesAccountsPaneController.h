...
- (BOOL)isPushAvailableForCurrentAccount;
...
- (void)_configureUIForSelectedAccountHelperSetupServerAddressFields:(id)arg1;
...
- (void)_configureUIForSelectedAccountHelperSetupAvailabilityFields:(id)arg1 source:(id)arg2;
