...
@class CalUILayerBackedView, NSDictionary, NSFont, NSImage, NSImageView, NSLayoutConstraint, NSString, NSTextField, NSView;
...
@property(retain) NSImageView *birthdayView; // @synthesize birthdayView=_birthdayView;
...
@property(retain) NSLayoutConstraint *titleDotConstraint; // @synthesize titleDotConstraint=_titleDotConstraint;
