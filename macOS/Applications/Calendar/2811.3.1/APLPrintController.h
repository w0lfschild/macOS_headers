...
@class APLImageView, APLLayout, APLModel, APLPresetsController, APLRangeController, APLView, CALMainController, CALNumericFormatter, NSArray, NSBox, NSButton, NSDictionary, NSMenu, NSMutableArray, NSMutableDictionary, NSPopUpButton, NSPrintInfo, NSProgressIndicator, NSSlider, NSStackView, NSString, NSTextField, NSView, NSWindow;
