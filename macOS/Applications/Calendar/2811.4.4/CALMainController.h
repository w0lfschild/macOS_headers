...
- (BOOL)showUIOccurrence:(id)arg1 event:(id)arg2 openInspector:(BOOL)arg3 inspectorType:(int)arg4 restoreDraft:(BOOL)arg5;
- (BOOL)showUIOccurrence:(id)arg1 event:(id)arg2 openInspector:(BOOL)arg3 inspectorType:(int)arg4;
- (BOOL)showEvent:(id)arg1 openInspector:(BOOL)arg2 inspectorType:(int)arg3;
- (BOOL)showEvent:(id)arg1;
- (BOOL)showEventWithEventOccurrenceID:(id)arg1 openInspector:(BOOL)arg2;
- (BOOL)showEventWithLegacyOccurrenceID:(id)arg1 openInspector:(BOOL)arg2;
