...
@class BottomBarSegmentedControl, Clip, ClipGroup, ClipHotKeyField, ClipsOutlineView, ModeHeaderView, NSButton, NSPopUpButton, NSPopover, NSString, NSTextField, NSTextView, NSView, PCCellDrawingPopUpButton, PCGradientButton, PlainTextEditor, TSFindTextField;

__attribute__((visibility("hidden")))
@interface ClipsViewController : SidebarObservableOutlineController <NSTextFieldDelegate, HotKeyValidation>
{
