...
@class NSColor, NSImage, NSMutableSet, NSTimer, PCNode, PCRemoteFileManager, PCRemoteFileNode, PCWebpagePreviewFetcher;
...
- (BOOL)pc_saveToURL:(id)arg1 ofType:(id)arg2 forSaveOperation:(unsigned long long)arg3 error:(id *)arg4;
