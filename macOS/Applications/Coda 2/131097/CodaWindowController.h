...
@class ClipsViewController, CodaSite, CodaViewController, DocumentTabBar, DocumentsViewController, ESImageButton, FileBrowserViewController, FindFilesController, HomeScreenController, MiniFileBrowserController, MiniMapControllerViewController, NSArray, NSMapTable, NSMenu, NSMutableArray, NSPopover, NSScriptCommand, NSSplitViewController, NSSplitViewItem, NSString, NSTimer, NSView, NSVisualEffectView, NewSplitViewController, NewTabButton, OperationsInProgressSheetController, PCBaseSplitView, PCRemoteFileManager, PCTitleBarTrialView, PlacesController, PopoverFileBrowserViewController, PublishController, QueueController, QuickOpenController, ReferenceController, SCMController, SharedFileBrowserController, SidebarTabBar, SidebarViewController, SitesTabButton, SitesViewController, SymbolsController, ValidationController;

__attribute__((visibility("hidden")))
@interface CodaWindowController : NSWindowController <NSWindowDelegate, NSSplitViewDelegate, NSOpenSavePanelDelegate, NSToolbarDelegate, PCSheetControllerDelegate, PCSheetControllerInterfaceDelegate, PCTabBarDelegate, QuickOpenControllerDelegate, DragSplitResizeDelegateProtocol>
{
    ...
    NSVisualEffectView *_toolbarBackgroundView;
    PCBaseSplitView *oSidebarSplitView;
    ...
    NSSplitViewItem *iSidebarSplitViewItem;
    CodaSite *iSite;
...
- (void)splitViewDidEndLiveResizeNotification:(id)arg1;
