...
@class NSDate, NSImage, NSMutableSet, NSMutableString, NSTimer;
...
@interface PCSourceOutlineView : PCTrackingOutlineView
{
    ...
    NSDate *_typeaheadDate;
}

@property(retain, nonatomic) NSDate *typeaheadDate; // @synthesize typeaheadDate=_typeaheadDate;
