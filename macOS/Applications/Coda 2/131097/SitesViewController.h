...
@class CodaSite, FirstLaunchViewController, NSArray, NSButton, NSCache, NSImageView, NSMapTable, NSMenu, NSMutableArray, NSPopUpButton, NSProgressIndicator, NSSearchField, NSSecureTextField, NSSortDescriptor, NSString, NSTabView, NSTextField, NSView, NSViewAnimation, OperationsInProgressSheetController, PCAccessoryWindow, PCActionPopUpButton, PCBorderedView, PCDisablingTextField, PCExpiredView, PCGradientButton, PCGridView, PCLinkTextView, PCOverlayView, PCRemoteConnectOperation, PCSplitView, PCSwitch, PCTexturedSlider, PCTimer, PCTransitionTabView, SCMOperation, SCMRepository, SSHIdentityFileHelper, SiteEditTabBackgroundView, SitesListDetailView, SitesOutlineView, TSBottomBarView, TSShadowView;

__attribute__((visibility("hidden")))
@interface SitesViewController : CodaViewController <TSSearchClient, NSAnimationDelegate, PCWebpagePreviewFetcherDelegate, NSTextViewDelegate, PCGridViewDelegate, PCSheetControllerDelegate, PCSheetControllerInterfaceDelegate, NSWindowDelegate, NSOutlineViewDelegate, NSOutlineViewDataSource, SSHIdentityFileHelperDelegate, NSSplitViewDelegate, NSTouchBarDelegate>
{
...
- (void)objectsWillCommit:(id)arg1;
- (void)dealloc;
- (void)unloadView;
