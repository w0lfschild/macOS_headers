...
@class ControlsProgressView, DeviceChromeView, DocumentMode, NSButton, NSMapTable, NSMenu, NSMenuItem, NSMutableArray, NSMutableDictionary, NSMutableSet, NSPanel, NSPopUpButton, NSString, NSTextField, NSTimer, NSURL, PCActionPopUpButton, PCBezelView, PCComboBox, PCTaskWrapper, PCTimer, PasswordInputSheetController, PreviewSourceTextView, TSShadowView, WebPreviewBackgroundView, WebPreviewStyleSheetManager, WebView;

__attribute__((visibility("hidden")))
@interface WebPreviewViewController : CodaDocumentViewController <TSFindClient, TSSearchClient, NSTextStorageDelegate, NSTextViewDelegate, PCSheetControllerDelegate, NSTouchBarDelegate, WebEditingDelegate>
{
    WebView *webView;
...
- (void)bottomBarFrameDidChangeNotification:(id)arg1;
