...
#import "FindReplaceDelegateProtocol-Protocol.h"
...
#import "PCTabBarDelegate-Protocol.h"
...
- (void)slidingViewsBar:(id)arg1 writeViewAtIndex:(long long)arg2 toPasteboard:(id)arg3;
...
- (void)nodeStatusDidChange:(id)arg1;
- (int)numberOfTabs;
- (int)numberOfSplits;
