...
@interface SidebarViewController : NSViewController <PCSheetControllerInterfaceDelegate, PCAppearanceViewDelegate, PCKeyLoopProtocol>
{
...
- (void)dealloc;
- (id)tabImageWithTemplateMaskURL:(id)arg1;
- (id)homeScreenImageWithTemplateMaskURL:(id)arg1;
- (id)alternateTabImageWithTemplateMaskURL:(id)arg1;
