...
@class CodaSite, NSLock, NSManagedObjectContext, NSManagedObjectModel, NSMutableArray, NSMutableSet, NSPersistentStoreCoordinator, PCFileSystemWatcher, PCMapTable, PCProgressPanelController, PCTimer;
...
+ (id)globalIndex;
@property(retain) PCTimer *mainContextSaveTimer; // @synthesize mainContextSaveTimer=_mainContextSaveTimer;
