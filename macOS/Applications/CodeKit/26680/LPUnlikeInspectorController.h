...
@class LPInspectorPaneSectionView, NSString, NSTextField;

__attribute__((visibility("hidden")))
@interface LPUnlikeInspectorController : LPFileInspectorChildController <LPInspectorViewDataSource>
{
    LPInspectorPaneSectionView *_unlikeSectionView;
