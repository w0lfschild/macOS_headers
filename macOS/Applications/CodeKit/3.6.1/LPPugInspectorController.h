...
@interface LPPugInspectorController : LPFileInspectorChildController <LPInspectorViewDataSource, VDKDeselectorTableViewDelegate, NSTableViewDataSource>
{
    BOOL _isSetup;
