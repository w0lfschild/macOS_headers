...
@interface LPSassInspectorController : LPFileInspectorChildController <LPInspectorViewDataSource, VDKDeselectorTableViewDelegate, NSTableViewDataSource>
{
    BOOL _isSetup;
    ...
    NSButton *_sourceMapCheckbox;
    NSButton *_useLibsassCheckbox;
...
- (void)useLibsassCheckboxAction:(id)arg1;
- (void)sourceMapCheckboxAction:(id)arg1;
