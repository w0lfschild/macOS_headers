...
@interface LPSlimInspectorController : LPFileInspectorChildController <LPInspectorViewDataSource, VDKDeselectorTableViewDelegate, NSTableViewDataSource>
{
    BOOL _isSetup;
    ...
    NSButton *_railsCompatibleCheckbox;
    NSButton *_compileOnlyCheckbox;
    NSButton *_logiclessCheckbox;
