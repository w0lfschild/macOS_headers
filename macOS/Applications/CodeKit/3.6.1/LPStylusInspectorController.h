...
@interface LPStylusInspectorController : LPFileInspectorChildController <LPInspectorViewDataSource, VDKDeselectorTableViewDelegate, NSTableViewDataSource>
{
    BOOL _isSetup;
    ...
    NSPopUpButton *_debugStylePopUpButton;
    NSButton *_createSourceMapCheckbox;
    NSButton *_importCSSCheckbox;
    NSButton *_resolveRelativeURLSCheckbox;
...
- (void)importCSSCheckboxAction:(id)arg1;
- (void)resolveRelativeURLSCheckboxAction:(id)arg1;
- (void)createSourceMapCheckboxAction:(id)arg1;
- (void)debugStylePopUpButtonAction:(id)arg1;
