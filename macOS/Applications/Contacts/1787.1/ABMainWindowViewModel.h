...
@class ABAddressBook, ABDefaultGroupEntriesFactory, ABGroupEntriesList, ABGroupListController, ABLastImportGroupController, ABMainWindowSelectionController, ABPersonListController, ABPersonListSearchController, ABPointOfInterestSearchController, CNContactCardViewController, CNWeakReference;
