...
@interface ABGroupRenameAction : NSObject <ABUserInterfaceAction>
{
...
@property(readonly, nonatomic) ABGroup *group; // @synthesize group=_group;
...
- (id)initWithAddressBook:(id)arg1 group:(id)arg2 groupEntriesList:(id)arg3 commandExecutor:(id)arg4 name:(id)arg5;
