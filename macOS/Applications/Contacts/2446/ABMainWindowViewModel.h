...
@class ABAddressBook, ABDefaultGroupEntriesFactory, ABGroupEntriesList, ABGroupListController, ABLastImportGroupController, ABMainWindowSelectionController, ABPersonListController, ABPersonListSearchController, ABPointOfInterestSearchController, CNContactCardViewController;
@protocol ABMainWindowController, ABMainWindowEditModeController;
...
- (void)showWindowDisplayingContactWithIdentifier:(id)arg1 edit:(BOOL)arg2;
- (void)selectContactWithIdentifier:(id)arg1 edit:(BOOL)arg2;
- (BOOL)areSelectedContactsRestricted;
- (BOOL)isAccountForNewRecordsRestricted;
...
- (BOOL)canEditContact;
- (id)contactInCardView;
- (id)cardStateObservable;
