...
@interface ABBookCreateGroupFromSelectionAction : NSObject
{
    ...
    BOOL _executionWasAuthorized;
}

- (void).cxx_destruct;
@property(nonatomic) BOOL executionWasAuthorized; // @synthesize executionWasAuthorized=_executionWasAuthorized;
- (id)folderWithMembersString;
- (id)groupWithMembersString;
- (void)createGroupFromSection;
