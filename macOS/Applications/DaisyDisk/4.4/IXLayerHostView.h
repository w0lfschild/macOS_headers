...
@class CALayer, IXDefaultKeyView, IXKeyViewManager, IXMouseViewManager, NSObject, NSTrackingArea;
...
- (void)stopMovingWindow;
- (void)moveWindowToPoint:(struct CGPoint)arg1;
- (void)startMovingWindowAtPoint:(struct CGPoint)arg1;
