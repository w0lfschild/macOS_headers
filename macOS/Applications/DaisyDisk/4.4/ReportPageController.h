...
- (void)expandSmallerItems:(id)arg1;
...
- (void)deletionProgressDidUpdate:(id)arg1 progress:(double)arg2;
...
- (BOOL)isItemVirtual:(id)arg1 considerSmallerItemsVirtual:(BOOL)arg2;
