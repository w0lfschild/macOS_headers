...
#import "ITPManipulationAnimationChainDelegate-Protocol.h"
#import "TPContext-Protocol.h"

@class DirectoryItem, GetSmallerItemsGroupItemVisitor, IXMouseEvent, NSArray, NSMapTable, NSMutableArray, NSObject, NSTimer, NSTrackingArea, TPInsertManipulationAnimationChain, TPRemoveManipulationAnimationChain, TPSegment, TPSimpleAnimationView, TPSizeLabel;
@protocol ColorSchemeProtocol, ITPNavigationAnimationChain, TreePieViewDelegate;
...
@interface TreePieView : NSView <TPContext, ITPManipulationAnimationChainDelegate>
{
    ...
    GetSmallerItemsGroupItemVisitor *_getSmallerItemsGroupVisitor;
