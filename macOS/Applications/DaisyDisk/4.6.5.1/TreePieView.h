...
@class DirectoryItem, IXMouseEvent, NSArray, NSMapTable, NSMutableArray, NSObject, NSTimer, NSTrackingArea, TPInsertManipulationAnimationChain, TPRemoveManipulationAnimationChain, TPSegment, TPSimpleAnimationView, TPSizeLabel;
