...
@class IXButtonStyles, NSColor, TextStyles;

@interface CZDeletingDropAreaStateStyles : StylesBase
{
    NSColor *_fillColor;
    ...
    double _ringCutWidth;
    double _ringMiddleAnimationPeriod;
    double _ringOuterAnimationPeriod;
}

@property(nonatomic) double ringOuterAnimationPeriod; // @synthesize ringOuterAnimationPeriod=_ringOuterAnimationPeriod;
@property(nonatomic) double ringMiddleAnimationPeriod; // @synthesize ringMiddleAnimationPeriod=_ringMiddleAnimationPeriod;
@property(nonatomic) double ringCutWidth; // @synthesize ringCutWidth=_ringCutWidth;
