...
@interface CZSystemDropAreaStateStyles : StylesBase
{
    NSColor *_fillColor;
    ...
    double _ringMiddleBarAngle;
}

@property(nonatomic) double ringMiddleBarAngle; // @synthesize ringMiddleBarAngle=_ringMiddleBarAngle;
