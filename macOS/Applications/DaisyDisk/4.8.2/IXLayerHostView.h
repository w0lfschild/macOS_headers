...
#import "IXCoordinateTransformerProtocol.h"
#import "IXHostProtocol.h"

@class CALayer, IXDefaultKeyView, IXKeyViewManager, IXMouseViewManager, IXYosemiteWindowDragger, NSObject<IXKeyHandlerProtocol>, NSObject<IXKeyViewLoopDelegate>, NSObject<IXMouseHandlerProtocol>, NSTrackingArea;
