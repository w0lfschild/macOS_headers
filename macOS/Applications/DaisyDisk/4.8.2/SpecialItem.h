...
@interface SpecialItem : DirectoryItem
{
    ...
    BOOL _hasFixedSizeInBytes;
    unsigned long long _fixedSizeInBytes;
...
- (BOOL)isSpecial;
- (BOOL)isSortable;
- (void)resetFixedSizeInBytes;
@property(nonatomic) unsigned long long fixedSizeInBytes;
