...
@interface ApplicationController : NSObject
{
    ...
    NSWindow *_newlyCreatedWindowOrTab;
}

+ (id)sharedAppController;
@property(readonly) NSWindow *newlyCreatedWindowOrTab; // @synthesize newlyCreatedWindowOrTab=_newlyCreatedWindowOrTab;
...
- (void)_checkActiveButNotInstalledDictionaries;
- (void)_prepareMobileAssetsQuery;
...
- (id)_newBrowserWindowCommon;
- (void)newBrowserTab:(id)arg1;
