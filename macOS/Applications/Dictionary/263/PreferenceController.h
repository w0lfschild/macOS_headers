...
@class DictionaryObj, NSDictionary, NSIndexSet, NSMutableArray, NSMutableDictionary, NSProgressIndicator, NSScrollView, NSURL, NSView, NSWindow, WebView;
...
@interface PreferenceController : NSObject
{
    ...
    NSDictionary *_currentPreference;
