...
@class BrowserWindowController, DSShadowOverlay, DictionaryRecordRepository, DictionaryWebView, NSArray, NSArrayController, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSScrollView, NSSplitViewController, NSString, NSTimer, NSWindow, WebWrapScrollView;
...
@interface DictionaryController : NSObject
{
    ...
    BOOL _lastClickWasOnSelection;
    NSString *_lastClickedTerm;
}

+ (BOOL)isSelectorExcludedFromWebScript:(SEL)arg1;
@property BOOL lastClickWasOnSelection; // @synthesize lastClickWasOnSelection=_lastClickWasOnSelection;
@property(copy) NSString *lastClickedTerm; // @synthesize lastClickedTerm=_lastClickedTerm;
...
- (long long)_topSelectableIndexRow;
