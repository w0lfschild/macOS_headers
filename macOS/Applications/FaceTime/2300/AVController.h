...
@property(retain, nonatomic) NSDictionary *outgoingCall; // @synthesize outgoingCall=_outgoingCall;
@property(retain, nonatomic) id onHoldCall; // @synthesize onHoldCall=_onHoldCall;
@property(retain, nonatomic) id callWaitingCall; // @synthesize callWaitingCall=_callWaitingCall;
@property(retain, nonatomic) id call; // @synthesize call=_call;
