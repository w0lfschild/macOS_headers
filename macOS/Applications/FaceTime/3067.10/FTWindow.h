...
@interface FTWindow : NSWindow
{
    ...
    BOOL _delegateWindowStoppedDragging;
...
@property(nonatomic) BOOL delegateWindowStoppedDragging; // @synthesize delegateWindowStoppedDragging=_delegateWindowStoppedDragging;
