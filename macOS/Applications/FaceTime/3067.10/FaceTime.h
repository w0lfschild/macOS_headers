...
@class FTDockTileHelper, FTPreferencesWindowController, NSMenu, NSMenuItem, NSMutableArray, NSString, NSTimer;
...
- (void)_vccReceivedFirstFrame:(id)arg1;
- (void)_vccRequestedPreview:(id)arg1;
