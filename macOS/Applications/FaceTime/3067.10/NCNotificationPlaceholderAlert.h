...
@interface NCNotificationPlaceholderAlert : NSObject
{
    ...
    _Bool _showingAlert;
    CDUnknownBlockType _reservedFrameUpdated;
    struct CGRect _reservedFrame;
}

@property(readonly, nonatomic) struct CGRect reservedFrame; // @synthesize reservedFrame=_reservedFrame;
@property(copy, nonatomic) CDUnknownBlockType reservedFrameUpdated; // @synthesize reservedFrameUpdated=_reservedFrameUpdated;
- (void).cxx_destruct;
- (void)_windowPositionChanged:(id)arg1;
...
- (void)_sendShowAlert:(_Bool)arg1 animation:(unsigned long long)arg2;
- (void)_got_server_keep_alive:(id)arg1;
- (id)connection;
- (void)connection:(id)arg1 didReceiveMessage:(id)arg2;
- (void)close;
- (void)resize:(double)arg1;
- (id)initWithAnimation:(unsigned long long)arg1 block:(CDUnknownBlockType)arg2;
