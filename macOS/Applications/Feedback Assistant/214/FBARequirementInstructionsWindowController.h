...
@interface FBARequirementInstructionsWindowController : NSWindowController
{
...
@property(retain, nonatomic) FBAFileRequirement *requirement; // @synthesize requirement=_requirement;
- (void).cxx_destruct;
