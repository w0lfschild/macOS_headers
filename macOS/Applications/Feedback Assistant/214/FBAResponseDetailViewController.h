...
@class FBACorrespondenceViewController, FBAFeedbackSummaryViewController, FBAFileCollectionView, FBAFollowupListView, FBAFormResponse, FBAJSONEncoding, FBARestInterface, FBAStackView, FBATextViewWithPlaceHolder, NSArray, NSButton, NSProgressIndicator, NSScrollView, NSSet, NSString, NSView;
...
@property(retain) FBAJSONEncoding *JSONContext; // @synthesize JSONContext=_JSONContext;
- (void).cxx_destruct;
