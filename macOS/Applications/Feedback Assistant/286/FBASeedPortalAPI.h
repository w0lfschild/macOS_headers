...
- (void)markCompleteForFormResponseWithID:(id)arg1 bugFormID:(id)arg2 withFiles:(BOOL)arg3 uploadStory:(id)arg4 success:(CDUnknownBlockType)arg5 error:(CDUnknownBlockType)arg6;
