...
@class FBAHTTPClient, FBAProjectsRefreshOperation, NSManagedObjectContext, NSMutableArray, NSURL;
...
@interface FBASeedPortalAPI : NSObject
{
    ...
    NSURL *_feedbackURL;
    NSMutableArray *_pendingRemoteSaveOperations;
    FBAProjectsRefreshOperation *_pendingRefreshOp;
}

@property(retain) FBAProjectsRefreshOperation *pendingRefreshOp; // @synthesize pendingRefreshOp=_pendingRefreshOp;
@property(retain) NSMutableArray *pendingRemoteSaveOperations; // @synthesize pendingRemoteSaveOperations=_pendingRemoteSaveOperations;
...
- (BOOL)hasEmptyRemoteSaveQueue;
- (void)unlockProjectRefreshWithIdentifier:(id)arg1;
- (void)lockProjectRefreshWithIdentifier:(id)arg1;
...
- (void)_updateProjectsIncludingiOSOnly:(BOOL)arg1 withSuccess:(CDUnknownBlockType)arg2 error:(CDUnknownBlockType)arg3;
