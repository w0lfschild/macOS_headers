...
@class FBACorrespondenceViewController, FBAFeedbackSummaryViewController, FBAFileCollectionView, FBAFollowupListView, FBAFormResponse, FBAStackView, FBATextViewWithPlaceHolder, NSArray, NSButton, NSProgressIndicator, NSScrollView, NSSet, NSString, NSView;
