...
@class FBACorrespondenceViewController, FBAFeedback, FBAFileCollectionView, FBAFollowupListView, FBAFormResponseStub, FBAFormResponseStubViewController, FBAStackView, FBATextViewWithPlaceHolder, NSArray, NSButton, NSLayoutConstraint, NSProgressIndicator, NSScrollView, NSSet, NSString, NSView;
