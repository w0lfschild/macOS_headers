...
@class FBAAdditionalFilesViewController, FBABugForm, FBABugFormPickerViewController, FBABugFormStub, FBABugFormViewController, FBADraftingController, FBAFiler, FBAFormResponse, FBAOptOutWindowController, FBAPrivacyAlert, FBASubmissionViewController, FBASummaryViewController, FBATeam, NSArray, NSButton, NSDictionary, NSMutableSet, NSPopover, NSProgressIndicator, NSSet, NSString, NSTextField, NSView, NSViewController;
@protocol FBADraftWindowDelegate;

@interface FBADraftWindowController : NSWindowController <NSToolbarDelegate, NSToolbarItemValidation, FBADraftingDelegate, FBAFilerDelegate, FBABugFormPickerDelegate, FBAFeedbackSummaryQuestionGroupViewControllerDelegate, NSWindowDelegate>
{
    BOOL _newResponse;
    BOOL _isObserving;
