...
@class NSArray, NSData, NSDictionary, NSError, NSString, NSURL, NSURLAuthenticationChallenge, NSURLRequest, WKBackForwardListItem, WKDownload, WKFrameInfo, WKNavigation, WKNavigationAction, WKWebView, WKWebpagePreferences, _WKContentRuleListAction;
