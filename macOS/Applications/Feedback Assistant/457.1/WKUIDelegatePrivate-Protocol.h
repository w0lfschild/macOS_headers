...
@class NSArray, NSData, NSDictionary, NSEvent, NSMenu, NSString, NSURL, WKFrameInfo, WKNavigationAction, WKSecurityOrigin, WKWebView, WKWebViewConfiguration, WKWindowFeatures, _WKAttachment, _WKContextMenuElementInfo, _WKFrameHandle, _WKHitTestResult, _WKInspector, _WKInspectorConfiguration, _WKWebAuthenticationPanel;
@protocol NSSecureCoding;

@protocol WKUIDelegatePrivate <WKUIDelegate>

@optional
- (void)_webView:(WKWebView *)arg1 willCloseLocalInspector:(_WKInspector *)arg2;
- (void)_webView:(WKWebView *)arg1 didAttachLocalInspector:(_WKInspector *)arg2;
- (_WKInspectorConfiguration *)_webView:(WKWebView *)arg1 configurationForLocalInspector:(_WKInspector *)arg2;
...
- (void)_webView:(WKWebView *)arg1 requestSpeechRecognitionPermissionForOrigin:(WKSecurityOrigin *)arg2 decisionHandler:(void (^)(BOOL))arg3;
...
- (void)_webView:(WKWebView *)arg1 shouldAllowPDFAtURL:(NSURL *)arg2 toOpenFromFrame:(WKFrameInfo *)arg3 completionHandler:(void (^)(BOOL))arg4;
...
- (void)_webView:(WKWebView *)arg1 printFrame:(_WKFrameHandle *)arg2 completionHandler:(void (^)(void))arg3;
