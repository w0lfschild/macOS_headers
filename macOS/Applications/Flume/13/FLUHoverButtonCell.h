...
- (void)setSelectedTextColor:(id)arg1 update:(BOOL)arg2;
- (void)setHoverTextColor:(id)arg1 update:(BOOL)arg2;
- (void)setRegularTextColor:(id)arg1 update:(BOOL)arg2;
- (void)setHovering:(BOOL)arg1 update:(BOOL)arg2;
