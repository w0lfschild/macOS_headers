...
@class FLUBlurView, FLUBorderView, FLUHoverButton, FLUImageView, FLUTabbedButton, FLUTextField, NSString, NSTimer;

@interface FLUMediaTableSearchHeaderView : FLUMediaTableHeaderView <FLUTextFieldDelegate>
{
