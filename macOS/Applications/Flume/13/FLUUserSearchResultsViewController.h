...
#import "FLUUserSearchResultTableCellViewDelegate.h"
#import "NSTableViewDataSource.h"
#import "NSTableViewDelegate.h"

@class NSArray, NSString, NSTableView;

@interface FLUUserSearchResultsViewController : NSViewController <NSTableViewDelegate, NSTableViewDataSource, FLUUserSearchResultTableCellViewDelegate>
{
    CDUnknownBlockType _selectionBlock;
    CDUnknownBlockType _deleteActionBlock;
    NSArray *_searchResults;
    NSArray *_disabledSearchResults;
    NSTableView *_tableView;
}

@property(nonatomic) __weak NSTableView *tableView; // @synthesize tableView=_tableView;
@property(retain, nonatomic) NSArray *disabledSearchResults; // @synthesize disabledSearchResults=_disabledSearchResults;
...
- (void)flu_didPressUserSearchResultDeleteButtonForUser:(id)arg1;
- (void)flu_didPressUserSearchResultSelectButtonForUser:(id)arg1;
