...
@class MQTTSSLSecurityPolicy, MQTTSession, NSArray, NSData, NSDictionary, NSError, NSLock, NSObject<OS_dispatch_queue>, NSString, ReconnectTimer;
...
- (void)connectToLast:(CDUnknownBlockType)arg1;
- (void)reconnect:(CDUnknownBlockType)arg1;
- (void)connectToInternal:(CDUnknownBlockType)arg1;
...
- (void)disconnectWithDisconnectHandler:(CDUnknownBlockType)arg1;
- (unsigned short)sendData:(id)arg1 topic:(id)arg2 qos:(unsigned char)arg3 retain:(BOOL)arg4;
- (void)connectTo:(id)arg1 port:(long long)arg2 tls:(BOOL)arg3 keepalive:(long long)arg4 clean:(BOOL)arg5 auth:(BOOL)arg6 user:(id)arg7 pass:(id)arg8 will:(BOOL)arg9 willTopic:(id)arg10 willMsg:(id)arg11 willQos:(unsigned char)arg12 willRetainFlag:(BOOL)arg13 withClientId:(id)arg14 securityPolicy:(id)arg15 certificates:(id)arg16 protocolLevel:(unsigned char)arg17 connectHandler:(CDUnknownBlockType)arg18;
- (id)initWithPersistence:(BOOL)arg1 maxWindowSize:(unsigned long long)arg2 maxMessages:(unsigned long long)arg3 maxSize:(unsigned long long)arg4 maxConnectionRetryInterval:(double)arg5 connectInForeground:(BOOL)arg6 streamSSLLevel:(id)arg7 queue:(id)arg8;
- (id)init;
