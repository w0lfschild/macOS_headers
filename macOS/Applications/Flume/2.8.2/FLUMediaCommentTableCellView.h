...
@class FLUAvatarButton, FLUComment, FLUHoverButton, FLULabel, FLUTextEntityLabel, FLUView, NSString, NSTrackingArea, YRKSpinningProgressIndicator;
@protocol FLUMediaCommentTableCellViewDelegate;
...
@interface FLUMediaCommentTableCellView : FLUTableCellView <NSTextViewDelegate, NSMenuDelegate>
{
    ...
    FLUAvatarButton *_previewUserFrontAvatarButton;
    FLUAvatarButton *_previewUserBackAvatarButton;
...
@property(retain, nonatomic) FLUAvatarButton *previewUserBackAvatarButton; // @synthesize previewUserBackAvatarButton=_previewUserBackAvatarButton;
@property(retain, nonatomic) FLUAvatarButton *previewUserFrontAvatarButton; // @synthesize previewUserFrontAvatarButton=_previewUserFrontAvatarButton;
...
- (void)didPressDeleteCommentMenuItem:(id)arg1;
- (void)didPressResendCommentMenuItem:(id)arg1;
- (void)didPressReplyMenuItem:(id)arg1;
- (void)didPressLikeMenuItem:(id)arg1;
