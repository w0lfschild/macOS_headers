...
@class FLUBlurView, FLUHoverButton, FLUImageView, FLUTextField, NSString, NSTimer;
@protocol FLUMediaTableConversationsHeaderViewDelegate;

@interface FLUMediaTableConversationsHeaderView : FLUView <NSTextFieldDelegate>
{
