...
@class AFHTTPResponseSerializer, FLUHTTPSessionManager, NSError, NSObject, NSSet, NSURLResponse;
@protocol AFURLResponseSerialization, OS_dispatch_queue;
...
@interface FLURequest : NSMutableURLRequest
{
    ...
    CDUnknownBlockType _workerBlock;
...
+ (id)requestConfigureMediaWithUploadID:(id)arg1 carouselUploadIDs:(id)arg2 mediaTypes:(id)arg3 sizes:(id)arg4 durations:(id)arg5 mediaLocation:(id)arg6 postingLocation:(id)arg7 tags:(id)arg8 sponsorTags:(id)arg9 caption:(id)arg10 shareToAccounts:(id)arg11 shareToFavorites:(BOOL)arg12 settings:(id)arg13;
...
@property(copy) CDUnknownBlockType workerBlock; // @synthesize workerBlock=_workerBlock;
