...
@class FBCollectionOutlineView, FBUIController, NSArray, NSButton, NSMutableSet, NSScrollView, NSString, NSVisualEffectView;
...
@property NSVisualEffectView *view; // @synthesize view=_view;
