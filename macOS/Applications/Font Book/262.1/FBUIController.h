...
@class FBBackgroundView, FBCollectionViewController, FBDuplicateResolutionWindowController, FBFontViewController, FBGroup, FBLanguagePicker, FBMultiPreviewController, FBPrintController, FBProgressWindowController, FBSearchController, FBSmartCollection, NSArray, NSBox, NSButton, NSDrawer, NSImage, NSMenu, NSMutableArray, NSNumberFormatter, NSPredicateEditor, NSPrintOperation, NSResponder, NSSegmentedControl, NSSpeechSynthesizer, NSSplitView, NSString, NSTextField, NSTimer, NSToolbar, NSToolbarItem, NSUndoManager, NSView, NSWindow;
...
@property id storedFirstResponder; // @synthesize storedFirstResponder=_storedFirstResponder;
...
@property(retain) NSDrawer *drawer; // @synthesize drawer=_drawer;
...
@property NSBox *mainSplitViewContainer; // @synthesize mainSplitViewContainer=_mainSplitViewContainer;
@property FBBackgroundView *mainBackgroundView; // @synthesize mainBackgroundView=_mainBackgroundView;
...
- (BOOL)appleInternalBoolForKey:(id)arg1;
