...
@class FBFile, FBUniqueString, NSArray, NSCharacterSet, NSDate, NSDictionary, NSFont, NSImage, NSSet, NSString, NSURL;
...
@property BOOL knowsUsers; // @synthesize knowsUsers=_knowsUsers;
@property(copy) NSArray *_knownUsers; // @synthesize _knownUsers=__knownUsers;
...
@property(readonly, copy) NSArray *knownUsers;
