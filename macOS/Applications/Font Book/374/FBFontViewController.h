...
@interface FBFontViewController : NSViewController <FBViewSizingDelegate, FBViewController, FBViewControllerTypeAhead, NSOutlineViewDelegate, NSOutlineViewDataSource, NSPasteboardWriting, NSMenuItemValidation>
{
...
@property(readonly) __weak NSArray *selectedFaceArray;
