...
@interface FBDuplicateResolutionWindowController : NSWindowController <NSWindowDelegate, NSCollectionViewDataSource, NSCollectionViewDelegate, NSTouchBarDelegate>
{
    NSPanel *panel;
