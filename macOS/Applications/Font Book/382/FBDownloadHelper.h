...
@class FBProgressRepresentedObject, NSMutableSet;
...
@interface FBDownloadHelper : NSObject
{
    ...
    FBProgressRepresentedObject *_progressObject;
}

+ (BOOL)executeProgressHandlerWithState:(unsigned int)arg1 andParameter:(id)arg2;
+ (void)beginErrorReporting;
+ (void)_prepareToDownload;
+ (id)_downloadHelper;
@property BOOL reportError; // @synthesize reportError=_reportError;
@property(retain) FBProgressRepresentedObject *progressObject; // @synthesize progressObject=_progressObject;
