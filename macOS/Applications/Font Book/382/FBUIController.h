...
@class FBCollectionViewController, FBDuplicateResolutionWindowController, FBFontViewController, FBGroup, FBLanguagePicker, FBMultiPreviewController, FBPrintController, FBProgressWindowController, FBSearchController, FBSmartCollection, NSArray, NSBox, NSButton, NSImage, NSMenu, NSMenuItem, NSMutableArray, NSNumberFormatter, NSPredicateEditor, NSPrintOperation, NSResponder, NSSearchToolbarItem, NSSegmentedControl, NSSpeechSynthesizer, NSSplitView, NSSplitViewController, NSSplitViewItem, NSString, NSTextField, NSTimer, NSToolbar, NSToolbarItem, NSTouchBar, NSUndoManager, NSView, NSWindow;

@interface FBUIController : NSWindowController <NSToolbarDelegate, NSAnimationDelegate, NSTouchBarDelegate>
{
    ...
    NSToolbar *_toolbar;
    NSToolbarItem *_addFontToolbarItem;
    NSMenuItem *_addFontMenuItem;
    NSToolbarItem *_setPreviewModeToolbarItem;
    NSMenuItem *_setPreviewModeMenuItem;
    NSSegmentedControl *_setPreviewTypeControl;
    NSSegmentedControl *_setPreviewTouchbarControl;
    NSMenu *_searchPopupMenu;
    FBSearchController *_searchController;
    NSSearchToolbarItem *_searchFieldItem;
    NSBox *_collectionControlsGroup;
    NSButton *_collectionAddButton;
    NSButton *_fontAddButton;
    NSButton *_enableDisableFontsButton;
    NSButton *_enableDisableTouchbarButton;
    NSToolbarItem *_enableDisableToolbarItem;
    NSMenuItem *_enableDisableMenuItem;
...
@property NSMenuItem *enableDisableMenuItem; // @synthesize enableDisableMenuItem=_enableDisableMenuItem;
@property NSToolbarItem *enableDisableToolbarItem; // @synthesize enableDisableToolbarItem=_enableDisableToolbarItem;
@property NSButton *enableDisableTouchbarButton; // @synthesize enableDisableTouchbarButton=_enableDisableTouchbarButton;
...
@property NSSearchToolbarItem *searchFieldItem; // @synthesize searchFieldItem=_searchFieldItem;
...
@property NSSegmentedControl *setPreviewTouchbarControl; // @synthesize setPreviewTouchbarControl=_setPreviewTouchbarControl;
@property NSSegmentedControl *setPreviewTypeControl; // @synthesize setPreviewTypeControl=_setPreviewTypeControl;
@property NSMenuItem *setPreviewModeMenuItem; // @synthesize setPreviewModeMenuItem=_setPreviewModeMenuItem;
@property NSToolbarItem *setPreviewModeToolbarItem; // @synthesize setPreviewModeToolbarItem=_setPreviewModeToolbarItem;
@property NSMenuItem *addFontMenuItem; // @synthesize addFontMenuItem=_addFontMenuItem;
@property NSToolbarItem *addFontToolbarItem; // @synthesize addFontToolbarItem=_addFontToolbarItem;
...
@property NSSplitView *mainSplitView; // @synthesize mainSplitView=_mainSplitView;
...
- (void)_purgeAllDownloadedFonts;
- (_Bool)_shouldDownloadLanguageSpecificFontAssets;
- (_Bool)_isAnyFontAssetDownloaded;
...
- (void)removeFaces:(id)arg1 fromGroup:(id)arg2 reverseConfirm:(BOOL)arg3;
