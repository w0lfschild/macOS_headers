...
@interface CLgEditorAreaView : MAKitView <MAAccessibilityFauxUIElementParent>
{
    ...
    int _prevSelectedMidiEditorViewID;
    int _prevSelectedAudioEditorViewID;
...
- (int)_editorViewIDForFirstSelectedRegionOrRecordingTrack;
...
- (void)setPrevSelectedAudioEditorViewID:(int)arg1;
- (int)prevSelectedAudioEditorViewID;
- (void)setPrevSelectedMidiEditorViewID:(int)arg1;
