...
@class LgLibraryDataSourceRevertInfo, NSMutableSet, NSTimer;
...
+ (BOOL)entryIsPremiumLockedOrHasMissingContent:(struct CMenuEntry *)arg1;
...
@property(nonatomic) CDStruct_9e44aee5 currentSelectionInfo; // @synthesize currentSelectionInfo=_currentSelectionInfo;
...
- (void)saveUserFile;
- (void)loadSettingForMenuEntry:(struct CMenuEntry *)arg1 enablePatchMerging:(BOOL)arg2 withPatchMergeFilterFlags:(int)arg3 force:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
- (void)loadPrevNextSetting:(BOOL)arg1 enablePatchMerging:(BOOL)arg2 withPatchMergeFilterFlags:(int)arg3 localMenuOnly:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)_internalLoadSettingFromURL:(id)arg1 withCategory:(id)arg2 intoTrack:(struct TPosOneBasedTrackNr *)arg3 withGinst:(int *)arg4 inFolderWithID:(int)arg5 enablePatchMerging:(BOOL)arg6 importFlags:(long long)arg7;
- (void)_loadSettingFromURL:(id)arg1 withCategory:(id)arg2 intoTrack:(struct TPosOneBasedTrackNr *)arg3 withGinst:(int *)arg4 inFolderWithID:(int)arg5 enablePatchMerging:(BOOL)arg6 importFlags:(long long)arg7;
...
- (BOOL)_selectionInfo:(CDStruct_9e44aee5)arg1 isEqualTo:(CDStruct_9e44aee5)arg2;
- (double)_timerDelay;
...
- (void)updateDataSourceForSelection:(CDStruct_9e44aee5)arg1;
