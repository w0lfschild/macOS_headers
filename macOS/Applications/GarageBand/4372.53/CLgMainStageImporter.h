...
+ (void)initialize;
@property(nonatomic) BOOL isFactoryPatch; // @synthesize isFactoryPatch=_isFactoryPatch;
...
- (id).cxx_construct;
- (void)instantiateAChannelFor:(int)arg1 inSong:(struct CSong *)arg2 withImportFlags:(long long)arg3;
