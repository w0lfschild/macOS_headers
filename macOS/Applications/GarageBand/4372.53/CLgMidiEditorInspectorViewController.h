...
@class MABackgroundView, MAKitMenu, MAKitTabView, MASegmentedControl, MASlider, MATextField, NSBox, NSTextField, NSView;

@interface CLgMidiEditorInspectorViewController : MALastClickedParameterViewController
{
