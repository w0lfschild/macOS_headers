...
+ (id)showAsSheet:(id)arg1 song:(struct CSong *)arg2 withTempoArray:(id)arg3 preferredTempo:(float)arg4 result:(struct DTOAR_Result *)arg5;
+ (id)nibName;
...
@property(nonatomic) _Bool applyTempoAverage; // @synthesize applyTempoAverage;
...
@property(nonatomic) _Bool writeTempoAverage; // @synthesize writeTempoAverage;
