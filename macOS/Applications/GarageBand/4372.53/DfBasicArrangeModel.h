...
@interface DfBasicArrangeModel : NSObject <NSCoding>
{
    ...
    long long m_currentAlignmentGuides[2][2];
    ...
    unsigned int m_showAlignmentGuides:1;
    unsigned int m_alignmentGuidesEnabled:1;
    NSMutableArray *m_alignmentGuidesClocks;
...
+ (BOOL)fileReferenceIsFromLibraryBundle:(id)arg1;
+ (id)fixLibraryFileReferenceToLocalLibraryBundleIfNeccessary:(id)arg1;
...
- (void)clearSelection;
- (void)deselectAll;
@property(readonly) BOOL duckingScenarioEnabled;
@property(readonly, nonatomic) BOOL duckingEnabled;
...
- (BOOL)applyAnalysisResults:(unsigned long long)arg1 forAudioRegion:(id)arg2 absoluteAlignmentClock:(long long)arg3 options:(int)arg4;
...
- (void)deleteRegionsOnTrack:(id)arg1 hideTrack:(BOOL)arg2 makeUndo:(BOOL)arg3;
...
- (void)setAlignmentGuidesEnabled:(BOOL)arg1;
- (BOOL)alignmentGuidesEnabled;
- (BOOL)canShowAlignmentGuides;
- (void)setShowAlignmentGuidesIn:(float)arg1 clockMode:(int)arg2;
- (void)setShowAlignmentGuides:(id)arg1;
- (long long)checkAlignmentGuide:(int)arg1 atClock:(long long)arg2 withMode:(int)arg3;
- (long long)checkAlignmentGuide:(int)arg1 atClock:(long long)arg2 withMode:(int)arg3 andTolerance:(float)arg4;
- (BOOL)_findAlignmentGuideClock:(long long)arg1 filteredClock:(long long *)arg2;
- (long long)alignmentGuide:(int)arg1;
- (void)resetAlignmentGuides;
- (void)prepareAlignmentGuidesForSampleEditor;
- (void)prepareAlignmentGuidesForEditor;
- (void)prepareAlignmentGuidesForArrange;
- (void)prepareAlignmentGuidesForRuler;
- (void)collectAlignmentGuidesForGrooveMasterTrack;
- (void)collectAlignmentGuidesForTransientsOfTrack:(id)arg1;
- (void)collectAlignmentGuidesForTrackEvents;
- (void)collectAlignmentGuidesForEventsInCurrentRegion;
- (void)collectAlignmentGuidesForEventsInRegions:(id)arg1;
- (void)collectAlignmentGuidesForEventsInRegion:(id)arg1;
- (void)collectAlignmentGuidesForRegions:(BOOL)arg1;
- (void)collectAlignmentGuidesForMarker;
...
- (id)mediaMarkers;
- (void)setMediaMarkers:(id)arg1;
- (void)setMediaProperties:(id)arg1;
- (id)mediaProperties;
- (BOOL)postMediaNotifications;
- (void)setPostMediaNotifications:(BOOL)arg1;
...
- (BOOL)replaceTracksWithSubmixBounce:(id)arg1 keepUsedGridRowsIfNeeded:(BOOL)arg2 makeUndo:(BOOL)arg3;
...
- (id)createTrackOfType:(int)arg1 withChannelStrip:(id)arg2 andNumberOfChannels:(unsigned long long)arg3 atTrackIndex:(long long)arg4 inputMethodKey:(id)arg5 makeUndo:(BOOL)arg6 categoryName:(id)arg7 subCategoryName:(id)arg8 chStripName:(id)arg9;
...
- (unsigned long long)numberOfDuckingPassiveTracks;
- (unsigned long long)numberOfDuckingDuckeeTracks;
- (unsigned long long)numberOfDuckingDuckerTracks;
- (unsigned long long)numberOfTracksWithDuckingState:(int)arg1;
...
- (BOOL)hasDuckingPassiveTracks;
- (BOOL)hasDuckingDuckeeTracks;
- (BOOL)hasDuckingDuckerTracks;
- (BOOL)hasTracksOfDuckingState:(int)arg1;
