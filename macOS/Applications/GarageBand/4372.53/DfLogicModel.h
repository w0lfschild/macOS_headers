...
- (void)movieSyncCallbackStartMovie:(void *)arg1;
...
- (void)rewireChanged:(void *)arg1;
- (void)midiEvent:(void *)arg1;
...
- (BOOL)isModelDirty;
@property(readonly) struct LGDOCUMENT *logicDocument;
- (id)undoManager;
