...
@class GBTrackInspectorAudioUnits, GBTrackInspectorInstrumentButton, MAKitTabView, MAPopUpButton, MASegmentedControl, MASlider, NSArrayController, NSButton, NSMapTable, NSNumber, NSString, NSTextField, NSView;
