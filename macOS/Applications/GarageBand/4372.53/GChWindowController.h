...
@class GChButton, GChCreatePanel, GChDatabase, GChEditorView, GChGlyphButton, GChGlyphPopup, GChInfoTextView, GChLibraryView, GChPopUpButton, GChProjView, GChSearchField, GChStepper, GChTabView, GChWindowView, MABorderView, MAKitOutlineView, MAKitSegmentedControl, MAKitTableView, MAKitTextField, NSMatrix, NSString, NSTabViewItem;
...
@interface GChWindowController : NSWindowController <NSTextFieldDelegate>
{
    ...
    MAKitTextField *main_edit_tuningPitches;
    MAKitTextField *main_edit_numStrings;
    ...
    MAKitTextField *main_create_libraryName;
    ...
    MAKitTextField *main_lib_tuningPitches;
    MAKitTextField *main_lib_numStrings;
    GChPopUpButton *main_lib_rootNote;
    MAKitTextField *main_lib_rootNoteLabel;
    GChPopUpButton *main_lib_bassNote;
    MAKitTextField *main_lib_bassNoteLabel;
    GChPopUpButton *main_lib_chordType;
    MAKitTextField *main_lib_chordTypeLabel;
    GChPopUpButton *main_lib_difficulty;
    MAKitTextField *main_lib_difficultyLabel;
    GChButton *main_lib_isFavorite;
    GChPopUpButton *main_lib_library;
    MAKitTextField *main_lib_libraryLabel;
    GChSearchField *main_lib_search;
    MAKitTextField *main_lib_searchLabel;
    ...
    MAKitTextField *mini_lib_tuningPitches;
    MAKitTextField *mini_lib_numStrings;
...
+ (BOOL)showModalGuitarChordsInspectorForChordDescr:(id)arg1 withTuningDescr:(id)arg2 filterParameters:(id)arg3 allowAllTunings:(BOOL)arg4 displayOptions:(id)arg5 scdi:(struct ScDragInfo1 *)arg6 scvs:(struct ScViewState *)arg7;
...
- (void)export_sheetDidEnd:(id)arg1 returnCode:(long long)arg2 contextInfo:(void *)arg3;
