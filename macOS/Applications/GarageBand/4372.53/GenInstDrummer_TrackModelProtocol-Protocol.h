...
- (NSURL *)patchURLForSelectedCharacterAtIndex:(unsigned long long)arg1;
- (NSArray *)patchURLsForGenreIdentifier:(NSString *)arg1 andCharacterIdentifier:(NSString *)arg2;
- (BOOL)defaultPatchURLExistsForGenreIdentifier:(NSString *)arg1 andCharacterIdentifier:(NSString *)arg2;
- (BOOL)saveNewPresetForRegion:(struct CRegion *)arg1 outPresetUniqueIdentifier:(id *)arg2;
- (void)setSelectedGenre:(NSString *)arg1 andCharacterIdentifier:(NSString *)arg2 loadAssociatedPatch:(int)arg3 withUndo:(int)arg4;
...
- (void)initializeNewDrummerRegion:(struct CRegion *)arg1 generate:(BOOL)arg2 adjustStartPosition:(BOOL)arg3 adjustLength:(BOOL)arg4 regionParameterValues:(NSDictionary *)arg5;
...
- (void)initializeDrumTrack:(struct CVirtualTrack)arg1 withOptions:(NSDictionary *)arg2;
