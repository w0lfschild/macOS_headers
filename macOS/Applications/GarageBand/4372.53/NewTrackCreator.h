...
@interface NewTrackCreator : NSObject
{
    ...
    BOOL m_shouldLoadDefaultCstOrPatch;
    int m_channelMode;
...
- (void)_loadAnimalSettingIntoTrack:(struct CTrack *)arg1;
- (void)storeSettings;
- (id)_settings;
