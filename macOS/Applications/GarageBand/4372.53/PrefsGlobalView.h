...
@class MAKitSegmentedScrubber, MAKitTextField, NSButton, NSPopUpButton, NSString, NSTabView;

@interface PrefsGlobalView : ModuleController <MANewProjectDialogDelegate>
{
    NSTabView *globTabView;
    NSPopUpButton *globStartupBehavior;
    NSButton *globSelectDefaultProjectBtn;
    MAKitTextField *globDefaultTemplateLabel;
    NSButton *globAskClose;
    NSButton *globExportFormat0;
    NSPopUpButton *globNumberOfAutobackups;
    MAKitTextField *globAutobackupsLabel;
    ...
    NSButton *globResetWarningsButton;
    MAKitTextField *globEnableForceTouchTrackpadGesturesLabel;
...
- (void)click_globResetWarningsButton:(id)arg1;
