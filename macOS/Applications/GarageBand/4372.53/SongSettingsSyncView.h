...
@class MAKitButton, MAKitPopUpButton, MAKitSegmentedScrubber, MAKitTabView, MAKitTextField, NSButton, NSMatrix, NSPopUpButton, NSSlider, NSString, NSTextField;
...
@interface SongSettingsSyncView : ModuleController <MAIdleCallback, NSMenuDelegate>
{
    ...
    MAKitTextField *syncMidiClockStartMiddleLabel;
    MAKitSegmentedScrubber *syncMidiClockStartLength;
    MAKitTextField *syncMidiClockStartRightLabel;
