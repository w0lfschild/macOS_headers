...
@class MAKitButton, MAKitSegmentedControl, MANinePartImageSet, NSIndexSet, NSMutableArray, NSString, NSView, TrackImportData, TrackImportTableView;
...
- (void)dealloc;
- (id)initWithFrame:(struct CGRect)arg1 tiData:(id)arg2 sender:(id)arg3;
...
- (id)_LGMediaBrowserViewController;
