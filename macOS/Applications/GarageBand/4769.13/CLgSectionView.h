...
@class CLgView, NSImmediateActionGestureRecognizer, NSMutableArray, NSMutableDictionary, NSString, NSTrackingArea;

@interface CLgSectionView : MAView <MARulerAccessibility, CLgAccessibilityTree, LgSectionView, MAIdleCallback, NSMenuDelegate, NSImmediateActionGestureRecognizerDelegate, NSImmediateActionAnimationController, MALastClickedParameterHandler>
{
...
- (void)dragOperationAndHintsForFileDragUpdateWithSong:(struct CSong *)arg1 seqID:(int)arg2 dragOperation:(unsigned long long *)arg3 trackNr:(struct TPosOneBasedTrackNr *)arg4 hint1:(id *)arg5 hint2:(id *)arg6;
