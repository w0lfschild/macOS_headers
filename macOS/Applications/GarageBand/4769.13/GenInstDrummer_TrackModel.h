...
- (BOOL)isContentBeingDownloadedForGenreIdentifier:(id)arg1 andCharacterIdentifier:(id)arg2;
- (BOOL)defaultPatchWasDownloadedForGenreIdentifier:(id)arg1 andCharacterIdentifier:(id)arg2;
- (void)downloadDefaultPatchForGenreIdentifier:(id)arg1 andCharacterIdentifier:(id)arg2;
...
- (id)presetManager;
- (void)_internSetSelectedGenre:(id)arg1 andCharacterIdentifier:(id)arg2 options:(id)arg3;
- (void)setSelectedGenre:(id)arg1 andCharacterIdentifier:(id)arg2 options:(id)arg3;
...
- (void)initializeDrumTrackWithOptions:(id)arg1;
