...
- (BOOL)addMidiFile:(id)arg1 onTrackWithID:(CDStruct_3d4e291e)arg2 atClock:(long long)arg3 beatCount:(long long)arg4 key:(long long)arg5 isMidiFile:(BOOL)arg6 properties:(id)arg7 tracksMode:(int)arg8;
