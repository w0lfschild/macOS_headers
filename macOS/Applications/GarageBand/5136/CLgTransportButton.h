...
+ (id)transportBtnImageForID:(int)arg1 state:(long long)arg2 asPressed:(BOOL)arg3 backColumnIndex:(long long)arg4 asWide:(BOOL)arg5 enabled:(BOOL)arg6 showMenuIndicator:(BOOL)arg7 transportMetronomeButtonPhase:(long long)arg8 touchBar:(BOOL)arg9;
