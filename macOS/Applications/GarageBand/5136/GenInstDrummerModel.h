...
@class GenInstDrummerLibrary, GenInstDrummer_AsyncGeneratorJobManager, GenInstModelUICoordinator, NSMutableDictionary, NSObject<OS_dispatch_queue>;

@interface GenInstDrummerModel : NSObject
{
    NSObject<OS_dispatch_queue> *_generatorJobManagerDispatchQueue;
...
- (void)adjustSongTempoIfPossibleToNewDefaultTempo:(id)arg1 forTrackNr:(struct TTrackNr)arg2;
...
- (id)state;
- (BOOL)songHasOnlyOneDrummerTrackWithContentAndOnlyOtherEmptyTracksForChangeOnTrack:(struct TTrackNr)arg1;
...
- (void)setSelectedGenre:(id)arg1 characterIdentifier:(id)arg2 forDrummerTrackModel:(id)arg3 options:(id)arg4;
