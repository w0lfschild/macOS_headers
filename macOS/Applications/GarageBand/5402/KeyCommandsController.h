...
@class BefContainer, CommandsOutline, MASearchField, NSArray, NSButton, NSMenu, NSPopUpButton, NSSegmentedControl, NSString, NSTableView, NSTextField, NSView;
...
@property(readonly, retain, nonatomic) CommandsOutline *commands;
...
@property(readonly, nonatomic) short befehl;
@property(readonly, nonatomic) short befGruppe;
...
@property(readonly, nonatomic) const struct BEFEHL *selectedBefehl;
@property(readonly, retain, nonatomic) BefContainer *selectedBefContainer;
