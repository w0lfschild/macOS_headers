...
- (void).cxx_destruct;
@property(retain, nonatomic) NSTabView *tabView; // @synthesize tabView=m_tabView;
@property(retain, nonatomic) NSView *view; // @synthesize view=m_view;
...
- (void)configureAutoresizingMaskForView;
- (void)willDisappear;
- (void)willAppear;
