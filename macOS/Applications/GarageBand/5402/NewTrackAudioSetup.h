...
+ (long long)globalIndexOfOutputWithType:(int)arg1 withIndex:(int)arg2 withChannelMode:(int)arg3 inDocument:(struct CDocumentLogic *)arg4 audioDeviceSetup:(id)arg5 GetType:(short *)arg6 getLocalIndex:(int *)arg7;
+ (long long)globalIndexOfInputWithType:(int)arg1 withIndex:(int)arg2 withChannelMode:(int)arg3 inDocument:(struct CDocumentLogic *)arg4 audioDeviceSetup:(id)arg5 GetType:(short *)arg6 getLocalIndex:(int *)arg7;
