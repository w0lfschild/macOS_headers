...
@class MAKitPathControl, NSArrayController, NSBox, NSButton, NSPopUpButton, NSSlider, NSString, NSTabView, NSTextField, NSView, SegmentedNumberScrubber, SegmentedScrubber;

@interface PrefsAudioView : ModuleController <NSOpenSavePanelDelegate, NSMenuDelegate>
{
    NSTabView *auTabView;
    ...
    SegmentedNumberScrubber *auLLMMaxDelay;
    ...
    SegmentedNumberScrubber *auDimLevel;
    NSSlider *auCrossfadeTimeSlider;
    SegmentedNumberScrubber *auCrossfadeTime;
    NSSlider *auCrossfadeCurveSlider;
    SegmentedNumberScrubber *auCrossfadeCurve;
    ...
    SegmentedNumberScrubber *auCoreAudioRecordingDelayNum;
    ...
    NSTabView *auSamplerTabView;
    NSPopUpButton *auSampleStorage;
    NSPopUpButton *auSearchSamplesOn;
    NSPopUpButton *auReadRootKeyFrom;
    NSPopUpButton *auRootKeyAtFileNamePos;
    NSPopUpButton *auPreviousInstStatus;
    SegmentedScrubber *auPreviousInstVal;
    NSPopUpButton *auNextInstStatus;
    SegmentedScrubber *auNextInstVal;
    NSButton *auKeepCommonSamples;
    NSButton *auActive;
    NSPopUpButton *auDiskDriveSpeed;
    NSPopUpButton *auHarddiskRecordingActivity;
    NSButton *auApplyVirtualMemory;
    NSTextField *auRequiresConstantRAM;
    NSTextField *auDiskIOTraffic;
    NSTextField *auNotReadFromDiskInTime;
    ...
    SegmentedNumberScrubber *auNumberOfUndoStepsInSE;
...
- (void)click_auApplyVirtualMemory:(id)arg1;
- (void)change_auHarddiskRecordingActivity:(id)arg1;
- (void)change_auDiskDriveSpeed:(id)arg1;
- (void)click_auActive:(id)arg1;
- (void)click_auKeepCommonSamples:(id)arg1;
- (void)change_auNextInstVal:(id)arg1;
- (void)change_auNextInstStatus:(id)arg1;
- (void)change_auPreviousInstVal:(id)arg1;
- (void)change_auPreviousInstStatus:(id)arg1;
- (void)changeInstStatus:(id)arg1 withPref:(char *)arg2 val:(id)arg3;
- (void)change_auRootKeyAtFileNamePos:(id)arg1;
- (void)change_auReadRootKeyFrom:(id)arg1;
- (void)change_auSearchSamplesOn:(id)arg1;
- (void)change_auSampleStorage:(id)arg1;
...
- (void)updateSurrUI;
- (void)updateSEUI;
- (void)updateSamplerUI;
- (void)updateVirtualMemory;
- (void)updateVirtualMemoryBlink;
- (void)updateMisc;
...
- (void)setupDelegateForPopupButtonMenus;
