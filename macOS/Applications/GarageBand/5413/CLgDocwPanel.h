...
- (long long)docwType;
- (void)setDocwType:(long long)arg1;
...
- (void)dealloc;
- (id)initAsWindow:(BOOL)arg1 frameRect:(struct CGRect)arg2 isFloatWindow:(BOOL)arg3 hasBigTitlebar:(BOOL)arg4 hasCloseBox:(BOOL)arg5 isResizable:(BOOL)arg6 isMiniaturizable:(BOOL)arg7 isHud:(BOOL)arg8 isUtility:(BOOL)arg9 screen:(id)arg10 isOpeningScreenset:(BOOL)arg11;
