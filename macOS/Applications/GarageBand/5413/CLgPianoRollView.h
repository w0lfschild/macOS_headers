...
@class CLgPianoRollContentsView, CLgPianoRollKeyboardContentsView, MAScrollViewContentPositioner, NSString;
...
- (struct CGColor *)colorForValue:(int)arg1 eventSelected:(_Bool)arg2 eventMuted:(_Bool)arg3 shadow:(_Bool)arg4;
...
- (void)pianoRollViewDoEditTronAnchor:(id)arg1;
