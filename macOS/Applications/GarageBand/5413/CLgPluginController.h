...
@interface CLgPluginController : NSWindowController <LgPluginDataController, MAPluginWindowContentDataSource, LgPluginController, NSWindowDelegate, MAIdleCallback>
{
    ...
    shared_ptr_3015cb8d _pSettingsMenu;
    ...
    NSString *_sideChainMenuName;
    NSString *sideChainDefaultItemName;
...
+ (id)userDefaultStringForSettingFileName:(id)arg1;
+ (id)factoryDefaultStringForSettingFileName:(id)arg1;
- (id).cxx_construct;
- (void).cxx_destruct;
...
@property(retain, nonatomic) NSString *sideChainDefaultItemName; // @synthesize sideChainDefaultItemName;
@property(retain, nonatomic) NSString *sideChainMenuName; // @synthesize sideChainMenuName=_sideChainMenuName;
@property(retain, nonatomic) NSView *pluginEditorView; // @synthesize pluginEditorView=_pluginEditorView;
- (double)currentEditorDesignScaleFactor;
- (void)idle_checkBypassStateForPlugin:(struct AUDIOPLUGIN *)arg1;
- (void)updateBypassStateForPlugin:(struct AUDIOPLUGIN *)arg1;
...
- (void)checkAndUpdateDefaultScaleFactorsForAllPlugIns;
- (void)resetScaleFactorsForPlugIns:(id)arg1 toValue:(double)arg2 ifAlreadyIn:(id)arg3;
- (id)peerControllers;
- (void)setIsLinked_local:(BOOL)arg1;
- (id)getSideChainName:(struct AUDIOPLUGIN *)arg1;
- (struct SAUCONFPLUGIN *)getSongPlugInPointer:(struct AUDIOPLUGIN *)arg1;
- (id)editorArchiveClasses;
- (id)scaleFactorArchiveClasses;
...
- (void)handleEXSMenuChanging:(id)arg1;
