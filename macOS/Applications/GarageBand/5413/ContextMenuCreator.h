...
@interface ContextMenuCreator : NSObject <CLgPopupMenuHandler, NSMenuDelegate>
{
    ...
    unsigned long long m_createMenuType;
...
- (void)appendItems:(const struct TContextMenuItem *)arg1 options:(CFlagSet_880f38d3)arg2 toMenu:(id)arg3 inView:(id)arg4 menuType:(unsigned long long)arg5;
