...
- (int)setInputIndexAndAddRecovery:(long long)arg1;
- (BOOL)isStereo;
...
- (id)currentEQ;
- (id)currentNoisegate;
- (id)findFirstPluginWithID:(long long)arg1 isMidi:(BOOL)arg2 outSlotNumber:(long long *)arg3;
- (id)findFirstPluginWithID:(long long)arg1 isMidi:(BOOL)arg2;
...
- (id)getAudioUnitPlugInWithDescription:(struct AudioComponentDescription *)arg1 fromSlot:(long long)arg2 isMidiPlugin:(BOOL)arg3;
- (id)sortedAudioUnitPlugInsFromSlot:(long long)arg1 isMidiPlugin:(BOOL)arg2;
- (id)sortedMIDIPlugInsFromSlot:(long long)arg1 filterNotAllowListed:(BOOL)arg2;
