...
#import "MAMixerManaging-Protocol.h"

@class NSString;
@protocol MAMixerControllerDataSource, MixerModelControlling;

@interface GBMixerManager : NSObject <MAMixerManaging>
{
    struct CDocumentLogic *_document;
    id <MAMixerControllerDataSource> _dataSource;
    id <MixerModelControlling> _controller;
}

+ (id)managerWithDocument:(struct CDocumentLogic *)arg1;
- (void).cxx_destruct;
@property(retain) id <MixerModelControlling> controller; // @synthesize controller=_controller;
@property(retain) id <MAMixerControllerDataSource> dataSource; // @synthesize dataSource=_dataSource;
@property struct CDocumentLogic *document; // @synthesize document=_document;
