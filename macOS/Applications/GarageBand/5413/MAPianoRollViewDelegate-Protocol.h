...
@optional
- (void)pianoRollViewDoEditTronAnchor:(MAPianoRollView *)arg1;
...
- (void)pianoRollView:(MAPianoRollView *)arg1 moveSPLToClock:(long long)arg2 startPlayback:(BOOL)arg3;
...
- (float)pianoRollViewGetStartPositionOfTronLoop:(MAPianoRollView *)arg1;
