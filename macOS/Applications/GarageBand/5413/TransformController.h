...
@class CrossView, MAButton, MAKitBox, MAKitSegmentedScrubber, MATextField, MapView, NSButton, NSPopUpButton, NSString, NSTextField;
...
@interface TransformController : SmallScreensetDialogController <NSMenuDelegate>
{
    ...
    BOOL mNotifications;
    BOOL mLink;
    BOOL skipTransformParameterSetChosenWhenTextDidEndEditing;
}
...
- (void)deleteTransformSetChosen:(id)arg1;
