...
- (long long)webView:(WebView *)arg1 dragSourceActionMaskForPoint:(struct CGPoint)arg2;
...
- (long long)webView:(WebView *)arg1 dragDestinationActionMaskForDraggingInfo:(id <NSDraggingInfo>)arg2;
...
- (void)webView:(WebView *)arg1 mouseDidMoveOverElement:(NSDictionary *)arg2 modifierFlags:(long long)arg3;
