...
@class NSArray, NSPopUpButton, NSProgressIndicator, NSString, NSTableView, NSTextField, NSToolbar, NSToolbarItem, NSView, _TtC9HSTracker10Statistics, _TtC9HSTracker12DeckCellView, _TtC9HSTracker4Deck, _TtC9HSTracker4Game, _TtC9HSTracker7NewDeck, _TtC9HSTracker8EditDeck, _TtC9HSTracker9CurveView;
...
- (void)windowDidLoad;
@property(nonatomic) __weak _TtC9HSTracker4Game *game; // @synthesize game;
