...
@interface HOLocationTriggerEditorMapDragRadiusView : UIView
{
    ...
    BOOL _isMinimum;
    BOOL _isMaximum;
    id <HOLocationTriggerEditorMapDragRadiusViewDelegate> _delegate;
...
@property(nonatomic) id <HOLocationTriggerEditorMapDragRadiusViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (BOOL)usesMetric;
