...
#import "HUTriggerEditorDelegate-Protocol.h"

@class HODashboardNavigationButton, HOTriggerListItemManager, HUGridLayoutOptions, NSString;

@interface HOTriggerListViewController : HUItemTableViewController <HUAboutResidentDeviceViewControllerDelegate, HUTriggerEditorDelegate, HUColoredButtonCellDelegate, HOTriggerListSubheadlineCellDelegate>
{
