...
@class HOAppNavigator, HOBaseController, HOMainTabBarController, HOSideBarViewController, HUDashboardNavigationBar, NSMutableDictionary, NSString, UINavigationController;
@protocol HUDashboardNavigator;

@interface HOSplitViewController : UISplitViewController <HOSideBarDelegate, UIViewControllerTransitioningDelegate, _UISplitViewControllerSupplementedDelegate, HOBaseControllerDelegate, HUVendsDashboardNavigator>
{
