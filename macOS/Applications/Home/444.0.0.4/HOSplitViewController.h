...
@interface HOSplitViewController : UISplitViewController <HOSideBarDelegate, UIViewControllerTransitioningDelegate, HOBaseControllerDelegate, HUVendsDashboardNavigator, UISplitViewControllerDelegate>
{
