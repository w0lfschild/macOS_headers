...
#import "HOWelcomeDelegate-Protocol.h"
...
@interface HOMainTabBarController : UITabBarController <HFItemManagerDelegate, HFHomeManagerObserver, HOInitialSetupStateControllerDelegate, HFExecutionEnvironmentObserver, HFHomeObserver, HFHomeKitSettingsObserver, HOBaseControllerDelegate, HOWelcomeDelegate, HUPresentationDelegate, UITabBarControllerDelegate, HUVendsDashboardNavigator>
{
...
- (void)selectLearnTab:(id)arg1;
- (void)refreshAfterSidebarTabbarSwitch;
