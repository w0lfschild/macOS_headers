...
- (void).cxx_destruct;
@property(nonatomic) BOOL disableFollowFocus; // @synthesize disableFollowFocus=_disableFollowFocus;
...
- (void)loadWallpaper;
- (void)switchToTabIdentifier:(id)arg1;
