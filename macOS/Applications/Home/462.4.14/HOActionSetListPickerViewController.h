...
#import "HUSelectableGridActionSetListViewControllerDelegate-Protocol.h"
#import "UICollectionViewDelegateFlowLayout-Protocol.h"

@class HFMutableSetDiff, HUGridLayoutOptions, HURoomActionSetListItemManager, NSMutableDictionary, NSString;
@protocol HOOnboardingChildViewControllerDelegate, HOOnboardingChildViewControllerNavigationBarDelegate;

@interface HOActionSetListPickerViewController : HUServiceGridViewController <UICollectionViewDelegateFlowLayout, HUSelectableGridActionSetListViewControllerDelegate, HOOnboardingChildViewController>
{
...
@property(readonly, nonatomic) HURoomActionSetListItemManager *itemManager; // @dynamic itemManager;
