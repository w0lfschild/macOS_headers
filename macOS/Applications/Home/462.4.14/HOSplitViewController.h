...
#import "HODiscoverWebViewToolbarDelegate-Protocol.h"
...
@interface HOSplitViewController : UISplitViewController <UIViewControllerTransitioningDelegate, UISplitViewControllerDelegate, HOBaseControllerDelegate, HUVendsDashboardNavigator, HOSideBarDelegate, HOSideBarSelectionChangeDelegate, HOWelcomeDelegate, HODiscoverWebViewToolbarDelegate>
{
...
- (void)didSwitchDiscoverTabPosition:(unsigned long long)arg1;
- (void)didSwitchDiscoverTabStyle:(unsigned long long)arg1;
