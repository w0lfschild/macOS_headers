...
@class NSMenuItem, NSMutableArray, NSString, NSTimer, NSView, NSWindow, advancedController, defaultsController, sparkleDelegate, taskController;
...
- (void)callCompressionChecks:(id)arg1;
