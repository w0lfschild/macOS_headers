...
@class KIntegerTextField, NSButton, NSMenu, NSPanel, NSPopUpButton, NSSegmentedControl, NSStepper, NSString, NSTableView, NSTextField, NSTimer, NSView;

@interface defaultsController : NSWindowController <NSWindowDelegate, NSToolbarDelegate>
{
    id parentController;
    ...
    NSButton *_alwaysTarballCompression;
    ...
    NSButton *_trackExternalVolumesWithFinderExtension;
    ...
    NSSegmentedControl *_finderExtensionListControl;
    NSTableView *_finderExtensionList;
    NSButton *_finderExtensionAddVolumesFolder;
}

@property(retain, nonatomic) NSButton *finderExtensionAddVolumesFolder; // @synthesize finderExtensionAddVolumesFolder=_finderExtensionAddVolumesFolder;
@property(retain, nonatomic) NSTableView *finderExtensionList; // @synthesize finderExtensionList=_finderExtensionList;
@property(retain, nonatomic) NSSegmentedControl *finderExtensionListControl; // @synthesize finderExtensionListControl=_finderExtensionListControl;
...
@property(retain, nonatomic) NSButton *trackExternalVolumesWithFinderExtension; // @synthesize trackExternalVolumesWithFinderExtension=_trackExternalVolumesWithFinderExtension;
...
@property(retain, nonatomic) NSButton *alwaysTarballCompression; // @synthesize alwaysTarballCompression=_alwaysTarballCompression;
...
- (void)trackExternalVolumesWithFinderExtension:(id)arg1;
...
- (void)showFileAccessListItemOnFinder;
...
- (void)alwaysTarballCompression:(id)arg1;
...
- (void)defaultAppCallHelperToSetDefaults;
