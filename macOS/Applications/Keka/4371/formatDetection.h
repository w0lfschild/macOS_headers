...
+ (int)isWim:(id)arg1;
+ (int)isWim:(id)arg1 fromBytes:(const char *)arg2;
+ (int)isCab:(id)arg1;
...
+ (int)isLrzip:(id)arg1;
+ (int)isLrzip:(id)arg1 fromBytes:(const char *)arg2;
+ (int)isZstd:(id)arg1;
+ (int)isZstd:(id)arg1 fromBytes:(const char *)arg2;
+ (int)isLha:(id)arg1;
...
+ (BOOL)isTwoExtensionsTarball:(id)arg1;
+ (BOOL)isOneExtensionTarball:(id)arg1;
