...
@interface taskController : NSObject <NSOpenSavePanelDelegate>
{
    ...
    BOOL tryMoreExtractionBinaries;
    BOOL ready;
    BOOL started;
    BOOL finished;
    BOOL cancelled;
...
- (double)accentColorModifier;
- (id)progressBarHUEEffect:(double)arg1;
- (void)applyProgressBarHUEAccentColorChange;
- (void)setProgressBarHUEColor;
- (void)setProgressBarQueueEffect;
