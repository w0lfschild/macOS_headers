...
@interface GSSPCmdTextIndentParagraphLevel : GSSPCmdTextStorageAction <GSSPAutoDecodable>
{
    vector_c16d56c8 mRangeList;
    vector_e0f2bd7e mParagraphLevelList;
}
...
- (void)dealloc;
- (void)setParagraphLevelList:(const vector_e0f2bd7e *)arg1;
- (vector_e0f2bd7e *)paragraphLevelList;
