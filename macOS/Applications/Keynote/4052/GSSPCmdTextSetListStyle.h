...
@interface GSSPCmdTextSetListStyle : GSSPCmdTextStorageAction <GSSPAutoDecodable>
{
    vector_c16d56c8 mRangeList;
    vector_7fecde4e mListStyleList;
}
...
- (void)dealloc;
- (void)setListStyleList:(const vector_7fecde4e *)arg1;
- (vector_7fecde4e *)listStyleList;
