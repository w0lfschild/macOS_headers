...
@interface GSSPCmdTextSetParagraphFirstTopicNumber : GSSPCmdTextStorageAction <GSSPAutoDecodable>
{
    vector_c16d56c8 mRangeList;
    vector_e0f2bd7e mFirstTopicNumberList;
}
...
- (void)dealloc;
- (void)setFirstTopicNumberList:(const vector_e0f2bd7e *)arg1;
- (vector_e0f2bd7e *)firstTopicNumberList;
