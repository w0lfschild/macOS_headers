...
@interface GSSPCommentInfo : GSSPShapeInfo <GSSPAutoDecodable>
{
...
- (id)commentStorage;
- (id)convertTSWPCommentInfoWithDecodeContext:(struct GSSPDecodeConversionContext *)arg1 error:(id *)arg2;
