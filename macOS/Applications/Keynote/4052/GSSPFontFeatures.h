...
@interface GSSPFontFeatures : GSSPMessageBase
{
    NSArray *mFontFeatureTypeList;
    NSArray *mFontFeatureSelectorList;
}
...
- (void)dealloc;
- (void)setFontFeatureSelectorList:(id)arg1;
- (id)fontFeatureSelectorList;
- (void)setFontFeatureTypeList:(id)arg1;
- (id)fontFeatureTypeList;
