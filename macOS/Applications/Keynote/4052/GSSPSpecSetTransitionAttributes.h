...
#import "GSSPSpecTransitionAttributes.h"

#import "GSSPAutoDecodable-Protocol.h"

@class KNTransitionAttributes;

@interface GSSPSpecSetTransitionAttributes : GSSPSpecTransitionAttributes <GSSPAutoDecodable>
{
    KNTransitionAttributes *mTransitionAttributes;
    BOOL mUnset;
}
