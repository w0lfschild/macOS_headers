...
- (void)exportAccessibility:(id)arg1 animator:(id)arg2 session:(id)arg3;
- (id)p_accessibilityRegions:(id)arg1 session:(id)arg2;
- (void)exportHyperlinks:(id)arg1 slideID:(id)arg2 animator:(id)arg3 session:(id)arg4;
...
- (void)p_exportObjectHyperlink:(id)arg1 toArray:(id)arg2;
...
- (struct _NSRange)p_visibleTextRange:(id)arg1 animator:(id)arg2;
- (BOOL)p_repIsVisible:(id)arg1 animator:(id)arg2;
...
- (id)initWithSession:(id)arg1 effectExporter:(id)arg2 hyperlinkLimit:(unsigned long long)arg3;
- (void)dealloc;
