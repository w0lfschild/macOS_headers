...
@interface KNMacLightTableView : KNMacVerticalAutoscrollingView <KNMacSlideDragControllerDelegate, NSDraggingDestination>
{
    ...
    NSTimer *mMarqueeSelectionAutoscrollTimer;
    CALayer *mMarqueeLayer;
    struct CGRect mMarqueeRect;
    long long mMarqueeSelectionMode;
    unsigned long long mHitSlideIndex;
    BOOL mDraggingEntered;
    BOOL mDragDidNotOriginateInView;
    BOOL mSelectSlideOnMouseUp;
    unsigned long long mContextIndex;
    BOOL mViewWasTornDown;
    KNMacLightTableViewController *mViewController;
...
@property(retain, nonatomic) KNMacSlideContextMenuController *p_contextMenuController; // @synthesize p_contextMenuController=mContextMenuController;
@property(nonatomic) KNMacLightTableViewController *viewController; // @synthesize viewController=mViewController;
