...
@interface KNMacPlaybackPresentationWindowManager : NSObject <KNMacPlaybackHelpWindowControllerDelegate>
{
...
@property(readonly, nonatomic) KNMacPlaybackPresentationController *presentationController; // @synthesize presentationController=_presentationController;
...
- (id)p_newPlaybackWindowControllerWithScreen:(id)arg1;
