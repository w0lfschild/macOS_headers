...
{
    double mNavigatorLayerHeight;
    BOOL mIsObservingClipViewGeometry;
    id <KNMacPlaybackSlideNavigatorViewDelegate> _delegate;
}

@property(nonatomic) id <KNMacPlaybackSlideNavigatorViewDelegate> delegate; // @synthesize delegate=_delegate;
