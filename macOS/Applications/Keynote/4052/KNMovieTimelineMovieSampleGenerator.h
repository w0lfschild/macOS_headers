...
@class AVAssetReader, AVAssetReaderAudioMixOutput, KNMovieTimeline, KNMovieTimelineMovieSampleGeneratorAudioTrack, NSArray, NSError, NSSet;
...
@interface KNMovieTimelineMovieSampleGenerator : NSObject
{
    ...
    long long mCreateSampleGeneratorsOnceToken;
