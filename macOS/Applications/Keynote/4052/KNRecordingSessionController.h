...
@protocol KNLaserOverlayController, KNRecordingSessionControllerDelegate, KNTimebase;
...
@property(retain, nonatomic) struct __CFRunLoop *recordingStoppedWaitRunLoop; // @synthesize recordingStoppedWaitRunLoop=_recordingStoppedWaitRunLoop;
@property(retain, nonatomic) struct __CFRunLoopSource *recordingStoppedSignalSource; // @synthesize recordingStoppedSignalSource=_recordingStoppedSignalSource;
...
- (void)p_startRecordingIfAllowed;
...
- (void)stopRunning;
- (void)startRunningWithPlaybackController:(id)arg1 laserOverlayController:(id)arg2 thumbnailGenerator:(id)arg3 delegate:(id)arg4;
