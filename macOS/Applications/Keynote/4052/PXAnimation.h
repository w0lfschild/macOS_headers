...
+ (BOOL)readOptionalStringAttribute:(id)arg1 fromNode:(struct _xmlNode *)arg2 attributeMap:(struct attributeMapEntry *)arg3 attributeCount:(int)arg4 toPDDomValue:(unsigned long long *)arg5;
...
+ (void)writeCmdBehavior:(id)arg1 attributeName:(id)arg2 cmd:(id)arg3 state:(id)arg4;
...
+ (id)stringForBezierPath:(id)arg1;
...
+ (void)writeAttribute:(id)arg1 withPDDomValue:(int)arg2 attributeMap:(struct attributeMapEntry *)arg3 attributeCount:(int)arg4 toFile:(id)arg5;
