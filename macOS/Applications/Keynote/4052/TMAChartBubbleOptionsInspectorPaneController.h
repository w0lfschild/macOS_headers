...
@property(nonatomic) NSPopUpButton *representPopupButton; // @synthesize representPopupButton=mRepresentPopupButton;
@property(nonatomic) NSTextField *representLabel; // @synthesize representLabel=mRepresentLabel;
- (void)dealloc;
