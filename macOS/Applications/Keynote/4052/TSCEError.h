...
+ (void)raiseReferenceToEmptyCellErrorForFunctionName:(id)arg1 rangeReference:(CDStruct_fc93c73e)arg2;
...
+ (void)raiseInvalidRangeUsageErrorForReference:(CDStruct_fc93c73e)arg1;
...
+ (void)raiseIndirectErrorForRangeReference:(CDStruct_fc93c73e)arg1 hostTableID:(struct __CFUUID *)arg2 calculationEngine:(id)arg3;
+ (id)indirectErrorForRangeReference:(CDStruct_fc93c73e)arg1 hostTableID:(struct __CFUUID *)arg2 calculationEngine:(id)arg3;
...
+ (id)invalidMergeReference:(CDStruct_fc93c73e)arg1 contextEntityID:(struct __CFUUID *)arg2;
+ (void)raiseErrorForInvalidReference:(CDStruct_fc93c73e)arg1 orString:(id)arg2 contextEntityID:(struct __CFUUID *)arg3 invalidMergeReference:(BOOL)arg4 disqualifiedFromEndCell:(BOOL)arg5;
+ (void)raiseErrorForInvalidReference:(CDStruct_fc93c73e)arg1 orString:(id)arg2 contextEntityID:(struct __CFUUID *)arg3;
