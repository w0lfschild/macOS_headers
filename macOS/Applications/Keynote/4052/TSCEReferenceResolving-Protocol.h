...
- (NSString *)cellRangeName:(struct TSCERangeCoordinate)arg1 stickyBits:(unsigned char)arg2 isRangeWithFunction:(BOOL)arg3 quoteComponents:(BOOL)arg4 forceEscaping:(BOOL)arg5;
- (NSString *)tableName;
- (NSString *)sheetName;
