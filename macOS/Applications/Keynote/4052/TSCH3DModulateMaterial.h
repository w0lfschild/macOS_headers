...
@interface TSCH3DModulateMaterial : TSCH3DTexturesMaterial <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPChart3dModulateMaterial:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
