...
@interface TSCHChartNonStyle : TSCHBaseStyle <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPChartNonStyle:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
