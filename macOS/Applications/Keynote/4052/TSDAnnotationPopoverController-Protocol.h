...
@protocol TSDAnnotationPopoverController <NSObject>
...
@property(retain, nonatomic) id <TSDAnnotationHosting> annotation;
- (void)setPinned:(BOOL)arg1;
- (void)closePopover;
- (void)showPopoverForAnnotation:(id <TSDAnnotationHosting>)arg1 relativeToRect:(struct CGRect)arg2 ofCanvasView:(TSDCanvasView *)arg3 preferredEdge:(unsigned int)arg4 beginEditing:(BOOL)arg5 pinned:(BOOL)arg6;
