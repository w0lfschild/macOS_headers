...
@class CALayer, NSArray, NSFormatter, NSMutableArray, NSMutableSet, NSNumberFormatter, NSSet, NSString, TSDBackgroundLayoutAndRenderState, TSDCanvas, TSDCanvasAnimation, TSDCanvasLayer, TSDCanvasView, TSDContainerRep, TSDDynamicOperationController, TSDEditorController, TSDGestureDispatcher, TSDGuideController, TSDLayoutController, TSDMacGestureRuntime, TSDTileStorage, TSDTrackerManipulatorCoordinator, TSDUserDefinedGuideController, TSKAccessController, TSKChangeNotifier, TSKCollaborationDocumentSessionController, TSKCommandController, TSKDocumentRoot, TSKSelectionPath, TSKSelectionPathTransformer, TSPObjectContext, TSUPointerKeyDictionary;
@protocol TSDAnnotationHosting, TSDAnnotationPopoverController, TSDCanvasEditor, TSDCanvasLayerHosting, TSDInteractiveCanvasControllerCollaboratorCursorDelegate, TSDInteractiveCanvasControllerDelegate, TSDRulerController, TSKDocumentRootProvider;

@interface TSDInteractiveCanvasController : NSObject <TSDCollaboratorCursorHUDControllerDelegate, TSDCanvasDelegate, TSDErrorPresenter, TSKChangeSourceObserver, NSCoding, TSKScrollViewDelegate, TSDBackgroundLayoutAndRenderStateDelegate, TSDRepTrackerDelegateCreation, TSDTilingLayerDelegate>
{
...
@property(readonly, nonatomic) id <TSDAnnotationPopoverController> annotationPopoverController; // @synthesize annotationPopoverController=mAnnotationPopoverController;
...
@property(nonatomic) id <TSDInteractiveCanvasControllerCollaboratorCursorDelegate> collaboratorCursorDelegate; // @synthesize collaboratorCursorDelegate=mCollaboratorCursorDelegate;
...
- (void)p_setDisplayedAnnotation:(id)arg1;
- (BOOL)hasAnnotations;
...
- (void)toggleAnnotationVisibility:(id)arg1 selectionPath:(id)arg2 beginEditing:(BOOL)arg3 shouldSetSelection:(BOOL)arg4;
...
- (void)replaceDisplayedAnnotation:(id)arg1;
...
- (BOOL)annotationShouldShowUI:(id)arg1;
...
- (id)p_currentAnnotationAuthorInStorage;
...
- (struct CGRect)p_visibleBoundsRectUsingSizeOfEnclosingScrollView:(BOOL)arg1 respectObscuredFrame:(BOOL)arg2;
...
- (id)infosForCurrentSelectionPath;
