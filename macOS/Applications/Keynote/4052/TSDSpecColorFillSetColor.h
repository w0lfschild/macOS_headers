...
@interface TSDSpecColorFillSetColor : TSDSpecFill <GSSPAutoEncodable>
{
    TSUColor *_color;
}
...
- (void)deallocSOS;
- (void)populateGSSPSpecColorFillSetColor:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
