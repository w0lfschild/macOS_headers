...
@interface TSDSpecFrameSetAssetScale : TSDSpecStroke <GSSPAutoEncodable>
{
    double _assetScale;
}
...
- (void)deallocSOS;
- (void)populateGSSPSpecFrameSetAssetScale:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
