...
@class NSError, NSMapTable, NSMutableArray, NSMutableSet, NSObject, NSSet, NSString, NSURL, NSUUID, TSPDocumentResourceDataProvider, TSPDocumentRevision, TSPFinalizeHandlerQueue, TSPObject, TSPObjectContainer, TSPObjectContext, TSPPackage, TSPPackageMetadata, TSPPersistedObjectUUIDMap;
...
@interface TSPPackageReadCoordinator : TSPReadCoordinatorBase <TSPPersistedObjectUUIDMapDelegate, TSPReadCoordinator>
{
    ...
    unordered_map_88cdf798 _readIdentifiers;
    NSMutableArray *_componentsToUpgrade;
    NSObject<OS_dispatch_queue> *_objectQueue;
    NSMapTable *_objects;
    unordered_map_88cdf798 _readExternalObjects;
