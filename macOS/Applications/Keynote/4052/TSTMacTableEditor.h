...
@class NSDocument, NSString, TSTCellInspectorPropertyVendor, TSTMacTableTouchBarProvider;

@interface TSTMacTableEditor : TSTTableEditor <TSDMacTouchBarAwareEditor, TSTMacTableTouchBarProviderDelegate, NSMenuDelegate>
{
...
- (unsigned long long)p_countCustomFilterMenuItemsForColumn:(unsigned char)arg1 filterIndices:(id)arg2 quickFilterItems:(id)arg3;
...
- (BOOL)p_canAddFilterRules:(unsigned long long)arg1;
- (id)p_sortedQuickFilterItemsInCellRegion:(id)arg1 includingHiddenCells:(BOOL)arg2;
...
- (id)p_selectionForEditorAction:(SEL)arg1;
