...
@interface TSTMultiTableRemapper : TSKSosBase <GSSPAutoEncodable, TSKMultiTableRemapping>
{
    ...
    UUIDMap_8a451d2c _chartToBackingTable;
    ...
    UUIDMap_8a451d2c _combinedTableUidMap;
...
- (struct __CFUUID *)backingTableIdForChart:(struct __CFUUID *)arg1;
- (UUIDData_5fbc143e)mapOwnerUID:(const UUIDData_5fbc143e *)arg1;
- (struct __CFUUID *)mapOwnerID:(struct __CFUUID *)arg1;
- (id)ownerWrapperIdMap;
- (const UUIDMap_8a451d2c *)combinedTableUidMap;
