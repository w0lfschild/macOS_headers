...
@protocol TSDAnnotationHosting, TSWPLayoutTarget;
...
@interface TSWPRep : TSDContainerRep <CAAnimationDelegate, TSKHighlightArrayControllerProtocol, TSKPulseAnimationControllerProtocol, TSWPHyperlinkHostRepProtocol, TSDDecorator, CALayerDelegate>
{
    ...
    BOOL _tornDown;
    id <TSDAnnotationHosting> _previousHoveredAnnotation;
    NSTimer *_caretTimer;
...
- (struct CGPoint)p_unscaledPointForChangeEntry:(id)arg1;
- (struct CGPoint)p_unscaledPointForCommentEntry:(id)arg1;
- (id)p_commentKnobForActivityLogEntry:(id)arg1;
