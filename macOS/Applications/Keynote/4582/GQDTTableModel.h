...
- (void)p_writeTableGridLinesWithLayout:(id)arg1 tableModel:(id)arg2 exporter:(id)arg3;
- (void)p_writeColumnGridStyles:(id)arg1 tableModel:(id)arg2 exporter:(id)arg3;
- (void)p_writeRowGridStyles:(id)arg1 tableModel:(id)arg2 exporter:(id)arg3;
- (id)p_newGridStyleWithVectorType:(int)arg1 start:(int)arg2 stop:(int)arg3 tableModel:(id)arg4 stroke:(id)arg5 exporter:(id)arg6;
- (void)p_freeBaseVectorStyles;
- (id)p_baseExportStyleForVectorType:(int)arg1;
- (void)p_setupBaseVectorStyles:(id)arg1 tableModel:(id)arg2;
- (int)p_exportRowVectorTypeForColumnIndex:(int)arg1 tableModel:(id)arg2 rowIndex:(int)arg3;
- (int)p_exportColumnVectorTypeForRowIndex:(int)arg1 tableModel:(id)arg2 colIndex:(int)arg3;
- (id)p_newSingleExportCell:(id)arg1 withStyle:(id)arg2 needsNewStyle:(BOOL)arg3 tableModel:(id)arg4 cellID:(struct TSUCellCoord)arg5 styleName:(id)arg6 exporter:(id)arg7;
