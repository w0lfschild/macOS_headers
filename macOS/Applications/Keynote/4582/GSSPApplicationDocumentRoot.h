...
#import "GSSPDocumentRoot.h"

@class GSSPLocalizedStrings, TSKCustomFormatList;

@interface GSSPApplicationDocumentRoot : GSSPDocumentRoot
{
    GSSPLocalizedStrings *mLocalizedStrings;
    TSKCustomFormatList *mCustomFormatList;
}
