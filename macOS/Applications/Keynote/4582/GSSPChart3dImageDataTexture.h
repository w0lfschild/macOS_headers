...
#import "GSSPChart3dTexture.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPImageData;

@interface GSSPChart3dImageDataTexture : GSSPChart3dTexture <GSSPAutoDecodable>
{
    GSSPImageData *mData;
    GSSPImageData *mMipmapData;
    BOOL mDefinedData;
    BOOL mDefinedMipmapData;
}
...
@property(readonly, nonatomic) BOOL definedMipmapData; // @synthesize definedMipmapData=mDefinedMipmapData;
...
- (void)dealloc;
- (BOOL)clearMipmapData;
- (BOOL)clearData;
- (void)setMipmapData:(id)arg1;
- (id)mipmapData;
