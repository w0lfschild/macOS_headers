...
@class TSCHNumberFormat, TSUFormatObject;

@interface GSSPChartMediatorAxisFormat : GSSPMessageBase
{
    TSCHNumberFormat *mNumberFormat;
    TSUFormatObject *mFormatObject;
    BOOL mDefinedNumberFormat;
    BOOL mDefinedFormatObject;
}

+ (Class)realClass;
+ (void)registerRealGsspClass:(Class)arg1;
@property(readonly, nonatomic) BOOL definedFormatObject; // @synthesize definedFormatObject=mDefinedFormatObject;
...
- (void)dealloc;
- (BOOL)clearFormatObject;
- (BOOL)clearNumberFormat;
- (void)setFormatObject:(id)arg1;
- (id)formatObject;
