...
@interface GSSPScmpCommandResponsePayload : GSSPMessageBase <GSSPAutoDecodable>
{
    vector_5ab6e457 mResponseList;
}
...
- (void)dealloc;
- (void)setResponseList:(const vector_5ab6e457 *)arg1;
- (vector_5ab6e457 *)responseList;
