...
#import "GSSPSpecChartsOptionalDoubleArchive.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPChartsOptionalDoubleArchive;

@interface GSSPSpecSetChartsOptionalDoubleArchive : GSSPSpecChartsOptionalDoubleArchive <GSSPAutoDecodable>
{
    GSSPChartsOptionalDoubleArchive *mChartsOptionalDoubleArchive;
    BOOL mUnset;
}
...
- (BOOL)unset;
- (void)setChartsOptionalDoubleArchive:(id)arg1;
- (id)chartsOptionalDoubleArchive;
