...
#import "GSSPPresetForTheme.h"

@class TSTTableStylePreset;

@interface GSSPTableStylePresetForTheme : GSSPPresetForTheme
{
    TSTTableStylePreset *mTableStylePresetForTables;
}
...
- (void)dealloc;
- (void)setTableStylePresetForTables:(id)arg1;
- (id)tableStylePresetForTables;
