...
{
    NSTextField *mMainTitleField;
    NSTextField *mRightFieldLabel;
    NSTextField *mLeftFieldLabel;
    KNMacEffectStepperTextEntryFieldViewController *mRightStepperController;
    KNMacEffectStepperTextEntryFieldViewController *mLeftStepperController;
}
