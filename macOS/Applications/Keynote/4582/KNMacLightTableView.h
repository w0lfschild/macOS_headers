...
@class CALayer, KNLightTableLayer, KNMacLightTableViewController, KNMacSlideContextMenuController, KNMacSlideDragController, NSString, NSTimer;
...
- (BOOL)isFlipped;
@property(readonly, nonatomic) KNLightTableLayer *lightTableLayer;
- (void)dealloc;
- (void)teardown;
