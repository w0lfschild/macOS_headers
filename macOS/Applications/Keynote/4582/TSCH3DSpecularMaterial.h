...
@interface TSCH3DSpecularMaterial : TSCH3DTexturesMaterial <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPChart3dSpecularMaterial:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
