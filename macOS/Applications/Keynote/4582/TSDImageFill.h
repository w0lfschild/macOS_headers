...
+ (id)presetKinds;
+ (void)p_makeCompatibleImageDataForFill:(BOOL)arg1 fromURL:(id)arg2 withContext:(id)arg3 modalOperationPresenter:(id)arg4 compatibilityAlertPresenter:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
