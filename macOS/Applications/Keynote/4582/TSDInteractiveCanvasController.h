...
@protocol TSDAnnotation, TSDAnnotationViewController, TSDCanvasEditor, TSDCanvasLayerHosting, TSDCanvasProxyDelegate, TSDInteractiveCanvasControllerCollaboratorCursorDelegate, TSDInteractiveCanvasControllerDelegate, TSDMutableContainerInfo, TSDRulerController, TSKDocumentRootProvider;
...
@interface TSDInteractiveCanvasController : NSObject <TSDDynamicCanvasDelegate, TSDCanvasProxyDelegate, TSDCollaboratorCursorHUDControllerDelegate, TSDCanvasDelegate, TSDErrorPresenter, TSKChangeSourceObserver, TSKScrollViewDelegate, TSDBackgroundLayoutAndRenderStateDelegate, TSDRepTrackerDelegateCreation, TSDTilingLayerDelegate>
{
    ...
    TSUPointerKeyDictionary *mRepLayersByRep;
    TSUPointerKeyDictionary *mRepsByRepLayer;
    NSObject<TSDCanvasEditor> *mCanvasEditor;
    BOOL mHasBeenTornDown;
    TSDCanvas *mCanvas;
    id <TSDCanvasLayerHosting> mLayerHost;
    id mObservedDocumentRoot;
    TSUPointerKeyDictionary *mContainerLayersByRep;
    TSUPointerKeyDictionary *mRepsByContainerLayer;
    ...
    id <TSDAnnotation> mDisplayedAnnotation;
...
@property(readonly, nonatomic) id <TSDAnnotationViewController> annotationViewController; // @synthesize annotationViewController=mAnnotationViewController;
