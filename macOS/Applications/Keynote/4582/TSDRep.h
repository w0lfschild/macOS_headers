...
@class CALayer, CAShapeLayer, NSArray, NSDictionary, NSString, TSDCanvas, TSDCanvasMessageHUDController, TSDInteractiveCanvasController, TSDKnobTracker, TSDLayout, TSDLayoutGeometry, TSDTextureContext, TSDTextureSet, TSDTilingBackgroundQueue, TSUColor, TSUOnce;
