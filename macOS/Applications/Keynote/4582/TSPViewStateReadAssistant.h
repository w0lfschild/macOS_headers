...
@class NSDictionary, NSString, NSUUID, TSPComponent, TSPObjectContext;

@interface TSPViewStateReadAssistant : NSObject <TSPDecoderReadCoordinatorDelegate>
{
    TSPObjectContext *_context;
    NSUUID *_documentVersionUUID;
    BOOL _needsDocumentVersionUUID;
    BOOL _hasDocumentVersionUUID;
...
- (id)decodeViewStateObjectWithData:(id)arg1 validator:(id)arg2;
- (id)init;
- (id)initWithContext:(id)arg1 needsDocumentVersionUUID:(BOOL)arg2;
