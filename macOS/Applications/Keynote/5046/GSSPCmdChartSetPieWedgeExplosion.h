...
@interface GSSPCmdChartSetPieWedgeExplosion : GSSPCmdChartBaseWithChartInfoId <GSSPAutoDecodable>
{
    NSArray *mSeriesIndices;
    NSArray *mWedgeExplosions;
}
...
- (void)dealloc;
- (void)setWedgeExplosions:(id)arg1;
- (id)wedgeExplosions;
- (void)setSeriesIndices:(id)arg1;
- (id)seriesIndices;
