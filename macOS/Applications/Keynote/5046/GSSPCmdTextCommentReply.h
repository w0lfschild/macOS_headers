...
@interface GSSPCmdTextCommentReply : GSSPCmdBase <GSSPAutoDecodable>
{
    NSString *mTextStorageUUIDPath;
    NSString *mAnnotationUUID;
    TSDCommentStorage *mForwardCommentStorage;
...
- (void)setForwardCommentStorage:(id)arg1;
- (id)forwardCommentStorage;
- (void)setAnnotationUUID:(id)arg1;
- (id)annotationUUID;
- (void)setTextStorageUUIDPath:(id)arg1;
- (id)textStorageUUIDPath;
