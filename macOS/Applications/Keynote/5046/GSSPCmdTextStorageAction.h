...
@class GSSPStorageTransaction, NSString;

@interface GSSPCmdTextStorageAction : GSSPCmdBase <GSSPAutoDecodable>
{
    int mCommandKind;
    NSString *mTextStorageIdPath;
    GSSPStorageTransaction *mStorageTransaction;
}
...
- (void)dealloc;
- (void)setStorageTransaction:(id)arg1;
- (id)storageTransaction;
- (void)setTextStorageIdPath:(id)arg1;
- (id)textStorageIdPath;
- (void)setCommandKind:(int)arg1;
- (int)commandKind;
