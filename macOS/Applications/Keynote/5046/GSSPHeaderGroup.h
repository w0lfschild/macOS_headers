...
@interface GSSPHeaderGroup : GSSPSosBase <GSSPAutoDecodable>
{
    ...
    vector_dadc1b26 mIdList;
    vector_e0a4097b mHeaderInfoList;
}
...
- (void)dealloc;
- (void)setHeaderInfoList:(const vector_e0a4097b *)arg1;
- (vector_e0a4097b *)headerInfoList;
- (void)setIdList:(const vector_dadc1b26 *)arg1;
- (vector_dadc1b26 *)idList;
