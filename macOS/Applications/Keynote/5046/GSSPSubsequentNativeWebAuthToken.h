...
@interface GSSPSubsequentNativeWebAuthToken : GSSPMessageBase
{
    NSString *mEncryptedDsId;
    NSString *mGilliganToken;
...
- (id)containerId;
- (void)setGilliganToken:(id)arg1;
- (id)gilliganToken;
- (void)setEncryptedDsId:(id)arg1;
- (id)encryptedDsId;
