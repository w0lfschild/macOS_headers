...
@interface GSSPTableStrokePresetList : GSSPMessageBase <GSSPAutoDecodable>
{
    vector_d7cbf4a5 mPresetList;
}
...
- (void)dealloc;
- (void)setPresetList:(const vector_d7cbf4a5 *)arg1;
- (vector_d7cbf4a5 *)presetList;
