...
- (void)p_addAnimationForLayer:(id)arg1 duration:(double)arg2 fromAngle:(double)arg3 toAngle:(double)arg4 acceleration:(id)arg5 toAnimations:(id)arg6 customAccelerationCurve:(id)arg7;
