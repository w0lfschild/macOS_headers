...
+ (id)tsuImageFromDrawableInfo:(id)arg1 imageBounds:(struct CGRect *)arg2 layoutGeometry:(id *)arg3 maskPathOrigin:(struct CGPoint *)arg4 isStrokeOnly:(BOOL)arg5 hasAlpha:(char *)arg6;
