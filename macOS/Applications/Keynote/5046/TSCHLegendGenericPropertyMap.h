...
@interface TSCHLegendGenericPropertyMap : TSSPropertyMap <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPLegendGenericPropertyMap:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
