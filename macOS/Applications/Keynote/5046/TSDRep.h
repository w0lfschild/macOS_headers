...
@class CALayer, CAShapeLayer, NSArray, NSDictionary, NSString, TSDCanvas, TSDCanvasMessageHUDController, TSDInteractiveCanvasController, TSDKnobTracker, TSDLayout, TSDLayoutGeometry, TSDTilingBackgroundQueue, TSUColor, TSUOnce;
