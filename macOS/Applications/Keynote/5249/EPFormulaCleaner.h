...
@class EDFormula, EDName, EDRowBlocks, EDSheet, TSUIntDictionary, TSUPointerKeyDictionary;
...
@interface EPFormulaCleaner : EDProcessor
{
    ...
    TSUIntDictionary *mNameArrayedTestCache;
    TSUIntDictionary *mNameCircularReferenceTestCache;
