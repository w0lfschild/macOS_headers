...
- (id)initWithPath:(id)arg1 pathToBundle:(id)arg2 indexFileName:(id)arg3 outputType:(int)arg4 outputPath:(struct __CFString *)arg5 previewRequest:(struct __QLPreviewRequest *)arg6 generator:(Class)arg7 cryptoKey:(id)arg8;
