...
@interface GSSPAbstractSlide : GSSPPersistableObject
{
    ...
    vector_a093891c mPlaceholdersForTagsTagList;
    vector_a093891c mPlaceholdersForTagsPlaceholderIdList;
}
...
- (void)dealloc;
- (void)setPlaceholdersForTagsPlaceholderIdList:(const vector_a093891c *)arg1;
- (vector_a093891c *)placeholdersForTagsPlaceholderIdList;
- (void)setPlaceholdersForTagsTagList:(const vector_a093891c *)arg1;
- (vector_a093891c *)placeholdersForTagsTagList;
