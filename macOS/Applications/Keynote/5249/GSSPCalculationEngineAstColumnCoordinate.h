...
@interface GSSPCalculationEngineAstColumnCoordinate : GSSPMessageBase
{
    int mColumn;
    BOOL mAbsolute;
    BOOL mDefinedAbsolute;
}

+ (Class)realClass;
+ (void)registerRealGsspClass:(Class)arg1;
@property(readonly, nonatomic) BOOL definedAbsolute; // @synthesize definedAbsolute=mDefinedAbsolute;
- (id)description;
- (id)dspClassName;
