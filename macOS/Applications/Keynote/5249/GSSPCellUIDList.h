...
{
    vector_dadc1b26 mRowUIDList;
    vector_dadc1b26 mColumnUIDList;
    vector_e0f2bd7e mRowUIDIndexList;
    vector_e0f2bd7e mColumnUIDIndexList;
}
...
- (void)dealloc;
- (void)setColumnUIDIndexList:(const vector_e0f2bd7e *)arg1;
- (vector_e0f2bd7e *)columnUIDIndexList;
- (void)setRowUIDIndexList:(const vector_e0f2bd7e *)arg1;
- (vector_e0f2bd7e *)rowUIDIndexList;
- (void)setColumnUIDList:(const vector_dadc1b26 *)arg1;
- (vector_dadc1b26 *)columnUIDList;
- (void)setRowUIDList:(const vector_dadc1b26 *)arg1;
- (vector_dadc1b26 *)rowUIDList;
