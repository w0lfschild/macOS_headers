...
{
    vector_e0f2bd7e mLocalSeriesIndexes;
    vector_e0f2bd7e mRemoteSeriesIndexes;
    BOOL mAllAreSame;
...
- (BOOL)allAreSame;
- (void)setRemoteSeriesIndexes:(const vector_e0f2bd7e *)arg1;
- (vector_e0f2bd7e *)remoteSeriesIndexes;
- (void)setLocalSeriesIndexes:(const vector_e0f2bd7e *)arg1;
- (vector_e0f2bd7e *)localSeriesIndexes;
