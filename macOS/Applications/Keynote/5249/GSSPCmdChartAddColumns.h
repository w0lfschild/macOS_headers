...
@interface GSSPCmdChartAddColumns : GSSPCmdChartBaseWithChartInfoId <GSSPAutoDecodable>
{
    NSArray *mColumnIdList;
    NSArray *mColumnNameList;
    NSUUID *mColumnId;
    BOOL mDefinedColumnId;
}
...
@property(readonly, nonatomic) BOOL definedColumnId; // @synthesize definedColumnId=mDefinedColumnId;
- (id)description;
- (id)dspClassName;
