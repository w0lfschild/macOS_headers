...
@interface GSSPCmdDrawableHyperlink : GSSPCmdDrawableBaseWithDrawableInfoId <GSSPAutoDecodable>
{
    NSString *mNewURL;
    BOOL mDefinedNewURL;
}
...
@property(readonly, nonatomic) BOOL definedNewURL; // @synthesize definedNewURL=mDefinedNewURL;
- (id)description;
- (id)dspClassName;
