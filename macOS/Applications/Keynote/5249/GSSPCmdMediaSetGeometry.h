...
@interface GSSPCmdMediaSetGeometry : GSSPCmdDrawableSetGeometry <GSSPAutoDecodable>
{
    GSSPSize *mMediaInfoOriginalSize;
}
...
- (void)dealloc;
- (void)setMediaInfoOriginalSize:(id)arg1;
- (id)mediaInfoOriginalSize;
