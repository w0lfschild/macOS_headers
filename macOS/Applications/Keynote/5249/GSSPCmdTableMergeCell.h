...
@class GSSPCellUID, TSTCellMap, TSTCellUIDList;

@interface GSSPCmdTableMergeCell : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    TSTCellUIDList *mCellUIDList;
    TSTCellMap *mCommitCellMap;
    GSSPCellUID *mMergeSource;
}
...
- (void)dealloc;
- (void)setMergeSource:(id)arg1;
- (id)mergeSource;
- (void)setCommitCellMap:(id)arg1;
- (id)commitCellMap;
