...
@class KNBodyPlaceholderInfo, KNObjectPlaceholderInfo, KNSlideBackgroundInfo, KNSlideNode, KNSlideNumberPlaceholderInfo, KNSlideStyle, KNTitlePlaceholderInfo, KNTransition, NSArray, NSDictionary, NSMutableArray, NSObject, NSOrderedSet, NSSet, NSString, TSDFill, TSDGuideStorage, TSDInfoGeometry, TSUMutablePointerSet, TSUPointerKeyDictionary;
@protocol TSDContainerInfo, TSDOwningAttachment;

@interface KNAbstractSlide : TSPObject <GSSPAutoEncodable, TSSPropertySource, TSKDocumentObject, TSDDrawableContainerInfo, TSDMutableContainerInfo, TSKTransformableObject, TSSStyleClient, TSDReplaceableMediaContainer, TSDReducibleImageContainer, TSDCompatibilityAwareMediaContainer>
{
    KNSlideStyle *_style;
