...
@class NSBox, NSButton, NSLayoutConstraint, NSPopUpButton, NSTextField, NSView, TSKSharingState;
...
@interface TMACloudSharingOptionsViewController : NSViewController
{
    ...
    NSButton *_thirdPartyShareOptionsButton;
}

@property NSButton *thirdPartyShareOptionsButton; // @synthesize thirdPartyShareOptionsButton=_thirdPartyShareOptionsButton;
...
@property(retain, nonatomic) TSKSharingState *sharingState; // @synthesize sharingState=_sharingState;
@property(nonatomic) id <TMACloudSharingOptionsViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)thirdPartyShareOptionsClicked:(id)arg1;
