...
@class NSDictionary, NSString, TSCHChartAxisID, TSCHChartDrawableInfo, TSCHChartEditorTouchBarProvider, TSCHChartModel, TSCHChartType, TSCHTextEditing, TSDLayout;
...
- (id)selectionPathForTapToTextEditForInfo:(id)arg1 withInfoSelectionPath:(id)arg2;
