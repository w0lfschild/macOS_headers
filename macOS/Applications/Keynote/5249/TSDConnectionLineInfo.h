...
@interface TSDConnectionLineInfo : TSDShapeInfo <GSSPAutoEncodable>
{
    ...
    BOOL mShouldWriteConnectedReferencesForCopies;
}

+ (void)p_scanBrandNewInfosAndFixConnectionLineUUIDs:(id)arg1 deepCopyMap:(id)arg2;
+ (void)ensureThatConnectionLinesPreserveConnectedReferences:(id)arg1;
+ (id)p_drawablesToCheckForConnectionLinesFromDrawables:(id)arg1;
+ (void)fixupUUIDsAndGeometriesFromOriginalDrawables:(id)arg1 withDeepCopyMap:(id)arg2;
...
@property(nonatomic) BOOL shouldWriteConnectedReferencesForCopies; // @synthesize shouldWriteConnectedReferencesForCopies=mShouldWriteConnectedReferencesForCopies;
...
- (BOOL)shouldSaveConnectedInfoReference:(id)arg1;
