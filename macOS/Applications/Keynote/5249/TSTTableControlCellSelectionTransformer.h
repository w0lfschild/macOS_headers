...
@interface TSTTableControlCellSelectionTransformer : TSTTableSubSelectionTransformerBase
{
    BOOL _keyboardShown;
...
@property(nonatomic) BOOL keyboardShown; // @synthesize keyboardShown=_keyboardShown;
...
- (id)initWithTableInfo:(id)arg1 cellUID:(const struct TSTCellUID *)arg2 keyboardShown:(BOOL)arg3;
