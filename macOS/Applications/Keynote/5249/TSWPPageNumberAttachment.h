...
@interface TSWPPageNumberAttachment : TSWPNumberAttachment <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPPageNumberAttachment:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
