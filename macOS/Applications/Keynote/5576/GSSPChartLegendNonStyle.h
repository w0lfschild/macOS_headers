...
@class GSSPChartLegendNonStyleProperties;

@interface GSSPChartLegendNonStyle : GSSPStyle <GSSPAutoDecodable>
{
    GSSPChartLegendNonStyleProperties *mOverridePropertyMap;
}
