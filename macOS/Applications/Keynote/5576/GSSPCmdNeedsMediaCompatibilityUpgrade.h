...
@interface GSSPCmdNeedsMediaCompatibilityUpgrade : GSSPCmdBase <GSSPAutoDecodable>
{
    BOOL mNeedsMediaCompatibilityUpgrade;
    BOOL mCollaborativeMediaCompatibilityUpgradeDidFail;
    BOOL mCanUseHEVC;
    BOOL mDefinedCanUseHEVC;
}
...
@property(readonly, nonatomic) BOOL definedCanUseHEVC; // @synthesize definedCanUseHEVC=mDefinedCanUseHEVC;
- (id)description;
- (id)dspClassName;
