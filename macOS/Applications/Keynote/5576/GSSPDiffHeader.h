...
@interface GSSPDiffHeader : GSSPMessageBase <GSSPAutoDecodable>
{
    ...
    vector_0e55654f mImageDigestDataList;
    vector_0466cb48 mMovieDigestDataList;
    NSArray *mAuthorList;
}
...
- (id)authorList;
- (void)setMovieDigestDataList:(const vector_0466cb48 *)arg1;
- (vector_0466cb48 *)movieDigestDataList;
- (void)setImageDigestDataList:(const vector_0e55654f *)arg1;
- (vector_0e55654f *)imageDigestDataList;
