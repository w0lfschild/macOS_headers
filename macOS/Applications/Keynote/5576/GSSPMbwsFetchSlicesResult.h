...
@class TSKSecret, TSPDocumentRevision;

@interface GSSPMbwsFetchSlicesResult : GSSPMessageBase
{
...
@property(readonly, nonatomic) BOOL definedSecret; // @synthesize definedSecret=mDefinedSecret;
- (void).cxx_destruct;
- (id)description;
- (id)dspClassName;
