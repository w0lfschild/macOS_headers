...
@interface KNActionJiggle : KNAnimationEffect <KNActionEffectBuildAnimator, KNBuildCAAnimator, KNBuildOpenGLAnimator>
{
...
- (void)p_addAnimationsToLayer:(id)arg1 duration:(double)arg2 attributes:(id)arg3 useKeyFrames:(BOOL)arg4 result:(id)arg5;
