...
@class KNAnimParameterGroup, NSArray, NSMapTable, NSMutableArray, NSString, TSDGLFrameBuffer, TSDGLMotionBlurEffect, TSDGLShader, TSDTexturedRectangle, TSUBezierPath;
@protocol TSDGLDataBuffer;

@interface KNBuildLineDraw : KNAnimationEffect <KNBuildOpenGLAnimator, KNAnimationPluginArchiving>
{
...
- (void)drawObjectTexture:(id)arg1 dataBuffer:(id)arg2 percent:(double)arg3;
