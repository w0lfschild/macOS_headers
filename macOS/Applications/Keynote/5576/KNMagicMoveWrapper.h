...
@interface KNMagicMoveWrapper : NSObject
{
    ...
    id <MTLRenderPipelineState> _blendingPipelineState;
    id <MTLRenderPipelineState> _defaultMotionBlurPipelineState;
    id <MTLRenderPipelineState> _blendingMotionBlurPipelineState;
