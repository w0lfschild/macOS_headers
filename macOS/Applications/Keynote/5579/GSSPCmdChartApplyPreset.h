...
@interface GSSPCmdChartApplyPreset : GSSPCmdChartBaseWithChartInfoId <GSSPAutoDecodable>
{
...
- (int)behavior;
- (void)setStyleSwapTuples:(id)arg1;
- (id)styleSwapTuples;
- (void)setShouldApplySwapTuples:(BOOL)arg1;
- (BOOL)shouldApplySwapTuples;
- (void)setOldPreset:(id)arg1;
- (id)oldPreset;
