...
#import "GSSPCmdAbstractGuide.h"

#import "GSSPAutoDecodable-Protocol.h"

@class NSString;

@interface GSSPCmdGuide : GSSPCmdAbstractGuide <GSSPAutoDecodable>
{
    NSString *mGuideStorageIdPath;
}
...
- (void)setGuideStorageIdPath:(id)arg1;
- (id)guideStorageIdPath;
