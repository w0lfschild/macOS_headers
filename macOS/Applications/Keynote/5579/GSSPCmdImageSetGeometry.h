...
@class GSSPSize, TSDInfoGeometry, TSDPathSource;

@interface GSSPCmdImageSetGeometry : GSSPCmdDrawableBaseWithDrawableInfoId <GSSPAutoDecodable>
{
    TSDInfoGeometry *mImageInfoGeometry;
    GSSPSize *mImageInfoOriginalSize;
    TSDInfoGeometry *mMaskInfoGeometry;
    TSDPathSource *mMaskPathSource;
}
...
- (void)setMaskPathSource:(id)arg1;
- (id)maskPathSource;
- (void)setMaskInfoGeometry:(id)arg1;
- (id)maskInfoGeometry;
- (void)setImageInfoOriginalSize:(id)arg1;
- (id)imageInfoOriginalSize;
