...
@interface GSSPCmdTableSetHeaderSize : GSSPCmdTableBaseRowColumnRangeCommand <GSSPAutoDecodable>
{
    vector_b67dfe3a mSizeList;
}
...
- (void)setSizeList:(const vector_b67dfe3a *)arg1;
- (vector_b67dfe3a *)sizeList;
