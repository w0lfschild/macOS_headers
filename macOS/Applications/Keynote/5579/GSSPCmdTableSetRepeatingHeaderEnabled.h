...
@interface GSSPCmdTableSetRepeatingHeaderEnabled : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    BOOL mRepeatingHeaderEnabled;
    long long mInDirection;
}
...
- (void)setInDirection:(long long)arg1;
- (long long)inDirection;
- (void)setRepeatingHeaderEnabled:(BOOL)arg1;
- (BOOL)repeatingHeaderEnabled;
