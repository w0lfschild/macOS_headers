...
@interface GSSPCmdTableUnmergeCell : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    vector_17f96b92 mCellUnmergeList;
}
...
- (void)setCellUnmergeList:(const vector_17f96b92 *)arg1;
- (vector_17f96b92 *)cellUnmergeList;
