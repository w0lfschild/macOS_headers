...
@interface GSSPColumns : GSSPMessageBase <GSSPAutoDecodable>
{
    int mColumnCount;
    BOOL mEqualWidth;
    vector_b67dfe3a mWidthList;
    vector_b67dfe3a mGapList;
}
...
- (void)setGapList:(const vector_b67dfe3a *)arg1;
- (vector_b67dfe3a *)gapList;
- (void)setWidthList:(const vector_b67dfe3a *)arg1;
- (vector_b67dfe3a *)widthList;
