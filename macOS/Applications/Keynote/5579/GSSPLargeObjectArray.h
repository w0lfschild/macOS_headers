...
#import "GSSPLargeArray.h"

#import "GSSPAutoDecodable-Protocol.h"

@interface GSSPLargeObjectArray : GSSPLargeArray <GSSPAutoDecodable>
{
    vector_6576d1fe mElementList;
}
...
- (void)setElementList:(const vector_6576d1fe *)arg1;
- (vector_6576d1fe *)elementList;
