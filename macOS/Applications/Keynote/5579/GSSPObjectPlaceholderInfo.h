...
@interface GSSPObjectPlaceholderInfo : GSSPPlaceholderInfo <GSSPAutoDecodable>
{
}
...
- (id)convertKNObjectPlaceholderInfoWithDecodeContext:(struct GSSPDecodeConversionContext *)arg1 error:(id *)arg2;
