...
@class GSSPPoint, GSSPRect, GSSPSize, NSString;
...
@interface GSSPPencilAnnotationStorage : GSSPMessageBase <GSSPAutoDecodable>
{
    ...
    NSString *mBase64RasterizedImage;
    NSString *mBase64EncodedDrawing;
    GSSPSize *mRasterizedImageSize;
...
- (id)pathString;
- (void)setRasterizedImageSize:(id)arg1;
- (id)rasterizedImageSize;
- (void)setBase64EncodedDrawing:(id)arg1;
- (id)base64EncodedDrawing;
- (void)setBase64RasterizedImage:(id)arg1;
- (id)base64RasterizedImage;
