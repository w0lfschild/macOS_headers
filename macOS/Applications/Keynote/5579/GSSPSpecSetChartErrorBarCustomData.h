...
#import "GSSPSpecChartErrorBarCustomData.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPChartErrorBarCustomData;

@interface GSSPSpecSetChartErrorBarCustomData : GSSPSpecChartErrorBarCustomData <GSSPAutoDecodable>
{
    GSSPChartErrorBarCustomData *mChartErrorBarCustomData;
    BOOL mUnset;
}
...
- (BOOL)unset;
- (void)setChartErrorBarCustomData:(id)arg1;
- (id)chartErrorBarCustomData;
