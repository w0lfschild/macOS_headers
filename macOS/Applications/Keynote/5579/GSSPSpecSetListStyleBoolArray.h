...
#import "GSSPSpecListStyleBoolArray.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPListStyleBoolArray;

@interface GSSPSpecSetListStyleBoolArray : GSSPSpecListStyleBoolArray <GSSPAutoDecodable>
{
    GSSPListStyleBoolArray *mListStyleBoolArray;
    BOOL mUnset;
}
...
- (BOOL)unset;
- (void)setListStyleBoolArray:(id)arg1;
- (id)listStyleBoolArray;
