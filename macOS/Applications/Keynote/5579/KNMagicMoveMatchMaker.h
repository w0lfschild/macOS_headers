...
+ (id)newFlattenedAnimationMatchesFromAnimationMatches:(id)arg1 animationContext:(id)arg2 isPreview:(BOOL)arg3 metalDevice:(id)arg4 pixelFormat:(unsigned long long)arg5;
