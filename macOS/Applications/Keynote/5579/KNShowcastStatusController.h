...
@class KNShowcastParticipantMonitor, KNShowcastServiceReachabilityMonitor, NSMutableArray, NSOperationQueue, NSSet, NSString, NSURL, TSKCloudKitMetadataController, TSKICloudHTTPRequestSenderFactory, TSUNetworkReachability;
