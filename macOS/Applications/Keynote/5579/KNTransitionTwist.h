...
- (void)p_drawTwistWithPercent:(double)arg1 currentBuffer:(unsigned long long)arg2 texture:(id)arg3 oldTexture:(id)arg4 encoder:(id)arg5;
...
- (void)drawGrid:(id)arg1 encoder:(id)arg2 currentBuffer:(unsigned long long)arg3;
