...
@interface TMAPhotoBrowserViewController : TMAMediaTypeBrowserViewController <TMACollectionViewDataSource, TMACollectionViewDelegate, TMAMediaBrowserDraggingDelegate, TMAMediaBrowserLibraryViewControllerDelegate>
{
...
- (id)mediaSourceIdentifierForCategory:(unsigned long long)arg1;
