...
- (void)mutateInfoByAdjustingScaleFromLayoutSettings:(const CDStruct_6d1c4171 *)arg1 toLayoutSettings:(const CDStruct_6d1c4171 *)arg2;
- (id)adjustedScaleFromLayoutSettings:(const CDStruct_6d1c4171 *)arg1 toLayoutSettings:(const CDStruct_6d1c4171 *)arg2;
...
- (id)configuredSceneWithLayoutSettings:(CDStruct_6d1c4171)arg1;
- (void)configureScene:(id)arg1;
- (CDStruct_6d1c4171)upgradedLayoutSettings;
- (CDStruct_6d1c4171)oldLayoutSettings;
- (CDStruct_6d1c4171)p_oldLayoutSettingsForSpice:(BOOL)arg1;
- (void)dealloc;
