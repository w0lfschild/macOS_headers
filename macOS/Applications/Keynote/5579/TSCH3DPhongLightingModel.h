...
@interface TSCH3DPhongLightingModel : TSCH3DPhongLikeLightingModel <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPChart3dPhongLightingModel:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
