...
@interface TSTIdempotentSelectionTransformer : TSPObject <TSKSelectionTransformer>
{
    TSKSelection *_selection;
}

@property(readonly, copy, nonatomic) TSKSelection *selection; // @synthesize selection=_selection;
