...
@property(retain, nonatomic) id <TSTLayoutDynamicRowMoveProtocol> dynamicRowMoveDelegate; // @synthesize dynamicRowMoveDelegate=_dynamicRowMoveDelegate;
...
@property(retain, nonatomic) id <TSTLayoutDynamicColumnMoveProtocol> dynamicColumnMoveDelegate; // @synthesize dynamicColumnMoveDelegate=_dynamicColumnMoveDelegate;
