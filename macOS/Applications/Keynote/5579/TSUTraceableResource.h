...
@interface TSUTraceableResource : NSObject
{
    ...
    NSString *_name;
    NSObject<TSULogContext> *_logContext;
}

@property(retain, nonatomic) NSObject<TSULogContext> *logContext; // @synthesize logContext=_logContext;
...
- (void)p_logErrorTokenSerializationDescriptionFromQueue;
...
- (id)initWithName:(id)arg1 logContext:(id)arg2;
- (id)init;
