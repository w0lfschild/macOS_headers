...
@class CALayer, CAShapeLayer, NSArray, NSString, NSTimer, TSDLayout, TSDNoDefaultImplicitActionLayer, TSKHighlightArrayController, TSKPulseAnimationController, TSUColor, TSWPSearchReference, TSWPSelection, TSWPStorage, TSWPStorageSpellChecker, TSWPTextEditor;
@protocol TSDAnnotation, TSWPLayoutTarget;

@interface TSWPRep : TSDContainerRep <CAAnimationDelegate, TSKHighlightArrayControllerProtocol, TSKPulseAnimationControllerProtocol, TSWPHyperlinkHostRepProtocol, CALayerDelegate>
{
...
- (void)p_clearICCActiveSearchReference;
...
- (void)p_spellCheckerWordsDidChangeNotification:(id)arg1;
...
- (Class)layerClass;
- (unsigned long long)charIndexFromPoint:(struct CGPoint)arg1 allowPastBreak:(BOOL)arg2 allowNotFound:(BOOL)arg3 pastCenterGoesToNextChar:(BOOL)arg4 constrainToAscentAndDescent:(BOOL)arg5 isAtEndOfLine:(char *)arg6 leadingEdge:(char *)arg7;
...
- (unsigned long long)charIndexFromPoint:(struct CGPoint)arg1 allowPastBreak:(BOOL)arg2 allowNotFound:(BOOL)arg3 constrainToAscentAndDescent:(BOOL)arg4 isAtEndOfLine:(char *)arg5 leadingEdge:(char *)arg6;
...
- (unsigned long long)charIndexFromPoint:(struct CGPoint)arg1 allowPastBreak:(BOOL)arg2 constrainToAscentAndDescent:(BOOL)arg3 isAtEndOfLine:(char *)arg4;
