...
@interface GSSPBodyPlaceholderInfo : GSSPPlaceholderInfo <GSSPAutoDecodable>
{
}
...
- (id)convertKNBodyPlaceholderInfoWithDecodeContext:(struct GSSPDecodeConversionContext *)arg1 error:(id *)arg2;
