...
@class GSSPChartSeriesNonStyleProperties;

@interface GSSPChartSeriesNonStyle : GSSPStyle <GSSPAutoDecodable>
{
    GSSPChartSeriesNonStyleProperties *mOverridePropertyMap;
}
