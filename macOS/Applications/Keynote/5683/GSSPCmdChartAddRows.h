...
@interface GSSPCmdChartAddRows : GSSPCmdChartBaseWithChartInfoId <GSSPAutoDecodable>
{
    NSArray *mRowIdList;
...
@property(readonly, nonatomic) BOOL definedRowId; // @synthesize definedRowId=mDefinedRowId;
- (void).cxx_destruct;
- (id)description;
- (id)dspClassName;
