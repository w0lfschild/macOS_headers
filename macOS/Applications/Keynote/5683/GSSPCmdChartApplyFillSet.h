...
@class GSSPChartFillSet, TSCHChartType;

@interface GSSPCmdChartApplyFillSet : GSSPCmdChartBaseWithChartInfoId <GSSPAutoDecodable>
{
    TSCHChartType *mChartType;
    GSSPChartFillSet *mFillSet;
}
