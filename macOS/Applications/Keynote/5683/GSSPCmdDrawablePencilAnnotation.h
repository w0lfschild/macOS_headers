...
@class NSUUID, TSDPencilAnnotation;

@interface GSSPCmdDrawablePencilAnnotation : GSSPCmdDrawableBaseWithDrawableInfoId <GSSPAutoDecodable>
{
    TSDPencilAnnotation *mPencilAnnotationToAdd;
    NSUUID *mPencilAnnotationToRemove;
}
...
- (void)setPencilAnnotationToRemove:(id)arg1;
- (id)pencilAnnotationToRemove;
- (void)setPencilAnnotationToAdd:(id)arg1;
- (id)pencilAnnotationToAdd;
