...
@interface GSSPCmdNoop : GSSPCmdBase <GSSPAutoDecodable>
{
    BOOL mIsUserEditJournal;
    BOOL mDefinedIsUserEditJournal;
}
...
@property(readonly, nonatomic) BOOL definedIsUserEditJournal; // @synthesize definedIsUserEditJournal=mDefinedIsUserEditJournal;
- (id)description;
- (id)dspClassName;
...
- (BOOL)clearIsUserEditJournal;
- (void)setIsUserEditJournal:(BOOL)arg1;
- (BOOL)isUserEditJournal;
