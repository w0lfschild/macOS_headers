...
@interface GSSPCmdTableJustForNotifying : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    int mChangeDescriptorTypeAsInteger;
}
...
- (void)setChangeDescriptorTypeAsInteger:(int)arg1;
- (int)changeDescriptorTypeAsInteger;
