...
@interface GSSPTextAttribute : GSSPMessageBase
{
    int mCharIndex;
    NSObject *mObject;
    vector_78d19954 mObjectEntries;
}
...
- (void)setObjectEntries:(const vector_78d19954 *)arg1;
- (vector_78d19954 *)objectEntries;
