...
@interface KNBuildBouncy : KNAnimationEffect <KNBuildCAAnimator, KNBuildOpenGLAnimator, KNAnimationPluginArchiving>
{
...
- (id)p_hopsArrayWithTexture:(id)arg1 numBounces:(long long)arg2 direction:(unsigned long long)arg3 duration:(double)arg4 isBuildIn:(BOOL)arg5;
