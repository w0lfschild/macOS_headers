...
@interface KNBuildPop : KNAnimationEffect <KNBuildCAAnimator, KNBuildOpenGLAnimator, KNAnimationPluginArchiving>
{
    KNAnimParameterGroup *_parameterGroupIn;
    KNAnimParameterGroup *_parameterGroupOut;
