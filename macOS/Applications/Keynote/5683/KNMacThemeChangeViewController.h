...
{
    id <KNMacThemeChangeViewControllerDelegate> _delegate;
    NSArray *_items;
    BOOL _needsReloadTemplates;
    BOOL _showUserTemplateCategory;
    unsigned long long _applicationTemplateCategoryIndex;
}

@property(nonatomic) BOOL showUserTemplateCategory; // @synthesize showUserTemplateCategory=_showUserTemplateCategory;
@property(nonatomic) unsigned long long applicationTemplateCategoryIndex; // @synthesize applicationTemplateCategoryIndex=_applicationTemplateCategoryIndex;
- (void).cxx_destruct;
