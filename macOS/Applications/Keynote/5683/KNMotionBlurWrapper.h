...
@class NSArray, NSMapTable, TSDGLMotionBlurEffect, TSDGLShader, TSDMetalMotionBlurEffect;
...
@interface KNMotionBlurWrapper : NSObject
{
    ...
    id <MTLRenderPipelineState> _defaultPipelineState;
...
- (id)initWithFramebufferSize:(struct CGSize)arg1 slideSize:(struct CGSize)arg2 textures:(id)arg3 duration:(double)arg4 shouldAddPerpendicularEdges:(BOOL)arg5 metalDevice:(id)arg6 metalPixelFormat:(unsigned long long)arg7 randomGenerator:(id)arg8;
