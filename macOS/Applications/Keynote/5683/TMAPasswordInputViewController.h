...
@class NSLayoutConstraint, NSString, NSTextField, SFUCryptoKey;
...
@interface TMAPasswordInputViewController : NSViewController <NSTextFieldDelegate>
{
    ...
    NSLayoutConstraint *_passwordNotPresentLabelBottomConstraint;
    NSTextField *_passwordMismatchLabel;
    NSLayoutConstraint *_passwordMismatchLabelBottomConstraint;
...
@property(retain, nonatomic) NSLayoutConstraint *passwordMismatchLabelBottomConstraint; // @synthesize passwordMismatchLabelBottomConstraint=_passwordMismatchLabelBottomConstraint;
@property(nonatomic) NSTextField *passwordMismatchLabel; // @synthesize passwordMismatchLabel=_passwordMismatchLabel;
@property(retain, nonatomic) NSLayoutConstraint *passwordNotPresentLabelBottomConstraint; // @synthesize passwordNotPresentLabelBottomConstraint=_passwordNotPresentLabelBottomConstraint;
