...
@interface TSDContactShadow : TSDShadow <GSSPAutoEncodable>
{
    double mHeight;
}
...
- (void)populateGSSPContactShadow:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
