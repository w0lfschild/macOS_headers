...
@interface TSPMutableLargeNumberArray : TSPAbstractMutableLargeArray <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPLargeNumberArray:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
