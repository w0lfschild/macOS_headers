...
@property(nonatomic, setter=tsaxSetParentRulerMarkerController:) __weak TSWPRulerMarkerControllerAccessibility *tsaxParentRulerMarkerController;
- (id)tsaxTarget;
...
@property(nonatomic, setter=tsaxSetParentRulerView:) __weak TSWPMacRulerViewAccessibility *tsaxParentRulerView;
