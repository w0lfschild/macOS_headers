...
@interface GSSPCellFormulaSpec : GSSPCellSpec <GSSPAutoDecodable>
{
    GSSPCalculationEngineFormula *mFormula;
    unsigned char mCategoryAggregateType;
    BOOL mDefinedCategoryAggregateType;
}
...
@property(readonly, nonatomic) BOOL definedCategoryAggregateType; // @synthesize definedCategoryAggregateType=mDefinedCategoryAggregateType;
- (id)description;
- (id)dspClassName;
...
- (BOOL)clearCategoryAggregateType;
- (void)setCategoryAggregateType:(unsigned char)arg1;
