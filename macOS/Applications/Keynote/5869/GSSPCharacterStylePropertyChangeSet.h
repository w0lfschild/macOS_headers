...
@interface GSSPCharacterStylePropertyChangeSet : GSSPStylePropertyChangeSet <GSSPAutoDecodable>
{
    ...
    TSSSpecBool *mIsNamedPointSize;
    TSSSpecBool *mCapitalizationUsesLinguistics;
    ...
    BOOL mDefinedCapitalizationUsesLinguistics;
}
...
@property(readonly, nonatomic) BOOL definedCapitalizationUsesLinguistics; // @synthesize definedCapitalizationUsesLinguistics=mDefinedCapitalizationUsesLinguistics;
...
- (BOOL)clearCapitalizationUsesLinguistics;
...
- (void)setCapitalizationUsesLinguistics:(id)arg1;
- (id)capitalizationUsesLinguistics;
- (void)setIsNamedPointSize:(id)arg1;
- (id)isNamedPointSize;
