...
@interface GSSPCmdChartMoveRows : GSSPCmdChartBaseWithChartInfoId <GSSPAutoDecodable>
{
    NSUUID *mStartRowId;
    NSUUID *mEndRowId;
    NSUUID *mAfterRowId;
    BOOL mDefinedAfterRowId;
}
...
@property(readonly, nonatomic) BOOL definedAfterRowId; // @synthesize definedAfterRowId=mDefinedAfterRowId;
- (void).cxx_destruct;
- (id)description;
- (id)dspClassName;
...
- (BOOL)clearAfterRowId;
- (void)setAfterRowId:(id)arg1;
- (id)afterRowId;
- (void)setEndRowId:(id)arg1;
- (id)endRowId;
- (void)setStartRowId:(id)arg1;
- (id)startRowId;
