...
@interface KNBuildTrace : KNAnimationEffect <KNBuildOpenGLAnimator, KNAnimationPluginArchiving>
{
...
- (id)p_extraTraceObjectsWithTextures:(id)arg1 originalTraceObjects:(id)arg2 randomGenerator:(id)arg3;
- (void)p_setupShadersWithRandomGenerator:(id)arg1;
