...
- (void)saveToArchive:(struct CommandBuildChunkSetValueArchive *)arg1 archiver:(id)arg2;
- (void)loadFromArchive:(const struct CommandBuildChunkSetValueArchive *)arg1 unarchiver:(id)arg2;
