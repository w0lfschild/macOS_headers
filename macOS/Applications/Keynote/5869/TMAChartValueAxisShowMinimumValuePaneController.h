...
@interface TMAChartValueAxisShowMinimumValuePaneController : TMAChartInspectorPaneGroupController
{
    NSArrayController *mAxisArrayController;
    TMAInspectorCheckBoxButton *_showMinimumValueCheckbox;
}
...
+ (id)tabIdentifier;
+ (id)nibName;
@property(nonatomic) __weak TMAInspectorCheckBoxButton *showMinimumValueCheckbox; // @synthesize showMinimumValueCheckbox=_showMinimumValueCheckbox;
