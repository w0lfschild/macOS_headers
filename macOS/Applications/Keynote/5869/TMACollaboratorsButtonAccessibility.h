...
@class NSString, TMADocumentWindowControllerAccessibility, TSKSharingStateAccessibility;
...
@property(readonly, nonatomic) TSKSharingStateAccessibility *_tsaxSharingState;
