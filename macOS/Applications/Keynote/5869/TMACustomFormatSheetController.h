...
@class NSArray, NSButton, NSDate, NSLayoutConstraint, NSMutableArray, NSNumber, NSPopUpButton, NSString, NSTabView, NSTextField, NSTokenField, NSView, NSWindow, TMABackgroundView, TMACustomFormatDateTokenDelegate, TMACustomFormatNumberTokenDelegate, TMACustomFormatSheetControllerData, TMAWellView, TSADocumentRoot;
...
@interface TMACustomFormatSheetController : NSWindowController <NSWindowDelegate, TMACustomFormatTokenController, NSTextFieldDelegate>
{
    ...
    TMABackgroundView *mBackgroundView;
