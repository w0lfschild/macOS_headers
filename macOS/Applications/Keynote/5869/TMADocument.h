...
@interface TMADocument : NSDocument <TMAScriptCommandExecutionResolving, NSUserActivityDelegate, TSPViewStateValidator, TSAViewStateSidecarDelegate, TSPObjectContextDelegate, TSAImportDelegate, TSADocumentRootDelegate, TSAUndoManagerDelegate, TSKDocumentRootProvider>
{
    ...
    NSObject<OS_dispatch_queue> *_encodeRestorableStateQueue;
...
- (void)p_upgradeIncompatibleMediaContainersWithUpgrader:(id)arg1 reduceFileSizeController:(id)arg2 requiredCompatibilityLevel:(long long)arg3 windowForSheet:(id)arg4 anyMediaDownloading:(BOOL)arg5 mediaContainerDataHintMap:(id)arg6 allowUndo:(BOOL)arg7 completionHandler:(CDUnknownBlockType)arg8;
...
- (void)p_upgradeIncompatibleMediaContainersFromEnumeratorFromBlock:(CDUnknownBlockType)arg1 targetDocumentRoot:(id)arg2 fromEntireDocument:(BOOL)arg3 requiredCompatibilityLevel:(long long)arg4 preset:(long long)arg5 shouldAllowUndo:(BOOL)arg6 warnIfNone:(BOOL)arg7 withSynchronousWaiting:(BOOL)arg8 reduceFileSizeController:(id)arg9 windowForSheet:(id)arg10 completionHandler:(CDUnknownBlockType)arg11;
- (void)p_reduceFileSizeIfNeededForDocumentRoot:(id)arg1 reduceImages:(BOOL)arg2 reduceMovies:(BOOL)arg3 preset:(long long)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (BOOL)p_fileModificationDate:(id)arg1 isEqualToFileModificationDateAccountingForTruncation:(id)arg2;
