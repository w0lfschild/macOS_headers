...
@class NSSet, NSString, TSAGalleryItem, TSDEditorController, TSKDocumentRoot;
@protocol TSKSearchReference;

@interface TSAGalleryItemEditor : NSObject <TSDEditor>
{
    TSDEditorController *_editorController;
    TSKDocumentRoot *_documentRoot;
    TSAGalleryItem *_item;
}

@property(readonly, nonatomic) TSAGalleryItem *item; // @synthesize item=_item;
