...
@interface TSCHChartSeriesGenericPropertyMap : TSSPropertyMap <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPChartSeriesGenericPropertyMap:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
