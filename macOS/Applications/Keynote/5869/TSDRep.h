...
- (BOOL)p_pencilAnnotationShouldShowSelectionAnimation:(id)arg1;
- (BOOL)p_isPencilAnnotationStorageSelected:(id)arg1;
- (double)p_pencilAnnotationIntervalSinceSelection;
- (id)p_pencilAnchorFadeAnimation;
- (id)p_pencilOverlayLayersForPencilOverlayDetails:(id)arg1;
- (id)p_pencilOverlayDetails;
...
@property(readonly, nonatomic) TSUColor *selectionHighlightColor;
@property(readonly, nonatomic) TSUColor *defaultSelectionHighlightColor;
...
@property(readonly, nonatomic) unsigned long long actionGhostIndex;
