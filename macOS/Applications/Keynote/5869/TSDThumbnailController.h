...
@interface TSDThumbnailController : NSObject <TSDThumbnailConsumer>
{
    ...
    TSKDocumentRoot *_strongDocumentRoot;
...
@property(nonatomic) __weak id <TSDThumbnailProducer> producer; // @synthesize producer=_producer;
@property(nonatomic) __weak id <TSDThumbnailControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
