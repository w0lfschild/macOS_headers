...
@interface TSRCFileInputWaveformDataSource : TSRCWaveformDataSource
{
...
@property(nonatomic) CDStruct_c3b9c2ee sourceTimeRange; // @synthesize sourceTimeRange=_sourceTimeRange;
