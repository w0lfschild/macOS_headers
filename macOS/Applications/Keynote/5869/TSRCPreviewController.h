...
#import "TSRCAVPlayerDelegate-Protocol.h"

@class AVPlayerItem, NSHashTable, NSMutableDictionary, NSString, NSURL, TSRCAVPlayer, TSRCAVState;

@interface TSRCPreviewController : NSObject <TSRCAVPlayerDelegate>
{
    ...
    TSRCAVPlayer *_AVPlayer;
    TSRCAVState *_AVState;
}

@property(retain, nonatomic) TSRCAVState *AVState; // @synthesize AVState=_AVState;
@property(readonly, nonatomic) TSRCAVPlayer *AVPlayer; // @synthesize AVPlayer=_AVPlayer;
...
@property(nonatomic) CDStruct_c3b9c2ee playableTimeRange;
- (void)stop;
- (void)pause;
- (void)playWithTimeRange:(CDStruct_c3b9c2ee)arg1 startTime:(double)arg2 playbackContextName:(id)arg3;
