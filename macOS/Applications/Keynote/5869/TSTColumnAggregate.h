...
@interface TSTColumnAggregate : TSKSosBase <GSSPAutoEncodable, NSCopying>
{
...
- (void)populateGSSPColumnAggregate:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
