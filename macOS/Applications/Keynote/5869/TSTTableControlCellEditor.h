...
@protocol TSDTextSelection, TSKSearchReference, TSTTableControlCellViewController;

@interface TSTTableControlCellEditor : NSObject <TSKChangeSourceObserver, TSDTextInput, TSTLayoutDynamicContentProtocol>
{
    BOOL _isResigning;
    BOOL _isSendingTextToTableEditor;
    BOOL _ratingsDynamicMode;
    BOOL _shouldShowControlCellUIOnLayout;
    int _interactionType;
    TSTTableRep *_tableRep;
    id <TSTTableControlCellViewController> _controlCellViewController;
    unsigned long long _ratingsDynamicStarValue;
...
@property(nonatomic) BOOL shouldShowControlCellUIOnLayout; // @synthesize shouldShowControlCellUIOnLayout=_shouldShowControlCellUIOnLayout;
@property(nonatomic) unsigned long long ratingsDynamicStarValue; // @synthesize ratingsDynamicStarValue=_ratingsDynamicStarValue;
@property(nonatomic) BOOL ratingsDynamicMode; // @synthesize ratingsDynamicMode=_ratingsDynamicMode;
@property(nonatomic) BOOL isSendingTextToTableEditor; // @synthesize isSendingTextToTableEditor=_isSendingTextToTableEditor;
@property(nonatomic) BOOL isResigning; // @synthesize isResigning=_isResigning;
@property(retain, nonatomic) id <TSTTableControlCellViewController> controlCellViewController; // @synthesize controlCellViewController=_controlCellViewController;
@property(nonatomic) __weak TSTTableRep *tableRep; // @synthesize tableRep=_tableRep;
@property(readonly, nonatomic) int interactionType; // @synthesize interactionType=_interactionType;
- (id).cxx_construct;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) int currentActiveInteractionType;
