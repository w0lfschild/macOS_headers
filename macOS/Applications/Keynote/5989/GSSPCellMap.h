...
@interface GSSPCellMap : GSSPMessageBase <GSSPAutoDecodable>
{
    vector_fa1cc45b mCellList;
    TSTCellUIDList *mCellUIDs;
    vector_c8dfb770 mMergeActionList;
}
...
- (void)setMergeActionList:(const vector_c8dfb770 *)arg1;
- (vector_c8dfb770 *)mergeActionList;
- (void)setCellUIDs:(id)arg1;
- (id)cellUIDs;
- (void)setCellList:(const vector_fa1cc45b *)arg1;
- (vector_fa1cc45b *)cellList;
