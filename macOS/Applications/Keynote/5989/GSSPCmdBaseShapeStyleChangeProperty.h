...
#import "GSSPCmdStyledInfoStyleChangeProperty.h"

#import "GSSPAutoDecodable-Protocol.h"

@class TSDShapeStylePropertyChangeSet;

@interface GSSPCmdBaseShapeStyleChangeProperty : GSSPCmdStyledInfoStyleChangeProperty <GSSPAutoDecodable>
{
    TSDShapeStylePropertyChangeSet *mChange;
}
