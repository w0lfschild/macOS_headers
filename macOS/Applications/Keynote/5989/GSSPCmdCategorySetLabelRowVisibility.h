...
@interface GSSPCmdCategorySetLabelRowVisibility : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    int mGroupLevel;
    int mLabelRowVisibility;
}
...
- (void)setLabelRowVisibility:(int)arg1;
- (int)labelRowVisibility;
