...
@interface GSSPColumnAggregateList : GSSPMessageBase <GSSPAutoDecodable>
{
    vector_dc5fd506 mColumnAggregates;
}
...
- (void)setColumnAggregates:(const vector_dc5fd506 *)arg1;
- (vector_dc5fd506 *)columnAggregates;
