...
@interface GSSPEditableBezierPathSource : GSSPPathSource <GSSPAutoDecodable>
{
    vector_f4d1330d mSubpathList;
    int mActiveSubpath;
}
...
- (void)setActiveSubpath:(int)arg1;
- (int)activeSubpath;
- (void)setSubpathList:(const vector_f4d1330d *)arg1;
- (vector_f4d1330d *)subpathList;
