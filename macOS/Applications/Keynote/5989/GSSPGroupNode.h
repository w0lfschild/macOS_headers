...
@interface GSSPGroupNode : GSSPMessageBase <GSSPAutoDecodable>
{
    UUIDData_5fbc143e mGroupUid;
    TSCECellValue *mGroupValue;
    int mGroupLevel;
    vector_ae6c0bda mChildNodes;
    vector_4dc5f307 mRowUids;
}
...
- (void)setRowUids:(const vector_4dc5f307 *)arg1;
- (vector_4dc5f307 *)rowUids;
- (void)setChildNodes:(const vector_ae6c0bda *)arg1;
- (vector_ae6c0bda *)childNodes;
- (void)setGroupLevel:(int)arg1;
- (int)groupLevel;
- (void)setGroupValue:(id)arg1;
- (id)groupValue;
- (void)setGroupUid:(UUIDData_5fbc143e)arg1;
- (UUIDData_5fbc143e)groupUid;
