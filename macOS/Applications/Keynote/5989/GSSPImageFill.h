...
@class GSSPImageData, GSSPSize, TSUColor;

@interface GSSPImageFill : GSSPFill <GSSPAutoDecodable>
{
    GSSPImageData *mData;
    int mTechnique;
    GSSPSize *mFillSize;
    TSUColor *mTintColor;
    BOOL mDefinedTintColor;
}
...
@property(readonly, nonatomic) BOOL definedTintColor; // @synthesize definedTintColor=mDefinedTintColor;
- (void).cxx_destruct;
- (id)description;
- (id)dspClassName;
