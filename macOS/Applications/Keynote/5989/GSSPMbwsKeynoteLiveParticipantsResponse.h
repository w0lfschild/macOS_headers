...
@interface GSSPMbwsKeynoteLiveParticipantsResponse : GSSPMessageBase <GSSPAutoDecodable>
{
    int mErrorCode;
    int mPresenterCount;
    int mAudienceCount;
    NSString *mResponseToken;
}
...
- (id)responseToken;
- (void)setAudienceCount:(int)arg1;
- (int)audienceCount;
- (void)setPresenterCount:(int)arg1;
- (int)presenterCount;
