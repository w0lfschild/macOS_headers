...
@interface GSSPTOCSettings : GSSPMessageBase
{
    NSString *mDisplayName;
    int mScope;
    vector_56a2c002 mTocMapEntryList;
}
...
- (void)setTocMapEntryList:(const vector_56a2c002 *)arg1;
- (vector_56a2c002 *)tocMapEntryList;
