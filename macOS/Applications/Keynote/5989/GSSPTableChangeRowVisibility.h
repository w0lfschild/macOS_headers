...
#import "GSSPTableChange.h"

@interface GSSPTableChangeRowVisibility : GSSPTableChange
{
    vector_4dc5f307 mRowUIDList;
    vector_561d5ecd mIsHiddenByFilterList;
}
...
- (void)setIsHiddenByFilterList:(const vector_561d5ecd *)arg1;
- (vector_561d5ecd *)isHiddenByFilterList;
