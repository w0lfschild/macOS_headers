...
- (id)p_texturedRectFromImagePath:(id)arg1 device:(id)arg2;
...
- (id)p_specksSystemForTR:(id)arg1 build:(id)arg2 randomGenerator:(id)arg3 device:(id)arg4;
- (id)p_smokeSystemForTR:(id)arg1 build:(id)arg2 randomGenerator:(id)arg3 device:(id)arg4;
