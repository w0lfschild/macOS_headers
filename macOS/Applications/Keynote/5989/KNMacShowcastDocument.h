...
@class KNKPFDocument, KNKPFPackage, KNShowcastKPFPackageLoader, KNShowcastSessionController, NSObject, NSString, NSUUID, TSUICloudRegionInfo;
...
@interface KNMacShowcastDocument : NSDocument <KNShowcastSessionControllerDelegate, KNShowcastMessageReceiver, KNShowcastPasswordProvider>
{
    ...
    TSUICloudRegionInfo *_regionInfo;
...
@property(retain, nonatomic) TSUICloudRegionInfo *regionInfo; // @synthesize regionInfo=_regionInfo;
