...
@property(readonly, nonatomic) struct CGSize mediaSize; // @synthesize mediaSize=_size;
- (void).cxx_destruct;
- (void)cancel;
- (void)willCancel;
...
- (id)init;
- (id)initWithDocumentRoot:(id)arg1 size:(struct CGSize)arg2 movieTimelineMovieSampleGenerator:(id)arg3 videoFrameDuration:(CDStruct_1b6d18a9)arg4 readTicket:(id)arg5;
