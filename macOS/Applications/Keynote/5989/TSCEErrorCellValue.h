...
@interface TSCEErrorCellValue : TSCECellValue <GSSPAutoEncodable>
{
...
- (void)populateGSSPCEErrorCellValue:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
