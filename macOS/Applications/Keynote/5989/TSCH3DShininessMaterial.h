...
@interface TSCH3DShininessMaterial : TSCH3DTexturesMaterial <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPChart3dShininessMaterial:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
