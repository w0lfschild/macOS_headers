...
+ (id)keyPathsForValuesAffectingChartSeriesDataShowPieExplosionDistanceFromCenter;
+ (id)keyPathsForValuesAffectingChartSpecificSeriesDataShowPieExplosion;
...
+ (id)keyPathsForValuesAffectingChartShowIfSupportsRoundedCorners;
+ (id)keyPathsForValuesAffectingChartShowIfSupportsCenterTitle;
...
+ (id)keyPathsForValuesAffectingChartCenterTitleOptions;
...
@property(readonly, nonatomic) __weak id chartParagraphStyleProxyControllerArray;
@property(readonly, nonatomic) __weak id textContainerProxies;
@property(readonly, nonatomic) __weak id paragraphSelectionProxies;
@property(readonly, nonatomic) __weak id characterSelectionProxies;
...
@property(readonly, nonatomic) __weak TSCHChartEditor *chartEditor;
...
@property(readonly, nonatomic) BOOL chartSeriesDataShowPieExplosionDistanceFromCenter;
@property(readonly, nonatomic) BOOL chartSpecificSeriesDataShowPieExplosion;
...
@property(readonly, nonatomic) BOOL chartShowIfSupportsRoundedCorners;
@property(readonly, nonatomic) BOOL chartShowIfSupportsCenterTitle;
...
@property(readonly, nonatomic) __weak id chartEnableCalloutLineSettings;
@property(readonly, nonatomic) __weak id chartCenterTitleOptions;
@property(readonly, nonatomic) __weak id chartAllCalloutLineTypes;
@property(readonly, nonatomic) __weak id chartAllSeriesIndices;
@property(readonly, nonatomic) __weak id chartSeriesValueLabelPositions;
@property(readonly, nonatomic) __weak id chartErrorBarSettings;
@property(readonly, nonatomic) __weak id chartTrendlineTypes;
@property(readonly, nonatomic) __weak id chartSharedValueLabelsNumberFormatAccuracyOptions;
@property(readonly, nonatomic) __weak id chartSharedValueLabelsNumberFormatCurrencyOptions;
@property(readonly, nonatomic) __weak id chartDataSymbolShapes;
@property(readonly, nonatomic) __weak id chartShadowKinds;
@property(readonly, nonatomic) __weak id chartNegativeNumberStyles;
@property(readonly, nonatomic) __weak id chartDataSetNameLocations;
@property(readonly, nonatomic) __weak id chartMultiDataControlTypes;
@property(readonly, nonatomic) __weak id chartSeriesValueLabelsAxes;
@property(readonly, nonatomic) __weak id chartValueLabelFormats;
@property(readonly, nonatomic) __weak id chartValueAxes;
@property(readonly, nonatomic) __weak id chartValueAxis3DLabelPositionOptions;
@property(readonly, nonatomic) __weak id chartValueAxisScaleOptions;
@property(readonly, nonatomic) __weak id chartConnectingLineOptions;
@property(readonly, nonatomic) __weak id chart3DLightingPackageOptions;
@property(readonly, nonatomic) __weak id chartBarShapes;
@property(readonly, nonatomic) __weak id chartPresets;
@property(readonly, nonatomic) __weak id chartSeriesTypes;
@property(readonly, nonatomic) __weak id chartTypes;
...
@property(readonly, nonatomic) __weak NSArray *chartSelectedReferenceLinesProxyArray;
- (id)p_selectedReferenceLinesDictionary;
@property(readonly, nonatomic) __weak TSCHChartSeriesPropertyVendor *chartSelectedErrorBarSeriesPropertyVendor;
@property(readonly, nonatomic) __weak NSArray *chartSelectedErrorBarSeriesPropertyVendors;
@property(readonly, nonatomic) __weak NSArray *chartSelectedLegendProxyArray;
@property(readonly, nonatomic) __weak TSCHChartSeriesPropertyVendor *chartSelectedSeriesPropertyVendor;
@property(readonly, nonatomic) __weak NSArray *chartSelectedSeriesPropertyVendors;
- (id)p_selectedSeriesOrSeriesObjectsIndexesByInfo;
- (id)p_selectedSeriesOrSeriesObjectsIndexesByInfoOutProxyClass:(Class *)arg1;
@property(readonly, nonatomic) __weak TSCHChartSeriesPropertyVendor *chartAllSeriesPropertyVendor;
@property(readonly, nonatomic) __weak NSArray *chartAllSeriesPropertyVendors;
@property(readonly, nonatomic) BOOL chartAnySelected;
@property(readonly, nonatomic) __weak id chartLayouts;
@property(readonly, nonatomic) __weak id charts;
- (void)p_willResignCurrentEditor:(id)arg1;
@property(readonly, nonatomic) __weak id chartObservableChartType;
@property(readonly, nonatomic) BOOL categoryAxisTabSelected;
@property(readonly, nonatomic) BOOL valueAxisTabSelected;
- (void)updateChartInfoInnerRadiusValue:(id)arg1;
- (void)teardown;
- (void)dealloc;
