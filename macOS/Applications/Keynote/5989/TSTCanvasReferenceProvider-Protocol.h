...
@class NSIndexSet, NSSet, TSCEWrappedRangeRef, TSDDrawableInfo, TSTCanvasReference, TSTCanvasReferenceIdentifier, TSTCellRegion, TSTInfo;
...
- (void)menuForSeries:(long long)arg1 inTable:(TSTInfo *)arg2 canvasPoint:(struct CGPoint)arg3;
@end
