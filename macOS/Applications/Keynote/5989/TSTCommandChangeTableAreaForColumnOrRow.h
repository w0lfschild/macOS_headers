...
@property unsigned long long activeTableAreaTransition; // @synthesize activeTableAreaTransition=_activeTableAreaTransition;
@property unsigned long long tableAreaTransition; // @synthesize tableAreaTransition=_tableAreaTransition;
...
- (void)changeToSetNumberActionString;
- (void)didInitFromSOS;
...
- (id)initWithTableInfo:(id)arg1 operatingOn:(unsigned long long)arg2 number:(unsigned int)arg3;
...
- (id)initWithTableInfo:(id)arg1 transition:(unsigned long long)arg2 uidList:(const vector_4dc5f307 *)arg3 cellDiffMap:(id)arg4;
