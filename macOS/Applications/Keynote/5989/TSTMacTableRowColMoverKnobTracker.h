...
- (struct TSUCellRect)p_expandInvalidationCellRange:(struct TSUCellRect)arg1 adjust:(unsigned int)arg2;
...
- (void)p_broadcastChangeNotificationForCellRange:(struct TSUCellRect)arg1;
