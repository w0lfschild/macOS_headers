...
- (id).cxx_construct;
- (void)reset;
- (struct NSEdgeInsets)getPaddingInsets;
- (BOOL)isCheckbox;
- (struct CGSize)getSize;
- (struct TSUCellRect)iter;
- (struct TSUCellRect)begin;
- (unsigned long long)count;
- (void)addRange:(struct TSUCellRect)arg1 andSize:(struct CGSize)arg2 andPaddingInsets:(struct NSEdgeInsets)arg3 andIsCheckbox:(BOOL)arg4;
- (void)dealloc;
- (id)init;
