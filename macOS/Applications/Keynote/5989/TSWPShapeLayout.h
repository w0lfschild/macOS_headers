...
@interface TSWPShapeLayout : TSDShapeLayout <TSWPLayoutParent, TSWPColumnMetrics, TSWPStorageObserver, TSKChangeSourceObserver>
{
    ...
    BOOL _shouldForceCreationOfContainedTextLayout;
    TSWPLayout *_containedLayout;
    id <TSWPShapeLayoutDelegate> _delegate;
}

@property(nonatomic) BOOL shouldForceCreationOfContainedTextLayout; // @synthesize shouldForceCreationOfContainedTextLayout=_shouldForceCreationOfContainedTextLayout;
