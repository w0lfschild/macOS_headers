...
@interface GSSPCmdSlideMoveBuildChunks : GSSPCmdBase <GSSPAutoDecodable>
{
    NSArray *mIdentifiersForBuildChunksToMove;
    NSArray *mIdentifiersForBuildChunksToMoveAfter;
...
- (id)tuplesToUpdate;
- (void)setIdentifiersForBuildChunksToMoveAfter:(id)arg1;
- (id)identifiersForBuildChunksToMoveAfter;
- (void)setIdentifiersForBuildChunksToMove:(id)arg1;
- (id)identifiersForBuildChunksToMove;
