...
@class KNRemoveBuildDescription;

@interface GSSPCmdSlideRemoveBuild : GSSPCmdBase <GSSPAutoDecodable>
{
    KNRemoveBuildDescription *mRemoveBuildDescription;
}
...
- (void)setRemoveBuildDescription:(id)arg1;
- (id)removeBuildDescription;
