...
@interface GSSPCmdSlideRemoveDrawables : GSSPCmdBase <GSSPAutoDecodable>
{
    NSUUID *mSlideId;
    NSArray *mArgsList;
    NSArray *mRemoveBuildDescriptions;
}
...
- (void)setRemoveBuildDescriptions:(id)arg1;
- (id)removeBuildDescriptions;
