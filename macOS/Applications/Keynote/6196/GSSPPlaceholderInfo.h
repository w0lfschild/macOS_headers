...
#import <TSText/GSSPShapeInfo.h>

@interface GSSPPlaceholderInfo : GSSPShapeInfo
{
}
...
- (id)convertKNPlaceholderInfoWithDecodeContext:(struct GSSPDecodeConversionContext *)arg1 forClass:(Class)arg2 error:(id *)arg3;
