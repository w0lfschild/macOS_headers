...
@interface GSSPRecordingSyncState : GSSPMessageBase <GSSPAutoDecodable>
{
    NSUUID *mOutOfSyncToken;
    BOOL mCanClearOutOfSyncToken;
}
...
- (void)setCanClearOutOfSyncToken:(BOOL)arg1;
- (BOOL)canClearOutOfSyncToken;
