...
@interface GSSPSliceKpfData : GSSPMessageBase
{
    NSString *mShowKpfJsonString;
    vector_95cc1646 mSlideKpfJsonStringList;
}
...
- (void)setSlideKpfJsonStringList:(const vector_95cc1646 *)arg1;
- (vector_95cc1646 *)slideKpfJsonStringList;
- (void)setShowKpfJsonString:(id)arg1;
- (id)showKpfJsonString;
