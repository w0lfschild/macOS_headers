...
@class KNBodyPlaceholderInfo, KNObjectPlaceholderInfo, KNSlideBackgroundInfo, KNSlideNode, KNSlideNumberPlaceholderInfo, KNSlideStyle, KNTitlePlaceholderInfo, KNTransition, NSArray, NSDictionary, NSMutableArray, NSObject, NSOrderedSet, NSSet, NSString, TSDFill, TSDGuideStorage, TSDInfoGeometry, TSDReplaceableMediaMap, TSUMutablePointerSet, TSUPointerKeyDictionary;
