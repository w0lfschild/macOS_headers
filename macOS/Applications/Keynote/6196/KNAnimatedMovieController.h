...
@class AVPlayerItemVideoOutput, KNPlaybackSession, NSString, TSDMovieInfo;
@protocol MTLDevice, MTLTexture, TSDMovieHUDViewController, TSKLayerMediaPlayerController;

@interface KNAnimatedMovieController : NSObject <TSKMediaPlayerControllerDelegate>
{
    BOOL _isWideGamut;
    BOOL _isAnimatedGIF;
