...
@class NSArray, NSObject, NSSet, NSString, NSView, TSDAutoscroll, TSDEditorController, TSDInteractiveCanvasController, TSDMovieInfo, TSDRep, TSDSelectionModelTranslator, TSKDocumentRoot, TSKSelectionPath, TSUColor;
@protocol OS_dispatch_queue, TSCEResolverContainer, TSDMediaReplacer, TSKSearchReference;
