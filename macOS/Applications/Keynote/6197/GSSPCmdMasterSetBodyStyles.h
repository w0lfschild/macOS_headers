...
@interface GSSPCmdMasterSetBodyStyles : GSSPCmdBase <GSSPAutoDecodable>
{
    NSUUID *mMasterSlideId;
    NSArray *mNewBodyParagraphStyles;
    NSArray *mNewBodyListStyles;
}
...
- (void)setNewBodyListStyles:(id)arg1;
- (id)newBodyListStyles;
- (void)setNewBodyParagraphStyles:(id)arg1;
- (id)newBodyParagraphStyles;
