...
@class KNBuildChunkIdentifier, NSArray, NSUUID;

@interface GSSPCmdSlideRemoveBuildChunk : GSSPCmdBase <GSSPAutoDecodable>
{
    NSUUID *mSlideId;
    KNBuildChunkIdentifier *mIdentifierForChunkToRemove;
    BOOL mShouldRemoveChunkIdentifier;
...
- (id)tuplesToUpdate;
- (void)setShouldRemoveChunkIdentifier:(BOOL)arg1;
- (BOOL)shouldRemoveChunkIdentifier;
- (void)setIdentifierForChunkToRemove:(id)arg1;
- (id)identifierForChunkToRemove;
