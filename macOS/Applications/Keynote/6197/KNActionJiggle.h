...
@interface KNActionJiggle : KNMotionBlurWrapperBasedEffect <KNActionEffectBuildAnimator>
{
...
- (void)p_addAnimationsToLayer:(id)arg1 duration:(double)arg2 attributes:(id)arg3 result:(id)arg4 isMetalRenderer:(BOOL)arg5;
