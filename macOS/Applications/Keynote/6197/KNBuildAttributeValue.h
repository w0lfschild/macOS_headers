...
-     // Error parsing type: v24@0:8^{BuildAttributeValueArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{PathSourceArchive}^{Color}dIBi}16, name: saveToMessage:
-     // Error parsing type: @24@0:8r^{BuildAttributeValueArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{PathSourceArchive}^{Color}dIBi}16, name: initWithMessage:
