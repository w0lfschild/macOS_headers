...
@interface KNBuildVanish : KNAnimationEffect <KNBuildOpenGLAnimator, KNBuildMetalAnimator, KNAnimationPluginArchiving>
{
    ...
    // Error parsing type: {?="MVPMatrix"{?="columns"[4]}"Percent"f"Opacity"f"ShouldSparkle"f"SparklePeriod"f"ParticleScalePercent"f"VelocityMultiplier"f"SpeedMax"f}, name: _vertexUniforms
...
- (void)p_drawMetalParticleSystemsWithEncoder:(id)arg1 percent:(double)arg2 sparkles:(BOOL)arg3 particleSystemOpacity:(double)arg4;
