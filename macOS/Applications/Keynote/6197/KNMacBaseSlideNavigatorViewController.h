...
@interface KNMacBaseSlideNavigatorViewController : NSViewController <CALayerDelegate, KNMacContentContainer, KNVisibleSlideNodesProvider, TSKChangeSourceObserver>
{
    ...
    NSObject<KNBaseSlideNavigatorController> *_navigatorController;
...
@property(readonly, nonatomic) NSObject<KNBaseSlideNavigatorController> *navigatorController; // @synthesize navigatorController=_navigatorController;
- (void).cxx_destruct;
