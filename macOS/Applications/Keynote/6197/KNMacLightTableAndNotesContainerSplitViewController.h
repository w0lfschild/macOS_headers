...
@class KNInteractiveCanvasController, KNMacLightTableViewController, KNMacPresenterNotesPaneViewController, KNSlideNode, KNSlideTreeEditor, NSColor, NSObject, NSString, NSTouchBar, NSView, TMAZoomStepper, TSDEditorController;
...
- (void)viewWillAppear;
- (void)dealloc;
- (id)initWithLightTableViewController:(id)arg1 slideTreeEditor:(id)arg2;
