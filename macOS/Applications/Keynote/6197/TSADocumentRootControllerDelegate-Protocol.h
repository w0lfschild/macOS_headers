...
@class NSError, NSObject, NSString, NSURL, SFUCryptoKey, TSACollaborationBackgroundStagingDocument, TSACollaborationErrorAction, TSADocumentInfo, TSADocumentRoot, TSKCommandExecutor, TSKDocumentRoot, TSKMailboxDocStatusMessage, TSKSharingState, TSPObjectContext, TSUDocumentSerializationToken;
@protocol NSFilePresenter, OS_dispatch_queue, TSACancellable, TSADocumentRootDelegate, TSADocumentStringProvider, TSKCollaborationCommandReceiver, TSKCollaborationSessionContext, TSPPassphraseConsumer, TSULogContext;
