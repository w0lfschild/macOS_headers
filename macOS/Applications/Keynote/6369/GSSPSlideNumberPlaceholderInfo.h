...
#import "GSSPPlaceholderInfo.h"

#import "GSSPAutoDecodable.h"

@interface GSSPSlideNumberPlaceholderInfo : GSSPPlaceholderInfo <GSSPAutoDecodable>
{
}
...
- (id)convertKNSlideNumberPlaceholderInfoWithDecodeContext:(struct GSSPDecodeConversionContext *)arg1 error:(id *)arg2;
