...
@class KNInteractiveCanvasController, KNMacLightTableAndNotesContainerSplitViewController, KNMacLightTableContainerButton, KNMacLightTableToolbarView, KNMacLightTableZoomControlView, KNSlideNode, NSColor, NSObject<KNSlideCollectionEditor>, NSObject<TSDCanvasEditor>, NSString, NSTouchBar, NSView, TMAZoomStepper, TSDEditorController;
