...
- (MFPen *)createPen:(int)arg1 in_width:(int)arg2 in_colour:(TSUColor *)arg3 in_userStyleArray:(double *)arg4;
- (MFPen *)createPen;
...
- (MFBrush *)createHatchBrush:(TSUColor *)arg1 in_hatchstyle:(int)arg2;
