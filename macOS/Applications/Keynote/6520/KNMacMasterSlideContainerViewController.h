...
@class KNDocumentRoot, KNInteractiveCanvasController, KNMacCanvasViewController, KNMacMasterSlideViewController, KNMasterSlideListEditor, KNSlideNode, NSColor, NSObject<KNSlideCollectionEditor>, NSObject<TSDCanvasEditor>, NSObject<TSTCellEditorHost>, NSString, NSTextField, NSTouchBar, NSView, TMACellEditorHostHelper, TMAReplaceImageController, TMAZoomStepper, TSDEditorController, TSKDocumentRoot;
