...
@class KNKPFDocument, KNKPFPackage, KNShowcastKPFPackageLoader, KNShowcastSessionController, NSObject<OS_dispatch_queue>, NSString, NSUUID;
...
@property(retain, nonatomic) id <TSURegionInfo> regionInfo; // @synthesize regionInfo=_regionInfo;
