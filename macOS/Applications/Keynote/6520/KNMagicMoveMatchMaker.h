...
+ (id)p_layerAndContentsArrayByUpdatingMorphMatches:(id)arg1 withPercent:(double)arg2 animatedSlideView:(id)arg3 playbackSession:(id)arg4 generateSingleTextures:(BOOL)arg5 GLContext:(struct _CGLContextObject *)arg6 generateMetalTextures:(BOOL)arg7 metalLayer:(id)arg8;
+ (id)layerAndContentsArrayByUpdatingMorphMatches:(id)arg1 withPercent:(double)arg2 animatedSlideView:(id)arg3 playbackSession:(id)arg4 generateMetalTextures:(BOOL)arg5 metalLayer:(id)arg6;
...
+ (void)p_addContainedAttachmentsForRep:(id)arg1 containingRep:(id)arg2 canvas:(id)arg3 repsByClass:(id)arg4 textOnlyReps:(id)arg5 conatiningRepToAttachmentRepsMap:(id)arg6 classNames:(id)arg7 allReps:(id)arg8;
