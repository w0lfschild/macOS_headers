...
@class AVCaptureDeviceInput, AVCaptureMovieFileOutput, AVCaptureSession, KNHostTimebase, NSArray, NSError, NSMutableArray, NSObject<KNTimebase>, NSString, NSURL, TSPObjectContext;
