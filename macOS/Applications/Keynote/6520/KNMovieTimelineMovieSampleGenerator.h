...
@class AVAssetReader, AVAssetReaderAudioMixOutput, KNMovieTimeline, KNMovieTimelineMovieSampleGeneratorAudioTrack, NSArray, NSDictionary, NSError, NSObject<OS_dispatch_queue>, NSSet, TSUOnce, TSUTemporaryDirectory;
