...
@interface KNTransitionPageFlip : KNAnimationEffect <KNTransitionOpenGLAnimator, KNTransitionMetalAnimator, KNAnimationPluginArchiving>
{
    ...
    TSDMetalShader *_pageFlipMetalShader;
...
- (void)p_drawFlipWithPercent:(double)arg1 currentBuffer:(unsigned long long)arg2 texture:(id)arg3 encoder:(id)arg4 isMotionBlurred:(BOOL)arg5 isUpdating:(BOOL)arg6;
