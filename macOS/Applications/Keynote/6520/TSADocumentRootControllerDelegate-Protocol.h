...
@class NSError, NSObject<OS_dispatch_queue>, NSString, NSURL, SFUCryptoKey, TSACollaborationBackgroundStagingDocument, TSACollaborationErrorAction, TSADocumentInfo, TSADocumentRoot, TSKCommandExecutor, TSKDocumentRoot, TSKMailboxDocStatusMessage, TSKSharingState, TSPObjectContext, TSUDocumentSerializationToken, TSUSandboxedURL;
