...
@interface EDSheet : OCDDelayedNode
{
    ...
    long long mDataValidationDrawableId;
}

+ (id)sheetWithWorkbook:(id)arg1;
@property(nonatomic) _Bool isRightToLeft; // @synthesize isRightToLeft=mIsRightToLeft;
...
- (void)setDataValidationDrawableId:(long long)arg1;
- (long long)dataValidationDrawableId;
