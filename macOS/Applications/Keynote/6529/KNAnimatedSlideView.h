...
#import "KNAnimatedMovieControllerDelegate.h"
#import "KNCanvasDelegate.h"
#import "TSDConnectedInfoReplacing.h"
#import "TSDLiveTexturedRectangleSource.h"

@class KNAnimatedSlideModel, KNAnimationDelayedCallbacks, KNPlaybackSession, KNSlide, KNSlideMetalRenderer, KNSlideNode, NSArray, NSIndexSet, NSLock, NSMapTable, NSMutableArray, NSMutableSet, NSObject<OS_os_log>, NSSet, NSString, TSDCanvas;

@interface KNAnimatedSlideView : NSObject <KNCanvasDelegate, TSDConnectedInfoReplacing, KNAnimatedMovieControllerDelegate, TSDLiveTexturedRectangleSource>
{
...
- (void)p_tearDownMovieControllers;
- (void)p_setupMovieControllers;
- (void)p_stopMovieControllersAndReset:(BOOL)arg1;
