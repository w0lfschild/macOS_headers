...
@class KNAbstractSlide, KNActionGhostInfo, KNAnimationInfo, KNAnimationPluginMenu, KNBuildAttributes, KNBuildChunk, NSArray, NSMutableDictionary, NSObject<TSDInfo>, NSSet, NSString, NSUUID, TSDBezierPathSource, TSDDrawableInfo, TSDEditableBezierPathSource, TSUColor;
