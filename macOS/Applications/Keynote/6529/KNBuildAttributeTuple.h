...
@class KNBuild, KNBuildAttributeValue, KNBuildChunk, KNBuildChunkIdentifier, NSString, NSUUID, TSKCommand<KNBuildOrChunkUpdatingCommand>;
...
-     // Error parsing type: v32@0:8^{BuildAttributeTupleArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{BuildAttributeValueArchive}^{UUID}^{BuildChunkIdentifierArchive}}16@24, name: saveToArchive:archiver:
-     // Error parsing type: v32@0:8r^{BuildAttributeTupleArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{BuildAttributeValueArchive}^{UUID}^{BuildChunkIdentifierArchive}}16@24, name: loadFromArchive:unarchiver:
