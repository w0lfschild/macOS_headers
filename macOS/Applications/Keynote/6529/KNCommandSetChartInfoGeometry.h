...
-     // Error parsing type: v32@0:8^{ChartInfoGeometryCommandArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{InfoGeometryCommandArchive}^{Point}^{Size}^{Point}^{Size}}16@24, name: saveToArchive:archiver:
-     // Error parsing type: v32@0:8r^{ChartInfoGeometryCommandArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{InfoGeometryCommandArchive}^{Point}^{Size}^{Point}^{Size}}16@24, name: loadFromArchive:unarchiver:
