...
-     // Error parsing type: v32@0:8^{CommandSlideSetStyleArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{CommandArchive}^{UUIDPath}^{Reference}^{Reference}}16@24, name: saveToArchive:archiver:
- (void)saveToArchiver:(id)arg1;
-     // Error parsing type: v32@0:8r^{CommandSlideSetStyleArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{CommandArchive}^{UUIDPath}^{Reference}^{Reference}}16@24, name: loadFromArchive:unarchiver:
