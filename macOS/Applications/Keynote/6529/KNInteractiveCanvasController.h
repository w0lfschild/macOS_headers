...
@class CALayer, KNAbstractSlide, KNActionGhostManager, KNRepDragTrackerDelegate, KNRepTrackerDelegate, KNShow, KNSlideNode, NSArray, NSMutableArray, NSObject<KNHyperlinkDelegate>, NSObject<TSDInfo>, NSSet, NSString, TSDDrawableInfo, TSUColor;
...
- (BOOL)p_allowedToShowHyperlinkUIForDrawable:(id)arg1;
