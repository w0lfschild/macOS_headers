...
- (void)p_setupAnimationsWithContext:(id)arg1 animationContext:(id)arg2 animationOverrideBlock:(CDUnknownBlockType)arg3 shouldFlattenTextures:(BOOL)arg4 shouldAlwaysFadeUnmatchedObjects:(BOOL)arg5;
...
- (void)dealloc;
- (void)teardown;
- (id)initWithPluginContext:(id)arg1 animationContext:(id)arg2 animationOverrideBlock:(CDUnknownBlockType)arg3 shouldFlattenTextures:(BOOL)arg4 shouldAlwaysFadeUnmatchedObjects:(BOOL)arg5;
- (id)init;
