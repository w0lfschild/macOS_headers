...
@class KNMotionBlurAnimationPluginWrapper, NSArray, NSMutableArray, NSString;

@interface KNTransitionBlinds : KNAnimationEffect <KNTransitionCAAnimator, KNTransitionOpenGLAnimator, KNTransitionMetalAnimator, KNAnimationPluginArchiving>
{
