...
- (void)p_drawTwistWithPercent:(double)arg1 currentBuffer:(unsigned long long)arg2 texture:(id)arg3 oldTexture:(id)arg4 encoder:(id)arg5 isMotionBlurred:(BOOL)arg6 isUpdating:(BOOL)arg7;
- (void)p_drawTwistWithPercent:(double)arg1 texture:(id)arg2 oldTexture:(id)arg3;
- (void)update:(id)arg1 withContext:(id)arg2 isUpdating:(BOOL)arg3;
