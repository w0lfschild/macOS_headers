...
@interface GSSPAbstractSlide : GSSPPersistableObject
{
    ...
    vector_95cc1646 mInstructionalTextForInfosIdList;
    vector_95cc1646 mInstructionalTextForInfosStringList;
}
...
- (void)setInstructionalTextForInfosStringList:(const vector_95cc1646 *)arg1;
- (vector_95cc1646 *)instructionalTextForInfosStringList;
- (void)setInstructionalTextForInfosIdList:(const vector_95cc1646 *)arg1;
- (vector_95cc1646 *)instructionalTextForInfosIdList;
