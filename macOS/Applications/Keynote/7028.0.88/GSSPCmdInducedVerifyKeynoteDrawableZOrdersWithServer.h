...
#import <TSApplication/GSSPCmdInducedVerifyDrawableZOrdersWithServer.h>

#import "GSSPAutoDecodable-Protocol.h"

@interface GSSPCmdInducedVerifyKeynoteDrawableZOrdersWithServer : GSSPCmdInducedVerifyDrawableZOrdersWithServer <GSSPAutoDecodable>
{
}
