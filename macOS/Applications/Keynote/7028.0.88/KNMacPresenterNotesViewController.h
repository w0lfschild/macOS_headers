...
@protocol KNMacPresenterNotesViewControllerDelegate, TSDMacModalSheetPresentationDelegate><TSDUserDialogPresenter;
...
@interface KNMacPresenterNotesViewController : NSViewController <TSAInteractiveCanvasControllerDelegate>
{
    ...
    id <KNMacPresenterNotesViewControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <KNMacPresenterNotesViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
