...
#import "KNMacPresenterNotesContainer-Protocol.h"

@class KNInteractiveCanvasController, KNMacPresenterNotesPaneViewController, KNMacSlideViewController, KNMacTemporaryEmptyContentContainerViewController, KNSlideNode, KNSlideTreeEditor, NSColor, NSObject, NSResponder, NSString, NSTouchBar, NSView, NSViewController, TMAZoomStepper, TSDEditorController;
@protocol KNMacMainContentContainer, KNMacPresenterNotesContainer, KNSlideCollectionEditor, TSDCanvasEditor, TSDMacModalSheetPresentationDelegate><TSDUserDialogPresenter;
