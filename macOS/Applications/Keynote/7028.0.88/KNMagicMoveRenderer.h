...
+ (void)p_clearMovieTextureFromTextureSetIfNeeded:(id)arg1;
+ (void)p_applyMovieTextureSourceToTextureSetIfNeeded:(id)arg1 fromMovieAssetMap:(id)arg2 session:(id)arg3 slideNode:(id)arg4;
+ (void)generateLayersForMatches:(id)arg1 oldHiddenValuesMap:(id)arg2;
+ (void)clearMovieAssetsFromTexturesForMatches:(id)arg1;
+ (void)applyMovieAssetsToTexturesFromMovieAssetMap:(id)arg1 forMatches:(id)arg2 session:(id)arg3 outgoingSlideNode:(id)arg4 incomingSlideNode:(id)arg5;
