...
+ (void)writeFrom:(id)arg1 to:(struct PptBinaryWriter *)arg2 cancel:(id)arg3;
...
+ (void)readFrom:(struct PptBinaryReader *)arg1 to:(id)arg2 cancel:(id)arg3;
...
+ (void)readSlides:(id)arg1 masterLayoutMap:(id)arg2 slideIdMap:(id)arg3 state:(id)arg4;
