...
@class NSError, NSObject, NSString, NSURL, SFUCryptoKey, TSACollaborationBackgroundStagingDocument, TSACollaborationErrorAction, TSADocumentInfo, TSADocumentRoot, TSKCommandExecutor, TSKDocumentRoot, TSKMailboxDocStatusMessage, TSKSharingState, TSPData, TSPDocumentSaveValidationPolicy, TSPObjectContext, TSUDocumentSerializationToken, TSUSandboxedURL;
@protocol NSFilePresenter, OS_dispatch_queue, TSADocumentRootDelegate, TSADocumentStringProvider, TSKCancellable, TSKCollaborationCacheSessionInfoProcessor, TSKCollaborationCommandReceiver, TSKCollaborationSessionContext, TSKSharingService, TSPPassphraseConsumer, TSULogContext;
...
- (BOOL)shouldAttemptRecoveryAfterWritingWithWastefulComponents:(TSPObjectContext *)arg1;
...
- (id <TSKCancellable>)retrieveRemotePassphraseWithConsumer:(id <TSPPassphraseConsumer>)arg1 completionQueue:(NSObject<OS_dispatch_queue> *)arg2 completionHandler:(void (^)(BOOL, NSError *))arg3;
