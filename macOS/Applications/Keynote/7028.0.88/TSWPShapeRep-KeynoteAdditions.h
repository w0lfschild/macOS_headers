...
- (struct CGRect)p_getCaretRectForCharIndex:(unsigned long long)arg1 transform:(struct CGAffineTransform)arg2 integralBounds:(struct CGRect)arg3 leadingEdge:(BOOL)arg4;
