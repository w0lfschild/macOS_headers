...
@interface GSSPCmdDocumentInsertSlide : GSSPCmdBase <GSSPAutoDecodable>
{
    NSArray *mSlideNodesBeingInserted;
    NSArray *mArgsList;
    NSArray *mIdsOfSlideNodesWithDepthChanges;
    NSArray *mDepthsOfSlideNodesWithDepthChanges;
    NSArray *mMasterNodesOfSlidesBeingInserted;
    NSArray *mMasterSlideIdsOfSlides;
}
...
- (void)setMasterSlideIdsOfSlides:(id)arg1;
- (id)masterSlideIdsOfSlides;
- (void)setMasterNodesOfSlidesBeingInserted:(id)arg1;
- (id)masterNodesOfSlidesBeingInserted;
...
- (id)argsList;
- (void)setSlideNodesBeingInserted:(id)arg1;
- (id)slideNodesBeingInserted;
