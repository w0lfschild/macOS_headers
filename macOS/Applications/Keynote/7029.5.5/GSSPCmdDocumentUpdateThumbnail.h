...
@interface GSSPCmdDocumentUpdateThumbnail : GSSPCmdBase <GSSPAutoDecodable>
{
    vector_95cc1646 mSlideIdList;
...
- (void)setSlideIdList:(const vector_95cc1646 *)arg1;
- (vector_95cc1646 *)slideIdList;
