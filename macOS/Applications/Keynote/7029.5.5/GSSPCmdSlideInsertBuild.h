...
@class KNInsertBuildDescription;

@interface GSSPCmdSlideInsertBuild : GSSPCmdBase <GSSPAutoDecodable>
{
    KNInsertBuildDescription *mInsertBuildDescription;
}
...
- (void)setInsertBuildDescription:(id)arg1;
- (id)insertBuildDescription;
