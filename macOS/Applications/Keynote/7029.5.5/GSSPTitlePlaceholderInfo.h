...
@interface GSSPTitlePlaceholderInfo : GSSPPlaceholderInfo <GSSPAutoDecodable>
{
}
...
- (id)convertKNTitlePlaceholderInfoWithDecodeContext:(struct GSSPDecodeConversionContext *)arg1 error:(id *)arg2;
