...
@class KNBodyPlaceholderInfo, KNObjectPlaceholderInfo, KNSlideBackgroundInfo, KNSlideNode, KNSlideNumberPlaceholderInfo, KNSlideStyle, KNTitlePlaceholderInfo, KNTransition, NSArray, NSDictionary, NSIndexSet, NSMapTable, NSMutableArray, NSObject, NSOrderedSet, NSSet, NSString, TSDFill, TSDGuideStorage, TSDInfoGeometry, TSDReplaceableMediaMap, TSUMutablePointerSet, TSUPointerKeyDictionary;
