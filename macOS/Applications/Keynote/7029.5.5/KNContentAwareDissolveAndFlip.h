...
#import "KNContentAwareTransitionCAAnimator-Protocol.h"
#import "KNContentAwareTransitionMetalAnimator-Protocol.h"
#import "KNContentAwareTransitionOpenGLAnimator-Protocol.h"

@class KNAnimParameterGroup, KNMotionBlurAnimationPluginWrapper, NSString;

@interface KNContentAwareDissolveAndFlip : KNAnimationEffect <KNContentAwareTransitionCAAnimator, KNContentAwareTransitionOpenGLAnimator, KNContentAwareTransitionMetalAnimator, KNAnimationPluginArchiving>
{
