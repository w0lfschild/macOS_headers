...
@class KNKPFLayer, KNKPFMovie, KNKPFWebVideo, NSDictionary, NSMutableArray, NSString;
...
@interface KNKPFEffect : NSObject <KNKPFReading, KNKPFWriting>
{
    ...
    NSString *_objectID;
    KNKPFMovie *_movie;
    KNKPFWebVideo *_webVideo;
    NSMutableArray *_effects;
}

- (void).cxx_destruct;
@property(retain, nonatomic) NSMutableArray *effects; // @synthesize effects=_effects;
@property(retain, nonatomic) KNKPFWebVideo *webVideo; // @synthesize webVideo=_webVideo;
