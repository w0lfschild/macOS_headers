...
- (BOOL)isTargetTableMoved;
- (BOOL)hasCategories;
- (BOOL)hasCategoryTableRefs:(unsigned int)arg1;
- (id)stringFromStringTokenAtIndex:(unsigned long long)arg1;
- (int)tokenTypeAtIndex:(unsigned long long)arg1;
- (void)dealloc;
- (struct EDBuildablePtg *)leafUnionPtg:(struct EDBuildablePtg *)arg1;
- (void)crossRefForToken:(struct EDBuildablePtg *)arg1 rowOffset:(unsigned int)arg2 colOffset:(unsigned int)arg3 isCrossExplicitlyFailed:(char *)arg4;
