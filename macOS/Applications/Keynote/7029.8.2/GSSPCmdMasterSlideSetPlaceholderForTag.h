...
#import "GSSPCmdSlideSetPlaceholdersForTags.h"

#import "GSSPAutoDecodable-Protocol.h"

@class NSString, NSUUID;

@interface GSSPCmdMasterSlideSetPlaceholderForTag : GSSPCmdSlideSetPlaceholdersForTags <GSSPAutoDecodable>
{
    NSUUID *mPlaceholderId;
    NSString *mTag;
    BOOL mDefinedTag;
}
