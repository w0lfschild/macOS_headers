...
#import <TSDrawables/GSSPCmdContainerInsertChildren.h>

#import "GSSPAutoDecodable-Protocol.h"

@interface GSSPCmdThemePrimitiveInsertMasterSlideNode : GSSPCmdContainerInsertChildren <GSSPAutoDecodable>
{
}
