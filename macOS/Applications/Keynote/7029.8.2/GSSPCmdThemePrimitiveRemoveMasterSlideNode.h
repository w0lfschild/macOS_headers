...
#import <TSDrawables/GSSPCmdContainerRemoveChildren.h>

#import "GSSPAutoDecodable-Protocol.h"

@interface GSSPCmdThemePrimitiveRemoveMasterSlideNode : GSSPCmdContainerRemoveChildren <GSSPAutoDecodable>
{
}
