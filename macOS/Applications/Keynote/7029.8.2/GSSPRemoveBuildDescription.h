...
@interface GSSPRemoveBuildDescription : GSSPPersistableObject <GSSPAutoDecodable>
{
    NSUUID *mSlideId;
    NSUUID *mBuildId;
    BOOL mShouldRemoveChunks;
    BOOL mShouldRemoveChunkIdentifiers;
...
- (id)tuplesToUpdate;
- (void)setShouldRemoveChunkIdentifiers:(BOOL)arg1;
- (BOOL)shouldRemoveChunkIdentifiers;
- (void)setShouldRemoveChunks:(BOOL)arg1;
- (BOOL)shouldRemoveChunks;
