...
@class KNNoteInfo, NSArray, NSString;

@interface GSSPSlide : GSSPAbstractSlide
{
    NSString *mMasterSlideId;
    KNNoteInfo *mNote;
    NSArray *mInfoUUIDsUsingObjectPlaceholderGeometry;
}
...
- (void)setInfoUUIDsUsingObjectPlaceholderGeometry:(id)arg1;
- (id)infoUUIDsUsingObjectPlaceholderGeometry;
- (void)setNote:(id)arg1;
- (id)note;
- (void)setMasterSlideId:(id)arg1;
- (id)masterSlideId;
- (id)convertToKNSlideWithSlideNode:(id)arg1 andShow:(id)arg2;
