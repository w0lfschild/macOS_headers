...
#import <TSStyles/GSSPStyle.h>

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPSlideStyleProperties;

@interface GSSPSlideStyle : GSSPStyle <GSSPAutoDecodable>
{
    GSSPSlideStyleProperties *mOverridePropertyMap;
}
