...
@class KNInteractiveCanvasController, KNMacLightTableAndNotesContainerSplitViewController, KNMacLightTableToolbarView, KNMacLightTableZoomControlView, KNSlideNode, NSButton, NSColor, NSObject, NSString, NSTouchBar, NSView, TMAZoomStepper, TSDEditorController;
