...
@class KNDocumentRoot, KNInteractiveCanvasController, KNMacCanvasViewController, KNMacMasterSlideViewController, KNMasterSlideListEditor, KNSlideNode, NSButton, NSColor, NSObject, NSString, NSTextField, NSTouchBar, NSView, TMACellEditorHostHelper, TMAReplaceImageController, TMAZoomStepper, TSDEditorController, TSKDocumentRoot;
...
- (BOOL)canDropIntoContainer:(id)arg1;
