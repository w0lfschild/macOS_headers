...
- (void)textViewDidDiscardMarkedText:(KNMacOutlineTextView *)arg1;
- (void)textView:(KNMacOutlineTextView *)arg1 didSetMarkedText:(id)arg2 selectedRange:(struct _NSRange)arg3 replacementRange:(struct _NSRange)arg4;
