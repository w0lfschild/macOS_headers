...
@interface KNMacPresenterDisplayContentViewController : NSViewController <KNMacPresenterDisplayContentViewDelegate, KNMacPresenterDisplayElementDragControllerDelegate>
{
    ...
    BOOL _isUpdatingPresenterNotesDarkModeEnabledFromConfiguration;
    BOOL _isCurrentSlideViewVisible;
    BOOL _isNextSlideViewVisible;
    BOOL _didBeginCurrentSlideViewControllerViewBoundsAnimation;
    BOOL _didBeginCurrentSlideViewControllerViewInteractiveResize;
    BOOL _didBeginNextSlideViewControllerViewInteractiveResize;
...
- (id)p_playbackViewControllerForHitElementIdentifier:(id)arg1;
