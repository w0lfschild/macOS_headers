...
@class KNInteractiveCanvasController, KNMacSlideNavigatorView, KNNavigatorController, KNNavigatorLayer, KNSlideNode, KNSlideTreeEditor;
@protocol KNMacSlideTreeResponderDelegate;

@interface KNMacSlideNavigatorViewController : KNMacBaseSlideNavigatorViewController
{
