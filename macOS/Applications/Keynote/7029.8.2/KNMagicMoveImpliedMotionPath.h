...
@interface KNMagicMoveImpliedMotionPath : KNAnimationEffect <KNMagicMoveTransitionCAAnimator, KNMagicMoveTransitionOpenGLAnimator, KNMagicMoveTransitionMetalAnimator, KNAnimationPluginObsoleteNames, KNAnimationPluginArchiving>
{
...
- (void)nonMetalAnimationWillBeginWithContext:(id)arg1;
