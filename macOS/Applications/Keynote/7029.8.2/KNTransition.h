...
- (int)gsspSharingFlag;
-     // Error parsing type: v32@0:8^{TransitionArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}^{TransitionAttributesArchive}}16@24, name: saveToArchive:archiver:
-     // Error parsing type: @40@0:8r^{TransitionArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}^{TransitionAttributesArchive}}16@24@32, name: initWithArchive:unarchiver:owner:
