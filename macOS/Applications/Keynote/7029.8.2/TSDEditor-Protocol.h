...
@class NSArray, NSEvent, NSMenu, NSObject, NSSet, NSString, TSDCursor, TSDCursorPlatformObject, TSDEditorController, TSDRep, TSKDocumentRoot, TSKSelection, TSKSelectionPath;
...
- (TSDCursor *)cursorAtPoint:(struct CGPoint)arg1 withCursorPlatformObject:(TSDCursorPlatformObject *)arg2;
