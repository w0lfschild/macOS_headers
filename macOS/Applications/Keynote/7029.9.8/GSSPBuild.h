...
@class KNBuildAttributes, NSString, NSUUID;

@interface GSSPBuild : GSSPPersistableObject <GSSPAutoDecodable>
{
    NSUUID *mDrawableId;
    NSString *mDelivery;
...
- (void)setChunkIDSeed:(int)arg1;
- (int)chunkIDSeed;
- (void)setAttributes:(id)arg1;
- (id)attributes;
- (void)setDelivery:(id)arg1;
- (id)delivery;
- (void)setDrawableId:(id)arg1;
- (id)drawableId;
