...
@interface GSSPCmdThemeInsertMasterSlideNode : GSSPCmdBase <GSSPAutoDecodable>
{
    NSArray *mUndoMasterChangeCommands;
    BOOL mSetsInsertedSlideAsDefaultMasterSlide;
...
- (void)setSetsInsertedSlideAsDefaultMasterSlide:(BOOL)arg1;
- (BOOL)setsInsertedSlideAsDefaultMasterSlide;
- (void)setUndoMasterChangeCommands:(id)arg1;
- (id)undoMasterChangeCommands;
