...
- (double)p_normalizedRotationInDegreesCCWFromRotationBuilds;
- (double)p_normalizedRotationInDegreesCCWFromMotionPathBuild;
- (double)p_normalizedRotationInDegreesCCWFromBuilds;
- (id)p_previousDescriptionWithMotionPathBuild;
- (double)p_previousAlignToPathEndAngleMinusPathStartAngle;
@property(readonly, nonatomic) double startStateRotationRelativeToOriginalDrawable;
@property(readonly, nonatomic) double rotationRelativeToPreviousInfo;
@property(readonly, nonatomic) double rotationFromRotationBuildsRelativeToPreviousInfo;
