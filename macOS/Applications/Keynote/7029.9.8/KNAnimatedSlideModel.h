...
- (BOOL)willMovieInfoPlayInThroughTransition:(id)arg1 isKnownToBeShared:(BOOL)arg2;
- (BOOL)willMovieInfoPlayInThroughTransition:(id)arg1 outgoingCollection:(id)arg2;
- (BOOL)willMovieInfoPlayOutThroughTransition:(id)arg1;
