...
- (BOOL)p_isValidStartOffset:(unsigned long long)arg1 andValidEndOffset:(unsigned long long)arg2;
- (id)commandToSetStartOffset:(unsigned long long)arg1 andEndOffset:(unsigned long long)arg2;
...
- (unsigned long long)p_numberOfMotionBuildsOnDrawable;
