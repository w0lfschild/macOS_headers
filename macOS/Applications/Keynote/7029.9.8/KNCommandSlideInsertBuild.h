...
-     // Error parsing type: v32@0:8^{CommandSlideInsertBuildArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}^{CommandArchive}^{Reference}^{BuildChunkIdentifierArchive}BBB}16@24, name: saveToArchive:archiver:
-     // Error parsing type: v32@0:8r^{CommandSlideInsertBuildArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{RepeatedPtrField<TSP::Reference>=^{Arena}ii^{Rep}}^{CommandArchive}^{Reference}^{BuildChunkIdentifierArchive}BBB}16@24, name: loadFromArchive:unarchiver:
