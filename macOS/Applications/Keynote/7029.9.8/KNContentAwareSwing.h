...
@class KNMagicMoveWrapper, KNMotionBlurAnimationPluginWrapper, KNMotionBlurWrapper, NSMutableArray, NSString;

@interface KNContentAwareSwing : KNAnimationEffect <KNMagicMoveTransitionCAAnimator, KNMagicMoveTransitionOpenGLAnimator, KNMagicMoveTransitionMetalAnimator>
{
