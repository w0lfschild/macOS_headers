...
@interface KNNavigatorLayer : TSDNoDefaultImplicitActionLayer <CAAnimationDelegate>
{
    ...
    double _additionalSelectionLeadingInset;
...
@property(nonatomic) double additionalSelectionLeadingInset; // @synthesize additionalSelectionLeadingInset=_additionalSelectionLeadingInset;
...
- (void)dragWillEnd;
- (void)dragPerformedForSlideLayer:(id)arg1 thumbnailPaneSizeOverride:(struct CGSize)arg2;
...
- (struct CGSize)p_slideLayerSizeForIndentLevel:(unsigned long long)arg1;
