...
@class KNAnimatedSlideModel, KNPlaybackSession, KNSlide, KNSlideMetalRenderer, KNSlideNode, NSArray, NSIndexSet, NSLock, NSMapTable, NSMutableArray, NSMutableSet, NSSet, NSString, TSDCanvas;
