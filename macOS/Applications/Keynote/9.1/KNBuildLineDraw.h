...
#import "KNAnimationPluginParameterizedStrokes.h"
...
- (struct CATransform3D)transformForLineEnd:(id)arg1 offsetAlongPath:(double)arg2 scale:(double)arg3 popPercent:(double)arg4 flipOrtho:(BOOL)arg5 adjustTransform:(BOOL)arg6;
