...
#import "KNMacZoomableContentContainer.h"
#import "NSTouchBarProvider.h"
#import "TSWPMacRulerControllerDelegate.h"

@class KNInteractiveCanvasController, KNMacCanvasViewController, KNSlideNode, NSArray, NSColor, NSCountedSet, NSMutableSet, NSObject<KNSlideCollectionEditor>, NSObject<NSTouchBarDelegate>, NSObject<TSDCanvasEditor>, NSString, NSTouchBar, NSView, NSVisualEffectView, TMAZoomStepper, TSDEditorController, TSKScrollView, TSWPMacRulerController;
