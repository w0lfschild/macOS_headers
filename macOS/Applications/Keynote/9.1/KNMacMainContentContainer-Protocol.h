...
@class KNInteractiveCanvasController, KNSlideNode, NSArray, NSColor, NSObject<KNSlideCollectionEditor>, NSObject<TSDCanvasEditor>, NSTouchBar, NSView, TMAZoomStepper, TSDEditorController, TSDInteractiveCanvasController;
