...
@class KNPlaybackController, KNPlaybackThumbnailGenerator, KNRecording, KNRecordingController, KNRecordingPlaybackController, KNRecordingScrubberSliderMarkerValueArray, KNRecordingSoundtrackAssetLoader, NSHashTable, NSObject<KNLaserOverlayController>, NSObject<KNTimebase>, NSString, NSTimer;
