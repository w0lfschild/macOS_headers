...
@class MSChannelUnitConfiguration, MSEncrypter, MSErrorReport, MSPLCrashReporter, NSMutableArray, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSObject<OS_dispatch_source>, NSString;
