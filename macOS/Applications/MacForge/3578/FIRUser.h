...
- (void)sendEmailVerificationBeforeUpdatingEmail:(id)arg1 actionCodeSettings:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)sendEmailVerificationBeforeUpdatingEmail:(id)arg1 completion:(CDUnknownBlockType)arg2;
