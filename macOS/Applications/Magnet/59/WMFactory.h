...
@class AXManager, AXSystemElement, NSStatusItem, NSUserDefaults, WMAppSettings, WMBezelController, WMDragObserver, WMFactoryBlacklist, WMFocusObserver, WMRatingReminderController, WMUserBlackList, WMWindowManager;
...
@interface WMFactory : NSObject
{
    ...
    AXManager *_accessibilityManager;
}

@property(retain) AXManager *accessibilityManager; // @synthesize accessibilityManager=_accessibilityManager;
...
- (id)wireSettings;
- (BOOL)isDynamoInstalled;
- (BOOL)shouldDisplayDynamo;
- (id)maximumVersionToDisplayDynamo;
- (id)init;
