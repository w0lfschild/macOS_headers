...
@interface MessageViewer : NSResponder <FlaggedStatusToolbarItemDelegate, MessageViewerSearchFieldFocusDelegate, NSToolbarDelegate, MSSearchSessionControllerDataSource, NSTouchBarDelegate, NSTouchBarProvider, MailboxesOutlineViewControllerDelegate, MailboxSelectionOwner, MCActivityTarget, MessageTransferDelegate, NSAnimationDelegate, NSSpeechSynthesizerDelegate, NSUserInterfaceValidations, NSWindowDelegate, NSWindowRestoration, SGTSearchFieldQueryScopeDelegate, TerminationHandler>
{
    ...
    _LeftAlignedMailboxSegmentedControl *_moveToFolderSegmentedControl;
}
...
@property(retain, nonatomic) _LeftAlignedMailboxSegmentedControl *moveToFolderSegmentedControl; // @synthesize moveToFolderSegmentedControl=_moveToFolderSegmentedControl;
...
- (id)_messageFromUserInteraction;
