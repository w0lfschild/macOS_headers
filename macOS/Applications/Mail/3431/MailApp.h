...
@class ActivityWindowController, DeliveryQueue, DockCountController, DynamicErrorWindowController, FlagIconFactory, FlagsMenuItemView, MailActivityNotifier, MailboxesController, NSArray, NSMenu, NSMutableArray, NSMutableSet, NSOperationQueue, NSString, NSTimer, NSTouchBar, NSURL, NSWindow, SortByMenuDelegate, UserActivityHandler;
@protocol SelectionOwner;

@interface MailApp : NSApplication <IMAPUserAgent, MCUserAgent, MFUserAgent, NSTouchBarDelegate, NSTouchBarProvider, MCActivityTarget, NSApplicationDelegate, NSMenuDelegate, TerminationHandler>
{
