...
@class MFLibraryStore, MessageListContentProvider, NSArray, NSDictionary, NSMutableDictionary, NSPredicate, NSString, NSTimer;
...
@interface MessageListContentController : NSObject <MessageListContentProviderDelegate, MCMessageDataSource>
{
    ...
    NSMutableDictionary *_messagesByProviderType;
...
@property(retain, nonatomic) NSMutableDictionary *messagesByProviderType; // @synthesize messagesByProviderType=_messagesByProviderType;
...
- (id)_searchStoreWithName:(id)arg1;
