...
@class CNAvatarViewController, ConversationMember, HeaderTextContainer, HeaderTruncationAttachmentCell, NSButton, NSLayoutConstraint, NSString, NSTextAttachment, NSTextField, NSTextView, NSView, UnreadVIPButton;
