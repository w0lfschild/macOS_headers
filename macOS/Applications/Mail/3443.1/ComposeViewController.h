...
@class ColorBackgroundView, ComposeBackEnd, ComposeStatusView, DeliveryFailure, EditingMessageWebView, EditingWebMessageController, HeadersEditor, LoadingOverlay, MCAttachment, NSArray, NSButton, NSDictionary, NSOperation, NSOperationQueue, NSStackView, NSString, NSTextField, NSTextFinder, NSView, ReportBugWindowController, StationerySelector, WebArchive, WebViewEditor, _ControllerTitleTransformer;
