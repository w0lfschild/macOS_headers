...
- (void)column:(id)arg1 wasMadeVisible:(BOOL)arg2 inTableView:(id)arg3 forMailboxes:(id)arg4 isSearching:(BOOL)arg5 searchTarget:(long long)arg6 searchField:(long long)arg7;
- (void)sizeColumnsToFitInTableView:(id)arg1 forMailboxes:(id)arg2 isThreaded:(BOOL)arg3 threadingDidChange:(BOOL)arg4;
- (void)showColumnsInTableView:(id)arg1 allColumns:(id)arg2 forSearchTarget:(long long)arg3 searchField:(long long)arg4 mailboxes:(id)arg5 isThreaded:(BOOL)arg6;
...
- (BOOL)_column:(long long)arg1 isAnAutomaticInsertColumnForMailboxType:(id)arg2 mailboxes:(id)arg3 multipleMailboxes:(BOOL)arg4 isSearching:(BOOL)arg5 searchTarget:(long long)arg6 searchField:(long long)arg7;
...
- (id)_visibleTableColumnSettingsForMailboxes:(id)arg1 multipleMailboxes:(BOOL)arg2 ofType:(id)arg3 withLastViewedDate:(BOOL)arg4 isThreaded:(BOOL)arg5 isSearching:(BOOL)arg6 searchTarget:(long long)arg7 searchField:(long long)arg8 tableView:(id)arg9;
...
- (void)takeDefaultsForMailboxes:(id)arg1 isThreaded:(BOOL)arg2 isSearching:(BOOL)arg3 searchTarget:(long long)arg4 fromCurrentColumnsInTableView:(id)arg5;
- (void)saveColumnPreferencesToStandardDefaults;
- (void)dealloc;
- (id)init;
- (id)initWithTableColumns:(id)arg1;
