...
@class ActivityWindowController, DeliveryQueue, DockCountController, DynamicErrorWindowController, FlagIconFactory, FlagsMenuItemView, MFAccountFactory_macOS, MailActivityNotifier, MailBundleController, MailboxesController, NSArray, NSMenu, NSMutableArray, NSMutableSet, NSOperationQueue, NSString, NSTimer, NSTouchBar, NSURL, NSUserDefaults, NSWindow, NSWindowController, SortByMenuDelegate, UserActivityHandler;
