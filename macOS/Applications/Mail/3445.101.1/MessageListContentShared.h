...
+ (long long)messageFlagsForMessage:(id)arg1 size:(unsigned long long *)arg2 appliedFlagColors:(id *)arg3 originalMessageByMessageID:(id)arg4 messageCopiesByMessageID:(id)arg5 includeDeleted:(BOOL)arg6;
