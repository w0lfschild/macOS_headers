...
@class DOMHTMLDocument, DOMNode, EditableWebMessageDocument, MCInvocationQueue, MCMessage, MCMessageBody, MCMessageHeaders, MFDeliveryAccount, MFMailAccount, MFMailbox, MFSignature, NSArray, NSFont, NSInputStream, NSLock, NSMutableArray, NSMutableData, NSMutableDictionary, NSMutableSet, NSNumber, NSOperationQueue, NSOutputStream, NSPort, NSScriptObjectSpecifier, NSString, NSUUID, NSUndoManager, NSUserActivity, SMIMEEncryptionState, StationeryController;
