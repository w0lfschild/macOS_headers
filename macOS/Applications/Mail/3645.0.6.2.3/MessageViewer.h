...
@interface MessageViewer : NSResponder <FlaggedStatusToolbarItemDelegate, MessageViewerSearchFieldFocusDelegate, NSToolbarDelegate, MSSearchSessionControllerDataSource, NSTouchBarDelegate, NSTouchBarProvider, NSMenuItemValidation, NSColorChanging, EFLoggable, MailboxesOutlineViewControllerDelegate, MailboxSelectionOwner, MCActivityTarget, MessageTransferDelegate, NSAnimationDelegate, NSSpeechSynthesizerDelegate, NSUserInterfaceValidations, NSWindowDelegate, NSWindowRestoration, SGTSearchFieldQueryScopeDelegate, TerminationHandler>
{
    ...
    BOOL _removeArchiveAndSpaceToolbarItem;
...
- (void).cxx_destruct;
@property(nonatomic) BOOL removeArchiveAndSpaceToolbarItem; // @synthesize removeArchiveAndSpaceToolbarItem=_removeArchiveAndSpaceToolbarItem;
