...
@interface MailApp : NSApplication <IMAPUserAgent, MCUserAgent, MFUserAgent, NSTouchBarDelegate, NSTouchBarProvider, NSToolbarItemValidation, ToolbarItemUpdater, MCActivityTarget, NSApplicationDelegate, NSMenuDelegate, NSTabViewDelegate, TerminationHandler>
{
