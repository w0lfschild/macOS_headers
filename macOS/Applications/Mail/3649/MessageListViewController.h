...
@class ClassicMenuHeaderController, MailTableView, MessageListFilterMenuHelper, MessageListLayoutViewController, MessageListSearchProgressView, MessageViewer, NSArray, NSButton, NSLayoutConstraint, NSString, RichMessageListSortView, TableViewManager;
