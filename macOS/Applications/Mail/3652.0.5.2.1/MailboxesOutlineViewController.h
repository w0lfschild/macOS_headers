...
@class EFAutoCancelationToken, FavoritesManager, MFMailbox, MailboxOutlineItem, MailboxOutlineItemProvider, MailboxesOutlineView, NSArray, NSDictionary, NSMapTable, NSString, NSWindow;
