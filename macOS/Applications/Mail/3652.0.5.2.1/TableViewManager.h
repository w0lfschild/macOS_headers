...
@class ConversationPrefetcher, MCMessage, MFGlobalBodyFetchContext, MFMessageThread, MailTableView, MessageListColumnManager, MessageListContentController, MessageSelection, NSArray, NSCache, NSDictionary, NSFont, NSMapTable, NSMutableArray, NSMutableSet, NSNumber, NSPredicate, NSSet, NSString, NSTableColumn, NSTableHeaderView, TableViewScrollState;
@protocol MCMessageDataSource, SortTitleSetter, TableViewManagerDelegate;

@interface TableViewManager : NSObject <MessageListContentControllerDelegate, NSPasteboardItemDataProvider, NSServicesMenuRequestor, RichTableRowViewDelegate, MailTableViewDelegate, NSTableViewDataSource, SelectionOwner>
{
...
- (unsigned long long)_groupingStyleForMessageListItem:(id)arg1 atIndex:(long long)arg2;
- (long long)_rowStyleForMessageListItem:(id)arg1;
