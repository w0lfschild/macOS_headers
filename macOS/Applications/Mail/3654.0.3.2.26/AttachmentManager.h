...
- (void)_addPurgeEntryForAttachmentAtPath:(id)arg1 modDate:(id)arg2 messageIDHeader:(id)arg3 partNumber:(id)arg4;
...
- (id)urlsForDraggedAttachments:(id)arg1 fromView:(id)arg2;
