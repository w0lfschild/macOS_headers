...
#import "_HeaderViewMouseTrackingStackViewDelegate-Protocol.h"

@class CNAvatarViewController, ConversationMember, HeaderTextContainer, HeaderTruncationAttachmentCell, NSBox, NSButton, NSImage, NSImageView, NSLayoutConstraint, NSStackView, NSString, NSTextField, NSTextView, _HeaderViewMouseTrackingStackView;

@interface HeaderViewController : NSViewController <NSLayoutManagerDelegate, NSTextViewDelegate, NSTokenAttachmentDelegate, QLPreviewMenuItemDelegate, _HeaderViewMouseTrackingStackViewDelegate, NSDraggingSource, NSMenuDelegate>
{
    NSTextField *_dateView;
    NSTextField *_mailboxView;
    NSButton *_detailsLink;
    _HeaderViewMouseTrackingStackView *_indicatorStackView;
    NSImageView *_unreadIndicator;
    NSButton *_vipButton;
    NSImage *_vipOnImage;
    NSImage *_vipOffImage;
    NSStackView *_extrasStackView;
    NSImageView *_attachmentIndicator;
    NSImageView *_flagIndicator;
...
- (void)mouseExitedStackView:(id)arg1;
- (void)mouseEnteredStackView:(id)arg1;
...
- (void)_updateFlagIndicator;
- (void)_updateAttachmentIndicator;
...
@property(readonly, nonatomic) NSImageView *flagIndicator;
@property(readonly, nonatomic) NSImageView *attachmentIndicator;
@property(readonly, nonatomic) NSStackView *extrasStackView;
@property(readonly, nonatomic) NSImage *vipOffImage;
@property(readonly, nonatomic) NSImage *vipOnImage;
- (void)_setVIPOffImage;
- (void)_setVIPOnImage;
@property(readonly, nonatomic) NSButton *vipButton;
@property(readonly, nonatomic) NSImageView *unreadIndicator;
@property(readonly, nonatomic) _HeaderViewMouseTrackingStackView *statusIndicatorStackView;
