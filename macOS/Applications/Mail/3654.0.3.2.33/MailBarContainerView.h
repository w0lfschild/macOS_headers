...
@class FavoritesBarView, MailBarContainerButton, MessageViewer, NSArray, NSButton, NSLayoutConstraint, NSStackView, NSString;
...
@interface MailBarContainerView : NSView <NSAccessibilityGroup>
{
    ...
    NSArray *_searchScopeMailboxes;
}

- (void).cxx_destruct;
@property(nonatomic) BOOL isShowingSearchResults; // @synthesize isShowingSearchResults=_isShowingSearchResults;
@property(copy, nonatomic) NSArray *searchScopeMailboxes; // @synthesize searchScopeMailboxes=_searchScopeMailboxes;
...
- (void)setSearchScopeViewVisible:(BOOL)arg1;
