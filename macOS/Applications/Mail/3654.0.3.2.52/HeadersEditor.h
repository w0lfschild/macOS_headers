...
@interface HeadersEditor : NSObject <MUIAddressFieldSenderAddressHandler, MUIAddressFieldContextProvider, NSMenuItemValidation, NSControlTextEditingDelegate, AccountStatusDataSourceDelegate, NSStackViewDelegate, NSUserInterfaceValidations>
{
