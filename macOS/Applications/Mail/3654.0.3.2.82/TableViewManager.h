...
#import "RichTableRowViewDelegate-Protocol.h"
#import "SelectionOwner-Protocol.h"
#import "TableViewGroupingHelperDelegate-Protocol.h"

@class ConversationPrefetcher, MCMessage, MFGlobalBodyFetchContext, MFMessageThread, MailTableView, MessageListColumnManager, MessageListContentController, MessageSelection, NSArray, NSCache, NSDictionary, NSFont, NSMapTable, NSMutableArray, NSMutableSet, NSNumber, NSPredicate, NSSet, NSString, NSTableColumn, NSTableHeaderView, TableViewGroupingHelper, TableViewScrollState;
@protocol MCMessageDataSource, SortTitleSetter, TableViewManagerDelegate;

@interface TableViewManager : NSObject <MessageListContentControllerDelegate, NSPasteboardItemDataProvider, NSServicesMenuRequestor, RichTableRowViewDelegate, TableViewGroupingHelperDelegate, MailTableViewDelegate, NSTableViewDataSource, SelectionOwner>
{
    ...
    MessageListColumnManager *_columnManager;
    ...
    TableViewGroupingHelper *_groupingHelper;
    ...
    NSNumber *_searchHeaderViewHeight;
    ...
    NSDictionary *_viewingStateOnMouseDownInHeaderOfTableColumn;
...
+ (id)log;
- (void).cxx_destruct;
@property(copy, nonatomic) NSDictionary *viewingStateOnMouseDownInHeaderOfTableColumn; // @synthesize viewingStateOnMouseDownInHeaderOfTableColumn=_viewingStateOnMouseDownInHeaderOfTableColumn;
...
@property(retain, nonatomic) NSNumber *searchHeaderViewHeight; // @synthesize searchHeaderViewHeight=_searchHeaderViewHeight;
...
@property(retain, nonatomic) TableViewGroupingHelper *groupingHelper; // @synthesize groupingHelper=_groupingHelper;
@property(retain, nonatomic) NSArray *tableColumns; // @synthesize tableColumns=_tableColumns;
...
@property(nonatomic, getter=isColumnLayoutMessageList) BOOL columnLayoutMessageList; // @synthesize columnLayoutMessageList=_columnLayoutMessageList;
@property(retain, nonatomic) MessageListColumnManager *columnManager; // @synthesize columnManager=_columnManager;
...
- (CDStruct_912cb5d2)tableViewGroupingHelper:(id)arg1 rowStyleForMessageAtIndex:(long long)arg2;
- (CDStruct_912cb5d2)_rowStyleForMessageListItem:(id)arg1;
- (id)_rowViewBackgroundColorForMessageListItem:(id)arg1 emphasized:(BOOL)arg2;
- (id)backgroundColorForRichTableRowView:(id)arg1;
...
- (void)searchForSuggestions:(id)arg1 withOptions:(long long)arg2 fromSuggestionsSearchField:(id)arg3 filterPredicate:(id)arg4;
...
- (BOOL)mailTableView:(id)arg1 shouldShowMenuForRow:(long long)arg2;
...
- (void)_resetObjectValueForCellView:(id)arg1 isSelected:(BOOL)arg2;
- (void)_resetObjectValueForCellView:(id)arg1;
- (BOOL)_shouldShowMailboxNames;
- (id)_tintColorForColumn:(id)arg1;
- (void)_prepareCell:(id)arg1 column:(id)arg2 withMessage:(id)arg3;
...
- (void)_reloadDisplayForVisibleMessages;
...
- (void)_calculateMinimumColumnWidths;
