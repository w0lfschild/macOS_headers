...
@interface MessageViewController : NSViewController <NSMenuDelegate, NSStackViewDelegate, EFLoggable, NSMenuItemValidation, NSToolbarItemValidation, PopoutAnimationContentProvider>
{
    BOOL _suppressesContentUpdates;
    BOOL _displayedInCellView;
    NSView *_headerView;
...
@property(nonatomic, getter=isDisplayedInCellView) BOOL displayedInCellView; // @synthesize displayedInCellView=_displayedInCellView;
