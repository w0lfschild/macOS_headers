...
@interface MailTableView : NSTableView <EFLoggable, NSScrollViewDelegate>
{
    ...
    BOOL _delegateRespondsToShouldShowMenu;
    NSLayoutConstraint *_widthConstraint;
}

+ (id)log;
- (void).cxx_destruct;
@property(nonatomic) BOOL delegateRespondsToShouldShowMenu; // @synthesize delegateRespondsToShouldShowMenu=_delegateRespondsToShouldShowMenu;
