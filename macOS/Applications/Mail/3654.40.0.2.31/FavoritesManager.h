...
+ (void)_resetDefaults;
+ (id)_orderedSpecialMailboxDatums;
...
- (BOOL)_addMailboxDatum:(id)arg1 toData:(id)arg2 prepend:(BOOL)arg3 allowRelativeInsertion:(BOOL)arg4;
...
- (void)_addDefaultMailboxesToData:(id)arg1 addFlags:(BOOL)arg2 addDrafts:(BOOL)arg3;
