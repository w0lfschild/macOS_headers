...
#import "FavoritesManagerMailboxExistence-Protocol.h"

@class FavoritesManager, MailboxOutlineItemProvider, NSArray, NSConditionLock, NSMutableDictionary, NSMutableSet, NSOperationQueue, NSSet, NSString;

@interface MailboxesOutlineViewStateStorage : NSObject <EFLoggable, FavoritesManagerMailboxExistence>
{
    ...
    NSMutableSet *_activeAccounts;
    BOOL _userCollapsedFavoritesSection;
    NSArray *_draggedItems;
    FavoritesManager *_favoritesManager;
    MailboxOutlineItemProvider *_itemProvider;
    NSSet *_observedTaskNames;
    NSOperationQueue *_showVariablesUpdateQueue;
}
...
@property(readonly, nonatomic) MailboxOutlineItemProvider *itemProvider; // @synthesize itemProvider=_itemProvider;
@property(retain, nonatomic) FavoritesManager *favoritesManager; // @synthesize favoritesManager=_favoritesManager;
@property(retain) NSArray *draggedItems; // @synthesize draggedItems=_draggedItems;
@property(nonatomic) BOOL userCollapsedFavoritesSection; // @synthesize userCollapsedFavoritesSection=_userCollapsedFavoritesSection;
...
@property(readonly) NSArray *draggedMailboxesIncludingAccountRoots;
@property(readonly) NSArray *draggedMailboxes;
@property(readonly, copy) NSArray *visibleMailboxes;
- (id)visibleSectionItemsInSearchMode:(BOOL)arg1;
...
- (id)_sectionOutlineItemsFromDefaultSectionItemIDs:(id)arg1;
