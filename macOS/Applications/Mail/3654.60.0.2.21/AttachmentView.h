...
@interface AttachmentView : NSView <NSSharingServicePickerDelegate, ServicesRolloverViewDelegate, NSViewToolTipOwner, NSAccessibilityImage, NSDraggingSource, NSSharingServiceDelegate>
{
