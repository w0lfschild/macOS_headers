...
@interface MailboxesChooser : NSObject <NSMenuDelegate>
{
    ...
    BOOL _includeAllSpecials;
    BOOL _includeSmartMailboxes;
    BOOL _useSelection;
    CDUnknownBlockType _includeMailboxCondition;
    CDUnknownBlockType _enableMailboxCondition;
    CDUnknownBlockType _traverseChildrenOfMailboxCondition;
    id _target;
    SEL _action;
...
@property(nonatomic) BOOL includeSmartMailboxes; // @synthesize includeSmartMailboxes=_includeSmartMailboxes;
@property(nonatomic) BOOL includeAllSpecials; // @synthesize includeAllSpecials=_includeAllSpecials;
@property(retain, nonatomic) NSArray *additionalItems; // @synthesize additionalItems=_additionalItems;
@property(nonatomic) SEL action; // @synthesize action=_action;
@property(nonatomic) __weak id target; // @synthesize target=_target;
@property(copy, nonatomic) CDUnknownBlockType traverseChildrenOfMailboxCondition; // @synthesize traverseChildrenOfMailboxCondition=_traverseChildrenOfMailboxCondition;
...
- (void)_addMenuItemsForItems:(id)arg1 toMenu:(id)arg2 withIndentationLevel:(long long)arg3 initialSeparatorItem:(BOOL)arg4 parentMailbox:(id)arg5;
- (id)_menuItemForItem:(id)arg1 indentationLevel:(long long)arg2 parentMailbox:(id)arg3;
