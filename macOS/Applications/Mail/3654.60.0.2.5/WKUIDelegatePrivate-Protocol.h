...
@class NSArray, NSData, NSDictionary, NSEvent, NSMenu, NSString, NSURL, WKFrameInfo, WKNavigationAction, WKSecurityOrigin, WKWebView, WKWebViewConfiguration, WKWindowFeatures, _WKAttachment, _WKContextMenuElementInfo, _WKFrameHandle, _WKHitTestResult, _WKWebAuthenticationPanel;
