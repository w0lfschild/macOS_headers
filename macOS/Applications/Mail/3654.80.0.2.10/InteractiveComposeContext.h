...
@interface InteractiveComposeContext : BasicComposeContext
{
    ...
    CDUnknownBlockType _composeAnimationCompletion;
...
@property(copy, nonatomic) CDUnknownBlockType composeAnimationCompletion; // @synthesize composeAnimationCompletion=_composeAnimationCompletion;
