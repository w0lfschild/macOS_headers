...
@class AccountManager, ActivityWindowController, DeliveryQueue, DockCountController, DynamicErrorWindowController, EDCategorySubsystem, EDInteractionEventLogFile, EDInteractionLogger, EMBlockedSenderManager, ErrorController, FlagIconFactory, FlagsMenuItemView, MailActivityNotifier, MailBundleController, MailboxesController, NSArray, NSMenu, NSMutableArray, NSMutableSet, NSOperationQueue, NSString, NSTimer, NSTouchBar, NSUserDefaults, NSWindow, NSWindowController, SortByMenuDelegate, UserActivityHandler;
@protocol SelectionOwner;

@interface MailApp : NSApplication <IMAPUserAgent, MCUserAgent, MFUserAgent, NSTouchBarDelegate, NSTouchBarProvider, NSToolbarItemValidation, ToolbarItemUpdater, EFLoggable, MCActivityTarget, NSApplicationDelegate, NSMenuDelegate, NSTabViewDelegate, TerminationHandler>
{
...
- (void)_occlusionStateDidChange:(id)arg1;
...
- (void)_upgradeDeleteJunkToolbarItems;
