...
@interface SingleMessageViewer : MessageViewer <EFLoggable, NSMenuItemValidation, NSToolbarDelegate, NSWindowRestoration, SelectionOwner>
{
    BOOL _shouldCloseOnSpaceBar;
    BOOL _nibLoaded;
...
@property(nonatomic) BOOL shouldCloseOnSpaceBar; // @synthesize shouldCloseOnSpaceBar=_shouldCloseOnSpaceBar;
