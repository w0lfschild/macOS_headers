...
@class ACAccount, EDiCloudAliasSupport, NSImage, NSPopUpButton, NSString;
...
@interface AccountInformationController : NSViewController
{
    ...
    id <EFScheduler> _aliasUpdateScheduler;
...
- (void).cxx_destruct;
@property(retain, nonatomic) EDiCloudAliasSupport *aliasSupport; // @synthesize aliasSupport=_aliasSupport;
@property(retain, nonatomic) id <EFScheduler> aliasUpdateScheduler; // @synthesize aliasUpdateScheduler=_aliasUpdateScheduler;
