...
@interface ComposeBackEnd : NSObject <AttachmentManagerDelegate, ImageConverterDelegate, MCActivityTarget, NSStreamDelegate, NSUserActivityDelegate>
{
    ...
    BOOL _originalMessageIsEncrypted;
...
@property BOOL originalMessageIsEncrypted; // @synthesize originalMessageIsEncrypted=_originalMessageIsEncrypted;
...
- (void)_updateSMIMEStatusAndSaveContentsUserInitiated:(BOOL)arg1 onlyIfHasSignificantContent:(BOOL)arg2;
