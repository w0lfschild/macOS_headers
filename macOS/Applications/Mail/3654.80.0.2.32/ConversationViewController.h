...
@class ConversationMember, ConversationMemberArrayController, ConversationViewFindController, MUICollectionView, MessageSelection, MessageViewController, NSArray, NSHashTable, NSMutableDictionary, NSMutableIndexSet, NSMutableOrderedSet, NSMutableSet, NSScrollView, NSString, NSUUID, NSVisualEffectView;
@protocol NSTextFinderBarContainer;

@interface ConversationViewController : NSViewController <MUICollectionViewDelegate, NSToolbarItemValidation, NSMenuItemValidation, EFLoggable, NSUserInterfaceValidations>
{
