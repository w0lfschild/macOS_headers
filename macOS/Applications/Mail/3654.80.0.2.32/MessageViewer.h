...
@class ActivityViewController, EFFuture, FavoritesBarView, FavoritesBarViewController, FlaggedStatusToolbarItem, MCMessage, MFMailbox, MSDiagnosticManager, MSSearchSessionController, MailBarContainerView, MailToolbar, MailboxOutlineItem, MailboxOutlineItemSelectionState, MailboxesOutlineViewController, MailboxesViewController, MessageListContentController, MessageListViewController, MessageSelection, MessageViewerSearchField, NSArray, NSButton, NSDictionary, NSIndexSet, NSMenu, NSMenuItem, NSMutableArray, NSMutableDictionary, NSNumber, NSPopoverTouchBarItem, NSSegmentedControl, NSSplitViewController, NSSplitViewItem, NSStackView, NSString, NSTextField, NSTimer, NSToolbarItem, NSTouchBar, NSTrackingSeparatorToolbarItem, NSView, NSWindow, SGTMailQueryGenius, SegmentedToolbarItem, TableViewManager, ViewingPaneViewController, _MailboxSegmentedControl;
@protocol EFCancelable;

@interface MessageViewer : NSResponder <FlaggedStatusToolbarItemDelegate, ToolbarItemUpdater, MessageViewerSearchFieldFocusDelegate, NSToolbarDelegate, MSSearchSessionControllerDataSource, NSTouchBarDelegate, NSTouchBarProvider, NSMenuItemValidation, NSColorChanging, EFLoggable, MailboxesOutlineViewControllerDelegate, MailboxSelectionOwner, MCActivityTarget, MessageTransferDelegate, NSAnimationDelegate, NSSpeechSynthesizerDelegate, NSUserInterfaceValidations, NSWindowDelegate, NSWindowRestoration, SGTSearchFieldDelegate, SGTSearchFieldQueryScopeDelegate, TerminationHandler>
{
    ...
    MailboxOutlineItemSelectionState *_mailboxSelectionState;
    ...
    NSTrackingSeparatorToolbarItem *_separatorToolbarItem;
...
+ (void)_mailApplicationDidFinishRestoringWindows:(id)arg1;
...
@property(nonatomic) __weak NSTrackingSeparatorToolbarItem *separatorToolbarItem; // @synthesize separatorToolbarItem=_separatorToolbarItem;
...
@property(nonatomic) BOOL previewPaneVisible; // @synthesize previewPaneVisible=_previewPaneVisible;
...
@property(retain, nonatomic) MailboxOutlineItemSelectionState *mailboxSelectionState; // @synthesize mailboxSelectionState=_mailboxSelectionState;
...
- (void)togglePreviewPosition:(id)arg1;
...
- (BOOL)_updateMoveToPredictiveFolderMenuItem:(id)arg1 withMailbox:(id)arg2 generatePrediction:(BOOL)arg3;
...
- (void)_setMailboxes:(id)arg1 forceUpdate:(BOOL)arg2;
...
- (id)selectedMessages;
- (void)setSelectedFavoriteMailbox:(id)arg1 hasParent:(BOOL)arg2;
...
- (void)_setMailboxSelectionState:(id)arg1 scrollToVisible:(BOOL)arg2 focusMessages:(BOOL)arg3;
...
- (id)_mailboxSegmentedControlsForMailboxes:(id)arg1 excludeMailboxes:(id)arg2;
...
- (id)_mailboxSelectionStateWithAttributes:(id)arg1;
- (void)awakeFromNib;
- (id)_mailboxesFromAttributes:(id)arg1;
- (id)_outlineItemPersistentObjectsFromAttributes:(id)arg1;
...
- (void)_updateToolbarItemForMessageListFilter:(id)arg1;
- (id)_messageListFilterMenu;
- (id)toolbar:(id)arg1 itemForItemIdentifier:(id)arg2 willBeInsertedIntoToolbar:(BOOL)arg3;
- (BOOL)_shouldRemoveToolbarItemWithTag:(long long)arg1;
- (BOOL)_shouldAddToolbarItemWithTag:(long long)arg1;
