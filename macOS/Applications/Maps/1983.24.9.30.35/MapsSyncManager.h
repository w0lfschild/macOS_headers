...
@interface MapsSyncManager : NSObject
{
    ...
    CDUnknownBlockType _editBatchWillBeginHandler;
    CDUnknownBlockType _editBatchDidEndHandler;
}
...
+ (id)syncIdentifier;
@property(copy, nonatomic) CDUnknownBlockType editBatchDidEndHandler; // @synthesize editBatchDidEndHandler=_editBatchDidEndHandler;
@property(copy, nonatomic) CDUnknownBlockType editBatchWillBeginHandler; // @synthesize editBatchWillBeginHandler=_editBatchWillBeginHandler;
...
- (void)_performPossiblyBatchedOperationBlock:(CDUnknownBlockType)arg1;
...
- (void)reset;
- (void)stop;
@property(readonly, nonatomic, getter=isApplyingEditBatch) BOOL applyingEditBatch;
- (void)start;
