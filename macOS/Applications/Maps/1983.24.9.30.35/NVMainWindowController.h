...
+ (void)updateSearchQuerySubtitle:(id)arg1 syncedSearchQuery:(id)arg2 inRect:(CDStruct_02837cd9)arg3 center:(struct CLLocationCoordinate2D)arg4;
...
- (id)newReportAProblemContextWithPlace:(id)arg1;
...
- (void)_performWithDefaultDirectionsTypeForOrigin:(id)arg1 destination:(id)arg2 handler:(CDUnknownBlockType)arg3;
