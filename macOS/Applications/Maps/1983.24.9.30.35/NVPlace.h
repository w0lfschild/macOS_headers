...
@class GEOAddress, GEOComposedWaypoint, GEOMapItemStorage, GEORPPlaceInfo, MKLabelMarker, MKMapItem, MKUserLocation, NSArray, NSDictionary, NSString, NSTimeZone, NSURL, NVSearchResult;
