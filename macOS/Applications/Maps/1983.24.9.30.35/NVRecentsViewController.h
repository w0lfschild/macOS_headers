...
@class BrowseCellView, CNContactPickerViewController, NSArray, NSSearchField, NSString, NSTableView, NSView, NVBookmarksViewController, NVRecentsWindow;
@protocol NVRecentsViewControllerDelegate;

__attribute__((visibility("hidden")))
@interface NVRecentsViewController : NSViewController <BrowseViewDelegate, BrowseViewMapsDelegate, NSTableViewDataSource, NSTableViewDelegate, CNContactPickerViewControllerDelegate>
{
    BOOL _showingInMenu;
    NVRecentsWindow *_window;
    BrowseCellView *_browseCellView;
...
- (void)browseViewUpdateHeight:(id)arg1 withAnimation:(BOOL)arg2;
