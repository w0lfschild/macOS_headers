...
#import "TransitDirectionsCellInfoDelegate-Protocol.h"
...
#import "TransitRouteIncidentCellDelegate-Protocol.h"
#import "TransitRoutePickingPageCellDelegate-Protocol.h"

@class MKArtworkImageView, NSArray, NSLayoutConstraint, NSString, NSView, NVDirectionsViewController, NVOutlineView, NVRouteManager, NVSideOutlineViewController, NVSideViewController, RoutePickingMessageView;

__attribute__((visibility("hidden")))
@interface NVTransitViewController : NSViewController <NSOutlineViewDataSource, TransitDirectionsInstructionsCellDelegate, TransitDirectionsCellInfoDelegate, TransitDirectionsIncidentCellDelegate, TransitRouteIncidentCellDelegate, TransitRoutePickingPageCellDelegate, TransitDirectionsClusteredVehiclesCellDelegate, NVSideOutlineViewControllerDelegate, NSTableViewDelegate, RouteTableViewCellDelegate, NVOutlineViewKeyDelegate>
{
    NVRouteManager *_routeManager;
    NSArray *_transitRouteDataSources;
    MKArtworkImageView *_overlayView;
    long long _overlayViewSourceIndex;
    NSView *_sidebarContainer;
    RoutePickingMessageView *_transitMessageView;
...
- (void)showIncidentSheetTappedInIncidentCell:(id)arg1;
- (void)transitDirectionsItemDetailWasTapped:(id)arg1;
- (void)transitDirectionsCellDetailWasTapped:(id)arg1;
- (BOOL)transitDirectionsCellShouldShowInfoButton:(id)arg1;
- (void)infoButtonTappedInCell:(id)arg1;
...
- (void)_setupNoticeCell:(id)arg1 withServerFormattedString:(id)arg2;
...
- (void)_transitMessageViewTapped;
- (id)_transitMessageViewButtonTitle;
- (id)_transitMessageViewString;
- (void)_updateTransitMessageView;
- (BOOL)_shouldShowTransitMessageView;
