...
@interface NVSharingController : MKSharingController <NSSharingServicePickerDelegate, NSSharingServiceDelegate, NVBookmarksAnimationDelegate>
{
...
- (id)thumbnailWithSize:(struct CGSize)arg1 annotationView:(id)arg2 place:(id)arg3;
