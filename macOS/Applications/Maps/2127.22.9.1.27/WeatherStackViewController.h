...
- (void)airQualityConditionsViewController:(id)arg1 didUpdateVisibility:(BOOL)arg2;
- (void)weatherConditionsViewController:(id)arg1 didUpdateVisibility:(BOOL)arg2;
