...
- (id)_initWithStep:(id)arg1 route:(id)arg2 distanceMeters:(unsigned long long)arg3 type:(long long)arg4 coordinate:(struct CLLocationCoordinate2D)arg5 startPointIndex:(unsigned int)arg6 endPointIndex:(unsigned int)arg7 signsColor:(int)arg8;
- (id)_initWithType:(long long)arg1 mode:(unsigned long long)arg2 coordinate:(struct CLLocationCoordinate2D)arg3 startPointIndex:(unsigned int)arg4 endPointIndex:(unsigned int)arg5 instructions:(id)arg6 distanceMeters:(unsigned long long)arg7 signsColor:(int)arg8 route:(id)arg9;
