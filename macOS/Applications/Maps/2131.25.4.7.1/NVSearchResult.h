...
@class GEOPlace, GEORPPlaceInfo, MKMapItem, MKMapItemIdentifier, NSArray, NSString, NSURL;
...
@property int geoMapServiceTraitSource; // @synthesize geoMapServiceTraitSource=_geoMapServiceTraitSource;
