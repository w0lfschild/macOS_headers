...
@class GEODirectionsRequest, GEODirectionsResponse, MKMapView, NSArray, NSMutableArray, NSMutableSet, NSString, NVPlace, NVRoute, RAPDirectionsRecording, RAPUserSearchInput, RouteMarkerFormatterTotal, RouteSet, VKPolylineGroupOverlay;
