...
@class GEOAddress, GEOComposedWaypoint, GEOMapItemStorage, GEORPPlaceInfo, MKLabelMarker, MKMapItem, MKMapItemIdentifier, MKUserLocation, NSArray, NSDictionary, NSString, NSTimeZone, NSURL, NVSearchResult;
...
@property(nonatomic) __weak MKLabelMarker *labelMarker; // @synthesize labelMarker=_labelMarker;
