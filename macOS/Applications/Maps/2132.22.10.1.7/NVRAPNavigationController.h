...
@property __weak NSTouchBarItem *sendItem; // @synthesize sendItem=_sendItem;
@property __weak NSTouchBarItem *continueItem; // @synthesize continueItem=_continueItem;
@property __weak NSTouchBarItem *gobackItem; // @synthesize gobackItem=_gobackItem;
@property __weak NSTouchBarItem *spacerItem2; // @synthesize spacerItem2=_spacerItem2;
@property __weak NSTouchBarItem *spacerItem1; // @synthesize spacerItem1=_spacerItem1;
@property __weak NSTouchBarItem *cancelItem; // @synthesize cancelItem=_cancelItem;
@property __weak NSGroupTouchBarItem *actionGroupItem; // @synthesize actionGroupItem=_actionGroupItem;
