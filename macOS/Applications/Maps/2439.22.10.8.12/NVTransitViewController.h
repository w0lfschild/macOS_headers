...
@class NSArray, NSDictionary, NSLayoutConstraint, NSString, NSView, NVDirectionsViewController, NVOutlineView, NVRouteManager, NVSideOutlineViewController, NVSideViewController;

__attribute__((visibility("hidden")))
@interface NVTransitViewController : NSViewController <NSOutlineViewDataSource, TransitDirectionsExpandableCellDelegate, TransitDirectionsIncidentCellDelegate, TransitRoutePickingPageCellDelegate, TransitDirectionsClusteredVehiclesCellDelegate, NVSideOutlineViewControllerDelegate, NVRouteOverviewCellDelegate, TransitDirectionGetTicketCellDelegate, NSTableViewDelegate, RouteTableViewCellDelegate, NVOutlineViewKeyDelegate>
{
