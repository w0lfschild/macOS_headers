...
@interface NVMainWindowController : NSWindowController <MapTypeSource, MKMapViewDelegate, NSSharingServicePickerDelegate, NSSharingServiceDelegate, NSWindowDelegate, NSTextFieldDelegate, NSPopoverDelegate, NVCoreLocationErrorPresenterDelegate, GEOResourceManifestTileGroupObserver, NVQuickRouteButtonViewDelegate, NVCalloutButtonViewDelegate, NVBannerViewDelegate, MKQuickRouteManagerDelegate, NVDirectionsViewControllerDelegate, NVSuggesterDelegate, NSMenuDelegate, NSGestureRecognizerDelegate, NSToolbarDelegate, MKURLHandlerDelegate>
{
    ...
    BOOL _sharing;
    BOOL _airQualityIndexEnabled;
    BOOL _weatherConditionsEnabled;
...
@property(nonatomic) BOOL weatherConditionsEnabled; // @synthesize weatherConditionsEnabled=_weatherConditionsEnabled;
@property(nonatomic) BOOL airQualityIndexEnabled; // @synthesize airQualityIndexEnabled=_airQualityIndexEnabled;
...
@property(retain, nonatomic) NSMutableSet *activeTrackingAreas; // @synthesize activeTrackingAreas=_activeTrackingAreas;
@property(retain, nonatomic) NVPlace *selectedSearchPlaceToAnimate; // @synthesize selectedSearchPlaceToAnimate=_selectedSearchPlaceToAnimate;
@property(nonatomic) __weak NVToolbarItem *mapViewStyle; // @synthesize mapViewStyle=_mapViewStyle;
...
@property(nonatomic, getter=isSharing) BOOL sharing; // @synthesize sharing=_sharing;
@property(nonatomic) BOOL dropsPinOnSearch; // @synthesize dropsPinOnSearch=_dropsPinOnSearch;
@property(nonatomic) __weak NSSplitViewController *splitViewController; // @synthesize splitViewController=_splitViewController;
@property(retain, nonatomic) NSDate *dateSinceMapWindowBecameKey; // @synthesize dateSinceMapWindowBecameKey=_dateSinceMapWindowBecameKey;
...
@property(nonatomic) __weak NVSideViewController *sideViewController; // @synthesize sideViewController;
@property(readonly, nonatomic) NSButton *bookmarksButton; // @synthesize bookmarksButton;
@property(copy, nonatomic) NSOrderedSet *displayedPinPlaces; // @synthesize displayedPinPlaces;
@property(readonly, nonatomic) NVSearchController *searchController; // @synthesize searchController;
...
@property(readonly, nonatomic, getter=areDisplayedPinsVisible) BOOL displayedPinsVisible;
@property(readonly, nonatomic, getter=isSelectedPinVisible) BOOL selectedPinVisible;
@property(readonly, nonatomic, getter=isDroppedPinVisible) BOOL droppedPinVisible;
...
@property(retain, nonatomic) NVPlace *selectedPinPlace; // @synthesize selectedPinPlace=_selectedPinPlace;
...
- (void)debugFlashBezelMessage:(id)arg1;
- (void)setBezelMessage:(id)arg1 error:(id)arg2 showsCloseButton:(BOOL)arg3 textAlignment:(long long)arg4;
...
@property(readonly, nonatomic) NVRouteManager *routeManager;
- (id)searchManager;
...
@property(readonly, nonatomic, getter=isDirectionsViewVisible) BOOL directionsViewVisible;
...
@property(readonly, nonatomic) BOOL canToggleTraffic;
@property(readonly, nonatomic) BOOL canResizeLabels;
@property(readonly, nonatomic) BOOL canLocalizeLabels;
- (BOOL)localizeLabels;
- (void)setLocalizeLabels:(BOOL)arg1;
@property(nonatomic) BOOL useLargeTextSize;
@property(nonatomic) long long labelTextSize;
- (BOOL)isPitched;
@property(nonatomic) BOOL mode3D;
- (void)toggle3DMode:(id)arg1;
- (BOOL)canHideLabels;
@property(readonly, nonatomic) BOOL canEnter3DMode;
@property(readonly, nonatomic) BOOL canSnapToNorth;
...
@property(nonatomic) long long selectedMapModeIndex;
