...
@property(nonatomic) unsigned long long directionMode; // @synthesize directionMode=_directionMode;
- (unsigned long long)hash;
- (BOOL)isEqual:(id)arg1;
@property(readonly, nonatomic) NSString *title;
- (id)description;
@property(readonly, nonatomic) NSString *destinationTitle;
@property(readonly, nonatomic) NSString *originTitle;
- (id)titleForPlace:(id)arg1;
@property(readonly, nonatomic) NVPlace *destinationPlace;
@property(readonly, nonatomic) NVPlace *originPlace;
