...
@class AppCoordinator, CollectionEditSession, CollectionPicker, ControlContainerViewController, DirectionItem, EVOnboardingController, GEOMapServiceTraits, LineCardViewController, MKMapItem, MKMuninView, MapSelectionManager, MapSelectionManagerState, NSString, ParkedCarViewController, PersonalizedItemManager, PersonalizedItemSource, PlaceCardViewController, PlatformController, ResultsViewController, RouteAnnotationContaineeViewController, RouteAnnotationsController, RouteIncidentsViewController, RoutePlanningDataCoordinator, RoutePlanningMapController, RoutePlanningOverviewViewController, RouteSearchViewController, RouteStepsViewController, SearchPinsManager, SearchSession, SearchSessionManager, SearchViewController, SettingsController, SimpleResultsViewController, TrafficIncidentContaineeViewController, TransitLineSelectionActionController, UGCPOIEnrichmentCoordinator, UIScrollView, UIViewController, UserLocationSearchResult, VenueCardCoordinator, VenuesManager;
...
@interface ActionCoordinator : NSObject <VenueCardCoordinatorDataSource, PlaceCardViewControllerDelegate, SimpleResultsViewControllerDelegate, LineCardViewControllerDelegate, MapSelectionManagerDelegate, SKStoreProductViewControllerDelegatePrivate, ViewModeDelegate, MarkedLocationRefinementDelegate, PPTTestPlaceCardProtocol, PPTTestSearchProtocol, PPTTestETAProtocol, PPTTestDirectionsDetailsProtocol, PPTTestGuidanceProtocol, PPTTestNavigationProtocol, PPTTestSettingsProtocol, PPTTestProactiveProtocol, PPTTestRecentsProtocol, PPTTestCollectionsProtocol, PPTTestChromeTrayProtocol, PPTTestVenuesProtocol, RoutePlanningDataCoordinatorPresentationDelegate, UGCPOIEnrichmentCoordinatorDelegate, CollectionPickerDelegate, SharedTripsActionCoordination, ShortcutEditSessionControllerDelegate, SearchSessionManagerDelegate, PlaceCardDismissable, PPTTestMuninProtocol, ActionCoordination, MapViewResponderHandling, DeleteDelegate, MapsSuggestionsDeleteActionDelegate>
{
...
- (void)setRoutePlanningNotices:(id)arg1;
...
- (void)presentVehicleOnboardingWithVehicles:(id)arg1;
...
- (void)viewController:(id)arg1 showCuratedCollectionsList:(id)arg2 usingTitle:(id)arg3;
- (void)showCuratedCollectionViewController:(id)arg1 replaceViewController:(BOOL)arg2;
- (void)viewController:(id)arg1 showFullyClientizedCuratedCollection:(id)arg2 replaceViewController:(BOOL)arg3;
- (void)viewController:(id)arg1 showCuratedCollectionIdentifier:(id)arg2 replaceViewController:(BOOL)arg3;
- (void)viewController:(id)arg1 showCuratedCollectionIdentifier:(id)arg2;
- (void)viewController:(id)arg1 showCuratedCollection:(id)arg2 replaceViewController:(BOOL)arg3;
...
- (void)viewController:(id)arg1 saveCollectionEditSession:(id)arg2 sourceView:(id)arg3 sourceRect:(struct CGRect)arg4;
