...
@class ActionCoordinator, CardAnimation, FloatingControlsViewController, MapGestureCardDismissalHelper, NSString, PlatformController, StatusIndicatorManager, StatusIndicatorView, UIView;
