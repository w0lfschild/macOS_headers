...
@class DragAndDropPreview, HomeOutlineSectionControllerConfiguration, IdentifierPath, MapsUIDiffableDataSourceIdentifierCache, MapsUIDiffableDataSourceOutlineNodeSnapshot, NSArray, NSDictionary, NSMutableDictionary, NSSet, NSString, UIDragItem;
@protocol HomeOutlineSectionControllerDelegate, MapsUIDiffableDataSourceViewModel;

__attribute__((visibility("hidden")))
@interface HomeOutlineSectionController : NSObject <HomeOutlineSectionControllerSubclassing, DragAndDropMapItemObserver, DragAndDropPreviewContentUpdateDelegate, UICollectionViewDelegate, UICollectionViewDragDelegate, HomeDataProvidingObserver>
{
...
@property(readonly, nonatomic) IdentifierPath *sectionIdentifierPath;
