...
@class NSArray, NSSet, NSString, SharedTripsDataProvider, SuggestionsDataProvider;
@protocol MapsUIDiffableDataSourceViewModel;

__attribute__((visibility("hidden")))
@interface HomeOutlineSuggestionsSectionController : HomeOutlineSectionController <TwoLinesOutlineCellAccessoryDelegate, HomeOutlineSectionControllerSubclassing>
{
