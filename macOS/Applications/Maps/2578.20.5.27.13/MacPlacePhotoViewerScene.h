...
- (void)openPhotoGalleryWithGalleryViewController:(id)arg1 mapItem:(id)arg2 delegate:(id)arg3;
- (void)openPhotoGalleryWithMapItem:(id)arg1 context:(long long)arg2 delegate:(id)arg3;
- (id)init;
