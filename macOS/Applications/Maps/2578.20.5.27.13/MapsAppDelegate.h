...
@class AppCoordinator, ApplicationSessionController, BKSProcessAssertion, CarDisplayController, DataActivationPopupAssertion, EntryPointsCoordinator, FavoritesSpotlightIndexingClient, FeedbackSubmissionManager, ForegroundOnlyDataActivationPopupAssertion, IOSChromeViewController, IdleTimerController, MKPlaceholderGridCache, MSPCloudSynchronizer, MapsDistanceUnitUpdater, MapsSyncDataMigrator, NSArray, NSString, POISearchManager, PlatformController, SiriNavStatusUpdater, UIWindow;

__attribute__((visibility("hidden")))
@interface MapsAppDelegate : UIResponder <CarDisplayDelegate, AppKitBundleMenuBarActionHandling, UNUserNotificationCenterDelegate, NSURLSessionTaskDelegate, GEOConfigChangeListenerDelegate, UIApplicationDelegate, UIApplicationDelegatePrivate, BackgroundNavigationDelegate, MNNavigationServiceObserver>
{
    int _navNotifyToken;
