...
@class DragAndDropPreview, MKMapItem, MKMuninView, MacPlacePhotoViewerScene, NSArray, NSMapTable, NSString, PlaceCardItem, RelatedSearchSuggestionViewController, ShortcutEditSession, UGCCallToActionViewProvider, UGCPOIEnrichmentCoordinator, UGCReportImageryController, _MKPlaceViewController;
...
@interface PlaceCardViewController : InfoCardViewController <_MKPlaceViewControllerDelegate, PlaceCardActionButtonControllingDelegate, ExtensionFlowDelegate, CNContactViewControllerDelegate, GEOLogContextDelegate, RelatedSearchSuggestionViewControllerDelegate, UGCCallToActionViewProviderDelegate, UGCPOIEnrichmentCoordinatorDelegate, ShortcutManagerObserver, CollectionManagerObserver, MacPlacePhotoViewerSceneDelegate, PlaceCardDismissable, MKMuninViewProvider>
{
    ...
    BOOL _shouldDisplaySecondaryActionWhenReady;
...
@property(nonatomic) BOOL shouldDisplaySecondaryActionWhenReady; // @synthesize shouldDisplaySecondaryActionWhenReady=_shouldDisplaySecondaryActionWhenReady;
...
- (void)callToActionViewProviderDidFinishResolvingInitialState:(id)arg1;
