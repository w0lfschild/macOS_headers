...
- (id)initWithCollectionView:(id)arg1 usingCuratedCollections:(id)arg2 withResultFilters:(id)arg3 withAPIController:(id)arg4 withCollectionRoutingDelegate:(id)arg5 usingAnalyticsManager:(id)arg6;
