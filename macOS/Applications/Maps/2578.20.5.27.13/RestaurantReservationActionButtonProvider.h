...
@class INRestaurantReservationUserBooking, MKMapItem, NSArray, NSNumberFormatter, NSString, NSUserActivity, RestaurantReservationAnalyticsBookingSession, RestaurantReservationRequester, SSLookupItem, UIViewController, _MXExtension, _MXExtensionManager;
