...
#import "TransitDirectionsCollectionViewCell.h"
...
@interface TransitDirectionsIconCollectionViewCell : TransitDirectionsCollectionViewCell <TransitDirectionsCell>
{
}
