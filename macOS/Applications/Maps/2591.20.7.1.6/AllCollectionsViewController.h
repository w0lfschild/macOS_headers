...
@class AllCollectionsAPIController, AllCollectionsDataSource, ContainerHeaderView, GEOMapServiceTraits, MKPlaceCollectionsLogicController, MKPlaceCollectionsSizeController, NSArray, NSDiffableDataSourceSnapshot, NSString, UICollectionView, UICollectionViewCompositionalLayout;
...
- (void)addLoadingView;
- (void)activateCollectionViewConstraints;
