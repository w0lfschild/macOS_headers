...
@class CuratedCollectionDescriptionCellModel, CuratedCollectionResolver, GEOPlaceCollection, NSArray, NSString, UITableViewDiffableDataSource;
@protocol CuratedCollectionDataSourceDelegate, TwoLinesContentViewModel;

__attribute__((visibility("hidden")))
@interface CuratedCollectionProvider : DataSource <CuratedCollectionResolverDelegate, CuratedCollectionItemTableViewCellDelegate, MapsUITableViewDiffableDataSourceCellProviding, UITableViewDelegate>
{
