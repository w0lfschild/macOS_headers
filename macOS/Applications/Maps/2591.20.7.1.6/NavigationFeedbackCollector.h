...
@class GEOComposedRoute, GEOComposedRouteStep, GEODirectionsFeedbackCollector, GEOETATrafficUpdateResponse, GEOLocation, GEOStepFeedback, NSArray, NSData, NSDate, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NavigationAudioFeedbackCollector;
