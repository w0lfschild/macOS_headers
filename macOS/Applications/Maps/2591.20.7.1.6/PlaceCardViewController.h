...
@class CollectionEditSession, DragAndDropPreview, MKMapItem, MKMuninView, MacPlacePhotoViewerScene, NSArray, NSMapTable, NSString, PlaceCardItem, RelatedSearchSuggestionViewController, ShortcutEditSession, UGCCallToActionViewProvider, UGCPOIEnrichmentCoordinator, UGCReportImageryController, _MKPlaceViewController;
...
- (void)placeViewController:(id)arg1 seeAllCollections:(id)arg2 usingTitle:(id)arg3;
