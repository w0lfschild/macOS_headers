...
- (void)placeViewController:(_MKPlaceViewController *)arg1 didSelectAddPhotosWithObserver:(id <MKActivityObserving>)arg2 shouldAddFromPhotoLibrary:(BOOL)arg3;
...
- (void)placeViewController:(_MKPlaceViewController *)arg1 seeAllCollections:(NSArray *)arg2 usingTitle:(NSString *)arg3;
