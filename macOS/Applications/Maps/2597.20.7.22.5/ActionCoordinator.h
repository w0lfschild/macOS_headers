...
@interface ActionCoordinator : NSObject <VenueCardCoordinatorDataSource, PlaceCardViewControllerDelegate, SimpleResultsViewControllerDelegate, LineCardViewControllerDelegate, MapSelectionManagerDelegate, SKStoreProductViewControllerDelegatePrivate, ViewModeDelegate, MarkedLocationRefinementDelegate, PPTTestPlaceCardProtocol, PPTTestSearchProtocol, PPTTestETAProtocol, PPTTestDirectionsDetailsProtocol, PPTTestGuidanceProtocol, PPTTestNavigationProtocol, PPTTestSettingsProtocol, PPTTestProactiveProtocol, PPTTestRecentsProtocol, PPTTestCollectionsProtocol, PPTTestChromeTrayProtocol, PPTTestVenuesProtocol, RoutePlanningDataCoordinatorPresentationDelegate, UGCPOIEnrichmentCoordinatorDelegate, CollectionPickerDelegate, SharedTripsActionCoordination, ShortcutEditSessionControllerDelegate, UGCPOIEnrichmentSubmissionStatusDelegate, UGCPOIEnrichmentPresentationDelegate, SearchSessionManagerDelegate, PlaceCardDismissable, UIPopoverPresentationControllerDelegate, PPTTestMuninProtocol, ActionCoordination, MapViewResponderHandling, DeleteDelegate, MapsSuggestionsDeleteActionDelegate>
{
