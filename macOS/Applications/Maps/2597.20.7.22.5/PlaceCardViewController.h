...
@class CollectionEditSession, DragAndDropPreview, MKMapItem, MKMuninView, MacPlacePhotoViewerScene, NSArray, NSMapTable, NSString, PlaceCardItem, RelatedSearchSuggestionViewController, ShortcutEditSession, UGCCallToActionViewProvider, UGCReportImageryController, _MKPlaceViewController;
...
- (void)placeViewController:(id)arg1 didSelectAddPhotosWithObserver:(id)arg2 shouldAddFromPhotoLibrary:(BOOL)arg3;
...
- (void)_addPlaceToCollection:(id)arg1;
