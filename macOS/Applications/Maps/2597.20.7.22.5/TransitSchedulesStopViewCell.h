...
@interface TransitSchedulesStopViewCell : UICollectionViewCell
{
    ...
    NSArray *_multiLineLayountConstraints;
    NSArray *_singleLineLayoutConstraints;
    NSLayoutConstraint *_vehicleImageViewVerticalConstraint;
    NSString *_placeholderString;
    BOOL _highlightStation;
    BOOL _isMultilineLayout;
...
@property(nonatomic) BOOL isMultilineLayout; // @synthesize isMultilineLayout=_isMultilineLayout;
