...
@interface SearchHomeDataSource : DataSource <SearchHomeDataFetcherDelegate, CuratedCollectionSyncManagerObserver, MapsUICollectionViewDiffableDataSourceCellProviding, UICollectionViewDelegate, DataSourceCollectionView>
{
...
- (void)performDeleteAnimationOnSectionWithIdentifier:(id)arg1 itemAtIndex:(unsigned long long)arg2 dataProvider:(id)arg3 animated:(BOOL)arg4;
