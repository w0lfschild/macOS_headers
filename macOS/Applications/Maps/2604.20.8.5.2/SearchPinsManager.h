...
- (void)dropPinsForSearchResults:(id)arg1 selectedSearchResult:(id)arg2 animate:(BOOL)arg3 itemSource:(id)arg4;
...
- (void)setSearchPinsFromSearchInfo:(id)arg1 scrollToResults:(BOOL)arg2 displayPlaceCardForResult:(id)arg3 animated:(BOOL)arg4 itemSource:(id)arg5;
...
- (void)setSingleSearchPinFromSearchInfo:(id)arg1 scrollToResults:(BOOL)arg2 displayPlaceCardForResult:(id)arg3 animated:(BOOL)arg4;
...
- (void)selectDroppedPinIsAnimated:(BOOL)arg1;
