...
@interface TwoLinesContentView : MapsThemeView <TwoLinesContentViewModelObserver>
{
    ...
    BOOL _vibrant;
    UIView *_vibrantView;
    BOOL _isParentCellSelectedAndFocused;
...
@property(nonatomic) BOOL isParentCellSelectedAndFocused; // @synthesize isParentCellSelectedAndFocused=_isParentCellSelectedAndFocused;
