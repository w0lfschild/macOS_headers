...
@class NSString, SidebarOutlineCellBackgroundModel, UICollectionViewCellRegistration;
@protocol GEOTransitLine, TwoLinesOutlineCellAccessoryModel;
...
- (id)initWithTransitLine:(id)arg1 backgroundModel:(id)arg2 accessoryModel:(id)arg3;
