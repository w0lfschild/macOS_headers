...
#import "TransitDirectionsStopCollectionViewCell.h"
...
@interface TransitDirectionsPassItemCollectionViewCell : TransitDirectionsStopCollectionViewCell <TransitDirectionsCell>
{
}
