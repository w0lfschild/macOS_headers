...
+ (id)acSuggestionEntriesFromSections:(id)arg1 personalizedItems:(id)arg2 context:(id)arg3 mapsSuggestionsInsights:(id)arg4 skipReportASearchItems:(BOOL)arg5 subactionMetaData:(id)arg6 indexOfResultWithSubactionMetadata:(id)arg7;
+ (id)acSuggestionEntriesFromAutoCompleteObjects:(id)arg1 personalizedItems:(id)arg2 context:(id)arg3 mapsSuggestionsInsights:(id)arg4 skipReportASearchItems:(BOOL)arg5;
+ (id)acSuggestionEntriesFromAutoCompleteObjects:(id)arg1 context:(id)arg2 mapsSuggestionsInsights:(id)arg3 skipReportASearchItems:(BOOL)arg4;
