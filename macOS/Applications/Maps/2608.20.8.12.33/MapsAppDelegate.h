...
@interface MapsAppDelegate : UIResponder <CarDisplayDelegate, AppKitBundleMenuBarActionHandling, UNUserNotificationCenterDelegate, NSURLSessionTaskDelegate, UIApplicationDelegate, UIApplicationDelegatePrivate, BackgroundNavigationDelegate, MNNavigationServiceObserver>
{
    int _navNotifyToken;
