...
@class MKMapItem, NSMenuToolbarItem, NSString, NSToolbar, NSToolbarItem, RAPPlacecardImageryLayoutManager;
...
@interface PhotoViewerToolbarController : NSObject <NSToolbarDelegate>
{
    ...
    NSToolbarItem *_addPhotoToolbarItem;
    RAPPlacecardImageryLayoutManager *_rapLayoutManger;
    BOOL _suppressPhotoGrid;
    NSToolbar *_toolbar;
    long long _context;
...
- (void).cxx_destruct;
@property(nonatomic, getter=shouldSuppressPhotoGrid) BOOL suppressPhotoGrid; // @synthesize suppressPhotoGrid=_suppressPhotoGrid;
...
@property(readonly, nonatomic) NSToolbarItem *addPhotoToolbarItem; // @synthesize addPhotoToolbarItem=_addPhotoToolbarItem;
...
- (id)_toolbarIdentifiersForContext:(long long)arg1;
