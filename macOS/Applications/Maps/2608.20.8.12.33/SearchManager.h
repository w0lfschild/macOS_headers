...
- (void)_submitTicketForSearchForCategory:(id)arg1 traits:(id)arg2 defaultSearchResultType:(unsigned int)arg3 completedQuery:(id)arg4 source:(int)arg5 maxResults:(unsigned int)arg6;
