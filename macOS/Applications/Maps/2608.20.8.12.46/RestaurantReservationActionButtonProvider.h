...
@class GEOAppStoreApp, INRestaurantReservationUserBooking, MKMapItem, NSArray, NSNumberFormatter, NSString, NSUserActivity, RestaurantReservationAnalyticsBookingSession, RestaurantReservationRequester, UIViewController, _MXExtension, _MXExtensionManager;
...
@property(copy, nonatomic) NSArray *regularQuickLinks; // @synthesize regularQuickLinks=_regularQuickLinks;
