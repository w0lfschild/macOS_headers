...
@class AppCoordinator, EntryPointsCoordinator, IOSBasedChromeViewController, MapsActionController, MapsActivity, MapsActivityController, MapsDebugController, NSObject, NSString, PlatformController, RAPPresenter, UINavigationController, UIViewController, UIWindow;
...
{
    BOOL _isTemporaryPreciseLocationAuthorizationPromptShown;
