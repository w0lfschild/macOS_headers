...
#import "TransitDirectionsInstructionsCollectionViewCell.h"
...
@interface TransitDirectionsStopCollectionViewCell : TransitDirectionsInstructionsCollectionViewCell <TransitDirectionsCell>
{
}
