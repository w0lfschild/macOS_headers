...
@class ContainerViewController, MKMapItem, NSToolbarItem, UIBarButtonItem, UIView, UIViewController;
...
@interface UGCPOIEnrichmentCoordinator : NSObject
{
    ...
    NSToolbarItem *_anchoringToolbarItem;
...
+ (id)photoEmphasizedAddCoordinatorWithMapItem:(id)arg1 anchoringToolbarItem:(id)arg2;
...
@property(nonatomic) __weak NSToolbarItem *anchoringToolbarItem; // @synthesize anchoringToolbarItem=_anchoringToolbarItem;
