...
@interface DirectionsPlan : PBCodable <NSCopying>
{
    ...
    BOOL _shouldRestoreLowGuidance;
    struct {
...
@property(nonatomic) BOOL shouldRestoreLowGuidance; // @synthesize shouldRestoreLowGuidance=_shouldRestoreLowGuidance;
...
@property(nonatomic) BOOL hasShouldRestoreLowGuidance;
