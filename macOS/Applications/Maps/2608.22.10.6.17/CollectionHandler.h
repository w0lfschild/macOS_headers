...
+ (void)setCachedDefaultImageIsRTL:(BOOL)arg1;
+ (BOOL)cachedDefaultImageIsRTL;
+ (void)setCachedDefaultImage:(id)arg1;
+ (id)cachedDefaultImage;
+ (void)setCachedDefaultImageIsBuilding:(BOOL)arg1;
+ (BOOL)cachedDefaultImageIsBuilding;
...
@property(readonly, nonatomic) BOOL containsTransitLine;
