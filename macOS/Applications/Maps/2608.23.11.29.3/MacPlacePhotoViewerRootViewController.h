...
@class MKMapItem, MKPlacePhotoGalleryViewController, MapsSceneDelegate, NSString, NSToolbar, PhotoViewerToolbarController, RAPPlacecardImageryLayoutManager, RAPPresenter, UGCMorePhotosFeedViewController, UGCReportImageryController;
