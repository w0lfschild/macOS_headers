...
+ (id)iconForSuggestionType:(long long)arg1 suggestionAttributes:(id)arg2 mapItemAttributes:(id)arg3 originBundleID:(id)arg4 screenScale:(double)arg5 showEVChargingIcon:(BOOL)arg6 inverted:(BOOL)arg7 isDashboardWidget:(BOOL)arg8 nightMode:(BOOL)arg9;
+ (id)sharedDefaults;
