...
@class DirectionsStepsTableViewController, ModalCardHeaderView, NSString, TransitDirectionsListViewController, UIScrollView, UIViewController;
@protocol RouteDirectionsListController, RoutePlanningDataCoordination;
...
{
    UIViewController<RouteDirectionsListController> *_observingHeaderOfController;
...
- (void)_updateHairlineVisibility:(BOOL)arg1;
- (void)_observeHeaderFlagForController:(id)arg1;
