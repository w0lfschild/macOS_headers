...
@class CardPresentationController, ContainerHeaderView, ExpandableMacPopoverPresentationController, KeyboardProxyingView, MKStackingViewController, MacMenuPresentationController, MacPopoverPresentationController, NSArray, NSString, UILabel;
