...
@interface RouteOverviewCell : MapsThemeCollectionViewListCell
{
...
@property(nonatomic) BOOL hasSelectedStep; // @synthesize hasSelectedStep=_hasSelectedStep;
