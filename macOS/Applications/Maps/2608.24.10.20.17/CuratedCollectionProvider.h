...
@class CuratedCollectionActionCellModel, CuratedCollectionDescriptionCellModel, CuratedCollectionResolver, CuratedCollectionViewAnalyticsController, GEOPlaceCollection, NSArray, NSString, UITableViewDiffableDataSource;
...
- (void)_updateActionColorsInCell:(id)arg1 animated:(BOOL)arg2;
- (void)_updateDescriptionColorsInCell:(id)arg1 animated:(BOOL)arg2;
