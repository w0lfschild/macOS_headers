...
+ (id)distanceStringFromLocation:(id)arg1 toCoordinate:(struct CLLocationCoordinate2D)arg2 withMapItem:(id)arg3 showsDistance:(out char *)arg4 onlyUseThreshold:(BOOL)arg5;
