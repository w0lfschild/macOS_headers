...
@class NSArray, NSDictionary, NSSet, NSString, PKAppletSubcredential, PKAppletSubcredentialSharingInvitation, PKBannerModel, PKDeviceSharingCapabilities, PKFeatureApplication, PKFieldProperties, PKPaymentBalanceReminder, PKPaymentMessage, PKPaymentTransaction, PKTransactionReceipt, PKTransitPassProperties, PKValueAddedServiceTransaction;

@protocol PKPaymentServiceDelegate <NSObject>

@optional
- (void)didRecieveBannerToDisplay:(PKBannerModel *)arg1;
