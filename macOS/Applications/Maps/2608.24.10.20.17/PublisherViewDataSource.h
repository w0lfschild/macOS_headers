...
#import "PublisherFilterViewProvider-Protocol.h"
#import "PublisherViewDataSourceUpdater-Protocol.h"
#import "UICollectionViewDelegate-Protocol.h"
#import "UICollectionViewDelegateFlowLayout-Protocol.h"

@class MKPlaceCollectionsLogicController, MKPlaceCollectionsSizeController, NSArray, NSIndexPath, NSString, PublisherAPIController, PublisherHeaderViewActionManager, UICollectionViewDiffableDataSource;
@protocol FilterAnalyticsProvider, MKCollectionCarouselRoutingDelegate, PublisherAnalytics;

__attribute__((visibility("hidden")))
@interface PublisherViewDataSource : DataSource <MapsUICollectionViewDiffableDataSourceCellProviding, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, CollectionsFilterRoutingDelegate, CuratedCollectionSyncManagerObserver, PublisherViewDataSourceUpdater, PublisherFilterViewProvider>
{
    ...
    PublisherHeaderViewActionManager *_actionsManager;
}
...
- (id)publisherFilterView;
- (struct CGSize)sizeForFilterView;
- (BOOL)shouldAddFilterView;
...
- (void)displayCollections:(CDUnknownBlockType)arg1;
- (long long)presentationStyle;
- (void)dealloc;
- (id)initWithCollectionView:(id)arg1 usingCuratedCollections:(id)arg2 usingPlaceCollectionIds:(id)arg3 withResultFilters:(id)arg4 withAPIController:(id)arg5 withCollectionRoutingDelegate:(id)arg6 usingAnalyticsManager:(id)arg7 usingPublisherActionsManager:(id)arg8;
