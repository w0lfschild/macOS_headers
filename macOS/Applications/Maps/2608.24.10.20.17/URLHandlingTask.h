...
+ (id)taskForURL:(id)arg1 referringURL:(id)arg2 sceneOptions:(id)arg3 mkOptions:(id)arg4 windowSize:(struct CGSize)arg5;
- (void).cxx_destruct;
...
- (id)initWithURL:(id)arg1 referringURL:(id)arg2 sceneOptions:(id)arg3 mkOptions:(id)arg4;
