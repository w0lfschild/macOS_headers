...
- (void).cxx_destruct;
@property(readonly, nonatomic) BOOL showsSectionButton; // @synthesize showsSectionButton=_showsSectionButton;
@property(readonly, nonatomic) NSArray *contents; // @synthesize contents=_contents;
@property(readonly, nonatomic) long long type; // @synthesize type=_type;
@property(readonly, nonatomic) BOOL hasOrthogonalLayout;
...
- (id)initWithType:(long long)arg1 contents:(id)arg2 showsSectionButton:(BOOL)arg3 customLocalizedName:(id)arg4;
