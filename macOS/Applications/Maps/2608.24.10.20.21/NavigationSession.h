...
@class GEOComposedWaypoint, MNNavigationService, MNNavigationTraceInfo, NSMutableArray, NSString, NSTimer, NavigationSessionConfiguration, ObserverHashTable, PlatformController, RouteCollection;
