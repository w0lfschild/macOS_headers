...
#import "RouteNoQueryDataSourceDelegate-Protocol.h"
...
@interface RouteSearchViewController : ControlContaineeViewController <RouteSearchFieldsDelegate, ACDataSourceDelegate, GEOLogContextDelegate, RouteNoQueryDataSourceDelegate>
{
    BOOL _isHeadless;
