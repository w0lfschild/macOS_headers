...
@property(nonatomic, getter=isUserTrackingViewVisible) BOOL userTrackingViewVisible; // @synthesize userTrackingViewVisible=_userTrackingViewVisible;
...
- (void)setUserTrackingViewVisible:(BOOL)arg1 animated:(BOOL)arg2;
