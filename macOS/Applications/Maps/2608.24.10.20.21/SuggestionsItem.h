...
@class AddressBookAddress, GEOServerResultScoreMetadata, MKMapItem, MapsLocationOfInterest, MapsSuggestionsEntry, NSArray, NSDate, NSSet, NSString, ParkedCar, PersonalizedItemPrioritizedStringAdornment, PersonalizedItemSource, PersonalizedItemStyleAttributesAdornment, SearchResult, TrafficIncidentReport, VKLabelMarker;
