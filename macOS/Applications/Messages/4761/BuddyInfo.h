...
@class IMHandle, IMPerson, NSButton, NSCollectionView, NSMenu, NSMutableArray, NSSegmentedControl, NSString, NSTabView, NSTabViewItem, NSTextField, NSTokenField, NSView, NSWindow, PeoplePicker, SOBuddyPictureView;
