...
@class AVChat, AVChatWindow, AVSegmentedControl, AnimatingTabView, AudioRecordingAdapter, FezAVRecorder, IMChat, NSButton, NSMutableArray, NSMutableString, NSSlider, NSString, NSTabView, NSTabViewItem, NSTimer, NSView, StretchyImageView, VCNotifier, VideoRecordingAdapter, VolumeIndicator;
...
+ (id)initiateInvitationTo:(id)arg1 isVideo:(BOOL)arg2;
+ (id)_beginNewInvitationTo:(id)arg1 isVideo:(BOOL)arg2;
+ (BOOL)isInvitationTo:(id)arg1;
+ (id)_controllerWithAVChat:(id)arg1 notifier:(id)arg2;
+ (void)_warnMultiway:(BOOL)arg1 allPeople:(id)arg2 offenders:(id)arg3 offerText:(BOOL)arg4;
+ (void)_warnMaxVideo:(BOOL)arg1;
+ (void)_warnWithReason:(id)arg1 video:(BOOL)arg2;
+ (id)_warnTitleVideo:(BOOL)arg1;
...
+ (void)closeAllChats;
@property IMChat *textReply; // @synthesize textReply=_textReply;
...
- (id)_initWithAVChat:(id)arg1 notifier:(id)arg2;
