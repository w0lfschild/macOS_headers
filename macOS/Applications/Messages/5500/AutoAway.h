...
+ (int)welcomeBackMode;
+ (void)install;
@property __weak NSButton *dontShowAgainCheckbox; // @synthesize dontShowAgainCheckbox=_dontShowAgainCheckbox;
@property __weak NSTextField *messageField; // @synthesize messageField=_messageField;
@property(retain) NSPanel *welcomeBackPanel; // @synthesize welcomeBackPanel=_welcomeBackPanel;
- (void).cxx_destruct;
- (void)screenUnlocked;
- (void)screenLocked;
