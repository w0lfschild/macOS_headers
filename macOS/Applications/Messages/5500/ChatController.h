...
@class ChatTranscriptSearch, ChatTranscriptSearchResult, IMChat, InstantMessage, NSArray, NSDate, NSMutableArray, NSMutableIndexSet, NSString;
...
@property(copy) CDUnknownBlockType leaveBlock; // @synthesize leaveBlock=_leaveBlock;
