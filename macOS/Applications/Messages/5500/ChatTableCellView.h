...
@class CNAvatarViewController, IMTypingChatItem, MaskedView, NSArray, NSButton, NSLayoutConstraint, NSString, NSTextField, NSTimer, NSTrackingArea, NSView, SOChatDisplayController, SOStaticImageView, SOTypingIndicatorView;

@interface ChatTableCellView : NSTableCellView <CNAvatarViewDelegate, NSImmediateActionGestureRecognizerDelegate, NSMenuDelegate>
{
    ...
    IMTypingChatItem *_typingIndicatorChatItem;
}
...
@property(retain, nonatomic) IMTypingChatItem *typingIndicatorChatItem; // @synthesize typingIndicatorChatItem=_typingIndicatorChatItem;
