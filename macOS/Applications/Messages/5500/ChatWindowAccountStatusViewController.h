...
@class AccountsScrollView, AccountsTableController, MyStatusControl, NSLayoutConstraint, NSTextField, NSView, StatusController;
...
@interface ChatWindowAccountStatusViewController : NSViewController
{
    ...
    NSTextField *_unifiedAccountLabel;
...
@property(retain, nonatomic) NSTextField *unifiedAccountLabel; // @synthesize unifiedAccountLabel=_unifiedAccountLabel;
