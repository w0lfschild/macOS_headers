...
@class AccountsScrollView, AccountsTableController, IKProfilePictureView, IMAccount, IMPeople, MenuButton, MyNameControl, MyStatusControl, MyStatusImageControl, NSArray, NSBox, NSButton, NSDictionary, NSHashTable, NSMenu, NSMutableArray, NSMutableDictionary, NSScrollView, NSSearchField, NSSegmentedControl, NSString, NSTableView, NSTextField, NSTimer, NSView, NSViewAnimation, PeopleList, SOTimerCenter, SearchBackgroundView, StatusController;

@interface PeopleListController : NSWindowController <PeopleListDelegate, NSAnimationDelegate, NSSearchFieldDelegate, IKProfilePictureDelegate>
{
...
@property(retain, nonatomic) NSSegmentedControl *buddyListButtons; // @synthesize buddyListButtons=_buddyListButtons;
- (void).cxx_destruct;
...
@property(retain, nonatomic) IMAccount *representedAccount;
