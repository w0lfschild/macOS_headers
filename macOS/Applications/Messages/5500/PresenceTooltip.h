...
@class FezPresence, NSArray, NSImageView, NSMutableArray, NSTableView, NSTextField;
...
@property(retain, nonatomic) FezPresence *presence; // @synthesize presence=_presence;
- (void).cxx_destruct;
