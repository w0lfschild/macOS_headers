...
@class NSString, NSTextField, NSTokenField;
...
@interface ServiceFieldController : NSCollectionViewItem <NSTokenFieldDelegate>
{
    ...
    id <ServiceFieldControllerDelegate><NSTokenFieldDelegate> _delegate;
    NSTextField *_serviceLabel;
}

@property __weak NSTextField *serviceLabel; // @synthesize serviceLabel=_serviceLabel;
@property __weak id <ServiceFieldControllerDelegate><NSTokenFieldDelegate> delegate; // @synthesize delegate=_delegate;
@property __weak NSTokenField *handlesTokenField; // @synthesize handlesTokenField=_handlesTokenField;
- (void).cxx_destruct;
