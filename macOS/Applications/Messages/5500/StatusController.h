...
@class MyNameControl, MyStatusControl, MyStatusImageControl, NSArray, NSMutableArray, NSString;

@interface StatusController : NSObject <NSMenuDelegate, MyStatusControlDelegate>
{
...
@property(retain, nonatomic) MyStatusControl *statusControl; // @synthesize statusControl=_statusControl;
@property(retain) MyStatusImageControl *statusImageControl; // @synthesize statusImageControl=_statusImageControl;
- (void).cxx_destruct;
...
- (void)myStatusControl:(id)arg1 changedStatus:(unsigned long long)arg2 message:(id)arg3 changeAllAccounts:(BOOL)arg4;
- (void)myStatusControl:(id)arg1 changedStatus:(unsigned long long)arg2 message:(id)arg3;
