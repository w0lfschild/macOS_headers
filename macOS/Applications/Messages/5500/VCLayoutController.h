...
@interface VCLayoutController : NSObject
{
    ...
    float _PIPScale;
    CDStruct_dec669bc _PIPPosition;
...
- (void)_getAspectTransitionForLayers:(unsigned long long)arg1 ofWidth:(double)arg2 auxVideoMode:(int)arg3 containerStart:(struct CGSize *)arg4 end:(struct CGSize *)arg5 windowStart:(struct CGRect *)arg6 end:(struct CGRect *)arg7;
- (void)_fadeOutAOLBadge;
- (void)containerDidEndLiveResize;
- (void)updateLayout;
- (struct CGRect)_banner:(id)arg1 frameInVCLayer:(id)arg2;
- (struct CGRect)_theoreticalPIPFrameForLayers:(unsigned long long)arg1 inBounds:(struct CGRect)arg2 auxVideoMode:(int)arg3;
...
- (struct CGSize)_windowSizeForRemoteLayers:(unsigned long long)arg1 ofWidth:(double)arg2;
- (double)_transitionProgressReverse:(BOOL)arg1;
- (BOOL)isPreview;
- (double)_videoWidthToSnapWithMin:(double)arg1;
- (double)currentLayerWidth;
- (CDStruct_dec669bc)PIPPosition;
- (double)PIPScale;
- (id)container;
- (void)dealloc;
- (void)clearContainer;
