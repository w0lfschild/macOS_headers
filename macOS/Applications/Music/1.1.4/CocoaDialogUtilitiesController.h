...
- (void)setupAsStaticTextFieldWithTag:(long long)arg1;
...
- (void)setMultistateImage:(shared_ptr_a1745e57)arg1 forViewWithTag:(long long)arg2 style:(long long)arg3 value:(long long)arg4;
- (void)setImage:(id)arg1 forViewWithTag:(long long)arg2;
- (void)setTextAlignment:(long long)arg1 viewWithTag:(long long)arg2;
...
- (void)pinWidth:(double)arg1 forViewWithTag:(long long)arg2;
- (double)sizeButtonForThemeLayoutForViewWithTag:(long long)arg1;
...
- (void)setTextViewIndent:(struct CGSize)arg1 viewWithTag:(long long)arg2;
