...
@protocol FailedLoginPhotosViewDelegate;

@interface FailedLoginPhotosView : BaseViewController
{
    id <FailedLoginPhotosViewDelegate> _delegate;
    NSTextField *_titleLabel;
    NSTextField *_descriptionLabel;
    NSImageView *_firstIcon;
...
@property(retain, nonatomic) NSImageView *firstIcon; // @synthesize firstIcon=_firstIcon;
...
@property(nonatomic) __weak id <FailedLoginPhotosViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
