...
- (id)ipAddressForInterface:(id)arg1;
- (id)hardwareAddressForInterface:(id)arg1;
- (void)save;
- (void)restore;
- (void)displayGenericStats:(id)arg1;
- (void)updateTextFieldIfDifferent:(id)arg1 withString:(id)arg2;
- (void)displayControllerPropertiesWithBSDName:(struct __CFString *)arg1;
