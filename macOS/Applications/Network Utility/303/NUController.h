...
@class NSLock, NSMenu, NSMenuItem, NSMutableDictionary, NSString, NSTabView, NSTextView, NSWindow;

@interface NUController : NSObject <NSTextViewDelegate>
{
    NSWindow *window;
    NSTabView *tabView;
    NSMenu *menu;
    NSTextView *networkingToolsTextView;
...
- (void)awakeFromNib;
- (id)__deprecationText;
- (BOOL)__isInstallEnvironment;
