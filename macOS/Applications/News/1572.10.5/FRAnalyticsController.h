...
@interface FRAnalyticsController : NSObject <FREventCenterObserving, FCUserInfoObserving, FCNetworkReachabilityObserving, FCNewsAppConfigurationObserving, NSSNewsAnalyticsSessionManager, NSSNewsAnalyticsPBEventStreamObserver>
{
    BOOL _isNewUser;
...
- (void)configurationManagerUserDidJoinOrLeaveExperiment:(id)arg1;
- (void)submitAndSaveWithCompletionQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_repairEventDictionariesForSubmission;
- (void)submitEventsWithCompletionHandler:(CDUnknownBlockType)arg1;
...
- (void)_processAnalyticsEvent:(id)arg1;
...
- (id)eventDictionaryFromEvent:(id)arg1 sessionID:(id)arg2;
- (id)genericAnalyticsPropertiesForKeys:(id)arg1 sessionID:(id)arg2 withEvent:(id)arg3;
- (void)_addWatchAppSession:(id)arg1 notificationsEnabled:(BOOL)arg2;
- (void)addWatchAppSession:(id)arg1;
- (void)_resetUserID;
- (void)_startSessionWithReferral:(id)arg1 notificationsEnabled:(BOOL)arg2;
- (id)_sessionDictionaryWithIdentifier:(id)arg1 sessionIDKey:(id)arg2 notificationsEnabled:(BOOL)arg3 referral:(id)arg4;
...
- (void)syncFeldsparIdentityWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)dealloc;
- (id)initWithCloudContext:(id)arg1 progressivePersonalizationAnalyticsDataProvider:(id)arg2 notificationManager:(id)arg3 versionHelpers:(id)arg4 appSessionDataProvider:(id)arg5;
- (id)init;
