...
- (void)articlePageViewController:(FRArticlePageViewController *)arg1 didFinishLoadingEndOfArticleSectionWithHeadline:(id <FCHeadlineProviding>)arg2 publisherHeadlines:(NSArray *)arg3 relatedHeadlines:(NSArray *)arg4 allTopics:(NSArray *)arg5;
