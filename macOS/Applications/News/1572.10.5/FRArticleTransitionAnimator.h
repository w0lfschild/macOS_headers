...
@class NSString, SXVideoPlayerViewController, UIImage, UIImageView, UINavigationBar, UINavigationController, UIView;
...
@interface FRArticleTransitionAnimator : NSObject <UIViewControllerAnimatedTransitioning>
{
    ...
    UINavigationController *_feedNavigationController;
    UINavigationController *_articleNavigationController;
...
@property(nonatomic) __weak UINavigationController *articleNavigationController; // @synthesize articleNavigationController=_articleNavigationController;
@property(nonatomic) __weak UINavigationController *feedNavigationController; // @synthesize feedNavigationController=_feedNavigationController;
