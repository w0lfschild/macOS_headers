...
@class FRDynamicBarAnimator, FRScrollViewDelegateRouter, NSString, TSScrollViewCoordinator, UIScrollView;
@protocol FRBarCompressorDelegate, FRInteractiveBarCompressionAnimating;

@interface FRBarCompressor : NSObject <UIScrollViewDelegate, FRDynamicBarAnimatorDelegate, TSCardViewAnimationCoordinatorDelegate>
{
