...
#import "FRSiriSuggestionsCollectionViewCellDelegate-Protocol.h"
...
@interface FRFeedDataSource : NSObject <FRFeedCollectionViewCellDelegate, FRFeedObscuredHeadlineCollectionViewCellDelegate, FRFeedBasedDataSourceDelegate, FCNewsAppConfigurationObserving, UIGestureRecognizerDelegate, UIViewControllerPreviewingDelegate, FRCollectionHeaderDelegate, FRCollectionFooterDelegate, FRSubscriptionMonitorDelegate, FRFeedCollectionViewLayoutBlueprintIntegratorType, FRFeedCollectionViewUpdateManagerDelegate, FRSiriSuggestionsCollectionViewCellDelegate, FRPickYourFavoritesCollectionViewCellDelegate, FRFeedHeadlineViewRendererDataSource, TSVideoGroupRoutableFeedDelegate, TSTopOfFeedRoutableFeedDelegate, UICollectionViewDataSource, FRDragControllerDataSource, FRFeedAdInventoryDelegate>
{
    ...
    NFObjectReuseManager *_specialEventsControllerReuseManager;
    NSMutableDictionary *_specialEventsGroupMetaData;
    NSMutableDictionary *_specialEventsGroupReuseIdentifiers;
...
@property(retain, nonatomic) NSMutableDictionary *specialEventsGroupReuseIdentifiers; // @synthesize specialEventsGroupReuseIdentifiers=_specialEventsGroupReuseIdentifiers;
@property(retain, nonatomic) NSMutableDictionary *specialEventsGroupMetaData; // @synthesize specialEventsGroupMetaData=_specialEventsGroupMetaData;
@property(retain, nonatomic) NFObjectReuseManager *specialEventsControllerReuseManager; // @synthesize specialEventsControllerReuseManager=_specialEventsControllerReuseManager;
...
- (void)runRemoveWelcomeToNewsModifier;
...
- (void)welcomeToNewsCollectionViewCellSettingsTapped:(id)arg1;
- (void)siriSuggestionsCollectionViewCellNewsAndPrivacyLinkTapped:(id)arg1;
