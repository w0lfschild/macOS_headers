...
@class FCFeedDescriptor, FRCollapsedHeadlineCell, FRCollectionHeaderReusableView, FRFeedCollectionViewCell, FRFeedDataSource, FRFeedObscuredHeadlineCollectionViewCell, FRFeedViewContext, FRHeartControl, FRSpecialEventsArticleViewContext, FRSubscriptionPlacardCollectionViewCell, NFLHeadlineTileInfo, NSArray, NSError, NSString, UIView, UIViewController, UIWindow;
@protocol FCHeadlineProviding, FRCoverArticlesCollectionViewCellDelegate;

@protocol FRFeedDataSourceDelegate <NSObject>
- (void)feedDataSource:(FRFeedDataSource *)arg1 didSelectHeadlineForTileInfo:(NFLHeadlineTileInfo *)arg2 specialEventsArticleViewContext:(FRSpecialEventsArticleViewContext *)arg3;
- (UIViewController *)feedDataSource:(FRFeedDataSource *)arg1 previewingViewControllerForTileInfo:(NFLHeadlineTileInfo *)arg2 specialEventsArticleViewContext:(FRSpecialEventsArticleViewContext *)arg3;
- (void)feedDataSource:(FRFeedDataSource *)arg1 didSelectShareActivityForHeadline:(id <FCHeadlineProviding>)arg2 activityType:(NSString *)arg3 completed:(BOOL)arg4 returnedItems:(NSArray *)arg5 activityError:(NSError *)arg6 groupType:(long long)arg7;
...
- (void)feedDataSourceWantToPresentPersonalizeNewsFlow:(FRFeedDataSource *)arg1;
...
- (void)feedDataSourceWillPresentContent:(FRFeedDataSource *)arg1 animated:(BOOL)arg2;
...
- (void)feedDataSource:(FRFeedDataSource *)arg1 headerView:(FRCollectionHeaderReusableView *)arg2 wantsToDebug:(FCFeedDescriptor *)arg3;
