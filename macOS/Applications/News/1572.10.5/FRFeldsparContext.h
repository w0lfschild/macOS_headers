...
@interface FRFeldsparContext : NSObject <FRFeldsparContext>
{
    ...
    FRSavedTabCountManager *_savedTabCountManager;
...
@property(retain, nonatomic) FRSavedTabCountManager *savedTabCountManager; // @synthesize savedTabCountManager=_savedTabCountManager;
