...
@class FCArticle, FRContentObscuringView, FRFeedSubscriptionModificationSessionManager, FRFlintAdController, FRFlintAppActivityMonitor, FRFlintDataProvider, FRHardPaywallViewController, FRNativeAdFetcher, FRNativeSubscriptionAdFetcher, FRSpinnerView, FRSponsoredBarViewController, FRStatusBarObserver, FRSubscriptionHeaderViewController, FRValidationQueue, NSDate, NSError, NSMutableDictionary, NSString, NUURLHandler, SXContext, SXScrollViewController, SXVideoPlayerViewControllerManager, TSArticleRecirculationInArticleViewControllerProvider, TSBlueprintManualImpressionUpdateProvider, TSScrollViewCoordinator, UIViewController;
@protocol FCOperationCanceling, TSArticleRecirculationBridgedServiceType, TSArticleRecirculationViewControllersProviderType, TSCardViewAnimationCoordinatorDelegate, UIViewControllerAnimatedTransitioning;

@interface FRFlintArticleContentViewController : FRArticleContentViewController <FRScrollPositionProviding, FCReadingHistoryObserving, FRAppActivityObserving, FRSubscriptionHeaderViewControllerDelegate, SXScrollViewControllerDelegate, SXAnalyticsReporting, FCStreamingResultsObserving, FRFlintArticleDataSource, FRHardPaywallViewControllerDelegate, FRPurchaseManagerPurchaseViewControllerDelegate, NUURLHandlerDelegate, TSArticleRecirculationViewControllerDelegate, TSArticleRecirculationRoutableFeedDelegate, TSParentViewBoundsProvider, TSCardViewAnimationCoordinatorDelegate, FRArticleTransitionAnimatorArticle, FRStackViewControllerAnimatorContext, TSNativeAdDataProviderType>
{
...
- (void)articleRecirculationRouted:(id)arg1 didSelectShareActivityForHeadline:(id)arg2 activityType:(id)arg3 completed:(BOOL)arg4 returnedItems:(id)arg5 activityError:(id)arg6 inSection:(long long)arg7;
- (void)articleRecirculationRouted:(id)arg1 didSelectReportConcernActivityForHeadline:(id)arg2;
- (void)articleRecirculationRouted:(id)arg1 didSelectHeadline:(id)arg2 withProperties:(id)arg3 inCollection:(id)arg4;
...
- (unsigned long long)sharingPolicyForHeadline:(id)arg1 appConfiguration:(id)arg2;
