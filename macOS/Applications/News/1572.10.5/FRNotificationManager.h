...
@class FCNotificationsConfiguration, FRNotificationAutoEnableHelper, NFMutexLock, NSDictionary, NSHashTable, NSString;
@protocol FCNewsAppConfigurationManager, FRFeldsparContext, FRNotificationManagerDelegate;
...
@interface FRNotificationManager : NSObject <UNUserNotificationCenterDelegate, FCNewsAppConfigurationObserving, FCSubscriptionObserving, TSNotificationManagerType>
{
    ...
    id <FRNotificationManagerDelegate> _delegate;
...
@property(nonatomic) __weak id <FRNotificationManagerDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)addTopStoriesAsPresubscribedChannel;
- (void)dealloc;
