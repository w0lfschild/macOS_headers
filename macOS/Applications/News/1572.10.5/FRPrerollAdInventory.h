...
- (void).cxx_destruct;
- (void)videoInFeedPrerollForFeedDescriptor:(id)arg1 articleViewContext:(id)arg2 prerollLoadingTimeout:(double)arg3 aspectRatioOfVideoPlayer:(double)arg4 headline:(id)arg5 completion:(CDUnknownBlockType)arg6;
