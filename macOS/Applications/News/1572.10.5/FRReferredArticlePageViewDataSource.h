...
- (void)articlePageViewController:(id)arg1 didFinishLoadingEndOfArticleSectionWithHeadline:(id)arg2 publisherHeadlines:(id)arg3 relatedHeadlines:(id)arg4 allTopics:(id)arg5;
- (id)filterSeletedHeadline:(id)arg1 headlines:(id)arg2;
- (void)_reIndexArticlePagesWithHeadlines:(id)arg1;
- (id)setReferredHeadlineSectionWithHeadlines:(id)arg1 bannerTitle:(id)arg2 sectionThemeColor:(id)arg3 showDiscoverMoreInterstitial:(BOOL)arg4;
...
- (void)handleFetchOperationResultWithHeadlines:(id)arg1 bannerTitle:(id)arg2 sectionThemeColor:(id)arg3 showDiscoverMoreInterstitial:(BOOL)arg4;
