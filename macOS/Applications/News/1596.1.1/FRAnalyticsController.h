...
- (void)_notificationSettingsWithCompletionHandler:(CDUnknownBlockType)arg1;
...
- (void)_addWatchAppSession:(id)arg1 notificationSettings:(id)arg2;
- (void)addWatchAppSession:(id)arg1;
- (void)_resetUserID;
- (void)_startSessionWithReferral:(id)arg1 notificationSettings:(id)arg2;
