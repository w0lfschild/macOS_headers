...
+ (id)articleContextForRelatedArticlesWithIsPaidSubscriberToSourceChannel:(BOOL)arg1;
+ (id)articleContextForMoreFromPublisherWithIsPaidSubscriberToSourceChannel:(BOOL)arg1;
