...
@class NSString, TSNewsTabNavigator;
@protocol FRFeldsparContext, NFResolver, TSBridgedNewsActivityFactoryType;
...
- (id)initWithFeldsparContext:(id)arg1 resolver:(id)arg2 navigator:(id)arg3 activityFactory:(id)arg4;
