...
@class FCArticle, FRContentObscuringView, FRFeedSubscriptionModificationSessionManager, FRFlintAdController, FRFlintAppActivityMonitor, FRFlintDataProvider, FRHardPaywallViewController, FRNativeAdFetcher, FRNativeSubscriptionAdFetcher, FRReferredArticlePageViewDataSource, FRSpinnerView, FRSponsoredBarViewController, FRStatusBarObserver, FRSubscriptionHeaderViewController, FRValidationQueue, NSDate, NSError, NSMutableDictionary, NSString, NUURLHandler, SXContext, SXScrollViewController, SXVideoPlayerViewControllerManager, TSArticleRecirculationInArticleViewControllerProvider, TSBlueprintManualImpressionUpdateProvider, UIViewController;
...
@interface FRFlintArticleContentViewController : FRArticleContentViewController <FRScrollPositionProviding, FCReadingHistoryObserving, FRAppActivityObserving, FRSubscriptionHeaderViewControllerDelegate, SXScrollViewControllerDelegate, SXAnalyticsReporting, FCStreamingResultsObserving, FRFlintArticleDataSource, FRHardPaywallViewControllerDelegate, FRPurchaseManagerPurchaseViewControllerDelegate, NUURLHandlerDelegate, TSArticleRecirculationViewControllerDelegate, TSArticleRecirculationRoutableFeedDelegate, TSParentViewBoundsProvider, FRArticleTransitionAnimatorArticle, FRStackViewControllerAnimatorContext, TSNativeAdDataProviderType, TSPurchaseContextProvider>
{
