...
@protocol FREditorialConfigurationProvider, FREditorialItemDownloader, FREditorialItemEntryManager, FREditorialItemThumbnailCreator, TSBrowseTabBarItemManagerType, TSEditorialItemChangeDelegate;
...
@interface FRToCEditorialManager : NSObject <FRAppActivityObserving, FCUserInfoObserving, TSEditorialItemProvider, FRToCEditorialManager>
{
    ...
    id <TSBrowseTabBarItemManagerType> browseTabBarItemManager;
...
@property(nonatomic) __weak id <TSBrowseTabBarItemManagerType> browseTabBarItemManager; // @synthesize browseTabBarItemManager;
