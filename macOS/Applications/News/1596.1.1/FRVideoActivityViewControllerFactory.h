...
@protocol FRFeldsparContext, NSSNewsAnalyticsArticleViewingSessionTracker;
...
- (void).cxx_destruct;
- (id)activityViewControllerForVideoItem:(id)arg1 presentingViewController:(id)arg2 URLHandler:(id)arg3;
- (id)initWithReferral:(id)arg1 feedType:(long long)arg2 groupType:(long long)arg3 shareLocation:(long long)arg4 feldsparContext:(id)arg5 articleViewingSessionTracker:(id)arg6;
- (id)init;
