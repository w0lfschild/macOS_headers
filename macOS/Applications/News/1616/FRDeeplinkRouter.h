...
@protocol FRFeldsparContext, NFResolver, TSActivityErrorHandlerType, TSBridgedNewsActivityFactoryType;
...
- (id)initWithFeldsparContext:(id)arg1 resolver:(id)arg2 navigator:(id)arg3 activityFactory:(id)arg4 activityErrorHandler:(id)arg5;
