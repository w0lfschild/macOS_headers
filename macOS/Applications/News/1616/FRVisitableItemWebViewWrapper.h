...
@property(readonly, nonatomic) BOOL showSubscriptionRequiredText; // @synthesize showSubscriptionRequiredText=_showSubscriptionRequiredText;
...
@property(readonly, nonatomic) BOOL usesImageOnTopLayout; // @synthesize usesImageOnTopLayout=_usesImageOnTopLayout;
@property(readonly, nonatomic) double tileProminenceScore; // @synthesize tileProminenceScore=_tileProminenceScore;
@property(readonly, nonatomic) FCFeedPersonalizedArticleScoreProfile *scoreProfile; // @synthesize scoreProfile=_scoreProfile;
@property(readonly, copy, nonatomic) NSString *accessoryText; // @synthesize accessoryText=_accessoryText;
@property(readonly, copy, nonatomic) NSSet *surfacedByTagIDs; // @synthesize surfacedByTagIDs=_surfacedByTagIDs;
...
@property(readonly, nonatomic) unsigned long long topStoryType; // @synthesize topStoryType=_topStoryType;
@property(readonly, nonatomic) BOOL isTopStory; // @synthesize isTopStory=_isTopStory;
...
@property(readonly, nonatomic, getter=isDisplayingAsNativeAd) BOOL displayAsNativeAd; // @synthesize displayAsNativeAd=_displayAsNativeAd;
...
@property(copy, nonatomic) FCHeadlineExperimentalTitleMetadata *experimentalTitleMetadata; // @synthesize experimentalTitleMetadata;
