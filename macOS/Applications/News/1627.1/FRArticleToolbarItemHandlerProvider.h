...
@class FCPurchaseController, FCReadingHistory, NSArray, NSString;
@protocol FCHeadlineProviding, FCNewsAppConfigurationManager;

@interface FRArticleToolbarItemHandlerProvider : NSObject <FCReadingHistoryObserving, TUWindowToolbarItemHandlerProviding>
{
...
- (void)dealloc;
- (id)initWithHeadline:(id)arg1 readingHistory:(id)arg2 appConfigurationManager:(id)arg3 purchaseController:(id)arg4 activitySources:(id)arg5;
