...
@interface FRSearchMoreResultsViewController : FRSearchResultsTableViewController <FCSubscriptionObserving, FRStoryboardRestorableViewController, UITableViewDataSource, UITableViewDelegate>
{
    BOOL _isLoading;
    BOOL _noMoreResults;
...
+ (id)searchMoreResultsViewControllerWithContext:(id)arg1 searchResults:(id)arg2 searchResultsType:(unsigned long long)arg3 searchResultsPresenter:(unsigned long long)arg4 storyboard:(id)arg5;
