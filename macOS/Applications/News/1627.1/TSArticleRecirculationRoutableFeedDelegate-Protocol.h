...
- (void)articleRecirculationRouted:(id <TSArticleRecirculationRoutedType>)arg1 didSelectShareActivityForHeadline:(id <FCHeadlineProviding>)arg2 activityType:(NSString *)arg3 completed:(BOOL)arg4 returnedItems:(NSArray *)arg5 activityError:(NSError *)arg6 inSection:(long long)arg7 groupViewExposureID:(NSString *)arg8;
