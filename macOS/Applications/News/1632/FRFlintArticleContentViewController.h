...
@interface FRFlintArticleContentViewController : FRArticleContentViewController <FRScrollPositionProviding, FCReadingHistoryObserving, FRAppActivityObserving, FRSubscriptionHeaderViewControllerDelegate, SXScrollViewControllerDelegate, SXAnalyticsReporting, FCStreamingResultsObserving, FRFlintArticleDataSource, FRHardPaywallViewControllerDelegate, FRPurchaseManagerPurchaseViewControllerDelegate, NUURLHandlerDelegate, TSArticleRecirculationViewControllerDelegate, TSArticleRecirculationRoutableFeedDelegate, TSParentViewBoundsProvider, FRLocalDraftPreviewable, FRArticleTransitionAnimatorArticle, FRStackViewControllerAnimatorContext, TSNativeAdDataProviderType, TSPurchaseContextProvider>
{
