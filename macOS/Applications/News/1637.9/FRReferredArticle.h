...
- (id)initWithArticleID:(id)arg1 sourceChannelID:(id)arg2 sectionData:(id)arg3 flintDocumentAssetHandle:(id)arg4 articleRecordData:(id)arg5 sourceChannelRecordData:(id)arg6;
