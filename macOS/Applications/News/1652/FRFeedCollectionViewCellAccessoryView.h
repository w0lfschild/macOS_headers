...
@class FRFeedCollectionViewCellActivityIndicatorView, FRTouchInsetsButton, NSString, UIColor, UIFont, UILabel;
...
{
    BOOL _configuredAdMarkerButton;
    ...
    FRTouchInsetsButton *_adMarkerButton;
...
+ (void)prefetchAdMarkImages;
+ (id)adMarkHighlightedImage;
+ (id)adMarkImage;
@property(retain, nonatomic) id <FCHeadlineProviding> populatedHeadline; // @synthesize populatedHeadline=_populatedHeadline;
@property(nonatomic) BOOL configuredAdMarkerButton; // @synthesize configuredAdMarkerButton=_configuredAdMarkerButton;
@property(nonatomic) FRTouchInsetsButton *adMarkerButton; // @synthesize adMarkerButton=_adMarkerButton;
