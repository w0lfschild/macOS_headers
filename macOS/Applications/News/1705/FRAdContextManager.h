...
+ (id)_dictionaryMetadataForFeed:(id)arg1 adPreviewID:(id)arg2;
...
+ (id)_dictionaryMetadataForGroupFeedDescriptor:(id)arg1 sectionDescriptorClass:(Class)arg2 additionalCategories:(id)arg3 additionalKeywords:(id)arg4;
...
+ (id)_groupContextWithArticleContext:(id)arg1;
