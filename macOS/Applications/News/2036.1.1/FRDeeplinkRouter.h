...
@class NSString;
@protocol FCNewsAppConfigurationManager, FRFeldsparContext, FRLocalDraftsManager, NFResolver, TSActivityErrorHandlerType, TSBridgedNewsActivityFactoryType, TSBridgedNewsActivityNavigatorType;
