...
- (id)initWithArticleController:(id)arg1 subscriptionController:(id)arg2 readingHistory:(id)arg3 purchaseController:(id)arg4 purchaseManager:(id)arg5 bundleSubscriptionManager:(id)arg6;
