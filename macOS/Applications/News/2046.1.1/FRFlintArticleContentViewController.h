...
@interface FRFlintArticleContentViewController : FRArticleContentViewController <FRScrollPositionProviding, FCReadingHistoryObserving, FRAppActivityObserving, FRSubscriptionHeaderViewControllerDelegate, SXScrollViewControllerDelegate, SXAnalyticsReporting, FCStreamingResultsObserving, FRFlintArticleDataSource, FRHardPaywallViewControllerDelegate, FRPurchaseManagerPurchaseViewControllerDelegate, NUURLHandlerDelegate, TSArticleRecirculationViewControllerDelegate, TSArticleRecirculationRoutableFeedDelegate, TSParentViewBoundsProvider, FRLocalDraftPreviewable, NUANFDebugSettingsObserver, FRArticleTransitionAnimatorArticle, FRViewControllerAnimatorContext, TSNativeAdDataProviderType, NABridgedArticleViewerPageItemActionHandlerDelegateType>
{
