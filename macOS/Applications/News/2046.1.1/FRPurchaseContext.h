...
+ (id)purchaseContextWithSourceChannelID:(id)arg1 articleID:(id)arg2 sectionID:(id)arg3 purchaseSessionID:(id)arg4 subscriptionConversionPointType:(long long)arg5 qToken:(id)arg6 parentFeedType:(long long)arg7 adCampaignID:(id)arg8 arrivedFromAd:(BOOL)arg9 sawSubscriptionSheet:(BOOL)arg10 referral:(id)arg11;
+ (id)purchaseContextWithSourceChannelID:(id)arg1 articleID:(id)arg2 sectionID:(id)arg3 subscriptionConversionPointType:(long long)arg4 qToken:(id)arg5 parentFeedType:(long long)arg6 adCampaignID:(id)arg7 fromSubscriptionAd:(BOOL)arg8 referral:(id)arg9;
