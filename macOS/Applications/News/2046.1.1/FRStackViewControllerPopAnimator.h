...
@class CADisplayLink, NSArray, NSString, TUAnimationAffineTransformFunction, TUAnimationFloatFunction, TUAnimationRectFunction, UINavigationBar, UIView;
...
@interface FRStackViewControllerPopAnimator : NSObject <UIViewControllerInteractiveTransitioning, UIViewControllerAnimatedTransitioning>
{
    ...
    TUAnimationAffineTransformFunction *_toViewTransformFunction;
    TUAnimationAffineTransformFunction *_fromViewTransformFunction;
    TUAnimationAffineTransformFunction *_fromTitleViewTransformFunction;
    TUAnimationAffineTransformFunction *_toTitleViewTransformFunction;
    TUAnimationRectFunction *_toViewFrameFunction;
    TUAnimationRectFunction *_fromViewFrameFunction;
    TUAnimationRectFunction *_toTitleViewFrameFunction;
    TUAnimationRectFunction *_fromTitleViewFrameFunction;
    TUAnimationFloatFunction *_shadowOpacityFunction;
    TUAnimationFloatFunction *_navBarFadingOutViewsAlphaFunction;
    TUAnimationFloatFunction *_navBarFadingInViewsAlphaFunction;
