...
@class FRNextArticleButton, NABridgedArticleViewerPageItemActionHandler, NSString, UIBarButtonItem, UIViewController;
...
- (void)doNext:(id)arg1;
- (void)updateMagazineButtonAndPageBottomInsetForHeadline:(id)arg1 animated:(BOOL)arg2;
