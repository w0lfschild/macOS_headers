...
+ (id)purchaseContextWithSourceChannelID:(id)arg1 articleID:(id)arg2 sectionID:(id)arg3 purchaseSessionID:(id)arg4 subscriptionConversionPointType:(long long)arg5 qToken:(id)arg6 parentFeedType:(long long)arg7 arrivedFromAd:(BOOL)arg8 sawSubscriptionSheet:(BOOL)arg9 referral:(id)arg10;
