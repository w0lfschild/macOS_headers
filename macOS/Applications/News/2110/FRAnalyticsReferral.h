...
- (id)initWithUserActivityType:(id)arg1 creativeID:(id)arg2 campaignID:(id)arg3 campaignType:(id)arg4 referringApplication:(id)arg5 referringURL:(id)arg6 appOpenedByUserActivity:(BOOL)arg7 widgetModeGroupID:(id)arg8 widgetEngagement:(id)arg9 appSessionStartMethod:(long long)arg10 appSessionStartNotificationType:(long long)arg11;
