...
@class FRFeedCollectionViewCellActivityIndicatorView, NEPremiumBadgeView, NSString, SVAdPrivacyButton, UIColor, UIFont, UILabel;
@protocol FCHeadlineProviding, FCPaidAccessCheckerType, FRFeedCollectionViewCellAccessoryViewDelegate;
...
- (void)populateWithHeadline:(id)arg1 paidAccessChecker:(id)arg2;
