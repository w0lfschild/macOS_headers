...
@interface FRFlintArticleContentViewController : FRArticleContentViewController <FRScrollPositionProviding, FCReadingHistoryObserving, FRAppActivityObserving, FRSubscriptionHeaderViewControllerDelegate, SXScrollViewControllerDelegate, SXAnalyticsReporting, FCStreamingResultsObserving, FRFlintArticleDataSource, FRHardPaywallViewControllerDelegate, NUURLHandlerDelegate, TSArticleRecirculationViewControllerDelegate, TSArticleRecirculationRoutableFeedDelegate, FRLocalDraftPreviewable, NPPaywallDelegate, NUANFDebugSettingsObserver, FRScrollable, NAZoomable, SXHostable, FRArticleTransitionAnimatorArticle, FRViewControllerAnimatorContext, TSNativeAdDataProviderType, NABridgedArticleViewerPageItemActionHandlerDelegateType>
{
