...
@class FCArticle, FRContentObscuringView, FRFeedSubscriptionModificationSessionManager, FRFlintAdController, FRFlintDataProvider, FRHardPaywallViewController, FRNativeAdFetcher, FRNativeSubscriptionAdFetcher, FRPaidBundleDeferredHardPaywallDocumentSectionItemProvider, FRPaidBundleSoftPaywallDocumentSectionItemProvider, FRReferredArticlePageViewDataSource, FRScrollQueueManager, FRSpinnerView, FRSponsoredBarViewController, FRStatusBarObserver, FRSubscriptionHeaderViewController, FRValidationQueue, NFEventManager, NPPaywall, NSDate, NSError, NSMutableDictionary, NSString, NUURLHandler, SXContext, SXScrollViewController, SXVideoPlayerViewControllerManager, TSArticleRecirculationInArticleViewControllerProvider, TSKeyCommandManager, UIResponder, UIViewController;
@protocol FCOperationCanceling, NUANFDebugSettingsProvider, NUArticleContentSizeManager, TSArticleRecirculationBridgedServiceType, TSArticleRecirculationViewControllersProviderType, UIViewControllerAnimatedTransitioning;

@interface FRFlintArticleContentViewController : FRArticleContentViewController <FRScrollPositionProviding, FCReadingHistoryObserving, FRAppActivityObserving, FRSubscriptionHeaderViewControllerDelegate, SXScrollViewControllerDelegate, SXAnalyticsReporting, FCStreamingResultsObserving, FRFlintArticleDataSource, FRHardPaywallViewControllerDelegate, NUURLHandlerDelegate, TSArticleRecirculationViewControllerDelegate, TSArticleRecirculationRoutableFeedDelegate, FRLocalDraftPreviewable, NPPaywallDelegate, NUANFDebugSettingsObserver, FRScrollable, NAZoomable, SXHostable, TSResponderProviding, FRArticleTransitionAnimatorArticle, FRViewControllerAnimatorContext, TSNativeAdDataProviderType, NABridgedArticleViewerPageItemActionHandlerDelegateType>
{
...
- (void)deferArticleRecirculationWork:(CDUnknownBlockType)arg1;
