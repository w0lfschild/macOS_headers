...
@class FCAssetHandle, FCCloudContext, FCFlintManifest, FCFlintResourceManager, FRFlintDataLoadingGroup, NFUnfairLock, NSArray, NSError, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSString, SXContext, UIImage;
...
- (id)initWithFlintManifest:(id)arg1 headline:(id)arg2 resourceManager:(id)arg3 cloudContext:(id)arg4 embedConfigurationManager:(id)arg5;
