...
+ (id)navigationStyleForForYouHeaderOverTopOfFeedWithThemeColor:(id)arg1 shouldUseMultiColorStatusBar:(BOOL)arg2;
+ (id)navigationStyleForForYouHeader;
+ (id)navigationStyleForCompressionFromBarStyle:(id)arg1;
+ (id)navigationStyleForInterstitial;
+ (id)navigationStyleForArticleWithSpecialEventsTheme:(id)arg1 shouldUseMultiColorStatusBar:(BOOL)arg2;
