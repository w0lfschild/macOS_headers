...
@class FCFeedDescriptor, FRBundleSubscriptionPlacardCollectionViewCell, FRCollapsedHeadlineCell, FRCollectionHeaderReusableView, FRFeedCollectionViewCell, FRFeedDataSource, FRFeedObscuredHeadlineCollectionViewCell, FRFeedViewContext, FRLikeDislikeControl, FRSubscriptionPlacardCollectionViewCell, NFLHeadlineTileInfo, NSArray, NSError, NSString, UIView, UIViewController, UIWindow;
...
- (void)feedDataSource:(FRFeedDataSource *)arg1 likeDislikeControlTapped:(UIView *)arg2 forSectionWithSectionID:(NSString *)arg3;
