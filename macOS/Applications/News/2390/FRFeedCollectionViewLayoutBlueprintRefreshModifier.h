...
- (BOOL)shouldContinueForAnimationWithDiff:(id)arg1 leftBlueprint:(id)arg2 rightBlueprint:(id)arg3;
...
- (id)initWithFeldsparContext:(id)arg1 feedSettings:(id)arg2 feedDataStorage:(id)arg3 offline:(BOOL)arg4 refreshKind:(unsigned long long)arg5 refreshDetector:(id)arg6 feed:(id)arg7 buttonController:(id)arg8 pluginManager:(id)arg9 bridgedBlueprintManager:(id)arg10 topVideosPluginFactory:(id)arg11 moreVideosPluginFactory:(id)arg12 channelIssuesPluginFactory:(id)arg13 magazinesPluginFactory:(id)arg14 todayPluginFactory:(id)arg15 subscriptionPlacardCreator:(id)arg16;
