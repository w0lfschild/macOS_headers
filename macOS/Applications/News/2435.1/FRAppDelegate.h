...
@interface FRAppDelegate : UIResponder <FRAppActivityObserving, FRNotificationManagerObserving, FCFlintHelper, FRGizmoSyncManagerDelegate, FCNewsAppConfigurationObserving, TSLocalDraftsDelegate, UIApplicationDelegate>
{
    int lockStateToken;
    BOOL _inPreviewMode;
