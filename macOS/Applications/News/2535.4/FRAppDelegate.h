...
- (void)applyStyles;
- (void)setupPPTAdditionalSteps;
- (void)setupPPTWithApplication:(id)arg1;
- (void)setRunningPPTWithApplication:(id)arg1;
- (void)scheduleTasksWithOptions:(id)arg1;
- (void)prefetchForyouASAPWithPersonalizationDataSource:(id)arg1;
- (double)_timeSinceLastActivation;
