...
- (id)initWithCloudContext:(id)arg1 activityMonitor:(id)arg2 editorialItemEntryManager:(id)arg3 articleEditorialItemDownloader:(id)arg4 tagEditorialItemDownloader:(id)arg5 editorialConfigurationProvider:(id)arg6 thumbnailCreator:(id)arg7 flintHelper:(id)arg8;
- (id)init;
