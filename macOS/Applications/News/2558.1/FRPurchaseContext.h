...
+ (id)purchaseContextWithSourceChannelID:(id)arg1 articleID:(id)arg2 issueID:(id)arg3 feedID:(id)arg4 sectionID:(id)arg5 groupID:(id)arg6 groupType:(long long)arg7 purchaseSessionID:(id)arg8 subscriptionConversionPointType:(long long)arg9 qToken:(id)arg10 parentFeedType:(long long)arg11 arrivedFromAd:(BOOL)arg12 referral:(id)arg13;
