...
@class FCAsyncSerialQueue, FCCloudContext, FCKeyValueStore, FRAppSessionCounter, FRNotificationManager, FRProactiveEventTracker, FRVersionHelpers, NSData, NSDate, NSHashTable, NSMutableArray, NSString, NTPBSession, TSNotificationSettings;
