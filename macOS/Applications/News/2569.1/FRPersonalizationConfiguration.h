...
@class FCKeyValueStore, FCLocalAreasMapping, FCPersonalizationBundleIDMapping, FCPersonalizationFavorabilityScores, FCPersonalizationTodaySectionMapping, FCPersonalizationTreatment, FCPersonalizationURLMapping, FRPersonalizationAutoFavorites, NSDate;
