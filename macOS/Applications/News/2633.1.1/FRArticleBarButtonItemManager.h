...
- (void)setToggleSaveBarButtonItemState:(BOOL)arg1;
...
- (id)initWithViewController:(id)arg1 readingHistory:(id)arg2 initialLikingStatus:(unsigned long long)arg3 initialSavedState:(BOOL)arg4 bundleSubscriptionManager:(id)arg5 headline:(id)arg6;
