...
@class FCFeedDescriptor, FRAnalyticsReferral, FRFeedCollectionViewLayoutSectionDescriptorForYou, FRFeedViewContext, NPPaywall, NSDate, NSString, NSURL, TSBridgedFeedArticleContext;
...
+ (id)articleContextForLinkWithURL:(id)arg1 sourceApplication:(id)arg2 previousArticleID:(id)arg3 previousArticleVersion:(id)arg4 adPreviewSessionID:(id)arg5 adPreviewID:(id)arg6 adQToken:(id)arg7 maximumAdRequestsForCurrentAdPreviewID:(long long)arg8 userActionDate:(id)arg9 shouldAutoPlayVideo:(BOOL)arg10;
...
- (id)ts_ArticleContextWithTitle:(id)arg1;
