...
@class FCAsyncSerialQueue, FCCloudContext, FCKeyValueStore, FRAppSessionCounter, FRNotificationManager, FRProactiveEventTracker, FRVersionHelpers, NSData, NSDate, NSHashTable, NSMutableArray, NSMutableDictionary, NSString, NTPBSession, TSNotificationSettings;
...
@interface FRAnalyticsController : NSObject <FREventCenterObserving, FCUserInfoObserving, FCNetworkReachabilityObserving, FCNewsAppConfigurationObserving, NSSNewsAnalyticsSessionManager, NSSNewsAnalyticsPBEventStreamObserver, NYSessionAccessing>
{
    ...
    BOOL _protobufSubmissionEnabled;
...
+ (BOOL)feed3_0Enabled:(id)arg1;
- (void).cxx_destruct;
@property(nonatomic) BOOL protobufSubmissionEnabled; // @synthesize protobufSubmissionEnabled=_protobufSubmissionEnabled;
...
- (void)setNotificationSettingsFromNotificationService:(id)arg1;
...
- (void)didObtainOffer:(id)arg1;
- (void)_updateIsNewUserIfNeeded;
- (void)_updateSessionsWithLocalRegionIDs:(id)arg1;
...
- (void)_startSessionWithReferral:(id)arg1 notificationSettings:(id)arg2 mainThreadProperties:(id)arg3 sceneID:(id)arg4 resetUserID:(BOOL)arg5;
...
- (void)endSessionForReason:(long long)arg1 byStartingNewSession:(BOOL)arg2 resetUserID:(BOOL)arg3 forSceneID:(id)arg4;
- (void)resignSessionForSceneID:(id)arg1;
- (void)startSessionIfNeededWithReferral:(id)arg1 sceneID:(id)arg2;
- (id)currentSessionID;
- (BOOL)sessionInProgressForID:(id)arg1;
- (void)updateSessionWithRegionIDs;
...
- (void)dealloc;
- (id)initWithCloudContext:(id)arg1 progressivePersonalizationAnalyticsDataProvider:(id)arg2 notificationManager:(id)arg3 versionHelpers:(id)arg4 preferredUserID:(id)arg5;
- (id)init;
