...
+ (id)_dictionaryMetadataForGroupFeedDescriptor:(id)arg1 sectionDescriptorClass:(Class)arg2 additionalCategories:(id)arg3 additionalKeywords:(id)arg4 languages:(id)arg5 channelID:(id)arg6 contentProviderID:(id)arg7;
