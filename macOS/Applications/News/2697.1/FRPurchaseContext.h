...
+ (id)purchaseContextWithSourceChannelID:(id)arg1 articleID:(id)arg2 issueID:(id)arg3 feedID:(id)arg4 sectionID:(id)arg5 groupID:(id)arg6 groupType:(long long)arg7 purchaseType:(long long)arg8 purchaseSessionID:(id)arg9 subscriptionConversionPointType:(long long)arg10 qToken:(id)arg11 parentFeedType:(long long)arg12 arrivedFromAd:(BOOL)arg13 referral:(id)arg14;
+ (id)purchaseContextWithSourceChannelID:(id)arg1 articleID:(id)arg2 feedID:(id)arg3 sectionID:(id)arg4 groupID:(id)arg5 groupType:(long long)arg6 subscriptionConversionPointType:(long long)arg7 qToken:(id)arg8 parentFeedType:(long long)arg9 fromSubscriptionAd:(BOOL)arg10 referral:(id)arg11;
- (void).cxx_destruct;
