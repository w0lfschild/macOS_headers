...
@interface FRFavoritesPickerViewController : UIViewController <FRGenericIntroductionSceneDelegate, UIAdaptivePresentationControllerDelegate>
{
    BOOL _shouldSaveOnDismiss;
...
+ (id)viewControllerWithContentContext:(id)arg1 sceneType:(long long)arg2 subscriptionList:(id)arg3 bundleSubscriptionManager:(id)arg4 feedManager:(id)arg5 tagRanker:(id)arg6 didTapOnItem:(CDUnknownBlockType)arg7 completion:(CDUnknownBlockType)arg8;
- (void).cxx_destruct;
...
@property(nonatomic) BOOL shouldSaveOnDismiss; // @synthesize shouldSaveOnDismiss=_shouldSaveOnDismiss;
