...
- (void)asyncImageOrientated:(BOOL)arg1 background:(int)arg2 completion:(CDUnknownBlockType)arg3;
- (struct NSImage *)imageOrientated:(BOOL)arg1 background:(int)arg2;
