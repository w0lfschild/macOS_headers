...
@class ICMNoteEditorController, ICMPasswordEntryViewController, ICMToolbarCenteringTextField, ICNote, NSButton, NSImage, NSMenu, NSMenuItem, NSString, NSToolbar, NSToolbarItem;
