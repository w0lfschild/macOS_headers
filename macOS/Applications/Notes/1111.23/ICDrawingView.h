...
+ (BOOL)isScaledDrawingClippedWithAdditionalScale:(double)arg1 viewBounds:(struct CGRect)arg2 drawing:(id)arg3;
+ (double)scaleAdjustingForNearlyEqualAspectRatiosForDrawing:(id)arg1 viewBounds:(struct CGRect)arg2;
+ (void)loadDefaults;
+ (void)setupDefaults;
+ (void)initialize;
- (void).cxx_destruct;
...
- (double)scaleAdjustingForNearlyEqualAspectRatios;
