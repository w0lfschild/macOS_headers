...
@interface ICMMainWindowController : ICMWindowController <ICMTokenizedSearchFieldDelegate, ICMViewModeSegmentedControlDelegate, NSUserInterfaceValidations, NSWindowDelegate, NSWindowRestoration, ICMNoteEditingWindowController>
{
    NSString *_ipAddress;
    ...
    BOOL _canShowGridViewNoteEditorBackButton;
    ...
    NSMenu *_shareViaICloudTitleMenu;
    NSMenuItem *_shareNoteViaICloudMenuItem;
    NSMenuItem *_shareFolderViaICloudMenuItem;
...
+ (id)keyPathsForValuesAffectingCanEnableGridViewNoteEditorBackButton;
...
@property(readonly, nonatomic) BOOL canShowGridViewNoteEditorBackButton; // @synthesize canShowGridViewNoteEditorBackButton=_canShowGridViewNoteEditorBackButton;
...
@property(nonatomic) __weak NSMenuItem *shareFolderViaICloudMenuItem; // @synthesize shareFolderViaICloudMenuItem=_shareFolderViaICloudMenuItem;
@property(nonatomic) __weak NSMenuItem *shareNoteViaICloudMenuItem; // @synthesize shareNoteViaICloudMenuItem=_shareNoteViaICloudMenuItem;
@property(retain, nonatomic) NSMenu *shareViaICloudTitleMenu; // @synthesize shareViaICloudTitleMenu=_shareViaICloudTitleMenu;
...
@property(retain, nonatomic) ICFolderCustomNoteSortType *currentCustomNoteSortType;
...
- (BOOL)canEnableGridViewNoteEditorBackButton;
...
- (void)shareFolderViaICloud:(id)arg1;
