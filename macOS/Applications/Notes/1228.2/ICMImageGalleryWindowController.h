...
@interface ICMImageGalleryWindowController : NSWindowController <NSCollectionViewDataSource, NSCollectionViewDelegate, NSSharingServiceDelegate, NSToolbarDelegate, ICMImageGalleryFilterViewControllerDelegate, ICMImageGalleryAttachmentViewItemDelegate, ICMImageGalleryQuadEditorControllerDelegate, ICMToolbarCenteringTextFieldDelegate, ICMImageGalleryCollectionViewMenuViewDelegate, NSSharingServicePickerDelegate>
{
    ...
    NSArray *_standardToolbarIdentifiers;
    NSArray *_recropToolbarIdentifiers;
...
+ (id)keyPathsForValuesAffectingRotateImage;
- (void).cxx_destruct;
...
@property(retain, nonatomic) NSArray *recropToolbarIdentifiers; // @synthesize recropToolbarIdentifiers=_recropToolbarIdentifiers;
@property(retain, nonatomic) NSArray *standardToolbarIdentifiers; // @synthesize standardToolbarIdentifiers=_standardToolbarIdentifiers;
...
@property(nonatomic) __weak NSButton *recropButton; // @synthesize recropButton=_recropButton;
...
@property(retain, nonatomic) NSSplitViewItem *sidebarSplitViewItem; // @synthesize sidebarSplitViewItem=_sidebarSplitViewItem;
...
@property(nonatomic, getter=isSidebarCollapsed) BOOL sidebarCollapsed;
...
- (id)toolbarIdentifiersForToolbar:(id)arg1;
...
@property(readonly, nonatomic) NSImage *rotateImage;
