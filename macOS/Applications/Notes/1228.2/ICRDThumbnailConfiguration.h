...
@class ICAppearanceInfo, NSString;
...
- (id)init;
- (id)initWithThumbnailType:(long long)arg1 associatedObjectIdentifier:(id)arg2 preferredSize:(struct CGSize)arg3 scale:(double)arg4 appearanceInfo:(id)arg5;
