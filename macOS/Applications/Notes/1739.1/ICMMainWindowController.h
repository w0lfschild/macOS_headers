...
@interface ICMMainWindowController : ICMNoteEditorWindowController <ICMTokenizedSearchFieldDelegate, ICMViewModeSegmentedControlDelegate, NSToolbarDelegate, NSUserInterfaceValidations, NSWindowDelegate, NSWindowRestoration>
{
    ...
    BOOL _isCancelingSearchAndRestoringSelectionIfNecessary;
...
@property(nonatomic) BOOL isCancelingSearchAndRestoringSelectionIfNecessary; // @synthesize isCancelingSearchAndRestoringSelectionIfNecessary=_isCancelingSearchAndRestoringSelectionIfNecessary;
...
- (void)tokenizedSearchField:(id)arg1 didUpdateTokens:(id)arg2;
