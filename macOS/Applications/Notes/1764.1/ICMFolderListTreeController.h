...
@class ICMFolderListDragDropHelper, ICMFolderListOutlineView, ICMFolderTreeCombiner, ICMFolderTreeNode, ICMHTMLFolderTreeGenerator, ICRDManagedObjectContextChangeController, NSArray, NSCountedSet, NSManagedObjectID, NSSet, NSString;

@interface ICMFolderListTreeController : NSTreeController <ICMFolderTreeCombinerDelegate, NSMenuDelegate, NSOutlineViewDelegate, ICRDManagedObjectContextChangeControllerDelegate, NSOutlineViewDataSource>
{
    ...
    NSManagedObjectID *_ignoreChangeNoteID;
}
...
- (void).cxx_destruct;
@property(retain, nonatomic) NSManagedObjectID *ignoreChangeNoteID; // @synthesize ignoreChangeNoteID=_ignoreChangeNoteID;
...
- (void)ignoreChangeOnNoteID:(id)arg1;
...
- (unsigned long long)outlineViewDraggingSourceOperationMask;
- (void)dealloc;
- (void)awakeFromNib;
