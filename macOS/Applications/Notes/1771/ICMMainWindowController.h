...
@interface ICMMainWindowController : ICMNoteEditorWindowController <ICMTokenizedSearchFieldDelegate, NSToolbarDelegate, NSUserInterfaceValidations, NSWindowDelegate, NSWindowRestoration>
{
    NSString *_ipAddress;
