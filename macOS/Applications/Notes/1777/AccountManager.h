...
@class ICSelectorDelayer, NSMapTable, NSMutableArray, NSOperationQueue, NSString, NSTimer;
...
@interface AccountManager : NSObject <ICNFMCAccountProxyManager>
{
    ...
    ICSelectorDelayer *_resetAccountsAndFetchDelayer;
    BOOL _isSyncing;
    BOOL _isOffline;
...
- (void)_resetAccountsAndPerformFetch;
