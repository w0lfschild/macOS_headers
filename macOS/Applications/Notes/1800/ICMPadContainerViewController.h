...
@class NSLayoutConstraint, NSManagedObjectContext, NSView, PadContentView, PadViewController;
...
@interface ICMPadContainerViewController : NSViewController
{
    ...
    NSView *_padView;
    NSLayoutConstraint *_padContainerViewTopConstraint;
}

- (void).cxx_destruct;
@property(nonatomic) __weak NSLayoutConstraint *padContainerViewTopConstraint; // @synthesize padContainerViewTopConstraint=_padContainerViewTopConstraint;
