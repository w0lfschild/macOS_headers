...
#import "ICMSearchFieldDelegate-Protocol.h"
...
@class ICFolderCustomNoteSortType, ICMFolderListController, ICMFolderListTreeController, ICMFolderTreeNode, ICMImageGalleryWindowController, ICMMainSplitViewController, ICMMainWindowTouchBarController, ICMNoteBrowserController, ICMNoteEditorController, ICMNoteGridController, ICMNoteListController, ICMPasswordChangeSheetViewController, ICMSearchField, ICMSearchToolbarItem, ICMStartupContainerViewController, ICNote, ICSelectorDelayer, NSArray, NSButton, NSCountedSet, NSImage, NSSet, NSString, NSTimer, NSUndoManager, NSUserActivity, PadViewController;

@interface ICMMainWindowController : ICMNoteEditorWindowController <ICMTokenizedSearchFieldDelegate, ICMSearchFieldDelegate, NSToolbarDelegate, NSUserInterfaceValidations, NSWindowDelegate, NSWindowRestoration>
{
    NSString *_ipAddress;
...
+ (id)windowIdentifier;
+ (id)keyPathsForValuesAffectingEnableGridBackToolbarItem;
...
+ (id)keyPathsForValuesAffectingFoldersToolbarItemToolTip;
+ (id)keyPathsForValuesAffectingFolderNamesCountedSet;
+ (id)keyPathsForValuesAffectingSearchToolbarItem;
...
@property(readonly, nonatomic) BOOL enableGridBackToolbarItem;
...
- (void)setIsShowingAttachmentBrowser:(BOOL)arg1;
...
- (id)undoablyAddEmptyNoteWithUUID:(id)arg1;
- (void)performTextFinderAction:(id)arg1;
- (id)undoablyAddEmptyHTMLNote;
- (id)performAddNote;
...
- (void)searchField:(id)arg1 didChangeScope:(long long)arg2;
@property(readonly, nonatomic) ICMSearchToolbarItem *searchToolbarItem;
@property(readonly, nonatomic) ICMSearchField *searchField;
