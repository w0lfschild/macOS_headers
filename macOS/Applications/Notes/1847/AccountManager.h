...
@class ACMonitoredAccountStore, NSMapTable, NSMutableArray, NSOperationQueue, NSString, NSTimer;

@interface AccountManager : NSObject <ACMonitoredAccountStoreDelegateProtocol, ICNFMCAccountProxyManager>
{
...
- (void)addOrRemoveAccount:(id)arg1 shouldRemove:(BOOL)arg2 shouldAdd:(BOOL)arg3;
- (id)accountProxyForAccount:(id)arg1;
- (void)addAccountProxyForObjectID:(id)arg1;
- (void)removeAccountProxyForObjectID:(id)arg1;
