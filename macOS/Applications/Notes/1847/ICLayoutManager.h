...
@class ICSelectorDelayer, NSDictionary, NSManagedObjectContext, NSMutableDictionary, NSRegularExpression, NSSet, NSString;
...
@property(nonatomic) BOOL shouldIgnoreCachedOriginUpdates; // @synthesize shouldIgnoreCachedOriginUpdates=_shouldIgnoreCachedOriginUpdates;
...
- (void)filterAttachmentsInTextStorage:(id)arg1 range:(struct _NSRange)arg2 targetAttachment:(id)arg3;
...
- (struct _NSRange)rangeForBaseAttachment:(id)arg1 withTextAttachment:(id *)arg2;
