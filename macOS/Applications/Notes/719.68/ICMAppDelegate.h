...
@class ICArchivedUIState, ICCloudNoteController, ICMImportNotesController, ICMSearchIndexerAccountMigrationHandler, ICMSharingMenuController, ICNoteContext, ICReachability, NSManagedObjectContext, NSMutableDictionary, NSString, NSTimer, NSURL, NSUndoManager, NSWindow;

@interface ICMAppDelegate : NSObject <ICArchivedUIStateDelegate, NSWindowRestoration, NSApplicationDelegate>
{
    ...
    ICMSearchIndexerAccountMigrationHandler *_searchIndexerAccountMigrationHandler;
...
@property(retain, nonatomic) ICMSearchIndexerAccountMigrationHandler *searchIndexerAccountMigrationHandler; // @synthesize searchIndexerAccountMigrationHandler=_searchIndexerAccountMigrationHandler;
...
- (id)openModernNoteInSeparateWindow:(id)arg1;
- (void)propagateZoomFromPadViewController:(id)arg1 toWindowsWithNote:(id)arg2;
- (void)showNotesInSeparateWindow:(id)arg1 clickedNote:(id)arg2;
...
- (void)setupSearchIndexerAccountMigrationHandler;
- (void)createSearchIndexerAccountMigrationHandlerIfNecessary;
