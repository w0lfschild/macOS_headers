...
@class ICMSharingMenuController, ICSelectorDelayer, NSArray, NSArrayController, NSCollectionView, NSMenu, NSMenuItem, NSPredicate, NSString;

@interface ICMAttachmentBrowserCommonController : NSViewController <NSCollectionViewDataSource, NSCollectionViewDelegate, QLPreviewPanelDataSource, QLPreviewPanelDelegate, QLSeamlessOpenerDelegate>
{
