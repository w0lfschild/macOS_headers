...
@class ICMAttachmentBrowserController, ICMCombinedFolderListController, ICMCombinedFolderListTreeController, ICMNoteSplitViewController, NSSplitViewItem, NSString, NSView, NSViewController;
...
@interface ICMMainSplitViewController : NSSplitViewController <ICMAttachmentBrowserControllerDelegate>
{
    ...
    ICMCombinedFolderListController *_folderListController;
    ...
    NSView *_eventMaskView;
}

@property(retain, nonatomic) NSView *eventMaskView; // @synthesize eventMaskView=_eventMaskView;
...
@property(readonly, nonatomic) ICMCombinedFolderListController *folderListController; // @synthesize folderListController=_folderListController;
- (void)viewDidLoad;
- (void)dealloc;
