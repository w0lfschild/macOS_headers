...
+ (id)keyPathsForValuesAffectingCombinedFolderListTreeController;
...
- (void)selectHTMLNoteInWindowWithNote:(id)arg1 folderPersistentIdentifier:(id)arg2 animated:(BOOL)arg3;
...
@property(readonly, nonatomic) ICMCombinedFolderListTreeController *combinedFolderListTreeController;
- (id)noteEditorController;
@property(readonly, nonatomic) ICMNoteListController *noteListController;
@property(readonly, nonatomic) ICMCombinedFolderListController *folderListController;
...
- (struct _NSRange)rangeForScrollingToAttachment:(id)arg1;
