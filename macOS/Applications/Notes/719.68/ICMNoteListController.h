...
@class FolderTreeNode, ICMHTMLNoteListArrayController, ICMModernNoteListArrayController, ICMNoteListArrayController, ICMNoteListTableView, ICMSearchNoteListArrayController, ICNote, NSArray, NSString;
...
@interface ICMNoteListController : NSViewController <ICMNoteListArrayControllerDelegate, ICMNoteListTableViewCellMenuItemProvider>
{
    ...
    FolderTreeNode *_selectedTreeNode;
...
@property(retain, nonatomic) FolderTreeNode *selectedTreeNode; // @synthesize selectedTreeNode=_selectedTreeNode;
- (void).cxx_destruct;
...
- (void)searchNoteForString:(id)arg1;
