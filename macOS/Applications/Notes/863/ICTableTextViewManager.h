...
@class ICDimensionSumCache, ICTableContentView, ICTableLayoutManager, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSUUID;
...
@interface ICTableTextViewManager : NSObject
{
    ...
    NSUUID *_draggedColumn;
    NSUUID *_draggedRow;
    struct CGPoint _anchorPoint;
}

@property(retain, nonatomic) NSUUID *draggedRow; // @synthesize draggedRow=_draggedRow;
@property(retain, nonatomic) NSUUID *draggedColumn; // @synthesize draggedColumn=_draggedColumn;
