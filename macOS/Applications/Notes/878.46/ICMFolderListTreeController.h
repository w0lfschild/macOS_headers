...
@class ICMFolderListDragDropHelper, ICMFolderListOutlineView, ICMFolderTreeCombiner, ICMHTMLFolderTreeGenerator, NSArray, NSSet, NSString;

@interface ICMFolderListTreeController : NSTreeController <ICMFolderTreeCombinerDelegate, NSMenuDelegate, NSOutlineViewDataSource>
{
