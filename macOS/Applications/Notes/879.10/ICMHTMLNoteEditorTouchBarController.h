...
@class NSButton, NSCandidateListTouchBarItem, NSCustomTouchBarItem, NSSet, NSString, NSTouchBar, NSWindowController, NoteWebView, PadViewController;
...
@property(readonly, nonatomic) NoteWebView *webView;
