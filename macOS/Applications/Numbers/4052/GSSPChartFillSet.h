...
@interface GSSPChartFillSet : GSSPMessageBase
{
    NSString *mIdentifier;
    NSString *mLookupString;
    NSArray *mSeriesStyles;
    int mNumberOfThemeSeriesStyles;
    BOOL mDefinedNumberOfThemeSeriesStyles;
}

+ (Class)realClass;
+ (void)registerRealGsspClass:(Class)arg1;
@property(readonly, nonatomic) BOOL definedNumberOfThemeSeriesStyles; // @synthesize definedNumberOfThemeSeriesStyles=mDefinedNumberOfThemeSeriesStyles;
- (id)description;
- (id)dspClassName;
...
- (void)dealloc;
- (BOOL)clearNumberOfThemeSeriesStyles;
- (void)setNumberOfThemeSeriesStyles:(int)arg1;
- (int)numberOfThemeSeriesStyles;
- (void)setSeriesStyles:(id)arg1;
- (id)seriesStyles;
- (void)setLookupString:(id)arg1;
- (id)lookupString;
