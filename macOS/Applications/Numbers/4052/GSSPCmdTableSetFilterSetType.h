...
@interface GSSPCmdTableSetFilterSetType : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    int mNewFilterSetType;
}
...
- (void)dealloc;
- (void)setNewFilterSetType:(int)arg1;
- (int)newFilterSetType;
