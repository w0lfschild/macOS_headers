...
@interface GSSPCmdTextCharacterStyleChangeProperty : GSSPCmdTextStorageAction <GSSPAutoDecodable>
{
    vector_c16d56c8 mRangeList;
    vector_7ab7fcf0 mChangeList;
    BOOL mDisableCharacterStylePromotion;
}
...
- (void)dealloc;
- (void)setDisableCharacterStylePromotion:(BOOL)arg1;
- (BOOL)disableCharacterStylePromotion;
- (void)setChangeList:(const vector_7ab7fcf0 *)arg1;
- (vector_7ab7fcf0 *)changeList;
