...
@interface GSSPPasteboardDrawable : GSSPMessageBase
{
    TSDDrawableInfo *mDrawableInfo;
    BOOL mWasAnchoredToText;
    BOOL mWasFloatingAboveText;
    BOOL mWasInlineWithText;
}
...
- (void)dealloc;
- (void)setWasInlineWithText:(BOOL)arg1;
- (BOOL)wasInlineWithText;
- (void)setWasFloatingAboveText:(BOOL)arg1;
- (BOOL)wasFloatingAboveText;
- (void)setWasAnchoredToText:(BOOL)arg1;
- (BOOL)wasAnchoredToText;
