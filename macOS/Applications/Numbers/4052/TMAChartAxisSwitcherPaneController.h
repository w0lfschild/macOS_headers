...
{
    NSSegmentedControl *mAxisSelectionControl;
...
@property(nonatomic) NSSegmentedControl *axisSelectionControl; // @synthesize axisSelectionControl=mAxisSelectionControl;
