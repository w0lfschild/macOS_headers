...
@class NSArray, NSData, NSDate, NSDictionary, NSError, NSMutableArray, NSMutableSet, NSObject, NSProgress, NSRecursiveLock, NSString, NSURL, NSUUID, SFUCryptoKey, TMADocumentAlternateContents, TMADocumentConflictAlert, TMADocumentSharingStateObserver, TMADocumentWindowController, TMAManagedTemporarySupportDirectory, TMAPasswordProvider, TMAProgressPanelController, TSACollaborationContext, TSACollaborationResponsiveness, TSADocumentRoot, TSAMetadataQueryHelper, TSANetworkHealthMonitor, TSATemplateInfo, TSAUbiquitousRefreshQueue, TSAViewStateSidecar, TSKCollaborationDocumentSessionController, TSKCollaborationState, TSPObjectContext, TSUBasicProgress, TSUImage, TSUManagedTemporaryDirectory, TSUNSProgressObserver, TSUTemporaryDirectory, TSUWeakReference;
...
@interface TMADocument : NSDocument <TMAScriptCommandExecutionResolving, NSUserActivityDelegate, TSPViewStateValidator, TSAViewStateSidecarDelegate, TSPObjectContextDelegate, TSAImportDelegate, TSADocumentRootDelegate, TSKDocumentRootProvider>
{
    ...
    TMAPasswordProvider *_collaborationPasswordProvider;
    ...
    BOOL _needsSaveAfterAutosaveResume;
    ...
    id _collaborationCloudReachability;
    ...
    id _collaborationProtectionStateObserver;
    ...
    TSUWeakReference *_collaborationPermissionAlertReference;
    TSUWeakReference *_collaborationOfflineAlertReference;
...
@property(retain, nonatomic) TSUWeakReference *collaborationOfflineAlertReference; // @synthesize collaborationOfflineAlertReference=_collaborationOfflineAlertReference;
@property(retain, nonatomic) TSUWeakReference *collaborationPermissionAlertReference; // @synthesize collaborationPermissionAlertReference=_collaborationPermissionAlertReference;
...
@property(retain, nonatomic) NSString *exportPasswordHint; // @synthesize exportPasswordHint=_exportPasswordHint;
...
@property(retain, nonatomic) id collaborationProtectionStateObserver; // @synthesize collaborationProtectionStateObserver=_collaborationProtectionStateObserver;
...
@property(retain, nonatomic) id collaborationCloudReachability; // @synthesize collaborationCloudReachability=_collaborationCloudReachability;
...
@property(retain, nonatomic) NSArray *documentWarnings; // @synthesize documentWarnings=_documentWarnings;
...
@property(readonly, retain, nonatomic) TSPObjectContext *context; // @synthesize context=_context;
...
- (void)p_document:(id)arg1 didDuplicate:(BOOL)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)addPersistenceWarning:(id)arg1;
...
- (void)p_revertCollaborativeDocumentToICloudVersionExpectingSameRevision:(BOOL)arg1 didResolveCollaborativeConflict:(BOOL)arg2 forceRefreshingSharingState:(BOOL)arg3 showError:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)p_revertCollaborativeDocumentToICloudVersionExpectingSameRevision:(BOOL)arg1 didResolveCollaborativeConflict:(BOOL)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)pauseSyncAlertsWithReason:(id)arg1 suspendingCollaboration:(BOOL)arg2;
...
- (void)p_didPresentErrorWithRecovery:(BOOL)arg1 copiedCompletionBlock:(CDUnknownBlockType)arg2;
...
- (void)hideProgress;
- (void)showProgressForType:(unsigned long long)arg1 modalForWindow:(id)arg2 withTitle:(id)arg3 message:(id)arg4 cancelButtonTitle:(id)arg5 documentURL:(id)arg6 isPasswordProtected:(BOOL)arg7 progress:(id)arg8 progressThreshold:(double)arg9 afterDelay:(double)arg10 cancelHandler:(CDUnknownBlockType)arg11;
...
- (void)p_downloadWithDocumentResourcesDownloader:(id)arg1 fontDownloadController:(id)arg2 URL:(id)arg3 afterDelay:(double)arg4 completion:(CDUnknownBlockType)arg5;
- (BOOL)p_isNetworkReachableForDownload;
...
- (void)p_prepareToRevertCollaborativeDocumentWithBlock:(CDUnknownBlockType)arg1 forceRefreshingSharingState:(BOOL)arg2 passphrase:(id)arg3 expectSameRevision:(BOOL)arg4 ignoreCache:(BOOL)arg5 validationTimerFrequency:(double)arg6 showProgress:(BOOL)arg7 progressCancelButtonTitle:(id)arg8 showError:(BOOL)arg9 thenRevertWithBlock:(CDUnknownBlockType)arg10 finishedRevertHandler:(CDUnknownBlockType)arg11;
...
- (void)p_promptUserWithCollaborationErrorAction:(id)arg1 isContinuingActivity:(BOOL)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)p_handleEndCollaborationAlertActionResponse:(long long)arg1 completionBlock:(CDUnknownBlockType)arg2;
- (void)i_stopSharingDocumentContinuingActivity:(BOOL)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)p_endCollaborativeModeForDocumentRootOrNil:(id)arg1 errorAction:(id)arg2 ignoreCleanDocuments:(BOOL)arg3 isContinuingActivity:(BOOL)arg4 completionBlock:(CDUnknownBlockType)arg5;
- (void)endCollaborativeModeForDocumentRoot:(id)arg1 errorAction:(id)arg2;
...
- (void)document:(id)arg1 didPrint:(BOOL)arg2 contextInfo:(CDUnknownBlockType)arg3;
...
- (void)didPresentSavingAllowedErrorWithRecovery:(BOOL)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)passphraseProviderDidCancel;
- (void)refreshPassword;
- (void)setEncryptionKeyWithPassphrase:(id)arg1 updateKeychain:(BOOL)arg2;
...
- (void)p_restoreDocumentWithTemplateURL:(id)arg1 templateDisplayName:(id)arg2 templateIdentifier:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
@property(nonatomic, getter=isFinishedLoading) BOOL finishedLoading;
- (id)displayName;
...
- (id)initWithTemplateInfo:(id)arg1 type:(id)arg2 error:(id *)arg3;
