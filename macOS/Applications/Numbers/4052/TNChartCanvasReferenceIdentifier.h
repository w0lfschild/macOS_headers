...
@property(nonatomic) CDStruct_fc93c73e rangeRef; // @synthesize rangeRef;
...
@property(readonly, nonatomic) CDStruct_a91f2c80 formulaID; // @synthesize formulaID;
...
- (void)dealloc;
- (id)initAreaOfType:(unsigned long long)arg1 formulaRefIDs:(id)arg2 rangeRef:(CDStruct_fc93c73e)arg3;
- (id)initCreationReference;
- (id)initWithFormulaID:(CDStruct_a91f2c80)arg1 argumentIndex:(unsigned long long)arg2 rangeRef:(CDStruct_fc93c73e)arg3;
