...
- (BOOL)chartIsBeingPastedWithSupportingTables:(id)arg1 withPasteboardDrawables:(id)arg2 ownerIDMap:(id)arg3;
- (id)tableDrawableForPastingChart:(id)arg1 tableIdRemapper:(id)arg2 withContext:(id)arg3;
- (BOOL)mustCreateTableForChart:(id)arg1 withPasteboardDrawables:(id)arg2 ownerIDMap:(id)arg3;
- (void)p_updateMappingReferencesAndCreateTablesForChartsIfNeededForPaste;
...
- (id)initWithSheet:(id)arg1 drawables:(id)arg2 atIndex:(unsigned long long)arg3 context:(id)arg4 forPaste:(BOOL)arg5 tableInfoIdPath:(id)arg6 topLeftCell:(struct TSTCellUID)arg7 bottomRightCell:(struct TSTCellUID)arg8;
