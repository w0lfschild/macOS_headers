...
@property(nonatomic) TNDocumentRoot *documentRoot; // @synthesize documentRoot=_documentRoot;
...
- (void)setPrinterID:(id)arg1 paperID:(id)arg2 pageSize:(struct CGSize)arg3;
@property(readonly, retain, nonatomic) TNSheetEditor *sheetEditor; // @synthesize sheetEditor=_sheetEditor;
- (void)dealloc;
