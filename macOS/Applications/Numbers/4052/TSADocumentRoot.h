...
@class NSArray, NSDictionary, NSMutableDictionary, NSMutableSet, NSObject, NSSet, NSString, SFUCryptoKey, TSADrawableFactory, TSAFunctionBrowserState, TSANetworkHealthMonitor, TSAShortcutController, TSCECalculationEngine, TSKCustomFormatList, TSKViewState, TSPLazyReference, TSTCustomFormatList;
...
- (void)suppressDocLocaleWarning;
- (BOOL)shouldShowDocLocaleWarning;
