...
+ (id)cacheWithInfoChartScale:(const tvec3_17f03ce0 *)arg1 containingViewport:(const tvec2_3b141483 *)arg2 chartBodyLayoutOffsetInChartAreaLayoutSpace:(const tvec2_84d5962d *)arg3 layoutSize:(struct CGSize)arg4 requestLayoutSize:(struct CGSize)arg5 chartBodyLayoutSize:(struct CGSize)arg6 requestChartBodyLayoutSize:(struct CGSize)arg7 layoutSettings:(CDStruct_2671d966)arg8;
...
- (id).cxx_construct;
@property(readonly, nonatomic) CDStruct_2671d966 layoutSettings;
