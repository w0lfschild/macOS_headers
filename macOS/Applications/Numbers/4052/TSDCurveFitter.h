...
- (void)fitCurveToPointArray:(CDStruct_8292cb43 *)arg1 count:(long long)arg2 bezierCallback:(CDUnknownFunctionPointerType)arg3 context:(void *)arg4;
- (void)fitCurveToPoints:(id)arg1 bezierCallback:(CDUnknownFunctionPointerType)arg2 context:(void *)arg3;
- (id)bezierPathFittingPointArray:(CDStruct_8292cb43 *)arg1 count:(long long)arg2;
