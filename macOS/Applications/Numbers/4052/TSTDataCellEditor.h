...
@class NSResponder, NSSet, NSString, NSView, TSDEditorController, TSKDocumentRoot, TSTCell, TSTLayout, TSTTableInfo, TSTTableModel, TSTTableRep, TSULocale;
...
- (BOOL)delegateForcesImplicitEditing;
...
- (void)i_commitAndKeepEditing:(BOOL)arg1;
