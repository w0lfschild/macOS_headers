...
@class NSString, TSWPMacHyperlinkController;
@protocol TSWPTextGestureDelegate;
...
- (void)showStorageBasedActivityLogEntry:(id)arg1;
- (void)p_popTextForStorageBasedActivityLogEntryWithSearchReference:(id)arg1;
