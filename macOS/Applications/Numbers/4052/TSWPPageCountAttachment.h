...
@interface TSWPPageCountAttachment : TSWPNumberAttachment <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPPageCountAttachment:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
