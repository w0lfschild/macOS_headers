...
@interface GSSPAnnotationAuthor : GSSPMessageBase <GSSPAutoDecodable>
{
    NSString *mName;
    TSUColor *mColor;
    NSString *mPublicID;
    BOOL mIsPublicAuthor;
    BOOL mDefinedPublicID;
    BOOL mDefinedIsPublicAuthor;
}
...
@property(readonly, nonatomic) BOOL definedIsPublicAuthor; // @synthesize definedIsPublicAuthor=mDefinedIsPublicAuthor;
@property(readonly, nonatomic) BOOL definedPublicID; // @synthesize definedPublicID=mDefinedPublicID;
- (id)description;
- (id)dspClassName;
