...
@interface GSSPCalculationEngineAstStickyBits : GSSPMessageBase
{
    BOOL mBeginRowIsAbsolute;
    BOOL mBeginColumnIsAbsolute;
    BOOL mEndRowIsAbsolute;
    BOOL mEndColumnIsAbsolute;
}
...
- (void)dealloc;
- (void)setEndColumnIsAbsolute:(BOOL)arg1;
- (BOOL)endColumnIsAbsolute;
- (void)setEndRowIsAbsolute:(BOOL)arg1;
- (BOOL)endRowIsAbsolute;
- (void)setBeginColumnIsAbsolute:(BOOL)arg1;
- (BOOL)beginColumnIsAbsolute;
- (void)setBeginRowIsAbsolute:(BOOL)arg1;
- (BOOL)beginRowIsAbsolute;
