...
@interface GSSPCmdChartBaseWithChartInfoId : GSSPCmdBase <GSSPAutoDecodable>
{
    NSString *mChartInfoIdPath;
    BOOL mOriginalDirtyState;
    BOOL mIsForForwardUndoRedo;
    BOOL mDefinedOriginalDirtyState;
    BOOL mDefinedIsForForwardUndoRedo;
}
...
@property(readonly, nonatomic) BOOL definedIsForForwardUndoRedo; // @synthesize definedIsForForwardUndoRedo=mDefinedIsForForwardUndoRedo;
@property(readonly, nonatomic) BOOL definedOriginalDirtyState; // @synthesize definedOriginalDirtyState=mDefinedOriginalDirtyState;
- (id)description;
- (id)dspClassName;
...
- (void)dealloc;
- (BOOL)clearIsForForwardUndoRedo;
- (BOOL)clearOriginalDirtyState;
- (void)setIsForForwardUndoRedo:(BOOL)arg1;
- (BOOL)isForForwardUndoRedo;
- (void)setOriginalDirtyState:(BOOL)arg1;
