...
@interface GSSPCmdTableSort : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    vector_dadc1b26 mFromRowUIDList;
    vector_dadc1b26 mToRowUIDList;
}
...
- (void)dealloc;
- (void)setToRowUIDList:(const vector_dadc1b26 *)arg1;
- (vector_dadc1b26 *)toRowUIDList;
- (void)setFromRowUIDList:(const vector_dadc1b26 *)arg1;
- (vector_dadc1b26 *)fromRowUIDList;
