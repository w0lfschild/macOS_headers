...
@interface GSSPCmdTableUndoSortRequest : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    vector_dadc1b26 mDestinationRowUIDList;
}
...
- (void)dealloc;
- (void)setDestinationRowUIDList:(const vector_dadc1b26 *)arg1;
- (vector_dadc1b26 *)destinationRowUIDList;
