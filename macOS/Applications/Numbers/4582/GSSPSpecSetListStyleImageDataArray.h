...
#import "GSSPSpecListStyleImageDataArray.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPListStyleImageDataArray;

@interface GSSPSpecSetListStyleImageDataArray : GSSPSpecListStyleImageDataArray <GSSPAutoDecodable>
{
    GSSPListStyleImageDataArray *mListStyleImageDataArray;
    BOOL mUnset;
}
...
- (BOOL)unset;
- (void)setListStyleImageDataArray:(id)arg1;
- (id)listStyleImageDataArray;
