...
- (void)replaceFormula:(CDStruct_a91f2c80)arg1 inOwner:(const UUIDData_5fbc143e *)arg2 precedentIterator:(CDUnknownFunctionPointerType)arg3 userData:(void *)arg4 calculatedRemoteDataInterest:(id)arg5 clearCycle:(BOOL)arg6;
- (void)replaceFormula:(CDStruct_a91f2c80)arg1 inOwner:(const UUIDData_5fbc143e *)arg2 precedentIterator:(CDUnknownFunctionPointerType)arg3 userData:(void *)arg4 clearCycle:(BOOL)arg5;
