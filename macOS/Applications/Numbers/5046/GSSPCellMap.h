...
{
    vector_16c93b0c mCellList;
    TSTCellUIDList *mCellUIDs;
    vector_b18431c0 mMergeActionList;
}
...
- (void)dealloc;
- (void)setMergeActionList:(const vector_b18431c0 *)arg1;
- (vector_b18431c0 *)mergeActionList;
- (void)setCellUIDs:(id)arg1;
- (id)cellUIDs;
- (void)setCellList:(const vector_16c93b0c *)arg1;
- (vector_16c93b0c *)cellList;
