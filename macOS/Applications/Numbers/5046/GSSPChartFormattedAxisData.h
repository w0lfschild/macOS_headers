...
@interface GSSPChartFormattedAxisData : GSSPMessageBase
{
    ...
    vector_a093891c mMajorGridlineLabelList;
    vector_64501fdd mMultiDataList;
}
...
- (void)dealloc;
- (void)setMultiDataList:(const vector_64501fdd *)arg1;
- (vector_64501fdd *)multiDataList;
- (void)setMajorGridlineLabelList:(const vector_a093891c *)arg1;
- (vector_a093891c *)majorGridlineLabelList;
