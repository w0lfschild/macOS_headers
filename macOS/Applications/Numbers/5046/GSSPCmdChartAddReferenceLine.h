...
@class NSUUID, TSCHChartAxisID, TSCHReferenceLineNonStyle, TSCHReferenceLineStyle;

@interface GSSPCmdChartAddReferenceLine : GSSPCmdChartBaseWithChartInfoId <GSSPAutoDecodable>
{
