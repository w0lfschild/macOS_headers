...
@interface GSSPCmdSheetRemoveDrawables : GSSPCmdBase <GSSPAutoDecodable>
{
    NSUUID *mSheetId;
    NSArray *mArgsList;
    vector_dadc1b26 mChartEntityIdForBackingTableList;
    vector_dadc1b26 mBackingTableInfoUidList;
}
...
- (void)dealloc;
- (void)setBackingTableInfoUidList:(const vector_dadc1b26 *)arg1;
- (vector_dadc1b26 *)backingTableInfoUidList;
- (void)setChartEntityIdForBackingTableList:(const vector_dadc1b26 *)arg1;
- (vector_dadc1b26 *)chartEntityIdForBackingTableList;
