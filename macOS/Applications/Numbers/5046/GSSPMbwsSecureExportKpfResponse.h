...
@interface GSSPMbwsSecureExportKpfResponse : GSSPMessageBase <GSSPAutoDecodable>
{
    ...
    vector_a093891c mAssetList;
    vector_a093891c mSecretList;
    NSString *mUrl;
...
- (void)setUrl:(id)arg1;
- (id)url;
- (void)setSecretList:(const vector_a093891c *)arg1;
- (vector_a093891c *)secretList;
- (void)setAssetList:(const vector_a093891c *)arg1;
- (vector_a093891c *)assetList;
