...
#import "GSSPSpecListStyleListLabelGeometryArray.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPListStyleListLabelGeometryArray;

@interface GSSPSpecSetListStyleListLabelGeometryArray : GSSPSpecListStyleListLabelGeometryArray <GSSPAutoDecodable>
{
    GSSPListStyleListLabelGeometryArray *mListStyleListLabelGeometryArray;
    BOOL mUnset;
}
...
- (void)dealloc;
- (void)setUnset:(BOOL)arg1;
- (BOOL)unset;
- (void)setListStyleListLabelGeometryArray:(id)arg1;
- (id)listStyleListLabelGeometryArray;
