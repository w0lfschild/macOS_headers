...
+ (id)tabIdentifier;
+ (id)nibName;
@property(nonatomic) NSTextField *presetButtonLabel; // @synthesize presetButtonLabel=mPresetButtonLabel;
@property(nonatomic) NSButton *presetButton; // @synthesize presetButton=mPresetButton;
