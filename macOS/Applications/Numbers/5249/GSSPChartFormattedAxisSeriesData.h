...
@interface GSSPChartFormattedAxisSeriesData : GSSPMessageBase
{
    vector_a093891c mValueList;
}
...
- (void)dealloc;
- (void)setValueList:(const vector_a093891c *)arg1;
- (vector_a093891c *)valueList;
