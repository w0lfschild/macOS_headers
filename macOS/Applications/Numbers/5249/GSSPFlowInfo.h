...
@interface GSSPFlowInfo : GSSPPersistableObject <GSSPAutoDecodable>
{
    TSWPStorage *mTextStorage;
    int mUserInterfaceIdentifier;
    NSArray *mTextboxIdPaths;
}
...
- (void)dealloc;
- (void)setTextboxIdPaths:(id)arg1;
- (id)textboxIdPaths;
- (void)setUserInterfaceIdentifier:(int)arg1;
- (int)userInterfaceIdentifier;
