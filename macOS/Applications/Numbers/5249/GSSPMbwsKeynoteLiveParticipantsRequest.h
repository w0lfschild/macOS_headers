...
@interface GSSPMbwsKeynoteLiveParticipantsRequest : GSSPMessageBase <GSSPAutoDecodable>
{
    NSString *mLastResponseToken;
}
...
- (void)dealloc;
- (void)setLastResponseToken:(id)arg1;
- (id)lastResponseToken;
