...
#import "GSSPSpecChart3dVector.h"

#import "GSSPAutoDecodable-Protocol.h"

@class TSCH3DVector;

@interface GSSPSpecSetChart3dVector : GSSPSpecChart3dVector <GSSPAutoDecodable>
{
    TSCH3DVector *mChart3dVector;
    BOOL mUnset;
}
