...
#import "GSSPSpecTableStrokePresetList.h"

#import "GSSPAutoDecodable-Protocol.h"

@class TSTTableStrokePresetList;

@interface GSSPSpecSetTableStrokePresetList : GSSPSpecTableStrokePresetList <GSSPAutoDecodable>
{
    TSTTableStrokePresetList *mTableStrokePresetList;
    BOOL mUnset;
}
...
- (BOOL)unset;
- (void)setTableStrokePresetList:(id)arg1;
- (id)tableStrokePresetList;
