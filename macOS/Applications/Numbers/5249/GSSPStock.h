...
{
    NSString *mSymbol;
    vector_e0f2bd7e mAttributes;
    vector_a093891c mValues;
    double mDate;
    BOOL mDefinedDate;
}
...
- (double)date;
- (void)setValues:(const vector_a093891c *)arg1;
- (vector_a093891c *)values;
- (void)setAttributes:(const vector_e0f2bd7e *)arg1;
- (vector_e0f2bd7e *)attributes;
