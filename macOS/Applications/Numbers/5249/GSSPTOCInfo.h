...
@interface GSSPTOCInfo : GSSPShapeInfo <GSSPAutoDecodable>
{
    ...
    vector_1b5e0c6d mTocEntries;
    vector_c16d56c8 mPageNumberRanges;
}
...
- (void)dealloc;
- (void)setPageNumberRanges:(const vector_c16d56c8 *)arg1;
- (vector_c16d56c8 *)pageNumberRanges;
- (void)setTocEntries:(const vector_1b5e0c6d *)arg1;
- (vector_1b5e0c6d *)tocEntries;
