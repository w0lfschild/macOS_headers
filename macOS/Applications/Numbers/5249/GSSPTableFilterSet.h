...
@interface GSSPTableFilterSet : GSSPMessageBase <GSSPAutoDecodable>
{
    ...
    vector_e0f2bd7e mFilterOffsetsList;
    vector_0cbbbdf2 mFilterEnabledList;
}
...
- (void)dealloc;
- (void)setFilterEnabledList:(const vector_0cbbbdf2 *)arg1;
- (vector_0cbbbdf2 *)filterEnabledList;
- (void)setFilterOffsetsList:(const vector_e0f2bd7e *)arg1;
- (vector_e0f2bd7e *)filterOffsetsList;
