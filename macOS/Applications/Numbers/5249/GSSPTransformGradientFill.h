...
#import "GSSPGradientFill.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPPoint, GSSPSize;

@interface GSSPTransformGradientFill : GSSPGradientFill <GSSPAutoDecodable>
{
    GSSPPoint *mStart;
    GSSPPoint *mEnd;
    GSSPSize *mBaseNaturalSize;
}
...
- (void)dealloc;
- (void)setBaseNaturalSize:(id)arg1;
- (id)baseNaturalSize;
- (void)setEnd:(id)arg1;
- (id)end;
