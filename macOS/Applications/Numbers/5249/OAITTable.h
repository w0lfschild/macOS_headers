...
@class OADTable, OADTableProperties, OADTableStyle, OAITDrawableContainer, OAITDrawingState, TSTInfo, TSTTableModel;
...
@interface OAITTable : NSObject
{
    ...
    TSTInfo *mTargetTableInfo;
    TSTTableModel *mTargetTableModel;
...
+ (void)createTablePresetWithIndex:(unsigned long long)arg1 tableStyle:(id)arg2 targetStyles:(id)arg3 drawingState:(id)arg4;
