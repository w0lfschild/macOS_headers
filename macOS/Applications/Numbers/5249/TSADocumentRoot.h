...
@class NSArray, NSDictionary, NSMutableDictionary, NSMutableSet, NSObject, NSSet, NSString, SFUCryptoKey, TSACachedDocumentInfo, TSADrawableFactory, TSADrawableProviderFactory, TSAFontResourceRequest, TSAFunctionBrowserState, TSANetworkHealthMonitor, TSAShortcutController, TSCECalculationEngine, TSKCustomFormatList, TSKViewState, TSPDocumentRevision, TSPLazyReference, TSTCustomFormatList;
...
+ (void)postProcessTablesInTextStorage:(id)arg1 importedFromAttributedString:(id)arg2 hasBeenCanceledBlock:(CDUnknownBlockType)arg3;
