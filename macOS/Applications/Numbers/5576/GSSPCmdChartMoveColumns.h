...
@interface GSSPCmdChartMoveColumns : GSSPCmdChartBaseWithChartInfoId <GSSPAutoDecodable>
{
    NSUUID *mStartColumnId;
    NSUUID *mEndColumnId;
    NSUUID *mAfterColumnId;
    BOOL mDefinedAfterColumnId;
}
...
@property(readonly, nonatomic) BOOL definedAfterColumnId; // @synthesize definedAfterColumnId=mDefinedAfterColumnId;
- (void).cxx_destruct;
- (id)description;
- (id)dspClassName;
...
- (BOOL)clearAfterColumnId;
- (void)setAfterColumnId:(id)arg1;
- (id)afterColumnId;
- (void)setEndColumnId:(id)arg1;
- (id)endColumnId;
- (void)setStartColumnId:(id)arg1;
- (id)startColumnId;
