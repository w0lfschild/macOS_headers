...
@class GSSPStylesheet, NSArray;

@interface GSSPDocumentTheme : GSSPMessageBase
{
    GSSPStylesheet *mDocumentStylesheet;
    NSArray *mPresetsOfKindList;
}
...
- (void)setPresetsOfKindList:(id)arg1;
- (id)presetsOfKindList;
