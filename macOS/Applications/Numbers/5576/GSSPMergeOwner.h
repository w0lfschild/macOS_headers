...
@interface GSSPMergeOwner : GSSPMessageBase
{
    vector_e696e3ca mMergeFormulaList;
}
...
- (void)setMergeFormulaList:(const vector_e696e3ca *)arg1;
- (vector_e696e3ca *)mergeFormulaList;
