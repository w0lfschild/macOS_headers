...
@class NSString, TSKPencilAnnotationStorage;

@interface GSSPPencilAnnotation : GSSPMessageBase <GSSPAutoDecodable>
{
    NSString *mTextAttributeUUIDString;
    TSKPencilAnnotationStorage *mPencilAnnotationStorage;
}
