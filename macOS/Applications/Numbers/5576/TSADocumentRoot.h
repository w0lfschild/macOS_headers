...
@class NSArray, NSDictionary, NSMapTable, NSMutableDictionary, NSMutableSet, NSObject, NSSet, NSString, SFUCryptoKey, TSADocumentInfo, TSADrawableFactory, TSADrawableProviderFactory, TSAFontResourceRequest, TSAFunctionBrowserState, TSANetworkHealthMonitor, TSAShortcutController, TSCECalculationEngine, TSDFreehandDrawingToolkitUIState, TSKCustomFormatList, TSKViewState, TSPDocumentRevision, TSPLazyReference, TSTCustomFormatList;
...
@property(readonly, nonatomic) TSADrawableProviderFactory *drawableProviderFactory;
@property(readonly, nonatomic) Class drawableProviderFactoryClass;
...
- (void)p_iterateDrawables:(id)arg1 removeDrawableCommentBlock:(CDUnknownBlockType)arg2 removeDrawablePencilAnnotationsBlock:(CDUnknownBlockType)arg3 removeTextCommentsBlock:(CDUnknownBlockType)arg4 removeTextPencilAnnotationBlock:(CDUnknownBlockType)arg5 removeCellCommentBlock:(CDUnknownBlockType)arg6;
...
- (void)fontReport;
- (id)d_modelParentForObject:(id)arg1;
- (id)fontReportIntersitialDescriptionForObject:(id)arg1 nextObject:(id)arg2 objectAdditional:(out id *)arg3 nextAdditional:(out id *)arg4;
- (void)reportForTextStorage:(id)arg1 range:(struct _NSRange)arg2;
- (void)reportForTextStorage:(id)arg1;
- (void)textStyleReportWithLabel:(id)arg1;
- (void)textStyleReport;
- (id)documentInfoMarkup;
