...
- (id)p_animationLayerWithFrame:(struct CGRect)arg1 untransformedFrame:(struct CGRect)arg2 scale:(double)arg3 colorSpace:(struct CGColorSpace *)arg4 returningDrawingFrame:(struct CGRect *)arg5 TSDGLLayer:(id *)arg6;
