...
#import "GSSPCloudKitMetadata.h"

#import "GSSPAutoDecodable-Protocol.h"

@class NSString;

@interface GSSPCloudKitKeynoteMetadata : GSSPCloudKitMetadata <GSSPAutoDecodable>
{
    BOOL mKeynoteLiveEnabled;
    BOOL mKeynoteLivePasswordEnabled;
    NSString *mKeynoteLivePassword;
}
...
- (void)setKeynoteLivePassword:(id)arg1;
- (id)keynoteLivePassword;
- (void)setKeynoteLivePasswordEnabled:(BOOL)arg1;
- (BOOL)keynoteLivePasswordEnabled;
- (void)setKeynoteLiveEnabled:(BOOL)arg1;
- (BOOL)keynoteLiveEnabled;
