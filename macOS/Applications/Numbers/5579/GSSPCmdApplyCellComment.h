...
@class GSSPCellUID, TSDCommentStorage;

@interface GSSPCmdApplyCellComment : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    GSSPCellUID *mCellUID;
...
- (void)setNewCommentStorage:(id)arg1;
- (id)newCommentStorage;
- (void)setCellUID:(id)arg1;
- (id)cellUID;
