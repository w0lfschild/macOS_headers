...
@class TSTTableSortOrderUID;

@interface GSSPCmdSetSortOrder : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    TSTTableSortOrderUID *mNewSortOrder;
}
