...
@interface GSSPCmdTableApplyCellDiffMap : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    TSTCellDiffMap *mCellDiffMap;
    BOOL mShouldAllowMergeFragments;
}
...
- (void)setShouldAllowMergeFragments:(BOOL)arg1;
- (BOOL)shouldAllowMergeFragments;
