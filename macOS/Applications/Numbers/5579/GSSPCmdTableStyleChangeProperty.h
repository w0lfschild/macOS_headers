...
@class TSTTableStylePropertyChangeSet;

@interface GSSPCmdTableStyleChangeProperty : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    TSTTableStylePropertyChangeSet *mChange;
}
