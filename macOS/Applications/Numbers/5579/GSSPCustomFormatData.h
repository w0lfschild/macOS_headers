...
{
    vector_95cc1646 mInterstitialStringList;
    vector_12bd641b mInterstitialStringInsertionIndexList;
...
- (id)formatString;
- (void)setInterstitialStringInsertionIndexList:(const vector_12bd641b *)arg1;
- (vector_12bd641b *)interstitialStringInsertionIndexList;
- (void)setInterstitialStringList:(const vector_95cc1646 *)arg1;
- (vector_95cc1646 *)interstitialStringList;
