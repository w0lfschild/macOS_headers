...
@interface GSSPStorageTransaction : GSSPMessageBase
{
    vector_65aa785d mActionGroups;
    int mFlags;
}
...
- (int)flags;
- (void)setActionGroups:(const vector_65aa785d *)arg1;
- (vector_65aa785d *)actionGroups;
