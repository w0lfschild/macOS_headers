...
@interface GSSPTableHeaderInfo : GSSPSosBase <GSSPAutoDecodable>
{
    UUIDData_5fbc143e mHeaderUID;
    double mSize;
...
- (double)size;
- (void)setHeaderUID:(UUIDData_5fbc143e)arg1;
- (UUIDData_5fbc143e)headerUID;
