...
@class NSButton, NSClipView, NSDictionary, NSString, NSTableView, NSTextField, NSTrackingArea, TMAPredicatePickerSelection, TMAPredicatePickerTabButtonCell, TMAPredicatePickerView, TSKMacNSPopover;
...
@interface TMAPredicatePickerViewController : NSViewController <NSTableViewDataSource, NSTableViewDelegate>
{
    ...
    NSDictionary *mCategoryDictionary;
    NSTrackingArea *mTrackingArea;
    TSKMacNSPopover *mPredicatePopover;
    unsigned long long mMouseOverRow;
    NSClipView *mClipView;
    NSString *mPopoverTitle;
    NSDictionary *mRuleTypeButtonDictionary;
    NSDictionary *mRuleTypeButtonCellDictionary;
...
- (void)updateRuleType:(long long)arg1;
- (long long)ruleTypeForPredicate:(int)arg1;
- (void)p_ruleSelectedAtIndex:(long long)arg1;
- (void)ruleSelected:(id)arg1;
- (void)changeRuleType:(id)arg1;
- (void)initializeRulesListIncludingRelativePredicates:(BOOL)arg1;
