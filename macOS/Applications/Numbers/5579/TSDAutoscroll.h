...
- (void)p_autoscrollIfPossibleWithDelta:(unsigned long long)arg1;
- (void)timerFired:(id)arg1;
- (unsigned long long)p_unscaledDeltaForCount:(unsigned long long)arg1;
- (void)invalidate;
- (BOOL)p_startAutoscroll:(id)arg1 unscaledPoint:(struct CGPoint)arg2 directions:(int)arg3 repeatInterval:(double)arg4;
- (void)dealloc;
