...
@interface TSPViewStateWriteAssistant : NSObject <TSPEncoderWriteCoordinatorDelegate>
{
...
- (void)encodeViewStateObject:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (id)initWithContext:(id)arg1 documentVersionUUID:(id)arg2;
- (id)init;
