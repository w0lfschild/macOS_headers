...
+ (id)edFormulaFromTSCEFormulaInChart:(struct TSCEFormula *)arg1 coalesce:(_Bool)arg2 state:(id)arg3;
...
+ (_Bool)checkForAnyDurationCellWithTable1:(const UUIDData_5fbc143e *)arg1 table2:(const UUIDData_5fbc143e *)arg2 row1:(unsigned short)arg3 col1:(unsigned short)arg4 row2:(unsigned short)arg5 col2:(unsigned short)arg6 state:(id)arg7;
...
+ (id)edFormulaFromTSCEFormula:(struct TSCEFormula *)arg1 atRow:(int)arg2 andCol:(int)arg3 inChart:(_Bool)arg4 inPredicate:(_Bool)arg5 dateOrDurationCell:(_Bool)arg6 coalesce:(_Bool)arg7 state:(id)arg8;
