...
@interface GSSPChartSeriesStyleProperties : GSSPMessageBase
{
    ...
    int mDonutLabelParagraphStyleIndex;
    ...
    int mDonutOutsideLabelParagraphStyleIndex;
...
- (void)setDonutOutsideLabelParagraphStyleIndex:(int)arg1;
- (int)donutOutsideLabelParagraphStyleIndex;
...
- (void)setDonutLabelParagraphStyleIndex:(int)arg1;
- (int)donutLabelParagraphStyleIndex;
