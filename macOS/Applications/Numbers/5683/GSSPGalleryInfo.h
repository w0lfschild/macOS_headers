...
@interface GSSPGalleryInfo : GSSPDrawableInfo <GSSPAutoDecodable>
{
    vector_dcbef869 mItems;
    long long mCaptionMode;
...
- (void)setItems:(const vector_dcbef869 *)arg1;
- (vector_dcbef869 *)items;
- (id)convertTSAGalleryInfoWithDecodeContext:(struct GSSPDecodeConversionContext *)arg1 error:(id *)arg2;
