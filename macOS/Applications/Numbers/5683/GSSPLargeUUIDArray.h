...
@interface GSSPLargeUUIDArray : GSSPLargeArray <GSSPAutoDecodable>
{
    vector_4dc5f307 mElementList;
}
...
- (void)setElementList:(const vector_4dc5f307 *)arg1;
- (vector_4dc5f307 *)elementList;
