...
@interface GSSPMovieInfo : GSSPMediaInfo <GSSPAutoDecodable>
{
    ...
    BOOL mDefinedNativeAudioRecording;
}
...
@property(readonly, nonatomic) BOOL definedNativeAudioRecording; // @synthesize definedNativeAudioRecording=mDefinedNativeAudioRecording;
