...
@interface GSSPPasteboardFreehandDrawing : GSSPPasteboardDrawable
{
    BOOL mSourceDocWantedSpacerShape;
}
...
- (void)setSourceDocWantedSpacerShape:(BOOL)arg1;
- (BOOL)sourceDocWantedSpacerShape;
