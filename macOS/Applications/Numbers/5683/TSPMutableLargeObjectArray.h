...
@interface TSPMutableLargeObjectArray : TSPAbstractMutableLargeArray <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPLargeObjectArray:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
