...
@interface EITImporter : OCImporter <TSKEncryptedDocumentImporter>
{
}
...
- (id)read;
- (BOOL)start;
- (void)mapToTNDocumentRoot:(id)arg1 state:(id)arg2;
- (BOOL)doesFileLookLikeOldExcel;
- (BOOL)startWithReaderClass:(Class)arg1;
- (_Bool)isTXT;
- (_Bool)isCSV;
