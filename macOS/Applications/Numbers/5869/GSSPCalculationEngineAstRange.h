...
@interface GSSPCalculationEngineAstRange : GSSPMessageBase
{
    int mRangeBegin;
    int mRangeEnd;
    BOOL mDefinedRangeEnd;
}

+ (Class)realClass;
+ (void)registerRealGsspClass:(Class)arg1;
@property(readonly, nonatomic) BOOL definedRangeEnd; // @synthesize definedRangeEnd=mDefinedRangeEnd;
- (id)description;
- (id)dspClassName;
