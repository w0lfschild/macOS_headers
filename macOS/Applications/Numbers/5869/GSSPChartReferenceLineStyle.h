...
@class GSSPChartReferenceLineStyleProperties;

@interface GSSPChartReferenceLineStyle : GSSPStyle <GSSPAutoDecodable>
{
    GSSPChartReferenceLineStyleProperties *mOverridePropertyMap;
}
