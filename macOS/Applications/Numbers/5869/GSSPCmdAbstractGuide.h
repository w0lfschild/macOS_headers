...
@interface GSSPCmdAbstractGuide : GSSPCmdBase <GSSPAutoDecodable>
{
    vector_f52f2ffb mNewGuides;
}
...
- (void)setNewGuides:(const vector_f52f2ffb *)arg1;
- (vector_f52f2ffb *)newGuides;
