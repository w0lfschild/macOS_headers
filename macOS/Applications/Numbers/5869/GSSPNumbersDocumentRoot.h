...
@interface GSSPNumbersDocumentRoot : GSSPApplicationDocumentRoot
{
    NSArray *mSheetNodeList;
    NSString *mSheetNameTemplate;
    vector_95cc1646 mFormNameList;
}
...
- (void)setFormNameList:(const vector_95cc1646 *)arg1;
- (vector_95cc1646 *)formNameList;
- (void)setSheetNameTemplate:(id)arg1;
- (id)sheetNameTemplate;
- (void)setSheetNodeList:(id)arg1;
- (id)sheetNodeList;
