...
#import "GSSPShapeInfo.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPTOCSettings;

@interface GSSPTOCInfo : GSSPShapeInfo <GSSPAutoDecodable>
{
    GSSPTOCSettings *mTocSettings;
    vector_dd86de9c mTocEntries;
    vector_ae1fc82d mPageNumberRanges;
}
...
- (void)setPageNumberRanges:(const vector_ae1fc82d *)arg1;
- (vector_ae1fc82d *)pageNumberRanges;
- (void)setTocEntries:(const vector_dd86de9c *)arg1;
- (vector_dd86de9c *)tocEntries;
- (void)setTocSettings:(id)arg1;
- (id)tocSettings;
- (id)convertTSWPTOCInfoWithDecodeContext:(struct GSSPDecodeConversionContext *)arg1 error:(id *)arg2;
