...
- (unsigned long long)numberOfNonEmptyPlotwiseLabelValuesWithCalcEngine:(id)arg1 inChart:(const UUIDData_5fbc143e *)arg2 byRow:(BOOL)arg3 shouldSkipHiddenData:(BOOL)arg4;
