...
- (void)p_iterateDrawables:(id)arg1 removeDrawableCommentBlock:(CDUnknownBlockType)arg2 removeDrawablePencilAnnotationsBlock:(CDUnknownBlockType)arg3 removeTextCommentsBlock:(CDUnknownBlockType)arg4 removeCellCommentBlock:(CDUnknownBlockType)arg5;
