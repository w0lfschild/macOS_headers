...
@interface TSCHChartAxisGenericPropertyMap : TSSPropertyMap <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPChartAxisGenericPropertyMap:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
