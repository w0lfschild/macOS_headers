...
@class AVAssetExportSession, TSRCComposition, TSRCWaveformDataSource;

@interface TSRCCompositionComposedAssetWriter : NSObject
{
    AVAssetExportSession *_exportSession;
    TSRCWaveformDataSource *_waveformDataSource;
