...
+ (id)formulaPredicateArgFromReferenceNode:(id)arg1;
+ (id)formulaForEditingPredicateArg:(id)arg1 calcEngine:(id)arg2 table:(id)arg3 atBaseHostCell:(struct TSUModelCellCoord)arg4;
