...
@class TSDPathSource, TSDShapeStyle;

@interface GSSPBaseShapeInfo : GSSPStyledInfo
{
    TSDPathSource *mPathSource;
    TSDShapeStyle *mStyle;
    double mStrokePatternOffset;
}
...
- (void)setStrokePatternOffset:(double)arg1;
- (double)strokePatternOffset;
