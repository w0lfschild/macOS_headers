...
@interface GSSPCalculationEngineAstNodeArray : GSSPMessageBase
{
    vector_f3bd1b2b mAstNodeList;
}
...
- (void)setAstNodeList:(const vector_f3bd1b2b *)arg1;
- (vector_f3bd1b2b *)astNodeList;
