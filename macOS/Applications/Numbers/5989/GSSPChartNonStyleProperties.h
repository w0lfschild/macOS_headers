...
@interface GSSPChartNonStyleProperties : GSSPMessageBase
{
    ...
    BOOL mDefaultDEPRECATEDRoundedCornerOuterEndOnly;
    double mDefaultDEPRECATEDRoundedCornerRadius;
    int mDefaultDataSetNameLocation;
    BOOL mDefaultDonutPlaceTitleAtCenter;
    double mDefaultInnerRadius;
...
- (void)setDefaultInnerRadius:(double)arg1;
- (double)defaultInnerRadius;
- (void)setDefaultDonutPlaceTitleAtCenter:(BOOL)arg1;
- (BOOL)defaultDonutPlaceTitleAtCenter;
- (void)setDefaultDataSetNameLocation:(int)arg1;
- (int)defaultDataSetNameLocation;
- (void)setDefaultDEPRECATEDRoundedCornerRadius:(double)arg1;
- (double)defaultDEPRECATEDRoundedCornerRadius;
- (void)setDefaultDEPRECATEDRoundedCornerOuterEndOnly:(BOOL)arg1;
- (BOOL)defaultDEPRECATEDRoundedCornerOuterEndOnly;
