...
@interface GSSPCmdCategoryResizeColumnOrRow : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    double mCategoryColumnSize;
    vector_b67dfe3a mCategoryRowSizeList;
    vector_b67dfe3a mCategoryLabelRowSizeList;
}
...
- (void)setCategoryLabelRowSizeList:(const vector_b67dfe3a *)arg1;
- (vector_b67dfe3a *)categoryLabelRowSizeList;
- (void)setCategoryRowSizeList:(const vector_b67dfe3a *)arg1;
- (vector_b67dfe3a *)categoryRowSizeList;
- (void)setCategoryColumnSize:(double)arg1;
- (double)categoryColumnSize;
