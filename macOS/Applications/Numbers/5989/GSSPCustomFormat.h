...
@class NSString, TSUCustomFormatData;

@interface GSSPCustomFormat : GSSPMessageBase <GSSPAutoDecodable>
{
    NSString *mFormatName;
    int mFormatType;
    TSUCustomFormatData *mDefaultFormatData;
    vector_ce2008ab mConditionList;
}
...
- (void)setConditionList:(const vector_ce2008ab *)arg1;
- (vector_ce2008ab *)conditionList;
- (void)setDefaultFormatData:(id)arg1;
