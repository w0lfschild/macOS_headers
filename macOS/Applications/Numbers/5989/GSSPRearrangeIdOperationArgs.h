...
#import "GSSPIdOperationArgs.h"

#import "GSSPAutoDecodable-Protocol.h"

@interface GSSPRearrangeIdOperationArgs : GSSPIdOperationArgs <GSSPAutoDecodable>
{
    int mFromIndex;
    int mToIndex;
}
...
- (void)setToIndex:(int)arg1;
- (int)toIndex;
- (void)setFromIndex:(int)arg1;
- (int)fromIndex;
