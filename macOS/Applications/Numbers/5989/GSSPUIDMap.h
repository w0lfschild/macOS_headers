...
@interface GSSPUIDMap : GSSPMessageBase
{
    vector_4dc5f307 mDomainUIDList;
    vector_4dc5f307 mRangeUIDList;
}
...
- (void)setRangeUIDList:(const vector_4dc5f307 *)arg1;
- (vector_4dc5f307 *)rangeUIDList;
- (void)setDomainUIDList:(const vector_4dc5f307 *)arg1;
- (vector_4dc5f307 *)domainUIDList;
