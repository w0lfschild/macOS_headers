...
@class NSTextField, TMABackgroundView;
...
@interface TMAAboutPanelController : NSWindowController
{
    ...
    TMABackgroundView *_topBackgroundView;
    TMABackgroundView *_bottomBackgroundView;
}

+ (id)sharedController;
@property(nonatomic) TMABackgroundView *bottomBackgroundView; // @synthesize bottomBackgroundView=_bottomBackgroundView;
@property(nonatomic) TMABackgroundView *topBackgroundView; // @synthesize topBackgroundView=_topBackgroundView;
