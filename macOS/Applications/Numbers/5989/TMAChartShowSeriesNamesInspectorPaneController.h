...
@interface TMAChartShowSeriesNamesInspectorPaneController : TMAChartInspectorPaneController
{
    NSArrayController *mSeriesArrayController;
    NSButton *_showNameButton;
}
...
+ (id)tabIdentifier;
+ (id)nibName;
@property(retain, nonatomic) NSButton *showNameButton; // @synthesize showNameButton=_showNameButton;
