...
@interface TMATextTabbedInspectorPaneProvider : NSObject <TMAInspectorPaneProvider>
{
}

+ (id)shrinkTextToFitPaneController;
+ (id)listPaneController;
+ (id)tabStopsPaneController;
+ (id)indentPaneController;
+ (id)spacingPaneController;
+ (id)alignmentPaneController;
+ (id)paneProvider;
