...
@class CALayer, NSArray, NSFormatter, NSMapTable, NSMutableArray, NSMutableOrderedSet, NSMutableSet, NSNumberFormatter, NSSet, NSString, TSDBackgroundLayoutAndRenderState, TSDCanvas, TSDCanvasAnimation, TSDCanvasLayer, TSDCanvasView, TSDContainerRep, TSDDynamicOperationController, TSDEditorController, TSDGestureDispatcher, TSDGuideController, TSDInteractiveCanvasLayerHelper, TSDLayoutController, TSDMacGestureRuntime, TSDSelectionModelTranslator, TSDTrackerManipulatorCoordinator, TSDUserDefinedGuideController, TSKAccessController, TSKChangeNotifier, TSKCollaborationDocumentSessionController, TSKCommandController, TSKDocumentRoot, TSKSelectionPath, TSKSelectionPathTransformer, TSPObject, TSPObjectContext, TSUColor, TSUPointerKeyDictionary;
...
@interface TSDInteractiveCanvasController : NSObject <TSDDynamicCanvasDelegate, TSDCanvasProxyDelegate, TSDCollaboratorCursorHUDControllerDelegate, TSDDynamicOverridingCanvasDelegate, TSDCanvasDelegate, TSDErrorPresenter, TSKChangeSourceObserver, TSKScrollViewDelegate, TSDBackgroundLayoutAndRenderStateDelegate, TSDRepTrackerDelegateCreation, TSDTilingLayerDelegate, TSDPencilAnnotationGeometryHelper>
{
    ...
    TSUColor *mSelectionHighlightColor;
    ...
    NSMutableOrderedSet *mDynamicOverrideProviders;
    ...
    NSMapTable *mPencilAnnotationImageCache;
    BOOL mShowsComments;
    BOOL mPencilAnnotationsHidden;
    BOOL mPencilAnnotationModeActive;
...
@property(nonatomic) BOOL pencilAnnotationModeActive; // @synthesize pencilAnnotationModeActive=mPencilAnnotationModeActive;
...
- (void)p_setNeedsDisplayIfNeededForAncestorRepOf:(id)arg1 inRect:(struct CGRect)arg2;
...
@property(readonly, nonatomic) TSDCanvasAnimation *i_currentAnimation;
@property(readonly, nonatomic) BOOL i_inPrintPreviewMode;
@property(readonly, nonatomic) BOOL i_shouldSuppressFontSmoothing;
...
- (id)p_hitRepAnnotationPairs:(id)arg1 withPoint:(struct CGPoint)arg2;
- (id)hitRepAnnotationPairAtUnscaledPoint:(struct CGPoint)arg1;
...
- (void)p_performBlockWithCachedLayoutsForCollaboratorCursors:(CDUnknownBlockType)arg1;
- (BOOL)i_shouldShowCollaboratorCursorForLayout:(id)arg1;
- (id)i_lobbySessionSelectingLayout:(id)arg1;
...
- (id)unscaledAnchorRectsForPencilAnnotationSelectionPath:(id)arg1 attachedType:(long long)arg2 withLayout:(id)arg3;
...
@property(readonly, nonatomic) BOOL freehandDrawingModeActive;
@property(readonly) BOOL shouldShowPencilAnnotations;
@property(readonly, nonatomic) NSMapTable *pencilAnnotationImageCache;
...
- (id)unitStringForAngle:(double)arg1 shouldNormalize:(BOOL)arg2;
...
- (id)numberFormatter;
- (id)unitFormatter;
@property(readonly, nonatomic) BOOL i_shouldAttemptToPreserveContentOffsetAfterFixFrame;
...
@property(copy, nonatomic) TSUColor *selectionHighlightColor;
...
- (void)removeDynamicOverrideProvider:(id)arg1;
- (void)addDynamicOverrideProvider:(id)arg1;
...
- (void)p_collabParticipantsDidChange:(id)arg1;
