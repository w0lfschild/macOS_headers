...
+ (id)keyPathsForValuesAffectingSelectedObjectsSupportingAttribution;
+ (id)keyPathsForValuesAffectingMediaInfos;
...
- (int)p_canMakeCurrentSelectionPlaceholder;
...
- (id)selectedObjectsSupportingReplacement;
