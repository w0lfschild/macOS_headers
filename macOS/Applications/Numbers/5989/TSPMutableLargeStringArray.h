...
@interface TSPMutableLargeStringArray : TSPAbstractMutableLargeArray <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPLargeStringArray:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
