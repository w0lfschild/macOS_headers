...
@class NSHashTable, NSString, NSURL, TSRCMutableWaveform, TSRCWaveform, TSRCWaveformGenerator;
@protocol OS_dispatch_queue;

@interface TSRCWaveformDataSource : NSObject <TSRCWaveformGeneratorSegmentOutputObserver>
{
    TSRCMutableWaveform *_accumulatorWaveform;
    TSRCMutableWaveform *_liveRecordingMergingWaveform;
    BOOL _hasStartedLoading;
    BOOL _hasSavedGeneratedWaveform;
    NSObject<OS_dispatch_queue> *_queue;
    TSRCWaveformGenerator *_waveformGenerator;
...
@property(readonly, nonatomic) TSRCWaveformGenerator *waveformGenerator; // @synthesize waveformGenerator=_waveformGenerator;
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *queue; // @synthesize queue=_queue;
@property(readonly, nonatomic) TSRCWaveform *liveRecordingMergingWaveform; // @synthesize liveRecordingMergingWaveform=_liveRecordingMergingWaveform;
@property(readonly, nonatomic) TSRCWaveform *accumulatorWaveform; // @synthesize accumulatorWaveform=_accumulatorWaveform;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) CDStruct_c3b9c2ee timeRangeToHighlight;
