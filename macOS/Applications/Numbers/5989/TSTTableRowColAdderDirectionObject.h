...
@class CALayer, NSMutableDictionary, TSTTableRowColAdderAnimation, TSUImage;

@interface TSTTableRowColAdderDirectionObject : NSObject
{
    BOOL leftToRight;
    unsigned int insertionIndex;
    unsigned int lastVisibleIndex;
    unsigned int lastVisibleBodyIndex;
    unsigned int elementCount;
    unsigned int fixedElementCount;
    unsigned int index;
...
@property(nonatomic) BOOL leftToRight; // @synthesize leftToRight;
...
@property(nonatomic) unsigned int fixedElementCount; // @synthesize fixedElementCount;
@property(nonatomic) unsigned long long maxElementCount; // @synthesize maxElementCount;
@property(nonatomic) unsigned int elementCount; // @synthesize elementCount;
@property(nonatomic) unsigned int lastVisibleBodyIndex; // @synthesize lastVisibleBodyIndex;
@property(nonatomic) unsigned int lastVisibleIndex; // @synthesize lastVisibleIndex;
@property(nonatomic) unsigned int insertionIndex; // @synthesize insertionIndex;
