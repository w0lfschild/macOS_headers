...
@class CALayer, NSDictionary, NSMutableDictionary, NSString, NSView, TSWPColumn, TSWPInteractiveCanvasController, TSWPRulerMarkerController, TSWPStorage;
@protocol TSWPRulerControllerDelegate, TSWPRulerMarkerEditor;

@interface TSWPRulerController : NSObject <TSWPRulerMarkerControllerDelegate, TSKChangeSourceObserver, TSDRulerController, CALayerDelegate>
{
    ...
    BOOL _suppressMarkerAnimations;
    BOOL _invalidateMarkersForProcessChanges;
    BOOL _invalidateRulerForProcessChanges;
...
@property(nonatomic) BOOL invalidateRulerForProcessChanges; // @synthesize invalidateRulerForProcessChanges=_invalidateRulerForProcessChanges;
@property(nonatomic) BOOL invalidateMarkersForProcessChanges; // @synthesize invalidateMarkersForProcessChanges=_invalidateMarkersForProcessChanges;
...
@property(nonatomic) BOOL suppressMarkerAnimations; // @synthesize suppressMarkerAnimations=_suppressMarkerAnimations;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) NSView *verticalRulerView;
@property(readonly, nonatomic) NSView *horizontalRulerView;
...
- (void)displayRulerDragUIForGuideType:(long long)arg1 andOffset:(double)arg2;
- (void)displayRulerDragUIForRect:(struct CGRect)arg1;
- (void)displayRulerDragUI;
- (void)setEnabled:(BOOL)arg1 animated:(BOOL)arg2;
- (CDStruct_f968f95a)rulerProperties;
