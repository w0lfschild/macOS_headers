...
#import <TSCharts/GSSPCmdChartBaseWithChartInfoId.h>

#import "GSSPAutoDecodable-Protocol.h"

@class NSArray;

@interface GSSPCmdChartMediatorSetFormula : GSSPCmdChartBaseWithChartInfoId <GSSPAutoDecodable>
{
...
- (int)seriesIndex;
- (void)setFormulaWrappers:(id)arg1;
- (id)formulaWrappers;
- (void)setModelUpdateDataType:(int)arg1;
- (int)modelUpdateDataType;
