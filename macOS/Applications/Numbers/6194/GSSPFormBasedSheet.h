...
@interface GSSPFormBasedSheet : GSSPSheet <GSSPAutoDecodable>
{
    NSString *mTableId;
    BOOL mDefinedTableId;
}
...
@property(readonly, nonatomic) BOOL definedTableId; // @synthesize definedTableId=mDefinedTableId;
- (void).cxx_destruct;
- (id)description;
- (id)dspClassName;
