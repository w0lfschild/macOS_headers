...
@interface GSSPNumbersPasteboardAppNativeObject : GSSPPasteboardAppNativeObject
{
    vector_fdea956d mSheetList;
}
...
- (void)setSheetList:(const vector_fdea956d *)arg1;
- (vector_fdea956d *)sheetList;
