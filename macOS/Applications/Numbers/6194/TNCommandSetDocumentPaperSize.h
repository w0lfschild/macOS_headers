...
- (id)actionString;
- (id)tnDocumentRoot;
-     // Error parsing type: v32@0:8r^{CommandSetDocumentPaperSize=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{Size}^{CommandArchive}}16@24, name: loadFromArchive:unarchiver:
