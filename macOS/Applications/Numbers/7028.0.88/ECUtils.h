...
+ (float)positionAtRowIndex:(int)arg1 adjustment:(float)arg2 isRelative:(_Bool)arg3 ignoreHidden:(_Bool)arg4 edWorksheet:(id)arg5;
+ (float)positionAtColumnIndex:(int)arg1 adjustment:(float)arg2 isRelative:(_Bool)arg3 ignoreHidden:(_Bool)arg4 edWorksheet:(id)arg5 convertor:(id)arg6;
