...
-     // Error parsing type: v32@0:8^{ChartMediatorArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{ChartMediatorArchive}^{ChartMediatorFormulaStorage}BB}16@24, name: saveToArchive:archiver:
-     // Error parsing type: @32@0:8r^{ChartMediatorArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>={__cxx_atomic_impl<int, std::__1::__cxx_atomic_base_impl<int> >=Ai}}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{ChartMediatorArchive}^{ChartMediatorFormulaStorage}BB}16@24, name: initFromArchive:unarchiver:
