...
@interface GSSPCmdChartMediatorSetEditingState : GSSPCmdChartBaseWithChartInfoId <GSSPAutoDecodable>
{
...
- (int)scatterFormat;
- (void)setHasScatterFormat:(BOOL)arg1;
- (BOOL)hasScatterFormat;
