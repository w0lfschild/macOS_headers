...
@interface GSSPCmdDocumentSetSheetLayoutDirection : GSSPCmdBase <GSSPAutoDecodable>
{
    NSUUID *mSheetId;
    unsigned long long mNewDirection;
}
...
- (void)setNewDirection:(unsigned long long)arg1;
- (unsigned long long)newDirection;
