...
@interface TNSheetEditor : NSObject <TSDKeyValueProxyVendingEditor, TSDEditor>
{
...
- (void)selectSheetByPosition:(id)arg1;
...
- (void)setSheetLayoutDirection:(unsigned long long)arg1 sheet:(id)arg2;
- (void)duplicateSheet:(id)arg1;
- (void)pasteSheetFromPasteboardAfterSheet:(id)arg1 fromPasteboard:(id)arg2;
- (void)pasteSheetFromPasteboardAfterSheet:(id)arg1;
- (void)copySheet:(id)arg1 toPasteboard:(id)arg2;
- (void)copySheet:(id)arg1;
- (void)cutSheet:(id)arg1 toPasteboard:(id)arg2;
- (void)cutSheet:(id)arg1;
- (void)deleteSheet:(id)arg1;
- (id)insertDefaultSheetWithName:(id)arg1 forNewForm:(BOOL)arg2;
- (id)insertDefaultSheetWithName:(id)arg1;
- (BOOL)canPasteSheet;
- (id)selectionPathForBuildingFormOnSheet:(id)arg1 withFormBuilderSelection:(id)arg2;
- (id)selectionPathForBuildingFormOnSheet:(id)arg1;
- (id)selectionPathForViewingFormOnSheet:(id)arg1 withFormViewerSelection:(id)arg2;
- (id)selectionPathForViewingFormOnSheet:(id)arg1;
