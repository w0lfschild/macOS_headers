...
- (void)updater:(SUUpdater *)arg1 willInstallUpdateOnQuit:(SUAppcastItem *)arg2 immediateInstallationBlock:(void (^)(void))arg3;
...
- (BOOL)updater:(SUUpdater *)arg1 shouldPostponeRelaunchForUpdate:(SUAppcastItem *)arg2;
...
- (void)updater:(SUUpdater *)arg1 userDidSkipThisVersion:(SUAppcastItem *)arg2;
- (void)updaterDidNotFindUpdate:(SUUpdater *)arg1;
- (void)updater:(SUUpdater *)arg1 didDismissUpdateAlertPermanently:(BOOL)arg2 forItem:(SUAppcastItem *)arg3;
- (BOOL)updaterShouldShowUpdateAlertForScheduledUpdate:(SUUpdater *)arg1 forItem:(SUAppcastItem *)arg2;
