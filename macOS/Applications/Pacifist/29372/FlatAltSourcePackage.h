...
#import "FlatPackage.h"

@class CSRef, NSString, NSURL;

@interface FlatAltSourcePackage : FlatPackage
{
    NSString *_altSourcePath;
    CSRef *_imageRef;
}

@property(copy, nonatomic) CSRef *imageRef; // @synthesize imageRef=_imageRef;
@property(copy, nonatomic) NSString *altSourcePath; // @synthesize altSourcePath=_altSourcePath;
- (void).cxx_destruct;
- (void)addChildrenOfItem:(id)arg1 toArray:(id)arg2;
@property(copy, nonatomic) NSURL *imageURL;
- (id)altSourceURLAndReturnDevEntryURL:(id *)arg1 error:(id *)arg2;
