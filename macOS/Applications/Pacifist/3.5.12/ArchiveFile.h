...
@class CSCodeSigningInfo, CSRef, NSArray, NSDate, NSDictionary, NSError, NSImage, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, NSURL, NSUUID, PackageItem, ScriptsFileItem;
