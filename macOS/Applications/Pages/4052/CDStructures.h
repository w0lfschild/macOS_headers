...
@class EDString, NSDate, NSIndexSet, NSMutableArray, NSObject, NSSet, NSString, NSUUID, TSCH3DAnimationInterpolation, TSCH3DChartRep, TSCH3DScene, TSCH3DShaderVariable, TSCHChartInfo, TSCHChartSeriesType, TSCHChartType, TSDDrawableInfo, TSTCell, TSUCustomFormat, TSWPStorage, WDBorder, WDShading, WDStyle;
...
struct map<WDAnnotation *, int, std::__1::less<WDAnnotation *>, std::__1::allocator<std::__1::pair<WDAnnotation *const, int>>> {
    struct __tree<std::__1::__value_type<WDAnnotation *, int>, std::__1::__map_value_compare<WDAnnotation *, std::__1::__value_type<WDAnnotation *, int>, std::__1::less<WDAnnotation *>, true>, std::__1::allocator<std::__1::__value_type<WDAnnotation *, int>>> {
        struct __tree_node<std::__1::__value_type<WDAnnotation *, int>, void *> *__begin_node_;
