...
@interface GSSPCmdTextCreateHyperlink : GSSPCmdTextStorageAction <GSSPAutoDecodable>
{
    vector_c16d56c8 mRangeList;
    vector_9300c341 mHyperlinkFieldList;
}
...
- (void)dealloc;
- (void)setHyperlinkFieldList:(const vector_9300c341 *)arg1;
- (vector_9300c341 *)hyperlinkFieldList;
