...
#import "GSSPCmdTextReplaceText.h"

#import "GSSPAutoDecodable-Protocol.h"

@class TSKAddIdOperationArgs, TSWPAttachment;

@interface GSSPCmdTextInsertAttachment : GSSPCmdTextReplaceText <GSSPAutoDecodable>
{
    TSWPAttachment *mAttachment;
    TSKAddIdOperationArgs *mAddedArgs;
}
