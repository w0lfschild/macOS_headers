...
@interface GSSPCmdTextParagraphStyleChangeProperty : GSSPCmdTextStorageAction <GSSPAutoDecodable>
{
    vector_c16d56c8 mRangeList;
    vector_c74776a8 mChangeList;
}
...
- (void)dealloc;
- (void)setChangeList:(const vector_c74776a8 *)arg1;
- (vector_c74776a8 *)changeList;
