...
@interface GSSPCmdTextSetCharacterStyle : GSSPCmdTextStorageAction <GSSPAutoDecodable>
{
    vector_c16d56c8 mRangeList;
    vector_896f3d69 mCharacterStyleOrNilList;
}
...
- (void)dealloc;
- (void)setCharacterStyleOrNilList:(const vector_896f3d69 *)arg1;
- (vector_896f3d69 *)characterStyleOrNilList;
