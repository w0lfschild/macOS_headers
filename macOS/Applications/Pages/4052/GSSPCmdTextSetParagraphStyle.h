...
@interface GSSPCmdTextSetParagraphStyle : GSSPCmdTextStorageAction <GSSPAutoDecodable>
{
    vector_c16d56c8 mRangeList;
    vector_dd8b49b6 mParagraphStyleList;
    BOOL mStripCharacterStyles;
}
...
- (void)dealloc;
- (void)setStripCharacterStyles:(BOOL)arg1;
- (BOOL)stripCharacterStyles;
