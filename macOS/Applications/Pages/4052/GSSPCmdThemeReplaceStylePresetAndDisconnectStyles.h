...
@interface GSSPCmdThemeReplaceStylePresetAndDisconnectStyles : GSSPCmdBase <GSSPAutoDecodable>
{
    TSSStyle *mPreset;
    TSSStyle *mReplacementPreset;
}
...
- (void)dealloc;
- (void)setReplacementPreset:(id)arg1;
- (id)replacementPreset;
