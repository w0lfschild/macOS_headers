...
@interface GSSPConnectionLineInfo : GSSPBaseShapeInfo <GSSPAutoDecodable>
{
...
- (id)connectedFromId;
- (id)convertTSDConnectionLineInfoWithDecodeContext:(struct GSSPDecodeConversionContext *)arg1 error:(id *)arg2;
