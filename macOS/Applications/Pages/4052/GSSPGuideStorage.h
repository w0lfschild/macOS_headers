...
@interface GSSPGuideStorage : GSSPPersistableObject <GSSPAutoDecodable>
{
    vector_c301cdb1 mUserDefinedGuideList;
}
...
- (void)dealloc;
- (void)setUserDefinedGuideList:(const vector_c301cdb1 *)arg1;
- (vector_c301cdb1 *)userDefinedGuideList;
