...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, TPDocumentSettings, TPDocumentViewController, TPDrawablesZOrder, TPFloatingDrawables, TPInteractiveCanvasController, TPPageLayoutNotifier, TPPaginatedPageController, TPSection, TPStatisticsController, TPTOCController, TPTheme, TSDThumbnailController, TSPObject, TSSStylesheet, TSWPChangeSession, TSWPStorage;
...
@property(nonatomic) TPDocumentViewController *viewController; // @synthesize viewController=_viewController;
