...
{
    TSUImage *_buttonBackground;
    NSAttributedString *_controlTitleThatDiffersFromMenu;
...
@property(retain, nonatomic) NSAttributedString *controlTitleThatDiffersFromMenu; // @synthesize controlTitleThatDiffersFromMenu=_controlTitleThatDiffersFromMenu;
