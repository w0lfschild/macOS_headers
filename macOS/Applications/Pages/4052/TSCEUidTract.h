...
+ (BOOL)p_remapUidVector:(vector_dadc1b26 *)arg1 usingUidMap:(const UUIDMap_8a451d2c *)arg2 clearIfMissing:(BOOL)arg3;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (BOOL)remapUsingColumnUidMap:(const UUIDMap_8a451d2c *)arg1 rowUidMap:(const UUIDMap_8a451d2c *)arg2 clearIfMissing:(BOOL)arg3;
- (BOOL)remapUsingUidMap:(const UUIDMap_8a451d2c *)arg1;
- (id)description;
