...
@interface TSCH3DPointLight : TSCH3DLight <GSSPAutoEncodable, TSCH3DLightPositionable>
{
...
- (void)populateGSSPChart3dPointLight:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
