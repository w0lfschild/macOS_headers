...
@interface TSCHCDESelectionTransformer : TSPObject <TSKSelectionTransformer>
{
    TSCHCDESelection *mSelection;
}

- (void)saveToArchive:(struct CDESelectionTransformerArchive *)arg1 archiver:(id)arg2;
- (void)saveToArchiver:(id)arg1;
- (void)loadFromArchive:(const struct CDESelectionTransformerArchive *)arg1 unarchiver:(id)arg2;
