...
@interface TSCHChartAxisNonStyle : TSCHBaseStyle <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPChartAxisNonStyle:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
