...
@interface TSCHLegendStyle : TSCHBaseStyle <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPChartLegendStyle:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
