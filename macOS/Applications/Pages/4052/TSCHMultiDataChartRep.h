...
@property(copy, nonatomic) NSMutableDictionary *previousOutsideBodyBounds; // @synthesize previousOutsideBodyBounds=mPreviousOutsideBodyBounds;
@property(copy, nonatomic) NSMutableDictionary *layerIdToLayerMap; // @synthesize layerIdToLayerMap=mLayerIdToLayerMap;
