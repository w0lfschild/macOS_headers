...
- (struct CGRect)p_fixedBoundsForScrollViewSize:(struct CGSize)arg1 viewScale:(double)arg2 contentInset:(struct NSEdgeInsets)arg3;
...
- (struct CGPoint)p_contentOffsetForUnscaledContentCenter:(struct CGPoint)arg1 viewScale:(double)arg2 contentInset:(struct NSEdgeInsets)arg3;
...
- (void)tsd_setNeedsDisplayForDirtyTiles:(id)arg1;
