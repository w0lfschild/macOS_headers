...
- (void)addMessage:(const struct Message *)arg1 withStrongReferencesMap:(unordered_map_88cdf798 *)arg2 forObjectIdentifier:(long long)arg3;
- (void)addArchiver:(id)arg1;
- (map_c224dc08 *)_messageAlternateMapFromArchivableContent:(id)arg1;
- (unordered_map_88cdf798 *)_strongReferencesFromArchiver:(id)arg1;
