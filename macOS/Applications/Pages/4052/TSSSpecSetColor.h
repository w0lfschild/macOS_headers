...
#import "TSSSpecColor.h"

#import "GSSPAutoEncodable-Protocol.h"

@class TSUColor;

@interface TSSSpecSetColor : TSSSpecColor <GSSPAutoEncodable>
{
    TSUColor *_color;
    BOOL _unset;
}
...
- (void)deallocSOS;
- (void)populateGSSPSpecSetColor:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
