...
@interface TSTDefaultCellStylesContainer : TSPObject <GSSPAutoEncodable>
{
    ...
    unordered_map_cbdc988b _uidToTextStyleMap;
    unordered_map_7b841237 _uidToCellStyleMap;
}

@property(readonly, nonatomic) unordered_map_7b841237 *uidToCellStyleMap; // @synthesize uidToCellStyleMap=_uidToCellStyleMap;
...
@property(readonly, nonatomic) unordered_map_cbdc988b *uidToTextStyleMap; // @synthesize uidToTextStyleMap=_uidToTextStyleMap;
