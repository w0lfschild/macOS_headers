...
- (void)setCellReference:(CDStruct_de21cb60)arg1 columnIsAbsolute:(BOOL)arg2 rowIsAbsolute:(BOOL)arg3;
...
- (id)initWithCellReference:(CDStruct_de21cb60)arg1 columnIsAbsolute:(BOOL)arg2 rowIsAbsolute:(BOOL)arg3;
