...
@interface GSSPCmdExecuteTestBetweenRollbackAndReapply : GSSPCmdBase <GSSPAutoDecodable>
{
    UUIDData_5fbc143e mBlockUUID;
}
...
- (void)dealloc;
- (void)setBlockUUID:(UUIDData_5fbc143e)arg1;
- (UUIDData_5fbc143e)blockUUID;
