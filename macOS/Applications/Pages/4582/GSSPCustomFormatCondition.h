...
@interface GSSPCustomFormatCondition : GSSPMessageBase
{
    int mConditionType;
    double mConditionValue;
    TSUCustomFormatData *mConditionFormatData;
}
...
- (void)dealloc;
- (void)setConditionFormatData:(id)arg1;
- (id)conditionFormatData;
- (void)setConditionValue:(double)arg1;
