...
#import "GSSPSpecListStyleListNumberTypeArray.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPListStyleListNumberTypeArray;

@interface GSSPSpecSetListStyleListNumberTypeArray : GSSPSpecListStyleListNumberTypeArray <GSSPAutoDecodable>
{
    GSSPListStyleListNumberTypeArray *mListStyleListNumberTypeArray;
    BOOL mUnset;
}
...
- (BOOL)unset;
- (void)setListStyleListNumberTypeArray:(id)arg1;
- (id)listStyleListNumberTypeArray;
