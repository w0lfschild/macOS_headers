...
@interface GSSPStrokePattern : GSSPMessageBase <GSSPAutoDecodable>
{
    int mPatternType;
    vector_3f7ffb82 mPatternList;
    double mPhase;
}
...
- (double)phase;
- (void)setPatternList:(const vector_3f7ffb82 *)arg1;
- (vector_3f7ffb82 *)patternList;
