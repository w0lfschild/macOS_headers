...
#import "GSSPParagraphStyleProperties.h"

@class TSWPCharacterStyle;

@interface GSSPTOCEntryStyleProperties : GSSPParagraphStyleProperties
{
    BOOL mTocShowPageNumber;
    TSWPCharacterStyle *mTocPageNumberStyle;
...
- (void)setTocShowPageNumber:(BOOL)arg1;
- (BOOL)tocShowPageNumber;
