...
{
    vector_dadc1b26 mDomainUIDList;
    vector_dadc1b26 mRangeUIDList;
}
...
- (void)dealloc;
- (void)setRangeUIDList:(const vector_dadc1b26 *)arg1;
- (vector_dadc1b26 *)rangeUIDList;
- (void)setDomainUIDList:(const vector_dadc1b26 *)arg1;
- (vector_dadc1b26 *)domainUIDList;
