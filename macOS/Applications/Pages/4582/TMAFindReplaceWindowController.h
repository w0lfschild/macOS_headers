...
@class NSArray, NSButton, NSMapTable, NSPopUpButton, NSSegmentedControl, NSString, TSAFindReplaceController, TSAProgressSearchField, TSKCollaborationState;
...
- (void)p_removeHighlightEventHandlerForInteractiveCanvasController:(id)arg1;
- (void)p_installHighlightEventHandlerForInteractiveCanvasControllerIfNeeded:(id)arg1;
