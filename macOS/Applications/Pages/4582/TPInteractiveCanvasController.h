...
@class CALayer, NSIndexSet, NSString, TPDocumentWindowController, TPInlineRepDragTrackerDelegate, TPRepDragTrackerDelegate, TPRepTrackerDelegate;

@interface TPInteractiveCanvasController : TSAInteractiveCanvasController <TPViewStateProvider, TPViewStateConsumer, TSKSearchCanvasDelegate, TSWPEndNoteCitationsControllerDelegate>
{
...
- (id)selectionPathForRange:(struct _NSRange)arg1 onStorage:(id)arg2;
...
- (id)p_pageMasterOwningModelForInfos:(id)arg1;
- (id)p_editorForArchivedViewState;
- (id)p_canvasBackgroundLayer;
- (void)didLayoutPageLayout:(id)arg1;
...
- (id)pInfoForObjectInDocSetup:(id)arg1;
...
@property(nonatomic) BOOL checkerboardBackgroundEnabled;
...
- (void)pageControllerWillDestroyBody:(id)arg1 afterPageIndex:(unsigned long long)arg2;
