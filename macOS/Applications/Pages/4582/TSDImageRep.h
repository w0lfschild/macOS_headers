...
@class CALayer, CAShapeLayer, NSCache, NSMutableArray, NSObject, NSRecursiveLock, NSString, TSDImageRepSizingState, TSDInstantAlphaTracker, TSDLayoutGeometry, TSDMacInstantAlphaMagnifierLoupeWindow, TSDMaskEditModeDragEventHandler, TSPData;
@protocol OS_dispatch_queue, OS_dispatch_semaphore;

@interface TSDImageRep : TSDMediaRep <CALayerDelegate, TSDMagicMoveMatching, TSDShapeControlRep>
{
...
- (BOOL)p_shouldUseSourceImageForContext:(id)arg1 clipBounds:(struct CGRect)arg2 transform:(struct CGAffineTransform)arg3 image:(struct CGImage *)arg4;
