...
- (BOOL)p_importingDrawablesFromSender:(id)arg1;
- (BOOL)insertPanelIsSender:(id)arg1;
- (BOOL)p_isDragOverSelectedDrawableForSender:(id)arg1;
...
- (id)p_storageForDragDropOperation;
...
- (id)textImageForSelection:(id)arg1 frame:(struct CGRect *)arg2 usingGlyphRect:(BOOL)arg3 shouldPulsate:(BOOL)arg4 suppressInvisibles:(BOOL)arg5 suppressChildReps:(BOOL)arg6;
- (id)p_imageForAnimatingPath:(struct CGPath *)arg1;
- (id)p_imageForRect:(struct CGRect)arg1 usingGlyphRect:(BOOL)arg2 drawBackground:(BOOL)arg3 shouldPulsate:(BOOL)arg4 forCaret:(BOOL)arg5 drawSelection:(id)arg6 suppressInvisibles:(BOOL)arg7 suppressChildReps:(BOOL)arg8;
...
- (BOOL)p_isDragPoint:(struct CGPoint)arg1 inSelection:(id)arg2;
