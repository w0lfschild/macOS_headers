...
@class NSMutableArray, NSMutableDictionary, TSSPropertySet, TSTCellStyle, TSTInfo, TSTTableModel, WDTable, WITDocumentState, WITTableBorderCache, WITTablePosition, WITTableRect, WITTextState;
...
@property(retain, nonatomic) TSTInfo *tstTableInfo; // @synthesize tstTableInfo=mTSTTableInfo;
@property(retain, nonatomic) TSTTableModel *tstTableModel; // @synthesize tstTableModel=mTSTTableModel;
