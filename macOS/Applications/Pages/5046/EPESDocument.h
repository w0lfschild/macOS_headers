...
@class EPEConnectionLineGroupCollection, EPEFootnote, EPXChapter, EPXDocument, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, TPDocumentRoot, TSPObjectContext, TSUMutableRetainedPointerSet, TSUPointerKeyDictionary, TSURetainedPointerKeyDictionary, TSURetainedPointerSet, TSWPStorage;
