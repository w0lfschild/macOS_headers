...
@class GSSPChartReferenceLineNonStyleProperties;

@interface GSSPChartReferenceLineNonStyle : GSSPStyle <GSSPAutoDecodable>
{
    GSSPChartReferenceLineNonStyleProperties *mOverridePropertyMap;
}
