...
@interface GSSPChartsOptionalDoubleArchive : GSSPMessageBase
{
    double mNumberArchive;
    BOOL mDefinedNumberArchive;
}

+ (Class)realClass;
+ (void)registerRealGsspClass:(Class)arg1;
@property(readonly, nonatomic) BOOL definedNumberArchive; // @synthesize definedNumberArchive=mDefinedNumberArchive;
- (id)description;
- (id)dspClassName;
...
- (void)dealloc;
- (BOOL)clearNumberArchive;
- (void)setNumberArchive:(double)arg1;
- (double)numberArchive;
- (void)saveToArchive:(struct ChartsNSNumberDoubleArchive *)arg1;
- (void)loadFromArchive:(const struct ChartsNSNumberDoubleArchive *)arg1;
