...
@interface GSSPCmdTableInducedTableChange : GSSPCmdBase <GSSPAutoDecodable>
{
    vector_e0b1a5c5 mTableChangeList;
}
...
- (void)dealloc;
- (void)setTableChangeList:(const vector_e0b1a5c5 *)arg1;
- (vector_e0b1a5c5 *)tableChangeList;
