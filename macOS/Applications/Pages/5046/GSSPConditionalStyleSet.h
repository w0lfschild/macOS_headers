...
@interface GSSPConditionalStyleSet : GSSPMessageBase <GSSPAutoDecodable>
{
    vector_f59ca16a mRuleList;
}
...
- (void)dealloc;
- (void)setRuleList:(const vector_f59ca16a *)arg1;
- (vector_f59ca16a *)ruleList;
