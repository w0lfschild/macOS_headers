...
{
    vector_d1537b29 mKeys;
    vector_bde5018d mFormats;
}
...
- (void)dealloc;
- (void)setFormats:(const vector_bde5018d *)arg1;
- (vector_bde5018d *)formats;
- (void)setKeys:(const vector_d1537b29 *)arg1;
- (vector_d1537b29 *)keys;
