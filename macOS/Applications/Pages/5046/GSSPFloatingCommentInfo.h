...
@interface GSSPFloatingCommentInfo : GSSPShapeInfo <GSSPAutoDecodable>
{
...
- (id)commentStorage;
- (id)convertTSWPFloatingCommentInfoWithDecodeContext:(struct GSSPDecodeConversionContext *)arg1 error:(id *)arg2;
