...
@interface GSSPSliceBody : GSSPMessageBase
{
    ...
    vector_a093891c mDrawableIdZOrderList;
    vector_718ce276 mFloatingDrawableList;
...
- (id)flowInfoList;
- (void)setFloatingDrawableList:(const vector_718ce276 *)arg1;
- (vector_718ce276 *)floatingDrawableList;
- (void)setDrawableIdZOrderList:(const vector_a093891c *)arg1;
- (vector_a093891c *)drawableIdZOrderList;
