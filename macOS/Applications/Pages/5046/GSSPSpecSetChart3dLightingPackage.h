...
#import "GSSPSpecChart3dLightingPackage.h"

#import "GSSPAutoDecodable-Protocol.h"

@class TSCH3DLightingPackage;

@interface GSSPSpecSetChart3dLightingPackage : GSSPSpecChart3dLightingPackage <GSSPAutoDecodable>
{
    TSCH3DLightingPackage *mChart3dLightingPackage;
    BOOL mUnset;
}
...
- (BOOL)unset;
- (void)setChart3dLightingPackage:(id)arg1;
- (id)chart3dLightingPackage;
