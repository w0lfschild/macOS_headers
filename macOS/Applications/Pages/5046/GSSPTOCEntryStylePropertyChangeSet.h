...
#import "GSSPParagraphStylePropertyChangeSet.h"

#import "GSSPAutoDecodable-Protocol.h"

@class TSSSpecBool, TSWPSpecCharacterStyle;

@interface GSSPTOCEntryStylePropertyChangeSet : GSSPParagraphStylePropertyChangeSet <GSSPAutoDecodable>
{
    TSSSpecBool *mTocShowPageNumber;
    TSWPSpecCharacterStyle *mTocPageNumberStyle;
    BOOL mDefinedTocShowPageNumber;
    BOOL mDefinedTocPageNumberStyle;
}
...
@property(readonly, nonatomic) BOOL definedTocPageNumberStyle; // @synthesize definedTocPageNumberStyle=mDefinedTocPageNumberStyle;
@property(readonly, nonatomic) BOOL definedTocShowPageNumber; // @synthesize definedTocShowPageNumber=mDefinedTocShowPageNumber;
- (id)description;
- (id)dspClassName;
...
- (void)dealloc;
- (BOOL)clearTocPageNumberStyle;
- (BOOL)clearTocShowPageNumber;
- (void)setTocPageNumberStyle:(id)arg1;
- (id)tocPageNumberStyle;
- (void)setTocShowPageNumber:(id)arg1;
- (id)tocShowPageNumber;
