...
- (void)p_updateCollaborativeModeByClearingCollaborationDisallowedForNetworkUnreachableErrorActionIfNeeded;
...
- (void)p_mergeAlternateContentsToURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)sharingStateRefreshed:(id)arg1 isUserInitiated:(BOOL)arg2 isContinuingActivity:(BOOL)arg3 completionBlock:(CDUnknownBlockType)arg4;
- (void)refreshSharingStateWithReason:(id)arg1 isUserInitiated:(BOOL)arg2 refreshShare:(BOOL)arg3 refreshPrivacy:(BOOL)arg4 migrateIfNecessary:(BOOL)arg5 canCoalesce:(BOOL)arg6 isContinuingActivity:(BOOL)arg7 queue:(id)arg8 completionBlock:(CDUnknownBlockType)arg9;
- (void)refreshSharingStateWithReason:(id)arg1 isUserInitiated:(BOOL)arg2 refreshShare:(BOOL)arg3 refreshPrivacy:(BOOL)arg4 migrateIfNecessary:(BOOL)arg5 queue:(id)arg6 completionBlock:(CDUnknownBlockType)arg7;
...
- (void)setPreferredPackageTypeToPackage:(BOOL)arg1;
