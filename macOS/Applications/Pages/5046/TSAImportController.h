...
@class NSDictionary, NSError, NSMutableArray, NSMutableSet, NSOperationQueue, NSProgress, NSSet, NSString, NSURL, NSUUID, SFUCryptoKey, TSACachedDocumentInfo, TSACollaborationErrorAction, TSPObjectContext, TSUProgressContext, TSUTemporaryDirectory;
@protocol NSFilePresenter, OS_dispatch_group, TSAImportDelegate, TSKCachedDocumentInfo, TSKImporter;
