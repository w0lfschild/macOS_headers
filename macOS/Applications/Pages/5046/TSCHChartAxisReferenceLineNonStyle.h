...
@interface TSCHChartAxisReferenceLineNonStyle : NSObject <GSSPAutoEncodable>
{
...
- (void)dealloc;
- (void)didInitFromSOS;
- (void)populateGSSPChartAxisReferenceLineNonStyle:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
