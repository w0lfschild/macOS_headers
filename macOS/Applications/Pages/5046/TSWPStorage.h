...
@class NSDictionary, NSMutableString, NSObject, NSString, TSDInfoGeometry, TSSStylesheet, TSTInfo, TSUWeakReference, TSWPCharacterStyle, TSWPDocumentRoot, TSWPStorageBroadcaster;
@protocol TSDContainerInfo><TSWPStorageParent, TSDOwningAttachment;

@interface TSWPStorage : TSPObject <GSSPAutoEncodable, TSDReplaceableMediaContainer, TSDReducibleImageContainer, TSDCompatibilityAwareMediaContainer, TSDDrawableContainerInfo, TSKSearchable, TSWPStorageParent, TSSStyleClient, TSWPTextSource, TSWPTextStatisticsTrackerProvider>
{
    NSMutableString *_string;
    struct TSWPAttributeArray *_attributesTable[20];
...
- (void)validate:(BOOL)arg1 shouldThrow:(BOOL)arg2 shouldFatalAssert:(BOOL)arg3;
...
- (id)pNSAttributedStringWithConversionDelegate:(id)arg1 ignoreLists:(BOOL)arg2 stripTextualAttachments:(BOOL)arg3 stripGraphicalAttachments:(BOOL)arg4 stripInlineAttachments:(BOOL)arg5 attachmentReplacementString:(id)arg6 scale:(double)arg7 withLayoutParent:(id)arg8 footnoteMarkStringProvider:(CDUnknownBlockType)arg9;
- (id)pNSAttributedStringWithDefaultConversionDelegateIgnoreLists:(BOOL)arg1 stripTextualAttachments:(BOOL)arg2 stripGraphicalAttachments:(BOOL)arg3 stripInlineAttachments:(BOOL)arg4 attachmentReplacementString:(id)arg5 scale:(double)arg6 withLayoutParent:(id)arg7;
...
- (id)nsAttributedSubstringFromRange:(struct _NSRange)arg1 conversionDelegate:(id)arg2 ignoreLists:(BOOL)arg3 scale:(double)arg4 applyChanges:(BOOL)arg5 includeInlineDrawables:(BOOL)arg6 footnoteMarkProvider:(id)arg7 withLayoutParent:(id)arg8;
...
- (void)p_attributesAtCharIndex:(unsigned long long)arg1 attributesOfInterest:(char [20])arg2 attributesTable:(id [20])arg3 effectiveRange:(struct _NSRange *)arg4;
...
- (int)p_highlightsAttributeKind;
- (BOOL)supportsOverlappingHighlights;
