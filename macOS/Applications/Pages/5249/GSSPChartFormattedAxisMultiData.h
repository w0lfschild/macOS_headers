...
{
    vector_d00ba620 mSeriesDataList;
    vector_a093891c mReferenceLineValueLabelList;
}
...
- (void)dealloc;
- (void)setReferenceLineValueLabelList:(const vector_a093891c *)arg1;
- (vector_a093891c *)referenceLineValueLabelList;
- (void)setSeriesDataList:(const vector_d00ba620 *)arg1;
- (vector_d00ba620 *)seriesDataList;
