...
@interface GSSPChartFormattedData : GSSPMessageBase
{
    vector_a4449968 mAxisDataList;
}
...
- (void)dealloc;
- (void)setAxisDataList:(const vector_a4449968 *)arg1;
- (vector_a4449968 *)axisDataList;
