...
@class TSCHChartStylePreset;

@interface GSSPChartStylePresetForTheme : GSSPPresetForTheme
{
    TSCHChartStylePreset *mChartStylePreset;
}
...
- (void)dealloc;
- (void)setChartStylePreset:(id)arg1;
- (id)chartStylePreset;
