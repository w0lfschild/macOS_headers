...
@interface GSSPCmdMutateCellFormat : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
...
- (void)dealloc;
- (void)setWholeFormatsDiffMap:(id)arg1;
- (id)wholeFormatsDiffMap;
- (void)setIntendedFormatType:(int)arg1;
- (int)intendedFormatType;
