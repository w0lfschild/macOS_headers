...
@class GSSPParagraphStyleProperties, NSString, TSCHStyleOwnerPath;

@interface GSSPCmdMutatePropertiesParagraphStylePropertyMutationMapEntry : GSSPMessageBase
{
    TSCHStyleOwnerPath *mStyleOwnerPath;
    NSString *mParagraphStyleIndexProperty;
    GSSPParagraphStyleProperties *mMap;
    BOOL mDefinedParagraphStyleIndexProperty;
    BOOL mDefinedMap;
}
...
@property(readonly, nonatomic) BOOL definedParagraphStyleIndexProperty; // @synthesize definedParagraphStyleIndexProperty=mDefinedParagraphStyleIndexProperty;
- (id)description;
- (id)dspClassName;
...
- (void)dealloc;
- (BOOL)clearMap;
- (BOOL)clearParagraphStyleIndexProperty;
- (void)setMap:(id)arg1;
- (id)map;
- (void)setParagraphStyleIndexProperty:(id)arg1;
- (id)paragraphStyleIndexProperty;
