...
@interface GSSPCmdTableFillCellsRequest : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    TSTCellUIDList *mSourceCells;
    TSTCellUIDList *mTargetCells;
    int mFillDirection;
}
...
- (int)fillDirection;
- (void)setTargetCells:(id)arg1;
- (id)targetCells;
- (void)setSourceCells:(id)arg1;
- (id)sourceCells;
