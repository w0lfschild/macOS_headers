...
@interface GSSPDurationFormat : GSSPMessageBase
{
    BOOL mUseAutomaticUnits;
    int mSmallest;
    int mLargest;
    int mStyle;
}
...
- (int)style;
- (void)setLargest:(int)arg1;
- (int)largest;
- (void)setSmallest:(int)arg1;
- (int)smallest;
- (void)setUseAutomaticUnits:(BOOL)arg1;
