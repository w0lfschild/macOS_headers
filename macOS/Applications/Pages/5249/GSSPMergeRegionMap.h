...
{
    vector_98d6607f mMergeRegionTopLeftCellUIDList;
    vector_e0f2bd7e mMergeRegionWidthList;
    vector_e0f2bd7e mMergeRegionHeightList;
}
...
- (void)dealloc;
- (void)setMergeRegionHeightList:(const vector_e0f2bd7e *)arg1;
- (vector_e0f2bd7e *)mergeRegionHeightList;
- (void)setMergeRegionWidthList:(const vector_e0f2bd7e *)arg1;
- (vector_e0f2bd7e *)mergeRegionWidthList;
- (void)setMergeRegionTopLeftCellUIDList:(const vector_98d6607f *)arg1;
- (vector_98d6607f *)mergeRegionTopLeftCellUIDList;
