...
#import "GSSPSpecListStyleStringArray.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPListStyleStringArray;

@interface GSSPSpecSetListStyleStringArray : GSSPSpecListStyleStringArray <GSSPAutoDecodable>
{
    GSSPListStyleStringArray *mListStyleStringArray;
    BOOL mUnset;
}
...
- (BOOL)unset;
- (void)setListStyleStringArray:(id)arg1;
- (id)listStyleStringArray;
