...
@class GSSPCellFormats, GSSPCellValue, GSSPFormula, NSString, TSDCommentStorage, TSTCellBorder, TSTCellStyle, TSTConditionalStyleSet, TSWPParagraphStyle, TSWPStorage;
