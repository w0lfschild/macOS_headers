...
@class NSArrayController, TMALocFittingSegmentedControl;
...
@property(nonatomic) TMALocFittingSegmentedControl *axisSelectionControl; // @synthesize axisSelectionControl=mAxisSelectionControl;
