...
@class NSArray, NSData, NSError, NSString, NSURL, NSUUID, TSACachedDocumentInfo, TSACollaborationContextValidator, TSACollaborationDocumentSessionStateJournalingController, TSACollaborationRevisionLog, TSADocumentRevisionNotifier, TSAProgressStalledNotifier, TSKDocumentRoot, TSKSharingState, TSUFakeProgress;
@protocol NSFilePresenter, OS_dispatch_queue, OS_dispatch_source, TSACollaborationCacheReconnectToken, TSACollaborationPassphraseRetriever, TSKCollaborationDocumentSessionStateJournaling, TSKCollaborationValidator;
...
@property(retain, nonatomic) TSACachedDocumentInfo *cachedDocumentInfo; // @synthesize cachedDocumentInfo=_cachedDocumentInfo;
...
- (void)dealloc;
- (id)initWithCachedDocumentInfo:(id)arg1 documentRoot:(id)arg2 sharingState:(id)arg3 passphrase:(id)arg4 flags:(unsigned long long)arg5 fileCoordinationInterrupter:(CDUnknownBlockType)arg6 filePresenter:(id)arg7;
