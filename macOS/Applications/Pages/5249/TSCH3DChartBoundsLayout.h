...
@property(readonly, nonatomic) CDStruct_e793ddfd layoutSettings; // @synthesize layoutSettings=mLayoutSettings;
...
- (void)dealloc;
- (id)init;
- (id)initWithScene:(id)arg1 containingViewport:(const tvec2_3b141483 *)arg2 originalContainingViewport:(const tvec2_3b141483 *)arg3 layoutSettings:(const CDStruct_e793ddfd *)arg4;
