...
+ (void)writeTextBox:(id)arg1 state:(id)arg2;
+ (void)write:(id)arg1 picOnly:(BOOL)arg2 state:(id)arg3;
...
+ (void)writeWrap:(id)arg1 state:(id)arg2;
...
+ (void)writeClientData:(id)arg1 state:(id)arg2;
+ (void)readClientData:(struct _xmlNode *)arg1 state:(id)arg2 to:(id)arg3;
+ (void)writeOAV:(id)arg1 state:(id)arg2;
+ (void)writeOAX:(id)arg1 state:(id)arg2;
