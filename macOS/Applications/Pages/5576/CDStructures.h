...
@class NSDate, NSIndexSet, NSMutableArray, NSObject, NSSet, NSString, NSUUID, TSCH3DAnimationInterpolation, TSCH3DChartRep, TSCH3DScene, TSCH3DShaderVariable, TSCHChartInfo, TSCHChartSeriesType, TSCHChartType, TSDDrawableInfo, TSUCustomFormat, TSWPStorage, WDBorder, WDShading;
