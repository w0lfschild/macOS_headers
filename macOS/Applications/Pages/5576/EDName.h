...
@class EDFormula, EDString, NSString, TSUPointerKeyDictionary;

@interface EDName : NSObject
{
    NSString *_formulaString;
    TSUPointerKeyDictionary *_maxWorksheetReferences;
...
- (void).cxx_destruct;
- (id)description;
@property(readonly, nonatomic) TSUPointerKeyDictionary *maxWorksheetReferences;
