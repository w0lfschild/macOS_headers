...
+ (void)loadExportInfoForFixedDrawableMappedAsImageInto:(id)arg1;
...
+ (double)maxReflowableDrawableWidthWithState:(id)arg1;
+ (void)mapReflowableDrawable:(id)arg1 toTextContainer:(id)arg2 geometryAdjustBlock:(CDUnknownBlockType)arg3 state:(id)arg4;
+ (void)writeDrawableExportInfo:(id)arg1 toTextContainer:(id)arg2 state:(id)arg3;
...
+ (void)tryToLoadExportInfoForMovieInto:(id)arg1;
...
+ (id)propertiesForPosition:(struct CGPoint)arg1 measureFromRight:(BOOL)arg2 positionAsMargins:(BOOL)arg3 cssPosition:(id)arg4 state:(id)arg5;
+ (id)propertiesForPosition:(struct CGPoint)arg1 measureFromRight:(BOOL)arg2 cssPosition:(id)arg3 state:(id)arg4;
+ (id)propertiesForPosition:(struct CGPoint)arg1 measureFromRight:(BOOL)arg2 state:(id)arg3;
+ (void)addPositionComponent:(double)arg1 withName:(id)arg2 isMargin:(BOOL)arg3 toDictionary:(id)arg4 state:(id)arg5;
