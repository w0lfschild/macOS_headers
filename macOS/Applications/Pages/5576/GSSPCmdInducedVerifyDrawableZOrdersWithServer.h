...
@interface GSSPCmdInducedVerifyDrawableZOrdersWithServer : GSSPCmdBase <GSSPAutoDecodable>
{
    NSArray *mServerDrawableZOrderLists;
}
...
- (void)setServerDrawableZOrderLists:(id)arg1;
- (id)serverDrawableZOrderLists;
