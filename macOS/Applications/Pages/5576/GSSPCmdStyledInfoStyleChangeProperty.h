...
@interface GSSPCmdStyledInfoStyleChangeProperty : GSSPCmdDrawableBaseWithDrawableInfoId <GSSPAutoDecodable>
{
    BOOL mIsBorderChange;
}
...
- (void)setIsBorderChange:(BOOL)arg1;
- (BOOL)isBorderChange;
