...
@interface GSSPCmdTestWithSlightModification : GSSPCmdBase <GSSPAutoDecodable>
{
    NSString *mDummyString;
    BOOL mDefinedDummyString;
}
...
@property(readonly, nonatomic) BOOL definedDummyString; // @synthesize definedDummyString=mDefinedDummyString;
- (void).cxx_destruct;
- (id)description;
- (id)dspClassName;
