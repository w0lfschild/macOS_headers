...
- (void)interactiveCanvasController:(TPInteractiveCanvasController *)arg1 didEnableCenteredSinglePageMode:(BOOL)arg2 animated:(BOOL)arg3;
...
- (void)showHUDForWPRep:(TSWPRep *)arg1 pageRep:(TPPageRep *)arg2 withFlags:(long long)arg3;
@end
