...
@class NSString, TSDReplaceableMediaMap, TSSPropertyMap, TSSStylesheet, TSURetainedPointerSet;

@interface TSSStyle : TSPObject <TSDReplaceableMediaContainer, TSDReducibleImageContainer, TSDCompatibilityAwareMediaContainer, GSSPPromiseCallback, GSSPAutoEncodable, NSCopying, TSSPropertyValueValidator, TSSStyleObject, TSSPropertySource, TSSStyleClient, TSKModel, TSKTransformableObject>
{
...
- (id)overridePropertyMapByReplacingMediaInOldToNewMap:(id)arg1;
