...
@interface TSTTableRowColMoveAnimation : TSTTableAnimationTask
{
    ...
    CALayer *mLayer;
    BOOL mUpLeadingValid;
    BOOL mLoTrailingValid;
}

@property(nonatomic) unsigned short numberOfRowCols; // @synthesize numberOfRowCols=mNumberOfRowCols;
@property(readonly, nonatomic) BOOL loTrailingValid; // @synthesize loTrailingValid=mLoTrailingValid;
@property(readonly, nonatomic) BOOL upLeadingValid; // @synthesize upLeadingValid=mUpLeadingValid;
...
- (void)installLoTrailingCellRange;
- (void)installUpLeadingCellRange;
- (void)teardownAnimation;
- (void)startAnimationOfDistance:(struct CGSize)arg1 animateUpLeading:(BOOL)arg2;
- (void)teardown;
- (void)dealloc;
