...
- (id)nsAttributedSubstringFromRange:(struct _NSRange)arg1 conversionDelegate:(id)arg2 ignoreLists:(BOOL)arg3 scale:(double)arg4 applyChanges:(BOOL)arg5 includeAttachments:(BOOL)arg6 footnoteMarkProvider:(id)arg7 withLayoutParent:(id)arg8;
