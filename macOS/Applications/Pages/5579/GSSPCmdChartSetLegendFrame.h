...
@interface GSSPCmdChartSetLegendFrame : GSSPCmdChartBaseWithChartInfoId <GSSPAutoDecodable>
{
    GSSPRect *mChangedLegendFrame;
}
...
- (void)setChangedLegendFrame:(id)arg1;
- (id)changedLegendFrame;
