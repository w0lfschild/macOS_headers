...
#import "GSSPCmdTableBaseRowColumnRangeCommand.h"

#import "GSSPAutoDecodable-Protocol.h"

@class TSTCellDiffMap;

@interface GSSPCmdTableChangeTableAreaForColumnOrRow : GSSPCmdTableBaseRowColumnRangeCommand <GSSPAutoDecodable>
{
    unsigned long long mTableAreaTransition;
...
- (id)cellDiffMap;
- (void)setTableAreaTransition:(unsigned long long)arg1;
- (unsigned long long)tableAreaTransition;
