...
@class TSTStructuredTextImportRecordSOS;

@interface GSSPCmdTableSetStructuredTextImportRecord : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    TSTStructuredTextImportRecordSOS *mImportRecord;
    BOOL mDefinedImportRecord;
}
...
@property(readonly, nonatomic) BOOL definedImportRecord; // @synthesize definedImportRecord=mDefinedImportRecord;
- (void).cxx_destruct;
- (id)description;
- (id)dspClassName;
...
- (BOOL)clearImportRecord;
- (void)setImportRecord:(id)arg1;
- (id)importRecord;
