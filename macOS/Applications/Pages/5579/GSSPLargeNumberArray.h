...
@interface GSSPLargeNumberArray : GSSPLargeArray <GSSPAutoDecodable>
{
    vector_12bd641b mElementList;
}
...
- (void)setElementList:(const vector_12bd641b *)arg1;
- (vector_12bd641b *)elementList;
