...
@interface GSSPLargeStringArray : GSSPLargeArray <GSSPAutoDecodable>
{
    vector_95cc1646 mElementList;
}
...
- (void)setElementList:(const vector_95cc1646 *)arg1;
- (vector_95cc1646 *)elementList;
