...
@interface GSSPScmpResponseHeader : GSSPMessageBase <GSSPAutoDecodable>
{
    NSString *mResponseId;
    NSString *mXdrToken;
    long long mAckMode;
    BOOL mDefinedAckMode;
}
...
@property(readonly, nonatomic) BOOL definedAckMode; // @synthesize definedAckMode=mDefinedAckMode;
- (void).cxx_destruct;
- (id)description;
- (id)dspClassName;
...
- (BOOL)clearAckMode;
- (void)setAckMode:(long long)arg1;
- (long long)ackMode;
