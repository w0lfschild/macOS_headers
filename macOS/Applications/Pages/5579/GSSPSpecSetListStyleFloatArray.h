...
#import "GSSPSpecListStyleFloatArray.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPListStyleFloatArray;

@interface GSSPSpecSetListStyleFloatArray : GSSPSpecListStyleFloatArray <GSSPAutoDecodable>
{
    GSSPListStyleFloatArray *mListStyleFloatArray;
    BOOL mUnset;
}
...
- (BOOL)unset;
- (void)setListStyleFloatArray:(id)arg1;
- (id)listStyleFloatArray;
