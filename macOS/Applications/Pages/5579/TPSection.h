...
@class NSArray, NSString, TMAScriptDrawableContainerInfoHelper, TPGuideStorageMap, TPPageMaster, TPPageTemplate, TSWPStorage;

@interface TPSection : TSPObject <GSSPAutoEncodable, TMAScriptCommandExecutionResolving, TMAScriptingContainerInfo, TPPageContainerInfo, TSKDocumentObject, TSKModel, TSWPSection, TSWPSetObjectPropertiesCommandTarget>
{
