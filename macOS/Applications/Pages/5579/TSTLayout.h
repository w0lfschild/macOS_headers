...
@class NSMutableDictionary, NSString, TSTEditingState, TSTInfo, TSTLayoutHint, TSTLayoutSpaceBundle, TSTMasterLayout, TSTTableModel, TSWPLayout, TSWPPadding;

@interface TSTLayout : TSWPTextHostLayout <TSDKeyValueProxyVending, TSWPColumnMetrics, TSWPLayoutParent, TSWPStorageObserver>
{
...
- (struct CGRect)p_rectInRootForSelectionPath:(id)arg1 forZoom:(BOOL)arg2;
