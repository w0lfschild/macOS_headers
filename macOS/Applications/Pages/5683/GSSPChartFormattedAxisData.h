...
@interface GSSPChartFormattedAxisData : GSSPMessageBase
{
    TSCHChartAxisID *mAxisIdentifier;
    vector_95cc1646 mMajorGridlineLabelList;
    vector_5de1b41c mMultiDataList;
}
...
- (void)setMultiDataList:(const vector_5de1b41c *)arg1;
- (vector_5de1b41c *)multiDataList;
- (void)setMajorGridlineLabelList:(const vector_95cc1646 *)arg1;
- (vector_95cc1646 *)majorGridlineLabelList;
