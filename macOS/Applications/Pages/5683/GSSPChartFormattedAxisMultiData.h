...
@interface GSSPChartFormattedAxisMultiData : GSSPMessageBase
{
    vector_f77d9161 mSeriesDataList;
    vector_95cc1646 mReferenceLineValueLabelList;
}
...
- (void)setReferenceLineValueLabelList:(const vector_95cc1646 *)arg1;
- (vector_95cc1646 *)referenceLineValueLabelList;
- (void)setSeriesDataList:(const vector_f77d9161 *)arg1;
- (vector_f77d9161 *)seriesDataList;
