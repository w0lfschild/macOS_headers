...
@interface GSSPCmdBase : GSSPMessageBase <GSSPAutoDecodable>
{
    BOOL mHoldUntilGroupCommit;
    BOOL mShadowed;
    vector_95cc1646 mUndoDigestList;
}
...
- (void)setUndoDigestList:(const vector_95cc1646 *)arg1;
- (vector_95cc1646 *)undoDigestList;
- (void)setShadowed:(BOOL)arg1;
- (BOOL)shadowed;
- (void)setHoldUntilGroupCommit:(BOOL)arg1;
- (BOOL)holdUntilGroupCommit;
