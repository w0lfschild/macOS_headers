...
@interface GSSPCmdPropagatePresetChange : GSSPCmdBase <GSSPAutoDecodable>
{
    TSKCommand *mPresetChangeCommand;
...
- (void)setAlwaysPreserveAppearance:(BOOL)arg1;
- (BOOL)alwaysPreserveAppearance;
- (void)setPresetChangeCommand:(id)arg1;
- (id)presetChangeCommand;
