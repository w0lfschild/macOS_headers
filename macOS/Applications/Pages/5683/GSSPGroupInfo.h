...
@interface GSSPGroupInfo : GSSPDrawableInfo <GSSPAutoDecodable>
{
    vector_de27e5be mChildInfoList;
}
...
- (void)setChildInfoList:(const vector_de27e5be *)arg1;
- (vector_de27e5be *)childInfoList;
- (void)populateGroupInfo:(id)arg1 withDecodeContext:(struct GSSPDecodeConversionContext *)arg2;
- (id)convertTSDGroupInfoWithDecodeContext:(struct GSSPDecodeConversionContext *)arg1 error:(id *)arg2;
