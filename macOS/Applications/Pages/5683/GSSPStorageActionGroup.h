...
@interface GSSPStorageActionGroup : GSSPMessageBase
{
    int mKind;
    vector_e72ee21a mForwardActions;
}
...
- (void)setForwardActions:(const vector_e72ee21a *)arg1;
- (vector_e72ee21a *)forwardActions;
