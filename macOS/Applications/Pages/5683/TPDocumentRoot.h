...
@class EQKitEnvironment, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, TPBackgroundLayoutController, TPBookmarkController, TPDocumentSettings, TPDrawablesZOrder, TPFloatingDrawables, TPInteractiveCanvasController, TPPageController, TPPageLayoutNotifier, TPSection, TPStatisticsController, TPTOCController, TPTheme, TSDFreehandDrawingToolkitUIState, TSDThumbnailController, TSPData, TSPObject, TSSStylesheet, TSWPChangeSession, TSWPFlowInfoContainer, TSWPStorage;
