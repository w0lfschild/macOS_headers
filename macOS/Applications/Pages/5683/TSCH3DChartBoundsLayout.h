...
@property(readonly, nonatomic) CDStruct_6d1c4171 layoutSettings; // @synthesize layoutSettings=mLayoutSettings;
...
- (void)dealloc;
- (id)init;
- (id)initWithScene:(id)arg1 containingViewport:(const tvec2_3b141483 *)arg2 originalContainingViewport:(const tvec2_3b141483 *)arg3 layoutSettings:(const CDStruct_6d1c4171 *)arg4;
