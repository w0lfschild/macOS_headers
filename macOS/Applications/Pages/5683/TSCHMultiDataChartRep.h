...
- (id)p_createAnimatedLayersDictionaryWithScale:(double)arg1 forBuildStage:(unsigned long long)arg2 buildIn:(BOOL)arg3 duration:(double)arg4 returningAnimatedLayers:(id *)arg5 shouldDisplayLayersImmediately:(BOOL)arg6;
- (id)createAnimatedLayersDictionaryWithScale:(double)arg1 forBuildStage:(unsigned long long)arg2 buildIn:(BOOL)arg3 duration:(double)arg4 returningAnimatedLayers:(id *)arg5 shouldDisplayLayersImmediately:(BOOL)arg6;
...
- (id)p_createAnimationInfosArrayWithBuildStages:(id)arg1 returningAnimatedLayers:(id *)arg2 shouldDisplayLayersImmediately:(BOOL)arg3;
