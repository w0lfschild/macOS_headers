...
{
    vector_4dc5f307 _fromRowUIDList;
    vector_4dc5f307 _toRowUIDList;
    TSTTableSortOrder *_sortOrder;
    TSKCommand *_undoFormulaRewriteCommand;
}

@property(readonly, nonatomic) vector_4dc5f307 *toRowUIDList; // @synthesize toRowUIDList=_toRowUIDList;
@property(readonly, nonatomic) vector_4dc5f307 *fromRowUIDList; // @synthesize fromRowUIDList=_fromRowUIDList;
- (id).cxx_construct;
- (void).cxx_destruct;
- (id)p_mappingFromRows:(vector_4dc5f307)arg1 toRows:(vector_4dc5f307)arg2;
- (void)p_generateIdListsFromMapping:(id)arg1 fromList:(vector_4dc5f307 *)arg2 toList:(vector_4dc5f307 *)arg3;
...
- (void)dealloc;
- (id)initWithTableInfo:(id)arg1 fromRowUIDList:(vector_4dc5f307)arg2 toRowUIDList:(vector_4dc5f307)arg3;
