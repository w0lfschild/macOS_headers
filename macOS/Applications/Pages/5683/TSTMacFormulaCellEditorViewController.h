...
#import "TSTFormulaCellEditorPresenting-Protocol.h"

@class NSString, NSView, TSDInteractiveCanvasController, TSKScrollView, TSTDataCellEditor;

@interface TSTMacFormulaCellEditorViewController : TSTMacWPBasedCellEditorViewController <TSTFormulaCellEditorPresenting>
{
}
