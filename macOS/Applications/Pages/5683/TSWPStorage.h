...
@class NSArray, NSMutableString, NSObject, NSString, TSDDrawableInfo, TSDInfoGeometry, TSDReplaceableMediaMap, TSSStylesheet, TSTInfo, TSWPCharacterStyle, TSWPDocumentRoot, TSWPStorageBroadcaster;
@protocol TSDContainerInfo><TSWPStorageParent, TSDOwningAttachment;

@interface TSWPStorage : TSPObject <GSSPAutoEncodable, TSDReplaceableMediaContainer, TSDReducibleImageContainer, TSDCompatibilityAwareMediaContainer, TSDDrawableContainerInfo, TSKPencilAnnotationContainer, TSKSearchable, TSWPStorageParent, TSSStyleClient, TSWPTextSource, TSWPTextStatisticsTrackerProvider>
{
...
+ (BOOL)p_shouldIncludeAttributeName:(id)arg1;
+ (id)p_filteredNSAttributes:(id)arg1;
...
- (id)commandToSetStorageWritingDirection:(int)arg1;
...
- (struct _NSRange)insertSectionBreakAtCharIndex:(unsigned long long)arg1 replaceParagraphBreak:(BOOL)arg2 sectionToInsert:(id)arg3 changeSession:(id)arg4 dolcContext:(id)arg5 undoTransaction:(struct TSWPStorageTransaction *)arg6;
...
- (void)attributesAtCharIndex:(unsigned long long)arg1 attributesOfInterest:(char [21])arg2 attributesTable:(id [21])arg3 effectiveRange:(struct _NSRange *)arg4;
...
- (void)saveRange:(struct _NSRange)arg1 toArchiver:(id)arg2 styleProvider:(id)arg3 archiveChanges:(BOOL)arg4 removeDeletedText:(BOOL)arg5 archivePencilAnnotations:(BOOL)arg6;
...
@property(readonly, nonatomic) TSTInfo *tst_tableInfo;
- (id)tst_selectionForImplicitlyEditingWithFormatType:(int)arg1 percentSymbol:(id)arg2 currencySymbol:(id)arg3;
- (id)tst_selectionForImplicitlyEditingCellWithFormat:(id)arg1;
...
- (void *)cfRetainedNonUndoableFastCopyAttributeRecord:(struct TSWPAttributeRecord *)arg1 shouldAddRecord:(char *)arg2 attributeArrayKind:(int)arg3 atIndex:(unsigned long long)arg4 sourceStorage:(id)arg5 objectContext:(id)arg6 flags:(unsigned int)arg7 actionState:(struct TSWPStorageActionState *)arg8;
...
- (void)p_attributesAtCharIndex:(unsigned long long)arg1 attributesOfInterest:(char [21])arg2 attributesTable:(id [21])arg3 effectiveRange:(struct _NSRange *)arg4;
...
- (unsigned long long)p_rankOfNamedListStyle:(id)arg1 forPropertyMap:(id)arg2 initialLevels:(unsigned long long)arg3;
- (id)p_namedListStyleForPropertyMap:(id)arg1 initialLevels:(unsigned long long)arg2;
- (BOOL)firstLeadingTabWillBeMissingAtStartOfAttributedString;
- (void)fixInlineObjectGeometriesWithDrawableLayoutProviderBlock:(CDUnknownBlockType)arg1;
- (id)pNSTextListFromListLevelInfo:(id)arg1;
- (id)pListStyleFromNSAttributedStringListDescriptor:(id)arg1;
- (void)pMapListsFromAttributedString:(id)arg1 ontoStorageRange:(struct _NSRange)arg2 removedRanges:(id)arg3;
- (void)pMapAttachmentsFromAttributedString:(id)arg1 ontoStorageRange:(struct _NSRange)arg2 removedRanges:(id)arg3;
- (void)pMapHyperlinksFromAttributedString:(id)arg1 ontoStorageRange:(struct _NSRange)arg2 removedRanges:(id)arg3;
- (id)pDrawableInfoFromImporter:(id)arg1 error:(id *)arg2;
- (id)pPropertyMapFromNSParagraphStyle:(id)arg1 paragraphStyle:(id)arg2;
...
- (void)pMapAttributesFromAttributedString:(id)arg1 ontoStorageRange:(struct _NSRange)arg2 asCharacterStylesOnly:(BOOL)arg3 removedRanges:(id)arg4;
...
- (id)pExportAttributes:(unsigned long long)arg1 effectiveRange:(struct _NSRange *)arg2 stickyFont:(const struct __CTFont **)arg3 scale:(double)arg4;
- (id)pNSAttributedStringWithConversionDelegate:(id)arg1 ignoreLists:(BOOL)arg2 stripTextualAttachments:(BOOL)arg3 includeTextualEquivalents:(BOOL)arg4 stripGraphicalAttachments:(BOOL)arg5 stripInlineAttachments:(BOOL)arg6 attachmentReplacementString:(id)arg7 scale:(double)arg8 withLayoutParent:(id)arg9 footnoteMarkStringProvider:(CDUnknownBlockType)arg10;
- (id)pNSAttributedStringWithDefaultConversionDelegateIgnoreLists:(BOOL)arg1 stripTextualAttachments:(BOOL)arg2 includeTextualEquivalents:(BOOL)arg3 stripGraphicalAttachments:(BOOL)arg4 stripInlineAttachments:(BOOL)arg5 attachmentReplacementString:(id)arg6 scale:(double)arg7 withLayoutParent:(id)arg8;
- (struct _NSRange)replaceCharactersInRange:(struct _NSRange)arg1 withAttributedString:(id)arg2 outDeletionRangeMap:(id *)arg3;
- (id)initWithContext:(id)arg1 attributedString:(id)arg2 kind:(int)arg3 stylesheet:(id)arg4 paragraphStyle:(id)arg5 outDeletionRangeMap:(id *)arg6;
- (id)nsAttributedStringWithConversionDelegate:(id)arg1 ignoreLists:(BOOL)arg2 withLayoutParent:(id)arg3;
- (id)nsAttributedSubstringFromRange:(struct _NSRange)arg1 conversionDelegate:(id)arg2 ignoreLists:(BOOL)arg3 scale:(double)arg4 applyChanges:(BOOL)arg5 includeAttachments:(BOOL)arg6 includeTextualEquivalents:(BOOL)arg7 footnoteMarkProvider:(id)arg8 withLayoutParent:(id)arg9;
- (id)nsAttributedSubstringFromRange:(struct _NSRange)arg1 scale:(double)arg2 applyChanges:(BOOL)arg3 includeAttachments:(BOOL)arg4 includeTextualEquivalents:(BOOL)arg5 withLayoutParent:(id)arg6;
- (id)nsAttributedSubstringFromRange:(struct _NSRange)arg1 scale:(double)arg2 applyChanges:(BOOL)arg3 includeAttachments:(BOOL)arg4 withLayoutParent:(id)arg5;
...
- (id)plainTextStringFromRange:(struct _NSRange)arg1 convertTextualAttachments:(BOOL)arg2 includeChildTextStorages:(BOOL)arg3 forExport:(BOOL)arg4 withLayoutParent:(id)arg5 includeVisibleDeletions:(BOOL)arg6;
...
- (void)p_findCommentsInRange:(struct _NSRange)arg1 atStart:(BOOL)arg2 searchCanvasDelegate:(id)arg3 onHit:(CDUnknownBlockType)arg4;
...
- (void)findCommentsInRange:(struct _NSRange)arg1 atStart:(BOOL)arg2 onHit:(CDUnknownBlockType)arg3;
...
- (void)p_findChangesInRange:(struct _NSRange)arg1 atStart:(BOOL)arg2 searchCanvasDelegate:(id)arg3 onHit:(CDUnknownBlockType)arg4;
...
- (void)findChangesInRange:(struct _NSRange)arg1 atStart:(BOOL)arg2 onHit:(CDUnknownBlockType)arg3;
