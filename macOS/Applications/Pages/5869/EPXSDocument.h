...
@class EPXFootnote, EPXImageBinary, EPXJavaScript, EPXMetadata, EPXStylesheet, NSMutableArray, NSMutableDictionary, NSMutableSet;
...
@property(readonly, nonatomic) NSMutableArray *navPointsForFixedLayout; // @synthesize navPointsForFixedLayout=_navPointsForFixedLayout;
