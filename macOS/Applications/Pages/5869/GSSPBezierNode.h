...
@interface GSSPBezierNode : GSSPMessageBase <GSSPAutoDecodable>
{
    GSSPPoint *mInControlPoint;
    GSSPPoint *mNodePoint;
    GSSPPoint *mOutControlPoint;
    BOOL mIsSelected;
    int mType;
}
...
- (BOOL)isSelected;
- (void)setOutControlPoint:(id)arg1;
- (id)outControlPoint;
- (void)setNodePoint:(id)arg1;
- (id)nodePoint;
- (void)setInControlPoint:(id)arg1;
- (id)inControlPoint;
