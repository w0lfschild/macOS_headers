...
@interface GSSPCalculationEngineFormulaTranslationFlags : GSSPMessageBase
{
    BOOL mExcelImportTranslation;
    BOOL mNumberToDateCoercionRemovalTranslation;
    BOOL mContainsUidFormReferences;
    BOOL mContainsFrozenRefs;
}
...
- (void)setContainsFrozenRefs:(BOOL)arg1;
- (BOOL)containsFrozenRefs;
- (void)setContainsUidFormReferences:(BOOL)arg1;
- (BOOL)containsUidFormReferences;
- (void)setNumberToDateCoercionRemovalTranslation:(BOOL)arg1;
- (BOOL)numberToDateCoercionRemovalTranslation;
- (void)setExcelImportTranslation:(BOOL)arg1;
- (BOOL)excelImportTranslation;
