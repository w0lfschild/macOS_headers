...
@interface GSSPCitationSmartField : GSSPSmartField <GSSPAutoDecodable>
{
    BOOL mLocalizable;
    vector_4dfb6302 mCitationRecordList;
}
...
- (void)setCitationRecordList:(const vector_4dfb6302 *)arg1;
- (vector_4dfb6302 *)citationRecordList;
