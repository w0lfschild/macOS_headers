...
@interface GSSPCmdChangeDocumentLocale : GSSPCmdBase <GSSPAutoDecodable>
{
    NSString *mOldLocaleID;
    NSString *mNewLocaleID;
}
...
- (void)setNewLocaleID:(id)arg1;
- (id)newLocaleID;
- (void)setOldLocaleID:(id)arg1;
- (id)oldLocaleID;
