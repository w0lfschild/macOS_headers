...
@interface GSSPCmdContainedObjects : GSSPCmdBase <GSSPAutoDecodable>
{
    NSString *mTargetUUIDPath;
    long long mBehavior;
    NSArray *mArgsList;
    NSArray *mObjects;
    NSString *mContainerName;
    BOOL mDefinedContainerName;
}
...
@property(readonly, nonatomic) BOOL definedContainerName; // @synthesize definedContainerName=mDefinedContainerName;
- (void).cxx_destruct;
- (id)description;
- (id)dspClassName;
...
- (long long)behavior;
- (void)setTargetUUIDPath:(id)arg1;
- (id)targetUUIDPath;
