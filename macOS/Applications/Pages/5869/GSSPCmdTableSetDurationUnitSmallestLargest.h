...
@interface GSSPCmdTableSetDurationUnitSmallestLargest : GSSPCmdMutateCellFormat <GSSPAutoDecodable>
{
    int mSmallestUnit;
    int mLargestUnit;
}
...
- (void)setLargestUnit:(int)arg1;
- (int)largestUnit;
- (void)setSmallestUnit:(int)arg1;
- (int)smallestUnit;
