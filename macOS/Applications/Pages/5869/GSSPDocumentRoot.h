...
@interface GSSPDocumentRoot : GSSPPersistableObject
{
    NSString *mDocumentLocaleIdentifier;
    NSString *mDocumentLanguageIdentifier;
}
...
- (void)setDocumentLanguageIdentifier:(id)arg1;
- (id)documentLanguageIdentifier;
- (void)setDocumentLocaleIdentifier:(id)arg1;
- (id)documentLocaleIdentifier;
