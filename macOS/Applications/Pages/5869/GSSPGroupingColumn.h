...
@interface GSSPGroupingColumn : GSSPMessageBase <GSSPAutoDecodable>
{
    UUIDData_5fbc143e mGroupingColumnUid;
...
- (void)setGroupingColumnUid:(UUIDData_5fbc143e)arg1;
- (UUIDData_5fbc143e)groupingColumnUid;
