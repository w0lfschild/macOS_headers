...
@interface GSSPGroupingColumnList : GSSPMessageBase <GSSPAutoDecodable>
{
    vector_47bb12b6 mGroupingColumns;
}
...
- (void)setGroupingColumns:(const vector_47bb12b6 *)arg1;
- (vector_47bb12b6 *)groupingColumns;
