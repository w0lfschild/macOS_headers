...
#import "GSSPJavaUnitTestBaseMessage.h"

@interface GSSPJavaUnitTestMessageInDependentAPackage : GSSPJavaUnitTestBaseMessage
{
    GSSPJavaUnitTestBaseMessage *mCommonMessage;
    BOOL mDefinedCommonMessage;
}

+ (Class)realClass;
+ (void)registerRealGsspClass:(Class)arg1;
@property(readonly, nonatomic) BOOL definedCommonMessage; // @synthesize definedCommonMessage=mDefinedCommonMessage;
- (id)description;
- (id)dspClassName;
...
- (BOOL)clearCommonMessage;
- (void)setCommonMessage:(id)arg1;
- (id)commonMessage;
