...
#import "GSSPSpecListStyleListLabelTypeArray.h"

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPListStyleListLabelTypeArray;

@interface GSSPSpecSetListStyleListLabelTypeArray : GSSPSpecListStyleListLabelTypeArray <GSSPAutoDecodable>
{
    GSSPListStyleListLabelTypeArray *mListStyleListLabelTypeArray;
    BOOL mUnset;
}
...
- (BOOL)unset;
- (void)setListStyleListLabelTypeArray:(id)arg1;
- (id)listStyleListLabelTypeArray;
