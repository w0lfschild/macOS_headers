...
@interface GSSPSummaryCellVendor : GSSPMessageBase <GSSPAutoDecodable>
{
    NSArray *mWildcardCells;
    NSArray *mCategoryColumnCells;
}
...
- (void)setCategoryColumnCells:(id)arg1;
- (id)categoryColumnCells;
- (void)setWildcardCells:(id)arg1;
- (id)wildcardCells;
