...
@interface GSSPTablePencilAnnotationOwner : GSSPMessageBase
{
    vector_e696e3ca mFormulaList;
...
- (id)annotations;
- (void)setFormulaList:(const vector_e696e3ca *)arg1;
- (vector_e696e3ca *)formulaList;
