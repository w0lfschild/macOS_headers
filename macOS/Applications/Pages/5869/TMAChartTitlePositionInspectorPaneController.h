...
@interface TMAChartTitlePositionInspectorPaneController : TMAChartInspectorPaneController
{
...
+ (id)tabIdentifier;
+ (id)nibName;
@property(retain) NSPopUpButton *positionPopUpButton; // @synthesize positionPopUpButton=_positionPopUpButton;
