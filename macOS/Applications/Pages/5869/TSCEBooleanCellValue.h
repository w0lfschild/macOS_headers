...
@interface TSCEBooleanCellValue : TSCECellValue <GSSPAutoEncodable>
{
...
- (void)populateGSSPCEBooleanCellValue:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
