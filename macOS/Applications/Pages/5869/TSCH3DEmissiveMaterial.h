...
@interface TSCH3DEmissiveMaterial : TSCH3DTexturesMaterial <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPChart3dEmissiveMaterial:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
