...
@class NSMutableDictionary, NSString, TSDShapeInfo, TSDShapeLayout;
...
@interface TSDShapeRep : TSDStyledRep <TSDMagicMoveMatching, TSDShapeControlRep, TSDPathEditableRep, CALayerDelegate>
{
    ...
    BOOL _isCurrentlyBeingFreehandDrawn;
...
@property(nonatomic, setter=i_setIsCurrentlyBeingFreehandDrawn:) BOOL i_isCurrentlyBeingFreehandDrawn; // @synthesize i_isCurrentlyBeingFreehandDrawn=_isCurrentlyBeingFreehandDrawn;
...
- (void)p_forciblyRerenderShapeForDynamicOverrideClearingOldLayerContents:(BOOL)arg1;
- (void)i_dynamicOverrideParameterizationDidChange;
...
- (void)p_hitCacheSetCachedValue:(BOOL)arg1 forPoint:(struct CGPoint)arg2 withPrecision:(BOOL)arg3;
- (BOOL)p_hitCacheGetCachedValue:(char *)arg1 forPoint:(struct CGPoint)arg2 withPrecision:(BOOL)arg3;
...
- (struct CGSize)p_sizeForSurfaceOrImageFromLayerSize:(struct CGSize)arg1;
...
- (BOOL)p_shouldDrawIntoSurfaceOrImage;
...
- (struct CGRect)p_layerFrameInScaledCanvasForDirectlyManagedLayer:(BOOL)arg1;
