...
@interface TSRCWaveformSegment : NSObject <NSSecureCoding>
{
...
+ (id)emptySegmentWithTimeRange:(CDStruct_c3b9c2ee)arg1;
+ (void)initialize;
...
- (id)_segmentWithValuesInContainedTimeRange:(CDStruct_c3b9c2ee)arg1;
- (id)segmentByClippingToTimeRange:(CDStruct_c3b9c2ee)arg1;
...
- (id)copyWithAdjustedTimeRange:(CDStruct_c3b9c2ee)arg1;
...
- (id)initWithTimeRange:(CDStruct_c3b9c2ee)arg1 averagePowerLevelVector:(vector_7584168e *)arg2;
- (id)_initWithTimeRange:(CDStruct_c3b9c2ee)arg1 averagePowerLevelData:(id)arg2;
- (id)initWithTimeRange:(CDStruct_c3b9c2ee)arg1 averagePowerLevelData:(id)arg2;
