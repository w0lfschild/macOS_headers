...
- (id)p_standardCellContextMenuItemsAtPoint:(struct CGPoint)arg1;
- (id)p_groupValueCellContextMenuItemsAtPoint:(struct CGPoint)arg1;
- (void)p_updateTextForCategoryMenuItems:(id)arg1 selection:(id)arg2;
- (id)p_summaryLabelCellContextMenuItemsAtPoint:(struct CGPoint)arg1;
- (id)cellContextMenuItemsAtPoint:(struct CGPoint)arg1;
- (id)rowContextMenuItemsForRow:(unsigned int)arg1 inColumn:(unsigned short)arg2;
- (id)rowContextMenuItemsAtPoint:(struct CGPoint)arg1;
- (id)columnContextMenuItemsForColumn:(unsigned short)arg1;
...
- (BOOL)allowRowsToBeMoved:(id)arg1;
...
- (int)interactionTypeForCell:(struct TSUCellCoord)arg1;
