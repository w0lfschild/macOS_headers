...
@class TSTCellDiffMap, TSTGroupingColumnList;

@interface GSSPCmdCategoryMoveRows : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    TSTGroupingColumnList *mGroupingColumns;
    vector_4dc5f307 mCategoryRowOrder;
...
- (id)cellDiffMap;
- (void)setCategoryRowOrder:(const vector_4dc5f307 *)arg1;
- (vector_4dc5f307 *)categoryRowOrder;
