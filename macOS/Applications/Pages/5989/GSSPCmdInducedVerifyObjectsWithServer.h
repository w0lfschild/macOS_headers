...
@interface GSSPCmdInducedVerifyObjectsWithServer : GSSPCmdBase <GSSPAutoDecodable>
{
    NSArray *mObjectIdList;
    NSArray *mServerObjectSOSStringList;
    BOOL mPendingRecalc;
    double mRemoteDataSyncKey;
}
...
- (void)setPendingRecalc:(BOOL)arg1;
- (BOOL)pendingRecalc;
- (void)setServerObjectSOSStringList:(id)arg1;
- (id)serverObjectSOSStringList;
- (void)setObjectIdList:(id)arg1;
- (id)objectIdList;
