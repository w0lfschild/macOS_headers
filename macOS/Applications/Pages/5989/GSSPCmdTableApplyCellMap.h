...
@interface GSSPCmdTableApplyCellMap : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    TSTCellMap *mCellMap;
    BOOL mIsFromPaste;
    BOOL mAsInducedCommand;
    BOOL mDefinedAsInducedCommand;
}
...
@property(readonly, nonatomic) BOOL definedAsInducedCommand; // @synthesize definedAsInducedCommand=mDefinedAsInducedCommand;
- (void).cxx_destruct;
- (id)description;
- (id)dspClassName;
...
- (BOOL)clearAsInducedCommand;
- (void)setAsInducedCommand:(BOOL)arg1;
- (BOOL)asInducedCommand;
- (void)setIsFromPaste:(BOOL)arg1;
- (BOOL)isFromPaste;
