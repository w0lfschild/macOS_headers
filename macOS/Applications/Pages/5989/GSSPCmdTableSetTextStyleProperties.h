...
@interface GSSPCmdTableSetTextStyleProperties : GSSPCmdTableBaseWithTableInfoId <GSSPAutoDecodable>
{
    TSTCellDiffMap *mCellDiffMap;
    NSArray *mCellWasRichTextAtFirstCommit;
}
...
- (void)setCellWasRichTextAtFirstCommit:(id)arg1;
- (id)cellWasRichTextAtFirstCommit;
