...
#import "GSSPRemoveIdOperationArgs.h"

#import "GSSPAutoDecodable-Protocol.h"

@interface GSSPConstrainedRemoveIdOperationArgs : GSSPRemoveIdOperationArgs <GSSPAutoDecodable>
{
    int mObjectCount;
...
- (void)setObjectCounterSpace:(int)arg1;
