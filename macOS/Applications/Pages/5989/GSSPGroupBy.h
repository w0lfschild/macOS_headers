...
@class NSArray, TSTGroupNode;

@interface GSSPGroupBy : GSSPMessageBase <GSSPAutoDecodable>
{
    UUIDData_5fbc143e mGroupByUid;
    BOOL mIsEnabled;
    NSArray *mGroupingColumns;
    NSArray *mColumnAggregates;
    TSTGroupNode *mGroupRoot;
}
