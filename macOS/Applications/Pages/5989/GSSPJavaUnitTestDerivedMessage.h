...
@interface GSSPJavaUnitTestDerivedMessage : GSSPJavaUnitTestBaseMessage
{
    int mRequired1;
    int mOptional1;
    BOOL mDefinedOptional1;
}

+ (Class)realClass;
+ (void)registerRealGsspClass:(Class)arg1;
@property(readonly, nonatomic) BOOL definedOptional1; // @synthesize definedOptional1=mDefinedOptional1;
- (id)description;
- (id)dspClassName;
...
- (BOOL)clearOptional1;
- (void)setOptional1:(int)arg1;
- (int)optional1;
- (void)setRequired1:(int)arg1;
- (int)required1;
