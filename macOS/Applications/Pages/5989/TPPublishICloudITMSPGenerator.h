...
@class NSArray, NSError, NSMutableArray, NSOperationQueue, NSString, NSURL, TPPublishSessionAuthenticator;
...
- (id)embeddableFontURLsInDocument;
- (id)embeddableFontURL:(id)arg1;
