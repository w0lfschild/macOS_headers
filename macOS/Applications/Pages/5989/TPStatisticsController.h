...
@class NSMutableSet, NSString, TPDocumentRoot, TPDocumentStatistics, TPInteractiveCanvasController, TSUDelayTimer, TSUNoCopyDictionary, TSWPStorage;
...
@property(retain, nonatomic) TSWPStorage *observedStorage; // @synthesize observedStorage=_observedStorage;
