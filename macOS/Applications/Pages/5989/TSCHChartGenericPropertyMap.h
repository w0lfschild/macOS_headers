...
@interface TSCHChartGenericPropertyMap : TSSPropertyMap <GSSPAutoEncodable>
{
}
...
- (void)populateGSSPChartGenericPropertyMap:(id)arg1 withEncodeContext:(struct GSSPEncodeConversionContext *)arg2;
