...
@class NSError, NSHashTable, NSMutableArray, TSRCExtAudioFilePipe;
@protocol OS_dispatch_queue, OS_dispatch_semaphore;

@interface TSRCWaveformGenerator : NSObject
{
    long long _state;
    ...
    TSRCExtAudioFilePipe *_activeExtAudioFile;
...
- (id)synchronouslyApproximateWaveformForAVContentURL:(id)arg1 byReadingCurrentFileAheadTimeRange:(CDStruct_c3b9c2ee)arg2;
- (void)_onQueue_appendAveragePowerLevelsByDigestingTimeRange:(CDStruct_c3b9c2ee)arg1 inExtAudioFile:(id)arg2 sourceFormat:(struct AudioStreamBasicDescription *)arg3 outputFormat:(struct AudioStreamBasicDescription *)arg4;
- (void)_appendAveragePowerLevelsByDigestingTimeRange:(CDStruct_c3b9c2ee)arg1 inExtAudioFile:(id)arg2 sourceFormat:(struct AudioStreamBasicDescription *)arg3 outputFormat:(struct AudioStreamBasicDescription *)arg4;
