...
- (void)p_applyDiffsInArrayItem:(id)arg1 localHelper:(id)arg2 remoteHelper:(id)arg3 undoDiffMap:(id)arg4 isCatWildCard:(BOOL)arg5;
- (id)p_presetArrayItemForCell:(id)arg1 cellID:(struct TSUCellCoord)arg2 cellUID:(struct TSTCellUID)arg3 tableStyleArea:(unsigned long long)arg4 sourceCellDiff:(id)arg5;
