...
#import "TSWPRepCaretControllerDelegate-Protocol.h"

@class CALayer, CAShapeLayer, NSArray, NSString, TSDLayout, TSDNoDefaultImplicitActionLayer, TSKHighlightArrayController, TSKPulseAnimationController, TSUColor, TSWPRangeArray, TSWPRepCaretController, TSWPSearchReference, TSWPSelection, TSWPStorage, TSWPStorageSpellChecker, TSWPTextEditor;
@protocol TSDAnnotation, TSWPLayoutTarget;

@interface TSWPRep : TSDContainerRep <CAAnimationDelegate, TSWPRepCaretControllerDelegate, TSKHighlightArrayControllerProtocol, TSKPulseAnimationControllerProtocol, TSWPHyperlinkHostRepProtocol, CALayerDelegate>
{
    ...
    TSWPRangeArray *_misspelledRanges;
    TSWPRangeArray *_ungrammaticRanges;
    ...
    TSWPRepCaretController *_caretController;
    BOOL _findIsShowing;
    BOOL _usesStandardHighlightColorForReplaceSelections;
    ...
    NSArray *_pencilOverlayLayersCache;
    struct CGPoint _dragAndDropNaturalPoint;
}

+ (void)p_useAppearance:(id)arg1 inBlock:(CDUnknownBlockType)arg2;
+ (void)p_systemColorsChanged:(id)arg1;
+ (void)initialize;
+ (id)unfocusedHighlightColorForDarkMode:(BOOL)arg1;
+ (id)focusedHighlightColorForDarkMode:(BOOL)arg1;
@property(retain, nonatomic) NSArray *pencilOverlayLayersCache; // @synthesize pencilOverlayLayersCache=_pencilOverlayLayersCache;
...
@property(nonatomic) __weak TSWPSelection *dropSelection; // @synthesize dropSelection=_dropSelection;
...
@property(nonatomic) BOOL usesStandardHighlightColorForReplaceSelections; // @synthesize usesStandardHighlightColorForReplaceSelections=_usesStandardHighlightColorForReplaceSelections;
...
- (id)currentAnnotationAtPoint:(struct CGPoint)arg1;
...
- (void)i_setSearchReferencesToHighlight:(id)arg1;
- (void)p_setPrimaryFindResultSearchReference:(id)arg1;
- (void)i_primaryFindResultChanged:(id)arg1;
...
- (void)p_spellcheckFinished:(id)arg1;
...
- (void)p_destroyLayer:(long long)arg1;
- (void)p_createLayer:(long long)arg1;
...
- (void)i_renderingOptionsDidChange;
- (void)i_spellCheckerLanguageDidChange;
...
@property(readonly, nonatomic) BOOL selectionChangeWasLocal;
...
- (id)pencilOverlayLayers;
- (struct _NSRange)p_rangeForPencilAnnotations;
...
- (struct CGPath *)p_newPathForSelection:(id)arg1 withTransform:(struct CGAffineTransform)arg2 withInset:(double)arg3;
