...
+ (void)mapReflowableGroupLeavesAsIndividualObjects:(id)arg1 toTextContainer:(id)arg2 state:(id)arg3;
...
+ (void)mapReflowableDrawable:(id)arg1 toTextContainer:(id)arg2 geometryAdjustBlock:(CDUnknownBlockType)arg3 state:(id)arg4;
+ (void)writeDrawableExportInfo:(id)arg1 toTextContainer:(id)arg2 containedIn:(struct CGSize)arg3 state:(id)arg4;
+ (id)accessibilityDescriptionForDrawable:(id)arg1;
+ (void)toDescriptionComponents:(id)arg1 appendComponent:(id)arg2;
+ (void)setMaxLineWidthForDrawableProperties:(id)arg1 orientation:(CDStruct_b560da7d)arg2;
...
+ (id)propertiesForGeometry:(id)arg1 containedIn:(struct CGSize)arg2 orientation:(CDStruct_b560da7d)arg3 state:(id)arg4;
+ (id)propertiesForPosition:(CDStruct_6a34ea72)arg1 measureFromRight:(BOOL)arg2 positionAsMargins:(BOOL)arg3 cssPosition:(id)arg4 state:(id)arg5;
+ (id)propertiesForPosition:(CDStruct_6a34ea72)arg1 measureFromRight:(BOOL)arg2 cssPosition:(id)arg3 state:(id)arg4;
+ (id)propertiesForPosition:(CDStruct_6a34ea72)arg1 measureFromRight:(BOOL)arg2 state:(id)arg3;
...
+ (id)propertiesForSize:(CDStruct_c3b9c2ee)arg1 orientation:(CDStruct_b560da7d)arg2 state:(id)arg3;
...
+ (void)mapFill:(id)arg1 rect:(CDStruct_e0f0dd31)arg2 toTextContainer:(id)arg3 state:(id)arg4;
+ (void)mapStroke:(id)arg1 rect:(CDStruct_e0f0dd31)arg2 toTextContainer:(id)arg3 state:(id)arg4;
+ (void)addImage:(id)arg1 withRect:(CDStruct_e0f0dd31)arg2 toTextContainer:(id)arg3 state:(id)arg4;
+ (id)imageDataForStroke:(id)arg1 rect:(CDStruct_e0f0dd31)arg2 returnClipRect:(CDStruct_e0f0dd31 *)arg3 state:(id)arg4;
...
+ (void)reportExportIssuesWithDrawableInfo:(id)arg1;
