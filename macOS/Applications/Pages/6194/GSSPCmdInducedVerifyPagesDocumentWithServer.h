...
@interface GSSPCmdInducedVerifyPagesDocumentWithServer : GSSPCmdBase <GSSPAutoDecodable>
{
    NSArray *mDrawablesZOrderList;
}
...
- (void)setDrawablesZOrderList:(id)arg1;
- (id)drawablesZOrderList;
