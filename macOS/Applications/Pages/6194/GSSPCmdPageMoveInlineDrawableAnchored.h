...
#import <TSText/GSSPCmdTextStorageAction.h>

#import "GSSPAutoDecodable-Protocol.h"

@class GSSPRange, NSString, TSDExteriorTextWrap, TSKIdPlacementOperationArgs;

@interface GSSPCmdPageMoveInlineDrawableAnchored : GSSPCmdTextStorageAction <GSSPAutoDecodable>
{
    TSKIdPlacementOperationArgs *mIdPlacementOperationArgs;
    GSSPRange *mReplacementRange;
...
- (id)replacementRange;
- (void)setIdPlacementOperationArgs:(id)arg1;
- (id)idPlacementOperationArgs;
