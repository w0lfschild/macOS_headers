...
#import <TSDrawables/GSSPCmdAbstractGuide.h>

#import "GSSPAutoDecodable-Protocol.h"

@class NSString;

@interface GSSPCmdSectionGuide : GSSPCmdAbstractGuide <GSSPAutoDecodable>
{
    NSString *mSectionIdPath;
    int mPageIndex;
}
