...
@interface GSSPGuideStorageMap : GSSPMessageBase
{
    vector_d98f2e62 mUserDefinedGuideStorageList;
}
...
- (void)setUserDefinedGuideStorageList:(const vector_d98f2e62 *)arg1;
- (vector_d98f2e62 *)userDefinedGuideStorageList;
