...
@class EQKitEnvironment, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, TPBackgroundPaginationController, TPBookmarkController, TPDocumentSettings, TPDrawablesZOrder, TPFloatingDrawables, TPInteractiveCanvasController, TPPageController, TPPageLayoutNotifier, TPRemoveDrawablesCommandProvider, TPSection, TPStorageLayoutIndexer, TPTOCController, TPTheme, TPUIState, TSDThumbnailController, TSPData, TSSStylesheet, TSWPChangeSession, TSWPFlowInfoContainer, TSWPStorage;
...
- (CDStruct_b560da7d)epe_orientation;
