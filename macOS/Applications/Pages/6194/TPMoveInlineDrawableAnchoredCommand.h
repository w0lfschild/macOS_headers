...
-     // Error parsing type: v32@0:8r^{MoveInlineDrawableAnchoredCommandArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{StorageActionCommandArchive}^{IdPlacementOperationArgs}^{UUIDPath}^{ExteriorTextWrapArchive}^{ExteriorTextWrapArchive}II}16@24, name: loadFromArchive:unarchiver:
- (void)saveToArchiver:(id)arg1;
-     // Error parsing type: v32@0:8^{MoveInlineDrawableAnchoredCommandArchive=^^?{InternalMetadataWithArena=^v}{HasBits<1>=[1I]}{CachedSize={atomic<int>=Ai}}^{StorageActionCommandArchive}^{IdPlacementOperationArgs}^{UUIDPath}^{ExteriorTextWrapArchive}^{ExteriorTextWrapArchive}II}16@24, name: saveToArchive:archiver:
- (int)persistenceKind;
