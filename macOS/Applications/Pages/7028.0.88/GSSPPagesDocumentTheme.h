...
#import <TSApplication/GSSPDocumentTheme.h>

@class NSString;

@interface GSSPPagesDocumentTheme : GSSPDocumentTheme
{
    NSString *mBodyStyleName;
    NSString *mHeaderAndFooterStyleName;
    NSString *mFootnoteStyleName;
    BOOL mIsBookPortraitTemplateTheme;
}
...
- (void)setIsBookPortraitTemplateTheme:(BOOL)arg1;
- (BOOL)isBookPortraitTemplateTheme;
- (void)setFootnoteStyleName:(id)arg1;
- (id)footnoteStyleName;
- (void)setHeaderAndFooterStyleName:(id)arg1;
- (id)headerAndFooterStyleName;
- (void)setBodyStyleName:(id)arg1;
- (id)bodyStyleName;
