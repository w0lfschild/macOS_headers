...
@interface GSSPPagesPasteboardAppNativeObject : GSSPPasteboardAppNativeObject
{
    vector_4dd96dbd mFlowInfoList;
}
...
- (void)setFlowInfoList:(const vector_4dd96dbd *)arg1;
- (vector_4dd96dbd *)flowInfoList;
