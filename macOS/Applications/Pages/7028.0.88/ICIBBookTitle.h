...
@interface ICIBBookTitle : NSObject <ICIBSidecarPageFileWriter>
{
    NSArray *_pageDrawables;
    struct CGSize _pageSize;
}

+ (void)map:(id)arg1 state:(id)arg2;
- (void).cxx_destruct;
@property(retain, nonatomic) NSArray *pageDrawables; // @synthesize pageDrawables=_pageDrawables;
@property(nonatomic) struct CGSize pageSize; // @synthesize pageSize=_pageSize;
- (id)ibaSidecarFileName;
