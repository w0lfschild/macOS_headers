...
@class NSMutableArray, NSSet, NSString, TPFootnoteOptionsPropertyVendor, TPInteractiveCanvasController, TSDEditorController, TSDFill, TSDStroke, TSKDocumentRoot, TSUColor, TSWPCharacterSelectionProxy, TSWPParagraphSelectionProxy, TSWPTextEditor;
...
- (id)currentListStyleForInspector:(id)arg1;
...
@property(copy, nonatomic) TSUColor *paragraphFill;
@property(copy, nonatomic) TSUColor *textBackground;
