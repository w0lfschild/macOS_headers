...
@class CXNamespace, NSMutableArray, NSMutableDictionary, NSNumber, OAXDrawingState, OCPPackagePart, TSUNoCopyDictionary, WDCharacterRun, WDDocument, WXOAVReadState;
...
- (id)readSymbolTo;
- (id)drawingState;
- (void)clearPendingRtl;
- (id)pendingRtl;
- (void)setPendingRtl:(BOOL)arg1;
