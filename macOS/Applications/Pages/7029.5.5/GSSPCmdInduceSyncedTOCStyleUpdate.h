...
@interface GSSPCmdInduceSyncedTOCStyleUpdate : GSSPCmdBase <GSSPAutoDecodable>
{
    TSWPParagraphStyle *mPreset;
    BOOL mShouldShowInTOC;
}
...
- (void)setShouldShowInTOC:(BOOL)arg1;
- (BOOL)shouldShowInTOC;
