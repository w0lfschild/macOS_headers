...
- (void)layoutSearchForMisspelledWordWithHitBlock:(CDUnknownBlockType)arg1;
- (void)layoutSearchForHyperlinkWithHitBlock:(CDUnknownBlockType)arg1;
- (void)layoutSearchForPencilAnnotationWithHitBlock:(CDUnknownBlockType)arg1;
