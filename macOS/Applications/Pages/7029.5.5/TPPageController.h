...
#import "TPBackgroundPaginationControllerDelegate-Protocol.h"
#import "TPPageLayoutInfoProvider-Protocol.h"
#import "TSKChangeSourceObserver-Protocol.h"
#import "TSWPLayoutOwner-Protocol.h"

@class NSArray, NSMutableArray, NSString, TPDocumentRoot, TPFootnoteLayoutController, TPPageControllerCanvasDelegate, TPTextFlowLayoutController, TPTextWrapController, TSUMutablePointerSet, TSWPLayoutManager, TSWPLayoutMetricsCache, _TtC5Pages17TPPageLayoutCache, _TtC5Pages17TPPaginationState;
@protocol TPPageControllerDelegate, TPPageControllerObserver;

@interface TPPageController : NSObject <TPPageLayoutInfoProvider, TSKChangeSourceObserver, TPBackgroundPaginationControllerDelegate, TSWPLayoutOwner>
{
    // Error parsing type: Ai, name: _isScrolling
    // Error parsing type: Ai, name: _isZooming
    BOOL _isObservingNotifications;
    _TtC5Pages17TPPageLayoutCache *_pageLayoutCache;
    _TtC5Pages17TPPaginationState *_paginationState;
    _TtC5Pages17TPPaginationState *_cachedPaginationState;
    ...
    BOOL _documentLevelChangeInFlight;
    BOOL _isPaginating;
...
- (void)p_endDocumentLevelChange;
- (void)p_beginDocumentLevelChange;
...
- (void)p_processHeaderFooterPropertyChanged;
...
- (id)p_pageIndicesForInfo:(id)arg1 onPageMaster:(id)arg2 pageInfos:(inout id)arg3;
...
- (struct _NSRange)sectionPageRangeForPageIndex:(unsigned long long)arg1 forcePagination:(BOOL)arg2 outEndIsValid:(char *)arg3;
...
- (struct _NSRange)p_pageRangeForSelection:(id)arg1 includingEmptyPages:(BOOL)arg2 outEndIsValid:(char *)arg3 forcePagination:(BOOL)arg4;
