...
@class NSArray, NSString, NSURL, NSUUID, TMAScriptDrawableContainerInfoHelper, TPGuideStorageMap, TPPageMaster, TPPageTemplate, TSDFill, TSDReplaceableMediaMap, TSWPStorage;

@interface TPSection : TSPObject <GSSPAutoEncodable, TMAScriptCommandExecutionResolving, TMAScriptingContainerInfo, TPPageContainerInfo, TSDKeyValueProxyVending, TSDReplaceableMediaContainer, TSKDocumentObject, TSKModel, TSWPSection, TSWPSetObjectPropertiesCommandTarget>
{
