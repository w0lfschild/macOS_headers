...
@class NSDictionary, NSError, NSSet, NSString, NSURL, NSUUID, TSPData, TSPDocumentLoadValidationPolicy, TSPDocumentSaveValidationPolicy, TSPObjectContext, TSPObjectReferenceMap;
