...
+ (BOOL)mapSectionDrawableAsBackgroundFill:(id)arg1 documentState:(id)arg2;
...
+ (void)performReplacementsForImportInOfficeArt:(id)arg1;
+ (void)performReplacementsForImportInGroup:(id)arg1;
+ (id)movieWrappedInsideShape:(id)arg1;
