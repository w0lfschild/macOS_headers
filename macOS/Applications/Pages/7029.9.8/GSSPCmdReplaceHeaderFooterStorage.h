...
@interface GSSPCmdReplaceHeaderFooterStorage : GSSPCmdBase <GSSPAutoDecodable>
{
    NSString *mHeaderFooterStorageIdPath;
    TSWPStorage *mReplacementHeaderFooterStorage;
}
...
- (void)setReplacementHeaderFooterStorage:(id)arg1;
- (id)replacementHeaderFooterStorage;
- (void)setHeaderFooterStorageIdPath:(id)arg1;
- (id)headerFooterStorageIdPath;
