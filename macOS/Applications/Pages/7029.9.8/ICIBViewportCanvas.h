...
@class GQDIBAViewportCanvasInfo, NSString;

@interface ICIBViewportCanvas : NSObject <ICIBSidecarPageFileWriter>
{
    GQDIBAViewportCanvasInfo *_qdViewportCanvasInfo;
}

+ (void)map:(id)arg1 state:(id)arg2;
- (void).cxx_destruct;
@property(retain, nonatomic) GQDIBAViewportCanvasInfo *qdViewportCanvasInfo; // @synthesize qdViewportCanvasInfo=_qdViewportCanvasInfo;
...
- (void)handleConnectionsInFrame:(id)arg1 ibaState:(id)arg2;
