...
@class NSData, NSMutableArray, OADBlipCollection, OADGraphicStyleCache, OADTableStyleCollection, OADTextListStyle, OADTheme, OCDReader, OCDSummary, OCDWriter, TSUPointerKeyDictionary;
...
@interface OCDDocument : NSObject
{
    ...
    TSUPointerKeyDictionary *mDualDrawableMap;
...
@property(readonly, nonatomic) TSUPointerKeyDictionary *dualDrawableMap; // @synthesize dualDrawableMap=mDualDrawableMap;
...
- (BOOL)textCanWrapInsideAutosizedShape:(BOOL)arg1;
