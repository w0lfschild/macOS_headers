...
@class NSArray, NSCache, NSDictionary, NSScrollView, NSString, NSTableView, NSView, TPDocumentRoot, TPInteractiveCanvasController, TSAActivityLineDecorator, TSAAnnotationController, TSAMacChangeTrackingView, TSAMacCommentThreadView, TSAMacHighlightView;
@protocol TPAnnotationHeaderViewCapable;
...
@interface TPAnnotationSidebarController : NSViewController <TSAMacChangeTrackingViewDelegate, TSAMacCommentThreadViewDelegate, TSAMacHighlightViewDelegate, TPAnnotationSidebarTableViewDelegate, NSTableViewDataSource, TSAAnnotationControllerDataObserver>
{
    ...
    NSArray *_groups;
    NSView<TPAnnotationHeaderViewCapable> *_headerView;
...
@property(retain, nonatomic) NSView<TPAnnotationHeaderViewCapable> *headerView; // @synthesize headerView=_headerView;
...
@property(nonatomic) BOOL currentlyResizing; // @synthesize currentlyResizing=_currentlyResizing;
