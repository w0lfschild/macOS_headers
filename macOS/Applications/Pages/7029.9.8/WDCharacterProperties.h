...
- (BOOL)isTextFillOverridden;
- (void)setTextFill:(id)arg1;
- (id)textFill;
- (BOOL)isTextOutlineOverridden;
- (void)setTextOutline:(id)arg1;
- (id)textOutline;
...
- (BOOL)isHorizontalInVerticalGroupIdOverridden;
- (void)setHorizontalInVerticalGroupId:(long long)arg1;
- (long long)horizontalInVerticalGroupId;
