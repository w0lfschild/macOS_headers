...
@class NSButton, NSLayoutConstraint, NSSegmentedControl, NSString, NSVisualEffectView, PBCountdownView, PBEmbossedTextField, PBFullscreenBorderView, PBProfileController, PBRecordingTimerView, PBShutterButton, PBTabViewWithGradientBackground, PBTextureView, PBTransitionWindow, PBTrayView, PBView, QLAnimationWindowEffect;

@interface PBMainWindow : NSWindow <NSSharingServiceDelegate, NSSharingServicePickerDelegate>
{
    PBView *videoView;
    ...
    NSSegmentedControl *recordingSwitcher;
    NSSegmentedControl *recordingSwitcherInStillTab;
    ...
    NSLayoutConstraint *restrictWindowWidthConstraint;
    NSLayoutConstraint *restrictWindowHeightConstraint;
...
- (void)_enablePillarAndLetterboxing:(BOOL)arg1;
