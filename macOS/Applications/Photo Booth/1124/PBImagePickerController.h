...
@class NSButton, PBCountdownView, PBEffectsButtonController, PBMainWindow, PBTabViewWithGradientBackground, PBTrayView, PBView;
...
@interface PBImagePickerController : NSObject
{
    ...
    PBEffectsButtonController *ibEffectsButtonController;
