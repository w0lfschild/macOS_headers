...
@class BuddyPictureHelper, NSArray, NSButton, NSMenuItem, NSString, NSURL, NSXPCConnection, PBAnimationController, PBImagePickerController, PBLibraryChooserController, PBMigrationController, PBPhotoController, PBPowerSaverManager, PBQTMovieController, PBRecordingRadioButton, PBShutterButton, PBTabViewWithGradientBackground, PBTrayView, PBView, SOAccountStatusHelper;
...
@property(readonly) BuddyPictureHelper *buddyPictureHelper; // @synthesize buddyPictureHelper=_buddyPictureHelper;
@property(readonly) SOAccountStatusHelper *accountStatusHelper; // @synthesize accountStatusHelper=_accountStatusHelper;
