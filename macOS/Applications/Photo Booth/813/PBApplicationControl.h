...
@class BuddyPictureHelper, NSArray, NSButton, NSMenuItem, NSString, NSURL, PBAnimationController, PBImagePickerController, PBLibraryChooserController, PBMigrationController, PBPhotoController, PBPowerSaverManager, PBQTMovieController, PBRecordingRadioButton, PBShutterButton, PBTabViewWithGradientBackground, PBTrayView, PBView, SOAccountStatusHelper;
