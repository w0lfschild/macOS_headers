...
@interface IPXAssetsViewController : IPXViewController <IPXAssetsViewTestElement, MOAssetsViewDataSource, MOAssetsViewDelegate, IPXLiveUpdateControllerDelegate, IPXAssetTransitioning>
{
