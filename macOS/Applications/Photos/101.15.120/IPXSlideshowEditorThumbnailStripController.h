...
@class IPXSelectionContainer, IPXSlideshow, IPXSlideshowEditorController, IPXSlideshowEditorThumbnailStripLayout, IPXSlideshowEditorThumbnailStripView, NSArray, NSMutableDictionary, NSString;

__attribute__((visibility("hidden")))
@interface IPXSlideshowEditorThumbnailStripController : IPXBrowserController <IPXSlideshowEditorThumbnailStripViewDelegate, IPXObjectsControllerChangeReceiver, MOMediaViewDataSource, IPXSelectionContainerProvider>
{
    ...
    NSMutableDictionary *_mediaItemsForAssets;
