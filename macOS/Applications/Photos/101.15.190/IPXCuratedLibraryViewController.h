...
@class IPXBrowserControllerBarsHelper, IPXFilePromiseHelper, IPXPhotosGridSliderController, IPXSelectionContainer, IPXWorkspaceController, IPXZoomButtonItem, NSArray, NSDictionary, NSScrollView, NSString, NSTouchBar, NSTrackingArea, NSView, PXCuratedLibraryViewProvider, PXGViewMouseSession, UXBarButtonItem, UXNavigationController;
@protocol PXBrowserSelectionSnapshot;

__attribute__((visibility("hidden")))
@interface IPXCuratedLibraryViewController : IPXViewController <IPXLibraryTestElement, IPXSelectionContainerProvider, IPXAssetTransitioning, IPXBrowserControllerBarsHelperDataSource, IPXPhotosGridSliderController, IPXWorkspaceMenuItemEnableProtocol, PXCuratedLibraryActionPerformerDelegate, PXCuratedLibraryFooterControllerDelegate, PXGViewMouseSessionDelegate, PXGViewSource, PXScrollViewControllerObserver, PXChangeObserver, PXGViewAccessibilityDelegate, NSMenuDelegate, NSTouchBarProvider, NSDraggingDestination>
{
