...
+ (void)forItems:(id)arg1 areValuesCommon:(char *)arg2 areValuesNil:(char *)arg3 propertyReader:(CDUnknownBlockType)arg4;
...
@property(nonatomic) __weak IPXMetadataInfoPopoverController *metadataController; // @synthesize metadataController=_metadataController;
- (void).cxx_destruct;
