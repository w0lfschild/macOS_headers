...
@class IPXBrowserControllerBarsHelper, IPXContentFilterController, IPXFilePromiseHelper, IPXPhotosGridSliderController, IPXSelectionContainer, IPXWorkspaceController, IPXZoomButtonItem, NSArray, NSDictionary, NSScrollView, NSString, NSTouchBar, NSTrackingArea, NSView, PXCPLServiceUI, PXCuratedLibraryViewProvider, PXGViewMouseSession, UXBarButtonItem, UXNavigationController;
@protocol PXBrowserSelectionSnapshot;

__attribute__((visibility("hidden")))
@interface IPXCuratedLibraryViewController : IPXViewController <IPXLibraryTestElement, IPXSelectionContainerProvider, IPXAssetTransitioning, IPXBrowserControllerBarsHelperDataSource, IPXPhotosGridSliderController, IPXWorkspaceMenuItemEnableProtocol, PXCuratedLibraryActionPerformerDelegate, IPXContentFilterControllerDelegate, IPXContentFilterMenuStatus, PXCuratedLibraryFooterControllerDelegate, PXGViewMouseSessionDelegate, PXGViewSource, PXScrollViewControllerObserver, PXChangeObserver, PXGViewAccessibilityDelegate, PXCPLServiceUIDelegate, NSMenuDelegate, NSTouchBarProvider, NSDraggingDestination>
{
...
- (void)_updateAccessibilitySelection;
- (void)_handleZoomLevelTransitionPhaseChanged;
- (void)_selectInitialItemForMove:(SEL)arg1;
- (struct PXSimpleIndexPath)_initialSectionIndexPathForDirection:(unsigned long long)arg1;
- (struct PXSimpleIndexPath)_initialItemIndexPathForDirection:(unsigned long long)arg1;
- (struct PXSimpleIndexPath)_startingIndexPathForMove:(SEL)arg1;
- (unsigned long long)_targetDirectionForMove:(SEL)arg1;
- (void)_extendSelectionFromIndexPath:(struct PXSimpleIndexPath)arg1 inDirection:(unsigned long long)arg2;
- (void)_moveSelectionFromIndexPath:(struct PXSimpleIndexPath)arg1 inDirection:(unsigned long long)arg2;
...
- (void)photosGridSliderController:(id)arg1 didChangeContinousValue:(double)arg2 finished:(BOOL)arg3;
...
- (struct CGRect)_convertImageContentsRectFromRegionOfInterest:(id)arg1 assetReference:(id)arg2 flipped:(BOOL)arg3;
- (id)makeTouchBar;
...
- (void)mouseSession:(id)arg1 createdDraggingSession:(id)arg2;
...
- (void)curatedLibraryActionPerformer:(id)arg1 presentFilterPopoverFromSpriteReference:(id)arg2 insets:(struct NSEdgeInsets)arg3;
- (void)curatedLibraryActionPerformer:(id)arg1 showMapWithAssetsFetchResult:(id)arg2;
