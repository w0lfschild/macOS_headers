...
@class IPXOneUpSelectionController, IPXTilingViewTileAnimator, IPXViewerModel, NSMutableSet, NSString, PLAvalanche, PXAssetsDataSource, PXNSScrollViewController, PXReusableObjectPool, PXTilingController;
...
- (void)viewDidLayout;
- (void)loadView;
- (id)initWithBurstController:(id)arg1 dataSourceManager:(id)arg2 selectionController:(id)arg3 viewerModel:(id)arg4;
