...
@class IPXFeedViewController, NSMutableArray;

__attribute__((visibility("hidden")))
@interface IPXFeedCollectionViewLayout : IPXCollectionsLayout
{
    ...
    IPXFeedViewController *_feedViewController;
...
@property(nonatomic) __weak IPXFeedViewController *feedViewController; // @synthesize feedViewController=_feedViewController;
- (void).cxx_destruct;
...
- (long long)numberOfTilesInSection:(long long)arg1;
...
- (id)init;
- (struct CGPoint)_backingAlignedPoint:(struct CGPoint)arg1;
- (double)_viewScale;
