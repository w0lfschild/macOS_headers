...
@class MOAssetsView, MOMediaItem, MOMediaSection, MOMediaViewCell, MOMediaViewLayout, MOMediaViewSupplementary, MOPhotosSupplementaryFooterInfo, NSArray, NSAttributedString, NSEvent, NSIndexPath, NSIndexSet, NSString;

@protocol MOAssetsViewDelegate <NSObject>

@optional
- (void)assetsViewCanFinallyPerformChanges:(MOAssetsView *)arg1;
- (void)assetsViewDidEndScrollingAnimation:(MOAssetsView *)arg1;
- (void)assetsViewDidEndScrolling:(MOAssetsView *)arg1;
- (void)assetsViewDidScroll:(MOAssetsView *)arg1;
...
- (NSIndexSet *)sectionsForSelectAllActionInAssetsView:(MOAssetsView *)arg1;
- (void)assetsView:(MOAssetsView *)arg1 didChangeSelectionByAddingIndexPaths:(NSArray *)arg2 removingIndexPaths:(NSArray *)arg3 animated:(BOOL)arg4;
- (void)assetsView:(MOAssetsView *)arg1 didDeselectItemAtIndexPath:(NSIndexPath *)arg2;
- (void)assetsView:(MOAssetsView *)arg1 didSelectItemAtIndexPath:(NSIndexPath *)arg2;
...
- (double)mainFooterHeightForAssetsView:(MOAssetsView *)arg1 width:(double)arg2 scale:(double)arg3;
- (MOPhotosSupplementaryFooterInfo *)mainFooterInfoForAssetsView:(MOAssetsView *)arg1;
- (NSAttributedString *)mainFooterTitleForAssetsView:(MOAssetsView *)arg1;
- (BOOL)shouldShowMainFooterForAssetsView:(MOAssetsView *)arg1 includingWhenInBounds:(char *)arg2;
- (double)mainHeaderHeightForAssetsView:(MOAssetsView *)arg1 width:(double)arg2 scale:(double)arg3;
- (BOOL)shouldShowMainHeaderForAssetsView:(MOAssetsView *)arg1;
- (BOOL)assetsView:(MOAssetsView *)arg1 shouldShowFooterAtIndexPath:(NSIndexPath *)arg2;
- (BOOL)assetsView:(MOAssetsView *)arg1 shouldShowHeaderAtIndexPath:(NSIndexPath *)arg2;
- (void)assetsView:(MOAssetsView *)arg1 didEndDisplayingCell:(MOMediaViewCell *)arg2 atIndexPath:(NSIndexPath *)arg3;
- (void)assetsView:(MOAssetsView *)arg1 willDisplayCell:(MOMediaViewCell *)arg2 atIndexPath:(NSIndexPath *)arg3;
...
- (Class)assetsView:(MOAssetsView *)arg1 mainHeaderClassForStyle:(unsigned long long)arg2;
- (Class)assetsView:(MOAssetsView *)arg1 mainFooterClassForStyle:(unsigned long long)arg2;
