...
@interface IPXFeedViewController : IPXBrowserController <IPXActivityFeedTestElement, MOMediaViewDataSource, MOMediaViewDelegate, IPXFeedCollectionViewLayoutDelegate, PXFeedSectionInfosManagerDelegate, IPXFeedCellDelegate, IPXFeedImageCellDelegate, IPXFeedInvitationCellDelegate, IPXFeedTextCellDelegate, IPXAssetTransitioning, PXSettingsKeyObserver, PLAssetContainerListChangeObserver, IPXSelectionContainerProvider, IPXiCloudConfigurationDelegate, PLCloudFeedNavigating, PXNavigableCloudFeedViewController>
{
    BOOL _contentLoaded;
