...
@interface IPXLibraryChooser : UXViewController <NSOpenSavePanelDelegate, IPXLibraryChooserClientProtocol, NSTableViewDataSource, NSTableViewDelegate>
{
...
- (void)stop;
- (void)_validateAndAddLibraryPaths:(id)arg1 replaceEverything:(BOOL)arg2;
- (void)viewDidLoad;
- (void)dealloc;
