...
@class IPXSlideshow_MessageTracer, NSArray, NSArrayController, NSDictionary, NSMutableDictionary, NSString, OMSlideshow, PHFetchResult, PHProject;
...
@property(retain, nonatomic) IPXSlideshow_MessageTracer *messageTracer; // @synthesize messageTracer=_messageTracer;
