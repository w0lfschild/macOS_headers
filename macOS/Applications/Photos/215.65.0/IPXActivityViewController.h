...
@class IPXActivityViewSectionInfosManager, IPXCollectionsView, IPXContentUnavailableView, IPXSharedTabBrowserController, IPXWorkspaceModel, NSButton, NSDictionary, NSIndexSet, NSMutableSet, NSPopover, NSString, PLDateRangeFormatter, PUFeedViewControllerSpec, RDAlbum, RDVersion, UXBarButtonItem, UXPopoverController;
