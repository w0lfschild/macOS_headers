...
#import "IPXCollectionsViewSupplementaryView.h"
...
@interface IPXActivityViewSupplementaryCell : IPXCollectionsViewSupplementaryView <IPXActivityViewCellProtocol>
{
    BOOL _clickable;
