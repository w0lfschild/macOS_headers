...
@class IPXFaceCollectionItem;

@interface IPXFaceMediaItem : MOMediaItem
{
    IPXFaceCollectionItem *_item;
}

@property(readonly, nonatomic) IPXFaceCollectionItem *item; // @synthesize item=_item;
- (void).cxx_destruct;
