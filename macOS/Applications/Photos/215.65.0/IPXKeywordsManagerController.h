...
@class IPXKeywordManager, IPXKeywordsGroupView, IPXKeywordsWindow, IPXLibrary, IPXVersionsMonitor, NSButton, NSMutableIndexSet, NSScrollView, NSSegmentedControl, NSString, NSTableView, NSTextField, NSUndoManager, NSView, PFCoalescer, PFDispatchQueue;
...
- (void).cxx_destruct;
- (void)libraryDeletedKeywordIds:(id)arg1 fromDatabase:(id)arg2;
