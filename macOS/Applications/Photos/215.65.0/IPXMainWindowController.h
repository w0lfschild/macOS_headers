...
@class IPXPrologueController, IPXWorkspaceController2, IPXWorkspaceModel, NSProgressIndicator, NSString, NSToolbarItem, NSUndoManager, NSWindow, UXNavigationController;
