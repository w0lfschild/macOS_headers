...
@class IPXAudioCollection, IPXAudioLibrary, IPXMusicPickerBackgroundView, NSArray, NSArrayController, NSButton, NSLayoutConstraint, NSMutableArray, NSPopUpButton, NSScrollView, NSSearchField, NSString, NSTableView, NSView;
