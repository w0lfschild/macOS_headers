...
@class IPXDragDropPasteboardController, IPXSidebarItemNode, IPXSidebarModelController, IPXSidebarPhotosNode, IPXSidebarSpacerNode, IPXWorkspaceController2, NSArray, NSMutableDictionary, NSOutlineView, NSString, PMRActivity;
