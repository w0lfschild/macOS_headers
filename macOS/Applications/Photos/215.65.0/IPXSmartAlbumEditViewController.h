...
@class NSButton, NSLayoutConstraint, NSMapTable, NSMutableArray, NSPopUpButton, NSString, NSTabView, NSTextField, NSView, NSWindow, RDAlbum, RDDatabase, RDMultiItemQuery;
