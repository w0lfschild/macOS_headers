...
@class IPXPluginManager, NSArray, NSMenu, NSString, PHAsset;
@protocol IPXEditPluginControllerDelegate, IPXPluginControllerContentDelegate;

__attribute__((visibility("hidden")))
@interface IPXEditPluginController : NSObject <IPXPluginManagerDelegate, NSMenuItemValidation>
{
    IPXPluginManager *_pluginManager;
    NSArray *_currentExtensionsInMenu;
    struct CGSize _iconSize;
    NSMenu *_menu;
    PHAsset *_primarySelection;
...
@property(retain, nonatomic) PHAsset *primarySelection; // @synthesize primarySelection=_primarySelection;
...
- (unsigned short)currentPlaybackVariationForAsset:(id)arg1;
