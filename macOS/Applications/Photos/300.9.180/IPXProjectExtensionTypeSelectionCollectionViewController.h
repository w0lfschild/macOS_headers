...
@interface IPXProjectExtensionTypeSelectionCollectionViewController : IPXViewController <NSCollectionViewDataSource, NSCollectionViewDelegate, PHProjectTypeDescriptionSourceClientObserver>
{
