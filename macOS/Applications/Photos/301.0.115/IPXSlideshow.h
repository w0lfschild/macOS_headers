...
@class IPXSlideshowAnalytics, NSArray, NSArrayController, NSDictionary, NSMutableDictionary, NSString, OMSlideshow, PHCollection, PHFetchResult, PHProject, PXUIMediaProvider;
...
- (void)logAnalyticsForPlaybackEndedReachingEnd:(BOOL)arg1;
- (void)logAnalyticsForPlaybackResumed;
- (void)logAnalyticsForPlaybackPaused;
- (void)_triggerAnalyticsForPlaybackStartWithType:(long long)arg1;
- (void)logAnalyticsForEditorPreviewPlaybackStarted;
- (void)logAnalyticsForEditorFullScreenPlaybackStarted;
- (void)logAnalyticsForInstantPlaybackStarted;
- (void)logAnalyticsForThumbnailViewPlayback;
- (void)logAnalyticsForDetailsHeaderPlayback;
- (void)logAnalyticsForExportEndedWithSuccess:(BOOL)arg1 error:(id)arg2;
- (void)logAnalyticsForExportStarted;
- (id)_captureAnalyticsIdentifierTrackingValues;
