...
@interface IPXAssetsGridViewController : IPXViewController <NSTouchBarProvider, NSMenuDelegate, NSMenuItemValidation, MOAssetsViewDelegate, MOAssetsViewDataSource, IPXBrowserControllerBarsHelperDataSource, IPXBrowserSummaryHelperDelegate, IPXPhotosGridSliderController, PXAssetsDataSourceManagerObserver, PXDeferrableDataSourceManagerDelegate, IPXSelectionContainerProvider, IPXShareServicesAnimationSource, IPXPlaceholderViewHelperDataSource, IPXActionIndicatorTarget, IPXGridBasedTestElement, IPXShareableTestElement, IPXOneUpTransitionableElement, IPXBrowserSummaryDataSource, IPXAssetTransitioning>
{
    IPXPlaceholderViewHelper *_placeholderHelper;
    BOOL _hasAppearedInitially;
...
@property(readonly, nonatomic) BOOL wantsVisibleDateInterval;
