...
@property(nonatomic) double lastVideoPlayingTime; // @synthesize lastVideoPlayingTime=_lastVideoPlayingTime;
@property(nonatomic) BOOL shouldHideHDRBadge; // @synthesize shouldHideHDRBadge=_shouldHideHDRBadge;
...
- (void)_updateHDRBadgeAnimated:(BOOL)arg1;
- (void)_hideHDRBadgeIfNeeded;
- (void)_showHDRBadgeImmediately;
