...
@class ICPSharedPhotoStreamMediaItem, IPXActivityViewCell, IPXActivityViewSectionInfosManager, IPXContentUnavailableView, IPXSharedTabBrowserController, IPXWorkspaceModel, MOMediaView, NSDictionary, NSIndexSet, NSMutableSet, NSPopover, NSString, PUFeedViewControllerSpec, RDAlbum, RDVersion, UXBarButtonItem, UXPopoverController;
