...
@class IPXAlbumSummaryController, IPXAssetsViewControllerColumnCountSliderController, IPXDatabaseAlbumController, IPXEditableTextFieldContainer, IPXSelection, NSArray, NSProgressIndicator, NSString, NSTextField, PFCoalescer, RDAlbum, RDDatabase, UXBarButtonItem;
@protocol IPXAlbumContentBrowserDelegate;

@interface IPXAlbumContentBrowserController : IPXAssetsBrowserController <IPXDatabaseObjectsControllerChangeReceiver, IPXObjectsControllerChangeReceiver, IPXAssetsViewControllerStyleBasedDelegate, IPXShareServicesAnimationSource, IPXActionIndicatorTarget, IPXEditableTextFieldContainerDelegate, RDLibraryMessagesReceiver, IPXSelectionProvider, IPXAlbumAndFolderSummaryControllerDelegate>
{
    ...
    PFCoalescer *_editorialButtonUpdateCoalescer;
    UXBarButtonItem *_playButtonItem;
    ...
    UXBarButtonItem *_toolbarMemoriesButton;
...
@property(readonly, nonatomic) IPXAlbumSummaryController *albumSummaryController;
...
- (void)viewWillAppear;
- (void)loadView;
- (unsigned long long)_userEventSourceTypeForDatabaseAlbum:(id)arg1;
- (void)_removeLoadingProgressIndicator;
- (void)_displayLoadingProgressIndicator;
- (void)_do_updateEditorialButtonWithContext:(id)arg1;
- (void)updateEditorialButton;
