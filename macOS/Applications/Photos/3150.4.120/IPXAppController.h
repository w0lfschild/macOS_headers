...
@interface IPXAppController : NSObject <NSApplicationDelegate, NSWindowDelegate, NSUserNotificationCenterDelegate, NSUserInterfaceValidations, IPXAutomationSupportProvider, RKImporterUIProviding, IPXLibraryInstantiatorGlobalMessagesReceiver, NSMenuDelegate>
{
