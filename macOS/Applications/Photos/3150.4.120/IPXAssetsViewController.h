...
@class IPXAssetsView, IPXLiveUpdateController, IPXMondrianViewDataSource, IPXMondrianViewDirtyItems, IPXMondrianViewLiveUpdateSuspensionRegistry, NSArray, NSMutableSet, NSObject, NSOperationQueue, NSString, NSViewController, RDVersionResourceRequest;
...
@interface IPXAssetsViewController : IPXViewController <MOAssetsViewDataSource, MOAssetsViewDelegate, IPXLiveUpdateControllerDelegate, IPXAssetTransitioning, IPXActionIndicatorTarget>
{
    ...
    unsigned int _delegateRespondsToPromiseDictionaryForDraggedItemAtIndexPath:1;
    unsigned int _delegateRespondsToDraggingItemForIndexPath:1;
    unsigned int _delegateRespondsToShouldUseFilePromises:1;
    unsigned int _delegateRespondsToDraggedTypesForIndexPaths:1;
    unsigned int _delegateRespondsToPreferredDraggingFormation:1;
    unsigned int _delegateRespondsToCreatedDraggingSession:1;
    unsigned int _delegateRespondsToNamesOfPromisedFilesForItems:1;
    ...
    unsigned int _delegateRespondsToPhotosBrowserMomentsHeaderDelegate:1;
...
- (void)assetsView:(id)arg1 filePromiseProvider:(id)arg2 writePromiseToURL:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)assetsView:(id)arg1 promiseOperationQueueForFilePromiseProvider:(id)arg2;
- (id)assetsView:(id)arg1 filePromiseProvider:(id)arg2 fileNameForType:(id)arg3 destinationLocation:(id)arg4;
...
- (id)assetsView:(id)arg1 promiseDictionaryForDraggedItemAtIndexPath:(id)arg2;
...
- (BOOL)assetsViewShouldUseFilePromises:(id)arg1;
...
- (id)promiseDictionaryForDraggedItemAtIndexPath:(id)arg1;
