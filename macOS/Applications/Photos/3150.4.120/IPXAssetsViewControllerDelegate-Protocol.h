...
@class IPXAssetsViewController, IPXCollectionChangeSet, IPXMondrianViewDataSource, IPXSectionsCollection, MOMediaItem, MOMediaSection, MOMediaViewCell, MOMediaViewSupplementary, NSArray, NSDictionary, NSDraggingItem, NSDraggingSession, NSEvent, NSImage, NSIndexPath, NSString, NSURL, NSViewController;
