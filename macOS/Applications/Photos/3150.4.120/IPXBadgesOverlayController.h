...
@class IPXAnnotationsBadge, IPXBadgeStackController, IPXCloudPhotosDownloadProgressBadge, IPXEditedBadge, IPXFileTypeBadge, IPXHDRBadge, IPXKeywordsBadge, IPXLivePhotoBadge, IPXLocationBadge, IPXLowResUnusableFileBadge, IPXReferencedFileBadge, IPXSDOFBadge, NSArray, NSProgressIndicator, NSSet, NSString, RDDatabase;
...
@interface IPXBadgesOverlayController : IPXViewerOverlayController <RDLibraryMessagesReceiver, PFResourceAccessClient>
{
    ...
    IPXBadgeStackController *_topRightBadgeStackController;
...
@property(retain, nonatomic) IPXBadgeStackController *topRightBadgeStackController; // @synthesize topRightBadgeStackController=_topRightBadgeStackController;
...
- (BOOL)_showBadge:(id)arg1 enabled:(BOOL)arg2 animate:(BOOL)arg3;
- (BOOL)_updateBadge:(id)arg1 withVersion:(id)arg2 enabled:(BOOL)arg3 animate:(BOOL)arg4;
...
- (BOOL)_hideMouseOverBadges:(BOOL)arg1;
- (void)_hideMouseOverBadgesDelayed;
- (void)_cancelHideMouseOverBadgesAfterDelay;
- (void)_hideMouseOverBadgesAfterDelay:(double)arg1;
- (BOOL)_showMouseOverBadges:(BOOL)arg1;
- (BOOL)_hasMouseOver;
- (void)mouseExited:(id)arg1;
- (void)mouseMoved:(id)arg1;
- (void)mouseEntered:(id)arg1;
- (BOOL)_updateLivePhotoBadgeWithVersion:(id)arg1 enabled:(BOOL)arg2 animate:(BOOL)arg3;
