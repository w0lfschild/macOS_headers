...
@class NSArray, NSMutableDictionary, NSString, RDMoment, RDMomentCollection, RDMomentYear;
...
+ (id)momentUserInfoWithUserInfo:(id)arg1 moment:(id)arg2 dateString:(id)arg3;
+ (id)momentCollectionUserInfoWithUserInfo:(id)arg1 dateString:(id)arg2 momentCollection:(id)arg3;
+ (id)momentYearUserInfoWithUserInfo:(id)arg1 dateString:(id)arg2 momentYear:(id)arg3;
