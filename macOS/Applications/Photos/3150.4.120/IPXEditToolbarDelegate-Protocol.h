...
@class IPXEditToolController, IPXEditToolbarController, NSMenu, RDVersion;
...
- (NSMenu *)pluginsMenuForToolbar:(IPXEditToolbarController *)arg1;
- (RDVersion *)primaryVersion;
