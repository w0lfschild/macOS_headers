...
@class IPXFaceNameSearchViewController, NSImageView, NSLayoutConstraint, NSString, RDPerson;
@protocol IPXEditorialPeopleTitleViewControllerDelegate;

@interface IPXEditorialPeopleTitleViewController : UXViewController <IPXSearchViewControllerResultsDelegate, IPXSearchViewControllerSizingDelegate, RDLibraryMessagesReceiver>
{
