...
@class IPXAssetsViewController, IPXAssetsViewControllerColumnCountSliderController, IPXFavoriteMemoriesBrowserLayout, IPXFavoriteMemoriesObjectsController, IPXLibrary, NSArray, NSString, NSTextField, PXMemoriesSpec, UXBarButtonItem;
...
@property(retain, nonatomic) UXBarButtonItem *toolbarItemCount; // @synthesize toolbarItemCount=_toolbarItemCount;
@property(retain, nonatomic) UXBarButtonItem *toolbarAlbumTitle; // @synthesize toolbarAlbumTitle=_toolbarAlbumTitle;
@property(retain, nonatomic) NSTextField *summaryItemCount; // @synthesize summaryItemCount=_summaryItemCount;
@property(retain, nonatomic) NSTextField *summaryAlbumTitle; // @synthesize summaryAlbumTitle=_summaryAlbumTitle;
