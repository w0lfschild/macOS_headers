...
- (void)processUserChosenURLs:(id)arg1 forceImportNow:(BOOL)arg2 checkDuplicates:(BOOL)arg3 intoAlbum:(id)arg4 switchToLastImport:(BOOL)arg5 atEnd:(CDUnknownBlockType)arg6;
