...
@class IPXAssetsViewControllerColumnCountSliderController, IPXLibrarySearchResult, IPXLibrarySearchResultsSecondaryToolbarViewController, IPXVersionsFilteringController, IPXZoomButtonItem, NSArray, NSButton, NSString, PFBlockControl, _IPXLibrarySearchResultObjectsController;

@interface IPXLibrarySearchResultsController : IPXAssetsBrowserController <IPXAssetsViewControllerDelegate, IPXLibrarySearchResultsSecondaryToolbarDelegate, IPXAssetsViewControllerStyleBasedDelegate, IPXObjectsControllerChangeReceiver, IPXSelectionProvider>
{
...
- (void)cancelSearch;
- (BOOL)showingLowConfidenceSceneResults;
- (BOOL)hasLowConfidenceSceneResults;
- (BOOL)hasSceneResults;
- (void)toggleLowConfidenceSceneResults;
