...
@interface IPXProjectBrowserController : IPXBrowserController <IPXObjectsControllerChangeReceiver, IPXAssetsViewControllerStyleBasedDelegate, IPXSelectionProvider, PFResourceAccessClient, UXNavigationRoot>
{
    IPXLibrary *_library;
