...
@class IPXSectionsCollection, IPXTilingControllerDataSource, NSMutableSet, NSString, RDVersion;
@protocol IPXCollection, IPXScrubberControllerDelegate;

@interface IPXScrubberController : NSObject <IPXScrubberViewControllerDelegate, IPXSelectionTileMediaDelegate>
{
...
@property(readonly, nonatomic) id selectedItem; // @synthesize selectedItem=_selectedItem;
...
- (void)scrubberViewControllerDidScroll:(id)arg1 toItem:(id)arg2 withContentOffset:(struct CGPoint)arg3;
- (void)scrubberViewControllerDidClick:(id)arg1 location:(struct CGPoint)arg2;
