...
- (void)scrubberViewControllerDidScroll:(IPXScrubberViewController *)arg1 toItem:(id)arg2 withContentOffset:(struct CGPoint)arg3;
- (void)scrubberViewControllerWillBeginScrolling:(IPXScrubberViewController *)arg1;
- (void)scrubberViewControllerDidClick:(IPXScrubberViewController *)arg1 location:(struct CGPoint)arg2;
