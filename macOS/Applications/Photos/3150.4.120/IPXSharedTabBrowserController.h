...
@class IPXAssetsViewController, IPXAssetsViewControllerColumnCountSliderController, IPXSharedTabBrowserModel, NSIndexPath, NSPopover, NSString, UXBarButtonItem;
...
@interface IPXSharedTabBrowserController : IPXBrowserController <SBLSharedServicesManagerReceiver, IPXSharedTabBrowserModelDelegate, IPXAssetsViewControllerStyleBasedDelegate, IPXShareiCloudCreateViewControllerDelegate, IPXAssetTransitioning, UXNavigationRoot, IPXSelectionProvider>
{
    ...
    UXBarButtonItem *_createButtonItem;
...
@property(retain) UXBarButtonItem *createButtonItem; // @synthesize createButtonItem=_createButtonItem;
@property(retain) UXBarButtonItem *shareButtonItem; // @synthesize shareButtonItem=_shareButtonItem;
