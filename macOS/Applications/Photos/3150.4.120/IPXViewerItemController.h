...
@class CALayer, IPXCanvasItemView, IPXEditViewConfiguration, IPXEditorialBrowserController, IPXElasticScrollAnimator, IPXReconnectManager, IPXViewerController, IPXViewerItemDragDropState, IPXViewerItemModel, NSDate, NSEvent, NSMutableArray, NSObject, NSOperationQueue, NSSet, NSString, NSView, PAItemController, PAItemViewController, PAPreviewRequest, PFCanceler, RDFaceTile, RDVersion;
@protocol IPXViewerItemControllerAXDelegate, IPXViewerItemControllerDelegate;

@interface IPXViewerItemController : IPXViewController <IPXViewerOverlayDataSource, IPXCanvasItemViewAXDelegate, IPXViewerItemControllerViewDelegate, IPXElasticScrollAnimatorTarget, IPXEditorialModelViewerDelegate, IPXEditorialBrowserControllerDelegate, PAPreviewStateReceiver, NSDraggingSource, NSFilePromiseProviderDelegate, IPXViewerLayoutItem>
{
    ...
    NSOperationQueue *__fileExportQueue;
...
@property(retain) NSOperationQueue *_fileExportQueue; // @synthesize _fileExportQueue=__fileExportQueue;
...
- (id)promiseOperationQueueForFilePromiseProvider:(id)arg1;
- (id)filePromiseProvider:(id)arg1 fileNameForType:(id)arg2;
- (id)filePromiseProvider:(id)arg1 fileNameForDestination:(id)arg2;
...
- (void)_updatePreviewItemViewConfigurationContentScale;
