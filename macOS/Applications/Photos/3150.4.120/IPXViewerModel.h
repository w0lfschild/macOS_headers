...
@class IPXViewerItemModel, IPXViewerSelection, NSArray, NSMapTable, NSMutableDictionary;
...
@interface IPXViewerModel : IPXModel
{
    ...
    NSMutableDictionary *_candidateVersionsMap;
...
@property(retain, nonatomic) NSMutableDictionary *candidateVersionsMap; // @synthesize candidateVersionsMap=_candidateVersionsMap;
- (void).cxx_destruct;
