...
@class ICCameraDevice, NSDate, NSImage, NSString, RDMetadata;
@protocol ImportAssetFile, ImportSource;

@protocol ImportAssetFile <PFFile, NSObject>
@property(retain) id <ImportAssetFile> videoComplement;
...
- (NSImage *)thumbnailOfSize:(unsigned long long)arg1 loadXmpData:(BOOL)arg2 error:(id *)arg3;
- (void)loadMetadataWithXMP:(BOOL)arg1;
@end
