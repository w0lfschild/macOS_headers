...
@class ICPSharedPhotoStreamMediaItem, IPXActivityViewCell, IPXActivityViewSectionInfosManager, IPXContentUnavailableView, IPXSharedBrowserModel, MOMediaView, NSArray, NSDictionary, NSIndexSet, NSMutableSet, NSPopover, NSScrollView, NSString, PUFeedViewControllerSpec, RDAlbum, RDVersion, UXBarButtonItem, UXNavigationController, UXPopoverController;
