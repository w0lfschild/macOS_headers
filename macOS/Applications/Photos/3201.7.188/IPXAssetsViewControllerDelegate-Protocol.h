...
@class IPXAssetsViewController, IPXCollectionChangeSet, IPXMondrianViewDataSource, IPXSectionsCollection, MOMediaItem, MOMediaSection, MOMediaViewCell, MOMediaViewSupplementary, MOPhotosSupplementaryFooterInfo, NSArray, NSAttributedString, NSDictionary, NSDraggingItem, NSDraggingSession, NSEvent, NSImage, NSIndexPath, NSString, NSURL, NSViewController;
...
- (BOOL)assetsViewControllerShouldUseFilePromises:(IPXAssetsViewController *)arg1;
...
- (NSDictionary *)assetsViewController:(IPXAssetsViewController *)arg1 promiseDictionaryForDraggedItemAtIndexPath:(NSIndexPath *)arg2;
