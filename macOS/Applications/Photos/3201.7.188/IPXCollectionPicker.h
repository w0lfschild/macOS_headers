...
@class IPXNestedAlbumMenuController, IPXWorkspaceModel, NSArray, NSButton, NSLayoutConstraint, NSMenuItem, NSMutableDictionary, NSPopUpButton, NSString, NSTextField, NSUndoManager, NSWindow, RDFolder;
