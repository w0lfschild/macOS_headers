...
{
    BOOL _hadResultsBeforeStringChange;
    id _context;
...
@property(nonatomic) BOOL hadResultsBeforeStringChange; // @synthesize hadResultsBeforeStringChange=_hadResultsBeforeStringChange;
