...
@class IPXBrowserControllerBarsHelper, IPXBrowserControllerSummaryHelper, IPXLibrary, IPXPeopleCollectionViewController, IPXWorkspaceController, MOMediaView, NSArray, NSDateInterval, NSDictionary, NSScrollView, NSString, PXPeopleProgressManager;
