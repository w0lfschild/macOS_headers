...
@class IPXFilePromiseHelper, IPXSidebarCellView, IPXSidebarItem, IPXSidebarModelController, IPXSidebarOutlineView, IPXWorkspaceController, NSArray, NSMenu, NSMutableArray, NSMutableDictionary, NSObject, NSPopover, NSString, PFLimitedConcurrencyQueue, PMRActivity;
...
@interface IPXSidebarViewController : IPXViewController <IPXSidebarModelChangeReceiver, IPXShareiCloudCreateViewControllerDelegate, NSMenuDelegate, NSOutlineViewDataSource, IPXSidebarOutlineViewDelegate, NSTextFieldDelegate, PFResourceAccessClient, UXSourceList>
{
    ...
    NSArray *_foldersNotSuitableForCreatingAlbumsInside;
