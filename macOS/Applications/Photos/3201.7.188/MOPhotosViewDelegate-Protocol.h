...
@class MOMediaSection, MOMediaViewSupplementary, MOPhotosSupplementaryFooterInfo, MOPhotosView, NSArray, NSAttributedString, NSDictionary, NSDraggingItem, NSDraggingSession, NSEvent, NSFilePromiseProvider, NSImage, NSIndexPath, NSOperationQueue, NSString, NSURL;
