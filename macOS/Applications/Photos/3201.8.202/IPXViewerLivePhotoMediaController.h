...
@class ISWrappedAVPlayer, LiAddress, NSArray, NSMutableSet, NSString, NULivePhotoRenderClient, NUMediaView, PHLivePhoto, PHLivePhotoView, RDDatabase;
...
- (void)_updateMediaViewWithRenderDescription:(id)arg1;
