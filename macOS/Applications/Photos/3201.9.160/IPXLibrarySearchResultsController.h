...
@class IPXAssetsViewControllerColumnCountSliderController, IPXBrowserControllerBarsHelper, IPXBrowserControllerSummaryHelper, IPXContentFilterObjectsController, IPXLibrarySearchResult, IPXVersionsFilteringController, IPXWorkspaceController, IPXZoomButtonItem, MOMediaView, NSArray, NSDateInterval, NSScrollView, NSString, UXBarButtonItem, _IPXLibrarySearchResultObjectsController;
