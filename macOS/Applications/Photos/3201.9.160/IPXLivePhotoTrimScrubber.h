...
@class AVAsset, AVVideoComposition, IPXLivePhotoTrimScrubberLoupeView, IPXVideoThumbStripView, NSArray, NSImage, NSImageView, NSPopover, NSPressGestureRecognizer, NSString, PFCoalescer, _IPXLivePhotoTrimScrubberDot;
@protocol IPXLivePhotoTrimScrubberDelegate, IPXLivePhotoTrimScrubberUpdateDelegate;
...
@property(nonatomic, getter=photoLoupeHidden) BOOL hidePhotoLoupe; // @synthesize hidePhotoLoupe=_hidePhotoLoupe;
@property(nonatomic, getter=markersHidden) BOOL hideMarkers; // @synthesize hideMarkers=_hideMarkers;
