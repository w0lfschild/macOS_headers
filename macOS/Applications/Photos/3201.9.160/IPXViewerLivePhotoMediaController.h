...
@class ISWrappedAVPlayer, LiAddress, NSArray, NSMutableSet, NSString, NULivePhotoRenderClient, NUMediaView, PHLivePhoto, PHLivePhotoView, RDDatabase, RDVersion;
...
@interface IPXViewerLivePhotoMediaController : IPXViewerImageController <PHLivePhotoViewDelegatePrivate, NUMediaViewDelegate, ISChangeObserver, PFResourceAccessClient, RDLibraryMessagesReceiver, IPXBadgeViewTrackingDelegate, PXVideoScrubberControllerTarget, IPXLivePhotoTrimScrubberDelegate>
{
    ...
    NULivePhotoRenderClient *_livePhotoRenderClient;
...
- (void)_handleAdjustedLivePhotoRenderResult:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
