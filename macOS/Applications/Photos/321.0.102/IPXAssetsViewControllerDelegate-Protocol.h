...
- (void)assetsViewControllerDidEndScrollingAnimation:(IPXAssetsViewController *)arg1;
...
- (double)mainFooterHeightForAssetsViewController:(IPXAssetsViewController *)arg1 width:(double)arg2 scale:(double)arg3;
