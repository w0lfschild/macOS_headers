...
@interface ILKSlider : NSSlider
{
    ...
    BOOL _mouseInside;
    BOOL _wantsDefaultIntrinsicContentSize;
...
@property(nonatomic) BOOL wantsDefaultIntrinsicContentSize; // @synthesize wantsDefaultIntrinsicContentSize=_wantsDefaultIntrinsicContentSize;
