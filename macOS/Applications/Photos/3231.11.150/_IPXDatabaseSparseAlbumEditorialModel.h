...
@class IPXDatabaseSparseAlbumController, RDAlbum;

@interface _IPXDatabaseSparseAlbumEditorialModel : _IPXDatabaseVersionsQueryEditorialModel
{
    IPXDatabaseSparseAlbumController *_databaseSparseAlbumController;
