...
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *queryDataQueue; // @synthesize queryDataQueue=_queryDataQueue;
...
- (void)_synchronouslyUnloadAndLoadQueryData;
