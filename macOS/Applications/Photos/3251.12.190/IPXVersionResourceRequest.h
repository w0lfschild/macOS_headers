...
#import <PhotoLibraryPrivate/RDVersionResourceRequest.h>
...
@interface IPXVersionResourceRequest : RDVersionResourceRequest <IPXVersionResourceProgressViewDelegate>
{
