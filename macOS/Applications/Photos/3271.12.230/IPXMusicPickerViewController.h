...
@class IPXAudioCollection, IPXAudioLibrary, IPXMusicPickerBackgroundView, IPXSearchField, NSArray, NSArrayController, NSButton, NSLayoutConstraint, NSMutableArray, NSPopUpButton, NSScrollView, NSString, NSTableView, NSView;
