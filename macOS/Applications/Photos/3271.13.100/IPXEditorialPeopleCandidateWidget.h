...
@class IPXAssetTransitionItem, IPXDatabaseObjectsController, IPXEditorialModel, IPXPeopleSuggestionDataSource, NSButton, NSString, NSView, PFDispatchQueue, RDPerson;
