...
@property(readonly, nonatomic) id anchorItemIdentifier; // @synthesize anchorItemIdentifier=_anchorItemIdentifier;
...
- (id)initWithChange:(id)arg1 tilingController:(id)arg2 anchorItemIdentifier:(id)arg3;
