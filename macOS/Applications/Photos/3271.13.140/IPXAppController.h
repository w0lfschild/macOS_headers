...
+ (void)finishLaunchActivity:(id)arg1 comment:(id)arg2;
+ (void)startLaunchActivity:(id)arg1 comment:(id)arg2;
+ (void)recordPMRForActivitySinceAppLaunch:(id)arg1;
