...
@class MOAssetsView, MOMediaItem, MOMediaSection, MOMediaViewCell, MOMediaViewLayout, MOMediaViewSupplementary, MOPhotosSupplementaryFooterInfo, NSArray, NSAttributedString, NSEvent, NSIndexPath, NSString;
...
- (double)mainFooterHeightForAssetsView:(MOAssetsView *)arg1;
