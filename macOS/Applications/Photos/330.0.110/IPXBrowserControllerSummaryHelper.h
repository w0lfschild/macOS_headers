...
@class IPXAppSettings, IPXAssetsStackBarButtonItem, IPXEditableLabelBarButtonItem, IPXLabelBarButtonItem, IPXPullDownBarButtonItem, IPXSectionHeaderBarButtonItem, MOMediaView, NSArray, NSDateInterval, NSScrollView, NSString, PXBrowserSummaryController, UXBarButtonItem;
@protocol IPXBrowserSummaryDataSource, IPXBrowserSummaryHelperDelegate, IPXViewControllerToolbarOutput, PXPhotosGridFloatingHeaderInfo;

__attribute__((visibility("hidden")))
@interface IPXBrowserControllerSummaryHelper : NSObject <PXChangeObserver, PXBrowserSummaryControllerDataSource, IPXEditableLabelBarButtonItemDelegate, IPXAssetsStackBarButtonItemDataSource>
{
    ...
    struct {
        ...
        char subtoolbarInfoReady;
    } _needsUpdateFlags;
    struct {
        char contentScrollView;
        char mediaView;
        char topSectionHeaderInfo;
        char wantsTopSectionHeaderInSummaryBar;
        char topScrollerInsetsForSectionHeader;
        char containerTitle;
    ...
    struct {
        char targetForSubtoolbarItem;
    } _toolbarOutputRespondsTo;
    struct {
        char didChange;
    } _delegateRespondsTo;
    ...
    id <IPXViewControllerToolbarOutput> _toolbarOutput;
    ...
    id <PXPhotosGridFloatingHeaderInfo> _floatingSectionHeaderInfo;
...
@property(retain, nonatomic) id <PXPhotosGridFloatingHeaderInfo> floatingSectionHeaderInfo; // @synthesize floatingSectionHeaderInfo=_floatingSectionHeaderInfo;
...
@property(nonatomic, getter=isSubtoolbarInfoReady) BOOL subtoolbarInfoReady; // @synthesize subtoolbarInfoReady=_subtoolbarInfoReady;
@property(copy, nonatomic) NSString *navigationTitle; // @synthesize navigationTitle=_navigationTitle;
@property(nonatomic) unsigned long long containerDateFormatGranularity; // @synthesize containerDateFormatGranularity=_containerDateFormatGranularity;
...
@property(nonatomic) BOOL shouldHideLeadingSubtoolbarItems; // @synthesize shouldHideLeadingSubtoolbarItems=_shouldHideLeadingSubtoolbarItems;
@property(nonatomic) BOOL shouldHideSummary; // @synthesize shouldHideSummary=_shouldHideSummary;
@property(nonatomic) __weak id <IPXViewControllerToolbarOutput> toolbarOutput; // @synthesize toolbarOutput=_toolbarOutput;
...
- (void)_updateSubtoolbarInfoReady;
- (void)_invalidateSubtoolbarInfoReady;
...
- (void)setShouldHideLeadingSubtoolbarItems:(BOOL)arg1 animated:(BOOL)arg2;
