...
#import "IPXActivityFeedTestElement-Protocol.h"
#import "IPXAssetTransitioning-Protocol.h"
#import "IPXFeedCellDelegate-Protocol.h"
#import "IPXFeedCollectionViewLayoutDelegate-Protocol.h"
#import "IPXFeedImageCellDelegate-Protocol.h"
#import "IPXFeedInvitationCellDelegate-Protocol.h"
#import "IPXFeedTextCellDelegate-Protocol.h"
...
#import "PXFeedSectionInfosManagerDelegate-Protocol.h"
#import "PXNavigableCloudFeedViewController-Protocol.h"
#import "PXSettingsKeyObserver-Protocol.h"

@class IPXContentUnavailableView, IPXFeedCell, IPXFeedViewControllerSpec, IPXFilePromiseHelper, IPXSelectionContainer, IPXiCloudConfiguration, MOMediaView, NSArray, NSDictionary, NSIndexPath, NSIndexSet, NSMutableSet, NSScrollView, NSString, PHPhotoLibrary, PLCloudSharedComment, PLManagedAsset, PLPhotoLibrary, PXAssetReference, PXFeedAssetContainerList, PXFeedSectionInfosManager, PXPhotoKitAssetsDataSourceManager, PXUIMediaProvider, UXBarButtonItem, UXNavigationController, UXPopoverController;
@protocol PLCloudSharedAlbumProtocol;

__attribute__((visibility("hidden")))
@interface IPXFeedViewController : IPXNavigationParticipatingViewController <IPXActivityFeedTestElement, MOMediaViewDataSource, MOMediaViewDelegate, IPXFeedCollectionViewLayoutDelegate, PXFeedSectionInfosManagerDelegate, IPXFeedCellDelegate, IPXFeedImageCellDelegate, IPXFeedInvitationCellDelegate, IPXFeedTextCellDelegate, IPXAssetTransitioning, PXSettingsKeyObserver, PLAssetContainerListChangeObserver, IPXSelectionContainerProvider, IPXiCloudConfigurationDelegate, NSMenuItemValidation, PLCloudFeedNavigating, PXNavigableCloudFeedViewController>
{
    BOOL _contentLoaded;
    ...
    BOOL _oneUpDataSourceUpdateScheduled;
    int _systemLibraryChangeToken;
    PXUIMediaProvider *_mediaProvider;
    unsigned long long _interfaceOrientation;
    PHPhotoLibrary *_photoLibrary;
    IPXFeedViewControllerSpec *_spec;
    long long _contentType;
    PLPhotoLibrary *_plPhotolibrary;
    ...
    NSIndexPath *_transitioningBackToIndexPath;
    IPXFeedCell *_clickedCell;
    PXAssetReference *_clickedAssetReference;
    id <PLCloudSharedAlbumProtocol> _pushedAlbum;
...
+ (id)sharedAlbumsLibraryUpdatingExpiredIndicatorFilePath;
...
@property(nonatomic) BOOL oneUpDataSourceUpdateScheduled; // @synthesize oneUpDataSourceUpdateScheduled=_oneUpDataSourceUpdateScheduled;
@property(retain, nonatomic) PXFeedAssetContainerList *browsingAssetContainerList; // @synthesize browsingAssetContainerList=_browsingAssetContainerList;
@property(retain, nonatomic) PLCloudSharedComment *browsingSelectedComment; // @synthesize browsingSelectedComment=_browsingSelectedComment;
@property(retain, nonatomic) PLManagedAsset *browsingSelectedAsset; // @synthesize browsingSelectedAsset=_browsingSelectedAsset;
@property(retain, nonatomic) id <PLCloudSharedAlbumProtocol> pushedAlbum; // @synthesize pushedAlbum=_pushedAlbum;
@property(nonatomic) int systemLibraryChangeToken; // @synthesize systemLibraryChangeToken=_systemLibraryChangeToken;
@property(retain, nonatomic) PXAssetReference *clickedAssetReference; // @synthesize clickedAssetReference=_clickedAssetReference;
@property(retain, nonatomic) IPXFeedCell *clickedCell; // @synthesize clickedCell=_clickedCell;
@property(retain, nonatomic) NSIndexPath *transitioningBackToIndexPath; // @synthesize transitioningBackToIndexPath=_transitioningBackToIndexPath;
...
@property(readonly, nonatomic) PLPhotoLibrary *plPhotolibrary; // @synthesize plPhotolibrary=_plPhotolibrary;
@property(readonly, nonatomic) long long contentType; // @synthesize contentType=_contentType;
@property(readonly, nonatomic) IPXFeedViewControllerSpec *spec; // @synthesize spec=_spec;
...
- (id)_dataSourceManagerWithAsset:(id)arg1;
- (void)expandLoadedSections:(id)arg1;
- (void)feedInvitationCellReportJunk:(id)arg1;
- (void)feedInvitationCell:(id)arg1 didAccept:(BOOL)arg2;
- (void)_showOutOfNetworkInvitationMessageForSharedAlbum:(id)arg1;
- (void)_reportJunkForSharedAlbum:(id)arg1;
- (void)_declineInvitationToSharedAlbum:(id)arg1;
- (void)_acceptInvitationToSharedAlbum:(id)arg1;
...
- (void)_availableDestinationForObject:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_createNewSharedAlbum;
- (void)_openAppiCloudSettings;
- (void)_openSystemiCloudSettings;
- (void)didClickButtonInFeedTextCell:(id)arg1;
- (void)didClickCommentButtonInFeedImageCell:(id)arg1;
- (void)didClickOverlayPlayButtonInFeedImageCell:(id)arg1;
- (BOOL)isThumbnail:(id)arg1;
- (void)didRightClickFeedCell:(id)arg1 event:(id)arg2;
- (void)didClickFeedCell:(id)arg1;
- (BOOL)isLiveUpdating;
- (void)_didRightClickAsset:(id)arg1 event:(id)arg2;
- (void)_didClickAssetFeedImageCell:(id)arg1;
- (void)_didClickSectionFooterFeedCell:(id)arg1;
- (void)_didClickSectionHeaderFeedCell:(id)arg1;
- (void)_didClickThumbnailInFeedCell:(id)arg1;
...
- (void)_revealAsset:(id)arg1 orComment:(id)arg2 withOptions:(long long)arg3;
...
- (void)_navigateToSharedAlbum:(id)arg1;
...
- (struct IPXFeedSeparatorMetrics)collectionView:(id)arg1 layout:(id)arg2 metricsForSeparatorBetweenSection:(long long)arg3 andSection:(long long)arg4 proposedMetrics:(struct IPXFeedSeparatorMetrics)arg5;
...
- (struct IPXFeedSeparatorMetrics)collectionView:(id)arg1 layout:(id)arg2 metricsForSeparatorBetweenRowAtIndexPath:(id)arg3 andRowAtIndexPath:(id)arg4 proposedMetrics:(struct IPXFeedSeparatorMetrics)arg5;
...
- (void)_requestThumbnailForAsset:(id)arg1 withSize:(struct CGSize)arg2 resultHandler:(CDUnknownBlockType)arg3;
- (void)_configureImageCell:(id)arg1 forAssetAtIndexPath:(id)arg2 inCollectionView:(id)arg3;
- (id)_transitionIndexPathForAsset:(id)arg1 orComment:(id)arg2;
...
@property(readonly, nonatomic) unsigned long long interfaceOrientation; // @synthesize interfaceOrientation=_interfaceOrientation;
...
- (void)_transitionFromVC:(id)arg1 toVC:(id)arg2 alphaValue:(double)arg3;
...
- (id)initWithPhotoLibrary:(id)arg1 spec:(id)arg2 contentType:(long long)arg3;
- (void)_stopObservingSystemLibraryChanges;
- (void)_startObservingSystemLibraryChanges;
- (void)_handleSystemLibraryChangedNotification;
...
- (void)_resetFeedSectionInfosManager;
