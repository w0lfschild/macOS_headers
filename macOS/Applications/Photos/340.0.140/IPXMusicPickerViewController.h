...
@class IPXAudioCollection, IPXAudioLibrary, IPXSuggestionsField, NSArray, NSArrayController, NSButton, NSLayoutConstraint, NSPopUpButton, NSScrollView, NSString, NSTableView, NSView, UXView;
@protocol MusicPickerViewControllerDelegate;

__attribute__((visibility("hidden")))
@interface IPXMusicPickerViewController : IPXViewController <NSTableViewDataSource, NSTableViewDelegate, IPXSuggestionsFieldDelegate>
{
    ...
    IPXSuggestionsField *_searchField;
...
@property __weak IPXSuggestionsField *searchField; // @synthesize searchField=_searchField;
