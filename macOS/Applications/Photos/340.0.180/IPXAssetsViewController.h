...
@class IPXAssetsView, IPXFilePromiseHelper, IPXLiveUpdateController, IPXMondrianViewDataSource, IPXMondrianViewDirtyItems, IPXMondrianViewLiveUpdateSuspensionRegistry, IPXTransitoryVisibleContentSnapshot, MOMediaView, NSArray, NSDictionary, NSMutableSet, NSObject, NSScrollView, NSString, NSViewController;
...
@interface IPXAssetsViewController : IPXViewController <IPXGridBasedTestElement, MOAssetsViewDataSource, MOAssetsViewDelegate, IPXLiveUpdateControllerDelegate, NSMenuItemValidation, IPXAssetTransitioning>
{
    ...
    unsigned int _delegateRespondsToDidEndScrollingAnimation:1;
    ...
    IPXTransitoryVisibleContentSnapshot *_transitoryVisibleContentSnapshot;
}

+ (id)customLayoutAssetsViewControllerWithDelegate:(id)arg1;
+ (id)styleBasedAssetsViewControllerWithDelegate:(id)arg1;
- (void).cxx_destruct;
@property(readonly, nonatomic) IPXTransitoryVisibleContentSnapshot *transitoryVisibleContentSnapshot; // @synthesize transitoryVisibleContentSnapshot=_transitoryVisibleContentSnapshot;
