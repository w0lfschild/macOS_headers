...
@class IPXMusicPickerViewController, IPXSlideshow, IPXSlideshowThemeBrowserViewController, NSArray, NSArrayController, NSButton, NSDictionary, NSMutableArray, NSSegmentedControl, NSString, NSTextField, NSView, NSVisualEffectView, OMSlideshowTheme, PHCollection, UXViewController;
...
@property(retain, nonatomic) NSArray *previewAssets; // @synthesize previewAssets=_previewAssets;
