...
@interface IPXAlbumContentBrowserController : IPXAssetsBrowserController <IPXDatabaseObjectsControllerChangeReceiver, IPXObjectsControllerChangeReceiver, IPXAssetsViewControllerStyleBasedDelegate, IPXShareServicesAnimationSource, IPXActionIndicatorTarget, IPXEditableTextFieldContainerDelegate, IPXBrowserSummaryDataSource, IPXBrowserSummaryHelperDelegate, IPXContentFilterDelegate, IPXBrowserSummaryActionDelegate, IPXBrowserToolbarItemsDataSource, IPXTransitorySelectionProvider, RDLibraryMessagesReceiver, IPXTransitoryVisibleContentSnapshotProvider, IPXLibraryChangeReceiver, IPXPasteboardActionContext, PFResourceAccessClient, IPXSelectionProvider, IPXAssetsActionReceiver>
{
    ...
    NSAttributedString *_albumDetailedLocalizedItemCount;
    ...
    id <UXNavigationDestination> _contentPreparationContextNavigationDestination;
    CDUnknownBlockType _contentPreparationContextNavigationCompletion;
    NSMutableArray *_contentPreparationContextViewControllers;
    long long _contentPreparationContext;
...
@property(nonatomic) long long contentPreparationContext; // @synthesize contentPreparationContext=_contentPreparationContext;
@property(retain, nonatomic) NSMutableArray *contentPreparationContextViewControllers; // @synthesize contentPreparationContextViewControllers=_contentPreparationContextViewControllers;
@property(copy, nonatomic) CDUnknownBlockType contentPreparationContextNavigationCompletion; // @synthesize contentPreparationContextNavigationCompletion=_contentPreparationContextNavigationCompletion;
@property(retain, nonatomic) id <UXNavigationDestination> contentPreparationContextNavigationDestination; // @synthesize contentPreparationContextNavigationDestination=_contentPreparationContextNavigationDestination;
...
@property(copy) NSAttributedString *albumDetailedLocalizedItemCount; // @synthesize albumDetailedLocalizedItemCount=_albumDetailedLocalizedItemCount;
...
- (BOOL)_startListeningToAlbumControllerChanges;
- (BOOL)_requestControllerContentPreparationFromContext:(long long)arg1;
- (void)_presentContentForRestoringEditorWithCompletion:(CDUnknownBlockType)arg1;
- (void)_presentContentForRestoringEditorIfNeeded;
- (void)_presentContentForTransitioningInWithCompletion:(CDUnknownBlockType)arg1;
- (void)_presentContentForTransitioningInIfNeeded;
...
- (id)_changeDisplayTitleIfNecessary:(id)arg1;
