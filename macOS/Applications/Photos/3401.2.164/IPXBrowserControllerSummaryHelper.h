...
@class IPXAssetsStackBarButtonItem, IPXBrowserControllerSettings, IPXEditableLabelBarButtonItem, IPXLabelBarButtonItem, IPXPullDownBarButtonItem, IPXSectionHeaderBarButtonItem, MOMediaSection, MOMediaView, MOPhotosSupplementaryHeader, NSArray, NSDateInterval, NSScrollView, NSString, PXBrowserSummaryController, UXBarButtonItem;
