...
@class IPXAssetsViewControllerColumnCountSliderController, IPXBrowserControllerBarsHelper, IPXBrowserControllerSummaryHelper, IPXContentFilterObjectsController, IPXImportHistoryDataSourceController, IPXLibrary, IPXWorkspaceController, MOMediaView, NSArray, NSDateInterval, NSScrollView, NSString, NSView;
@protocol PXBrowserSelectionSnapshot, PXBrowserVisibleContentSnapshot;

@interface IPXImportHistoryBrowserController : IPXAssetsBrowserController <IPXBrowserSummaryDataSource, IPXBrowserSummaryHelperDelegate, IPXBrowserSummaryActionDelegate, IPXBrowserToolbarItemsDataSource, IPXObjectsControllerChangeReceiver, IPXAssetsViewControllerStyleBasedDelegate, IPXDatabaseObjectsControllerChangeReceiver, IPXSelectionProvider, IPXContentFilterObjectsControllerChangeReceiver, IPXPasteboardActionContext>
{
    BOOL _didReloadInitially;
    IPXLibrary *_library;
