...
@class IPXMusicPickerViewController, IPXSlideshow, IPXSlideshowThemeBrowserViewController, NSArray, NSArrayController, NSButton, NSDictionary, NSMutableArray, NSSegmentedControl, NSString, NSTextField, NSView, OMSlideshowTheme, UXView, UXViewController;
