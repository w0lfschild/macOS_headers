...
+ (void)initialize;
+ (id)allVersionsInFolder:(id)arg1;
...
- (void)dispatchExportMastersForVersions:(id)arg1 toURL:(id)arg2 metadataMode:(int)arg3 fileNamingPolicy:(id)arg4 exportIntoMomentsSubfolders:(BOOL)arg5;
- (void)setupFinalDestinationsForAlbumsAndFoldersForMasters:(id)arg1 toURL:(id)arg2 metadataMode:(int)arg3 fileNamingPolicy:(id)arg4 exportIntoMomentsSubfolders:(BOOL)arg5;
...
- (void)showSavePanelUsingDefaultSettingsForVersions:(id)arg1 forAlbum:(id)arg2;
