...
@class ILKBarSlider, IPXRedEyeToolOverlay, NSButton, NSString;

@interface IPXRedEyeBrickController : IPXAdjustmentBrickTitledController <PADescriptionEditReceiver, ILKBarSliderDelegate>
{
    NSButton *_redEyeToolButton;
...
- (void)a_toggleRedEyeButton:(id)arg1;
