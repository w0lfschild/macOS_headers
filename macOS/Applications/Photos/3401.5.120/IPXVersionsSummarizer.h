...
+ (id)attributedDescriptiveForLibraryLastKnownItemCounts:(id)arg1 attributes:(id)arg2;
...
- (id)dateRangeForVersions:(id)arg1 format:(unsigned long long)arg2 dateInterval:(id *)arg3;
- (id)dateRangeForVersions:(id)arg1 format:(unsigned long long)arg2;
- (id)dateRangeForVersionsCollection:(id)arg1 format:(unsigned long long)arg2 dateInterval:(id *)arg3;
