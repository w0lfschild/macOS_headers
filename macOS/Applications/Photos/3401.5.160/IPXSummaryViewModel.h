...
@interface IPXSummaryViewModel : NSObject
{
    BOOL _showFavorite;
    BOOL _isLivePhotoMedia;
    BOOL _hasHiddenLivePhotoMedia;
...
@property BOOL hasHiddenLivePhotoMedia; // @synthesize hasHiddenLivePhotoMedia=_hasHiddenLivePhotoMedia;
@property BOOL isLivePhotoMedia; // @synthesize isLivePhotoMedia=_isLivePhotoMedia;
