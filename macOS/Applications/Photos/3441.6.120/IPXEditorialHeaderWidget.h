...
@class IPXAssetTransitionItem, IPXDatabaseObjectsController, IPXEditorialModel, IPXEditorialModelMediaItem, IPXMemoryCell, IPXSlideshow, NSOperationQueue, NSString, OMSlideshowViewController, PFDispatchQueue, PXMemoriesSpec, RDVersion, RDVersionResourceRequest, UXView;
