...
- (void)processDraggedURLs:(id)arg1 intoFolder:(id)arg2 forceImportNow:(BOOL)arg3;
- (void)processDraggedURLs:(id)arg1 intoAlbum:(id)arg2 switchToLastImport:(BOOL)arg3;
- (void)processUserChosenURLs:(id)arg1 forceImportNow:(BOOL)arg2 checkDuplicates:(BOOL)arg3 intoContainer:(id)arg4 switchToLastImport:(BOOL)arg5 userAction:(unsigned long long)arg6 atEnd:(CDUnknownBlockType)arg7;
