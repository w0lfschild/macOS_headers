...
@class NSSet, RDFolder;

@interface IPXFolderThumbnailInfo : NSObject <NSCopying>
{
    ...
    NSSet *_albumsAndFolderUuidsAffectingThumbnail;
}

@property(retain) NSSet *albumsAndFolderUuidsAffectingThumbnail; // @synthesize albumsAndFolderUuidsAffectingThumbnail=_albumsAndFolderUuidsAffectingThumbnail;
