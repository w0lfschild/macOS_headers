...
@class IPXAssetsViewController, IPXAssetsViewControllerColumnCountSliderController, IPXBrowserControllerBarsHelper, IPXDatabaseProjectsController, IPXLibrary, IPXProjectBrowserModel, IPXSlideshowEditorController, IPXVersionResourceRequest, IPXWorkspaceController, NSButton, NSMutableArray, NSString, NSTextField, RDAlbum, UXView;
