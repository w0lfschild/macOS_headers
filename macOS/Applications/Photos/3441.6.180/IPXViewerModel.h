...
@interface IPXViewerModel : NSObject
{
    ...
    NSMapTable *_candidateVersionsIdentifiersToIndexes;
...
@property(retain, nonatomic) NSMapTable *candidateVersionsIdentifiersToIndexes; // @synthesize candidateVersionsIdentifiersToIndexes=_candidateVersionsIdentifiersToIndexes;
- (void).cxx_destruct;
