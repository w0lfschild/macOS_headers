...
@class IPXAssetsViewControllerColumnCountSliderController, IPXBrowserControllerSummaryHelper, IPXLibrary, IPXSectionsCollection, MOMediaView, NSArray, NSDateInterval, NSIndexSet, NSMutableArray, NSMutableSet, NSScrollView, NSString, UXBarButtonItem;
...
- (BOOL)pushOneUpViewControllerWithPrimaryVersion:(id)arg1 editModeEnabled:(BOOL)arg2;
