...
@class IPXAssetTransitionItem, IPXDatabaseObjectsController, IPXEditorialModel, IPXEditorialProgressView, IPXRelatedModelCollectionController, NSString, PFDispatchQueue, UXView;
