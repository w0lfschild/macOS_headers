...
@class IPXAssetsViewController, IPXAssetsViewControllerColumnCountSliderController, IPXDatabaseTrashAlbumController, IPXLabelBarButtonItem, IPXLibrary, NSButton, NSString, NSTextField, UXView;
...
@property BOOL assetsViewControllerNeedsUpdate; // @synthesize assetsViewControllerNeedsUpdate=_assetsViewControllerNeedsUpdate;
@property BOOL assetsViewControllerIsReloading; // @synthesize assetsViewControllerIsReloading=_assetsViewControllerIsReloading;
