...
@class IPXAssetTransitionItem, IPXDatabaseObjectsController, IPXEditorialModel, NSArray, NSEvent, NSImage, NSString, NSView, PFDispatchQueue, UXView;
...
- (NSArray *)debugMenuItemsForObject:(id)arg1;
- (void)openObjects:(NSArray *)arg1 withEvent:(NSEvent *)arg2 forEditing:(BOOL)arg3;
- (BOOL)shouldSelectObject:(id)arg1;
- (void)userDidSelectCaptionControl;
- (void)userDidSelectDisclosureControl;
- (NSArray *)versionsForObjects:(NSArray *)arg1;
