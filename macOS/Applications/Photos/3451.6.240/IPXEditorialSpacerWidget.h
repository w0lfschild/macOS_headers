...
@class IPXAssetTransitionItem, IPXDatabaseObjectsController, IPXEditorialModel, NSString, NSView, PFDispatchQueue, UXView;
@protocol IPXEditorialWidgetDelegate;

@interface IPXEditorialSpacerWidget : NSObject <IPXEditorialWidget>
{
...
@property(readonly, nonatomic) NSView *spacerView; // @synthesize spacerView=_spacerView;
