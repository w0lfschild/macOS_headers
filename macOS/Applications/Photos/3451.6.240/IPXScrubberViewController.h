...
- (void)scrubber:(id)arg1 didReplaceDataSource:(id)arg2 withDataSource:(id)arg3 selectedItem:(id)arg4;
- (void)scrubberVideoScrubberControllerDidChange:(id)arg1;
- (void)adjustTileItemIdentifiersForDataSource:(id)arg1 replacedWithOldDataSource:(id)arg2;
- (void)scrubber:(id)arg1 didReplaceDataSource:(id)arg2 withDataSource:(id)arg3;
