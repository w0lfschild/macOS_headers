...
@protocol IPXSharedBrowserModelDelegate;

@interface IPXSharedBrowserModel : IPXBrowserModel <SBLSharedServicesManagerReceiver, IPXObjectsControllerChangeReceiver, PFURLHandlingSubsystem>
{
    id <IPXSharedBrowserModelDelegate> _delegate;
...
+ (CDUnknownBlockType)modelComparator;
...
@property(nonatomic) __weak id <IPXSharedBrowserModelDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)navigateToSharedStream:(id)arg1;
- (void)navigateToActivityView;
