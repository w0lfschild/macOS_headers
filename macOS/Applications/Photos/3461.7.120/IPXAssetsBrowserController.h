...
@class IPXAssetsViewController, NSArray, NSString;
...
- (BOOL)validateToggleMediaPlaybackForMenuItem:(id)arg1;
...
@property(readonly, nonatomic) IPXAssetsViewController *assetsViewController;
- (void)dealloc;
