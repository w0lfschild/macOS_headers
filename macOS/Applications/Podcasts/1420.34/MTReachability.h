...
#import "_TtP8Podcasts20ReachabilityProtocol_-Protocol.h"

@class ITMReachability, NSHashTable, RadiosPreferences;
@protocol OS_dispatch_queue;

@interface MTReachability : NSObject <_TtP8Podcasts20ReachabilityProtocol_, RadiosPreferencesDelegate>
{
