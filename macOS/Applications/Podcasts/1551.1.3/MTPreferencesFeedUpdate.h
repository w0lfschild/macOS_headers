...
+ (id)getCompanionSubscriptionSyncRevisionNumberForSyncType:(long long)arg1;
...
+ (void)removeCompanionSubscriptionSyncRevisionStringForSyncType:(long long)arg1;
+ (void)setCompanionSubscriptionSyncRevisionString:(id)arg1 syncType:(long long)arg2;
