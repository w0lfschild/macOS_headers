...
+ (void)allEpisodesMigrationForVersion40to41In:(id)arg1;
+ (void)allEpisodesMigrationForVersion39to40In:(id)arg1;
+ (void)runMigrationOnAllEpisodesForVersion:(long long)arg1;
...
+ (void)podcastMigrationForVersion34to35:(id)arg1;
+ (void)podcastMigrationForVersion35to36:(id)arg1;
+ (void)podcastMigrationForVersion36to37:(id)arg1;
+ (void)podcastMigrationForVersion38to39:(id)arg1;
