...
#import "NSToolbarDelegateToBeAPI-Protocol.h"
...
@interface PVWindowController : NSWindowController <PDFPageVisibilityDelegate, NSSearchFieldDelegate, NSTextFieldDelegate, NSToolbarDelegateToBeAPI, PDFViewDelegate, PVC3DCameraElementDelegate, PVTextSearchQueryDelegate, PVEventInterceptorDelegate, NSOpenSavePanelDelegate, PVTransitionOverlayViewDelegate, NSSharingServiceDelegate, NSMenuDelegate, AKControllerDelegateProtocol, PDFAKControllerDelegateProtocol, NSTouchBarProvider>
{
    ...
    NSButton *_slideshowBackButton;
    NSButton *_slideshowForwardButton;
    NSButton *_slideshowPlayPauseButton;
    NSButton *_slideshowExitButton;
    ...
    BOOL _inPDFPageChangedNotification;
    NSTimer *_updateThumbnailSelectionTimer;
    ...
    CDUnknownBlockType _enterFullScreenCompletionHandler;
    CDUnknownBlockType _exitFullScreenCompletionHandler;
    ...
    PVScrollViewMasking *_scrollViewMasking;
}
...
+ (void)initialize;
- (void).cxx_destruct;
@property(retain, nonatomic) PVScrollViewMasking *scrollViewMasking; // @synthesize scrollViewMasking=_scrollViewMasking;
...
@property(copy, nonatomic) CDUnknownBlockType exitFullScreenCompletionHandler; // @synthesize exitFullScreenCompletionHandler=_exitFullScreenCompletionHandler;
@property(copy, nonatomic) CDUnknownBlockType enterFullScreenCompletionHandler; // @synthesize enterFullScreenCompletionHandler=_enterFullScreenCompletionHandler;
...
- (id)searchField;
- (void)exitContactSheetToViewMode:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
- (void)enterContactSheetModeWithCompletionHandler:(CDUnknownBlockType)arg1;
...
- (void)setViewMode:(long long)arg1 animated:(BOOL)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
