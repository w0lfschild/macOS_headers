...
@class NSArray, NSDictionary, NSMutableArray, NSMutableSet, NSSet, NSString, PDFDocument, PVAKModelReceptionist, PVPrintSettingsSidecar;

@interface PVPDFPageContainer : PVMediaContainerBase <PDFDocumentDelegate>
{
...
@property(readonly) BOOL isPDFDocumentLocked; // @synthesize isPDFDocumentLocked=_isPDFDocumentLocked;
...
- (BOOL)checkForPermissions:(unsigned int)arg1;
...
@property(retain) PVAKModelReceptionist *annotationSelectionController; // @dynamic annotationSelectionController;
