...
@property BOOL usesPageLabels; // @synthesize usesPageLabels=_usesPageLabels;
...
- (void)setZoomFactor:(double)arg1 withCenter:(struct CGPoint)arg2 animate:(BOOL)arg3 stickyFit:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
