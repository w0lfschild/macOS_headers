...
@property(readonly, retain) SCNSceneSource *sceneSource; // @synthesize sceneSource=_sceneSource;
...
- (BOOL)isPDFContainer;
- (id)authoringTool;
@property(readonly, retain) SCNRenderer *cameraSharedThumbnailRenderer;
