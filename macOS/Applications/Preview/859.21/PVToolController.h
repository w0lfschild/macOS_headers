...
@property(readonly) PVWindowController *windowController; // @synthesize windowController=_windowController;
...
- (BOOL)_isToolEnabledForTag:(long long)arg1;
- (BOOL)_isToolEnabledForSender:(id)arg1;
