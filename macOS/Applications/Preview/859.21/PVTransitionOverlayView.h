...
@class CAAnimation, CALayer, NSMapTable;
...
+ (void)initialize;
@property(nonatomic) id <PVTransitionOverlayViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(readonly) id currentFromElement; // @synthesize currentFromElement=_currentFromElement;
@property(readonly) id currentToElement; // @synthesize currentToElement=_currentToElement;
