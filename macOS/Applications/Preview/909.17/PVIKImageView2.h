...
@class CALayer, NSArray, NSColor, NSCursor, NSMutableArray, NSObject, NSString, NSTrackingArea, PVFloatingStringPanel, PVIVSelection, PVImageContainer, PVImageElement, Profile;
@protocol PVContentViewDelegate;
...
{
    id <PVContentViewDelegate> _delegate;
...
- (struct CGPoint)distanceToAlignAnnotationBounds:(struct CGRect)arg1 withAnnotations:(id)arg2;
