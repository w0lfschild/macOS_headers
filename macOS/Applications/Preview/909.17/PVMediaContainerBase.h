...
@class AKController, IKSaveOptions, NSArray, NSDictionary, NSMapTable, NSMutableSet, NSPrintInfo, NSString, NSTimer, NSURL, NSUUID, PVImageSizeCalculator, PVWindowController;
...
@interface PVMediaContainerBase : NSDocument <PVMediaContainer, AKControllerDelegateProtocol>
{
    ...
    long long _logFirstBadStateToken;
...
+ (BOOL)_isIBooksICloudDriveFileURL:(id)arg1;
