...
#import "PVContentViewDelegate-Protocol.h"
...
@interface PVWindowController : NSWindowController <PDFPageVisibilityDelegate, NSTextFieldDelegate, NSToolbarDelegate, PVContentViewDelegate, PDFViewDelegate, PVC3DCameraElementDelegate, PVTextSearchQueryDelegate, PVEventInterceptorDelegate, NSOpenSavePanelDelegate, PVTransitionOverlayViewDelegate, NSSharingServiceDelegate, NSMenuDelegate, AKControllerDelegateProtocol, NSTouchBarProvider>
{
    ...
    id _loadedAnnotationSelectionChangeAdditionObserver;
    id _loadedAnnotationSelectionChangeRemovalObserver;
...
- (void)pdfViewTilesFinishedDrawing:(id)arg1;
- (void)_callEnsureAnnotationsAreLoaded;
