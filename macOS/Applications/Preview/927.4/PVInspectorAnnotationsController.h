...
@class AKNoteAnnotation, NSArray, NSMapTable, NSMutableArray, NSObjectController, NSString, NSTableView, NSTextView, PVClickableTextField;

@interface PVInspectorAnnotationsController : NSObject <NSTextViewDelegate>
{
    NSObjectController *_inspectedWindowController;
    NSObjectController *_inspectedMediaContainer;
