...
+ (void)logWindowState26858779withLastSetStack:(id)arg1 lastClearedStack:(id)arg2 lastOperation:(unsigned long long)arg3 situation:(unsigned long long)arg4 documentsOnParent:(unsigned long long)arg5 documentsOnPassedIn:(unsigned long long)arg6 parentWindowControllerIsKnown:(BOOL)arg7 passedInWindowControllerIsKnown:(BOOL)arg8 passedInWindowControllerClassName:(id)arg9;
+ (BOOL)canLogDebugWindowStateDebugging;
