...
@property(retain, nonatomic) NSVisualEffectView *windowBackgroundMaterialVisualEffectView; // @synthesize windowBackgroundMaterialVisualEffectView=_windowBackgroundMaterialVisualEffectView;
