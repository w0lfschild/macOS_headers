...
@class AVAsset, AVPlayer, AVPlayerController, AVPlayerItem, MGAssetCache, MGDocumentSaveContext, MGDocumentViewController, MGMediaClipPreviewProvider, MGMediaComposition, MGMediaCompositionEditController, MGMediaCompositionPlayerItemController, MGMediaCompositionSelectionController, MGMediaCompositionUndoController, MGPlayerDocumentDRMHandler, MGSavePanelViewController, NSArray, NSMutableArray, NSMutableSet, NSString, NSWindowController;
