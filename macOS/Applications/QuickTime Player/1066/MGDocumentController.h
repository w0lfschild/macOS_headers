...
@interface MGDocumentController : NSDocumentController <NSMenuDelegate, NSOpenSavePanelDelegate>
{
    ...
    unsigned long long _numberOfPlayerDocumentsOpen;
    ...
    long long _activeScreenRecordingCount;
...
- (id)openNewRecordingDocumentWithRecordingType:(unsigned long long)arg1;
...
- (void)_decrementActiveScreenRecordingCount;
- (void)_incrementActiveScreenRecordingCount;
- (BOOL)hasActiveScreenRecordings;
