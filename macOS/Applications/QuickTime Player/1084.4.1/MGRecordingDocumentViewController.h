...
#import "AVVolumeControlViewDelegate-Protocol.h"
#import "MGVisualContentContainer-Protocol.h"
#import "NSMenuDelegate-Protocol.h"

@class AVAudioLevelIndicatorView, AVVolumeControlSlider, NSButton, NSMenu, NSString, NSTextField, NSView;

@interface MGRecordingDocumentViewController : MGDocumentViewController <NSMenuDelegate, AVVolumeControlViewDelegate, MGVisualContentContainer>
{
    ...
    NSButton *_captureOptionsButton;
...
@property(readonly, nonatomic) NSButton *captureOptionsButton; // @synthesize captureOptionsButton=_captureOptionsButton;
...
- (id)_documentIfAudioOnlyRecordingDocument;
