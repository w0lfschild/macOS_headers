...
@class MGAtomicCancelationToken, MGAudioAmplitudeExtractionSession;
...
- (void)invalidate;
- (id)init;
- (id)initWithOwner:(id)arg1 forAsset:(id)arg2 numberOfChannels:(unsigned long long)arg3 numberOfAmplitudeSamplesPerSecond:(unsigned long long)arg4;
