...
@class AVPlayerController, AVPlayerControllerTimeResolver, MGMediaCompositionEditController, MGMediaCompositionViewController, NSDocument, NSView;
...
@property(retain, nonatomic) MGMediaCompositionEditController *compositionEditController; // @synthesize compositionEditController=_compositionEditController;
