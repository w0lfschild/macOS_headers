...
@class MGCaptureDeviceAndInputSourceSelectionController, NSButton, NSPopUpButton, NSString, NSTextField, NSTimer;

@interface MGAudioOnlyRecordingDocumentViewController : MGRecordingDocumentViewController <NSMenuDelegate>
{
...
@property(retain) MGCaptureDeviceAndInputSourceSelectionController *deviceSelectionController; // @synthesize deviceSelectionController=_deviceSelectionController;
- (void).cxx_destruct;
