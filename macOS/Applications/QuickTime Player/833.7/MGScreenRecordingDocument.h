...
@class AVCaptureScreenInput, AVPlayer, CALayer, MGCaptureAudioPreviewOutput, MGCaptureCompressionPreset, MGCaptureDeviceSelectionController, MGScreenRecordingDocumentViewController, MGScreenSelector, NSArray, NSObject, NSScreen, NSStatusItem, NSString, NSURL, NSWindow;
