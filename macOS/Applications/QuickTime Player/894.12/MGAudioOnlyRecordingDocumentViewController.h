...
@class AVFunctionBarRecordingControlsProvider, NSButton, NSString, NSTextField, NSTimer;
...
- (id)touchBar;
- (BOOL)_isFunctionBarRecordingControlsProviderLoaded;
- (id)_functionBarRecordingControlsProvider;
- (void)close;
- (void)loadView;
