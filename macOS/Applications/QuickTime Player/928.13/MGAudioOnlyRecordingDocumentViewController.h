...
@class AVTouchBarRecordingControlsProvider, NSButton, NSString, NSTextField, NSTimer;
...
- (id)touchBar;
- (BOOL)_isTouchBarRecordingControlsProviderLoaded;
- (id)_touchBarRecordingControlsProvider;
- (void)close;
- (void)loadView;
