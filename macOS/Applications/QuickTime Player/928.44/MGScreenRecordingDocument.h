...
@interface MGScreenRecordingDocument : MGRecordingDocument <MGInspectionAttributeContainer, MGScreenSelectorDelegate, NSMenuDelegate>
{
    ...
    AVTouchBarCaptureInputSourceItem *_selectedScreenCaptureInputSourceItem;
    AVTouchBarCaptureInputSourceItem *_selectionScreenCaptureInputSourceItem;
    AVTouchBarCaptureInputSourceItem *_builtInScreenCaptureInputSourceItem;
...
@property(retain) AVTouchBarCaptureInputSourceItem *selectedScreenTouchBarInputSourceItem; // @synthesize selectedScreenTouchBarInputSourceItem;
@property(retain) NSArray *screenTouchBarInputSourceItems; // @synthesize screenTouchBarInputSourceItems;
- (void).cxx_destruct;
...
- (void)reloadScreenTouchBarInputSourceItems;
- (void)applicationDidChangeScreenParameters:(id)arg1;
- (BOOL)isTouchBarRecordingControlsProviderLoaded;
...
- (void)dismissModalTouchBar;
- (void)presentModalTouchBar;
