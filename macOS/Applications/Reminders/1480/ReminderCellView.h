...
@class CardContentViewController, DelayedHoverButton, EKEditingContext, EKReminder, NSButton, NSImageView, NSLayoutConstraint, NSMutableArray, NSStackView, NSString, RemindersShadowTextField, ShadowTextField;
...
@interface ReminderCellView : DelayedHoverButtonTableCellView <ResizeableEditingFieldDelegate>
{
    ...
    NSLayoutConstraint *_proximityGlyphInset;
...
@property(retain) NSLayoutConstraint *proximityGlyphInset; // @synthesize proximityGlyphInset=_proximityGlyphInset;
