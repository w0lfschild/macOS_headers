...
@class NSArray, NSButton, NSStackView, NSTextField, _TtC9Reminders16TTRListBadgeView;
...
@property(nonatomic) __weak _TtC9Reminders16TTRListBadgeView *badge; // @synthesize badge;
