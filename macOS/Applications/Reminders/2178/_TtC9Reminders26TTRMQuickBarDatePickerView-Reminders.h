...
#import "_TtC9Reminders26TTRMQuickBarDatePickerView.h"

#import "TTRMDatePickerWithMiniCalDelegate-Protocol.h"

@interface _TtC9Reminders26TTRMQuickBarDatePickerView (Reminders) <TTRMDatePickerWithMiniCalDelegate>
- (id)startDate;
