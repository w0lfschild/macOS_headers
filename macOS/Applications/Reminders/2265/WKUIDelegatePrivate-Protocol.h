...
@class NSArray, NSData, NSDictionary, NSEvent, NSString, NSURL, WKFrameInfo, WKNavigationAction, WKSecurityOrigin, WKWebView, WKWebViewConfiguration, WKWindowFeatures, _WKAttachment, _WKWebAuthenticationPanel;
