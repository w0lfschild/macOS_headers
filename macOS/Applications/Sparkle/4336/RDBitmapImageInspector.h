...
@class NSButton, NSImageView, NSSegmentedControl, NSString, NSTextField, RDAssetReference, RDResolutionReportView;

@interface RDBitmapImageInspector : RDInspectorSectionViewController <RDDroppableViewProtocol>
{
    ...
    RDResolutionReportView *_resolutionReportView;
...
@property(nonatomic) __weak RDResolutionReportView *resolutionReportView; // @synthesize resolutionReportView=_resolutionReportView;
