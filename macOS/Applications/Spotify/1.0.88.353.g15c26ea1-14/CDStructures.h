...
struct BrowserClientMac {
    ...
    _Bool _field6;
    struct scoped_refptr<CefBrowser> _field7;
    struct scoped_refptr<spotify::desktop::ControlMessageHandler> _field8;
    struct scoped_refptr<spotify::desktop::DisplayHandler> _field9;
    struct scoped_refptr<spotify::desktop::DevToolsHandler> _field10;
    struct scoped_refptr<CefContextMenuHandler> _field11;
    ...
    struct AppDelegateImpl _field25;
    _Bool _field26;
    basic_string_805fe43b _field27;
    ...
    struct unordered_map<std::__1::basic_string<char>, spotify::desktop::BrowserClient::AppCrashStats, std::__1::hash<std::__1::basic_string<char>>, std::__1::equal_to<std::__1::basic_string<char>>, std::__1::allocator<std::__1::pair<const std::__1::basic_string<char>, spotify::desktop::BrowserClient::AppCrashStats>>> _field36;
    ...
    struct function<void ()> _field43;
    _Bool _field44;
    _Bool _field45;
    _Bool _field46;
    struct CefRefCount _field47;
    struct Lock _field48;
    struct NotificationBroadcaster _field49;
    vector_89351b1b _field50;
    struct PlayerState _field51;
    struct mutex _field52;
    id _field53;
};
...
struct CoreHandler {
    ...
    _Bool _field3;
    _Bool _field4;
    struct signal<void (spotify::client::Session *, spotify::hermes::HermesHandler *, const boost::system::error_code &, bool), boost::signals2::optional_last_value<void>, int, std::__1::less<int>, boost::function<void (spotify::client::Session *, spotify::hermes::HermesHandler *, const boost::system::error_code &, bool)>, boost::function<void (const boost::signals2::connection &, spotify::client::Session *, spotify::hermes::HermesHandler *, const boost::system::error_code &, bool)>, boost::signals2::mutex> _field5;
