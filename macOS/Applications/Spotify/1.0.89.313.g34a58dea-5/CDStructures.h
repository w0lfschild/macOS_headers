...
struct BrowserClientMac {
    ...
    struct scoped_refptr<spotify::desktop::ControlMessageHandler> _field4;
...
struct CoreHandler {
    ...
    _Bool _field3;
    _Bool _field4;
    struct signal<void (spotify::client::Session *, spotify::hermes::HermesHandler *, const boost::system::error_code &), boost::signals2::optional_last_value<void>, int, std::__1::less<int>, boost::function<void (spotify::client::Session *, spotify::hermes::HermesHandler *, const boost::system::error_code &)>, boost::function<void (const boost::signals2::connection &, spotify::client::Session *, spotify::hermes::HermesHandler *, const boost::system::error_code &)>, boost::signals2::mutex> _field5;
    ...
    struct signal<void (const spotify::spos::SposDict &), boost::signals2::optional_last_value<void>, int, std::__1::less<int>, boost::function<void (const spotify::spos::SposDict &)>, boost::function<void (const boost::signals2::connection &, const spotify::spos::SposDict &)>, boost::signals2::mutex> _field7;
    struct SposDict _field8;
    basic_string_805fe43b _field9;
    _Bool _field10;
    struct function<void (spotify::client::Core *)> _field11;
    struct unique_ptr<spotify::desktop::audio::DriverManager, std::__1::default_delete<spotify::desktop::audio::DriverManager>> _field12;
    struct unique_ptr<spotify::desktop::CollectionFollowedArtistsHelper, std::__1::default_delete<spotify::desktop::CollectionFollowedArtistsHelper>> _field13;
    struct shared_ptr<void> _field14;
    struct CoreCreateOptions _field15;
    struct unique_ptr<spotify::desktop::CoreSessionState, std::__1::default_delete<spotify::desktop::CoreSessionState>> _field16;
    struct unique_ptr<spotify::desktop::SessionStatePersister, std::__1::default_delete<spotify::desktop::SessionStatePersister>> _field17;
    struct function<std::__1::shared_ptr<void>(const spotify::cosmos::Request &, const std::__1::function<void (spotify::cosmos::Response)>&)> _field18;
    struct function<std::__1::shared_ptr<void>(const spotify::cosmos::Request &, const std::__1::function<void (spotify::cosmos::Response)>&)> _field19;
    struct unique_ptr<spotify::desktop::MicroCosmosResolvers, std::__1::default_delete<spotify::desktop::MicroCosmosResolvers>> _field20;
    ...
    struct mutex _field44;
    struct time_point<std::__1::chrono::system_clock, std::__1::chrono::duration<long long, std::__1::ratio<1, 1000000>>> _field45;
    struct unique_ptr<spotify::abba::FeatureFlags, std::__1::default_delete<spotify::abba::FeatureFlags>> _field46;
    struct mutex _field47;
};
...
struct scoped_refptr<spotify::desktop::ControlMessageHandler> {
    struct ControlMessageHandler *_field1;
};
