...
struct CoreCreateOptions {
    ...
    struct function<void (const std::__1::basic_string<char>&)> _field9;
    _Bool _field10;
};
...
struct CoreHandler {
    ...
    struct unique_ptr<spotify::abba::FeatureFlags, std::__1::default_delete<spotify::abba::FeatureFlags>> _field48;
