...
struct CoreHandler {
    ...
    struct unique_ptr<sp::BridgeLogger, std::__1::default_delete<sp::BridgeLogger>> _field20;
    ...
    struct unique_ptr<spotify::desktop::FeatureFlagsManager, std::__1::default_delete<spotify::desktop::FeatureFlagsManager>> _field43;
    struct PlayerDelegate _field44;
    struct mutex _field45;
    struct time_point<std::__1::chrono::system_clock, std::__1::chrono::duration<long long, std::__1::ratio<1, 1000000>>> _field46;
...
struct weak_ptr<boost::signals2::detail::connection_body_base> {
    struct connection_body_base *_field1;
