...
struct CoreHandler {
    ...
    struct signal<void (spotify::connectivity::auth::Session *, spotify::hermes::HermesHandler *, const boost::system::error_code &), spotify::signals::optional_last_value<void>, int, std::__1::less<int>> _field6;
...
struct signal<void (spotify::connectivity::auth::Session *, spotify::hermes::HermesHandler *, const boost::system::error_code &), spotify::signals::optional_last_value<void>, int, std::__1::less<int>> {
    struct shared_ptr<void> _field1;
    struct mutex _field2;
    struct slot_vector _field3;
    struct optional_last_value<void> _field4;
