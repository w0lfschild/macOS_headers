...
struct ApplicationScopeStack {
    struct unique_ptr<spotify::desktop::remote_config::Fetcher, std::__1::default_delete<spotify::desktop::remote_config::Fetcher>> _field1;
    struct unique_ptr<spotify::desktop::remote_config::Resolver, std::__1::default_delete<spotify::desktop::remote_config::Resolver>> _field2;
};
...
struct CoreHandler {
    ...
    _Bool _field4;
    struct signal<void (), spotify::signals::optional_last_value<void>, int, std::__1::less<int>> _field5;
    struct signal<void (spotify::connectivity::auth::Session *, spotify::hermes::HermesHandler *, const std::__1::error_code &), spotify::signals::optional_last_value<void>, int, std::__1::less<int>> _field6;
    struct signal<void (), spotify::signals::optional_last_value<void>, int, std::__1::less<int>> _field7;
    basic_string_23d93216 _field8;
    _Bool _field9;
    struct unique_ptr<spotify::desktop::audio::DriverManager, std::__1::default_delete<spotify::desktop::audio::DriverManager>> _field10;
    struct unique_ptr<spotify::desktop::CollectionFollowedArtistsHelper, std::__1::default_delete<spotify::desktop::CollectionFollowedArtistsHelper>> _field11;
    struct CoreCreateOptions _field12;
    struct unique_ptr<spotify::client::Core, std::__1::default_delete<spotify::client::Core>> _field13;
    ...
    struct CosmosHandler _field17;
    struct unique_ptr<spotify::desktop::voice::VoiceController, std::__1::default_delete<spotify::desktop::voice::VoiceController>> _field18;
    struct unique_ptr<spotify::desktop::NetworkNotifier, std::__1::default_delete<spotify::desktop::NetworkNotifier>> _field19;
    struct scoped_connection _field20;
    struct unique_ptr<sp::BridgeLogger, std::__1::default_delete<sp::BridgeLogger>> _field21;
    struct unique_ptr<spotify::desktop::BridgeDelegate, std::__1::default_delete<spotify::desktop::BridgeDelegate>> _field22;
    ...
    struct map<std::__1::basic_string<char>, boost::optional<std::__1::basic_string<char>>, std::__1::less<std::__1::basic_string<char>>, std::__1::allocator<std::__1::pair<const std::__1::basic_string<char>, boost::optional<std::__1::basic_string<char>>>>> _field25;
    struct scoped_connection _field26;
    ...
    struct unique_ptr<spotify::desktop::LoginManager, std::__1::default_delete<spotify::desktop::LoginManager>> _field41;
    struct ApplicationScopeStack _field42;
...
struct unique_ptr<spotify::desktop::remote_config::Fetcher, std::__1::default_delete<spotify::desktop::remote_config::Fetcher>> {
    struct __compressed_pair<spotify::desktop::remote_config::Fetcher *, std::__1::default_delete<spotify::desktop::remote_config::Fetcher>> {
        struct Fetcher *_field1;
    } _field1;
};

struct unique_ptr<spotify::desktop::remote_config::Resolver, std::__1::default_delete<spotify::desktop::remote_config::Resolver>> {
    struct __compressed_pair<spotify::desktop::remote_config::Resolver *, std::__1::default_delete<spotify::desktop::remote_config::Resolver>> {
