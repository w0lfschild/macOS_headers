...
struct AudioRoutingArbiterClient;

struct AutomaticLogSink;
...
struct BrowserClientMac {
    ...
    struct unique_ptr<spotify::desktop::AudioRoutingArbiterClient, std::__1::default_delete<spotify::desktop::AudioRoutingArbiterClient>> _field41;
    struct PlayerState _field42;
    struct mutex _field43;
    id _field44;
};
...
struct ClientTokenHandler;

struct ClientTokenStorage;
...
struct CoreHandler {
    ...
    struct shared_ptr<void> _field41;
    ...
    struct shared_ptr<spotify::event_sender::EventSenderHttp> _field48;
    struct unique_ptr<spotify::desktop::EventOwnerProviderImpl, std::__1::default_delete<spotify::desktop::EventOwnerProviderImpl>> _field49;
    struct shared_ptr<spotify::desktop::ClientTokenStorage> _field50;
    struct unique_ptr<spotify::desktop::ClientTokenHandler, std::__1::default_delete<spotify::desktop::ClientTokenHandler>> _field51;
    struct weak_ptr<spotify::desktop::AutomaticLogSink> _field52;
    struct unique_ptr<spotify::desktop::LogSessionManager, std::__1::default_delete<spotify::desktop::LogSessionManager>> _field53;
};
...
struct shared_ptr<spotify::desktop::ClientTokenStorage> {
    struct ClientTokenStorage *_field1;
    struct __shared_weak_count *_field2;
};
...
struct unique_ptr<spotify::desktop::AudioRoutingArbiterClient, std::__1::default_delete<spotify::desktop::AudioRoutingArbiterClient>> {
    struct __compressed_pair<spotify::desktop::AudioRoutingArbiterClient *, std::__1::default_delete<spotify::desktop::AudioRoutingArbiterClient>> {
        struct AudioRoutingArbiterClient *_field1;
    } _field1;
};
...
struct unique_ptr<spotify::desktop::ClientTokenHandler, std::__1::default_delete<spotify::desktop::ClientTokenHandler>> {
    struct __compressed_pair<spotify::desktop::ClientTokenHandler *, std::__1::default_delete<spotify::desktop::ClientTokenHandler>> {
        struct ClientTokenHandler *_field1;
    } _field1;
};
...
struct unique_ptr<spotify::desktop::EventOwnerProviderImpl, std::__1::default_delete<spotify::desktop::EventOwnerProviderImpl>> {
    struct __compressed_pair<spotify::desktop::EventOwnerProviderImpl *, std::__1::default_delete<spotify::desktop::EventOwnerProviderImpl>> {
        struct EventOwnerProviderImpl *_field1;
    } _field1;
};

struct unique_ptr<spotify::desktop::LogSessionManager, std::__1::default_delete<spotify::desktop::LogSessionManager>> {
    struct __compressed_pair<spotify::desktop::LogSessionManager *, std::__1::default_delete<spotify::desktop::LogSessionManager>> {
        struct LogSessionManager *_field1;
    } _field1;
};
...
struct weak_ptr<spotify::desktop::AutomaticLogSink> {
    struct AutomaticLogSink *_field1;
    struct __shared_weak_count *_field2;
};
