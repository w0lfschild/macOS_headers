...
struct CoreHandler {
    ...
    struct unique_ptr<spotify::desktop::LoginManager, std::__1::default_delete<spotify::desktop::LoginManager>> _field46;
    struct unique_ptr<spotify::desktop::FeatureFlagsManager, std::__1::default_delete<spotify::desktop::FeatureFlagsManager>> _field47;
    struct PlayerDelegate _field48;
    struct mutex _field49;
    struct time_point<std::__1::chrono::system_clock, std::__1::chrono::duration<long long, std::__1::ratio<1, 1000000>>> _field50;
    basic_string_23d93216 _field51;
};
