...
+ (id)glyphImageNamed:(id)arg1;
- (id)coloredTemplateWithSize:(struct CGSize)arg1 fromRect:(struct CGRect)arg2 withTemplateColor:(id)arg3;
- (id)coloredTemplateWithTemplateColor:(id)arg1;
