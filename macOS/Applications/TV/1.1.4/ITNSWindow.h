...
@interface ITNSWindow : NSWindow
{
    ...
    int _lastDragResult;
    vector_8405b5fc _touchBarITButtons;
}

- (id).cxx_construct;
- (void).cxx_destruct;
- (void)setTouchBarButtons:(const vector_8405b5fc *)arg1 defaultButton:(shared_ptr_f58a763f)arg2 cancelButton:(shared_ptr_f58a763f)arg3 addSpaceAfterLeadingButton:(BOOL)arg4;
...
@property(nonatomic) double nativeControlOpacity;
