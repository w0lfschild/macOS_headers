...
@property(nonatomic) BOOL fullscreenPadding; // @synthesize fullscreenPadding=_fullscreenPadding;
...
- (void)keyModifiersChanged:(struct __CGEvent *)arg1;
...
- (unsigned long long)paddingForAction:(unsigned long long)arg1;
