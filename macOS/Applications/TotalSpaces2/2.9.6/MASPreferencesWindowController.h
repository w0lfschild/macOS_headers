...
@class NSArray, NSMutableDictionary, NSString, NSViewController<MASPreferencesViewController>;
...
- (id)menuPreferencesViewController;
- (id)appBindingsPreferencesViewController;
- (id)generalPreferencesViewController;
- (id)layoutPreferencesViewController;
