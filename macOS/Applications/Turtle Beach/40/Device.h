...
@property BOOL hasLightXU; // @synthesize hasLightXU=_hasLightXU;
...
@property BOOL requirePowerUp; // @synthesize requirePowerUp=_requirePowerUp;
...
@property(retain, nonatomic) HIDDevice *hidDevice; // @synthesize hidDevice;
@property(nonatomic) void *libUsbDevice_ptr; // @synthesize libUsbDevice_ptr;
...
- (id)addReportId:(long long)arg1 withCommand:(id)arg2;
- (BOOL)writeParamFinish:(id)arg1;
- (id)writeReadVerifyForLightXU:(id)arg1;
- (id)readFirmwareVersionForLightXU;
- (id)readFirmwareVersion;
- (id)readBytes:(long long)arg1;
- (id)readBytes;
