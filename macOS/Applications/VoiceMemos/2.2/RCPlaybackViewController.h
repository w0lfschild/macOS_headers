...
@interface RCPlaybackViewController : RCRecordingViewController
{
    ...
    UIBarButtonItem *_favoriteButtonItem;
    ...
    UIBarButtonItem *_moveToFolderButtonItem;
}

- (void).cxx_destruct;
@property(nonatomic) BOOL needsExtraSpace; // @synthesize needsExtraSpace=_needsExtraSpace;
@property(retain, nonatomic) UIBarButtonItem *moveToFolderButtonItem; // @synthesize moveToFolderButtonItem=_moveToFolderButtonItem;
...
@property(retain, nonatomic) UIBarButtonItem *favoriteButtonItem; // @synthesize favoriteButtonItem=_favoriteButtonItem;
