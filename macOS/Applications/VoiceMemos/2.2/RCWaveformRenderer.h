...
@interface RCWaveformRenderer : UIViewController <RCWaveformDataSourceObserver, RCDisplayLinkObserver, CAAnimationDelegate>
{
    ...
    BOOL _calcBlockShouldRefreshAllSlices;
...
@property BOOL waitForFinalCalc; // @synthesize waitForFinalCalc=_waitForFinalCalc;
...
@property(nonatomic) BOOL calcBlockShouldRefreshAllSlices; // @synthesize calcBlockShouldRefreshAllSlices=_calcBlockShouldRefreshAllSlices;
...
- (double)_timeForPointOffset:(double)arg1;
- (double)_timeForPointOffset:(double)arg1 withVisibleTimeRange:(CDStruct_73a5d3ca)arg2;
- (double)_pointOffsetForTime:(double)arg1;
