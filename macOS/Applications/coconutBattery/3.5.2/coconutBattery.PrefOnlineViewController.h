...
@interface coconutBattery.PrefOnlineViewController : NSViewController
{
    // Error parsing type: , name: hasResizableWidth
    // Error parsing type: , name: hasResizableHeight
    // Error parsing type: , name: autoUploadCheckBox
}

- (CDUnknownBlockType).cxx_destruct;
- (id)initWithCoder:(id)arg1;
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;
- (void)setAutoUpload:(id)arg1;
- (void)viewWillAppear;
@property(nonatomic) __weak NSButton *autoUploadCheckBox; // @synthesize autoUploadCheckBox;
- (void)viewDidLoad;
