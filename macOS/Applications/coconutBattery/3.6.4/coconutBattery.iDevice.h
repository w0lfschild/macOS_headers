...
@class NSDictionary, NSMutableDictionary, NSString, NSTimer, OS_dispatch_queue, _TtC14coconutBattery18CCBiOSDetailViewer;
...
@interface coconutBattery.iDevice : NSObject
{
    ...
    // Error parsing type: , name: hideTimeOutWarning
...
- (void)getData;
@property(nonatomic, readonly) OS_dispatch_queue *iOSQueue; // @synthesize iOSQueue;
- (void)startTimer;
- (void)establishConnectionWithRef:(struct am_device *)arg1;
- (id)listConnections;
- (id)getSavingData;
- (id)facilityfromSerial;
...
@property(nonatomic, retain) NSMutableDictionary *batteryData; // @synthesize batteryData;
@property(nonatomic, retain) NSMutableDictionary *deviceData; // @synthesize deviceData;
...
@property(nonatomic) BOOL hideTimeOutWarning; // @synthesize hideTimeOutWarning;
