...
@interface CHFileChecksumAuthorizationList : PBGeneratedMessage
{
    NSMutableArray *fileChecksumAuthorizationArray;
}
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *fileChecksumAuthorizationArray; // @synthesize fileChecksumAuthorizationArray;
- (void).cxx_destruct;
...
@property(readonly) NSArray *fileChecksumAuthorization; // @dynamic fileChecksumAuthorization;
- (id)defaultInstance;
- (id)init;
