...
@interface CHMethodCompletionInfoList : PBGeneratedMessage
{
    NSMutableArray *methodCompletionInfoArray;
}
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *methodCompletionInfoArray; // @synthesize methodCompletionInfoArray;
- (void).cxx_destruct;
...
@property(readonly) NSArray *methodCompletionInfo; // @dynamic methodCompletionInfo;
- (id)defaultInstance;
- (id)init;
