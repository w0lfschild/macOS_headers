...
@interface CHStorageContainerChunkLists : PBGeneratedMessage
{
    unsigned int hasVerbosityLevel_:1;
    unsigned int verbosityLevel;
    NSMutableArray *storageContainerChunkListArray;
...
@property(retain) NSMutableArray *storageContainerChunkListArray; // @synthesize storageContainerChunkListArray;
- (void).cxx_destruct;
...
@property(readonly) NSArray *storageContainerChunkList; // @dynamic storageContainerChunkList;
- (id)defaultInstance;
- (id)init;
