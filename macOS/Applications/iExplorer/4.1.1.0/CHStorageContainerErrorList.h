...
@interface CHStorageContainerErrorList : PBGeneratedMessage
{
    NSMutableArray *storageContainerErrorArray;
}
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *storageContainerErrorArray; // @synthesize storageContainerErrorArray;
- (void).cxx_destruct;
...
@property(readonly) NSArray *storageContainerError; // @dynamic storageContainerError;
- (id)defaultInstance;
- (id)init;
