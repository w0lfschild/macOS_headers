...
@interface FontInformation : PBGeneratedMessage
{
    unsigned int hasValue_:1;
    unsigned int hasFontName_:1;
    long long value;
    NSString *fontName;
}
...
@property(retain) NSString *fontName; // @synthesize fontName;
- (void).cxx_destruct;
