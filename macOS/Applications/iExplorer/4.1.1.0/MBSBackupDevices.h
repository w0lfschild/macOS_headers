...
@interface MBSBackupDevices : PBGeneratedMessage
{
    unsigned int hasAccountId_:1;
    NSString *accountId;
    NSMutableArray *backupUdidsArray;
}
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *backupUdidsArray; // @synthesize backupUdidsArray;
...
@property(readonly) NSArray *backupUdids; // @dynamic backupUdids;
- (id)defaultInstance;
- (id)init;
