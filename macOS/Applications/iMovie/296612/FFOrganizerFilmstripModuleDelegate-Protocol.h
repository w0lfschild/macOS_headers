...
@class FFAnchoredTimeMarker, FFEditorModule, FFProject, FigTimeRangeAndObject, LKMenu, NSArray, NSError, NSObject, NSPopover, NSProView, OKPaneCapItem;
...
- (void)shouldShowSearchUI:(NSObject<FFOrganizerMediaDetailSearchHeaderDelegate> *)arg1;
