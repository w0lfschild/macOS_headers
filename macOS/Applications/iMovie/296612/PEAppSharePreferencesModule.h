...
@class LKButton, LKTileView, NSArray, NSImageView, NSMutableArray, NSString, NSTreeController, NSUndoManager, PEAppSharePreferencesOutlineView;
...
@interface PEAppSharePreferencesModule : LKPreferencesModule <NSOutlineViewDataSource>
{
    ...
    NSImageView *_footerView;
    NSImageView *_separator1;
    NSImageView *_separator2;
    LKButton *_addBtn;
    LKButton *_removeBtn;
