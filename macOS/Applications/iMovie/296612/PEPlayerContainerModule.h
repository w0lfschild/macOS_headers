...
@class LKButton, LKContainerItemView, LKMenu, LKPopUpButton, LKSegmentedControl, LKWindow, NSArray, NSDictionary, NSImageView, NSMenu, NSMutableArray, NSMutableDictionary, NSProView, NSString, NSTextField, NSTouchBar, NSView, PEPlayerDFRController, PETimecodeDisplayViewController, PEToolbarMetersButton, PEViewedClipSet;
