...
@class FFContext, LKButton, LKTextField, NSImageView, PEStartNumericEntryButton;
...
@interface PETimecodeDisplayViewController : NSViewController <FFNumericEntryDelegate>
{
    ...
    PEStartNumericEntryButton *_numericEntryGoGoGoButton;
    FFContext *_context;
}

@property(retain, nonatomic) FFContext *context; // @synthesize context=_context;
@property(nonatomic) PEStartNumericEntryButton *numericEntryGoGoGoButton; // @synthesize numericEntryGoGoGoButton=_numericEntryGoGoGoButton;
