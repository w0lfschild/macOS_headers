...
@class CETimelineViewItemHeightBindingBridge, CEZoomSlider, FFAnchoredSequence, FFAnchoredTimelineModule, FFEditorModule, FFIMovieHeaderView, FFProject, FFVideoEffectTool, LKButton, LKImageView, LKPopUpButton, LKSegmentedControl, LKSlider, LKTextField, NSArray, NSImageView, NSPopover, NSString, NSTextField, NSView, PEViewedClipSet;
...
@interface CEEditorContainerModule : LKViewModule <FFEditorModuleDelegate, NSWindowDelegate, NSPopoverDelegate>
{
    ...
    CETimelineViewItemHeightBindingBridge *_timelineViewItemHeightBindingBridge;
}

@property(retain, nonatomic) CETimelineViewItemHeightBindingBridge *timelineViewItemHeightBindingBridge; // @synthesize timelineViewItemHeightBindingBridge=_timelineViewItemHeightBindingBridge;
...
@property(nonatomic) BOOL showWaveForms; // @synthesize showWaveForms=_showWaveForms;
...
- (void)stopNUpViewer;
- (void)replaceNUpMedia:(id)arg1 context:(id)arg2 withMedia:(id)arg3 context:(id)arg4;
...
- (BOOL)replaceSkimmedObject:(id)arg1 context:(id)arg2 withSkimmable:(id)arg3 context:(id)arg4 effectCount:(long long)arg5 allowPlayback:(BOOL)arg6 controlCanvas:(BOOL)arg7 showAngles:(BOOL)arg8 owner:(id)arg9;
- (BOOL)startSkimmingWithSkimmable:(id)arg1 context:(id)arg2 effectCount:(long long)arg3 allowPlayback:(BOOL)arg4 controlCanvas:(BOOL)arg5 showAngles:(BOOL)arg6 owner:(id)arg7;
