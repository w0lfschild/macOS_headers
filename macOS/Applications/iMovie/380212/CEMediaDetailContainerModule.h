...
@class FFConsumerOrganizerFilmstripModule, FFIMovieHeaderView, FFMDAppleTVModule, FFMDEffectsModule, FFMDEmptyModule, FFMDEventLibraryModule, FFMDGarageBandModule, FFMDITunesModule, FFMDMapModule, FFMDMusicLibraryModule, FFMDPhotoLibraryModule, FFMDTitleModule, FFMDTransitionModule, NSString;
