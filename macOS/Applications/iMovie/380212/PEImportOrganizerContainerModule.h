...
- (BOOL)startSkimmingWithSkimmable:(id)arg1 context:(id)arg2 owner:(id)arg3;
- (void)displayMedia:(id)arg1 context:(id)arg2 effectCount:(long long)arg3 unloadingBlock:(CDUnknownBlockType)arg4;
- (void)displayMedia:(id)arg1 context:(id)arg2 unloadingBlock:(CDUnknownBlockType)arg3;
- (void)displayMedia:(id)arg1 context:(id)arg2;
