...
@interface PEPlayerContainerModule : LKViewModule <PEPlayerContainerViewDelegate, FFErrorReportingProtocol, FFPlayerModuleDelegate, NSMenuDelegate, NSTouchBarProvider>
{
    ...
    NSObject<FFSkimmableProtocol><FFDataModelProtocol><FFAssetContainerProtocol> *_compareSkimmable;
...
- (void)_displayMedia:(id)arg1 context:(id)arg2 effectCount:(long long)arg3 preferAudio:(BOOL)arg4;
