...
- (BOOL)inspectorModule:(id)arg1 isSkimmingSkimmable:(id)arg2 owner:(id)arg3;
- (void)inspectorModule:(id)arg1 stopSkimmingForOwner:(id)arg2;
- (BOOL)inspectorModule:(id)arg1 startSkimmingReplacingSkimmable:(id)arg2 withSkimmable:(id)arg3 context:(id)arg4 effectCount:(long long)arg5 allowPlayback:(BOOL)arg6 owner:(id)arg7;
- (BOOL)inspectorModule:(id)arg1 startSkimmingWithSkimmable:(id)arg2 context:(id)arg3 effectCount:(long long)arg4 allowPlayback:(BOOL)arg5 owner:(id)arg6;
- (BOOL)_startSkimmingWithSkimmable:(id)arg1 context:(id)arg2 effectCount:(long long)arg3 allowPlayback:(BOOL)arg4 owner:(id)arg5 replacingSkimmable:(id)arg6;
