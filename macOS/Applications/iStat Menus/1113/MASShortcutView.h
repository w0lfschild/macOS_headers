...
@class BJAButton, InputFieldBackground, MASShortcut, MASShortcutValidator, NSButtonCell, NSString, NSTrackingArea;
...
@interface MASShortcutView : NSView
{
    ...
    InputFieldBackground *_background;
...
@property(retain, nonatomic) InputFieldBackground *background; // @synthesize background=_background;
