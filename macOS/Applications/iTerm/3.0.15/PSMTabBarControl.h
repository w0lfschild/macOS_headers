...
#import "PSMTabBarControlProtocol-Protocol.h"
...
@interface PSMTabBarControl : NSControl <PSMTabBarControlProtocol, NSDraggingSource, PSMProgressIndicatorDelegate, PSMTabViewDelegate>
{
...
- (void)_finishCellUpdate:(id)arg1;
