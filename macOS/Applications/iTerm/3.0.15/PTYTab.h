...
+ (void)setSizesInTmuxParseTree:(id)arg1 inTerminal:(id)arg2 zoomed:(BOOL)arg3;
...
+ (id)tabWithArrangement:(id)arg1 inTerminal:(id)arg2 hasFlexibleView:(BOOL)arg3 viewMap:(id)arg4 sessionMap:(id)arg5;
...
- (void)_cleanupAfterRemove:(id)arg1;
- (void)_checkInvariants:(id)arg1;
- (void)dump;
...
- (id)_sessionAdjacentTo:(id)arg1 verticalDir:(BOOL)arg2 after:(BOOL)arg3;
...
- (void)sessionWithTmuxGateway:(id)arg1 wasNotifiedWindowWithId:(int)arg2 renamedTo:(id)arg3;
