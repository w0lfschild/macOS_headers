...
@class EquivalenceClassSet, NSArray, NSMutableDictionary, NSMutableSet, NSString, NSTimer, TmuxGateway;
...
- (void)newWindowWithAffinity:(id)arg1;
- (void)newWindowInSession:(id)arg1 afterWindowWithName:(id)arg2;
- (void)splitWindowPane:(int)arg1 vertically:(BOOL)arg2;
...
- (void)guessVersionResponse:(id)arg1;
...
- (void)openWindowsOfSize:(struct CGSize)arg1;
...
- (void)openWindowWithIndex:(int)arg1 name:(id)arg2 size:(struct CGSize)arg3 layout:(id)arg4 affinities:(id)arg5 windowFlags:(id)arg6;
- (void)dealloc;
- (id)initWithGateway:(id)arg1 clientName:(id)arg2;
