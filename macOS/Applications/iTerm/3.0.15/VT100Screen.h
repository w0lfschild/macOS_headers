...
@interface VT100Screen : NSObject <iTermTemporaryDoubleBufferedGridControllerDelegate, iTermMarkDelegate, PTYNoteViewControllerDelegate, PTYTextViewDataSource, VT100GridDelegate, VT100TerminalDelegate>
{
    ...
    CDStruct_dc106ac8 nextCommandOutputStart_;
    double lastBell_;
    BOOL _cursorVisible;
...
- (void)commandDidStartAtCoord:(CDStruct_1ef3fb1f)arg1;
...
- (void)setFindString:(id)arg1 forwardDirection:(BOOL)arg2 ignoringCase:(BOOL)arg3 regex:(BOOL)arg4 startingAtX:(int)arg5 startingAtY:(int)arg6 withOffset:(int)arg7 inContext:(id)arg8 multipleResults:(BOOL)arg9;
- (id)findContext;
