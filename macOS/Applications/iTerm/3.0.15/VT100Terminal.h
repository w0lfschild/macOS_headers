...
@class NSDictionary, NSString, VT100Output, VT100Parser;
...
@interface VT100Terminal : NSObject
{
    ...
    CDStruct_e243bc5a mainSavedCursor_;
    CDStruct_e243bc5a altSavedCursor_;
...
- (CDStruct_e243bc5a)savedCursorFromDictionary:(id)arg1;
- (id)dictionaryForSavedCursor:(CDStruct_e243bc5a)arg1;
