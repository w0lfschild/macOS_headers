...
@class NSArray, NSDate, NSDictionary, NSEvent, NSMenu, NSMutableDictionary, NSScriptObjectSpecifier, NSString, NSWindow, NSWindowController, PSMTabBarControl, PTYSession, PTYTab, PTYWindow, TmuxController, VT100RemoteHost, iTermPopupWindowController;
...
- (void)updateAutoCommandHistoryForPrefix:(NSString *)arg1 inSession:(PTYSession *)arg2;
