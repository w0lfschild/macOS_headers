...
- (id)updateUnderlinedURLs:(id)arg1;
- (void)removeUnderline;
- (BOOL)hasUnderline;
- (void)updateCursor:(id)arg1 action:(id)arg2;
...
- (void)handleKeyDownEvent:(id)arg1 eschewCocoaTextHandling:(BOOL)arg2;
