...
@class NSArray, NSMutableArray, NSString, PseudoTerminal, iTermFullScreenWindowManager, iTermRestorableSession;
...
- (void)loadWindowArrangementWithName:(id)arg1 asTabs:(BOOL)arg2;
- (void)tryOpenArrangement:(id)arg1 asTabs:(BOOL)arg2;
