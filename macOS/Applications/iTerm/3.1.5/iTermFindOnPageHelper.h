...
@class FindContext, NSDictionary, NSMutableDictionary, NSMutableOrderedSet, NSOrderedSet, NSString, NSView;
...
- (void)findString:(id)arg1 forwardDirection:(BOOL)arg2 mode:(unsigned long long)arg3 withOffset:(int)arg4 context:(id)arg5 numberOfLines:(int)arg6 totalScrollbackOverflow:(long long)arg7;
