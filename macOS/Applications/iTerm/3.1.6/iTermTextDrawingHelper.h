...
@class NSAttributedString, NSColor, NSFont, NSImage, NSMutableDictionary, NSMutableSet, NSSet, NSString, NSView, iTermColorMap, iTermSelection, iTermTimestampDrawHelper;
...
+ (struct CGRect)rectForBadgeImageOfSize:(struct CGSize)arg1 destinationRect:(struct CGRect)arg2 destinationFrameSize:(struct CGSize)arg3 visibleSize:(struct CGSize)arg4 sourceRectPtr:(struct CGRect *)arg5;
...
- (double)yOriginForUnderlineGivenFontXHeight:(double)arg1 yOffset:(double)arg2;
...
- (id)imageForCoord:(CDStruct_1ef3fb1f)arg1 size:(struct CGSize)arg2;
