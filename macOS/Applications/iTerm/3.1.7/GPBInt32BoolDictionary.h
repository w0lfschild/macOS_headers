...
+ (id)dictionaryWithBools:(const char *)arg1 forKeys:(const int *)arg2 count:(unsigned long long)arg3;
...
- (id)initWithBools:(const char *)arg1 forKeys:(const int *)arg2 count:(unsigned long long)arg3;
- (id)init;
