...
@class AdvancedWorkingDirectoryWindowController, NSButton, NSMatrix, NSPopUpButton, NSString, NSTextField, NSTimer, NSTokenField, NSView, ProfileListView, iTermShortcutInputView;
@protocol ProfilesGeneralPreferencesViewControllerDelegate;

@interface ProfilesGeneralPreferencesViewController : iTermProfilePreferencesBaseViewController <iTermShortcutInputViewDelegate, NSMenuDelegate, ProfileListViewDelegate>
{
...
- (void)postUpdateSessionNameNotification:(id)arg1;
