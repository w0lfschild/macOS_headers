...
@interface PTYTab : NSObject <NSCopying, NSSplitViewDelegate, PTYSessionDelegate, PTYSplitViewDelegate, PSMTabBarControlRepresentedObjectIdentifierProtocol>
{
    ...
    NSString *_metalUnavailableReason;
...
@property(readonly, nonatomic) NSString *metalUnavailableReason; // @synthesize metalUnavailableReason=_metalUnavailableReason;
