...
@class NSFont, NSMutableDictionary, NSScrollView, NSSet, NSSplitView, NSString, NSTableColumn, ProfileModelWrapper, ProfileTableView, ProfileTagsView, iTermSearchField;
...
- (id)tagColorWhenUnselected;
- (id)textColorWhenUnselected;
- (id)tagColorWhenSelected;
- (id)textColorWhenInactiveAndSelected;
- (id)textColorWhenActiveAndSelected;
- (BOOL)lightTheme;
- (id)tagFont;
- (id)mainFont;
