...
struct map<std::__1::tuple<int, int, int>, int, std::__1::less<std::__1::tuple<int, int, int>>, std::__1::allocator<std::__1::pair<const std::__1::tuple<int, int, int>, int>>> {
    struct __tree<std::__1::__value_type<std::__1::tuple<int, int, int>, int>, std::__1::__map_value_compare<std::__1::tuple<int, int, int>, std::__1::__value_type<std::__1::tuple<int, int, int>, int>, std::__1::less<std::__1::tuple<int, int, int>>, true>, std::__1::allocator<std::__1::__value_type<std::__1::tuple<int, int, int>, int>>> {
        struct __tree_end_node<std::__1::__tree_node_base<void *>*> *__begin_node_;
        struct __compressed_pair<std::__1::__tree_end_node<std::__1::__tree_node_base<void *>*>, std::__1::allocator<std::__1::__tree_node<std::__1::__value_type<std::__1::tuple<int, int, int>, int>, void *>>> {
            struct __tree_end_node<std::__1::__tree_node_base<void *>*> __value_;
        } __pair1_;
        struct __compressed_pair<unsigned long, std::__1::__map_value_compare<std::__1::tuple<int, int, int>, std::__1::__value_type<std::__1::tuple<int, int, int>, int>, std::__1::less<std::__1::tuple<int, int, int>>, true>> {
            unsigned long long __value_;
        } __pair3_;
    } __tree_;
};
