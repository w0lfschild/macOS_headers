...
- (NSColor *)textColorDefaultSelected:(BOOL)arg1;
- (BOOL)useLightControls;
- (NSColor *)accessoryTextColor;
- (void)fillPath:(NSBezierPath *)arg1;
- (NSColor *)accessoryStrokeColor;
- (NSColor *)accessoryFillColor;
- (void)drawTabBar:(PSMTabBarControl *)arg1 inRect:(struct CGRect)arg2 clipRect:(struct CGRect)arg3 horizontal:(BOOL)arg4;
