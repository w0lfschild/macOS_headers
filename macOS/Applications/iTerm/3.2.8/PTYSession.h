...
#import "iTermMetalGlueDelegate-Protocol.h"
...
@class DVR, DVRDecoder, FindContext, Interval, MovingAverage, NSArray, NSColor, NSDate, NSDictionary, NSImage, NSMutableArray, NSMutableData, NSMutableDictionary, NSMutableSet, NSNumber, NSObject, NSString, NSTimer, PTYTask, PTYTextView, SessionView, TerminalFileDownload, TerminalFileUpload, TextViewWrapper, TmuxController, TmuxGateway, VT100RemoteHost, VT100Screen, VT100Terminal, iTermAutomaticProfileSwitcher, iTermColorMap, iTermCopyModeState, iTermMark, iTermMetalGlue, iTermPasteHelper, iTermPromptOnCloseReason, iTermQuickLookController, iTermRestorableSession, iTermThroughputEstimator, iTermUpdateCadenceController;
@protocol OS_dispatch_semaphore, PTYSessionDelegate;

@interface PTYSession : NSResponder <iTermAutomaticProfileSwitcherDelegate, iTermCoprocessDelegate, iTermHotKeyNavigableSession, iTermMetalGlueDelegate, iTermPasteHelperDelegate, iTermSessionViewDelegate, iTermUpdateCadenceControllerDelegate, FindViewControllerDelegate, iTermWeaklyReferenceable, PopupDelegate, PTYTaskDelegate, PTYTextViewDelegate, TmuxGatewayDelegate, VT100ScreenDelegate>
{
    BOOL _registered;
    NSString *_name;
...
+ (id)arrangementFromTmuxParsedLayout:(id)arg1 bookmark:(id)arg2 tmuxController:(id)arg3;
+ (id)pasteboardString;
