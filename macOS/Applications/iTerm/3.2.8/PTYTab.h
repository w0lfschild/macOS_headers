...
@class FakeWindow, NSArray, NSDictionary, NSImage, NSMapTable, NSMutableArray, NSMutableDictionary, NSSplitView, NSString, NSTabViewItem, NSView, NSWindowController, PTYSession, TmuxController, iTermFlexibleView;
...
+ (id)arrangementForDecoratedTmuxParseTree:(id)arg1 bookmark:(id)arg2 activeWindowPane:(int)arg3 tmuxController:(id)arg4;
+ (id)_recursiveArrangementForDecoratedTmuxParseTree:(id)arg1 bookmark:(id)arg2 origin:(struct CGPoint)arg3 activeWindowPane:(int)arg4 tmuxController:(id)arg5;
...
- (void)reallyChangeSessionFontSize:(id)arg1;
