...
@class AutocompleteView, CommandHistoryPopupWindowController, DirectoriesPopupWindowController, NSArray, NSButton, NSCandidateListTouchBarItem, NSColor, NSComboBox, NSCustomTouchBarItem, NSDictionary, NSMutableSet, NSPanel, NSScreen, NSString, NSTextField, NSTimer, PasteboardHistoryWindowController, iTermInstantReplayWindowController, iTermPasswordManagerWindowController, iTermRateLimitedUpdate, iTermRootTerminalView;
...
- (void)sessionBackgroundColorDidChangeInTab:(id)arg1;
...
- (id)tabView:(id)arg1 imageForTabViewItem:(id)arg2 styleMask:(unsigned int *)arg3;
