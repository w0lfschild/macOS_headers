...
@class FindViewController, MTKView, NSMutableArray, NSString, NSTextField, NSVisualEffectView, PTYScrollView, PTYScroller, SessionTitleView, SplitSelectionView, iTermAnnouncementViewController, iTermMetalClipView, iTermMetalDriver;
...
+ (void)initialize;
+ (double)titleHeight;
@property(readonly, nonatomic) NSVisualEffectView *visualEffectView; // @synthesize visualEffectView=_visualEffectView;
