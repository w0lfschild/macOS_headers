...
@class NSArray, NSDate, NSMenu, NSMenuItem, NSString, SUUpdater, iTermAPIHelper, iTermPasswordManagerWindowController, iTermScriptsMenuController;
@protocol NSObject;

@interface iTermApplicationDelegate : NSObject <iTermPasswordManagerDelegate, iTermApplicationDelegate>
{
    ...
    iTermAPIHelper *_apiHelper;
}

@property(readonly, nonatomic) iTermAPIHelper *apiHelper; // @synthesize apiHelper=_apiHelper;
