...
- (void)drawBoxAtOffset:(struct CGPoint)arg1;
- (void)drawBoxInContext:(struct CGContext *)arg1 offset:(struct CGPoint)arg2;
...
- (int)maxParts;
- (void)dealloc;
- (id)initWithCharacter:(id)arg1 descriptor:(id)arg2 attributes:(id)arg3 boxDrawing:(BOOL)arg4 radius:(int)arg5 context:(struct CGContext *)arg6;
