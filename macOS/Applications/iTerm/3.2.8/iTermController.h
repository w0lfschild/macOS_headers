...
#import "iTermSetCurrentTerminalHelperDelegate-Protocol.h"
...
- (void)openSingleUseWindowWithCommand:(id)arg1 inject:(id)arg2;
- (void)openSingleUseWindowWithCommand:(id)arg1;
...
- (id)frontTextView;
- (id)launchBookmark:(id)arg1 inTerminal:(id)arg2 withURL:(id)arg3 hotkeyWindowType:(unsigned long long)arg4 makeKey:(BOOL)arg5 canActivate:(BOOL)arg6 command:(id)arg7 block:(CDUnknownBlockType)arg8;
...
- (void)saveWindowArrangmentForAllWindows:(BOOL)arg1 name:(id)arg2;
