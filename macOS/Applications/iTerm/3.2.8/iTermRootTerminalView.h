...
@class NSDictionary, NSString, NSVisualEffectView, PTYTabView, iTermDragHandleView, iTermTabBarControlView, iTermToolbeltView;
...
@interface iTermRootTerminalView : SolidColorView <iTermTabBarControlViewDelegate, iTermDragHandleViewDelegate>
{
    ...
    NSVisualEffectView *_tabBarBacking;
...
- (void)setTabBarAutoresizingMask:(unsigned long long)arg1;
