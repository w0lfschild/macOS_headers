...
- (void)drawUnderlineOfColor:(id)arg1 style:(long long)arg2 font:(id)arg3 rect:(struct CGRect)arg4;
...
- (void)getAttributesForCharacter:(struct screen_char_t *)arg1 atIndex:(long long)arg2 forceTextColor:(id)arg3 forceUnderline:(BOOL)arg4 colorRun:(CDStruct_56368ce9 *)arg5 drawable:(BOOL)arg6 textColorContext:(struct iTermTextColorContext *)arg7 attributes:(CDStruct_43ea45b0 *)arg8;
...
- (void)drawUnderlinedTextWithContext:(CDStruct_078aa1c5 *)arg1 inRect:(struct CGRect)arg2 underlineColor:(id)arg3 style:(long long)arg4 font:(id)arg5 block:(CDUnknownBlockType)arg6;
- (void)drawUnderlineForAttributedString:(id)arg1 atPoint:(struct CGPoint)arg2 positions:(double *)arg3;
...
- (void)drawUnderlineForFastPathString:(id)arg1 atPoint:(struct CGPoint)arg2 positions:(double *)arg3 backgroundColor:(id)arg4;
- (int)drawFastPathStringWithoutUnderline:(id)arg1 atPoint:(struct CGPoint)arg2 origin:(CDStruct_1ef3fb1f)arg3 positions:(double *)arg4 inContext:(struct CGContext *)arg5 backgroundColor:(id)arg6 forUnderline:(BOOL)arg7;
- (int)drawFastPathString:(id)arg1 atPoint:(struct CGPoint)arg2 origin:(CDStruct_1ef3fb1f)arg3 positions:(double *)arg4 inContext:(struct CGContext *)arg5 backgroundColor:(id)arg6;
