...
+ (id)sessionMap;
@property(copy, nonatomic) NSString *reusableCookie; // @synthesize reusableCookie=_reusableCookie;
...
- (void)attachToServer:(CDStruct_daf9c769)arg1;
