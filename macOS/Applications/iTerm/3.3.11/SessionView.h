...
@class MTKView, NSMutableArray, NSString, NSTextField, PTYScrollView, PTYScroller, SessionTitleView, SplitSelectionView, iTermAnnouncementViewController, iTermDropDownFindViewController, iTermFindDriver, iTermGenericStatusBarContainer, iTermHoverContainerView, iTermMetalClipView, iTermMetalDriver;
