...
@class DVR, FindContext, IntervalTree, LineBuffer, NSDictionary, NSIndexSet, NSMutableDictionary, NSMutableIndexSet, NSMutableSet, NSMutableString, NSString, VT100Grid, VT100ScreenMark, VT100Terminal, iTermOrderEnforcer, iTermTemporaryDoubleBufferedGridController;
...
- (void)appendImageAtCursorWithName:(id)arg1 width:(int)arg2 units:(long long)arg3 height:(int)arg4 units:(long long)arg5 preserveAspectRatio:(BOOL)arg6 roundUp:(BOOL)arg7 inset:(struct NSEdgeInsets)arg8 image:(id)arg9 data:(id)arg10 isSixel:(BOOL)arg11;
...
- (void)didResizeToSize:(CDStruct_1ef3fb1f)arg1 selection:(id)arg2 couldHaveSelection:(BOOL)arg3 subSelections:(id)arg4;
