...
@class NSArray, NSDate, NSMenu, NSMenuItem, NSString, SUUpdater, iTermFocusFollowsMouseController, iTermGlobalScopeController, iTermPasswordManagerWindowController, iTermScriptsMenuController;

@interface iTermApplicationDelegate : NSObject <iTermOrphanServerAdopterDelegate, iTermPasswordManagerDelegate, iTermApplicationDelegate>
{
