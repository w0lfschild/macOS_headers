...
@interface iTermRootTerminalView : SolidColorView <iTermTabBarControlViewDelegate, iTermDragHandleViewDelegate, iTermGenericStatusBarContainer, iTermStoplightHotboxDelegate>
{
    ...
    NSImageView *_topLeftCornerRoundImageView;
    NSImageView *_topRightCornerRoundImageView;
    NSImageView *_bottomLeftCornerRoundImageView;
    NSImageView *_bottomRightCornerRoundImageView;
