...
@interface PTYTask : NSObject
{
    ...
    BOOL _paused;
    int _socketFd;
    CDStruct_79c71658 _desiredSize;
...
- (void)reallyLaunchWithPath:(id)arg1 arguments:(id)arg2 environment:(id)arg3 width:(int)arg4 height:(int)arg5 isUTF8:(BOOL)arg6 autologPath:(id)arg7 synchronous:(BOOL)arg8 completion:(CDUnknownBlockType)arg9;
...
- (void)launchWithPath:(id)arg1 arguments:(id)arg2 environment:(id)arg3 width:(int)arg4 height:(int)arg5 isUTF8:(BOOL)arg6 autologPath:(id)arg7 synchronous:(BOOL)arg8 completion:(CDUnknownBlockType)arg9;
- (id)originalCommand;
- (BOOL)hasBrokenPipe;
