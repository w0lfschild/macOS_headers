...
- (id)splitVertically:(BOOL)arg1 before:(BOOL)arg2 profile:(id)arg3 targetSession:(id)arg4 synchronous:(BOOL)arg5;
...
- (BOOL)isInitialized;
- (BOOL)tabViewCanDragSolitaryTab:(id)arg1;
