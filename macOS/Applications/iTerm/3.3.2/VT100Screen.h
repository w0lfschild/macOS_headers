...
- (id)subSelectionsAfterRestoringAlternateScreen:(id)arg1 fromLineBuffer:(id)arg2 toLineBuffer:(id)arg3 subSelectionTuples:(id)arg4 originalLastPosition:(id)arg5 oldSize:(CDStruct_1ef3fb1f)arg6 newSize:(CDStruct_1ef3fb1f)arg7 usedHeight:(int)arg8 intervalTreeObjects:(id)arg9;
- (void)restoreAlternateScreenFromTemporaryLineBuffer:(id)arg1 realLineBuffer:(id)arg2 oldSize:(CDStruct_1ef3fb1f)arg3 newSize:(CDStruct_1ef3fb1f)arg4;
