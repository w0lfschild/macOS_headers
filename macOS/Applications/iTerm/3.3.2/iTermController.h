...
- (id)openSingleUseWindowWithCommand:(id)arg1 inject:(id)arg2 environment:(id)arg3 pwd:(id)arg4 options:(unsigned long long)arg5 completion:(CDUnknownBlockType)arg6;
- (id)openSingleUseWindowWithCommand:(id)arg1 inject:(id)arg2 environment:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (id)openSingleUseWindowWithCommand:(id)arg1 inject:(id)arg2 environment:(id)arg3;
- (id)openSingleUseWindowWithCommand:(id)arg1;
