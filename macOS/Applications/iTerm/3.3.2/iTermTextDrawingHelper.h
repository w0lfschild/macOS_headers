...
- (id)dictionaryForCharacterAttributes:(CDStruct_3a96f9a6 *)arg1;
- (void)getAttributesForCharacter:(struct screen_char_t *)arg1 atIndex:(long long)arg2 forceTextColor:(id)arg3 forceUnderline:(BOOL)arg4 colorRun:(CDStruct_56368ce9 *)arg5 drawable:(BOOL)arg6 textColorContext:(struct iTermTextColorContext *)arg7 attributes:(CDStruct_3a96f9a6 *)arg8;
- (BOOL)imageAttributes:(id)arg1 followImageAttributes:(id)arg2;
- (BOOL)shouldSegmentWithAttributes:(CDStruct_3a96f9a6 *)arg1 imageAttributes:(id)arg2 previousAttributes:(CDStruct_3a96f9a6 *)arg3 previousImageAttributes:(id)arg4 combinedAttributesChanged:(char *)arg5;
