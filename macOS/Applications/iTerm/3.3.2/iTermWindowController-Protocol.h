...
@class NSArray, NSDate, NSDictionary, NSEvent, NSMenu, NSMutableDictionary, NSScriptObjectSpecifier, NSString, NSWindow, NSWindowController<iTermWindowController>, PSMTabBarControl, PTYSession, PTYTab, TmuxController, VT100RemoteHost, iTermPopupWindowController, iTermRestorableSession, iTermSwiftyStringGraph;
...
- (PTYSession *)splitVertically:(BOOL)arg1 withBookmark:(NSDictionary *)arg2 targetSession:(PTYSession *)arg3 synchronous:(BOOL)arg4;
- (PTYSession *)splitVertically:(BOOL)arg1 withProfile:(NSDictionary *)arg2 synchronous:(BOOL)arg3;
- (PTYSession *)splitVertically:(BOOL)arg1 withBookmarkGuid:(NSString *)arg2 synchronous:(BOOL)arg3;
