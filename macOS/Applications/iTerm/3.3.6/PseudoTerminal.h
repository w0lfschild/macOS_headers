...
- (void)tab:(id)arg1 proxyIconDidChange:(id)arg2;
...
- (id)createTabWithProfile:(id)arg1 withCommand:(id)arg2 environment:(id)arg3 synchronous:(BOOL)arg4 completion:(CDUnknownBlockType)arg5;
...
- (id)splitVertically:(BOOL)arg1 before:(BOOL)arg2 profile:(id)arg3 targetSession:(id)arg4 synchronous:(BOOL)arg5 completion:(CDUnknownBlockType)arg6;
- (id)splitVertically:(BOOL)arg1 withBookmark:(id)arg2 targetSession:(id)arg3 synchronous:(BOOL)arg4;
...
- (id)splitVertically:(BOOL)arg1 withBookmarkGuid:(id)arg2 synchronous:(BOOL)arg3;
- (id)splitVertically:(BOOL)arg1 withProfile:(id)arg2 synchronous:(BOOL)arg3;
