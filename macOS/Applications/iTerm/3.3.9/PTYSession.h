...
- (id)popupVT100Screen;
- (BOOL)screenConfirmDownloadAllowed:(id)arg1 size:(long long)arg2 promptIfBig:(char *)arg3;
...
- (BOOL)textViewReportMouseEvent:(unsigned long long)arg1 modifiers:(unsigned long long)arg2 button:(int)arg3 coordinate:(CDStruct_1ef3fb1f)arg4 deltaY:(double)arg5 allowDragBeforeMouseDown:(BOOL)arg6;
...
- (void)startProgram:(id)arg1 environment:(id)arg2 customShell:(id)arg3 isUTF8:(BOOL)arg4 substitutions:(id)arg5 synchronous:(BOOL)arg6 completion:(CDUnknownBlockType)arg7;
