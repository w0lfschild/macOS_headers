...
@class Coprocess, NSLock, NSMutableData, NSNumber, NSString, iTermLoggingHelper;
...
- (void)reallyLaunchWithPath:(id)arg1 arguments:(id)arg2 environment:(id)arg3 customShell:(id)arg4 gridSize:(CDStruct_1ef3fb1f)arg5 viewSize:(struct CGSize)arg6 isUTF8:(BOOL)arg7 synchronous:(BOOL)arg8 completion:(CDUnknownBlockType)arg9;
- (void)setTty:(id)arg1;
...
- (void)launchWithPath:(id)arg1 arguments:(id)arg2 environment:(id)arg3 customShell:(id)arg4 gridSize:(CDStruct_1ef3fb1f)arg5 viewSize:(struct CGSize)arg6 isUTF8:(BOOL)arg7 synchronous:(BOOL)arg8 completion:(CDUnknownBlockType)arg9;
- (id)originalCommand;
