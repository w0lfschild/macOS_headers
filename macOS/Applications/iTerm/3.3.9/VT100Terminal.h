...
@interface VT100Terminal : NSObject
{
    ...
    BOOL ansiMode_;
    BOOL numLock_;
    CDStruct_96479191 mainSavedCursor_;
    CDStruct_96479191 altSavedCursor_;
    ...
    NSURL *_url;
    NSString *_urlParams;
    CDStruct_9288fe50 graphicRendition_;
}
...
@property(nonatomic) CDStruct_9288fe50 graphicRendition; // @synthesize graphicRendition=graphicRendition_;
...
- (CDStruct_96479191)savedCursorFromDictionary:(id)arg1;
- (id)dictionaryForSavedCursor:(CDStruct_96479191)arg1;
- (CDStruct_9288fe50)graphicRenditionFromDictionary:(id)arg1;
- (id)dictionaryForGraphicRendition:(CDStruct_9288fe50)arg1;
