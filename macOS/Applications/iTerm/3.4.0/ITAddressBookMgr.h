...
+ (BOOL)shortcutIdentifier:(id)arg1 title:(id)arg2 matchesItem:(id)arg3;
...
+ (BOOL)removeProfile:(id)arg1 fromModel:(id)arg2;
+ (BOOL)canRemoveProfile:(id)arg1 fromModel:(id)arg2;
+ (id)_advancedWorkingDirWithOption:(id)arg1 directory:(id)arg2;
+ (id)customShellForProfile:(id)arg1;
+ (id)bookmarkCommandSwiftyString:(id)arg1 forObjectType:(long long)arg2;
+ (void)computeCommandForProfile:(id)arg1 objectType:(long long)arg2 scope:(id)arg3 completion:(CDUnknownBlockType)arg4;
+ (id)standardLoginCommand;
+ (BOOL)hushlogin;
+ (id)loginShellCommandForBookmark:(id)arg1 forObjectType:(long long)arg2;
+ (id)shellLauncherCommandWithCustomShell:(id)arg1;
+ (id)sanitizedCustomShell:(id)arg1;
...
- (id)usernameFromTXTRecord:(id)arg1;
- (unsigned short)portFromSockaddr:(struct sockaddr *)arg1;
- (void *)inaddrFromSockaddr:(struct sockaddr *)arg1;
- (void)_addBonjourHostProfileWithName:(id)arg1 ipAddressString:(id)arg2 port:(int)arg3 serviceType:(id)arg4 userName:(id)arg5;
- (BOOL)usernameIsSafe:(id)arg1;
