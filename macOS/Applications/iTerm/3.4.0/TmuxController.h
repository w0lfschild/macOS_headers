...
@interface TmuxController : NSObject <iTermTmuxBufferSizeMonitorDelegate>
{
    ...
    NSMutableDictionary *_buriedWindows;
...
- (void)getBuriedIndexesResponse:(id)arg1;
...
- (int)tabIndexOfWindowID:(int)arg1;
- (void)setWindowID:(int)arg1 buriedFromTerminalGUID:(id)arg2 tabIndex:(int)arg3;
- (id)terminalGUIDForWindowID:(int)arg1;
...
- (void)adjustWindowSizeIfNeededForTabs:(id)arg1;
- (BOOL)setLayoutInTab:(id)arg1 toLayout:(id)arg2 zoomed:(id)arg3;
- (void)replaceOldTerminalGUID:(id)arg1 with:(id)arg2;
- (void)openWindowWithIndex:(int)arg1 name:(id)arg2 size:(struct CGSize)arg3 layout:(id)arg4 affinities:(id)arg5 windowFlags:(id)arg6 profile:(id)arg7 initial:(BOOL)arg8 tabIndex:(id)arg9;
