...
- (void)escapeCharacters:(id)arg1 forBash:(BOOL)arg2;
- (void)escapeCharacters:(id)arg1;
- (void)escapeShellCharactersWithBackslashIncludingNewlines:(BOOL)arg1;
- (void)escapeShellCharactersWithSingleQuotesIncludingNewlines:(BOOL)arg1 forBash:(BOOL)arg2;
- (void)escapeShellCharactersWithSingleQuotesIncludingNewlines:(BOOL)arg1;
