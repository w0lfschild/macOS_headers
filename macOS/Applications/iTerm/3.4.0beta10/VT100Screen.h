...
- (BOOL)encodeContents:(id)arg1 linesDropped:(int *)arg2;
- (int)numberOfLinesDroppedWhenEncodingModernFormatWithEncoder:(id)arg1 intervalOffset:(long long *)arg2;
- (int)numberOfLinesDroppedWhenEncodingLegacyFormatWithEncoder:(id)arg1 intervalOffset:(long long *)arg2;
- (int)numberOfLinewDroppedWhenEncodingContentsIncludingGrid:(BOOL)arg1 encoder:(id)arg2 intervalOffset:(long long *)arg3;
...
- (void)terminalPasteBracketingWillChangeTo:(BOOL)arg1;
