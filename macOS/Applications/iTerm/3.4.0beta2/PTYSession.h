...
@interface PTYSession : NSResponder <iTermAutomaticProfileSwitcherDelegate, iTermBackgroundDrawingHelperDelegate, iTermCoprocessDelegate, iTermCopyModeHandlerDelegate, iTermComposerManagerDelegate, iTermHotKeyNavigableSession, iTermIntervalTreeObserver, iTermLogging, iTermMetaFrustrationDetector, iTermMetalGlueDelegate, iTermNaggingControllerDelegate, iTermObject, iTermPasteHelperDelegate, iTermSessionNameControllerDelegate, iTermSessionViewDelegate, iTermStandardKeyMapperDelegate, iTermStatusBarViewControllerDelegate, iTermTermkeyKeyMapperDelegate, iTermUpdateCadenceControllerDelegate, iTermWorkingDirectoryPollerDelegate, iTermEchoProbeDelegate, iTermFindDriverDelegate, iTermSubscribable, iTermTmuxControllerSession, iTermWeaklyReferenceable, PopupDelegate, PTYTaskDelegate, PTYTextViewDelegate, TmuxGatewayDelegate, VT100ScreenDelegate>
{
