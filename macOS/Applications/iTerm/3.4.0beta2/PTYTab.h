...
@interface PTYTab : NSObject <iTermObject, NSCopying, NSSplitViewDelegate, PTYSessionDelegate, PTYSplitViewDelegate, PSMTabBarControlRepresentedObjectIdentifierProtocol>
{
...
- (id)arrangementNodeWithContents:(BOOL)arg1 fromArrangementNode:(id)arg2;
