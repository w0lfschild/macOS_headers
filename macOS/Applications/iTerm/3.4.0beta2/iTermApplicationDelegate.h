...
@class NSArray, NSDate, NSMenu, NSMenuItem, NSString, SUUpdater, iTermFocusFollowsMouseController, iTermGlobalScopeController, iTermPasswordManagerWindowController, iTermRestorableStateController, iTermScriptsMenuController, iTermUntitledWindowStateMachine;

@interface iTermApplicationDelegate : NSObject <iTermOrphanServerAdopterDelegate, iTermPasswordManagerDelegate, iTermRestorableStateControllerDelegate, iTermUntitledWindowStateMachineDelegate, iTermApplicationDelegate>
{
...
- (void)restorableStateController:(id)arg1 encodeWithCoder:(id)arg2 window:(id)arg3;
- (void)restorableStateController:(id)arg1 restoreWithCoder:(id)arg2 identifier:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (BOOL)restorableStateController:(id)arg1 windowNeedsRestoration:(id)arg2;
- (id)restorableStateControllerWindows:(id)arg1;
- (void)makeSessionWithConnection:(CDStruct_daf9c769)arg1 windowController:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)orphanServerAdopterOpenSessionForConnection:(CDStruct_daf9c769)arg1 inWindow:(id)arg2 completion:(CDUnknownBlockType)arg3;
