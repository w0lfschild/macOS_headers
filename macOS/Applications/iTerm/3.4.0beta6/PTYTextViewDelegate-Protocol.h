...
@class NSArray, NSColor, NSDictionary, NSError, NSEvent, NSImage, NSMenu, NSMenuItem, NSString, NSURL, NSView, PTYScroller, PTYTask, SCPPath, iTermExpect, iTermVariableScope;
