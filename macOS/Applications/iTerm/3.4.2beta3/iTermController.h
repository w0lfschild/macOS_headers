...
#import "iTermPresentationControllerDelegate.h"
...
@interface iTermController : NSObject <iTermSetCurrentTerminalHelperDelegate, iTermPresentationControllerDelegate>
{
...
- (id)presentationControllerManagedWindows;
- (void)reallySetCurrentTerminal:(id)arg1;
- (void)openSingleUseWindowWithCommand:(id)arg1 arguments:(id)arg2 inject:(id)arg3 environment:(id)arg4 pwd:(id)arg5 options:(unsigned long long)arg6 didMakeSession:(CDUnknownBlockType)arg7 completion:(CDUnknownBlockType)arg8;
- (void)openSingleUseWindowWithCommand:(id)arg1 inject:(id)arg2 environment:(id)arg3 pwd:(id)arg4 options:(unsigned long long)arg5 didMakeSession:(CDUnknownBlockType)arg6 completion:(CDUnknownBlockType)arg7;
...
- (void)openSessionsFromProfiles:(id)arg1 inWindowController:(id)arg2;
...
- (void)tryOpenArrangement:(id)arg1 named:(id)arg2 asTabsInWindow:(id)arg3;
...
- (void)repairSavedArrangementNamed:(id)arg1 replaceInitialDirectoryForSessionWithGUID:(id)arg2 with:(id)arg3;
- (BOOL)arrangementWithName:(id)arg1 hasSessionWithGUID:(id)arg2 pwd:(id)arg3;
