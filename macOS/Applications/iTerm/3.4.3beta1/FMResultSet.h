...
- (void).cxx_destruct;
@property(nonatomic) BOOL shouldAutoClose; // @synthesize shouldAutoClose=_shouldAutoClose;
...
- (BOOL)bindWithArray:(id)arg1 orDictionary:(id)arg2 orVAList:(struct __va_list_tag [1])arg3;
