...
- (void)restorableStateDidFinishRequestingRestorations:(id)arg1;
- (void)makeSessionWithPartialAttachment:(id)arg1 windowController:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)makeSessionWithConnection:(CDStruct_b0cac789)arg1 windowController:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)orphanServerAdopterOpenSessionForPartialAttachment:(id)arg1 inWindow:(id)arg2 completion:(CDUnknownBlockType)arg3;
