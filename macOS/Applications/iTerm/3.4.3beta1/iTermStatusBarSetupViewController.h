...
@class CPKColorWell, NSArray, NSButton, NSCollectionView, NSColor, NSDictionary, NSPanel, NSPopUpButton, NSString, NSTextField, iTermStatusBarLayout, iTermStatusBarSetupDestinationCollectionViewController;
...
@interface iTermStatusBarSetupViewController : NSViewController <NSCollectionViewDataSource, NSCollectionViewDelegateFlowLayout>
{
    ...
    NSButton *_removeEmptyComponents;
    NSPopUpButton *_autoRainbow;
    NSArray *_elements;
