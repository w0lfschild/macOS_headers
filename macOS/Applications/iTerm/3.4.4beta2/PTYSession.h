...
@property(retain, nonatomic) iTermImageWrapper *backgroundImage; // @synthesize backgroundImage=_backgroundImage;
...
- (id)composerManagerTmuxController:(id)arg1;
- (id)composerManagerShell:(id)arg1;
- (id)composerManagerWorkingDirectory:(id)arg1;
- (id)composerManagerRemoteHost:(id)arg1;
- (id)composerManagerAppearance:(id)arg1;
...
- (void)addAnnotationWithCompletion:(CDUnknownBlockType)arg1 startX:(id)arg2 startY:(id)arg3 endX:(id)arg4 endY:(id)arg5 text:(id)arg6;
...
- (void)addTriggerDictionary:(id)arg1 updateProfile:(BOOL)arg2;
- (void)textViewAddTrigger:(id)arg1;
...
- (BOOL)textViewDrawBackgroundImageInView:(id)arg1 viewRect:(struct CGRect)arg2 blendDefaultBackground:(BOOL)arg3;
