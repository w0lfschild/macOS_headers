...
+ (id)tabWithArrangement:(id)arg1 named:(id)arg2 inTerminal:(id)arg3 hasFlexibleView:(BOOL)arg4 viewMap:(id)arg5 sessionMap:(id)arg6 tmuxController:(id)arg7 partialAttachments:(id)arg8 reservedTabGUIDs:(id)arg9;
+ (void)openPartialAttachmentsForArrangement:(id)arg1 completion:(CDUnknownBlockType)arg2;
+ (void)_recursiveOpenPartialAttachments:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (id)_recursiveRestoreSessions:(id)arg1 named:(id)arg2 atNode:(id)arg3 inTab:(id)arg4 forObjectType:(long long)arg5 partialAttachments:(id)arg6;
