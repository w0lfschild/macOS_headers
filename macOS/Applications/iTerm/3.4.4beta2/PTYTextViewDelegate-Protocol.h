...
@class NSArray, NSColor, NSDictionary, NSError, NSEvent, NSMenu, NSMenuItem, NSString, NSURL, NSView, PTYScroller, PTYTask, SCPPath, iTermAction, iTermExpect, iTermImageWrapper, iTermVariableScope;
...
- (void)textViewAddTrigger:(NSString *)arg1;
...
- (BOOL)textViewDrawBackgroundImageInView:(NSView *)arg1 viewRect:(struct CGRect)arg2 blendDefaultBackground:(BOOL)arg3;
