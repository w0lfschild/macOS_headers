...
@interface PseudoTerminal : NSWindowController <NSCandidateListTouchBarItemDelegate, NSTouchBarDelegate, NSScrubberDelegate, NSScrubberDataSource, iTermBroadcastInputHelperDelegate, iTermGraphCodable, iTermObject, iTermTabBarControlViewDelegate, iTermPasswordManagerDelegate, iTermUniquelyIdentifiable, iTermRootTerminalViewDelegate, iTermToolbeltViewDelegate, NSComboBoxDelegate, PSMMinimalTabStyleDelegate, iTermInstantReplayDelegate, iTermPresentationControllerManagedWindowController, iTermSubscribable, iTermWeaklyReferenceable, iTermWindowController, NSWindowDelegate, PSMTabBarControlDelegate, PSMTabViewDelegate, PTYWindowDelegateProtocol, WindowControllerInterface>
{
    BOOL _fullScreen;
...
+ (id)arrangementForSessionWithGUID:(id)arg1 inWindowArrangement:(id)arg2;
...
+ (unsigned long long)styleMaskForWindowType:(int)arg1 savedWindowType:(int)arg2 hotkeyWindowType:(unsigned long long)arg3;
+ (BOOL)windowTypeIsMovable:(int)arg1;
...
- (void)tabEditSnippets:(id)arg1;
- (void)tabEditActions:(id)arg1;
...
- (BOOL)shouldSaveRestorableStateLegacy:(BOOL)arg1;
- (BOOL)windowRestorationEnabled;
- (BOOL)allTabsAreTmuxTabs;
- (void)window:(id)arg1 didDecodeRestorableState:(id)arg2;
- (void)openPartialAttachmentsForArrangement:(id)arg1 timeout:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;
- (void)asyncRestoreArrangement:(id)arg1 timeout:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;
- (void)restoreArrangement:(id)arg1;
- (void)asyncRestoreState:(id)arg1 timeout:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;
...
- (id)tabGUIDs;
- (id)openTabWithArrangement:(id)arg1 named:(id)arg2 hasFlexibleView:(BOOL)arg3 viewMap:(id)arg4 sessionMap:(id)arg5 partialAttachments:(id)arg6;
- (float)minWidth;
...
- (void)setNeedsUpdateTabObjectCounts:(BOOL)arg1;
...
- (id)arrangement;
- (BOOL)populateArrangementWithTabs:(id)arg1 includingContents:(BOOL)arg2 encoder:(id)arg3;
...
- (id)tabsToEncodeExcludingTmux:(BOOL)arg1;
- (BOOL)restoreTabsFromArrangement:(id)arg1 named:(id)arg2 sessions:(id)arg3 partialAttachments:(id)arg4;
- (BOOL)stringIsValidTerminalGuid:(id)arg1;
- (BOOL)loadArrangement:(id)arg1 named:(id)arg2 sessions:(id)arg3 partialAttachments:(id)arg4;
...
- (BOOL)broadcastInputHelper:(id)arg1 tabWithSessionIsBroadcasting:(id)arg2;
...
- (void)toggleFullScreenModeImpl:(id)arg1;
- (BOOL)togglingLionFullScreenImpl;
- (void)windowDidExitFullScreenImpl:(id)arg1;
- (void)windowWillExitFullScreenImpl:(id)arg1;
- (void)windowDidFailToEnterFullScreenImpl:(id)arg1;
- (void)didFinishFullScreenTransitionSuccessfully:(BOOL)arg1;
- (void)windowDidEnterFullScreenImpl:(id)arg1;
- (void)windowWillEnterFullScreenImpl:(id)arg1;
- (void)enterFullScreenMode;
- (void)delayedEnterFullscreenImpl;
- (void)toggleFullScreenModeImpl:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)changeToWindowType:(int)arg1;
- (BOOL)windowTypeHasTitleBar:(int)arg1;
- (BOOL)windowTypeIsFullScreen:(int)arg1;
