...
@class MTKView, NSColor, NSMutableArray, NSString, NSTextField, PTYScrollView, PTYScroller, SessionTitleView, SplitSelectionView, iTermAnnouncementViewController, iTermBackgroundColorView, iTermDropDownFindViewController, iTermFindDriver, iTermGenericStatusBarContainer, iTermHoverContainerView, iTermImageView, iTermImageWrapper, iTermIncrementalMinimapView, iTermMetalClipView, iTermMetalDriver, iTermSearchResultsMinimapView, iTermUnobtrusiveMessage;
...
@property(readonly, nonatomic) BOOL statusBarIsInPaneTitleBar;
...
@property(retain, nonatomic) iTermImageWrapper *image;
