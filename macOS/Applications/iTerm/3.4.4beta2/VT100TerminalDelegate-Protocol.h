...
- (void)terminalAppendSixelData:(NSData *)arg1;
...
- (BOOL)terminalWillReceiveInlineFileNamed:(NSString *)arg1 ofSize:(long long)arg2 width:(int)arg3 units:(long long)arg4 height:(int)arg5 units:(long long)arg6 preserveAspectRatio:(BOOL)arg7 inset:(struct NSEdgeInsets)arg8;
- (BOOL)terminalWillReceiveFileNamed:(NSString *)arg1 ofSize:(long long)arg2;
...
- (void)terminalSetProxyIcon:(NSString *)arg1;
...
- (NSArray *)terminalSGRCodesInRectangle:(CDStruct_7a47e81c)arg1;
...
- (BOOL)terminalShouldSendReportForVariable:(NSString *)arg1;
