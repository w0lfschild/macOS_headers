...
+ (void)observeNotificationsWithHandler:(CDUnknownBlockType)arg1;
- (void).cxx_destruct;
...
- (id)initWithRawLogger:(id)arg1 plainLogger:(id)arg2 profileGUID:(id)arg3;
