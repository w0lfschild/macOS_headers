...
@class NSDictionary, NSImageView, NSMutableDictionary, NSNumber, NSString, NSTextField, NSView, PTYTabView, iTermDragHandleView, iTermFakeWindowTitleLabel, iTermGenericStatusBarContainer, iTermImageView, iTermLayerBackedSolidColorView, iTermStandardWindowButtonsView, iTermStatusBarViewController, iTermStoplightHotbox, iTermTabBarBacking, iTermTabBarControlView, iTermToolbeltView, iTermWindowSizeView;
...
@interface iTermRootTerminalView : SolidColorView <iTermTabBarControlViewDelegate, iTermDragHandleViewDelegate, iTermGenericStatusBarContainer, iTermStoplightHotboxDelegate>
{
    ...
    NSImageView *_topLeftCornerHalfRoundImageView;
    NSImageView *_topRightCornerHalfRoundImageView;
    NSImageView *_bottomLeftCornerHalfRoundImageView;
    NSImageView *_bottomRightCornerHalfRoundImageView;
    NSImageView *_topLeftCornerFullRoundImageView;
    NSImageView *_topRightCornerFullRoundImageView;
    NSImageView *_bottomLeftCornerFullRoundImageView;
    NSImageView *_bottomRightCornerFullRoundImageView;
...
@property(readonly, nonatomic) iTermImageView *backgroundImage; // @synthesize backgroundImage=_backgroundImage;
...
- (double)topBorderInset;
- (double)bottomBorderInset;
- (double)rightBorderInset;
- (double)leftBorderInset;
...
@property(readonly, nonatomic) BOOL tabBarShouldBeVisibleEvenWhenOnLoan;
