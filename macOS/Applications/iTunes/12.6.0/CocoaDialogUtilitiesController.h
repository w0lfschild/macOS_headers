...
@class ArtworkController, NSArray, NSBox, NSButton, NSButtonCell, NSMutableDictionary, NSProgressIndicator, NSString, NSTabView, NSTabViewItem, NSTextFieldCell, NSTextView, NSToolbar, NSTouchBar, NSView, NSWindow;
