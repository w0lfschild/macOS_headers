...
@interface VisualizerClientOpenGLLayer : CAOpenGLLayer
{
    ...
    struct Visualizer *_mVisualizerForDrawing;
}

@property(nonatomic) int thermalPressure; // @synthesize thermalPressure=_thermalPressure;
@property(nonatomic) struct Visualizer *mVisualizerForDrawing; // @synthesize mVisualizerForDrawing=_mVisualizerForDrawing;
