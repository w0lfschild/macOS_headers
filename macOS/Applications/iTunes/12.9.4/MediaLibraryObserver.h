...
- (int)waitForProperty:(id)arg1 onObject:(id)arg2 withTimeout:(double)arg3 withMainThreadCallback:(function_55f90a0f)arg4 progressInfo:(struct ProgressInfo *)arg5 resultObject:(id *)arg6;
