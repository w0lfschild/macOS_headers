...
@interface NSITViewHost : NSView
{
    ...
    shared_ptr_0819caaf _shim;
}

@property(retain, nonatomic) NSTrackingArea *trackingArea; // @synthesize trackingArea=_trackingArea;
@property(nonatomic) shared_ptr_0819caaf shim; // @synthesize shim=_shim;
@property(nonatomic) weak_ptr_b631f5cc mouseDraggingView; // @synthesize mouseDraggingView=_mouseDraggingView;
@property(nonatomic) struct ITWindow *itWindow; // @synthesize itWindow=_itWindow;
...
@property(nonatomic) shared_ptr_d213862f root;
