...
@interface SubViewMouseSetup : SubViewAutoPairDevice <AutoPairDeviceProtocol>
{
}

- (void)automaticDeviceSetupBluetoothKeyboardConnected:(id)arg1;
- (void)automaticDeviceSetupUSBPairingSuccessful:(id)arg1;
- (void)automaticDeviceSetupUSBKeyboardConnected:(id)arg1;
- (void)automaticDeviceSetupBluetoothMouseBeingPairedConnected:(id)arg1;
- (void)automaticDeviceSetupBluetoothMouseConnected:(id)arg1;
- (void)automaticDeviceSetupUSBMouseConnected:(id)arg1;
- (void)automaticDeviceSetupPairingWaitingForUserAck:(id)arg1 device:(id)arg2 timeRemaining:(int)arg3;
- (void)automaticDeviceSetupPairingDeviceConnected:(id)arg1 deviceNumber:(int)arg2 device:(id)arg3;
- (id)messageWaitingForUserAck:(id)arg1 timeRemaining:(int)arg2;
