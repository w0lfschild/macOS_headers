...
@class NSAppleEventDescriptor, NSMutableArray, NSMutableDictionary, NSNumber, NSString, NSURL;
...
+ (id)alertForURL:(id)arg1 withButtons:(BOOL)arg2 withCautionBadge:(BOOL)arg3 malwareInfo:(id)arg4 quarantineInfo:(id)arg5 allowUnsigned:(BOOL)arg6 riskCategory:(id)arg7 appASN:(struct __LSASN *)arg8;
