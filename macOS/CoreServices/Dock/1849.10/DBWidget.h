...
- (void)_handleEvents;
- (_Bool)_intialize:(unsigned int)arg1 url:(id)arg2 size:(struct CGSize)arg3 identifier:(id)arg4 image:(id)arg5 close_inset:(struct CGPoint)arg6 in_layer:(_Bool)arg7 showDefaultBackground:(_Bool)arg8 vers:(CDStruct_5cef646e)arg9 scaleFactor:(float)arg10;
