...
@class ECLimitQueue, LPRoot, LPStorage, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSSet;
...
- (void)_checkForOlderAppsToReplace:(id)arg1 withApp:(id)arg2 version:(CDStruct_5cef646e)arg3 context:(id)arg4;
