...
@class CALayer, ECSBSpringboard, ECShadowTextLayer, ECTextLayer, LPAppManager, LPLayout, LPRoot, NSArray, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, _TtC4Dock16WALayerKitWindow, _TtC4Dock23AccessibleObserverStore;
