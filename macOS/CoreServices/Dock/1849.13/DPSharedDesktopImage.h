...
+ (void)sharedDesktopImageWithPath:(id)arg1 size:(struct CGSize)arg2 placement:(int)arg3 colorSpace:(id)arg4 scaleFactor:(float)arg5 miniImageScale:(float)arg6 cache:(_Bool)arg7 handler:(CDUnknownBlockType)arg8;
