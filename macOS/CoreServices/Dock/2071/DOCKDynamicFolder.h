...
@interface DOCKDynamicFolder : DOCKFolder <DOCKStackCollapsedDataSource>
{
    ...
    _Bool _needsToInvalidateDataSource;
    NSMutableArray *_menuListCleanup;
    NSMapTable *_fileToMenuItemMap;
}
...
- (void)_setCollapsedPreviewImage:(id)arg1 atIndex:(unsigned long long)arg2 withIconSize:(unsigned long long)arg3 forFile:(id)arg4 cache:(_Bool)arg5;
