...
@property(nonatomic) _Bool darkened; // @synthesize darkened=_darkened;
...
- (_Bool)setFrame:(struct CGRect)arg1;
...
@property(readonly, nonatomic) _Bool isRenderable; // @dynamic isRenderable;
