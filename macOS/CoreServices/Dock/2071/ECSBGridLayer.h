...
@property(nonatomic) _Bool centerSingleRow; // @synthesize centerSingleRow=_centerSingleRow;
...
- (unsigned long long)itemIndexWithFrame:(struct CGRect)arg1 relativeToItemIndex:(unsigned long long)arg2 usingHysteresis:(_Bool)arg3;
