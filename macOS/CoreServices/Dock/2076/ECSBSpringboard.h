...
- (_Bool)performDropAtIndex:(unsigned long long)arg1 withEvent:(id)arg2 sender:(id)arg3;
- (_Bool)canAcceptDropAtIndex:(unsigned long long)arg1 withEvent:(id)arg2 sender:(id)arg3;
...
- (_Bool)handleTextInputKeyEvent:(id)arg1;
...
@property(readonly, nonatomic) _Bool filtering; // @dynamic filtering;
@property(nonatomic) long long pagerControlVisibility; // @dynamic pagerControlVisibility;
@property(nonatomic) _Bool supportsGroups; // @dynamic supportsGroups;
