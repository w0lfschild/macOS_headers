...
@class ECLimitQueue, LPRoot, LPStorage, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSSet, _TtC4Dock20ScreenTimeController;
...
@interface LPAppManager : NSObject
{
    ...
    _Bool _readOnly;
    _Bool _stillScanning;
    _Bool _addingSources;
    _Bool _invalidated;
}
...
@property(nonatomic) _Bool sourcesStillScanning; // @synthesize sourcesStillScanning=_stillScanning;
...
- (void)_scanForApplicationsAtPath:(id)arg1 symlinkUnresolvedPath:(id)arg2 fromSource:(id)arg3 linksFollowed:(id)arg4 recurse:(_Bool)arg5 withContext:(id)arg6;
- (void)_processScannedApplicationURL:(struct __CFURL *)arg1 unresolvedSymlinkPath:(id)arg2 fromSource:(id)arg3 isLink:(_Bool *)arg4 preventRecursion:(_Bool *)arg5 withContext:(id)arg6;
- (void)_newRunnbleFound:(id)arg1 withExistingRunnable:(id)arg2;
- (void)_updateExistingRunnable:(id)arg1 withNewRunnable:(id)arg2 context:(id)arg3;
- (void)_checkForOlderAppsToReplace:(id)arg1 withApp:(id)arg2 version:(struct LSVersionNumber)arg3 context:(id)arg4;
- (void)_addNewRunnable:(id)arg1;
- (void)_source:(id)arg1 atURL:(id)arg2 withContext:(id)arg3;
...
- (void)_findExistingRunnableMatching:(id)arg1 atPath:(id)arg2 resolveURLs:(_Bool)arg3 withExisting:(CDUnknownBlockType)arg4;
...
- (_Bool)_addResumeAuthorizationToMessage:(id)arg1;
...
- (_Bool)pathValidForApplications:(id)arg1;
