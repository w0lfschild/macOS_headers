...
@property(readonly, nonatomic) _Bool restrictDragsToPager; // @synthesize restrictDragsToPager=_restrictDragsToPager;
@property(nonatomic) _Bool supportsGroups; // @synthesize supportsGroups=_supportsGroups;
...
@property(nonatomic) _Bool willBeOpeningGroup; // @synthesize willBeOpeningGroup=_willBeOpeningGroup;
@property(nonatomic) _Bool removingGroup; // @synthesize removingGroup=_removingGroup;
@property(readonly, nonatomic) _Bool closingGroup; // @synthesize closingGroup=_closingGroup;
@property(readonly, nonatomic) _Bool openingGroup; // @synthesize openingGroup=_openingGroup;
...
- (void)reloadItemContents:(_Bool)arg1;
- (void)purgeItemContents:(_Bool)arg1;
...
@property(readonly, nonatomic) _Bool canScroll; // @dynamic canScroll;
@property(readonly, nonatomic) _Bool makingGroup; // @dynamic makingGroup;
- (Class)pagerLayerClass;
@property(nonatomic) _Bool groupShown; // @dynamic groupShown;
