...
- (_Bool)performDropForItem:(id)arg1 withEvent:(id)arg2 sender:(id)arg3;
- (_Bool)canAcceptDropForItem:(id)arg1 withEvent:(id)arg2 sender:(id)arg3;
- (id)debugDump;
