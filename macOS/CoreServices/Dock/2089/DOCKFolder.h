...
@interface DOCKFolder : NSObject <DOCKStackActionHandling, DOCKStackExpandedDataSource>
{
    ...
    NSMutableDictionary *_screenTimeApplications;
    NSMutableDictionary *_screenTimePaths;
...
- (_Bool)prepareForStackDrag:(struct OpaqueCoreDrag *)arg1 atIndex:(unsigned long long)arg2 sender:(id)arg3;
...
- (void)setProgress:(float)arg1 cancelable:(_Bool)arg2 forFile:(id)arg3;
