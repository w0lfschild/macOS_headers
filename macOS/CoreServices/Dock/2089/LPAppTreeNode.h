...
- (_Bool)_apps:(CDUnknownBlockType)arg1;
- (void)_deleteNodeAndPruneEmptyNodes:(_Bool)arg1 atPathComponents:(id)arg2;
- (void)_insertNode:(id)arg1 atPathComponents:(id)arg2;
- (id)_nodeAtPathComponents:(id)arg1 createIfNecessary:(_Bool)arg2;
