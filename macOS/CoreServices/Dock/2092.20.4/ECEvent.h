...
@property(readonly, nonatomic) _Bool scrollWheelReversed; // @dynamic scrollWheelReversed;
@property(readonly, nonatomic) _Bool isMomentum; // @dynamic isMomentum;
@property(readonly, nonatomic) _Bool isContinuous; // @dynamic isContinuous;
...
@property(readonly, nonatomic) _Bool controlKeyDown; // @dynamic controlKeyDown;
@property(readonly, nonatomic) _Bool alternateKeyDown; // @dynamic alternateKeyDown;
@property(readonly, nonatomic) _Bool commandKeyDown; // @dynamic commandKeyDown;
@property(readonly, nonatomic) _Bool shiftKeyDown; // @dynamic shiftKeyDown;
...
@property(readonly, nonatomic) _Bool keyRepeat; // @dynamic keyRepeat;
