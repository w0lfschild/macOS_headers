...
- (_Bool)shouldPresentAlertPanelForAction:(NSString *)arg1 ofItem:(id)arg2 withEvent:(ECEvent *)arg3;
...
- (_Bool)willEndDragOfItem:(id)arg1 withEvent:(ECEvent *)arg2 andLayer:(CALayer *)arg3;
- (_Bool)didDragItem:(id)arg1 withEvent:(ECEvent *)arg2 andLayer:(CALayer *)arg3;
