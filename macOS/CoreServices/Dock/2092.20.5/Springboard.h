...
- (void)_setupApplicationSources:(_Bool)arg1;
...
- (_Bool)unregisterObservationOfItem:(id)arg1;
- (_Bool)registerObservationOfItem:(id)arg1;
...
- (_Bool)isStoreAppForThisLaunchpad:(id)arg1;
...
- (_Bool)shouldPresentAlertPanelForAction:(id)arg1 ofItem:(id)arg2 withEvent:(id)arg3;
...
- (_Bool)willEndDragOfItem:(id)arg1 withEvent:(id)arg2 andLayer:(id)arg3;
- (_Bool)didDragItem:(id)arg1 withEvent:(id)arg2 andLayer:(id)arg3;
...
- (_Bool)canMakeGroupUsingItem:(id)arg1 withItem:(id)arg2;
...
- (_Bool)handleRunnableOpen:(id)arg1 atURL:(id)arg2 fromFrame:(struct CGRect)arg3 toFrame:(struct CGRect *)arg4;
- (void)setVisible:(_Bool)arg1 slow:(_Bool)arg2;
...
- (void)layout;
- (id)_newDesktopLayer;
- (void)_enterExitAnimation:(_Bool)arg1 slow:(_Bool)arg2;
...
- (void)performExitAnimation:(_Bool)arg1;
- (void)performEnterAnimation:(_Bool)arg1;
...
@property(readonly) _Bool filtersWithBlacklist;
...
@property(nonatomic) _Bool deleting; // @dynamic deleting;
...
@property(readonly, nonatomic) _Bool showsDock; // @dynamic showsDock;
