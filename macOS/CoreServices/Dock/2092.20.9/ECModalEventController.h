...
- (void)addHandler:(id)arg1 externalEventSource:(_Bool)arg2 usingMouseHysteresis:(_Bool)arg3;
@property(readonly, nonatomic) _Bool coreDragging; // @dynamic coreDragging;
@property(readonly, nonatomic) id <ECModalEventHandler> currentHandler; // @dynamic currentHandler;
@property(nonatomic) _Bool suppressDraggedEnterExits; // @dynamic suppressDraggedEnterExits;
- (id)init;
