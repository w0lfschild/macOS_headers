...
@property(nonatomic) _Bool useFadeMask; // @synthesize useFadeMask=_useFadeMask;
...
@property(nonatomic) _Bool snapToRowHeight; // @synthesize snapToRowHeight=_snapToRowHeight;
