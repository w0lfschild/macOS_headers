...
- (_Bool)_collectApplicationInfoForURL:(id)arg1;
...
- (id)debugDescription;
@property(readonly, nonatomic) _Bool uiElement;
@property(readonly, nonatomic) _Bool hasExtraPlugin;
- (_Bool)resolvesBookmarks;
- (_Bool)isApp;
