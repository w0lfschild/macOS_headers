...
@class NSImage, NSString, TImageView, TMeetingRoomAreYouSureViewController, TMeetingRoomAskUserViewController, TMeetingRoomErrorViewController, TMeetingRoomProgressController, TMeetingRoomStatusViewController, TMeetingRoomWaitingViewController, TView;
...
- (void)showStatusView;
- (_Bool)isShowingAskUserView;
- (void)showAskUserICloudSharingViewWithSenderName:(struct TString)arg1 URL:(id)arg2;
