...
+ (void)drawBorderImage:(id)arg1 middleImage:(id)arg2 borderImage:(id)arg3 inRect:(struct CGRect)arg4 withOrientation:(unsigned long long)arg5 flipped:(_Bool)arg6 operation:(unsigned long long)arg7 fraction:(double)arg8;
