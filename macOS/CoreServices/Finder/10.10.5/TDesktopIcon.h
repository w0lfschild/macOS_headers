...
{
    struct TNSRef<TBasicImageView *> _iconView;
    struct TNSRef<TDesktopIconSelectionView *> _iconSelectionView;
    struct TNSRef<TDesktopInlineProgressHostView *> _inlineProgressHostView;
    struct TNSRef<TDesktopTitleBubbleView *> _titleBubbleView;
    struct TNSRef<TDesktopSubtitleTextField *> _subtitleField;
    ...
    double _gridSpacing;
    struct TNSRef<NSArray *> _tagColorIndexes;
    struct TNSRef<NSImage *> _placeholderTagImage;
