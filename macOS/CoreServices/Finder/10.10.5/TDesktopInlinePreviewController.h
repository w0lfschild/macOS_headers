...
@interface TDesktopInlinePreviewController : NSObject <QLInlinePreviewDelegate, TTrackingAreaOwnerProtocol>
{
    ...
    struct TNSRef<QLInlinePreviewController *> _rolloverInlinePreviewController;
    struct TNSRef<QLInlinePreviewController *> _playInlinePreviewController;
    struct TNSRef<QLInlinePreviewController *> _mouseInlinePreviewController;
}
