...
{
    struct TNSRef<NSMutableArray *> _desktopViewControllers;
    struct TMutex _desktopViewControllersLock;
    struct TNSRef<TDesktopViewDataSource *> _dataSource;
    struct TNSRef<TDesktopGridLayoutController *> _gridLayoutController;
    struct TNSRef<TDesktopIconSpatialDataController *> _spatialDataController;
    struct TNSRef<TDesktopBandSelectionController *> _bandSelectionController;
    struct TNSRef<TDesktopInlinePreviewController *> _inlinePreviewController;
    struct TNSRef<TGroupInFolderAnimationController *> _groupAsFolderAnimationController;
    struct TFENode _nodeClickedOnMouseDown;
    _Bool _deselectOnBandSelect;
    struct TNSRef<NSEvent *> _mouseDownEventForDrag;
    struct TNSRef<TDesktopViewController *> _viewControllerForDrag;
...
- (_Bool)isDesktopAnchorPoint:(const struct CGPoint *)arg1 obscuredByWindowFrames:(const vector_b8c73e0a *)arg2;
- (_Bool)isDesktopAnchoredFrame:(const struct CGRect *)arg1 obscuredByWindowFrames:(const vector_b8c73e0a *)arg2;
- (void)getPotentiallyObscuringWindowFrames:(vector_b8c73e0a *)arg1;
