...
@interface TEncryptionController : NSObject <DMAsyncDelegate>
{
    ...
    struct TRef<__DADisk *, TRetainReleasePolicy<DADiskRef>> _newVolumeDiskRef;
    _Bool _preflightDone;
...
- (void)setNewVolumeDiskRef:(struct __DADisk *)arg1;
- (struct __DADisk *)newVolumeDiskRef;
- (_Bool)preflightDone;
