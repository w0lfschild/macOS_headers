...
@interface TFENodePBWriterForDrag : TFENodePasteboardItem
{
    ...
    _Bool _itemNeedsConversionOnDrop;
    _Bool _allowsDraggingToMoveFilesOut;
}

@property(nonatomic) _Bool allowsDraggingToMoveFilesOut; // @synthesize allowsDraggingToMoveFilesOut=_allowsDraggingToMoveFilesOut;
