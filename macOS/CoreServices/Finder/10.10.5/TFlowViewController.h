...
@class NSString, NSView, TFlowView;
...
- (void)imageFlow:(id)arg1 dragImage:(id)arg2 at:(struct CGPoint)arg3 offset:(struct CGSize)arg4 event:(id)arg5 pasteboard:(id)arg6 source:(id)arg7 slideBack:(_Bool)arg8;
