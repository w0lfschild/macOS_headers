...
@class NSDateFormatter, NSMutableArray, NSMutableDictionary, NSString, TListHeaderRowView, TListMoreCell, TListNameField, TListTableColumn;

@interface TListViewController : TBrowserViewController <NSOutlineViewDelegate, NSTableViewDelegate, NSOutlineViewDataSource, NSWindowDelegate, NSMenuDelegate, NSScrollViewDelegate>
{
    ...
    _Bool _editing;
    TListNameField *_originalEditedNameField;
...
@property(retain, nonatomic) TListNameField *originalEditedNameField; // @synthesize originalEditedNameField=_originalEditedNameField;
...
@property(nonatomic) TListTableColumn *genericNumericColumn; // @synthesize genericNumericColumn=_genericNumericColumn;
@property(nonatomic) TListTableColumn *genericDateColumn; // @synthesize genericDateColumn=_genericDateColumn;
@property(nonatomic) TListTableColumn *genericTextColumn; // @synthesize genericTextColumn=_genericTextColumn;
- (id).cxx_construct;
- (void).cxx_destruct;
