...
@interface TOpenWithMenuFactory : NSObject
{
    ...
    struct TRef<dispatch_queue_s *, TRetainReleasePolicy<dispatch_queue_t>> _openWithMenuQueue;
...
- (_Bool)getOrFetchAppNodes:(CDUnknownBlockType)arg1;
- (_Bool)getOpenerAppNodes:(CDUnknownBlockType)arg1;
- (_Bool)getDefaultAppNode:(CDUnknownBlockType)arg1;
