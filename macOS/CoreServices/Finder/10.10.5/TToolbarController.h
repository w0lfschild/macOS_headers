...
@class NSButton, NSMenu, NSMenuItem, NSPopUpButton, NSSegmentedControl, NSString, NSToolbar, SGTSearchField, TBrowserWindowController;
...
+ (_Bool)itemArrayContainsSyncExtensions:(id)arg1;
...
@property(readonly, retain, nonatomic) NSMenuItem *arrangeMenu; // @synthesize arrangeMenu=_arrangeMenu;
