...
@interface TBaseBrowserViewController : TViewController <NSDraggingSource, NSSharingServiceDelegate, NSSharingServicePickerDelegate, TBrowserViewDelegate, TDropOperationDelegateProtocol, TNodeTaskDelegateProtocol, TQLPreviewWindowControllerProtocol, TGroupAsFolderDelegate, TTypeSelectDelegate, TValidatorClientProtocol, NSSharingServicePickerTouchBarItemDelegate, NSTouchBarDelegate, TFloatingInputWindowDelegateProtocol>
{
