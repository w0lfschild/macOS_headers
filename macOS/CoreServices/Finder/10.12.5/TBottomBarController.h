...
@class NSString, NSVisualEffectView, TBrowserContainerController, TPathControl;

@interface TBottomBarController : TViewController <TPathControlDelegate, TNodeObserverProtocol, NSMenuDelegate>
{
