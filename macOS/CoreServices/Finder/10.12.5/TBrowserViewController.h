...
@interface TBrowserViewController : TBaseBrowserViewController <TThumbnailExtractorDelegate, NSMenuDelegate>
{
...
- (_Bool)searchResultsArePartial:(unsigned long long)arg1;
...
- (void)resortDataSource:(_Bool)arg1 withSortProperty:(const struct TString *)arg2 completionHandler:(const function_f9feaa7d *)arg3;
...
- (void)flushNodeEventsWithCompletion:(const function_f9feaa7d *)arg1;
