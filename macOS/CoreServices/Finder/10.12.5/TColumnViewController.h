...
#import "AccessibilityProtocol-Protocol.h"
#import "FIAliasResolution-Protocol.h"
#import "TColumnViewDelegate-Protocol.h"
#import "TDuplicateTaskDelegateProtocol-Protocol.h"
#import "TNameTextFieldDelegate-Protocol.h"

@class NSString, TColumnPreviewController;

@interface TColumnViewController : TBrowserViewController <FIAliasResolution, TColumnViewDelegate, AccessibilityProtocol, TNameTextFieldDelegate, TDuplicateTaskDelegateProtocol>
{
    ...
    struct unique_ptr<TColumnPreviewQTEjectHelper, std::__1::default_delete<TColumnPreviewQTEjectHelper>> _ejectHelper;
...
- (id)makeNameCellViewForDragImage:(const struct TFENode *)arg1 inBrowserTableView:(id)arg2;
...
- (void)handleNodeChangedPropertyMap:(const unordered_map_a0710478 *)arg1 forBrowserTableView:(id)arg2;
