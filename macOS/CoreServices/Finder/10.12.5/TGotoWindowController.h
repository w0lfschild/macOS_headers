...
@interface TGotoWindowController : TScriptableWindowController <NSComboBoxDelegate, NSComboBoxDataSource, NSWindowDelegate>
{
    ...
    function_69b63682 _completionHandler;
...
+ (id)showGoToWindowRelativeToNode:(const struct TFENode *)arg1 parentWindow:(id)arg2 initialPath:(const struct TString *)arg3 completionHandler:(const function_69b63682 *)arg4;
...
- (void)setCompletionHandler:(const function_69b63682 *)arg1;
...
- (void)windowDidLoad;
- (id)_initWithRelativeToNode:(const struct TFENode *)arg1 parentWindow:(id)arg2 initialPath:(const struct TString *)arg3 completionHandler:(const function_69b63682 *)arg4;
