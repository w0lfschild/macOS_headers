...
@class TIconSpatialDataController;
...
@interface TIconCollectionViewFreeFormLayout : NSCollectionViewLayout
{
    ...
    struct unordered_map<TFENode, DataBrowserItemSpatialData, std::__1::hash<TFENode>, std::__1::equal_to<TFENode>, std::__1::allocator<std::__1::pair<const TFENode, DataBrowserItemSpatialData>>> _nodeToSpatialDataCache;
}
...
- (struct CGRect)iconViewFrameForSpatialData:(const struct DataBrowserItemSpatialData *)arg1;
- (struct CGRect)iconViewFrameForNode:(const struct TFENode *)arg1;
- (struct CGRect)iconViewFrameForIndexPath:(id)arg1;
- (struct DataBrowserItemSpatialData)spatialDataForNode:(const struct TFENode *)arg1;
