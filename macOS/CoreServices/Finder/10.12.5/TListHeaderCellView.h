...
@interface TListHeaderCellView : NSTableCellView
{
    ...
    function_29a8a487 _shouldForceImageOverText;
}

@property function_29a8a487 shouldForceImageOverText; // @synthesize shouldForceImageOverText=_shouldForceImageOverText;
