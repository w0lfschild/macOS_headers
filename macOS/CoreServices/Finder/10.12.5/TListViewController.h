...
@class NSDictionary, NSString, TListHeaderRowView, TListNameCellView, TListTableColumn;
...
@interface TListViewController : TBrowserViewController <NSOutlineViewDelegate, NSTableViewDelegate, NSOutlineViewDataSource, NSWindowDelegate, NSScrollViewDelegate>
{
    ...
    struct TNSRef<TValidatingDateFormatter *, void> _shortDateFormatter;
    struct TNSRef<TValidatingDateFormatter *, void> _shortDateWithTimeFormatter;
    struct TNSRef<TValidatingDateFormatter *, void> _mediumDateFormatter;
    struct TNSRef<TValidatingDateFormatter *, void> _longDateFormatter;
...
@property(readonly, nonatomic) TListTableColumn *genericNumericColumn; // @synthesize genericNumericColumn=_genericNumericColumn;
@property(readonly, nonatomic) TListTableColumn *genericDateColumn; // @synthesize genericDateColumn=_genericDateColumn;
@property(readonly, nonatomic) TListTableColumn *genericTextColumn; // @synthesize genericTextColumn=_genericTextColumn;
- (id).cxx_construct;
- (void).cxx_destruct;
