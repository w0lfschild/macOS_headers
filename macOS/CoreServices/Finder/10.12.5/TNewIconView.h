...
@interface TNewIconView : TUpdateLayerView <TICloudBadgeButtonContainer, NSDraggingDestination, NSSpringLoadingDestination>
{
...
- (void)updateInlineProgressViewCancelHandler:(const function_f9feaa7d *)arg1;
- (void)setInlineProgressStatus:(const struct TNodeProgressStatus *)arg1 cancelHandler:(const function_f9feaa7d *)arg2;
