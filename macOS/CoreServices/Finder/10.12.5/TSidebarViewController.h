...
@interface TSidebarViewController : TViewController <NSOutlineViewDataSource, TSidebarViewDelegate, NSMenuDelegate, ISpawnOriginDelegateProtocol, QLSeamlessCloserDelegate>
{
    ...
    function_f9feaa7d _sidebarUpdateCallback;
...
- (void)setSidebarUpdateCallback:(function_f9feaa7d)arg1;
