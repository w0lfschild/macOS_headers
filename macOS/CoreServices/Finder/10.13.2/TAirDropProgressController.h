...
@interface TAirDropProgressController : NSObject
{
    ...
    struct TKeyValueObserver _percentConvertedObserver;
    struct TKeyValueObserver _mediaFormatsNeedConversionObserver;
}
...
- (void)bytesToCopyOrBytesCopiedOrPercentConvertedChanged;
