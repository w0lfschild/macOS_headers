...
#import "TIconCollectionViewDelegateProtocol-Protocol.h"
#import "TInfoExtractorDelegate-Protocol.h"

@class NSColor, NSImage, NSString;

@interface TIconCollectionViewController : TBaseCollectionViewController <TIconCollectionViewDelegateProtocol, TInfoExtractorDelegate, TDesktopInlinePreviewDataSource>
{
    double _gridSpacing;
...
- (void)prefetchIconsForNewlyInsertedNodes:(const unordered_map_40f47690 *)arg1;
...
- (void)configureGroupNodes:(const unordered_set_9d385924 *)arg1 firstPopulation:(_Bool)arg2;
...
- (_Bool)collapseNewSections:(const unordered_set_9d385924 *)arg1 firstPopulation:(_Bool)arg2;
...
- (void)displaceNodesToNewPoints:(const struct TFENodeVector *)arg1;
