...
+ (void)animateUngroupingDesktop:(const vector_eda5774c *)arg1 groupFolderLayer:(id)arg2 startingAnchorPoint:(const struct CGPoint *)arg3 duration:(double)arg4 completionBlock:(CDUnknownBlockType)arg5;
+ (void)animateGroupingDesktop:(const vector_eda5774c *)arg1 groupFolderLayer:(id)arg2 destinationAnchorPoint:(const struct CGPoint *)arg3 duration:(double)arg4 completionBlock:(CDUnknownBlockType)arg5;
