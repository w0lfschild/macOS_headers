...
- (struct TFENodeVector)nodesForSpatialDataFromNodes:(const struct TFENodeVector *)arg1;
...
- (vector_805a7690)spatialDataForNodes:(const struct TFENodeVector *)arg1;
- (vector_805a7690)spatialDataForNodes:(const struct TFENodeVector *)arg1 forParent:(struct TFENode)arg2;
