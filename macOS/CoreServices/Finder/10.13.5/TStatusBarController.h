...
@class NSImageView, NSLayoutConstraint, NSProgressIndicator, NSSlider, NSStackView, NSString, NSVisualEffectView, TRefreshButton, TStatusBarBorderView, TStatusTextFldController;
...
@interface TStatusBarController : TViewController <TCoalescingNodeObserverProtocol>
{
    ...
    TStatusBarBorderView *_statusBarBorderView;
