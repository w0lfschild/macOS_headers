...
@interface TBaseBrowserViewController : TViewController <NSDraggingSource, NSSharingServiceDelegate, NSSharingServicePickerDelegate, TBrowserViewDelegate, TDropOperationDelegateProtocol, TNodeTaskDelegateProtocol, TQLPreviewWindowControllerProtocol, TGroupAsFolderDelegate, TTypeSelectDelegate, TMarkTornDown, NSSharingServicePickerTouchBarItemDelegate, NSTouchBarDelegate, TFloatingInputWindowDelegateProtocol>
{
