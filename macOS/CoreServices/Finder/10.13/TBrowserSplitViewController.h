...
- (void)setPreviewColumnCollapsed:(_Bool)arg1 target:(const struct TFENode *)arg2 containerLayoutManager:(id)arg3 animated:(_Bool)arg4;
- (void)collapsePreviewColumn:(_Bool)arg1;
- (void)expandPreviewColumn:(const struct TFENode *)arg1 containerLayoutManager:(id)arg2 animated:(_Bool)arg3;
