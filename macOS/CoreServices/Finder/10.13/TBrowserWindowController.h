...
@interface TBrowserWindowController : TBaseBrowserWindowController <NSWindowDelegate, NSDraggingDestination, BrowserContainerTargeting, BrowserContainerSearching, BrowserContainerDelegate>
{
    struct TNSRef<TTabViewController *, void> _tabViewController;
    struct TNSRef<TSingleLineTabViewController *, void> _singleLineTabViewController;
    shared_ptr_3b64c573 _spawnOrigin;
    struct TNSRef<NSButton *, void> _closeButton;
    ...
    TNSRef_c1203c12 _springRememberedTab;
...
- (id)initForBackupWithState:(id)arg1 targetPath:(const struct TFENodeVector *)arg2 forSnapshotGenerator:(_Bool)arg3 withTMTarget:(struct TTimeMachineTarget *)arg4;
