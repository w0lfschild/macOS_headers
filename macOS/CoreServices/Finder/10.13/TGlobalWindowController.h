...
+ (void)closeWindowForTarget:(const struct TFENode *)arg1;
...
+ (void)retargetFrontOrCreateWindowForFind:(int)arg1 searchString:(id)arg2 shouldSpawn:(_Bool)arg3 scopes:(const vector_e0f53d80 *)arg4;
...
+ (id)firstBrowserWindowControllerActivelyTargetedToNode:(const struct TFENode *)arg1;
...
- (void)spotlightFindFile:(const struct TString *)arg1 isRawString:(_Bool)arg2 scopes:(const vector_e0f53d80 *)arg3;
...
- (void)closeOneWindowDetails:(id)arg1;
- (void)closeAllWindowsExceptDesktop;
- (void)closeAllWindowsExceptDesktopAsync;
- (void)_closeAllWindowsExceptDesktop:(id)arg1 enumerator:(id)arg2;
