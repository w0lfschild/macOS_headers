...
+ (id)showGoToWindowRelativeToNode:(const struct TFENode *)arg1 parentWindow:(id)arg2 initialPath:(const struct TString *)arg3 completionHandler:(const function_52422bbc *)arg4;
...
- (void)windowDidLoad;
- (id)_initWithRelativeToNode:(const struct TFENode *)arg1 parentWindow:(id)arg2 initialPath:(const struct TString *)arg3 completionHandler:(const function_52422bbc *)arg4;
