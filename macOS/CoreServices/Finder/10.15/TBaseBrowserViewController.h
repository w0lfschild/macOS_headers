...
@class NSEvent, NSObject, NSString, NSTouchBar, NSView, TBrowserContainerController, TNodeViewSettings;
...
{
    struct TNSRef<NSCustomTouchBarItem, void> _backForwardTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _viewSwitcherTouchBarItem;
    ...
    struct TNSRef<NSCustomTouchBarItem, void> _emptyTrashTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _deleteSelectionTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _putBackTouchBarItem;
    struct TNSRef<NSPopoverTouchBarItem, void> _viewOptionsTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _sortByTouchBarItem;
    struct TKeyValueBinder _viewSettingsTouchBarBinder;
    struct TNSRef<NSCustomTouchBarItem, void> _quickLookTouchBarItem;
    struct TNSRef<NSSharingServicePickerTouchBarItem, void> _shareButtonTouchBarItem;
    struct TNSRef<NSPopoverTouchBarItem, void> _addTagsTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _tagDotsTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _showEditTagsTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _newFolderTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _newFolderWithSelectionTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _newWindowTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _newTabTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _moveToTrashTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _connectToServerTouchBarItem;
    struct TNSRef<NSPopoverTouchBarItem, void> _openWithTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _openWithViewTouchBarItem;
    struct TNSRef<NSPopoverTouchBarItem, void> _moveToTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _moveToViewTouchBarItem;
    struct TNSRef<NSPopoverTouchBarItem, void> _copyToTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _copyToViewTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _goToTouchBarItem;
    struct TNSRef<NSCustomTouchBarItem, void> _getInfoTouchBarItem;
...
- (void)preflightFPFolderWithNode:(struct TFENode)arg1 service:(id)arg2 completion:(const function_fa9a3333 *)arg3;
