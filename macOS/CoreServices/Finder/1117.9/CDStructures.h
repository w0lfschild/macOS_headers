...
struct TNodeTask {
    ...
    int _field26;
    struct unique_ptr<TNodeTaskProfiler, std::__1::default_delete<TNodeTaskProfiler>> _field27;
    _Bool _field28;
    _Bool _field29;
    int _field30;
...
struct unique_ptr<TNodeTaskProfiler, std::__1::default_delete<TNodeTaskProfiler>> {
    struct __compressed_pair<TNodeTaskProfiler *, std::__1::default_delete<TNodeTaskProfiler>> {
        struct TNodeTaskProfiler *_field1;
    } _field1;
};
