...
@interface IBasePropertyColumnPreviewIconController : TPropertyImageViewController <TPropertyThumbnailExtractorDelegate, TThumbnailExtractorDelegate>
{
    struct TFENodeVector _nodes;
    struct TFENodeVector _nodesToThumbnail;
    ...
    struct TString _paMarkOperationName;
...
- (void)updateImageAnglesForNewNodes:(const struct TFENodeVector *)arg1;
