...
- (void)unlockForRead;
- (void)lockForRead;
- (void)_modifyChildrenOfContainerAsync:(const struct TFENode *)arg1 withUnlockedFunctor:(const function_43c5f29d *)arg2;
