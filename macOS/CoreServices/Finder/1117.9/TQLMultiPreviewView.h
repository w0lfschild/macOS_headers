...
@class NSString, TPropertyColumnPreviewLargeIconController;
@protocol QLPreviewItem;

@interface TQLMultiPreviewView : TUpdateLayerView <QLPreviewCustomView, TMarkTornDown>
{
    TPropertyColumnPreviewLargeIconController *_iconController;
...
@property(readonly, retain) TPropertyColumnPreviewLargeIconController *iconController; // @dynamic iconController;
