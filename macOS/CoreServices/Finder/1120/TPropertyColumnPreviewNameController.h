...
#import "TPropertyNameController.h"
...
@interface TPropertyColumnPreviewNameController : TPropertyNameController <TShrinkToFitDelegateProtocol, NSGestureRecognizerDelegate>
{
