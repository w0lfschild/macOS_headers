...
@interface TSearchSliceController : TViewController <NSTextFieldDelegate, TSearchScopeSliceControllerDelegate, TSearchCriteriaViewControllerDelegate, TMarkTornDown>
{
