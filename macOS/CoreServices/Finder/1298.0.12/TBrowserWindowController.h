...
@interface TBrowserWindowController : TBaseBrowserWindowController <TToolbarControllerDelegateProtocol, NSTouchBarDelegate, NSWindowDelegate, NSDraggingDestination, NSTabDraggingDestination, NSTabDraggingWindowDestination, BrowserContainerTargeting, BrowserContainerSearching, BrowserContainerDelegate>
{
    struct TNSRef<TToolbarController, void> _toolbarController;
    struct TKeyValueBinder _activeContainerBinder;
    struct TNSRef<TTouchBarSearchScopeViewController, void> _searchScopeViewController;
