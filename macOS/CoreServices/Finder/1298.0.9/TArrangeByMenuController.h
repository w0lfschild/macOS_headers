...
@interface TArrangeByMenuController : NSObject
{
    ...
    int _sortBy;
    _Bool _inOpenSave;
    struct TNSWeakPtr<TViewOptionsSettingsController, void> _weakViewOptionsSettingsController;
...
@property(nonatomic) __weak TViewOptionsSettingsController *viewOptionsSettingsController; // @dynamic viewOptionsSettingsController;
