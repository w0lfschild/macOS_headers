...
@class BRContainer, CALayer, CNAvatarCache, CNAvatarViewController, CNContactStore, DMEraseDisk, DeviceCollection, IPropertyValueApplicator, IPropertyValueExtractor, NSAccessibilityCustomAction, NSArray, NSArrayController, NSAttributedString, NSBackgroundActivityScheduler, NSBox, NSButton, NSColor, NSCustomTouchBarItem, NSData, NSDate, NSDateComponents, NSDateInterval, NSDictionary, NSEvent, NSFont, NSGroupTouchBarItem, NSImage, NSImageView, NSImmediateActionGestureRecognizer, NSIndexSet, NSLayoutConstraint, NSLayoutGuide, NSMenu, NSMetadataQuery, NSMutableArray, NSMutableDictionary, NSMutableIndexSet, NSMutableOrderedSet, NSMutableSet, NSNumber, NSObject, NSOperationQueue, NSPasteboard, NSPopoverTouchBarItem, NSSavePanel, NSScrollView, NSSet, NSSharingServicePicker, NSSharingServicePickerTouchBarItem, NSSplitViewItem, NSStackView, NSString, NSTextContainer, NSTextField, NSTextStorage, NSTimer, NSToolbar, NSTouchBar, NSTrackingArea, NSURL, NSURLConnection, NSUbiquitousKeyValueStore, NSValue, NSView, NSViewController, NSVisualEffectView, NSWindow, QLInlinePreviewController, QLPreviewPanel, QLPreviewView, SFAirDropDiscoveryController, SFWirelessSettingsController, TAirDropCollectionViewLayout, TAirDropDiscoverableModePopoverViewController, TAirDropDiscoveryController, TAirDropInfoViewController, TAirDropLegacyModePopoverViewController, TAirDropNotAvailableViewController, TAirDropProgressLayer, TAlertCallbackStub, TArrangeByMenuController, TBVDSBulkConfigChangedState, TBackupContainerDelegate, TBaseBrowserWindowController, TBasicImageView, TBrowserImmediateActionGestureRecognizerDelegate, TBrowserSplitViewController, TBrowserViewContainerController, TBrowserViewController, TBrowserViewDataSource, TBrowserViewSwitchAnimator, TBrowserWindowPlusTabDraggingDelegate, TBulkRenameController, TButton, TChooseAppAccessoryViewController, TClipImageView, TColumnPreviewController, TConnectToFieldEditor, TContainerLayoutManager, TCustomWherePathTextView, TDesktopBandSelectionController, TDesktopGridLayout, TDesktopGridLayoutController, TDesktopGridLayoutControllerDelegate, TDesktopIconSpatialDataController, TDesktopIconView, TDesktopInlinePreviewController, TDesktopInlineProgressView, TDesktopMultiViewController, TDesktopSubtitleTextField, TDesktopTitleBubbleView, TDesktopTitleLayoutManager, TDesktopViewController, TDesktopViewDataSource, TDesktopViewDataSourceItem, TDesktopViewDataSourcePileItem, TFileSizeFormatter, TFloatingInputView, TGalleryIconView, TGalleryPreviewViewController, TGalleryViewSettings, TGoToAutoCompletionController, TGoToFieldEditor, TGroupInFolderAnimationController, TICloudAccountManager, TICloudBadgeButton, TICloudBadgePlaceholderView, TICloudDriveSpaceObserver, TICloudNoDocumentsViewController, TICloudProgressObserver, TIconSelectionView, TIconSpatialDataController, TIconView, TIconViewSettings, TImageView, TInfoWindowApplyToWindowController, TInfoWindowUndoManager, TInlineCancelButtonLayer, TInlinePreviewData, TInlineProgressBarLayer, TInlineProgressHostLayer, TInlineProgressView, TInternalCloudProgressObserver, TKeyValueObserverGlue, TLabelView, TLayer, TListHeaderCellView, TListHeaderRowView, TListNameCellView, TListNameSubtitleTextField, TListTextField, TListViewSettings, TLoadingViewController, TMDUserSearch, TMidnightTimer, TNSSharedFileListItem, TNodeViewSettings, TNodesAndValues, TNotificationCenterObserverGlue, TOpenPanel, TOpenWithChooseAppAccessoryViewController, TOpenWithMenuFactory, TOpenWithPopupMenuController, TOverlappingController, TPathBarController, TPieChartProgressLayer, TPopoverController, TPreviewOptions, TPreviewOptionsController, TPreviewOptionsDynamicGroupSettings, TPreviewOptionsGroup, TPreviewOptionsGroupSettings, TPrivilegesOperation, TProgressStatusViewController, TProgressWindowController, TPropertyLogicalSizeExtractor, TPropertyQLPreviewViewExtractor, TQLMultiPreviewItem, TQLMultiPreviewView, TQLMultiPreviewViewCommonDelegate, TQLPreviewViewZoomController, TQueuedPopoverController, TQuickActionButton, TQuickActionsViewController, TRenameOperation, TRunAfterHelper, TSavePanel, TScrollView, TSearchCriteriaSheetController, TSearchCriteriaViewController, TSearchForSliceController, TSearchScopeSliceController, TSearchSliceController, TSegmentedControl, TShrinkToFitController, TShrinkToFitTextView, TShrinkToFitWindow, TSidebarSplitViewController, TSidebarViewController, TStatusBarController, TTableView, TTableViewController, TTableViewShrinkToFitController, TTagColumnTableViewController, TTagEditorController, TTagInfo, TTagOperationDelegate, TTagSuggestionsWindowController, TTaggingPopoverContentViewController, TTaggingSuggestionsViewController, TTagsImageView, TTargetActionFunctor, TTextField, TTitlePopoverController, TToolbarController, TTouchBarSearchScopeViewController, TTrackingImageView, TUpdateLayerView, TValidatingDateFormatter, TViewGridLayoutController, TViewGridLayoutControllerDelegate, TViewOptionsSettingsController, TWindowHistory, _NSQuickAction, _NSQuickActionProvider, _NSQuickActionValidator;
...
struct TNSRef<TOpenWithChooseAppAccessoryViewController, void> {
    TOpenWithChooseAppAccessoryViewController *fRef;
};
...
struct TNSRef<TSegmentedControl, void> {
    TSegmentedControl *fRef;
};
...
struct TNSRef<TTouchBarSearchScopeViewController, void> {
    TTouchBarSearchScopeViewController *fRef;
};
...
struct TNSWeakPtr<NSResponder<TToolbarControllerDelegateProtocol>, void> {
    struct TNSRef<NSValue, void> fWeakObject;
};
...
struct TNodeTask {
    ...
    struct TNSRef<TVolumeUnmountObserver, void> _field14;
    unsigned int _field15;
    ...
    _Bool _field29;
    int _field30;
    struct OperationIterator *_field31;
    struct OperationRecord *_field32;
    struct TFENode _field33;
    struct TNSRef<NSTimer, void> _field34;
    struct TNSWeakPtr<NSObject<TNodeTaskDelegateProtocol>, void> _field35;
    struct vector<std::__1::pair<OperationConflict, OperationResolution>, std::__1::allocator<std::__1::pair<OperationConflict, OperationResolution>>> _field36;
};
