...
@class NSDictionary, NSEvent, NSLayoutGuide, NSString, TBrowserViewDataSource, TListHeaderRowView, TListNameCellView;

@interface TListViewController : TBrowserViewController <NSOutlineViewDelegate, NSTableViewDelegate, NSOutlineViewDataSource, NSWindowDelegate, NSScrollViewDelegate, TListNameFieldDelegate, TListRowViewDelegate, TListViewDelegate>
{
...
- (void)_superGroupAsFolderUndoCompleted:(struct TNodeTask *)arg1 forGroupFolder:(const struct TFENode *)arg2 nodes:(const struct TFENodeVector *)arg3 status:(int)arg4;
- (void)groupAsFolderCompleted:(struct TNodeTask *)arg1 withFolder:(const struct TFENode *)arg2 status:(int)arg3;
- (void)_superGroupAsFolderCompleted:(struct TNodeTask *)arg1 withFolder:(const struct TFENode *)arg2 status:(int)arg3;
