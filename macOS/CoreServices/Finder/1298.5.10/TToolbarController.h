...
@class NSButton, NSMenu, NSMenuItem, NSPopUpButton, NSResponder, NSSegmentedControl, NSString, SGTSearchField, TSegmentedControl;
...
@interface TToolbarController : NSController <NSToolbarDelegate, TMarkTornDown>
{
    ...
    struct TNSWeakPtr<NSResponder<TToolbarControllerDelegateProtocol>, void> _weakDelegate;
