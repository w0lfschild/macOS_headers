...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(readonly) _Bool immediateActionGestureRecognizerDidRecognize; // @synthesize immediateActionGestureRecognizerDidRecognize=_immediateActionGestureRecognizerDidRecognize;
...
- (id)desktopView;
@property __weak NSObject<TDesktopViewControllerDelegateProtocol> *delegate; // @dynamic delegate;
