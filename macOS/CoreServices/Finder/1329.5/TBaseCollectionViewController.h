...
@interface TBaseCollectionViewController : TBrowserViewController <NSCollectionViewDelegate, NSCollectionViewDataSourcePrivate, TCollectionViewDelegateProtocol>
{
    ...
    struct TNSRef<NSCollectionViewDiffableDataSource<FINode *, FINode *>, void> _diffableDataSource;
}
...
- (void)diffableDataSourceChanged:(const vector_274a36ec *)arg1;
- (void)diffableDataSourceChanged_buildPropChanged:(const struct TFENode *)arg1:(const struct TBVDSChangedPayload *)arg2:(unordered_map_80f1bec4 *)arg3;
- (void)diffableDataSourceChanged_Move:(const struct TFENode *)arg1:(const struct TBVDSChangedPayload *)arg2:(id)arg3;
- (void)diffableDataSourceChanged_Insert:(const struct TFENode *)arg1:(const struct TBVDSChangedPayload *)arg2:(unordered_set_931aff12 *)arg3:(unordered_set_931aff12 *)arg4:(struct TFENodeOrderedSet *)arg5:(id)arg6;
- (void)diffableDataSourceChanged_Remove:(const struct TFENode *)arg1:(const struct TBVDSChangedPayload *)arg2:(unordered_set_931aff12 *)arg3:(id)arg4;
- (id)diffableDataSource;
- (void)didUpdateSnapshot:(id)arg1;
- (void)willUpdateSnapshot:(id)arg1;
- (void)dataSourceChanged_buildPropChanged:(const struct TFENode *)arg1:(const struct TBVDSChangedPayload *)arg2:(unordered_map_80f1bec4 *)arg3;
