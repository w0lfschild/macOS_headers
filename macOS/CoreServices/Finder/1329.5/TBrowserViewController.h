...
@class NSArray, NSLayoutGuide, NSString, NSView, NSVisualEffectView, TBrowserViewDataSource, TContainerLayoutManager;

@interface TBrowserViewController : TBaseBrowserViewController <FPUIActionViewControllerDelegate, TThumbnailExtractorDelegate, NSMenuDelegate, NSMenuItemValidation, NSScrollViewDelegate, NSToolbarItemValidation>
{
