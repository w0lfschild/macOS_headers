...
@interface TDesktopMultiViewController : NSResponder <TDesktopInlinePreviewDataSource, TDesktopViewDataSourceDelegateProtocol, TDesktopViewControllerDelegateProtocol, NSMenuItemValidation, TGroupAsFolderDelegate>
{
...
- (void)invalidateThumbnailsInDrag:(const unordered_set_931aff12 *)arg1;
