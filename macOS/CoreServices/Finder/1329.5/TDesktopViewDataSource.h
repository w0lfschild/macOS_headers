...
- (void)getGroupedItemsToAddAndRemoveForNodes:(const struct TFENodeVector *)arg1 itemsToRemove:(id)arg2 sortedItemsToAdd:(id)arg3 pileItems:(vector_bbe7e81c *)arg4 sortAddedItems:(_Bool)arg5 delegate:(id)arg6 iconSize:(unsigned long long)arg7 fetchThumbnails:(_Bool)arg8 isDarkBackground:(_Bool)arg9;
- (struct TFENodeVector)updateNodesForTaggedFolders:(const struct TFENodeVector *)arg1;
- (id)createDesktopItemsWithNodesToRemove:(const struct TFENodeVector *)arg1 isDarkBackground:(_Bool)arg2 group:(const shared_ptr_2bd9f2cf *)arg3 groupsToMove:(unordered_set_66e9327b *)arg4;
- (id)createDesktopItemsWithNodesToAdd:(const struct TFENodeVector *)arg1 delegate:(id)arg2 iconSize:(unsigned long long)arg3 fetchThumbnails:(_Bool)arg4 isDarkBackground:(_Bool)arg5 group:(const shared_ptr_2bd9f2cf *)arg6 groupsToMove:(unordered_set_66e9327b *)arg7 folders:(id)arg8 volumes:(id)arg9;
- (id)createDesktopItemForNode:(const struct TFENode *)arg1 delegate:(id)arg2 iconSize:(unsigned long long)arg3 fetchThumbnails:(_Bool)arg4 isDarkBackground:(_Bool)arg5 group:(const shared_ptr_2bd9f2cf *)arg6 isForAdd:(_Bool)arg7 waitForThumbnail:(_Bool)arg8;
