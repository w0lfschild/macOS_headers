...
@property(readonly, nonatomic) TRenameOperation *renameOp; // @dynamic renameOp;
@property(readonly, nonatomic) NSWindow *parentWindow; // @dynamic parentWindow;
@property(readonly, nonatomic) TShrinkToFitTextView *stfTextView; // @dynamic stfTextView;
- (void)dealloc;
