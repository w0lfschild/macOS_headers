...
@class NSArray, NSString, TTagSuggestionsWindowController, TTaggingSuggestionsViewController;
...
@interface TTaggingTokenField : NSTokenField <TTouchBarTagsViewTagProviding, NSTouchBarDelegate, TMarkTornDown>
{
    ...
    _Bool _wasCancelled;
    TNSWeakPtr_971ddea6 _showSuggestionsWindowToken;
    ...
    struct TNSWeakPtr<TTouchBar, void> _editTagsTouchBar;
    struct TNSWeakPtr<TCustomTouchBarItem, void> _touchBarAddTagsToolBarItem;
