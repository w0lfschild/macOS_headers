...
- (void)getGroupedItemsToAddAndRemoveForNodes:(const struct TFENodeVector *)arg1 itemsToRemove:(id)arg2 sortedItemsToAdd:(id)arg3 pileItems:(vector_bbe7e81c *)arg4 sortAddedItems:(_Bool)arg5 iconSize:(unsigned long long)arg6 fetchThumbnails:(_Bool)arg7 isDarkBackground:(_Bool)arg8 withImages:(unordered_map_a7a4a2b7 *)arg9;
...
- (id)createDesktopItemsWithNodesToAdd:(const struct TFENodeVector *)arg1 iconSize:(unsigned long long)arg2 fetchThumbnails:(_Bool)arg3 isDarkBackground:(_Bool)arg4 group:(const shared_ptr_2bd9f2cf *)arg5 groupsToMove:(unordered_set_66e9327b *)arg6 folders:(id)arg7 volumes:(id)arg8 images:(unordered_map_a7a4a2b7 *)arg9;
