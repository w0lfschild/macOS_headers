...
@property(readonly, retain) NSView *browserColumnView; // @dynamic browserColumnView;
@property(readonly, retain) TBrowserViewContainerController *browserViewContainerController;
