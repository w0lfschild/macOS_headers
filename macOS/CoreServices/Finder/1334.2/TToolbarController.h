...
@class NSArray, NSButton, NSMenu, NSMenuItem, NSPopUpButton, NSResponder, NSSegmentedControl, NSString, NSToolbar, SGTSearchField, TSegmentedControl, TToolbarCustomizationController;
