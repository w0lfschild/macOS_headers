...
@class NSEvent, NSObject, NSString, NSView, TBrowserContainerController, TNodeViewSettings, TTouchBar;
...
- (void)handlePreflightServiceWithItems:(id)arg1 service:(id)arg2 completion:(const function_0f9bafe8 *)arg3;
...
- (_Bool)canShareWithSpecificSharingService:(id)arg1;
