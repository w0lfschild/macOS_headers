...
struct function<NSImage *(bool, bool, bool, NSTableViewRowSizeStyle, double)> {
    struct __value_func<NSImage *(bool, bool, bool, NSTableViewRowSizeStyle, double)> {
        struct type __buf_;
