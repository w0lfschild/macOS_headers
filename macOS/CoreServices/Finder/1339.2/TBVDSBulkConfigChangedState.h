...
@interface TBVDSBulkConfigChangedState : NSObject
{
    ...
    function_d3afe2e2 _sortByCompletionHandler;
}

- (id).cxx_construct;
- (void).cxx_destruct;
@property function_d3afe2e2 sortByCompletionHandler; // @synthesize sortByCompletionHandler=_sortByCompletionHandler;
