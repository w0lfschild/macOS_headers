...
- (void)getGroupedItemsToAddAndRemoveForNodes:(const struct TFENodeVector *)arg1 itemsToRemove:(id)arg2 sortedItemsToAdd:(id)arg3 pileItems:(vector_bbe7e81c *)arg4 sortAddedItems:(_Bool)arg5 withImages:(const unordered_map_a7a4a2b7 *)arg6;
