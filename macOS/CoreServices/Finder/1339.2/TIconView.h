...
@interface TIconView : TUpdateLayerView <TCollectionViewItemViewProtocol, TICloudBadgeButtonContainer, TImageAttachmentContainer, NSSpringLoadingDestination, NSDraggingDestination, TMarkTornDown>
{
    ...
    function_d3afe2e2 _iCloudDownloadHandler;
    ...
    struct TNSRef<NSSet<NSString *>, void> _subtitleStringSet;
...
- (void)updateInlineProgressViewCancelHandler:(const function_d3afe2e2 *)arg1;
- (void)setInlineProgressStatus:(const struct TNodeProgressStatus *)arg1 cancelHandler:(const function_d3afe2e2 *)arg2;
...
@property(nonatomic, getter=isIconDimmed) _Bool iconDimmed; // @dynamic iconDimmed;
- (_Bool)isDimmed;
@property(nonatomic, getter=isSubtitleEnabled) _Bool subtitleEnabled; // @dynamic subtitleEnabled;
@property(nonatomic, getter=isTitleEnabled) _Bool titleEnabled; // @dynamic titleEnabled;
...
@property(nonatomic) const vector_12bd641b *tagColorIndexes; // @dynamic tagColorIndexes;
@property(copy, nonatomic) NSImage *vendorBadgeImage;
@property(copy, nonatomic) NSImage *badgeImage; // @dynamic badgeImage;
@property(copy, nonatomic) NSColor *subtitleFontColor; // @dynamic subtitleFontColor;
...
@property(copy, nonatomic) NSSet *subtitleStringSet; // @dynamic subtitleStringSet;
...
@property(copy, nonatomic) NSColor *titleFontColor; // @dynamic titleFontColor;
- (id)_titleFontColor;
