...
{
    struct unordered_map<TFENode, NSObject *, std::__1::hash<TFENode>, std::__1::equal_to<TFENode>, std::__1::allocator<std::__1::pair<const TFENode, NSObject *>>> _values;
    shared_ptr_f8db59dd _allNodes;
    struct TString _attribute;
    _Bool _forPreview;
    TNodesAndValues *_masterValues;
    ...
    NSObject *_highest;
    double _total;
    struct unordered_map<NSObject *, unsigned long, std::__1::hash<NSObject *>, std::__1::equal_to<NSObject *>, std::__1::allocator<std::__1::pair<NSObject *const, unsigned long>>> _uniqueValueCounts;
    struct vector<std::__1::pair<NSObject *, unsigned long>, std::__1::allocator<std::__1::pair<NSObject *, unsigned long>>> _valuesSortedByCount;
...
- (struct TFENodeVector)nodesWithValues;
...
- (id)initWithAttribute:(const struct TString *)arg1 allNodes:(const shared_ptr_f8db59dd *)arg2 forPreview:(_Bool)arg3;
