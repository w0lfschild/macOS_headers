...
@class NSBackgroundActivityScheduler, NSMenu, NSString, TArrangeByMenuController, TICloudAccountManager, TMidnightTimer;
...
@interface TApplicationController : NSResponder <NSMenuDelegate, NSApplicationDelegate, NSToolbarItemValidation, TNodeObserverProtocol>
{
    ...
    TICloudAccountManager *_iCloudAccountMonitor;
