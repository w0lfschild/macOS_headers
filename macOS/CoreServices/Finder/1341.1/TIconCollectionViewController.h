...
@interface TIconCollectionViewController : TIconOrGalleryCollectionViewController <TUpdateLayoutControllerSuspenderProtocol, TInfoExtractorDelegate, TDesktopInlinePreviewDataSource>
{
    ...
    struct TKeyValueObserver _verticalScrollerVisibleObserver;
    _Bool _isObservingVerticalScroller;
    struct TNotificationCenterObserver _scrollerStyleObserver;
}
...
- (void)observeVerticalScrollerVisibility:(_Bool)arg1;
