...
@interface TBackupContainerDelegate : NSObject <TGoToWindowDelegate, TMarkTornDown>
{
    ...
    function_d3afe2e2 _viewSyncedToDataSourceHandler;
    struct TFENode _viewSyncedToDataSourceTarget;
    function_d3afe2e2 _viewFullyPopulatedHandler;
    struct TFENode _oldTargetContainer;
    struct TNSWeakPtr<TBrowserContainerController, void> _weakContainer;
    TNSWeakPtr_971ddea6 _delayedScrollContentChangedToken;
...
@property(readonly, nonatomic) __weak TBrowserContainerController *container; // @dynamic container;
