...
@class NSMutableIndexSet, NSObject, NSString, TContainerLayoutManager, TICloudProgressObserver, TSidebarView;
@protocol TSidebarViewControllerDelegate;

@interface TSidebarViewController : TViewController <NSOutlineViewDataSource, TSidebarViewDelegate, NSMenuDelegate, NSMenuItemValidation, ISpawnOriginDelegateProtocol, QLSeamlessCloserDelegate, TMarkTornDown>
{
    TSidebarView *_sidebarView;
    struct TNSWeakPtr<NSObject<TSidebarViewControllerDelegate>, void> _delegate;
    ...
    function_d3afe2e2 _sidebarUpdateCallback;
    struct TFENodeVector _animatedCells;
    struct vector<NSWindow *, std::__1::allocator<NSWindow *>> _animatedCellViews;
    ...
    TICloudProgressObserver *_iCloudObserver;
...
- (void)setProgressPercentage:(double)arg1 ifApplies:(const function_06359cd0 *)arg2 initial:(_Bool)arg3;
...
- (void)setSidebarUpdateCallback:(function_d3afe2e2)arg1;
...
@property(readonly, nonatomic) __weak NSObject<TSidebarViewControllerDelegate> *delegate; // @dynamic delegate;
