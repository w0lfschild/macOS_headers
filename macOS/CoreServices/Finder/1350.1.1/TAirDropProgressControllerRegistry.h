...
@interface TAirDropProgressControllerRegistry : NSObject <TCoalescingNodeObserverProtocol>
{
    ...
    struct vector<TNSWeakPtr<NSObject<TAirDropProgressControllerDelegate>, void>, std::__1::allocator<TNSWeakPtr<NSObject<TAirDropProgressControllerDelegate>, void>>> _weakDelegates;
    struct shared_ptr<TCoalescingNodeObserverCocoaBridge> _nodeObserver;
    _Bool _isUserInAirDrop;
    TNSWeakPtr_971ddea6 _updateControllersToken;
