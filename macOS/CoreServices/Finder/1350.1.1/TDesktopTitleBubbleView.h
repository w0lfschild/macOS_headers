...
- (void)setICloudBadge:(int)arg1 keepPlaceHolder:(_Bool)arg2 placeHolder:(TNSRef_69374e60 *)arg3 clickHandler:(const function_d3afe2e2 *)arg4 context:(int)arg5 toolTip:(const struct TString *)arg6;
