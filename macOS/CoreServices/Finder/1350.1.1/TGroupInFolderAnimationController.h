...
+ (void)animateUngroupingDesktop:(const vector_558f1846 *)arg1 groupFolderLayer:(id)arg2 startingAnchorPoint:(const struct CGPoint *)arg3 duration:(double)arg4 completionFunc:(const function_d3afe2e2 *)arg5;
+ (void)animateGroupingDesktop:(const vector_558f1846 *)arg1 groupFolderLayer:(id)arg2 destinationAnchorPoint:(const struct CGPoint *)arg3 duration:(double)arg4 completionFunc:(const function_d3afe2e2 *)arg5;
