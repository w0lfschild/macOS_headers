...
+ (id)tagInfoPlaceholderWithName:(id)arg1;
...
- (void)dealloc;
- (id)initWithName:(id)arg1 tagNode:(const struct TFENode *)arg2 label:(short)arg3 isVisible:(const struct TriStateBool *)arg4 isAddTagPlaceholder:(_Bool)arg5;
