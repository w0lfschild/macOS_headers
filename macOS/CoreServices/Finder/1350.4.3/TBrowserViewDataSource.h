...
- (void)unlockForRead;
- (void)lockForRead;
- (void)_modifyChildrenOfContainerAsync:(const struct TFENode *)arg1 withUnlockedFunctor:(const function_4df49464 *)arg2;
...
- (void)_resortOnWorkerQueue:(id)arg1 completionHandler:(const function_d3afe2e2 *)arg2 forceResort:(_Bool)arg3;
- (void)setSortBy:(int)arg1 inIncreasingOrder:(_Bool)arg2 sortFoldersFirst:(_Bool)arg3 completionHandler:(const function_d3afe2e2 *)arg4;
