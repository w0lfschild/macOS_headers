...
@interface TDesktopViewController : TBaseBrowserViewController <NSMenuDelegate, TDesktopViewDelegate, QLPreviewMenuItemDelegate>
{
    ...
    TDesktopIconView *_pileIconClickedOnMouseDown;
    TDesktopIconView *_viewHiddenForSkimming;
    TDesktopViewDataSourceItem *_itemShownForSkimming;
    vector_26ddff62 _itemsToSkim;
