...
@interface TSearchCriteriaViewController : TViewController <NSTextFieldDelegate, NSRuleEditorDelegate, TSearchCriteriaSheetDelegate, TMarkTornDown>
{
...
@property(nonatomic) __weak NSObject<TSearchCriteriaViewControllerDelegate> *delegate; // @dynamic delegate;
