...
#import "TToolbarControllerDelegateProtocol-Protocol.h"

@class NSDate, NSString, NSTimer, NSWindow, TBackupContainerDelegate, TBrowserContainerController, TBrowserContentViewController, TBrowserWindowPlusTabDraggingDelegate, TContainerLayoutManager, TNodeViewSettings, TToolbarController;

@interface TBrowserWindowController : TBaseBrowserWindowController <TToolbarControllerDelegateProtocol, NSTouchBarDelegate, NSWindowDelegate, NSDraggingDestination, NSMenuItemValidation, NSToolbarItemValidation, NSTabDraggingDestination, NSTabDraggingWindowDestination, BrowserContainerTargeting, BrowserContainerSearching, BrowserContainerDelegate>
{
    TToolbarController *_toolbarController;
    struct TKeyValueBinder _activeContainerBinder;
    struct TNSWeakPtr<TTouchBar, void> _activeTouchBar;
    struct TNSWeakPtr<TCustomTouchBarItem, void> _searchLabelTouchBarItem;
    struct TNSWeakPtr<TCustomTouchBarItem, void> _searchScopeTouchBarItem;
    ...
    TBackupContainerDelegate *_initTimeBackupDelegate;
    TBrowserWindowPlusTabDraggingDelegate *_plusTabDraggingDelegate;
    ...
    function_d3afe2e2 _fullScreenExitCallback;
...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(readonly, nonatomic, getter=isExitingFullScreen) _Bool exitingFullScreen; // @synthesize exitingFullScreen=_exitingFullScreen;
@property(readonly, nonatomic) NSDate *windowCreationTime; // @synthesize windowCreationTime=_windowCreationTime;
...
- (void)setExitFullScreenCallback:(const function_d3afe2e2 *)arg1;
...
- (pair_38a1eb9e)searchScopeTitlesAndScopeIndex;
