...
@interface TDesktopViewDataSource : NSObject <TInfoExtractorDelegate, TNodeEngineProtocol, TReadWriteLockingProtocol, TThumbnailExtractorDelegate, TMarkTornDown>
{
    ...
    struct TNSWeakPtr<NSObject<TDesktopViewDataSourceDelegateProtocol>, void> _weakDelegate;
...
- (id)getPileItemForGroup:(const shared_ptr_2bd9f2cf *)arg1;
...
- (unordered_map_a7a4a2b7)imagesForNodes:(const struct TFENodeVector *)arg1;
- (void)getGroupedItemsToAddAndRemoveForNodes:(const struct TFENodeVector *)arg1 itemsToRemove:(id)arg2 sortedItemsToAdd:(id)arg3 pileItems:(vector_26ddff62 *)arg4 sortAddedItems:(_Bool)arg5 withImages:(const unordered_map_a7a4a2b7 *)arg6;
- (struct TFENodeVector)updateNodesForTaggedFolders:(const struct TFENodeVector *)arg1;
- (id)createDesktopItemsWithNodesToRemove:(const struct TFENodeVector *)arg1 group:(const shared_ptr_2bd9f2cf *)arg2 groupsToMove:(unordered_set_66e9327b *)arg3;
- (id)createDesktopItemsWithNodesToAdd:(const struct TFENodeVector *)arg1 group:(const shared_ptr_2bd9f2cf *)arg2 groupsToMove:(unordered_set_66e9327b *)arg3 folders:(id)arg4 volumes:(id)arg5 images:(const unordered_map_a7a4a2b7 *)arg6;
- (id)createDesktopItemForNode:(const struct TFENode *)arg1 group:(const shared_ptr_2bd9f2cf *)arg2 isForAdd:(_Bool)arg3 withImage:(id)arg4;
...
@property __weak NSObject<TDesktopViewDataSourceDelegateProtocol> *delegate; // @dynamic delegate;
...
- (void)sortAsynchronouslyWithCompletionBlock:(const function_d3afe2e2 *)arg1;
- (void)setSortBy:(int)arg1 withCompletionBlock:(const function_d3afe2e2 *)arg2;
@property int sortBy; // @dynamic sortBy;
- (void)updatePileCountForGroup:(const shared_ptr_2bd9f2cf *)arg1 increment:(_Bool)arg2 updatedPiles:(id)arg3;
- (void)resetPileCountForGroup:(const shared_ptr_2bd9f2cf *)arg1;
- (id)setPileItemForGroup:(struct TGroup *)arg1 hide:(_Bool)arg2 resetCollapsedState:(_Bool)arg3 insertIfNeeded:(_Bool)arg4;
- (void)groupAsynchronouslyWithCompletionHandler:(const function_d3afe2e2 *)arg1;
...
- (void)setGroupBy:(int)arg1 withCompletionHandler:(const function_d3afe2e2 *)arg2;
@property int groupBy; // @dynamic groupBy;
@property unsigned long long iconSize; // @dynamic iconSize;
@property(readonly) NSOrderedSet *sortedItems; // @dynamic sortedItems;
- (void)postDidChangeSelectedNodes;
- (void)deselectAll;
- (void)selectAll;
...
@property(readonly) NSIndexSet *selectedNodesIndexes; // @dynamic selectedNodesIndexes;
...
- (struct TFENodeVector)nodesInGroup:(const shared_ptr_2bd9f2cf *)arg1;
