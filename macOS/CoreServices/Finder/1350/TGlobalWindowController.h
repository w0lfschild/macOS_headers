...
{
    struct TNotificationCenterObserver _spaceChangedObserver;
...
+ (void)targetSelectOrCreateWindowsForTargetsAsync:(const struct TFENodeVector *)arg1 withOptions:(const vector_a313d94e *)arg2;
...
+ (pair_9532ba8d)selectionForMainBrowserWindowUpTo:(unsigned long long)arg1;
...
- (void)restoreOneBrowserWindowFromState:(id)arg1 forReopenEvent:(_Bool)arg2 withCompletion:(const function_910c940d *)arg3;
...
- (void)cmdGoToSharedByMe:(id)arg1;
- (void)cmdGoToSharedWithMe:(id)arg1;
- (void)cmdGoToAllShared:(id)arg1;
- (_Bool)validateGoToSharedByMe:(id)arg1;
- (_Bool)validateGoToSharedWithMe:(id)arg1;
- (_Bool)validateGoToAllShared:(id)arg1;
