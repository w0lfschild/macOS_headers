...
@class HPDQuery, HVHelpViewController, HVURLHandler, NSMutableArray, NSMutableDictionary, NSString, NSURL, WebHistoryItem, WebScriptObject;

@interface HVWebDelegate : NSObject <HPDQueryDelegate>
{
    HVHelpViewController *helpViewController;
...
- (void)callJSMethodTOCButtonUncheckCallback;
- (void)callJSMethodTOCButtonCheckCallback;
...
- (void)_loadLocalURLInWebView:(id)arg1 forFailedURL:(id)arg2 withInitialURL:(id)arg3;
