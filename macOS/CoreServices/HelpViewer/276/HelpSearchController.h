...
@class HVHelpViewController, HVSearchField, HelpViewToolbarController, NSArray, NSMutableArray, NSScrollView, NSString, NSTableView, NSTextField, NSWindow;
...
@interface HelpSearchController : NSObject <NSTextFieldDelegate, NSTableViewDelegate, NSTableViewDataSource, HPDQueryDelegate>
{
    ...
    NSArray *mEventObervers;
    NSArray *mEventMonitors;
}
