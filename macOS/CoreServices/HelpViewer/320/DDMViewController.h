...
- (void)_displayTopic:(id)arg1 jumpToAnchor:(id)arg2;
- (void)_requestTopicWithID:(id)arg1 jumpToAnchor:(id)arg2;
- (void)_loadTopicWithID:(id)arg1 jumpToAnchor:(id)arg2;
- (void)mtLogErrors:(long long)arg1;
- (void)_requestDDMBookWithHelpBookID:(id)arg1 selectTopicWithID:(id)arg2 jumpToAnchor:(id)arg3;
- (void)_loadDDMBook:(id)arg1 withHelpBookID:(id)arg2 selectTopicWithID:(id)arg3 jumpToAnchor:(id)arg4;
