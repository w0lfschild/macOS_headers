...
@class DDMAsideController, DDMBook, DDMTocItem, HVContentLoadController, HVSidebarController, HVWebDelegate, NSArray, NSSplitViewController, NSString, NSView, SearchableWebView;
...
- (void).cxx_destruct;
- (void)_mtLogErrors:(long long)arg1;
