...
@class HPDQuery, HVContentLoadController, HVResultCellView, HVResultsHistoryItem, NSArray, NSMutableArray, NSString, NSTableView, NSTextField, NSView, SearchableWebView;
