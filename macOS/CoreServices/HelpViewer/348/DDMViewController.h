...
@class DDMAsideController, DDMBook, DDMTocItem, HVContentLoadController, HVSidebarController, HVWebDelegate, JSValue, NSArray, NSSplitViewController, NSString, NSView, SearchableWebView;
