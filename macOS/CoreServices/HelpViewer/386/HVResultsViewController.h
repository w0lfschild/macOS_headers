...
@class HPDQuery, HVContentLoadController, HVResultCellView, HVResultsHistoryItem, NSArray, NSLayoutConstraint, NSMutableArray, NSString, NSTableView, NSView, SearchableWebView;
...
@interface HVResultsViewController : NSViewController <HPDQueryDelegate, HVContentController>
{
    ...
    HVResultCellView *_allHelpSizingView;
    ...
    NSLayoutConstraint *_offlineMessageConstraint;
}

- (void).cxx_destruct;
@property __weak NSLayoutConstraint *offlineMessageConstraint; // @synthesize offlineMessageConstraint=_offlineMessageConstraint;
...
@property(retain) HVResultCellView *allHelpSizingView; // @synthesize allHelpSizingView=_allHelpSizingView;
...
- (id)_sizingCellViewWithIdentifier:(id)arg1;
...
- (void)endLoadOperation:(id)arg1;
- (void)beginLoadOperation:(id)arg1;
