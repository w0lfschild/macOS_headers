...
#import "HVSearchFieldFocusDelegate-Protocol.h"
...
@class HVSearchController, HVSearchField, HVTextView, HVToolbar, NSArray, NSMenu, NSMenuItem, NSMutableDictionary, NSPopUpButton, NSProgressIndicator, NSSearchField, NSSegmentedControl, NSString;
@protocol HVContentController, HVToolbarHistoryDelegate;

@interface HVToolbarController : NSObject <NSToolbarItemValidation, HVSearchFieldFocusDelegate, NSToolbarDelegate, NSMenuDelegate, NSSharingServicePickerDelegate, NSSharingServiceDelegate>
{
    HVToolbar *_toolbar;
