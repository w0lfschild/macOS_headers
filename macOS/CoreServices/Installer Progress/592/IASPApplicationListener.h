...
- (void).cxx_destruct;
@property(retain) NSMutableDictionary *connectedProcesses; // @synthesize connectedProcesses=_connectedProcesses;
...
- (void)setProgressIndicatorInfo:(id)arg1;
