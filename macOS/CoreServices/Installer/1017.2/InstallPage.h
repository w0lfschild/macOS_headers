...
@interface InstallPage : InstallerPane <IFDInstallDelegate>
{
    ...
    BOOL _shouldFailDueToWarning;
}

- (void)_startPostLogoutInstallWithDocument:(id)arg1;
- (BOOL)_shouldDoPostLogoutInstallForDocument:(id)arg1 failInstall:(char *)arg2;
...
- (void)installWarning:(id)arg1 forInstallDocument:(id)arg2 shouldFail:(char *)arg3;
