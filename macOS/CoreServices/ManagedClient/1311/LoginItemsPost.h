...
+ (BOOL)adjustLoginItemsROSPPaths:(id)arg1 forKey:(id)arg2;
+ (void)doLoginItems:(id)arg1 withHome:(id)arg2 withOriginalHomeLoc:(id)arg3 withGroupHomeLoc:(id)arg4 userUID:(unsigned int)arg5 atLoginTime:(BOOL)arg6;
...
+ (BOOL)loginItemsPostCompositePrefFileForLogiwindowPrefs:(id)arg1 forKey:(id)arg2 withHomeURL:(id)arg3 withGroupVolURL:(id)arg4 destPrefFile:(id)arg5;
