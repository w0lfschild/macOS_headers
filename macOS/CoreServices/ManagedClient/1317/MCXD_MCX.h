...
@class IASUnifiedProgressClient, NSArray, NSBundle, NSString, NSTimer, ODNode, ODUGroupGraph, ODUMCXRecord;

@interface MCXD_MCX : NSObject
{
    ODNode *mLocalNode;
    ODNode *mSearchNode;
    NSBundle *mBundle;
...
- (void)updateDEPAutoCreatedUserRecords;
- (BOOL)setAutoGrantAttributeOnRegularUsers;
- (BOOL)setAutoGrantAttributeForUserRec:(id)arg1;
...
- (id)copyCloudConfigProfileDataFromServer:(id)arg1 authDict:(id)arg2 forIdentity:(struct __SecIdentity *)arg3 anchorCerts:(id)arg4 returnsError:(id *)arg5;
- (struct __SecIdentity *)copyDeviceIdentity;
- (BOOL)unbindServerUsingPayload:(id)arg1 error:(id *)arg2;
- (BOOL)bindServerUsingPayload:(id)arg1 profile:(id)arg2 error:(id *)arg3;
- (id)odDictionaryForServer:(id)arg1 error:(id *)arg2;
- (id)odUnbindActionForServer:(id)arg1 usingPayload:(id)arg2;
- (id)odBindActionForServer:(id)arg1 usingPayload:(id)arg2 profile:(id)arg3;
- (id)adUnbindActionForServer:(id)arg1 usingPayload:(id)arg2;
- (id)adBindActionForServer:(id)arg1 usingPayload:(id)arg2 profile:(id)arg3;
- (BOOL)mcx_SetupACMContextWithBootstrapToken:(id)arg1 contextRefData:(id)arg2 outError:(int *)arg3;
- (BOOL)mcx_SetBootstrapToken:(id)arg1 outError:(int *)arg2;
- (BOOL)mcx_DeleteBootstrapToken:(id)arg1 authUserPassword:(id)arg2 outError:(int *)arg3;
- (id)mcx_CreateBootstrapTokenWithAuthentication:(id)arg1 authUserPassword:(id)arg2 outError:(int *)arg3;
- (id)mcx_CreateBootstrapTokenWithACMContext:(id)arg1 contextRefData:(id)arg2 outError:(int *)arg3;
- (BOOL)mcx_SupportsBootstrapToken;
- (id)mcx_GetBootstrapToken:(int *)arg1;
