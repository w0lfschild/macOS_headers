...
@class NSArray, NSBundle, NSConnection, NSDate, NSDictionary, NSMutableArray, NSString, NSTimer, ODNode, ODUGroupGraph, ODUMCXRecord;
...
@interface MCXD_MCX : NSObject <MCXD_Server>
{
    ...
    NSDictionary *mInitialManagedHomeSyncPrefs;
    NSDictionary *mInitialHomeSyncPrefs;
...
- (unsigned int)canUserLogin:(id)arg1 password:(in id)arg2;
...
- (BOOL)doDeferFileVaultEnablementForUser:(id)arg1 withPassword:(id)arg2;
- (BOOL)DoSaveInfoToKeychain;
- (BOOL)DoRefreshPreferences;
- (int)DoLogoutChecks:(BOOL)arg1 userRecord:(id)arg2 prefSyncCompleted:(char *)arg3;
- (int)DoLoginChecks:(BOOL)arg1 prefSyncCompleted:(char *)arg2;
- (BOOL)userHasInclusionList:(id)arg1 userID:(unsigned int)arg2 useLoginInclusionKeys:(BOOL)arg3;
- (id)getCinchDefaultList:(id)arg1;
- (BOOL)checkPeriodicSyncFlag:(id)arg1 userID:(unsigned int)arg2;
- (BOOL)checkBooleanPrefForUser:(id)arg1 userID:(unsigned int)arg2 key:(id)arg3 domain:(id)arg4 defaultValue:(BOOL)arg5 prefFileMissingValue:(BOOL)arg6;
- (BOOL)CinchSaveInfoToUserKeychain:(id)arg1;
- (BOOL)userHasDontSyncOverrides:(id)arg1;
- (BOOL)keyValueSaysDontSync:(id)arg1 inPrefs:(id)arg2 defaultCase:(BOOL)arg3;
- (BOOL)CinchRefreshPreferences:(id)arg1;
- (int)CinchLogoutCheck:(BOOL)arg1 userRecord:(id)arg2 prefSyncCompleted:(char *)arg3;
- (BOOL)CinchLoginCheck:(BOOL)arg1;
- (BOOL)OpenCinchConnection;
- (void)QuitCinch;
- (BOOL)LaunchHomeSyncIfNecessary:(id)arg1 userPassword:(id)arg2 userID:(unsigned int)arg3 groupID:(unsigned int)arg4 atLogin:(BOOL)arg5 hasOriginalNetworkHome:(BOOL)arg6 newMobileAccount:(BOOL)arg7 originalHomeLoc:(id)arg8;
- (BOOL)checkLoginOrLogoutSync:(id)arg1 userID:(unsigned int)arg2 atLogin:(BOOL)arg3;
- (int)launchTool:(id)arg1 withArguments:(id)arg2 asUser:(id)arg3 withUID:(unsigned int)arg4 withGID:(unsigned int)arg5 withStdInPipe:(id)arg6;
...
- (id)injectUPKsIfNecessary:(id)arg1;
- (BOOL)hasAutologinUser;
- (int)_showMHDAlert:(id)arg1 uid:(unsigned int)arg2 isPHDAccount:(BOOL)arg3 dontAsk:(char *)arg4 newHomeType:(int *)arg5 newHomeRef:(id *)arg6 allowDontCreate:(BOOL)arg7;
...
- (void)saveHomeChangeTimeForUserID:(unsigned int)arg1;
...
- (int)vpnInstallSafariDomainsAppLayerService:(id)arg1 vpnAppLayerUUID:(id)arg2 safariDomains:(struct __CFArray *)arg3;
- (int)vpnInstallAppLayerService:(id)arg1 vpnAppLayerUUID:(id)arg2 appMappingPayload:(struct __CFDictionary *)arg3;
- (int)vpnRemoveService:(struct __CFDictionary *)arg1 payloadSummary:(struct __CFDictionary *)arg2 serviceType:(id)arg3 subType:(id)arg4 sysCertRefs:(id)arg5;
- (int)vpnSetupService:(struct __CFDictionary *)arg1 payloadSummary:(struct __CFDictionary *)arg2 credentialInfoDict:(struct __CFDictionary *)arg3 isSystemProfile:(BOOL)arg4 outServiceID:(id *)arg5 outSysPersistCertRefs:(id *)arg6;
