...
@class NSDictionary, NSString, _NCDNDSchedule, _TtC21NotificationCenterApp15DNDPrefsWrapper;
...
@interface NCDNDController : NSObject <_NCDNDScheduleDelegate>
{
    ...
    _TtC21NotificationCenterApp15DNDPrefsWrapper *_prefsWrapper;
...
@property(readonly, retain, nonatomic) _TtC21NotificationCenterApp15DNDPrefsWrapper *prefsWrapper; // @synthesize prefsWrapper=_prefsWrapper;
...
- (void)sendCoreAnalyticsWithSortPref:(id)arg1 shareWidgetShowPref:(_Bool)arg2;
...
- (id)init;
- (void)dndPrefsChanged;
@property(nonatomic, readonly) BOOL dndDisplayLock;
@property(nonatomic, readonly) BOOL dndDisplaySleep;
@property(nonatomic) BOOL dndMirrored;
@property(nonatomic, readonly) double endTime;
@property(nonatomic, readonly) double startTime;
@property(nonatomic, readonly) BOOL hasScheduledTime;
@property(nonatomic, readonly) BOOL repeatedFacetimeCallsBreaksDND;
@property(nonatomic, readonly) BOOL facetimeCanBreakDND;
- (void)preferencesUpdated:(id)arg1;
- (void)setupSiriConnection;
