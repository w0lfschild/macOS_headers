...
@class NCBannerAnimation, NSArray, NSLayoutConstraint, NSMutableSet, NSString, NSView, _TtC21NotificationCenterApp15AlertWindowView;
@protocol BannerModel, NCNotificationWindowDelegate;
...
@property(readonly, nonatomic) id <BannerModel> baseBanner; // @synthesize baseBanner=_baseBanner;
