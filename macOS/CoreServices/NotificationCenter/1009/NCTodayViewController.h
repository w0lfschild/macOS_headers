...
@class NCDuetController, NCRemotePlugInManager, NCTodayConfigurationViewController, NCTodayItem, NCTodayListController, NCTodaySummaryItem, NSArray, NSDate, NSDateComponentsFormatter, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString, NSXPCListener, _TtC21NotificationCenterApp20ScreenTimeController;
...
@interface NCTodayViewController : NSViewController <NCWidgetPrefServerInterface, NCTodayHeaderDelegate, NCTodayListControllerDelegate, NCRemotePlugInManagerDelegate, NCTodayItemViewControllerDelegate, NSXPCListenerDelegate, NCTodayListControllerTarget, NCNotificationCenterTabProtocol>
{
    ...
    _TtC21NotificationCenterApp20ScreenTimeController *_screenTimeController;
...
@property(readonly, nonatomic) _TtC21NotificationCenterApp20ScreenTimeController *screenTimeController; // @synthesize screenTimeController=_screenTimeController;
...
- (void)_updateScreenTimeShield:(id)arg1 enabled:(_Bool)arg2;
- (void)_updateScreenTimeList;
...
- (void)_updateScreenTimeIdentifiers;
...
- (void)registerSnippetCallbacks;
- (void)setScreentimeIdentifiersWithIdentifiers:(id)arg1;
- (void)setupScreentimeCallback;
