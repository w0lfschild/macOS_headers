...
@class CAFenceHandle, NCCAController, NCCARemoteSession;

@protocol NCCAControllerDelegate
- (void)NCCAController:(NCCAController *)arg1 heightChangedTo:(double)arg2 fence:(CAFenceHandle *)arg3 forSession:(NCCARemoteSession *)arg4;
