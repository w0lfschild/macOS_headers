...
@class NSString, NSView, _TtC21NotificationCenterApp18NotificationBanner, _TtC21NotificationCenterApp22NotificationActionObjC;
@protocol _TtP21NotificationCenterApp23BannerExtensionDelegate_;

@interface NotificationCenterApp.BannerExtensionViewController : NSViewController
{
...
@property(nonatomic, readonly) _TtC21NotificationCenterApp18NotificationBanner *model; // @synthesize model;
