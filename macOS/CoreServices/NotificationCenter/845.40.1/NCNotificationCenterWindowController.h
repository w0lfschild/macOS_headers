...
@class NCConfigButton, NCNotificationTabContainer, NCShadowTextFieldCell, NCTexturedView, NCTodayConfigurationViewController, NCTodayViewController, NSBox, NSButton, NSLayoutConstraint, NSObject, NSSegmentedControl, NSString, NSToolbar, NSTrackingArea, NSView, NSViewController, _TtC21NotificationCenterApp28NotificationsTableController;
@protocol OS_dispatch_source;

@interface NCNotificationCenterWindowController : NSWindowController <_NCWindowDelegate, NCMaterialDelegate>
{
...
@property(nonatomic) NSBox *configDebugRightLine; // @synthesize configDebugRightLine=_configDebugRightLine;
@property(nonatomic) NSBox *configLine; // @synthesize configLine=_configLine;
