...
@class FileReference, IOBluetoothOBEXSession, IOBluetoothTransferProgressUI, NSData, NSMutableArray, NSString, NSTimer;
...
@property(retain) FileReference *pendingFile; // @synthesize pendingFile=mPendingFile;
