...
@class IPKPopOverWindow, IPKToolbarItem, IPKToolbarView, KHCanvasViewController, KHProductOrderController, KHProjectTooltipView, MultiPaneController, NSMenuItem, NSString, NSTimer, NSTrackingArea, NSView;
