...
@class Album, CALayer, CAScrollHUDLayer, HgRidList, IPKScroller, IPMessageReceiver, IPScrollBounceAnimator, ImageDB, InlineEditController, NSColor, NSImage, NSMenu, NSMutableArray, NSMutableIndexSet, NSMutableSet, NSOperationQueue, NSSet, NSString, NSTimer, NSTrackingArea, TypeAheadController;

@interface CAGridView : NSView <MultiPanePaneProtocol, InlineEditProtocol, IPScrollBounceAnimatorTarget, RKTerminationDelegateProtocol, NSScrollerImpPairDelegate, NSFileManagerDelegate, CALayerDelegate>
{
    CALayer *_baseLayer;
    ...
    struct map<unsigned long, long, std::__1::less<unsigned long>, std::__1::allocator<std::__1::pair<const unsigned long, long>>> *_keyIndexMap;
    double _zoomFactor;
    ...
    struct map<long, id, std::__1::less<long>, std::__1::allocator<std::__1::pair<const long, id>>> *_cellIndexToCellLayerMap;
    ...
    struct map<long, CGSize, std::__1::less<long>, std::__1::allocator<std::__1::pair<const long, CGSize>>> *_displacementMap;
    map_ab925a61 *_toolTipMap;
