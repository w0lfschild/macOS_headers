...
- (id)unpublishOperationForDB:(struct NSObject *)arg1 URL:(id)arg2 service:(id)arg3;
...
- (struct NSObject *)ellipsizerWithAttributes:(id)arg1;
...
- (void)_plugin:(struct NSObject *)arg1 retrievedAlbumContents:(id)arg2 error:(id)arg3 contextInfo:(void *)arg4;
...
- (void)_plugin:(struct NSObject *)arg1 retrievedAlbumList:(id)arg2 error:(id)arg3 contextInfo:(void *)arg4;
- (void)processAlbumsReplyHandler:(id)arg1;
- (void)listAlbumsReplyHandler:(id)arg1;
- (void)retrieveAlbumList:(id)arg1;
- (void)invokeValidationError:(id)arg1 plugin:(struct NSObject *)arg2 selector:(SEL)arg3;
...
- (struct NSObject *)dotMacUtils;
- (void)initializePlugin:(struct NSObject *)arg1;
- (struct NSObject *)newPluginForServiceKey:(id)arg1 username:(id)arg2;
- (struct NSObject *)newAnonymousPluginForServiceKey:(id)arg1;
- (struct NSObject *)newPluginForServiceKey:(id)arg1;
- (struct NSObject *)pluginForServiceKey:(id)arg1;
- (Class)pluginClassForServiceKey:(id)arg1;
- (id)allPluginClasses;
- (void)_scanDirectoryForPlugins:(id)arg1 foundBundles:(id)arg2;
- (struct NSObject *)_validPluginClass:(Class)arg1;
- (void)scanForPlugins;
