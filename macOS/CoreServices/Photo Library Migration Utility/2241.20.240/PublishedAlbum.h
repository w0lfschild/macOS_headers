...
- (id)imageFilePathRefForPhotoWithUID:(id)arg1;
- (id)refForMovieWithUID:(id)arg1 transcodingOptions:(id)arg2;
- (id)refForPhotoWithUID:(id)arg1 format:(unsigned int)arg2 quality:(int)arg3 maxDimensions:(unsigned long long)arg4;
...
- (BOOL)canPublish;
- (id)publishPluginForServiceKey:(id)arg1;
