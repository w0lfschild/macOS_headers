...
@class IPKPopOverWindow, IPKToolbarItem, IPKToolbarView, KHCanvasViewController, KHProjectTooltipView, MultiPaneController, NSMenuItem, NSString, NSTimer, NSTrackingArea, NSView;
