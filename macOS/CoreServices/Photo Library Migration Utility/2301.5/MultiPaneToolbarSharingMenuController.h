...
- (void)accountConfigurationManager:(id)arg1 didValidateAccountConfiguration:(id)arg2 isValid:(BOOL)arg3 contextInfoPublishToFBProfilePicture:(id)arg4;
- (void)publishToFBProfilePicture:(id)arg1;
- (void)accountConfigurationManager:(id)arg1 didValidateAccountConfiguration:(id)arg2 isValid:(BOOL)arg3 contextInfoPublishToFBWallAlbum:(id)arg4;
...
- (void)plugin:(id)arg1 didCheckFlickrPhotostreamUploadLimitsForPhotoRefs:(id)arg2 acceptablePhotoRefs:(id)arg3 contextInfo:(id)arg4;
- (void)accountConfigurationManager:(id)arg1 didValidateAccountConfiguration:(id)arg2 isValid:(BOOL)arg3 contextInfoPublishToFlickrPhotostream:(id)arg4;
...
- (id)photoRefFromPhotoInfo:(struct IPPhotoInfo *)arg1;
...
- (void)plugin:(id)arg1 didCheckUploadLimitsForPhotoRefs:(id)arg2 acceptablePhotoRefs:(id)arg3 contextInfo:(id)arg4;
- (void)accountConfigurationManager:(id)arg1 didValidateAccountConfiguration:(id)arg2 isValid:(BOOL)arg3 contextInfoPublishNetAlbums:(id)arg4;
- (void)_postSharedPhotoStreamSettingsDidEnd:(id)arg1 returnCode:(int)arg2 contextInfo:(void *)arg3;
- (void)__uploadPhotos:(id)arg1 fromImageDB:(id)arg2 toSharedStream:(id)arg3 usingPlugin:(id)arg4 isNewStream:(BOOL)arg5 withCaption:(id)arg6;
- (void)_sharedStreamPlugin:(id)arg1 didCheckUploadLimitsForPhotoRefs:(id)arg2 acceptablePhotoRefs:(id)arg3 contextInfo:(id)arg4;
- (void)accountConfigurationManager:(id)arg1 didValidateAccountConfiguration:(id)arg2 isValid:(BOOL)arg3 contextInfoPublishToSharedPhotoStream:(id)arg4;
