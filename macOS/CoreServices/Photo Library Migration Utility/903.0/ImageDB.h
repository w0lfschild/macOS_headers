...
@interface ImageDB : NSObject <ILShareContentsDelegate, RKTerminationDelegateProtocol>
{
    ...
    struct list<double, std::allocator<double>> *mLastNUpgradedPercent;
    struct list<unsigned long long, std::allocator<unsigned long long>> *mLastNUpgradedBytes;
...
- (struct IPPhotoList *)photosForKeys:(vector_632d33ce *)arg1;
...
- (id)rollMap;
- (id)rollUIDs;
- (vector_a4032abb *)newSortedRollVector;
- (vector_a4032abb *)newRollVector;
- (struct IPPhotoList *)photosInUnnamedRolls;
- (BOOL)likelyRollUser;
- (struct IPStack *)stackForKey:(unsigned long long)arg1;
- (vector_a4032abb *)rollsForKeys:(id)arg1;
