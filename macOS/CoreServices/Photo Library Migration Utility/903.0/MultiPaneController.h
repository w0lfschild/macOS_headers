...
@class Album, IPDefinePeopleController, IPKPopUpButton, MWOneUpTransition, MultiPaneToolbarController, NSAnimation, NSMutableArray, NSMutableIndexSet, NSView, NSWindow;
