...
@interface ProblemReportWindowController : NSWindowController
{
    ...
    NSTextField *_radarCommentsMinLengthTextField;
...
- (void)createPanicRadar:(id)arg1;
- (void)createSleepWakeFailureRadar:(id)arg1;
- (void)composeRadar:(id)arg1 description:(id)arg2 attachments:(id)arg3 keyword:(id)arg4 title:(id)arg5;
- (void)createRadar:(id)arg1;
- (void)createDuplicateRadar:(id)arg1;
- (void)_displayRadarInfoSheet;
- (void)fileRadarFromRadarInfoSheet:(id)arg1;
...
- (void)_updateMinimumCharactersRequiredForRadarCreateButton;
- (void)_updateEnabledStateForRadarCreateButton;
- (unsigned long long)_effectiveCommentsSize;
- (void)_updateGUI;
- (void)_updateButtons;
