...
@class MBMigrateMethod, NSMutableArray, NSString, SMMigrationCustomizeViewController, SMProgress_Client, SMSelectSourceViewController, SMSystem_Client;
@protocol OS_dispatch_queue;

@interface MigrationManager : NSObject <HiCloudManager, SMSystemScannerClient>
{
...
+ (void)consumeMigraitonBuddyCookie;
+ (void)setShouldResumePostMigration;
+ (BOOL)shouldResumePostMigrationConsumingCookie;
