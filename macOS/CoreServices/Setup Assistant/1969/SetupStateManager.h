...
@class CloudConfigurationManager, CountryManager, DateAndTimeManager, IncompatibleSoftwareManager, KeyboardManager, LocalUserAccountManager, MBUTConnection, MigrationManager, NSString, NetworkingManager, PointingDeviceManager, PreloginTasksManager, RegistrationServerManager, ServicesManager, WiFiManager, iCloudManager;
