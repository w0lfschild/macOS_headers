...
@interface iCloudManager : NSObject <MacBuddyManager>
{
    ...
    long long _keychainSyncDestination;
...
@property long long keychainSyncDestination; // @synthesize keychainSyncDestination=_keychainSyncDestination;
...
- (void)prepareUnifiedResponseDict;
@property(readonly) NSDictionary *additionalRequestAttributesDict;
@property(readonly, copy) NSDictionary *_keychainSyncState;
