...
@class MMWebKitViewController, NSError, NSString, NSURLResponse;

@protocol MMWebKitViewControllerDelegate <NSObject>

@optional
- (void)mmWebKitViewControllerAgreeToTerms:(MMWebKitViewController *)arg1 urlString:(NSString *)arg2 completion:(void (^)(AAResponse *))arg3;
