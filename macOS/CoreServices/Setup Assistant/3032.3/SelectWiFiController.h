...
@class NSArrayController, NSLayoutConstraint, NSObject, NSSecureTextField, NSString, NSTableColumn, NSTableView, NSTextField, NSView, NSWindow, OBAnimationController, WiFiManager;
