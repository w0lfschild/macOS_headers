...
@class MMWebKitViewController, NSDictionary, NSError, NSURLResponse;

@protocol MMWebKitViewControllerDelegate <NSObject>

@optional
- (void)mmWebKitViewControllerAgreedToTerms:(MMWebKitViewController *)arg1 termsInfo:(NSDictionary *)arg2;
