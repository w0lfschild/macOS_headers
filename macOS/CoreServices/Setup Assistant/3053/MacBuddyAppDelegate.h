...
@class FrankenBuddyManager, MacBuddyController, MacBuddyWindowController, NSDate, NSDictionary, NSString, NSTimer, NSWindow;
...
- (id)launchApplicationAtPath:(id)arg1;
...
- (BOOL)_shouldBringFrontmost;
- (void)_bringMiniBuddyToFront;
