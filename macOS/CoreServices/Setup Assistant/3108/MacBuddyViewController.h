...
@class MacBuddyController, MacBuddyWindowController, NSScrollView, NSString, NSView, NavigateItem, OBTemplateView, SetupStateManager;
...
@property(copy) OBTemplateView *templateView; // @synthesize templateView=_templateView;
