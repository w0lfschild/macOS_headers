...
@interface CountryManager : NSObject <MacBuddyManager>
{
    ...
    NSString *_languageBasedAssetName;
}
...
- (void).cxx_destruct;
@property(retain) NSString *languageBasedAssetName; // @synthesize languageBasedAssetName=_languageBasedAssetName;
...
- (id)_assetNameForRegion:(long long)arg1;
- (void)refreshLanguageBasedAssetNameForCountry:(id)arg1;
