...
- (void)getMAAdminCredentials:(CDUnknownBlockType)arg1;
- (void)writePreviousSystemCleanupService:(CDUnknownBlockType)arg1;
...
- (void)requestBridgedFetchActivationRecordWithReply:(CDUnknownBlockType)arg1;
...
- (void)removeNeedsPostMigrationAppStoreCookie:(CDUnknownBlockType)arg1;
- (void)setNeedsPostMigrationAppStoreCookie:(CDUnknownBlockType)arg1;
...
- (void)getResumeBuddyCookieAccentColor:(CDUnknownBlockType)arg1;
- (void)setResumeBuddyAccentColor:(long long)arg1 withCompletionBlock:(CDUnknownBlockType)arg2;
