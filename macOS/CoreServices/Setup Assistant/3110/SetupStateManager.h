...
@class AutoAdvanceManager, CloudConfigurationManager, CountryManager, DateAndTimeManager, IncompatibleSoftwareManager, KeyboardManager, LocalUserAccountManager, MBUTConnection, MultilingualManager, NSString, NetworkingManager, PointingDeviceManager, PreloginTasksManager, RegistrationServerManager, ServicesManager, SoftwareUpdateManager, WiFiManager, iCloudManager;
