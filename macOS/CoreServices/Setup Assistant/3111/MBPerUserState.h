...
@interface MBPerUserState : NSObject
{
    ...
    BOOL _didSeeAccessibility;
    BOOL _didSeeAppStore;
...
@property BOOL didSeeAppStore; // @synthesize didSeeAppStore=_didSeeAppStore;
@property BOOL didSeeAccessibility; // @synthesize didSeeAccessibility=_didSeeAccessibility;
