...
@interface MacBuddyController : NSObject
{
    ...
    BOOL _didRunFLO;
    NSString *__approprateFirstMiniBuddyPane;
...
@property(readonly, copy) NSString *_approprateFirstMiniBuddyPane; // @synthesize _approprateFirstMiniBuddyPane=__approprateFirstMiniBuddyPane;
- (BOOL)shouldCheckAppStoreLaunchRequirements;
- (void)launchAppStoreAndQuit;
- (void)performPreloginTasksAndQuit;
- (void)kickoffPrimingTasks;
- (BOOL)_hasFeature:(id)arg1;
- (void)postBuddyTasks;
- (id)_appropriateFirstEOSRestorePane;
...
- (id)_appropriateFirstNonFLOMiniBuddyPane;
- (id)_appropriateFirstNonAccessibilityMiniBuddyPane;
- (id)_appropriateFirstMiniBuddyPane;
