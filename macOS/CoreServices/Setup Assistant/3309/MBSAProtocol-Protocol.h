...
- (void)getMAAdminCredentials:(void (^)(NSDictionary *))arg1;
- (void)writePreviousSystemCleanupService:(void (^)(BOOL, NSError *))arg1;
...
- (void)removeNeedsPostMigrationAppStoreCookie:(void (^)(BOOL))arg1;
- (void)setNeedsPostMigrationAppStoreCookie:(void (^)(BOOL))arg1;
...
- (void)requestBridgedFetchActivationRecordWithReply:(void (^)(BOOL, NSDictionary *, NSError *))arg1;
...
- (void)getResumeBuddyCookieAccentColor:(void (^)(BOOL, NSNumber *))arg1;
- (void)setResumeBuddyAccentColor:(long long)arg1 withCompletionBlock:(void (^)(BOOL))arg2;
