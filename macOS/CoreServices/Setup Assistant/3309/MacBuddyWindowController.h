...
@property(retain, nonatomic) MacBuddyController *MacBuddyController; // @synthesize MacBuddyController=_MacBuddyController;
...
- (void)_hideWindowLevelApplicationUIWithApplyInitialBackButtonEnableState:(BOOL)arg1;
...
- (void)updateInputMenuVisibility;
...
- (void)removeActionIfControl:(id)arg1;
...
- (void)stopSettingsApplicationUI:(id)arg1 applyInitialBackButtonEnableState:(BOOL)arg2;
