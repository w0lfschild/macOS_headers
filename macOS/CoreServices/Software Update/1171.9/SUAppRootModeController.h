...
@protocol OS_dispatch_source, OS_os_activity, SUUpdateService;
...
@interface SUAppRootModeController : NSObject
{
    ...
    BOOL _hasAnOSUpdate;
    long long _currentSnapShottingStatus;
    NSMutableArray *_baseSystemUpdateProductKeys;
    ...
    BOOL _showBridgeOSUpdateBlackScreenWarning;
    NSObject<OS_os_activity> *_rootModeActivity;
...
- (void)_commitStash:(BOOL)arg1 hasArmedBaseSystemUpdates:(BOOL)arg2;
- (void)_finishAllOperationsWithError:(id)arg1 hasArmedBaseSystemUpdates:(BOOL)arg2;
- (void)_serviceStatusTimer;
- (void)_startRootModeUpdates;
- (void)_captureOSSnapShot;
