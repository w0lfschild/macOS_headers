...
@interface SPAppDelegate : NSObject <SPResultViewControllerDelegate, NSTouchBarDelegate, NSTouchBarProvider, SPQueryTaskDelegate, NSApplicationDelegate, NSWindowDelegate>
{
    BOOL _previewReady;
