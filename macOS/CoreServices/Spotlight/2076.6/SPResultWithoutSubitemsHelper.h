...
@class NSImage, NSLayoutConstraint, NSString, NSTextField, NSView, SPDimmableImageView;
...
+ (id)attributedDisplayNameForResult:(id)arg1 inLabel:(id)arg2 appIsScreenTimeRestricted:(BOOL)arg3;
- (void).cxx_destruct;
