...
@class NSAlignmentFeedbackFilter, NSArray, NSView, NSVisualEffectView, SPSearchField, SearchUIFirstTimeExperienceViewController;

@interface SPSearchPanel : NSPanel
{
    SearchUIFirstTimeExperienceViewController *_fteController;
    BOOL _shouldCenter;
...
@property BOOL suggestionsMode; // @synthesize suggestionsMode=_suggestionsMode;
...
@property __weak NSView *contentsView; // @synthesize contentsView=_contentsView;
