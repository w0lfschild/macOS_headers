...
@interface SPSearchFieldEditor : NSTextView <NSTextInputClient_IncrementalSearch>
{
    ...
    unsigned long long _savedCompletionLength;
    BOOL _resigning;
...
@property(retain, nonatomic) NSString *tabCompletionString; // @synthesize tabCompletionString=_tabCompletionString;
...
- (id)completionForString:(id)arg1 userString:(id)arg2;
