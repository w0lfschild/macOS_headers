...
@class NSArray, NSImageView, NSStackView, NSTextField, NSView, UACPanelViewController, UAShortcutCategory;

@interface UACCategoryViewController : NSViewController
{
    BOOL _showBottomDelim;
    UACPanelViewController *_delegate;
...
@property(nonatomic) __weak UACPanelViewController *delegate; // @synthesize delegate=_delegate;
- (void)viewDidLoad;
- (void)updateState;
- (id)_categoryImage;
