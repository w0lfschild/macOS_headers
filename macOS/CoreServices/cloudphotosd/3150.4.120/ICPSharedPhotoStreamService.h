...
- (long long)unviewedAlbumAndPhoneInvitationCount;
...
- (void)addVideoComplementInformationFromPhotoInfo:(id)arg1 toAssetCollection:(id)arg2;
...
- (void)handleUserNotificationActionWithUserInfo:(id)arg1;
- (void)handleUserNotificationActivatedWithUserInfo:(id)arg1;
...
- (void)reconnectDownloadedMasters;
...
- (void)_attemptLibraryImportForAssetCollectionGUID:(id)arg1 reply:(CDUnknownBlockType)arg2;
...
- (id)videoComplementAssetFromAssetCollection:(id)arg1;
...
- (BOOL)agentOwnedPublishedAssetsDirectoryContainsItemAtURL:(id)arg1;
- (id)agentOwnedPublishedAssetsDirectoryURL;
- (id)assetsDirectoryURL;
- (void)handlePushNotification;
- (void)disableIDSService;
- (void)enableIDSService;
