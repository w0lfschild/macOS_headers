...
@property(retain, nonatomic) NSDictionary *albumInfo; // @dynamic albumInfo;
...
@property(retain, nonatomic) NSDictionary *phoneInvitationInfo; // @dynamic phoneInvitationInfo;
@property(retain, nonatomic) NSDictionary *relationshipInfo; // @dynamic relationshipInfo;
