...
- (void)executeModelAccessSync:(CDUnknownBlockType)arg1;
...
- (id)commentToCommentInfo:(id)arg1 mediaItemIdentifier:(id)arg2 options:(unsigned long long)arg3;
...
- (id)passthroughAssetForAssetCollection:(id)arg1 imageProperties:(id)arg2;
...
- (id)sharedStreamInfoForAlbum:(id)arg1 withInvitation:(id)arg2 options:(unsigned long long)arg3;
