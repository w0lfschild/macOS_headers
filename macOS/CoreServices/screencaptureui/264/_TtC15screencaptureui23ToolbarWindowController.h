...
@interface _TtC15screencaptureui23ToolbarWindowController : NSWindowController
{
    ...
    // Error parsing type: , name: captureLine
    // Error parsing type: , name: captureButton
    // Error parsing type: , name: hiddenCaptureWidthConstraint
    // Error parsing type: , name: visibleCaptureWidthConstraint
    // Error parsing type: , name: line
    // Error parsing type: , name: lineBottom
    // Error parsing type: , name: lineTop
    ...
    // Error parsing type: , name: saveToQiuckTimeMenu
    // Error parsing type: , name: saveToMessages
    // Error parsing type: , name: chooseOtherMenu
    ...
    // Error parsing type: , name: rememberLastSelection
    // Error parsing type: , name: showMouseCursorItem
    // Error parsing type: , name: showMouseClicks
    // Error parsing type: , name: windowLeadingConstraint
    // Error parsing type: , name: originalWindowLeadingValue
    ...
    // Error parsing type: , name: _optionsMenuLastDownTime
    // Error parsing type: , name: _selectedDisplay
    // Error parsing type: , name: _displaySelectionWindows
    // Error parsing type: , name: _simulateLockscreenMode
}
...
@property(nonatomic) __weak NSLayoutConstraint *windowLeadingConstraint; // @synthesize windowLeadingConstraint;
...
@property(nonatomic, retain) NSMenuItem *rememberLastSelection; // @synthesize rememberLastSelection;
...
@property(nonatomic, retain) NSMenuItem *chooseOtherMenu; // @synthesize chooseOtherMenu;
@property(nonatomic, retain) NSMenuItem *saveToMessages; // @synthesize saveToMessages;
@property(nonatomic, retain) NSMenuItem *saveToQiuckTimeMenu; // @synthesize saveToQiuckTimeMenu;
...
@property(nonatomic) __weak NSLayoutConstraint *lineTop; // @synthesize lineTop;
@property(nonatomic) __weak NSLayoutConstraint *lineBottom; // @synthesize lineBottom;
@property(nonatomic) __weak NSBox *line; // @synthesize line;
@property(nonatomic, retain) NSLayoutConstraint *visibleCaptureWidthConstraint; // @synthesize visibleCaptureWidthConstraint;
@property(nonatomic, retain) NSLayoutConstraint *hiddenCaptureWidthConstraint; // @synthesize hiddenCaptureWidthConstraint;
@property(nonatomic, retain) _TtC15screencaptureui13ToolbarButton *captureButton; // @synthesize captureButton;
@property(nonatomic, retain) NSBox *captureLine; // @synthesize captureLine;
...
- (void)fakeLockscreenMode:(id)arg1;
- (void)toggleDebugAnnotationsSide:(id)arg1;
- (void)toggleDebugStatusItem:(id)arg1;
- (void)toggleDebugSelectionBoundingBoxes:(id)arg1;
- (void)toggleRemberLastSelection:(id)arg1;
