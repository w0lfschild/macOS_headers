...
@protocol AVFigRoutingContextOutputDeviceTranslator, OS_dispatch_queue;
...
- (id)initWithFigRoutingContextCreator:(CDUnknownBlockType)arg1 outputDeviceTranslator:(id)arg2 volumeController:(struct OpaqueFigVolumeControllerState *)arg3;
