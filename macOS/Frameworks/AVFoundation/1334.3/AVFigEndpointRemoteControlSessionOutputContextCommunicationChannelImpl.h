...
@class AVFigEndpointRemoteControlSessionCommunicationChannelManager, AVOutputContextCommunicationChannel, AVWeakReference, NSString;
...
@property __weak AVFigEndpointRemoteControlSessionCommunicationChannelManager *parentCommunicationChannelManager; // @synthesize parentCommunicationChannelManager=_parentCommChannelManager;
