...
@interface AVCaptureDALDevice : AVCaptureDevice
{
    ...
    struct dispatch_queue_s *_transportPropertyObserverQueue;
    struct dispatch_queue_s *_transportTimerQueue;
    long long _transportPropertyObserverCount;
    struct dispatch_source_s *_transportPropertyObserverTimer;
