...
- (void).cxx_destruct;
- (long long)_menuControllerSelectionForServiceInterfaceSelection:(long long)arg1;
- (long long)showMenuForRect:(struct CGRect)arg1 appearanceName:(id)arg2 allowReselectionOfSelectedOutputDevice:(BOOL)arg3 customMenuItemTitle:(id)arg4 customMenuItemEnabled:(BOOL)arg5;
