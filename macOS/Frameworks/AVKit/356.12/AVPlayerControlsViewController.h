...
@class AVChapterMenuController, AVFunctionBarPlaybackControlsProvider, AVOutputDeviceMenuController, AVPlayerController, AVPlayerControllerTimeResolver, AVPlayerView, AVSlowMotionSlider, NSButton, NSMenu, NSString, NSTextField, NSView;
...
@interface AVPlayerControlsViewController : AVControlsViewController <AVScrubberValueTransformerDelegate, AVSlowMotionSliderDelegate>
{
    ...
    AVFunctionBarPlaybackControlsProvider *_functionBarPlaybackControlsProvider;
...
@property(readonly) AVFunctionBarPlaybackControlsProvider *functionBarPlaybackControlsProvider; // @synthesize functionBarPlaybackControlsProvider=_functionBarPlaybackControlsProvider;
- (void).cxx_destruct;
