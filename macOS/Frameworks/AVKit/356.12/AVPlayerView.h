...
@interface AVPlayerView : NSView <NSSharingServicePickerDelegate, NSSharingServiceDelegate, AVTrimControlsViewControllerDelegate, CALayerDelegate>
{
    ...
    AVPlayerLayer *_functionBarThumbnailPlayerLayer;
    ...
    long long _functionBarViewAppearCount;
...
@property(retain) AVPlayerLayer *functionBarThumbnailPlayerLayer; // @synthesize functionBarThumbnailPlayerLayer=_functionBarThumbnailPlayerLayer;
...
- (void)functionBarControlsViewDidDisappear;
- (void)functionBarControlsViewWillAppear;
