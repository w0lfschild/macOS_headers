...
@class AVFunctionBarTrimControlsViewController, AVPlayerControllerTimeResolver, NSCustomTouchBarItem, NSString, NSView;
...
@interface AVTrimControlsViewController : AVPlayerControlsViewController <NSTouchBarDelegate, AVTrimViewDelegate>
{
    ...
    NSView *_trimView;
    NSCustomTouchBarItem *_trimControlsFunctionBarItem;
    AVFunctionBarTrimControlsViewController *_functionBarTrimControlsViewController;
...
- (void)cancel:(id)arg1;
- (void)trim:(id)arg1;
- (BOOL)canStartTrackingForTrimView:(id)arg1;
