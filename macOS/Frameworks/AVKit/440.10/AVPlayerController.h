...
@class AVFragmentedMovieMinder, AVFunctionBarMediaSelectionOption, AVOutputContextController, AVPlayer, AVTouchBarMediaSelectionOption, AVValueTiming, NSArray, NSDate, NSDictionary, NSError, NSObject, NSString, NSURL;
