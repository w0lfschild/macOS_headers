...
@class AVCameraDisabledView, AVCaptureController, AVCaptureControlsViewController, AVCaptureDevice, AVCaptureFileOutput, AVCaptureSession, AVCaptureVideoPreviewLayer, AVControlsContainerViewController, AVLoadingIndicatorView, NSArray, NSObject, NSString, NSTimer, NSTouchBar, NSTrackingArea;
