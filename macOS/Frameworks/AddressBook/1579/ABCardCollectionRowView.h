...
@class ABCardViewStyleProvider, ABCollectionViewItem, ABImmediateActionGestureAdapter, ABThrottledTrackingAreaMonitor, NSArray, NSButton, NSImageView, NSPopUpButton, NSStackView, NSString, NSTrackingArea;
