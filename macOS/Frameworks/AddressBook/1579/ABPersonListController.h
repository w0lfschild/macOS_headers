...
@class ABAccount, ABActionAutovalidator, ABAddressBook, ABCommandExecutor, ABGroup, ABKeystrokeForwarder, ABMainListOutlineView, ABPersonEntriesList, ABPersonListDragExportHelper, ABPersonListMenuHelper, NSArray, NSMutableArray, NSMutableIndexSet, NSOutlineView, NSString, NSUndoManager;
@protocol ABPersonListDelegate, ABPersonListHeadlining;
...
@property(readonly, copy) NSArray *affectedStores;
- (void)dealloc;
- (void)awakeFromNib;
- (id)init;
