...
@class ABAddressBook, ABCardView, ABCardViewPersonMapper, AKCardViewFaceTimeAvailabilityWatcher, AKCardViewImageDataSource, CNContact, CNContactStore, CNWeakReference, NSArray, NSDictionary, NSMutableArray, NSMutableSet, NSString;
@protocol ABCardViewDataSourceDelegate, ABCommand;
