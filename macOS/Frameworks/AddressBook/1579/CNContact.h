...
@class CNContactIdentifier, NSArray, NSDate, NSDateComponents, NSDictionary, NSString, NSURL;
...
@property(readonly, copy, nonatomic) CNContactIdentifier *identifier; // @synthesize identifier=_identifier;
