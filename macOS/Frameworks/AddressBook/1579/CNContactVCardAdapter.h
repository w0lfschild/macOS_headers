...
#import <AddressBook/CNVCardPerson-Protocol.h>

@class ABPhotoHelper, CNContact, CNContactVCardExtraInfo, NSArray, NSData, NSDateComponents, NSDictionary, NSString;

__attribute__((visibility("hidden")))
@interface CNContactVCardAdapter : NSObject <CNVCardPerson>
{
    CNContact *_contact;
    ABPhotoHelper *_photoHelper;
    CNContactVCardExtraInfo *_extraInfo;
    BOOL _isMe;
}
