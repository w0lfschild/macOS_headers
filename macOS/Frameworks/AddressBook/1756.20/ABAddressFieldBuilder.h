...
@class ABCNPostalAddress, ABCardViewStyleProvider, NSArray, NSColor, NSTextField;
...
@property(readonly, nonatomic) ABCNPostalAddress *postalAddress; // @synthesize postalAddress=_postalAddress;
- (void).cxx_destruct;
- (void)buildFields;
