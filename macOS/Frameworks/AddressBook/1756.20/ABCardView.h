...
#import <AddressBook/AKCardViewDataSourceSupport-Protocol.h>
#import <AddressBook/CNUIShareKitTransitionProvider-Protocol.h>
...
@interface ABCardView : NSView <ABScrollViewDelegate, CNUIShareKitTransitionProvider, AKCardViewDataSourceSupport>
{
...
@property(nonatomic) BOOL canEditContact; // @synthesize canEditContact=_canEditContact;
...
@property(nonatomic) BOOL importMode; // @synthesize importMode=mImportMode;
@property(nonatomic) BOOL editMode; // @synthesize editMode=mEditMode;
