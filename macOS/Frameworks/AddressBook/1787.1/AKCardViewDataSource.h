...
@class ABCardViewPersonMapper, AKCardViewFaceTimeAvailabilityWatcher, AKCardViewImageDataSource, CNContact, CNContactStore, CNUIMeContactMonitor, CNUIUndoableCommand, NSArray, NSDictionary, NSMutableArray, NSMutableSet, NSString;
...
@property(nonatomic, getter=isAvailableForFaceTime) BOOL availableForFaceTime; // @synthesize availableForFaceTime=_availableForFaceTime;
...
@property(retain, nonatomic) AKCardViewFaceTimeAvailabilityWatcher *faceTimeWatcher; // @synthesize faceTimeWatcher=_faceTimeWatcher;
