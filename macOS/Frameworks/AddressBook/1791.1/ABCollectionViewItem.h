...
@protocol ABCardCollectionRowView, ABCardCollectionViewDelegate, ABCardViewMultiValue, ABCardViewProperty, ABCollectionAction;
...
@property(readonly, nonatomic) double editViewHeight;
