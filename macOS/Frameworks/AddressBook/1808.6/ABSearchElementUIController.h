...
#import <AddressBook/ABSearchElementRepresentationBuilder-Protocol.h>

@class ABSearchElementSetView, ABSmartGroup, NSButton, NSLayoutConstraint, NSMutableArray, NSPopUpButton, NSTextField, NSView, NSWindow;
