...
@class NSArray, NSDockTile, NSEvent, NSGraphicsContext, NSImage, NSMenu, NSString, NSURL, NSWindow;
...
- (BOOL)_isHandlingDisplayReconfig;
- (BOOL)_startHandlingDisplayReconfig;
...
@property id <NSApplicationDelegate> delegate;
- (id)_eventDelegate;
