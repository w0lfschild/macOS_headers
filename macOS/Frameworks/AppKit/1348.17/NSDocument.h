...
@class NSArray, NSDate, NSOperationQueue, NSPrintInfo, NSPrintOperation, NSScriptObjectSpecifier, NSString, NSURL, NSUndoManager, NSUserActivity, NSView, NSWindow;
...
- (void)_setNeedsToReleaseSecurityScope:(BOOL)arg1;
