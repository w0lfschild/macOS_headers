...
- (id)savePanel;
- (double)fauxToolbarHeightForWindow:(NSWindow *)arg1 appCentric:(BOOL)arg2 hasMessageView:(BOOL)arg3 runningAsAService:(BOOL)arg4 verticalSpaceAbove:(double *)arg5;
