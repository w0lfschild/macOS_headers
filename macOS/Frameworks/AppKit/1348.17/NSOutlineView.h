...
@class NSButtonCell, NSMapTable, NSString, NSTableColumn, _NSOVRowEntry;
...
- (id)_staticItems;
- (id)_nonStaticDataSourceChild:(long long)arg1 ofItem:(id)arg2 isShowMoreRow:(BOOL)arg3;
- (id)_staticDataSourceChild:(long long)arg1 ofItem:(id)arg2 isShowMoreRow:(BOOL)arg3;
