...
- (void)_withOpenSavePanelDelegateMessagingDisallowed:(CDUnknownBlockType)arg1;
...
- (void)_layoutViewsVerticallyAndResizeWindowToLastExpandedSize:(BOOL)arg1 accessoryViewHeight:(double)arg2 parentWindow:(id)arg3;
...
- (struct CGSize)_getAndAdjustContentMinSize;
- (struct CGRect)_visibleFrameAvailableForPanelWithParentWindow:(id)arg1;
- (void)_fixFetchExpandedFrameSizeForVisibleFrameWithParentWindow:(id)arg1;
...
- (double)_computeMinPixelHeightForSimpleSavePanel:(BOOL)arg1;
- (double)_titlebarAuxiliaryHeight;
- (double)_computeMinPixelWidthForSimpleSavePanel:(BOOL)arg1;
