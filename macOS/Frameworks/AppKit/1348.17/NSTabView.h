...
- (void)_updateSpringLoadSubscription;
- (void)_setHasSetSpringLoadingDragTypes:(BOOL)arg1;
- (BOOL)_hasSetSpringLoadingDragTypes;
- (void)_setSubclassSubscribedDragTypes:(id)arg1;
- (id)_subclassSubscribedDragTypes;
...
@property id <NSTabViewDelegate> delegate;
