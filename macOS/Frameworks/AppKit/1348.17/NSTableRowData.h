...
@class NSBundle, NSControl, NSIndexSet, NSMutableArray, NSMutableDictionary, NSMutableIndexSet, NSString, NSTableRowView, NSTableUpdateData, NSTableView, NSTableViewDropFeedbackData, NSView, _NSTableGroupRowSupport;
