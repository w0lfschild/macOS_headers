...
- (void)tryTSMProcessRawKeyEvent:(struct OpaqueEventRef *)arg1 dispatchCondition:(CDUnknownBlockType)arg2 setupForDispatch:(CDUnknownBlockType)arg3 furtherCondition:(CDUnknownBlockType)arg4 dispatchWork:(CDUnknownBlockType)arg5 continuation:(CDUnknownBlockType)arg6;
