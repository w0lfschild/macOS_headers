...
@class NSArray, NSAttributedString, NSColor, NSDictionary, NSMutableSet, NSParagraphStyle, NSRulerView, NSSelectionArray, NSSharingServicePicker, NSTextContainer, NSTextFinder, NSTextInputContext, NSTextView, NSUndoManager, NSWindow;
