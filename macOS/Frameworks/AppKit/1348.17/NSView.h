...
@class CALayer, CIFilter, NSAppearance, NSArray, NSMenuItem, NSScrollView, NSShadow, NSString, NSTextInputContext, NSURL, NSViewController, NSWindow, _NSViewAuxiliary;
...
- (void)_revertGestureRecognizerPressureConfigurationForEvent:(id)arg1;
