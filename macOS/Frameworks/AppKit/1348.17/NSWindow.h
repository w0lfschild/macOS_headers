...
@class NSAppearance, NSArray, NSColor, NSColorSpace, NSDictionary, NSDockTile, NSEvent, NSGraphicsContext, NSImage, NSMutableSet, NSScreen, NSString, NSURL, NSView, NSViewController, NSWindowAuxiliary;
...
- (void)enumerateEventsMatchingMask:(unsigned long long)arg1 withTimeout:(double)arg2 inMode:(id)arg3 handler:(CDUnknownBlockType)arg4;
...
- (BOOL)_trackingRectInstalledSuccessfully:(long long)arg1;
...
- (id)_themeFrame;
- (BOOL)_isDocWindow;
@property(readonly) struct CGPoint mouseLocationOutsideOfEventStream;
