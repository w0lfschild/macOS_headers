...
- (void)_takeStartingWindowSnapshots:(struct __CFArray *)arg1 withShadow:(BOOL)arg2 onSpace:(unsigned long long)arg3;
- (struct CGRect)_updateShadowDeltaRect:(struct CGRect *)arg1 forFrame:(struct CGRect)arg2 basedOnImage:(struct CGImage *)arg3;
- (struct CGImage *)_getWindowSnapshotImageForWindowIDs:(struct __CFArray *)arg1 withShadow:(BOOL)arg2 onSpace:(unsigned long long)arg3;
