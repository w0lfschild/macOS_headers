...
@class NSFont, NSImage, NSImageView, NSString, _NSButtonCellAux;
...
- (void)_drawSelectionBorderWithFrame:(struct CGRect)arg1 inView:(id)arg2;
- (struct CGRect)_selectionBorderRectForBounds:(struct CGRect)arg1;
- (id)_coreUISelectionBorderContentsWithFrame:(struct CGRect)arg1 inView:(id)arg2;
- (struct __CFDictionary *)_coreUISelectionBorderDrawOptionsWithFrame:(struct CGRect)arg1 inView:(id)arg2;
...
- (BOOL)_shouldDrawSelectionBorder;
- (void)_removeSelectionBorderView;
- (void)_updateSelectionBorderViewWithFrame:(struct CGRect)arg1 inView:(id)arg2;
- (void)_setSelectionBorderView:(id)arg1;
- (id)_selectionBorderView;
...
- (struct CGSize)_coreUIIntrinsticContentSizeForRect:(struct CGRect)arg1 inView:(id)arg2;
...
- (void)_controlViewDidChangeAppearance:(id)arg1;
