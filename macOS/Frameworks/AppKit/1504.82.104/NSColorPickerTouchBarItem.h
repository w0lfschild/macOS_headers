...
#import <AppKit/NSFunctionRowColorPickerViewControllerDelegate-Protocol.h>
#import <AppKit/NSGestureRecognizerDelegate-Protocol.h>
#import <AppKit/NSTouchBarItemTypePopover-Protocol.h>

@class NSColor, NSColorList, NSImage, NSString, NSTouchBar, NSTouchBarItemOverlay, NSView;

@interface NSColorPickerTouchBarItem : NSTouchBarItem <NSTouchBarItemTypePopover, NSGestureRecognizerDelegate, NSFunctionRowColorPickerViewControllerDelegate>
{
    id _overlay;
...
- (void)colorPicker:(id)arg1 didChangeCurrentModeFrom:(unsigned long long)arg2 to:(unsigned long long)arg3;
