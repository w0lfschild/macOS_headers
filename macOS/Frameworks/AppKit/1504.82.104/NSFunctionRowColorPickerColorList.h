...
@class NSColor, NSColorList, NSPressGestureRecognizer, NSScrubber, NSString, NSTouchBarColorListPickerPressAndHoldPopUp;

__attribute__((visibility("hidden")))
@interface NSFunctionRowColorPickerColorList : NSControl <NSScrubberDelegate, NSScrubberDataSource, NSTouchBarColorListPickerPressAndHoldPopUpDelegate, NSGestureRecognizerDelegate, NSFunctionRowColorPickerView>
{
