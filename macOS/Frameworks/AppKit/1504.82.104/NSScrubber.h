...
@class NSArray, NSButton, NSColor, NSPanGestureRecognizer, NSPressGestureRecognizer, NSScrollView, NSScrubberLayout, NSScrubberPendingChanges, NSScrubberSelectionStyle, NSString;
...
- (void)_scrollView:(id)arg1 adjustScrollOffset:(inout struct CGPoint *)arg2 withVelocity:(struct CGPoint)arg3 toItemWithAlignment:(long long)arg4 pinningTarget:(BOOL)arg5;
...
- (void)_autoupdateFloatsSelectionIfNeeded;
