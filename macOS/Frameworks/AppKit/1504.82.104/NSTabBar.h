...
@class CABackdropLayer, CALayer, NSArray, NSLayoutConstraint, NSMapTable, NSMutableArray, NSScrollView, NSString, NSTabBarEmptyRegionPlaceholderButton, NSTabButton, NSTrackingArea, NSVisualEffectView;
