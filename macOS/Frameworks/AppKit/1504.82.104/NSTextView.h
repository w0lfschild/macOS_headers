...
- (void)updateTextFunctionBarItems;
- (id)candidateListFunctionBarItem;
- (void)updateFunctionBarItemIdentifiers;
...
@property id <NSTextViewDelegate> delegate;
...
- (void)setAllowsCharacterPickerFunctionBarItemIdentifier:(BOOL)arg1;
- (BOOL)allowsCharacterPickerFunctionBarItemIdentifier;
- (void)setAllowsCharacterPickerFunctionRowItemIdentifier:(BOOL)arg1;
- (BOOL)allowsCharacterPickerFunctionRowItemIdentifier;
...
- (void)insertCandidateString:(id)arg1 replacementRange:(struct _NSRange)arg2;
