...
#import <AppKit/NSCollectionViewDelegateDFRCustomizationLayout-Protocol.h>
#import <AppKit/NSTouchBarCustomizationPreviewFlexibleSectionLayoutDelegate-Protocol.h>
...
@interface NSTouchBarCustomizationPreviewViewController : NSViewController <NSTouchBarCustomizationPreviewInteractionCoordinatorDelegate, NSCollectionViewDelegateDFRCustomizationLayout, NSCollectionViewDataSource, NSTouchBarCustomizationPreviewFlexibleSectionLayoutDelegate, NSTouchBarCustomizationPreviewMiniControlStripSectionLayoutDelegate>
{
    ...
    unsigned int _cachedApplicationPresentationItemsAreInvalid:1;
    unsigned int _cachedMiniControlStripPresentationItemsAreInvalid:1;
    unsigned int _cachedExpandedControlStripPresentationItemsAreInvalid:1;
