...
- (void)_layerBackedDisplayRectIgnoringOpacity:(struct CGRect)arg1 inContext:(id)arg2 isRootView:(BOOL)arg3 flipContextIfNeedeed:(BOOL)arg4;
...
@property(setter=_setPostsNeedsDisplayInRectNotifications:) BOOL _postsNeedsDisplayInRectNotifications;
- (id)_regionDrawnInto;
...
- (void)_actuallyUpdateFrameFromLayoutEngineForSize:(BOOL)arg1 origin:(BOOL)arg2;
...
@property(readonly) BOOL allowsVibrancy; // @dynamic allowsVibrancy;
- (id)_layerSurface;
...
- (id)printJobTitle;
@property(readonly) NSCandidateListFunctionBarItem *candidateListFunctionBarItem;
