...
@class NSAppearance, NSArray, NSButtonCell, NSColor, NSColorSpace, NSDictionary, NSDockTile, NSGraphicsContext, NSImage, NSMutableSet, NSScreen, NSString, NSTitlebarAccessoryViewController, NSToolbar, NSURL, NSView, NSViewController, NSWindowAuxiliary, NSWindowController, NSWindowStackController, NSWindowTabViewItem;
...
- (void)_enterFullScreenMode:(id)arg1 options:(CDStruct_5e576fff)arg2;
- (void)_enterFullScreenMode:(id)arg1 options:(CDStruct_5e576fff)arg2 implicitlyTile:(BOOL)arg3;
...
- (void)_deferTileFullScreenWindowXPCMessage:(CDUnknownBlockType)arg1;
...
@property id <NSWindowDelegate> delegate;
...
- (BOOL)_tabbedWindowsHandleEnterFullScreenWithOptions:(CDStruct_5e576fff)arg1;
...
- (BOOL)_canProbablyFitInSize:(struct CGSize)arg1;
...
@property(retain) NSWindowTabViewItem *tabViewItem;
...
- (void)_setFullScreenManagedInfoFromDock:(CDStruct_79f078d6 *)arg1;
...
- (void)_setFullScreenTiled:(BOOL)arg1 withOptions:(CDStruct_5e576fff)arg2 overrideIsOnActiveSpace:(BOOL)arg3;
