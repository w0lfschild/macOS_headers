...
@class NSMapTable, NSMutableArray, NSMutableDictionary, NSPersistentUICrashHandler, NSPersistentUIEncodingQueue, NSPersistentUIFileManager, NSPersistentUIFlushScheduler, NSPersistentUIRestorer, NSPersistentUISecureURLHerder, NSPersistentUIWindowSnapshotter, NSString;
