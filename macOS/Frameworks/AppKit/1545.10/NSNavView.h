...
#import <AppKit/NSPathControlDelegate-Protocol.h>
...
@interface NSNavView : NSView <NSPathControlDelegate, NSSearchFieldDelegate, NSNavFileBrowser>
{
...
@property(retain) NSNavViewController *navViewController; // @synthesize navViewController=_navViewController;
@property(retain) NSNavSplitViewController *splitViewController; // @synthesize splitViewController=_splitViewController;
@property(retain) NSMenu *iconViewMenu; // @synthesize iconViewMenu=_iconViewMenu;
