...
- (void)scheduleURLEnableTestForItems:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)_layoutViewsVerticallyAndResizeWindowToLastExpandedSize:(BOOL)arg1 accessoryViewHeight:(double)arg2 documentWindow:(id)arg3 navViewMinSize:(struct CGSize)arg4;
