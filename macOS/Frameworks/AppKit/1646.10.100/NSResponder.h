...
@class NSArray, NSMenu, NSString, NSTouchBar, NSUserActivity;
...
+ (BOOL)automaticallyNotifiesObserversOfSelectionItems;
+ (BOOL)automaticallyNotifiesObserversOfCanReadSelectionFromItems;
+ (id)keyPathsForValuesAffectingSupportsQuickActionReturningItems;
+ (id)keyPathsForValuesAffectingQuickActionItems;
+ (BOOL)automaticallyNotifiesObserversOfQuickActionItems;
+ (BOOL)automaticallyNotifiesObserversOfSupportsQuickActionReturningItems;
