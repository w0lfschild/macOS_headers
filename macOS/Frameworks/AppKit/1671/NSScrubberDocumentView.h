...
- (struct CGPoint)scrollPointAligningItemAtIndex:(long long)arg1 toAlignment:(long long)arg2 forSelectedIndex:(long long)arg3 approximatedScrollPoint:(struct CGPoint)arg4;
- (struct CGPoint)scrollPointAligningItemAtIndex:(long long)arg1 toAlignment:(long long)arg2;
- (struct CGPoint)scrollPointAligningItemAtIndex:(long long)arg1 toAlignment:(long long)arg2 forState:(CDStruct_99688279)arg3;
- (void)applyPinningConfiguration:(CDStruct_3bb9c5bc)arg1;
- (CDStruct_3bb9c5bc)calculatePinningConfigurationForState:(CDStruct_99688279)arg1;
...
- (void)applySelectionAttributes:(id)arg1 startingAttributes:(id)arg2 withState:(CDStruct_99688279)arg3;
- (void)cleanupAfterSelectionTransitions:(id)arg1;
- (void)performSelectionTransitions:(id)arg1 withState:(CDStruct_99688279)arg2;
- (void)prepareForSelectionTransitions:(id)arg1;
- (void)applyLayoutAttributes:(id)arg1 toItemView:(id)arg2;
- (void)applyItemAttributes:(id)arg1 startingAttributes:(id)arg2 withState:(CDStruct_99688279)arg3;
...
- (struct CGRect)visibleContentRectForPinningConfiguration:(CDStruct_3bb9c5bc)arg1;
