...
@class _NSImageViewWithConfigurableVibrancy;
@protocol _NSVibrancyTransitioningImageViewDelegate;
...
@interface _NSVibrancyTransitioningImageView : NSView
{
    ...
    id <_NSVibrancyTransitioningImageViewDelegate> _delegate;
}

@property(nonatomic) __weak id <_NSVibrancyTransitioningImageViewDelegate> delegate; // @synthesize delegate=_delegate;
