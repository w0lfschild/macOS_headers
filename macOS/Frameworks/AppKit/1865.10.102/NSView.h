...
@class CALayer, CAProxyLayer, CIFilter, NSAppearance, NSArray, NSBezierPath, NSCGSWindowBackdrop, NSCandidateListTouchBarItem, NSColor, NSColorSpace, NSDictionary, NSFunctionRow, NSLayoutGuide, NSLayoutRect, NSMenu, NSMenuItem, NSMutableArray, NSMutableSet, NSPressureConfiguration, NSScrollView, NSShadow, NSString, NSSurface, NSTextInputContext, NSURL, NSViewController, NSWindow, _NSBindingAdaptor, _NSIdleTimer, _NSViewAnimator, _NSViewLayerSurface, _NSViewLayoutAux;
@protocol NSAppearanceCustomization, NSContentStyle;

@interface NSView : NSResponder <NSLayoutSpacingItem, NSAppearanceCustomizationInternal, NSAnimatablePropertyContainer, NSUserInterfaceItemIdentification, NSDraggingDestination, NSAppearanceCustomization, NSAccessibilityElement, NSAccessibility>
{
    NSView *_superview;
...
- (void)_unregisterDraggingForiOSMacContext:(unsigned int)arg1;
- (void)_registerDraggingForiOSMacContext:(unsigned int)arg1;
...
- (id)printJobTitle;
- (id)_menuItemsForRevealItem:(id)arg1 contextual:(BOOL)arg2 options:(id)arg3 locationInWindow:(struct CGPoint)arg4;
- (void)_revealItemFromString:(id)arg1 range:(struct _NSRange)arg2 options:(id)arg3 baselineOriginProvider:(CDUnknownBlockType)arg4;
- (id)_rvItemForAttributedString:(id)arg1 range:(struct _NSRange)arg2;
...
- (void)measureMin:(struct CGSize *)arg1 max:(struct CGSize *)arg2 ideal:(struct CGSize *)arg3;
...
- (void)_invalidateIntrinsicContentSizeDirtyingConstraints:(BOOL)arg1;
...
@property(readonly, nonatomic) NSLayoutGuide *safeAreaLayoutGuide;
- (id)_safeAreaLayoutGuideIfExists;
- (struct NSEdgeInsets)_safeAreaInsetsForFrame:(struct CGRect)arg1 inSuperview:(id)arg2;
- (struct NSEdgeInsets)computedSafeAreaInsets;
...
@property(readonly) struct NSEdgeInsets safeAreaInsets; // @dynamic safeAreaInsets;
