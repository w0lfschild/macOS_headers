...
+ (struct CGRect)_integralizeProposedFrame:(struct CGRect)arg1 againstExistingFrame:(struct CGRect)arg2;
...
- (struct CGRect)_adjustFrame:(struct CGRect)arg1 fittingRect:(struct CGRect)arg2;
- (struct CGRect)_standardFrameForScreen:(id)arg1 isMoveToiPad:(BOOL)arg2;
- (struct CGRect)_divideFrameForEdge:(unsigned long long)arg1;
...
- (void)_reallySetFrame:(struct CGRect)arg1;
...
- (BOOL)_isWindowPointInStandardWindowButtonGroup:(struct CGPoint)arg1;
- (BOOL)_isView:(id)arg1 standardWindowButtonOfType:(unsigned long long)arg2;
...
- (void)_moveWindowFrame:(struct CGRect *)arg1 fromScreen:(id)arg2 toScreen:(id)arg3;
...
- (void)_enterATUWithTileOnLeft:(BOOL)arg1;
