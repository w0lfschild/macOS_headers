...
#import "NSAccessibilityTable.h"
#import "NSDraggingSource.h"
#import "NSTextViewDelegate.h"
#import "NSUserInterfaceValidations.h"

@class NSArray, NSCell, NSColor, NSDictionary, NSIndexSet, NSMutableArray, NSMutableIndexSet, NSString, NSTableColumn, NSTableHeaderView, NSView;
...
- (void)_getRow:(long long *)arg1 column:(long long *)arg2 forPoint:(struct CGPoint)arg3;
...
- (id)_makeRubberBandViewWithFrame:(struct CGRect)arg1 inView:(id)arg2;
...
- (void)_startObservingContainingVisualEffectView:(BOOL)arg1 andThemeFrame:(BOOL)arg2;
- (void)_stopObservingContainingVisualEffectView:(BOOL)arg1 andThemeFrame:(BOOL)arg2;
...
- (id)_makeSelectionBlurBackdropViewWithFrame:(struct CGRect)arg1;
...
- (void)_callDrawBackgroundInClipRect:(struct CGRect)arg1;
- (void)_drawBackgroundColor:(id)arg1 inClipRect:(struct CGRect)arg2;
- (void)_drawSourceListBackgroundInClipRect:(struct CGRect)arg1;
- (void)_drawStuff:(CDUnknownBlockType)arg1 withClipRect:(struct CGRect)arg2;
...
- (void)_callHighlightSelectionInClipRect:(struct CGRect)arg1;
...
- (CDStruct_6b6ad735)_cellPositionAtColumn:(long long)arg1 row:(long long)arg2;
...
- (struct _NSRange)_rtlColumnsInRect:(struct CGRect)arg1;
- (struct _NSRange)_ltrColumnsInRect:(struct CGRect)arg1;
...
- (void)_adjustRowRect:(struct CGRect *)arg1 forSourceListRow:(long long)arg2;
...
- (struct CGRect)_newRectOfColumn:(long long)arg1;
- (double)_standardGroupHeight;
...
- (void)setAnimationCompletionHandler:(CDUnknownBlockType)arg1;
- (CDUnknownBlockType)animationCompletionHandler;
- (id)_mutableSelectedRows;
@property(readonly, copy) NSIndexSet *hiddenRowIndexes; // @dynamic hiddenRowIndexes;
