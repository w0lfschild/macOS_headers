...
- (void)_readDescriptorOfType:(unsigned short)arg1 withID:(unsigned short)arg2 inConfiguration:(unsigned short)arg3 forObject:(id)arg4 inflightLimiter:(id)arg5;
- (void)readDescriptorOfType:(unsigned short)arg1 withID:(unsigned short)arg2 inConfiguration:(unsigned short)arg3 forObject:(id)arg4 inflightLimiter:(id)arg5;
