...
- (void)dealloc;
@property(readonly, nonatomic) unsigned long long dclMaximumStreamPayloadSize; // @dynamic dclMaximumStreamPayloadSize;
@property(readonly, nonatomic) unsigned long long dclMaximumStreamHeaderSize; // @dynamic dclMaximumStreamHeaderSize;
@property(readonly, nonatomic) unsigned int numberOfDCLs; // @dynamic numberOfDCLs;
