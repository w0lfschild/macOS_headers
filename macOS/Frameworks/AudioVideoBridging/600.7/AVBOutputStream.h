...
+ (id)IOClassName;
- (void)dealloc;
- (BOOL)removeUnicastDestinationAddress:(id)arg1 error:(id *)arg2;
- (BOOL)addUnicastDestinationAddress:(id)arg1 error:(id *)arg2;
- (BOOL)enableMulticast:(BOOL)arg1 error:(id *)arg2;
