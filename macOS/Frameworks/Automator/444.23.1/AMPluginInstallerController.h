...
@class NSArray, NSButton, NSImage, NSImageView, NSProgressIndicator, NSString, NSTextField, NSTimer, NSView, NSViewAnimation, NSViewController;
...
@property __weak NSImageView *successIconView; // @synthesize successIconView=_successIconView;
...
- (id)_installErrorForPersonalityCanSaveError:(id)arg1;
