...
@class AMWorkflowController, AMWorkflowMetaData, AMWorkflowPersonality, NSArray, NSAttributedString, NSDictionary, NSMapTable, NSMutableArray, NSString, NSURL, NSUndoManager;
...
- (BOOL)firstActionToConnectToHeaderViewHasPotentialConnectionToInputType:(id)arg1 returningLength:(unsigned long long *)arg2;
