...
#import <Automator/NSXMLParserDelegate-Protocol.h>

@class AMFFeedElement, NSData, NSMutableArray, NSString, NSURL;
@protocol AMFFeedParserDelegate, OS_dispatch_queue;
