...
@class NSArray, NSData, NSDictionary, NSError, NSObject<OS_voucher>, NSProgress, NSString, NSURL, NSURLRequest, NSURLResponse, NSURLSessionEffectiveConfiguration, NSURLSessionTaskDependency, NSURLSessionTaskDependencyTree, NSURLSessionTaskHTTPAuthenticator, NSUUID, __CFN_TransactionMetrics;
