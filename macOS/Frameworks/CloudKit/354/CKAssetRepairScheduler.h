...
@class CKContainer, CKUploadRequestConfiguration, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSOperationQueue, NSSet, NSURL;
