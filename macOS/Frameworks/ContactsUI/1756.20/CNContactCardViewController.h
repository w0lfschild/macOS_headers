...
@class ABAddressBook, ABCardViewSaveHelper, ABCardViewStyleProvider, ABCardViewUndoableDataSource, ABCommandExecutor, ABPerson, AKCardViewDataSource, AKCardViewDataSourceFactory, CNContact, CNContactCardViewControlContext, CNContactCardViewControllerABPersonViewMediator, CNContactCardViewControllerDataSourceDelegate, CNContactCardViewControllerWidgetProviderDelegate, CNContactCardWidgetProvider, CNContactPersistenceHelper, CNSuddenTerminationInhibitor, CNUIMeContactMonitor, CNUIUserActionListDataSource, NSArray, NSMutableDictionary, NSSet, NSStackView, NSString, NSTextField, NSUndoManager;
@protocol CNCancelable, CNContactCardViewControllerDelegate, CNContactCardViewRefreshStrategy, CNSchedulerProvider;
...
- (void)_refreshData;
- (void)refreshData;
- (void)switchModeFromMode:(unsigned long long)arg1 toMode:(unsigned long long)arg2;
