...
@class ABCardViewSaveHelper, ABCommandExecutor, AKCardViewDataSource, CNContact, CNContainer, CNUIEditingPolicy, NSString;
...
@property(retain, nonatomic) CNUIEditingPolicy *editingPolicy; // @synthesize editingPolicy=_editingPolicy;
