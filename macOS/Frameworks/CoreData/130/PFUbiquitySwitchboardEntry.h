...
@class NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, NSURL, PFUbiquityContainerMonitor, PFUbiquityFilePresenter, PFUbiquityLocation, PFUbiquitySetupAssistant, PFUbiquitySwitchboardEntryMetadata;
