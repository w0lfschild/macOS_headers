...
@class NSArray, NSDictionary, NSManagedObjectModel, NSMapTable, NSString, NSURL, NSXPCListener, NSXPCStoreServerNotificationManager, NSXPCStoreServerRequestHandlingPolicy;
