...
@class CKDatabase, CKRecordZone, NSCKImportOperation, NSCloudKitMirroringDelegateOptions, NSDictionary, NSMutableArray, NSMutableDictionary, NSPersistentStore, NSPersistentStoreCoordinator, NSSQLCore, NSString, NSURL, PFCloudKitStoreMonitor;
