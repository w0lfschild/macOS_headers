...
@class CKContainer, CKDatabase, CKRecordZone, CKRecordZoneSubscription, NSCloudKitMirroringDelegateOptions, NSError, NSPersistentStore, NSPersistentStoreCoordinator, NSSQLCore, NSString;
