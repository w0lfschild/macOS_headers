...
@class CDDCloudKitClient, CKContainer, CKDatabase, CKDatabaseSubscription, CKNotificationListener, CKRecordZone, CKScheduler, NSCloudKitMirroringDelegateOptions, NSCloudKitMirroringRequestManager, NSError, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSPersistentStore, NSPersistentStoreCoordinator, NSSQLCore, NSString, PFCloudKitExporterOptions;
