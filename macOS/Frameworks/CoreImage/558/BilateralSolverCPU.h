...
@interface BilateralSolverCPU : NSObject
{
    int _width;
    int _height;
...
- (int)doSolveWithBilateralGridhash:(id)arg1 reference:(struct __CVBuffer *)arg2 input:(struct __CVBuffer *)arg3 confidence:(struct __CVBuffer *)arg4 output:(struct __CVBuffer *)arg5 lambda:(float)arg6 maxIterations:(int)arg7;
- (void)dealloc;
