...
- (void)_computeBilateralSpaceYCC444:(struct __IOSurface *)arg1 region:(struct CGRect)arg2 cropRect:(struct CGRect)arg3 sigma_s:(int)arg4 sigma_r_luma:(int)arg5 sigma_r_chroma:(int)arg6;
...
- (void)createWithSurface:(struct __IOSurface *)arg1 region:(struct CGRect)arg2 cropRect:(struct CGRect)arg3 sigma_s:(int)arg4 sigma_r_luma:(int)arg5 sigma_r_chroma:(int)arg6;
- (void)clear;
- (void)dealloc;
