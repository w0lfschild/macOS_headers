...
- (int)redEyeRemovalWithData:(CDStruct_88c8157e)arg1;
- (void)skinInit;
- (void)prepareLineFunctions;
- (int)distanceMaskFromPolyToCb:(int)arg1 Cr:(int)arg2;
- (void)autoRepairExtractAndSearchLeft:(CDStruct_a734b2e2)arg1 right:(CDStruct_a734b2e2)arg2 data:(CDStruct_28cfb1ba *)arg3 repairSize:(float)arg4 autoPupilTonality:(BOOL)arg5 faceIndex:(int)arg6;
- (BOOL)gatherProminencesWithC:(CDStruct_c3faddef *)arg1 MC:(CDStruct_c3faddef *)arg2 altC:(CDStruct_c3faddef *)arg3 altMC:(CDStruct_c3faddef *)arg4 maxwindowsize:(int)arg5 repairsize:(int)arg6 IR:(CDStruct_a734b2e2)arg7 fr:(CDStruct_28cfb1ba *)arg8 intoHopper:(CDStruct_08ff8b76 *)arg9 faceIndex:(int)arg10 left:(BOOL)arg11;
...
- (float)extractAverageFaceY:(CDStruct_28cfb1ba *)arg1 contrast:(float *)arg2 faceIndex:(int)arg3;
- (void)redoLastRepair;
- (int)redoRepairWithTag:(int)arg1 IOD:(float)arg2;
- (CDStruct_97798437 *)repairWithTag:(int)arg1;
