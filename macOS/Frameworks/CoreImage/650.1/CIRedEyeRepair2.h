...
+ (BOOL)verifyBorderPoints:(CDStruct_94ca5ecd *)arg1 rect:(CDStruct_a734b2e2)arg2 inside:(CDStruct_b1bd45e0 *)arg3 outside:(CDStruct_b1bd45e0 *)arg4 error:(char [256])arg5;
+ (void)printBorder:(CDStruct_b1bd45e0 *)arg1 name:(char *)arg2;
+ (BOOL)computeBorderPoints:(CDStruct_94ca5ecd *)arg1 rect:(CDStruct_a734b2e2)arg2 inside:(CDStruct_b1bd45e0 *)arg3 outside:(CDStruct_b1bd45e0 *)arg4;
...
- (CDStruct_ad9f718b)transformGlobalRepairRecord:(CDStruct_ad9f718b *)arg1 transform:(struct CGAffineTransform)arg2;
- (struct CGPoint)leftHandedTransform:(struct CGAffineTransform)arg1 ofPoint:(struct CGPoint)arg2;
- (id)packRepairDictionary:(CDStruct_ad9f718b *)arg1;
- (id)packGlobalRepairDictionary:(CDStruct_ad9f718b *)arg1;
- (CDStruct_ad9f718b)unpackRepairDictionary:(id)arg1;
- (CDStruct_ad9f718b)unpackGlobalRepairDictionary:(id)arg1;
...
- (BOOL)analyzeIrisColors:(CDStruct_ad9f718b *)arg1 side:(int)arg2;
...
- (void)extractIrisColors:(CDStruct_ad9f718b *)arg1;
- (void)alignPupils;
...
- (void)printRepair:(CDStruct_ad9f718b)arg1;
