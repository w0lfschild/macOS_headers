...
- (CDStruct_2eb7bc67)repairWithProminence:(CDStruct_28d7c0ef)arg1 white:(CDStruct_28d7c0ef *)arg2 onSide:(int)arg3 metrics:(CDStruct_265c7ca9)arg4 rect:(CDStruct_a734b2e2)arg5;
- (CDStruct_28d7c0ef)winningProminence:(CDStruct_28d7c0ef [7])arg1 metrics:(CDStruct_265c7ca9)arg2;
- (void)acquireProminences:(CDStruct_28d7c0ef [7])arg1 onSide:(int)arg2 metrics:(CDStruct_265c7ca9)arg3;
- (void)freeChoiceRecord:(CDStruct_28d7c0ef *)arg1;
- (void)initChoiceRecord:(CDStruct_28d7c0ef *)arg1 type:(int)arg2 title:(char *)arg3 plusWhiteTitle:(char *)arg4 name:(char *)arg5 canPlusWhite:(BOOL)arg6 canSpecular:(BOOL)arg7 metrics:(CDStruct_265c7ca9)arg8;
...
- (BOOL)findProminenceWithSide:(int)arg1 record:(CDStruct_28d7c0ef *)arg2;
- (void)freeBitmaps;
