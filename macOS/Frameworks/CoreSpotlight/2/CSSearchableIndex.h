...
@class CSIndexConnection, CSIndexingQueue, NSMutableArray, NSNumber, NSObject<OS_dispatch_queue>, NSString;
...
+ (void)fetchFile:(id)arg1 attributesWithCompletionHandler:(CDUnknownBlockType)arg2;
