...
- (BOOL)associateToEnterpriseNetwork:(id)arg1 clientItemID:(struct __EAPOLClientItemID *)arg2 username:(id)arg3 password:(id)arg4 identity:(struct OpaqueSecIdentityRef *)arg5 forceBSSID:(BOOL)arg6 remember:(BOOL)arg7 possiblyHidden:(BOOL)arg8 error:(out id *)arg9;
...
- (BOOL)associateToEnterpriseNetwork:(id)arg1 identity:(struct OpaqueSecIdentityRef *)arg2 username:(id)arg3 password:(id)arg4 forceBSSID:(BOOL)arg5 remember:(BOOL)arg6 possiblyHidden:(BOOL)arg7 error:(out id *)arg8;
