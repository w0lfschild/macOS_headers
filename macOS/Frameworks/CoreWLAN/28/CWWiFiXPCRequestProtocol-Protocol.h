...
- (void)internal_handOffSidecarMetricsFromCompanion:(NSString *)arg1 metricsData:(NSData *)arg2;
- (void)internal_receivedAutoHotspotNotificationResponse:(BOOL)arg1 updateMode:(long long)arg2 tetherDevice:(CWTetherDevice *)arg3 interfaceName:(NSString *)arg4;
- (void)setAutoHotspotMode:(long long)arg1 reply:(void (^)(NSError *))arg2;
...
- (void)internal_userAgentWillShowJoinUIForWiFiNetwork:(CWNetwork *)arg1 interfaceName:(NSString *)arg2 timestamp:(double)arg3 reply:(void (^)(NSError *))arg4;
- (void)internal_foundTetherDevices:(NSSet *)arg1;
- (void)joinWiFiNetwork:(CWNetwork *)arg1 interfaceName:(NSString *)arg2 reply:(void (^)(NSError *))arg3;
...
- (void)associateToLoginWindowMode8021XWiFiNetwork:(CWNetwork *)arg1 interfaceName:(NSString *)arg2 token:(long long)arg3 priority:(long long)arg4 authorization:(NSData *)arg5 reply:(void (^)(NSError *))arg6;
...
- (void)queryScanCacheWithChannels:(NSSet *)arg1 ssidList:(NSSet *)arg2 maxAge:(double)arg3 maxMissCount:(long long)arg4 maxWakeCount:(long long)arg5 maxAutoJoinCount:(long long)arg6 trimmedScanResultProperties:(NSSet *)arg7 interfaceName:(NSString *)arg8 reply:(void (^)(NSError *, NSSet *))arg9;
...
- (void)queryBSSIDForInterfaceWithName:(NSString *)arg1 reply:(void (^)(NSError *, NSString *))arg2;
@end
