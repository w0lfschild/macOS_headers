...
- (void)internal_joinWiFiNetworkWithUserAgent:(CWNetwork *)arg1 interfaceName:(NSString *)arg2 timestamp:(double)arg3 reply:(void (^)(NSError *))arg4;
...
- (void)internal_startUserMode8021XWithProfile:(NSDictionary *)arg1 interfaceWithName:(NSString *)arg2 reply:(void (^)(NSError *))arg3;
