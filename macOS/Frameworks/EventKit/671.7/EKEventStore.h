...
- (BOOL)_respondToInvitations:(id)arg1 withStatus:(long long)arg2 exceptForDates:(id)arg3 placingInCalendar:(id)arg4 commit:(BOOL)arg5 error:(id *)arg6;
- (BOOL)acceptInvitation:(id)arg1 exceptForDates:(id)arg2 placingInCalendar:(id)arg3 commit:(BOOL)arg4 error:(id *)arg5;
- (BOOL)respondToInvitations:(id)arg1 withStatus:(long long)arg2 commit:(BOOL)arg3 error:(id *)arg4;
- (BOOL)respondToInvitation:(id)arg1 withStatus:(long long)arg2 placingInCalendar:(id)arg3 commit:(BOOL)arg4 error:(id *)arg5;
