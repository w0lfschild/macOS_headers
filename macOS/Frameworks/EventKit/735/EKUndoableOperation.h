...
@interface EKUndoableOperation : NSObject
{
    ...
    EKUndoableOperation *_precomputedInverseOperation;
}

+ (id)operationWithObjects:(id)arg1 span:(long long)arg2;
+ (id)operationForContext:(id)arg1;
@property(retain) EKUndoableOperation *precomputedInverseOperation; // @synthesize precomputedInverseOperation=_precomputedInverseOperation;
