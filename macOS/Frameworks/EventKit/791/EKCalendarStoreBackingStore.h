...
@class CalAccumulatingQueue, CalAgentLinkQueueStatusOperation, EKBackingStoreAccounting, NSDate, NSObject;
...
- (BOOL)addEventAndAnyExceptionsForEvent:(id)arg1 withManagedObject:(id)arg2 toAddedEvents:(id)arg3;
- (BOOL)addReminder:(id)arg1 toAddedReminders:(id)arg2;
- (id)_createFrozenItemForManagedItem:(id)arg1;
