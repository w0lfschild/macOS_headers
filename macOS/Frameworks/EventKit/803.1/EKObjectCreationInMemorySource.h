...
@interface EKObjectCreationInMemorySource : EKObjectCreationInMemoryObject <CalendarSourceModelProtocol>
{
    BOOL _isDelegate;
...
@property(nonatomic) BOOL supportsPhoneNumbers; // @synthesize supportsPhoneNumbers=_supportsPhoneNumbers;
