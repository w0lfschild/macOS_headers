...
#import "FPReachabilityObserver.h"

@class FPAppRegistry, FPItemID, FPPacer, NSArray, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSPredicate, NSString, _FPItemList;
