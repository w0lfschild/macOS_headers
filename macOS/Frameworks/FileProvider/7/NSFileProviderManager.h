...
@class NSArray, NSFileProviderDomain, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSObject<OS_dispatch_source>, NSString, NSURL, NSXPCConnection<FPDDaemon>, _FPFilePresenterObserver;
