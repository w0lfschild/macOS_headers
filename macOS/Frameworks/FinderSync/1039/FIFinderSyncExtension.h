...
- (void)fetchRemoteFileProviderEndpointForProtocolName:(id)arg1 messageInterface:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)requestMessageInterfaceNamesForURL:(id)arg1;
