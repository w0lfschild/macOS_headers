...
@class NSArray, NSDictionary, NSFileProviderMessageInterface, NSString, NSURL;
...
- (void)fetchRemoteFileProviderEndpointForProtocolName:(NSString *)arg1 messageInterface:(NSFileProviderMessageInterface *)arg2 completionHandler:(void (^)(NSXPCListenerEndpoint *, NSError *))arg3;
- (void)requestMessageInterfaceNamesForURL:(NSString *)arg1;
