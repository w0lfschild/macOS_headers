...
@class NSArray, NSFileProviderMessageInterface, NSImage, NSMenu, NSString, NSURL, NSXPCListenerEndpoint, Protocol;
...
- (NSXPCListenerEndpoint *)makeListenerEndpointForServiceName:(NSString *)arg1 andReturnError:(id *)arg2;
