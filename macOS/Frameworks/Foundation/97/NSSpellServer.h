...
- (bycopy id)_dataFromGeneratingCandidatesForSelectedRange:(struct _NSRange)arg1 inString:(in id)arg2 offset:(in unsigned long long)arg3 types:(in unsigned long long)arg4 optionsData:(in bycopy id)arg5 orthography:(in bycopy id)arg6 learnedDictionaries:(in bycopy id)arg7;
- (bycopy id)_dataFromGeneratingCandidatesForSelectedRange:(struct _NSRange)arg1 inString:(in id)arg2 offset:(in unsigned long long)arg3 types:(in unsigned long long)arg4 options:(in bycopy id)arg5 orthography:(in bycopy id)arg6 learnedDictionaries:(in bycopy id)arg7;
