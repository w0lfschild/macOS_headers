...
@class BluetoothHIDDeviceController, IOBluetoothDevice, IOBluetoothDeviceInquiry, IOBluetoothDevicePair, IORegistryObjectNotifier, NSMutableArray, NSString, NSTimer, SystemPowerNotifier;
