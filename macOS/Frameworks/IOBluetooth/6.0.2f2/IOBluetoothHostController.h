...
- (void)BluetoothHostControllerLEAdvertisingReportEventTest:(unsigned char)arg1;
...
- (int)BluetoothHCIWriteCurrentIACLAP:(const struct BluetoothHCICurrentInquiryAccessCodesForWrite *)arg1;
...
- (int)BluetoothHCIReadLocalName:(unsigned char [248])arg1;
- (int)BluetoothHCIWriteLocalName:(unsigned char [248])arg1;
