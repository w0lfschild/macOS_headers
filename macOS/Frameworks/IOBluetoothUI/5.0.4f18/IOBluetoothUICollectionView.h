...
#import <IOBluetoothUI/CBPeripheralPairingDelegate-Protocol.h>
...
@class AppleOptions_82795B5D88, BluetoothHIDDeviceController, CBCentralManager, CBPeripheral, IOBluetoothDevice, IOBluetoothDeviceInquiry, IOBluetoothDevicePairViewController, IOBluetoothUISortedArrayController, NSAlert, NSArray, NSButton, NSImage, NSImageView, NSMutableArray, NSMutableDictionary, NSPanel, NSProgressIndicator, NSString, NSTableView, NSTextField, NSTimer, NSTrackingArea, NSView;

@interface IOBluetoothUICollectionView : NSViewController <NSMenuDelegate, NSTableViewDelegate, IOBluetoothDevicePairDelegate, CBCentralManagerDelegate, CBPeripheralDelegate, CBPeripheralPairingDelegate, NSWindowDelegate>
{
    ...
    BOOL windowLoaded;
    AppleOptions_82795B5D88 *controller;
    BOOL _mShowPairButton;
    NSTimer *_mLETimer;
    IOBluetoothDevice *_mAppleDevice;
    AppleOptions_82795B5D88 *_optionsController;
}
...
@property(retain) AppleOptions_82795B5D88 *optionsController; // @synthesize optionsController=_optionsController;
