...
+ (BOOL)validateBundleIdentifierControllingExternalMediaDevices:(id)arg1;
+ (void)addBundleIdentifierControllingExternalMediaDevices:(id)arg1;
+ (void)revokeBundleIdentifierControllingExternalMediaDevices:(id)arg1;
+ (id)bundleIdentifiersControllingExternalMediaDevices;
