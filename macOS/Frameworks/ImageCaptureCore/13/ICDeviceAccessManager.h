...
- (void)displayControlAlertForApplication:(id)arg1 notificationDict:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (void)addControlApplicationWithBundleIdentifier:(id)arg1 authorized:(BOOL)arg2;
