...
@class NSArray, NSDictionary, NSLock, NSMutableDictionary, NSMutableSet, NSNumber, NSString, NSXPCConnection, NSXPCListenerEndpoint;
@protocol ICDeviceDelegate, OS_dispatch_queue;
