...
@property BOOL proxy; // @synthesize proxy=_proxy;
@property(copy) NSString *buttonPressed; // @synthesize buttonPressed=_buttonPressed;
@property double preferredTimeStamp; // @synthesize preferredTimeStamp=_preferredTimeStamp;
...
@property(retain) NSMutableSet *capabilities; // @synthesize capabilities=_capabilities;
