...
@class IMKCandidates, IMKEvent, IMKInputController, IMKPreferences, NSBundle, NSConnection, NSLock, NSMenu, NSMutableArray, NSMutableDictionary, NSRecursiveLock, NSString, NSTask, NSTimer, NSXPCConnection, NSXPCListener, NSXPCListenerEndpoint;
