...
#import <InstallerPlugins/NSTextFieldDelegate-Protocol.h>
#import <InstallerPlugins/NSToolbarDelegate-Protocol.h>

@class IFXLogDataSource, NSArray, NSBundle, NSMutableDictionary, NSPanel, NSPopUpButton, NSSearchField, NSString, NSTableView, NSTextField, NSWindow;
