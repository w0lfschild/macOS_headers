...
- (id).cxx_construct;
- (void).cxx_destruct;
-     // Error parsing type: ^{Structure=ICCCC{StructureIDBlob=(?={?=ICCCC}{?=ii}q)}SC{Lock={Atomic<unsigned char>={atomic<unsigned char>=AC}}}I{WriteBarrier<JSC::JSGlobalObject, WTF::DumbPtrTraits<JSC::JSGlobalObject> >=^{JSGlobalObject}}{WriteBarrier<JSC::Unknown, WTF::DumbValueTraits<JSC::Unknown> >=q}{WriteBarrier<JSC::StructureChain, WTF::DumbPtrTraits<JSC::StructureChain> >=^{StructureChain}}{WriteBarrier<JSC::JSCell, WTF::DumbPtrTraits<JSC::JSCell> >=^{JSCell}}{RefPtr<WTF::UniquedStringImpl, WTF::DumbPtrTraits<WTF::UniquedStringImpl> >=^{UniquedStringImpl}}{Poisoned<WTF::Poison<&JSC::g_GlobalDataPoison>, const JSC::ClassInfo *, void>=Q}{StructureTransitionTable=q}{WriteBarrier<JSC::PropertyTable, WTF::DumbPtrTraits<JSC::PropertyTable> >=^{PropertyTable}}{WriteBarrier<JSC::InferredTypeTable, WTF::DumbPtrTraits<JSC::InferredTypeTable> >=^{InferredTypeTable}}{InlineWatchpointSet=Q}iI}24@0:8@16, name: structureInContext:
