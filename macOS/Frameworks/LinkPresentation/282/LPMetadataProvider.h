...
@class LPAnimatedImageTranscoder, LPFetcherGroup, LPLinkMetadata, LPMetadataProviderSpecialization, NSMutableArray, NSObject<OS_dispatch_group>, NSString, NSTimer, NSURL, WKWebView;
