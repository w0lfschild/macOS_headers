...
@class MKAnnotationCalloutController, MKAnnotationView, MKPinAnnotationView, NSMutableArray, NSMutableSet, NSString, _MKBalloonAnnotationCalloutController;
@protocol MKAnnotationContainerViewDelegate;

@interface MKAnnotationContainerView : NSView <MKAnnotationCalloutControllerDelegate, _MKPinAnnotationViewDelegate>
{
