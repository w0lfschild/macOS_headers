...
@property(nonatomic, getter=_shouldDelayLocationUpdatesUntilInitialRendering, setter=_setShouldDelayLocationUpdatesUntilInitialRendering:) BOOL shouldDelayLocationUpdatesUntilIntialRendering;
