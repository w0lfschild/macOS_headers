...
- (id)ticketForNearestTransitStation:(id)arg1 coordinate:(struct CLLocationCoordinate2D)arg2 includeETA:(BOOL)arg3 traits:(id)arg4;
- (id)ticketForTransitLines:(id)arg1 traits:(id)arg2;
- (id)ticketForChildPlace:(id)arg1 includeETA:(BOOL)arg2 traits:(id)arg3;
...
- (id)ticketForCategoryListWithVenueID:(unsigned long long)arg1 componentIdentifier:(id)arg2 minimumNumberOfCategories:(int)arg3 withTraits:(id)arg4;
...
- (id)_ticketForReverseGeocodeCoordinate:(struct CLLocationCoordinate2D)arg1 floorOrdinal:(int)arg2 includeEntryPoints:(BOOL)arg3 includeETA:(BOOL)arg4 preserveOriginalLocation:(BOOL)arg5 traits:(id)arg6;
