...
@interface MKTransitDeparturesViewController : _MKClickableTableViewController <_MKTransitConnectionCellDelegate, MKTransitDeparturesCellDelegate, MKDynamicTransitUIContainer, _MKInfoCardChildViewControllerAnalyticsDelegate, MKModuleViewControllerProtocol>
{
