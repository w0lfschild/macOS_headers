...
#import <MapKit/_MKWiFiObserverDelegate-Protocol.h>

@class CLHeading, CLLocation, GEOLocation, GEOLocationShifter, NSBundle, NSError, NSHashTable, NSLock, NSMutableArray, NSString, NSTimer, _MKWiFiObserver;
