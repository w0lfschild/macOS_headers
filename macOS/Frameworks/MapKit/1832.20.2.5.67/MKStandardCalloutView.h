...
@class MKSmallCalloutView, NSColor, NSString, NSView, NSVisualEffectView, _MKCalloutContentView, _MKCalloutLayer;

@interface MKStandardCalloutView : MKCalloutView <CALayerDelegate, NUIContainerBoxViewDelegate>
{
    struct {
