...
struct _MTLIndirectArgumentBufferLayoutPrivate {
    struct unordered_map<unsigned long, MTLPointerTypeInternal *, std::__1::hash<unsigned long>, std::__1::equal_to<unsigned long>, std::__1::allocator<std::__1::pair<const unsigned long, MTLPointerTypeInternal *>>> _field1;
};
