...
@class MTLCommandQueueDescriptor, MTLComputePipelineDescriptor, MTLStructType, MTLTextureDescriptor, NSArray, NSObject, NSString, _MTLIndirectArgumentBufferLayout;
@protocol MTLArgumentEncoder, MTLCommandQueue, MTLComputePipelineState, MTLDeviceSPI, MTLIndirectArgumentEncoder, MTLLibrary, MTLTexture, OS_dispatch_data;
