...
+ (void)initNewTextureDataWithDevice:(id)arg1 descriptor:(id)arg2 sysMemSize:(unsigned int)arg3 sysMemRowBytes:(unsigned int)arg4 vidMemSize:(unsigned int)arg5 vidMemRowBytes:(unsigned int)arg6 args:(struct IOAccelNewResourceArgs *)arg7;
...
- (id)initWithBuffer:(id)arg1 descriptor:(id)arg2 sysMemOffset:(unsigned int)arg3 sysMemRowBytes:(unsigned int)arg4 vidMemSize:(unsigned int)arg5 vidMemRowBytes:(unsigned int)arg6 args:(struct IOAccelNewResourceArgs *)arg7 argsSize:(unsigned int)arg8 isStrideTexture:(BOOL)arg9;
