...
@class NSString;
@protocol MTLBuffer, MTLDevice, MTLIndirectArgumentEncoder, MTLRenderPipelineState, MTLSamplerState, MTLTexture;
...
- (id <MTLIndirectArgumentEncoder>)newIndirectArgumentEncoderForBufferAtIndex:(unsigned long long)arg1;
