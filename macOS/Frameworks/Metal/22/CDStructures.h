...
@class MTLIOAccelBuffer, MTLIOAccelDevice, MTLIOAccelDevice<MTLDevice>, MTLIOAccelDeviceShmem, MTLIOAccelDeviceShmemPool, MTLIOAccelHeap, MTLIOAccelPooledResource, MTLIOAccelResource, MTLIOAccelResourcePool, MTLPipelineBufferDescriptorArrayInternal, MTLRenderPassColorAttachmentDescriptorArrayInternal, MTLRenderPipelineColorAttachmentDescriptorArrayInternal, MTLResourceAllocationInfo, MTLResourceList, MTLStageInputOutputDescriptor, MTLStencilDescriptorInternal, MTLVertexDescriptorInternal, NSData, NSDictionary, NSObject<OS_dispatch_data>, NSString;
