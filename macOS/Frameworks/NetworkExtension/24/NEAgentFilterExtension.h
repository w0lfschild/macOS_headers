...
@class NEFilterControlExtensionProviderHostContext, NEFilterExtensionProviderHostContext, NEFilterProviderConfiguration, NSArray, NSExtension, NSObject<OS_dispatch_queue>, NSString, NSUUID, NSXPCInterface, NSXPCListenerEndpoint;
