...
@class CPLStatus, NSError, NSHashTable, NSManagedObjectID, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSProgress, NSString, NSURL, PHPerformChangesRequest, PHPersistentChangeToken, PHPhotoLibraryAppPrivateData, PLAssetsdClient, PLFileSystemVolume, PLLazyObject, PLPhotoAnalysisServiceClient, PLPhotoKitVariationCache, PLPhotoLibrary, PLPhotoLibraryBundle;
