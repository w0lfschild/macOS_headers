...
+ (id)mutableModelForFaceCrop:(id)arg1;
+ (id)creationRequestsForFaceCropsWithOriginatingFace:(id)arg1 resourceData:(id)arg2;
+ (id)creationRequestForFaceCropWithOriginatingFace:(id)arg1 resourceData:(id)arg2 personId:(long long)arg3 userConfirmedForPerson:(BOOL)arg4;
