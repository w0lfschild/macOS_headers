...
@class NSDictionary, RDFaceGroupsQuery;
...
- (id)_faceGroupsGroupedByFaceLocalIdentifier;
- (id)copyWithZone:(struct _NSZone *)arg1;
- (id)initForEmptyFaceGroupsWithOptions:(id)arg1;
- (id)initWithFaces:(id)arg1 fetchOptions:(id)arg2;
