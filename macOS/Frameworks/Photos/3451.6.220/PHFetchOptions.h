...
@interface PHFetchOptions : NSObject <NSCopying>
{
    ...
    BOOL _includeOnlyFacesInFaceGroups;
...
@property(nonatomic) BOOL includeOnlyFacesInFaceGroups; // @synthesize includeOnlyFacesInFaceGroups=_includeOnlyFacesInFaceGroups;
