...
struct QTFigTimeImageBufferQueueInternal {
    struct map<CMTime, ImageBufferContainer, std::__1::less<CMTime>, std::__1::allocator<std::__1::pair<const CMTime, ImageBufferContainer>>> _field1;
};

struct QTGraphicsDeviceOpenGLInfo {
    struct _CGLContextObject *_field1;
    struct _CGLPixelFormatObject *_field2;
    CDStruct_bc20ce20 _field3;
};
...
struct QTImageBufferQueueInternal {
    struct map<unsigned long long, ImageBufferContainer, std::__1::less<unsigned long long>, std::__1::allocator<std::__1::pair<const unsigned long long, ImageBufferContainer>>> _field1;
};

struct QTMoviePlaybackControllerInternal {
    id _field1;
    double _field2;
    double _field3;
    CDStruct_65de7ec3 _field4;
};

struct QTMovieVideoProviderQuartzComposerOnlyInternal {
    id _field1;
    id _field2;
};

struct QTPFixedQuad {
    struct FixedPoint _field1;
    struct FixedPoint _field2;
    struct FixedPoint _field3;
    struct FixedPoint _field4;
};

struct QTSurfaceRendererConfigInternal {
    unsigned int _field1;
    unsigned int _field2;
    int _field3;
    char _field4;
...
struct map<CMTime, ImageBufferContainer, std::__1::less<CMTime>, std::__1::allocator<std::__1::pair<const CMTime, ImageBufferContainer>>> {
    struct __tree<std::__1::__value_type<CMTime, ImageBufferContainer>, std::__1::__map_value_compare<CMTime, std::__1::__value_type<CMTime, ImageBufferContainer>, std::__1::less<CMTime>, true>, std::__1::allocator<std::__1::__value_type<CMTime, ImageBufferContainer>>> {
        struct __tree_node<std::__1::__value_type<CMTime, ImageBufferContainer>, void *> *_field1;
        struct __compressed_pair<std::__1::__tree_end_node<std::__1::__tree_node_base<void *>*>, std::__1::allocator<std::__1::__tree_node<std::__1::__value_type<CMTime, ImageBufferContainer>, void *>>> {
            struct __tree_end_node<std::__1::__tree_node_base<void *>*> _field1;
        } _field2;
        struct __compressed_pair<unsigned long, std::__1::__map_value_compare<CMTime, std::__1::__value_type<CMTime, ImageBufferContainer>, std::__1::less<CMTime>, true>> {
            unsigned long long _field1;
        } _field3;
    } _field1;
};

struct map<unsigned long long, ImageBufferContainer, std::__1::less<unsigned long long>, std::__1::allocator<std::__1::pair<const unsigned long long, ImageBufferContainer>>> {
    struct __tree<std::__1::__value_type<unsigned long long, ImageBufferContainer>, std::__1::__map_value_compare<unsigned long long, std::__1::__value_type<unsigned long long, ImageBufferContainer>, std::__1::less<unsigned long long>, true>, std::__1::allocator<std::__1::__value_type<unsigned long long, ImageBufferContainer>>> {
        struct __tree_node<std::__1::__value_type<unsigned long long, ImageBufferContainer>, void *> *_field1;
        struct __compressed_pair<std::__1::__tree_end_node<std::__1::__tree_node_base<void *>*>, std::__1::allocator<std::__1::__tree_node<std::__1::__value_type<unsigned long long, ImageBufferContainer>, void *>>> {
            struct __tree_end_node<std::__1::__tree_node_base<void *>*> _field1;
        } _field2;
        struct __compressed_pair<unsigned long, std::__1::__map_value_compare<unsigned long long, std::__1::__value_type<unsigned long long, ImageBufferContainer>, std::__1::less<unsigned long long>, true>> {
            unsigned long long _field1;
        } _field3;
    } _field1;
};
...
typedef struct {
    ...
    struct OpaqueCMBlockBuffer *_field2;
} CDStruct_a14ad952;
...
typedef struct {
    struct ComponentDescription _field1;
    unsigned int _field2;
    unsigned int _field3;
} CDStruct_4addb5b9;
