...
- (void)didGenerateThumbnailForRequestWithSequenceNumber:(long long)arg1 data:(id)arg2 bitmapFormat:(id)arg3 metadata:(id)arg4 contentRect:(struct CGRect)arg5 iconFlavor:(int)arg6 thumbnailType:(long long)arg7 clientShouldTakeOwnership:(BOOL)arg8;
...
- (void)_handleThumbnailGenerationCompletionWithSequenceNumber:(long long)arg1 data:(id)arg2 format:(id)arg3 metadata:(id)arg4 contentRect:(struct CGRect)arg5 iconFlavor:(int)arg6 thumbnailType:(long long)arg7 clientShouldTakeOwnership:(BOOL)arg8 error:(id)arg9;
...
- (BOOL)__requestWithSequenceNumberIsStillRunning:(unsigned long long)arg1;
