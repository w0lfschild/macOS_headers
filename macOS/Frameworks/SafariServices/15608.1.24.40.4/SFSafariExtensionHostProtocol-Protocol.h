...
- (void)getBaseURIWithCompletionHandler:(void (^)(NSURL *))arg1;
- (void)showPopoverFromToolbarItem:(SFSafariToolbarItem *)arg1;
...
- (void)getScreenshotOfVisibleAreaForPage:(SFSafariPage *)arg1 completionHandler:(void (^)(NSImage *))arg2;
