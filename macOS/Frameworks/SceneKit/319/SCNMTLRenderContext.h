...
#import "SCNBufferStream.h"

@class CAMetalLayer, MTLRenderPassDescriptor, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSString, SCNMTLRenderPipeline, SCNMTLResourceManager;
