...
@class NSMapTable, NSMutableSet, SCNMetalMesh, SCNMetalMeshElement, SCNMetalRenderPipeline, SCNMetalShadable;
...
struct SCNMTLRenderCommandEncoder {
    ...
    _Bool _blendColor___lockCullMode;
    _Bool _lockFillMode;
    CDStruct_deec94a8 _vertexBuffers[31];
    id _vertexTextures[128];
    id _vertexSamplers[16];
    CDStruct_deec94a8 _fragmentBuffers[31];
    id _fragmentTextures[128];
    id _fragmentSamplers[16];
    id _renderPipelineState;
    id _commandBuffer;
    id _encoder;
    struct SCNMTLBufferPool *_bufferPool;
    unsigned int _vertexTexturesToBind;
    unsigned int _fragmentTexturesToBind;
};
