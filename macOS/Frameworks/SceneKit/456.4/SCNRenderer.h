...
@class AVAudioEngine, AVAudioEnvironmentNode, NSArray, NSColor, NSLock, NSOpenGLContext, NSString, SCNAuthoringEnvironment, SCNMTLRenderContext, SCNNode, SCNRendererTransitionContext, SCNScene, SCNTechnique, SKScene, __SKSCNRenderer;
