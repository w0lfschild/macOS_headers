...
- (id)newRenderPipelineStateWithDesc:(CDStruct_2e1f3d1e)arg1;
- (void)_createPipelineStateWithDescriptor:(id)arg1 desc:(CDStruct_2e1f3d1e)arg2 pipeline:(id)arg3;
