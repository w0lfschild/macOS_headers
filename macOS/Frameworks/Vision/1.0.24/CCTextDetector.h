...
- (int)_generateCRCharBoxInformation:(id)arg1 inputImage:(struct vImage_Buffer)arg2 singleVotingImageAddressRef:(char *)arg3 bigBoxes:(struct __CCBigBox *)arg4 bigBoxesAdapt:(struct __CCBigBox *)arg5 textOut:(struct vImage_Buffer)arg6 adaptOut:(struct vImage_Buffer)arg7 lowHighRGB:(struct __rgbMinMaxFloat *)arg8 countBigBox:(unsigned char)arg9;
- (int)_generateCRCharBoxInformation_extendTextBoxes:(struct __CCBigBox *)arg1 countBigBox:(unsigned char)arg2 rowStartLocation2:(unsigned short)arg3 finalCharBoxCoordCount:(unsigned long long)arg4 finalCoordinatesForStubRevised:(struct __CCBox *)arg5 width:(unsigned long long)arg6;
...
- (int)_generateCRCharBoxInformation_zcFinalVectorOriginate:(struct vImage_Buffer)arg1 textOut:(struct vImage_Buffer)arg2 adaptOut:(struct vImage_Buffer)arg3 bigBoxes:(struct __CCBigBox *)arg4 bigBoxesAdapt:(struct __CCBigBox *)arg5 ccCharBoxesAggr:(struct __CCCharBox *)arg6 ccCharBoxesFiltered:(struct __CCCharBox *)arg7 height:(unsigned short)arg8 rowStartLocation2:(unsigned short)arg9 rowStopLocation2:(unsigned short)arg10 singleVotingImageAddressRef:(char *)arg11 countBigBox:(unsigned char)arg12 filterWalkUpDownCount:(unsigned short *)arg13;
- (int)extractBoxesForStub:(struct __CCBigBox *)arg1 bigBoxesAdapt:(struct __CCBigBox *)arg2 countBigBox:(unsigned char)arg3 rowStartLocation2:(unsigned short)arg4 rowStopLocation2:(unsigned short)arg5 heightConstraint:(unsigned char)arg6 imageWidth:(unsigned short)arg7 height:(unsigned short)arg8 ccCharBoxesAggr:(struct __CCCharBox *)arg9 ccCharBoxesFiltered:(struct __CCCharBox *)arg10;
...
- (int)_generateCRCharBoxInformation_spaceBoxRemovalMagicThresh:(struct vImage_Buffer)arg1 magicMinHeight:(float)arg2 magicMaxHeight:(float)arg3 rowStartLocation2:(unsigned short)arg4 magicThresh:(float *)arg5 magicThreshPrev:(float *)arg6;
...
- (void)_generateCRCharBoxInformation_spaceBoxRemovalTruthFilter:(float *)arg1 magicThresh:(float *)arg2 zcStartLeft:(unsigned short)arg3 zcStopRight:(unsigned short)arg4 isSpaceBoxAccepted:(char *)arg5 histCompliancePercent:(float *)arg6;
- (void)_generateCRCharBoxInformation_spaceBoxRemovalTightenBox:(struct vImage_Buffer)arg1 singleVotingImageAddressRef:(char *)arg2 adaptOut:(struct vImage_Buffer)arg3 textOut:(struct vImage_Buffer)arg4 zcStartLeft:(unsigned short)arg5 zcStopRight:(unsigned short)arg6 finalCoordinatesForStub:(struct __CCBox *)arg7 finalCoordinatesForStubRevised:(struct __CCBox *)arg8 finalCharBoxCoordCount:(unsigned long long *)arg9;
...
- (int)_generateBoxes:(id)arg1 pulseVector:(unsigned long long)arg2 uImage:(struct vImage_Buffer)arg3 countBigBoxOut:(unsigned long long *)arg4 bigBoxes:(struct __CCBigBox *)arg5 bigBoxesA:(struct __CCBigBox *)arg6;
- (int)_generateSmoothedImage:(struct vImage_Buffer)arg1 uImage:(struct vImage_Buffer)arg2;
- (int)_generateAdaptiveBinarization:(struct vImage_Buffer)arg1 adaptImage:(struct vImage_Buffer)arg2;
- (int)_generateAndApplyColorProfileForImage:(struct vImage_Buffer)arg1 votingImage:(struct vImage_Buffer)arg2 textOut:(struct vImage_Buffer)arg3 minMaxRGB:(struct __rgbMinMaxU8 *)arg4 lowHighRGB:(struct __rgbMinMaxFloat *)arg5 numCropRows:(unsigned short)arg6 rowStartLocation:(unsigned short)arg7 rowStopLocation:(unsigned short)arg8 sumTextOutFirstPass:(unsigned int *)arg9;
...
- (int)_generateVotingImage:(struct vImage_Buffer)arg1 votingImage:(struct vImage_Buffer)arg2;
