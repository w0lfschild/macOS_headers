...
+ (BOOL)computeLabelsAndConfidence:(struct ImageClassifierAbstract *)arg1 usingDescriptorBuffer:(struct ImageDescriptorBufferAbstract *)arg2 populateLabelsAndConfidence:(vector_dcc19312 *)arg3 options:(id)arg4 metalContext:(id)arg5 error:(id *)arg6;
