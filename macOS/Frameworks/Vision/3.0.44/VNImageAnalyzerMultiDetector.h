...
- (unsigned int)_analysisTypeForScene:(BOOL)arg1 junk:(BOOL)arg2 sceneprint:(BOOL)arg3 includingLabelsAndConfidences:(BOOL)arg4 compressedSceneprint:(BOOL)arg5 aesthetics:(BOOL)arg6 saliencyHeatMap:(BOOL)arg7;
