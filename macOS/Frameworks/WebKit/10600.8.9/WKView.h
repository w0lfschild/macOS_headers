...
@class NSColor, NSTrackingArea, NSWindow, WKBrowsingContextController, WKFullScreenWindowController, WKViewData, _WKThumbnailView;
...
- (void)_didPerformActionMenuHitTest:(const struct ActionMenuHitTestResult *)arg1 forImmediateAction:(BOOL)arg2 userData:(struct Object *)arg3;
...
@property(retain, nonatomic, setter=_setPrimaryTrackingArea:) NSTrackingArea *_primaryTrackingArea;
...
- (void)_setTextIndicator:(PassRefPtr_a4ca8695)arg1 fadeOut:(BOOL)arg2;
...
- (void)_interpretKeyEvent:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_collectKeyboardLayoutCommandsForEvent:(id)arg1 to:(Vector_869e4bea *)arg2;
...
- (id)_actionMenuItemsForHitTestResult:(struct OpaqueWKHitTestResult *)arg1 withType:(unsigned int)arg2 defaultActionMenuItems:(id)arg3;
