...
@class AVFunctionBarScrubber, NSColor, NSString, NSTouchBar, WKBrowsingContextController, WKViewData, _WKThumbnailView;
...
@property(readonly, nonatomic) AVFunctionBarScrubber *_mediaPlaybackControlsView;
