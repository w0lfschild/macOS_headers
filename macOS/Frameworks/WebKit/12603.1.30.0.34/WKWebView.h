...
@class AVFunctionBarScrubber, NSArray, NSColor, NSData, NSString, NSTouchBar, NSURL, WKBackForwardList, WKBrowsingContextHandle, WKWebViewConfiguration, _WKSessionState;
