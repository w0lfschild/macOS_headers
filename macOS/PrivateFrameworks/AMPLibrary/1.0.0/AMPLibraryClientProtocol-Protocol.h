...
- (void)sendDBChangesToLibrary:(NSDictionary *)arg1 withReply:(void (^)(NSError *))arg2;
...
- (void)openDomains:(unsigned long long)arg1 forClientID:(unsigned int)arg2 optionalParams:(NSDictionary *)arg3 withReply:(void (^)(NSError *, NSDictionary *))arg4;
