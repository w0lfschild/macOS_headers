...
@interface MMContactsService : MMService <MMServicePreflightProtocol>
{
}

- (BOOL)preflightForSignout:(id *)arg1 withWindow:(id)arg2;
- (long long)_showInProcessDisableConfirmationSheet:(id)arg1;
- (long long)_showDisableConfirmationSheet:(id)arg1;
