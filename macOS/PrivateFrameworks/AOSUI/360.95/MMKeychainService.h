...
@class MMAuthenticatingPasswordSheet, MMCSCRecoveryController, MMKeychainOptionsController, MMModalDialog, MMTermsOfServiceController, NSButton, NSImageView, NSLock, NSString, NSTextField, NSWindow;
...
- (void)_finishManuallyResetSheet:(id)arg1 shouldRestore:(BOOL)arg2;
...
- (void)_handleDidForgetSheet:(id)arg1 window:(id)arg2 shouldRegister:(BOOL)arg3 password:(id)arg4 firstDevice:(BOOL)arg5 alreadyPending:(BOOL)arg6;
- (void)_handleHardLimitReset:(id)arg1 shouldRegister:(BOOL)arg2 password:(id)arg3 didReset:(BOOL)arg4 modifiesCircle:(BOOL)arg5 firstDevice:(BOOL)arg6;
...
- (void)_handleRestoreSecureBackup:(id)arg1 registerCredentials:(BOOL)arg2 password:(id)arg3;
- (void)_handleSetupSecureBackup:(id)arg1 registerCredentials:(BOOL)arg2 password:(id)arg3 didReset:(BOOL)arg4 modifyCircle:(BOOL)arg5;
- (void)_finishRequestApproval:(id)arg1 secureBackupEnabled:(BOOL)arg2 alreadyPending:(BOOL)arg3 registerCredentials:(BOOL)arg4 password:(id)arg5;
- (void)_handleAlreadyPending:(id)arg1 secureBackupEnabled:(BOOL)arg2;
- (void)_handleReqestApproval:(id)arg1 secureBackupEnabled:(BOOL)arg2 registerCredentials:(BOOL)arg3 password:(id)arg4;
...
- (void)_completeEnable:(id)arg1 registerCredentials:(BOOL)arg2 usingPassword:(id)arg3;
