...
@class CPSConfigurationClient, MMLinkTextField, MMWebKitViewController, NSButton, NSByteCountFormatter, NSImageView, NSLayoutConstraint, NSMutableDictionary, NSProgress, NSProgressIndicator, NSString, NSTextField, NSWindow;
...
- (BOOL)_hasPhotoLibraryReferencedFiles;
- (id)_isExiting;
- (id)_rampedState;
...
- (void)showiCloudPhotoLibraryReferencedFilesSheet;
