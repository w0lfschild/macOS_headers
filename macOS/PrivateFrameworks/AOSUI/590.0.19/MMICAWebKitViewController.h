...
@class ADMChangePasswordController, CDPContext, CDPStateController, JSContext, JSValue, MMJSDialogController, MMKeychainCDP, MMWebKitController, NSDictionary, NSString, NSView, NSWindow, WebView;
