...
#import <AOSUI/MMCSCRecoveryControllerDelegate-Protocol.h>
...
@class MMAuthenticatingPasswordSheet, MMCSCRecoveryController, MMKeychainCDP, MMKeychainOptionsController, MMModalDialog, MMTermsOfServiceController, NSButton, NSImageView, NSLock, NSString, NSTextField, NSWindow, iCloudPrefPaneCDPEnrollViewController, iCloudPrefPaneCDPOption;
