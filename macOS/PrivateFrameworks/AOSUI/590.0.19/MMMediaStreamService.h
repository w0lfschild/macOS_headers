...
@class CPSConfigurationClient, MMLinkTextField, MMWebKitViewController, NSButton, NSImageView, NSLayoutConstraint, NSMutableDictionary, NSProgress, NSProgressIndicator, NSString, NSTextField, NSWindow;
...
- (_Bool)needsPassword;
- (void)enablePhotosteamWithCreating:(BOOL)arg1;
