...
@class CDPContext, CDPDevice, CDPRemoteDeviceSecretValidator, IASPickerViewController, MMPinFieldView, NSArray, NSButton, NSLayoutConstraint, NSMutableArray, NSNumber, NSProgressIndicator, NSSecureTextField, NSString, NSTextField, NSView, NSWindow;

@interface iCloudPrefPaneCDPEnrollViewController : NSViewController <MMPinFieldViewDelegate>
{
