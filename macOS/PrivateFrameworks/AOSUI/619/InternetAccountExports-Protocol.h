...
- (void)openPurchaseStorageWithQueryParams:(NSString *)arg1;
...
- (void)openPurchaseStorageWithQueryParams:(NSString *)arg1 __JS_EXPORT_AS__openPurchaseStorageWithQueryParams:(id)arg2;
