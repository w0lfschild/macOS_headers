...
@class ADMChangePasswordController, CDPContext, CDPStateController, CDPStateUIController, JSContext, JSValue, MMJSDialogController, MMWebKitController, NSDictionary, NSString, NSView, NSWindow, WebView, iCloudPurchaseStorageController;
