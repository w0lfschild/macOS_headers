...
- (int)startPreview;
- (void)dealloc;
- (id)initWithOptions:(void *)arg1 callback:(CDUnknownFunctionPointerType)arg2 width:(int)arg3 height:(int)arg4 frameRate:(int)arg5 camera:(id)arg6 withError:(int *)arg7;
