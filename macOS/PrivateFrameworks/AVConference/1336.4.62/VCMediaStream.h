...
@class AVCBasebandCongestionDetector, AVCStatisticsCollector, NSMutableArray, NSObject, NSString, VCDatagramChannelIDS, VCMediaStreamConfig, VCMediaStreamTransport, VCWeakObjectHolder;
