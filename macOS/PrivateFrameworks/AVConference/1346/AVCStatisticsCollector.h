...
- (void)addActualBitrateInfo:(CDStruct_e9907a6b *)arg1;
- (void)addPacketLossInfo:(CDStruct_e9907a6b *)arg1;
- (void)computeOWRDEstimation:(CDStruct_e9907a6b *)arg1;
- (void)computeBWEstimation:(CDStruct_e9907a6b *)arg1;
- (void)updateLocalEstimatedBandwidth;
- (void)recordRemoteEstimatedBandwidthForLargeFrameInfo:(CDStruct_e9907a6b *)arg1;
- (void)computeOtherStatistics:(CDStruct_e9907a6b *)arg1;
- (void)addStatisticsHistory:(CDStruct_e9907a6b)arg1;
- (void)addEntriesFromStatistics:(CDStruct_e9907a6b)arg1;
- (void)processVCStatistics:(CDStruct_e9907a6b)arg1;
- (CDStruct_e9907a6b)getVCStatisticsWithType:(int)arg1 time:(double)arg2;
- (void)setVCStatistics:(CDStruct_e9907a6b)arg1;
