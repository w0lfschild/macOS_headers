...
- (void)addMostBurstyLossInfo:(CDStruct_b3eb8f4a *)arg1;
- (void)addRoundTripTimeInfo:(CDStruct_b3eb8f4a *)arg1;
- (void)addAFRCActualBitrate:(CDStruct_b3eb8f4a *)arg1;
- (void)addActualBitrateInfo:(CDStruct_b3eb8f4a *)arg1;
- (void)addPacketLossInfo:(CDStruct_b3eb8f4a *)arg1;
- (void)computeOWRDEstimation:(CDStruct_b3eb8f4a *)arg1;
- (void)computeBWEstimation:(CDStruct_b3eb8f4a *)arg1;
- (void)updateLocalEstimatedBandwidth;
- (void)recordRemoteEstimatedBandwidthForLargeFrameInfo:(CDStruct_b3eb8f4a *)arg1;
- (void)updateMaxLocalBurstyLoss:(unsigned int)arg1;
- (void)updatePacketReceivedCount:(CDStruct_b3eb8f4a *)arg1;
- (void)computeOtherStatistics:(CDStruct_b3eb8f4a *)arg1;
- (void)addStatisticsHistory:(CDStruct_b3eb8f4a *)arg1;
- (void)addEntriesFromStatistics:(CDStruct_b3eb8f4a)arg1;
- (void)processVCStatisticsInternal:(CDStruct_b3eb8f4a)arg1;
- (CDStruct_b3eb8f4a)getVCStatisticsWithType:(int)arg1 time:(double)arg2;
- (void)drainAndProcessVCStatistics:(CDStruct_b3eb8f4a)arg1;
- (void)setVCStatistics:(CDStruct_b3eb8f4a)arg1;
