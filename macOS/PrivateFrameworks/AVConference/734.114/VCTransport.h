...
- (void)iceSetupSecondaryRelayForCallID:(unsigned int)arg1 callerRequired:(BOOL)arg2;
...
- (void)registerICEBlockForCallID:(unsigned int)arg1 connectedBlock:(CDUnknownBlockType)arg2 newCandidatesBlock:(CDUnknownBlockType)arg3 setupRelayBlock:(CDUnknownBlockType)arg4;
- (void)dealloc;
- (id)init;
