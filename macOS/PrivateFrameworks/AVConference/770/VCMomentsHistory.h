...
#import "VCMomentsHistoryBufferDelegate.h"

@class NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<VCMovieWriterProtocol>, NSString, VCMomentsHistoryBuffer, VideoAttributes;
