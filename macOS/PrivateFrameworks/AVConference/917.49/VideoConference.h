...
@class CameraConferenceSynchronizer, FFTMeter, GKNATObserver, NSArray, NSDictionary, NSMutableDictionary, NSString, VCAudioManager, VCAudioPowerLevelMonitor, VCCallSession, VCImageQueue, VCVideoRule, VideoConferenceManager;
