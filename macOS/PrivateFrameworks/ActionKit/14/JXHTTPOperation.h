...
@class NSArray, NSDate, NSDictionary, NSNumber, NSObject<JXHTTPOperationDelegate>, NSObject<JXHTTPRequestBody>, NSObject<OS_dispatch_queue>, NSString, NSURL, NSURLAuthenticationChallenge, NSURLCredential;
