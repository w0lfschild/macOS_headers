...
- (CDStruct_86e0e803 *)copyIntentionDictionary;
- (void)setPrefsIntentionDictionary:(CDStruct_86e0e803 *)arg1;
- (void)setIntentionDictionary:(CDStruct_86e0e803 *)arg1;
...
- (void)warpLUTlevelsWithGamma:(float)arg1 blackPoint:(int)arg2 blackPointLinear:(int)arg3 saturationPoint:(int)arg4 hue:(float)arg5 saturation:(float)arg6;
- (void)warpLUTwithGamma:(float)arg1 blackPoint:(float)arg2 blackPointLinear:(float)arg3 saturationPoint:(float)arg4 hue:(float)arg5 saturation:(float)arg6;
