...
- (void)setIntentionLegacyDictionary:(CDStruct_5a4619cb *)arg1;
- (int)getSystemGammaModeLegacy;
- (void)setSystemGammaMode:(int)arg1;
- (_Bool)getCompensationStateLegacy;
...
- (void)setOverridesFoundLegacy:(_Bool)arg1;
- (_Bool)animationMatrixPreemptive;
- (_Bool)animationMatrixCompleted;
- (_Bool)animationPreemptable;
- (_Bool)animationCompleted;
...
- (void)setNativeWhitePointLegacyAndAnimateWithDuration:(float)arg1 thawIntention:(_Bool)arg2;
- (void)setWhitePointXYZandAnimateLegacyToX:(float)arg1 Y:(float)arg2 Z:(float)arg3 duration:(float)arg4 thawIntention:(_Bool)arg5;
