...
@class AKActionController, AKAttributeController, AKCursorController_Mac, AKDFRController, AKFormFeatureDetectorController, AKIntelligentSketchController, AKMainEventHandler, AKModelController, AKPageController, AKSignatureModelController, AKTextEditorController, AKToolController, AKToolbarViewController, AKUndoController, NSMapTable, NSMutableArray, NSView, NSWindow;
...
- (void)setTouchBarCentersWithPrincipleItems:(BOOL)arg1;
- (id)akTouchBar;
- (BOOL)isInDFRAction;
