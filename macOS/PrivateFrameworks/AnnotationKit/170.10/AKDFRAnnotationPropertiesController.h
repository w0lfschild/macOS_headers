...
#import <AnnotationKit/NSFunctionRowColorPickerViewControllerDelegate-Protocol.h>
...
@interface AKDFRAnnotationPropertiesController : NSObject <NSTouchBarDelegate, NSFunctionRowColorPickerViewControllerDelegate>
{
