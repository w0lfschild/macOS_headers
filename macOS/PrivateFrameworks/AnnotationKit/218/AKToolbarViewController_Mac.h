...
@class AKLineStylesViewController_Mac, AKTextAttributesViewController, AKToolbarButtonItem_Mac, AKToolbarColorWellItem_Mac, AKToolbarHighlightControlItem_Mac, NSMenu, NSPopover, NSString, NSView, NSWindow;
...
@interface AKToolbarViewController_Mac : AKToolbarViewController <NSPopoverDelegate>
{
    ...
    AKToolbarButtonItem_Mac *_noteButton;
    AKToolbarColorWellItem_Mac *_strokeColorWell;
    AKToolbarColorWellItem_Mac *_fillColorWell;
    AKToolbarHighlightControlItem_Mac *_highlightControl;
...
@property(retain) NSView *highlightControl; // @synthesize highlightControl=_highlightControl;
@property(retain) NSView *noteButton; // @synthesize noteButton=_noteButton;
