...
@class ASAuthorizationProviderExtensionAuthorizationRequest, NSData, NSDate, NSObject<OS_dispatch_group>, NSString, NSUUID, SOKerberosExtensionData, SOKerberosRealmSettings, SONetworkIdentity, SORealmSettingManager, SOSiteCode;
