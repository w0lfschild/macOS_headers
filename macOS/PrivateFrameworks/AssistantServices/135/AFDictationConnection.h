...
@class AFAudioPowerUpdater, AFSpeechRequestOptions, NSArray, NSMutableData, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSSet, NSString, NSXPCConnection;
