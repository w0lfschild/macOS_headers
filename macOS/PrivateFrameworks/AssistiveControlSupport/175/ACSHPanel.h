...
@interface ACSHPanel : ACSHPanelElement
{
    ...
    unsigned long long _transientScreenPosition;
...
@property(nonatomic) unsigned long long transientScreenPosition; // @synthesize transientScreenPosition=_transientScreenPosition;
