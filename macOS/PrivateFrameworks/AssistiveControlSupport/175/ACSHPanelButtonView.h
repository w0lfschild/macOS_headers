...
+ (void)initialize;
@property(retain) NSString *_accessibilityTitle; // @synthesize _accessibilityTitle=__accessibilityTitle;
...
@property(readonly, nonatomic) __weak ACSHPanelButton *button; // @synthesize button=_button;
- (void).cxx_destruct;
