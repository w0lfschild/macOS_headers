...
+ (unsigned long long)functionMappedMacKeyCodeMacKeyCode:(unsigned long long)arg1 modifiers:(unsigned int)arg2;
+ (unsigned long long)relevantAndAdjustedModifiersFromModifiers:(unsigned long long)arg1;
+ (unsigned long long)adjustedModifiersForModifiers:(unsigned long long)arg1;
