...
@property(readonly, nonatomic) ACSHPanelElement *panelElement; // @synthesize panelElement=_panelElement;
...
- (void)updateSelectionIfNeededForDwellAction:(long long)arg1;
