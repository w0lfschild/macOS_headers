...
#import "aura_BooleanControlPriv.h"

@class NSString;

__attribute__((visibility("hidden")))
@interface aura_BooleanControlPrivImpl : NSObject <aura_BooleanControlPriv>
{
    shared_ptr_d7117daa reactor_;
}

+ (id)controlWithReactor:(shared_ptr_d7117daa)arg1;
- (id).cxx_construct;
- (void).cxx_destruct;
...
- (id)initWithReactor:(shared_ptr_d7117daa)arg1;
