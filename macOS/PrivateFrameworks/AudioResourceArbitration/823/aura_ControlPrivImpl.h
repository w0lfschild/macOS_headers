...
#import "aura_ControlPriv.h"

@class NSString;

__attribute__((visibility("hidden")))
@interface aura_ControlPrivImpl : NSObject <aura_ControlPriv>
{
    shared_ptr_e543a3dd reactor_;
}

+ (id)controlWithReactor:(shared_ptr_e543a3dd)arg1;
- (id).cxx_construct;
- (void).cxx_destruct;
...
- (id)initWithReactor:(shared_ptr_e543a3dd)arg1;
