...
#import "aura_SliderControlPriv.h"

@class NSString;

__attribute__((visibility("hidden")))
@interface aura_SliderControlPrivImpl : NSObject <aura_SliderControlPriv>
{
    shared_ptr_7305d1ef reactor_;
}

+ (id)controlWithReactor:(shared_ptr_7305d1ef)arg1;
- (id).cxx_construct;
- (void).cxx_destruct;
...
- (id)initWithReactor:(shared_ptr_7305d1ef)arg1;
