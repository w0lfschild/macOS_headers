...
@class AKTouchBarController, NSButton, NSImage, NSImageCell, NSLayoutConstraint, NSProgressIndicator, NSString, NSTextField, NSTouchBar, NSView;
...
@interface AKSignInPromptController : NSViewController <NSTouchBarProvider>
{
    ...
    NSLayoutConstraint *_standardAuthenticationUsernameFieldBottom;
...
@property(retain) NSLayoutConstraint *standardAuthenticationUsernameFieldBottom; // @synthesize standardAuthenticationUsernameFieldBottom=_standardAuthenticationUsernameFieldBottom;
