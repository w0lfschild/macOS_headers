...
@interface MetalFAST9BRIEF : NSObject
{
    ...
    id <MTLComputePipelineState> _response4PipelineState;
    id <MTLComputePipelineState> _suppress4PipelineState;
    id <MTLComputePipelineState> _compute4HistogramPipelineState;
    id <MTLFunction> _responseMapKernel;
    id <MTLFunction> _suppressMapKernel;
    id <MTLFunction> _computeHistogramKernel;
    id <MTLComputePipelineState> _responsePipelineState;
    id <MTLComputePipelineState> _suppressPipelineState;
    id <MTLComputePipelineState> _computeHistogramPipelineState;
    ...
    id <MTLComputePipelineState> _gaussianishBlurPipelineState;
