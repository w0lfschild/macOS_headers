...
@class BU_ButtonPart, BU_DPRemoteDesktopPicture, BU_TBUStarfieldShadowLayer, BU_TValidatingDateFormatter, CABackdropLayer, CALayer, NSArray, NSDate, NSDateComponents, NSTimer;
...
struct TNSRef<BU_ButtonPart *> {
    BU_ButtonPart *fRef;
};

struct TNSRef<BU_DPRemoteDesktopPicture *> {
...
struct TTimelineControl {
    ...
    struct TNSRef<NSTimer *> _field34;
