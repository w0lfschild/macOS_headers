...
#import <BiometricSupport/NSObject-Protocol.h>
...
- (void)getFlowMode:(unsigned long long)arg1 replyBlock:(void (^)(long long))arg2;
...
- (void)getBioLockoutStateForUser:(unsigned int)arg1 client:(unsigned long long)arg2 replyBlock:(void (^)(long long))arg3;
