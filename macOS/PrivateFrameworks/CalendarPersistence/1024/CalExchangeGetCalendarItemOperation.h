...
- (BOOL)createOrUpdateItems:(id)arg1 inCalendar:(id)arg2 inContext:(id)arg3 error:(id *)arg4;
- (id)responseShape;
- (id)_correctStartDateForItem:(id)arg1 date:(id)arg2 calendarInEventTimeZone:(id)arg3 calendarInGMT:(id)arg4;
- (BOOL)_updateEvent:(id)arg1 inCalendar:(id)arg2 withCalendarItem:(id)arg3 occurrences:(id)arg4 masterCalendarItem:(id)arg5 inContext:(id)arg6 error:(id *)arg7;
