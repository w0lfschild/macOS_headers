...
+ (BOOL)_handleDuplicateAccounts:(id)arg1 forInsertedAccount:(id)arg2 existingAccounts:(id)arg3 context:(id)arg4 path:(id)arg5;
...
+ (void)processAccountsMarkedForDeletion;
