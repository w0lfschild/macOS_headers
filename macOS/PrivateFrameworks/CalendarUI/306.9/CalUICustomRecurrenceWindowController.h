...
@class CalUIPopupWindowState, EKCalendarItem, NSButton, NSMatrix, NSMutableArray, NSPopUpButton, NSTabView, NSTextField, NSView, NSWindow;
...
+ (id)sharedInstance;
@property(retain) NSMutableArray *weekDaysNames; // @synthesize weekDaysNames=_weekDaysNames;
@property int currentWkStart; // @synthesize currentWkStart=_currentWkStart;
...
@property __weak NSMatrix *yearlyMonthMatrix; // @synthesize yearlyMonthMatrix=_yearlyMonthMatrix;
...
@property __weak NSMatrix *monthlyDayMatrix; // @synthesize monthlyDayMatrix=_monthlyDayMatrix;
@property __weak NSMatrix *monthlyRuleMatrix; // @synthesize monthlyRuleMatrix=_monthlyRuleMatrix;
@property __weak NSTextField *monthlyRecurrenceInterval; // @synthesize monthlyRecurrenceInterval=_monthlyRecurrenceInterval;
@property __weak NSMatrix *weeklyDaySelectionMatrix; // @synthesize weeklyDaySelectionMatrix=_weeklyDaySelectionMatrix;
