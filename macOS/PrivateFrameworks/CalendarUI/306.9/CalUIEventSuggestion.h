...
#import <CalendarUI/NSCopying-Protocol.h>

@class EKCalendar, EKEvent, EKStructuredLocation, NSArray, NSDate, NSString, NSTimeZone, NSURL;
...
@property int availability; // @synthesize availability=_availability;
