...
@class CalDefaultDictionary, EKEventViewController, EKUIGadget, EKUIGadgetContainerDividerView, EKUIGadgetContainerView, NSArray, NSDictionary, NSMutableDictionary, NSMutableOrderedSet, NSString;
...
- (void).cxx_destruct;
- (void)drawContainerInBounds:(struct CGRect)arg1 dirtyRect:(struct CGRect)arg2;
