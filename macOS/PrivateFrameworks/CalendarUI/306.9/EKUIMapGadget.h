...
#import <CalendarUI/MKMapViewDelegate-Protocol.h>

@class CLLocation, CalUIFontSmoothedTextField, EKUIMapView, EKUIWeatherBox, NSDateComponents, NSDictionary, NSImageView, NSString;
...
@property(retain) CalUIFontSmoothedTextField *cityNameField; // @synthesize cityNameField=_cityNameField;
@property(retain) CalUIFontSmoothedTextField *temperatureField; // @synthesize temperatureField=_temperatureField;
