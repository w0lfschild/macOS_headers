...
#import <CalendarUI/AutocompleteResultWindowDelegate-Protocol.h>
...
@interface CalUISuggestionsField : CalUIResizingTextField <NSCandidateListTouchBarItemDelegate, NSWindowDelegate, AutocompleteResultWindowDelegate>
{
