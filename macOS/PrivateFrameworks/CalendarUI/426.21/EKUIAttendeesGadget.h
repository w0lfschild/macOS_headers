...
@class CalAutoCompleteOperation, CalUISuggestionsField, EKUIAttendeesControlContainer, EKUIEditingField, EKUIPlusButton, EKUITextButton, EKUITokenField, NSDictionary, NSLayoutConstraint, NSMutableDictionary, NSMutableSet, NSProgressIndicator, NSStackView, NSString, NSView;
