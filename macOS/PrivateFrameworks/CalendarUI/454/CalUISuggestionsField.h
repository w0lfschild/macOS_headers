...
@class CNAutocompleteResultWindowBase, CalUICandidateTouchBar, NSArray, NSLayoutConstraint, NSScrollView, NSString, NSTimer;
...
@interface CalUISuggestionsField : CalUIResizingTextField <NSWindowDelegate, CNAutocompleteResultWindowDelegate, NSCandidateListTouchBarItemDelegate>
{
    ...
    NSArray *_pendingSuggestions;
    NSTimer *_suggestionUpdateThrottle;
...
@property(retain) NSTimer *suggestionUpdateThrottle; // @synthesize suggestionUpdateThrottle=_suggestionUpdateThrottle;
@property(retain) NSArray *pendingSuggestions; // @synthesize pendingSuggestions=_pendingSuggestions;
...
- (void)updateWithPendingSuggestions;
