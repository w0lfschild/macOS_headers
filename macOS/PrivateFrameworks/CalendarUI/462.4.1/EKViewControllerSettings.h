...
@property BOOL hideButtons; // @synthesize hideButtons=_hideButtons;
@property BOOL showLinksAsText; // @synthesize showLinksAsText=_showLinksAsText;
@property BOOL miniInspector; // @synthesize miniInspector=_miniInspector;
