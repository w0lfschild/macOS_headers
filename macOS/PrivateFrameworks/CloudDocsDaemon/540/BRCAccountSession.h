...
- (BOOL)dumpDatabaseToFileHandle:(id)arg1 zoneName:(id)arg2 includeItems:(BOOL)arg3 tracker:(id)arg4 error:(id *)arg5;
...
- (BOOL)_dumpClientZone:(id)arg1 toContext:(id)arg2 includeItems:(BOOL)arg3 error:(id *)arg4;
