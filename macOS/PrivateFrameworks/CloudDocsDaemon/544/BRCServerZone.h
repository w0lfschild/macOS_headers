...
- (BOOL)_savePendingChangesSharesIgnoringRecordIDs:(id)arg1;
- (BOOL)_savePendingChangesDeletedRecordIDsIgnoringRecordIDs:(id)arg1;
- (BOOL)_savePendingChangesEditedContentRecordsIgnoringRecordIDs:(id)arg1;
- (BOOL)_savePendingChangesEditedStructureRecordsIgnoringRecordIDs:(id)arg1;
