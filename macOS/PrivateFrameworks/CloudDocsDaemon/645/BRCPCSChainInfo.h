...
@property(readonly, nonatomic) BOOL aliasTargetZoneIsShared; // @synthesize aliasTargetZoneIsShared=_aliasTargetZoneIsShared;
...
- (id)initWithItemID:(id)arg1 parentID:(id)arg2 structuralCKInfo:(id)arg3 contentCKInfo:(id)arg4 itemType:(BOOL)arg5 chainState:(unsigned int)arg6 aliasTargetZoneIsShared:(BOOL)arg7;
