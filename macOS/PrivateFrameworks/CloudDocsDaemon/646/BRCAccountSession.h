...
- (BOOL)_fetchDesktopAndDocumentIfNecessaryWithError:(id *)arg1;
- (void)__fetchContentsOfDocsOrDesktopItemID:(id)arg1 appLibrary:(id)arg2 completion:(CDUnknownBlockType)arg3;
