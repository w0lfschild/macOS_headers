...
@interface BRCApplyScheduler : BRCFSSchedulerBase <BRCModule, BRCSuspendable>
{
    ...
    NSMutableSet *_appLibrariesWatchingFaults;
...
- (void)didSyncDownZone:(id)arg1 requestID:(unsigned long long)arg2 upToRank:(long long)arg3 caughtUpWithServer:(BOOL)arg4 fullSync:(BOOL)arg5;
- (unsigned long long)_addRanksUpToRank:(long long)arg1 inZone:(id)arg2;
- (void)deleteExpiredJobs;
- (void)endWriteCoordinationInAppLibrary:(id)arg1 itemID:(id)arg2 clientZone:(id)arg3;
- (BOOL)startWriteCoordinationInAppLibrary:(id)arg1;
- (unsigned long long)_writeCoordinationCount;
- (void)stopMonitoringFaultingForAppLibrary:(id)arg1;
- (void)monitorFaultingForAppLibrary:(id)arg1;
