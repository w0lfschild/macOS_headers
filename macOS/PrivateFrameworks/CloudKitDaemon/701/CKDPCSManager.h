...
+ (void)setKeyRegistrySyncGroup:(id)arg1;
+ (id)keyRegistrySyncGroup;
+ (void)setLastKeyRegistrySyncError:(id)arg1;
+ (id)lastKeyRegistrySyncError;
+ (void)setLastKeyRegistrySyncSuccess:(BOOL)arg1;
+ (BOOL)lastKeyRegistrySyncSuccess;
...
- (void).cxx_destruct;
- (BOOL)_identitySetIsEmpty:(struct _PCSIdentitySetData *)arg1;
