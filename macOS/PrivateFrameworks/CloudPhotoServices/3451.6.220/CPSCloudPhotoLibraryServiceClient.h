...
@class NSMutableDictionary, NSString, PFDispatchQueue;
...
@interface CPSCloudPhotoLibraryServiceClient : ICPServiceClient <CPSCloudPhotoLibraryServiceClient>
{
    ...
    NSMutableDictionary *_taskIdentifierToCompletionHandlerDictionary;
}

@property(readonly) NSMutableDictionary *taskIdentifierToCompletionHandlerDictionary; // @synthesize taskIdentifierToCompletionHandlerDictionary=_taskIdentifierToCompletionHandlerDictionary;
@property(readonly) PFDispatchQueue *serialQueue; // @synthesize serialQueue=_serialQueue;
...
- (void).cxx_destruct;
- (id)observerProtocol;
- (void)inMemoryDownloadDidCompleteForTaskIdentifier:(id)arg1 data:(id)arg2 error:(id)arg3;
...
- (void)overrideSystemBudgetsForSyncSession:(BOOL)arg1;
