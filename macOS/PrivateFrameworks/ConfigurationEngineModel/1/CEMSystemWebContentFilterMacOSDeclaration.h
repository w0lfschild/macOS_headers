...
@property(readonly, nonatomic) NSArray *payloadFilterBlackList;
@property(readonly, nonatomic) NSArray *payloadFilterWhiteList;
@property(readonly, nonatomic) NSArray *payloadSiteWhiteList;
@property(readonly, nonatomic) NSNumber *payloadWhiteListEnabled;
@property(readonly, nonatomic) NSNumber *payloadUseContentFilter;
@property(readonly, nonatomic) NSNumber *payloadRestrictWeb;
