...
@class CNCDDatabasePreparationResult, CNPersistentStoreBuilderEnvironment, CNPersistentStoreDescription, NSDictionary, NSError, NSPersistentStore, NSPersistentStoreCoordinator, NSString, NSURL;
...
@property(copy) CNCDDatabasePreparationResult *preparationResult; // @synthesize preparationResult=_preparationResult;
