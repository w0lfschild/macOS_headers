...
- (id)postJSON:(id)arg1 toURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (id)fetchRecordsWithItemType:(Class)arg1 filter:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
