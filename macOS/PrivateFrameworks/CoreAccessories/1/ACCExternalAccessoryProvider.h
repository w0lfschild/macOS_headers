...
#import <CoreAccessories/ACCExternalAccessoryXPCClientProtocol-Protocol.h>
...
- (void)createExternalAccessorySessionForProtocol:(id)arg1 accessoryUUID:(id)arg2 withReply:(CDUnknownBlockType)arg3;
...
- (id)_removeAccessoryForPrimaryUUID:(id)arg1;
