...
@class CALayer, CCVegaAccessibilityHelper, CCVegaRenderer, JSContext, NSArray, NSDictionary, NSMutableDictionary, NSString;
...
@property _Bool isActive; // @synthesize isActive;
...
- (void)dispatchRender:(id)arg1 dirtyAll:(_Bool)arg2;
- (void)render:(id)arg1;
...
@property _Bool updateFromBackground;
