...
- (int)_removeControllerKeyPairForKeyType:(id)arg1 viewHint:(id)arg2 identifier:(id)arg3 leaveTombstone:(BOOL)arg4;
...
- (int)_removeControllerKeyPairForKeyType:(id)arg1 viewHint:(id)arg2 leaveTombstone:(BOOL)arg3;
- (int)_removeControllerKeyPairLeaveTombstone:(BOOL)arg1;
...
- (int)_saveKeyPair:(id)arg1 username:(id)arg2 syncable:(BOOL)arg3 keyType:(id)arg4 viewHint:(id)arg5;
...
- (id)_getControllerKeychainItemForKeyType:(id)arg1 viewHint:(id)arg2 error:(int *)arg3;
