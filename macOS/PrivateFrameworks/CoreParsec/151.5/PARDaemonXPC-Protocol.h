...
@class NSDate, NSString, PARRequest, PARSessionConfiguration, SFFeedback;
...
- (void)reportEvent:(NSString *)arg1 queryId:(unsigned long long)arg2 feedback:(SFFeedback *)arg3;
