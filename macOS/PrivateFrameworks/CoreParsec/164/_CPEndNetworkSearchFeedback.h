...
@interface _CPEndNetworkSearchFeedback : PBCodable <_CPProcessableFeedback, _CPFeedbackUUID, _CPEndNetworkSearchFeedback, NSSecureCoding>
{
    ...
    _CPStruct *_networkStatistics;
    NSString *_uuid;
    NSString *_parsecStatus;
    NSString *_fbq;
    double _duration;
    NSString *_partialClientIp;
    NSDictionary *_timingEvents;
}

@property(copy, nonatomic) NSDictionary *timingEvents; // @synthesize timingEvents=_timingEvents;
...
@property(retain, nonatomic) _CPStruct *networkStatistics; // @synthesize networkStatistics=_networkStatistics;
...
- (void)setTimingEvents:(id)arg1 forKey:(int)arg2;
...
- (void)_formatNetworkTimingData:(id)arg1;
