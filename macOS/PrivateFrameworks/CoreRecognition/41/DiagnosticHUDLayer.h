...
@class AVCaptureVideoPreviewLayer, CAShapeLayer, NSColor, NSMutableArray;

@interface DiagnosticHUDLayer : CALayer
{
    AVCaptureVideoPreviewLayer *_previewLayer;
    NSColor *_freshPointColor;
    NSColor *_stalePointColor;
...
@property(retain) NSColor *stalePointColor; // @synthesize stalePointColor=_stalePointColor;
@property(retain) NSColor *freshPointColor; // @synthesize freshPointColor=_freshPointColor;
