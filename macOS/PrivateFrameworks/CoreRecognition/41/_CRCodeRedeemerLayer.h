...
@protocol CRCodeRedeemerLayerDebuggingDelegate, CRCodeRedeemerLayerDelegate><CRCodeRedeemerLayerDelegatePrivate, OS_dispatch_queue;

@interface _CRCodeRedeemerLayer : CRCodeRedeemerLayer <AVCaptureVideoDataOutputSampleBufferDelegate>
{
    ...
    id <CRCodeRedeemerLayerDelegate><CRCodeRedeemerLayerDelegatePrivate> _delegate;
