...
@class CRAlignmentLayer, CRBoxLayer, CRCaptureSessionManager, DiagnosticHUDLayer, NSArray, NSCache, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject, NSPointerArray, NSString, NSTimer;
...
+ (id)extractCardImage:(struct vImage_Buffer *)arg1 andCIImage:(id *)arg2 fromPixelBuffer:(struct __CVBuffer *)arg3 withCardBuffer:(struct __CVBuffer *)arg4 withPoints:(id)arg5 pixelFocalLength:(id)arg6 isPortrait:(BOOL)arg7;
+ (BOOL)isTestMode;
...
- (id)findCCExpDateInImageEmbossed:(struct vImage_Buffer)arg1;
- (id)findCCNameInImageEmbossed:(struct vImage_Buffer)arg1;
- (id)findCCNumberInImageEmbossed:(struct vImage_Buffer)arg1;
- (id)findCCResultsInImageFlat:(struct vImage_Buffer)arg1 usingTextFeatures:(id)arg2 invert:(BOOL)arg3;
- (id)findCCObjectsEmbossed:(id)arg1 inImage:(struct vImage_Buffer)arg2 numberRects:(id)arg3 nameRects:(id)arg4 dateRects:(id)arg5;
- (id)findObjectsFlat:(id)arg1 inImage:(struct vImage_Buffer)arg2 numberRects:(id)arg3 invert:(BOOL)arg4;
- (id)findCCObjectEmbossed:(id)arg1 inImage:(struct vImage_Buffer)arg2 forRect:(id)arg3;
- (id)findObjectsEmbossed:(id)arg1 inImage:(struct vImage_Buffer)arg2;
