...
@class APSConnection, CKContainer, CKDatabase, NSError, NSMutableArray, NSObject<OS_dispatch_queue>, NSOperation, NSOperationQueue, NSString, SGFuture, _PASKVOHandler, _SGDCloudKitSyncPersistedState;
