...
@property(retain, nonatomic) NSString *featuresModelId; // @synthesize featuresModelId=_featuresModelId;
@property(retain, nonatomic) NSString *featuresVersion; // @synthesize featuresVersion=_featuresVersion;
