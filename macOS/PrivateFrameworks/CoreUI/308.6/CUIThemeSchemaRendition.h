...
- (BOOL)_initializeDisclosureTriangle:(const struct CUIDescriptor *)arg1;
- (BOOL)_initializeNavBannerBackground:(const struct CUIDescriptor *)arg1;
...
- (BOOL)_initializeProgressBarTrackOutline:(const struct CUIDescriptor *)arg1;
...
- (BOOL)_initializeControlTransitionAnimation:(const struct CUIDescriptor *)arg1;
- (BOOL)_initializePopUpSubpart:(const struct CUIDescriptor *)arg1;
