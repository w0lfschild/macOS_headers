...
@class CBScalablePipe, CBScalablePipeManager, CUReadRequest, CUWriteRequest, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, NSUUID;
