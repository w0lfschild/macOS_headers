...
@class CBCentralManager, CBPeripheralManager, CUSystemMonitor, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString;
