...
@class CWInterface, CWNetwork, NSButton, NSError, NSImageView, NSPopUpButton, NSProgressIndicator, NSScrollView, NSSecureTextField, NSString, NSTextField, NSView, SFCertificateView;
