...
@class CWInterface, CWNetwork, CWProxyClient, NSButton, NSError, NSImageView, NSPopUpButton, NSProgressIndicator, NSScrollView, NSSecureTextField, NSString, NSTextField, NSView, SFCertificateView;
