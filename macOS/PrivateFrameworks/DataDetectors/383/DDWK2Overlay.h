...
- (id)actionContextForResultAtPoint:(struct WKPoint)arg1 rangeHandle:(const struct OpaqueWKBundleRangeHandle **)arg2;
- (id)hitView;
...
- (void)_addMultiViewForObject:(id)arg1 withArrow:(BOOL)arg2 availableViews:(id)arg3 dark:(BOOL)arg4;
- (void)_setTrackingAreaForBasicHighlight:(id)arg1 entering:(BOOL)arg2 ignoreCleanup:(BOOL)arg3;
- (void)recomputeLayout;
- (BOOL)contentBackgroundIsDark;
- (void)hideHighlights;
