...
@interface DirectoryEditorViewController : NSObject <ODQueryDelegate>
{
    ...
    XSLoginPanelController *_loginPanelController;
...
@property(retain) SFAuthorization *authForLocalNode; // @synthesize authForLocalNode=_authForLocalNode;
@property(retain) ODSession *odSession; // @synthesize odSession=_odSession;
...
@property(retain) NSString *currentRecordType; // @synthesize currentRecordType;
...
- (void)threadedCreateODSession:(id)arg1 userName:(id)arg2 password:(id)arg3 loginPanelController:(id)arg4;
- (void)closeLoginSheet:(id)arg1;
