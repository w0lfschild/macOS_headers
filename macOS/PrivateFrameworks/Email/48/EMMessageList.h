...
@class EFLazyCache, EMCollectionItemIDStateCapturer, EMMailboxScope, EMMessageRepository, EMObjectID, EMThreadScope, NSMapTable, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSSet, NSString;
