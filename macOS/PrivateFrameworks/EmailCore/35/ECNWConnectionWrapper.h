...
@class NSArray, NSConditionLock, NSData, NSError, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSObject<OS_nw_connection>, NSObject<OS_nw_endpoint>, NSObject<OS_nw_error>, NSString;
