...
#import "EDMailboxPredictionQueryAdapter.h"
#import "EFLoggable.h"

@class EDConversationPersistence, EDMailboxPersistence, EDPersistenceDatabase, EDVIPManager, EMBlockedSenderManager, NSNumber, NSObject<OS_dispatch_queue>, NSString;
