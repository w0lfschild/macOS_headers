...
@class EDFetchController, EDMailboxPersistence, EDMailboxPredictionController, EDMessageChangeManager, EDMessagePersistence, EDPersistenceHookRegistry, EDThreadPersistence, NSConditionLock, NSHashTable, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString;
