...
@class CSSearchableIndex, EFCancelationToken, EFLazyCache, EFObservable, NSArray, NSMutableArray, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSObject<OS_os_activity>, NSString, _EMSearchableIndexPendingRemovals;
