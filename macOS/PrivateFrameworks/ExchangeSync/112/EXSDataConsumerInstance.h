...
#import <ExchangeSync/EXSDataConsumerDelegate-Protocol.h>

@class EXSAccount, EXSDataConsumerPlugin, EXSDataManager, NSString;
@protocol EXSDataConsumer, EXSDataConsumerInstanceDelegate, OS_dispatch_queue, OS_os_log;
