...
- (void)startOperation:(id <FPOperationClient>)arg1 toFetchParentForItem:(FPItemID *)arg2 recursively:(BOOL)arg3 reply:(void (^)(NSArray *, NSError *))arg4;
...
- (void)startOperation:(id <FPOperationClient>)arg1 toReparentItems:(NSArray *)arg2 underParent:(FPItemID *)arg3 shouldBounce:(BOOL)arg4 reply:(void (^)(NSDictionary *, NSError *))arg5;
