...
@class FPItemID, NSArray, NSFileHandle, NSFileProviderDomain, NSString, NSURL;
...
- (void)setAlternateContentsURL:(NSURL *)arg1 onDocumentURL:(NSURL *)arg2 completionHandler:(void (^)(NSError *))arg3;
...
- (void)fetchSupportedMessageInterfacesForItemID:(FPItemID *)arg1 completionHandler:(void (^)(NSArray *, NSError *))arg2;
- (void)fetchSupportedMessageInterfacesForDocumentAtURL:(NSURL *)arg1 completionHandler:(void (^)(NSArray *, NSError *))arg2;
...
- (void)fetchRemoteMessageInterfaceProviderWithIdentifier:(NSString *)arg1 handler:(void (^)(id <FPDRemoteMessageInterfaceProvider>, NSError *))arg2;
