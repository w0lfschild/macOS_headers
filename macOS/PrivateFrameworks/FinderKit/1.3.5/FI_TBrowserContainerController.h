...
#import <FinderKit/TValidatorClientProtocol-Protocol.h>

@class FI_TBottomBarController, FI_TBrowserViewController, FI_TDrawRectView, FI_TNodeViewSettings, FI_TSearchSliceController, FI_TSidebarSplitterController, FI_TSplitView, NSString, NSView, NSViewController, TAirDropInfoViewController, TAirDropNotAvailableViewController, TBackupContainerDelegate;
...
@interface FI_TBrowserContainerController : NSResponder <TNodeObserverProtocol, NSSplitViewDelegate, TValidatorClientProtocol>
{
    ...
    struct TNSRef<FI_TSplitView *> _browserSplitView;
    struct TNSRef<FI_TDrawRectView *> _tagsBackgroundView;
    struct TNSRef<FI_TTagColumnTableViewController *> _tagColumnTableViewController;
    double _lastTagsColumnWidth;
    struct TNSRef<FI_TBrowserBackgroundView *> _browserBackgroundView;
...
@property(readonly, retain) FI_TBrowserViewController *browserViewController; // @synthesize browserViewController=_browserViewController;
...
@property(readonly, retain, nonatomic) FI_TDrawRectView *browserBackgroundView; // @dynamic browserBackgroundView;
