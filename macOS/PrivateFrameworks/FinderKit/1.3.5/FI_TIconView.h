...
@class FI_TIconViewController, FI_TShrinkToFitController, NSString;
...
@property(retain, nonatomic) FI_TIconViewController *controller; // @synthesize controller=_controller;
- (id).cxx_construct;
- (void).cxx_destruct;
