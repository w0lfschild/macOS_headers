...
@class FI_TListViewController, FI_TTableViewShrinkToFitController;
...
@interface FI_TListView : NSOutlineView
{
    ...
    struct TNSRef<FI_TLayer *> _headerDropShadowLayer;
...
- (struct CGRect)frameForDropShadow;
...
- (_Bool)_shouldAutoExpandItem:(id)arg1;
