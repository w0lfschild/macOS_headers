...
@interface FI_TTaggingSuggestionsViewController : FI_TTableViewController
{
    ...
    struct TNSRef<NSImage *> _topClipViewMaskImage;
    struct TNSRef<NSImage *> _bottomClipViewMaskImage;
    struct TNSRef<NSImage *> _topAndBottomClipViewMaskImage;
...
@property _Bool drawsRoundedSelection; // @synthesize drawsRoundedSelection=_drawsRoundedSelection;
- (id).cxx_construct;
- (void).cxx_destruct;
