...
@interface NSArray (FI_NSArrayAdditions)
+ (id)FINodesFromFENodeVector_FI:(const struct TFENodeVector *)arg1;
...
- (struct CGRect)rectAtIndex_FI:(unsigned long long)arg1 defaultValue:(const struct CGRect *)arg2;
- (struct CGRect)rectAtIndex_FI:(unsigned long long)arg1;
- (struct CGPoint)pointAtIndex_FI:(unsigned long long)arg1 defaultValue:(const struct CGPoint *)arg2;
- (struct CGPoint)pointAtIndex_FI:(unsigned long long)arg1;
- (unsigned int)fourCharCodeAtIndex_FI:(unsigned long long)arg1 defaultValue:(unsigned int)arg2;
- (unsigned int)fourCharCodeAtIndex_FI:(unsigned long long)arg1;
...
- (_Bool)boolAtIndex_FI:(unsigned long long)arg1 defaultValue:(_Bool)arg2;
- (_Bool)boolAtIndex_FI:(unsigned long long)arg1;
- (id)reverseFE_FI;
