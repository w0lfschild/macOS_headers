...
@interface FI_TBrowserViewController : FI_TBaseBrowserViewController <TThumbnailExtractorDelegate, NSMenuDelegate>
{
...
- (_Bool)checkForInvalidDropItems:(const struct TFENodeVector *)arg1;
