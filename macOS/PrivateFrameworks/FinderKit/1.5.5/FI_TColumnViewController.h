...
@interface FI_TColumnViewController : FI_TBrowserViewController <FIAliasResolution, TColumnViewDelegate, AccessibilityProtocol, TNameTextFieldDelegate, TDuplicateTaskDelegateProtocol>
{
