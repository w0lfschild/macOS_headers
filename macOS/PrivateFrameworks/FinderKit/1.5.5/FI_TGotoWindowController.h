...
@interface FI_TGotoWindowController : FI_TScriptableWindowController <NSComboBoxDelegate, NSComboBoxDataSource, NSWindowDelegate>
{
    ...
    function_cc9d02f7 _completionHandler;
...
+ (id)showGoToWindowRelativeToNode:(const struct TFENode *)arg1 parentWindow:(id)arg2 initialPath:(const struct TString *)arg3 completionHandler:(const function_cc9d02f7 *)arg4;
...
- (void)setCompletionHandler:(const function_cc9d02f7 *)arg1;
...
- (void)windowDidLoad;
- (id)_initWithRelativeToNode:(const struct TFENode *)arg1 parentWindow:(id)arg2 initialPath:(const struct TString *)arg3 completionHandler:(const function_cc9d02f7 *)arg4;
