...
{
    unordered_map_b5cb3b2e _dateFormattersAndAttributes;
    ...
    unordered_set_9d385924 _nodesToRecursivelyExpand;
    _Bool _setupExpandingNodes;
    unordered_set_9d385924 _nodesToExpand;
...
- (void)updateProperty:(unsigned int)arg1 cellView:(id)arg2 node:(const struct TFENode *)arg3;
...
- (_Bool)isDateProperty:(unsigned int)arg1;
