...
#import <FinderKit/TBestFitStringSelectorDelegate-Protocol.h>
...
@interface FI_TTextField : NSTextField <TBestFitStringSelectorDelegate>
{
    ...
    struct unique_ptr<FI_TBestFitStringSelector, std::__1::default_delete<FI_TBestFitStringSelector>> _bestFitStringSelector;
...
- (void)setFormattersAndAttributes:(const unordered_map_b5cb3b2e *)arg1 extraContentInsets:(struct NSEdgeInsets)arg2;
- (void)setSharedBestFitFormatterSelector:(const shared_ptr_2ccd00e6 *)arg1;
- (void)_updateBestFitFormatterInBound:(double)arg1;
- (unordered_map_b5cb3b2e)formattersAndAttributes;
...
- (void)setStringSet:(const unordered_set_66d0470b *)arg1 extraContentInsets:(struct NSEdgeInsets)arg2;
