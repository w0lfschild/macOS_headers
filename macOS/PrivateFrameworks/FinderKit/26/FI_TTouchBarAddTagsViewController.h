...
@class NSObject<TTouchBarTagsViewTagProviding>, NSString;
...
@interface FI_TTouchBarAddTagsViewController : FI_TTouchBarScrollingStackViewController <TCoalescingNodeObserverProtocol>
{
    ...
    struct map<TString, TNSRef<FI_TTouchBarTagButton, void>, std::__1::less<TString>, std::__1::allocator<std::__1::pair<const TString, TNSRef<FI_TTouchBarTagButton, void>>>> _tagNameToButtonMap;
...
- (const function_92f9ed64 *)buttonAction;
