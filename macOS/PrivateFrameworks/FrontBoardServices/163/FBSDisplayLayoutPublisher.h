...
#import "BSServiceConnectionListenerDelegate.h"

@class BSAtomicSignal, BSServiceConnectionListener, FBSDisplayConfiguration, FBSDisplayLayout, NSHashTable, NSMutableOrderedSet, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_xpc_object>, NSString;
