...
@class GKAchievementsDataSource, GKChallengesDataSource, GKCollectionViewAggregateDataSource, GKCollectionViewDataSource, GKComposeController, GKFriendPlayersDataSource, GKGameDetailWrapperController, GKGameRecentPlayersDataSource, GKGameRecommendationInternal, GKGameRecord, GKLeaderboardHeaderView, GKLeaderboardScoresDataSource, GKSegmentedSectionDataSource, GKSupplementaryViewMetrics, NSCollectionReusableView, NSString, NSViewController;
...
@interface GKGameDetailViewController : GKCollectionViewController <NSPopoverDelegate, GKComposeControllerDelegate, GKScoreDetailDelegate, GKAchievementDetailDelegate, GKChallengeDetailDelegate, GKGamePlayerDetailViewControllerDelegate, GKChallengeSuggestViewControllerDelegate>
{
    ...
    NSCollectionReusableView *_headerView;
    ...
    GKGameDetailWrapperController *_wrapperController;
}

@property GKGameDetailWrapperController *wrapperController; // @synthesize wrapperController=_wrapperController;
...
@property(retain) NSCollectionReusableView *headerView; // @synthesize headerView=_headerView;
