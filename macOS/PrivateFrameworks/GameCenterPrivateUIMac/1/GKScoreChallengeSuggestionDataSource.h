...
@class GKGame, GKPlayer, NSDictionary;
...
@property(retain, nonatomic) NSDictionary *leaderboardIdentifierToLeaderboard; // @synthesize leaderboardIdentifierToLeaderboard=_leaderboardIdentifierToLeaderboard;
