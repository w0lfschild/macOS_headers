...
#import <GameCenterPrivateUIMac/GKServerWebViewJSRootDelegate-Protocol.h>
...
- (void)serverWebViewJSRoot:(id)arg1 reauthenticateWithCompletionHandler:(CDUnknownBlockType)arg2;
