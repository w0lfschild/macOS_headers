...
@class NSCollectionViewLayout, NSString, NSUICollectionView;

@interface NSCollectionViewController : UXViewController <NSUICollectionViewDelegate, NSCollectionViewDataSource>
{
...
- (void)loadView;
- (id)_wrappingView;
@property(readonly, nonatomic) NSCollectionViewLayout *collectionViewLayout;
