...
@class CALayer, NSArray, NSCollectionDocumentView, NSCollectionViewData, NSCollectionViewLayout, NSCollectionViewUpdate, NSIndexPath, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSSet;
@protocol NSCollectionViewDataSource, NSUICollectionViewDelegate;

@interface NSUICollectionView : NSScrollView
{
    NSCollectionDocumentView *_collectionDocumentView;
    NSObject<NSCollectionViewDataSource> *_dataSource;
...
@property(nonatomic) __weak NSObject<NSCollectionViewDataSource> *dataSource; // @synthesize dataSource=_dataSource;
