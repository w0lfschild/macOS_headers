...
#import <GameCenterPrivateUIMac/NSUICollectionViewController.h>
...
@class GKColorPalette, GKComposeController, GKLoadableContentStateMachine, GKPlaceholderView, GKSearchBar, NSMapTable, NSString, NSUICollectionViewLayout, UIActivityIndicatorView, UXNavigationController;
...
@interface GKCollectionViewController : NSUICollectionViewController <GKComposeControllerDelegate, _GKStateMachineDelegate, GKCollectionViewDataSourceDelegate, NSTextFieldDelegate, GKSegmentedSectionDataSourceEventHandler>
{
    ...
    UXNavigationController *_placeholderNavigationController;
...
@property(retain, nonatomic) UXNavigationController *placeholderNavigationController; // @synthesize placeholderNavigationController=_placeholderNavigationController;
