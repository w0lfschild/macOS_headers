...
#import <GameCenterUI/NSUICollectionViewController.h>
...
@class GKColorPalette, GKComposeController, GKLoadableContentStateMachine, GKPlaceholderView, GKSearchBar, GKUIActivityIndicatorView, NSMapTable, NSObject<OS_dispatch_queue>, NSString, NSUICollectionViewLayout, NSUUID, UXNavigationController;
