...
@class NSArray, NSMutableArray, NSUICollectionViewUpdateItem;

@interface NSUICollectionViewUpdateGap : NSObject
{
    NSUICollectionViewUpdateItem *_firstUpdateItem;
    NSUICollectionViewUpdateItem *_lastUpdateItem;
...
@property(retain, nonatomic) NSUICollectionViewUpdateItem *lastUpdateItem; // @synthesize lastUpdateItem=_lastUpdateItem;
@property(retain, nonatomic) NSUICollectionViewUpdateItem *firstUpdateItem; // @synthesize firstUpdateItem=_firstUpdateItem;
