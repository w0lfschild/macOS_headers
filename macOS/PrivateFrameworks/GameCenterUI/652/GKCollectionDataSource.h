...
#import <GameCenterUI/NSUICollectionViewDelegateFlowLayout-Protocol.h>
#import <GameCenterUI/UICollectionViewDelegate_Private-Protocol.h>

@class NSArray, NSString, UXViewController;

@interface GKCollectionDataSource : NSObject <UICollectionViewDelegate_Private, NSUICollectionViewDataSource, NSUICollectionViewDelegateFlowLayout>
{
