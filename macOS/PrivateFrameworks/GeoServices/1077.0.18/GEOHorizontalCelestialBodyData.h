...
- (void)_calcuateAzimuthandAltitudeForCoordiante:(CDStruct_c3b9c2ee)arg1 julianDay:(double)arg2 eclipticLongitude:(double)arg3 eclipticLatitude:(double)arg4 radius:(double)arg5;
