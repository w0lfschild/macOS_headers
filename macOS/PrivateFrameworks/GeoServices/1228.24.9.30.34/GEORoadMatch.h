...
{
    CDStruct_ffa96740 *_roadFeature;
    NSString *_roadName;
...
@property(readonly, nonatomic) CDStruct_ffa96740 *roadFeature; // @synthesize roadFeature=_roadFeature;
- (void)setRoadFeature:(CDStruct_ffa96740 *)arg1;
- (void)dealloc;
