...
@interface GEOVectorTile : NSObject
{
    ...
    CDStruct_ffa96740 *_coastlines;
    unsigned long long _coastlinesCount;
    CDStruct_91e7d825 *_polygons;
    ...
    CDStruct_3dff2f81 *_pois;
    unsigned long long _poisCount;
    CDStruct_2cfe8adb *_labelTextPlacements;
    ...
    CDStruct_289bebd0 *_transitAccessPoints;
...
@property(readonly, nonatomic) CDStruct_289bebd0 *transitAccessPoints; // @synthesize transitAccessPoints=_transitAccessPoints;
...
@property(readonly, nonatomic) CDStruct_2cfe8adb *labelTextPlacements; // @synthesize labelTextPlacements=_labelTextPlacements;
@property(readonly, nonatomic) unsigned long long poisCount; // @synthesize poisCount=_poisCount;
@property(readonly, nonatomic) CDStruct_3dff2f81 *pois; // @synthesize pois=_pois;
...
@property(readonly, nonatomic) CDStruct_cae2bc5c *hiResBuildingFootprints; // @synthesize hiResBuildingFootprints=_hiResBuildingFootprints;
...
@property(readonly, nonatomic) CDStruct_cae2bc5c *buildingFootprints; // @synthesize buildingFootprints=_buildingFootprints;
@property(readonly, nonatomic) unsigned long long polygonsCount; // @synthesize polygonsCount=_polygonsCount;
@property(readonly, nonatomic) CDStruct_91e7d825 *polygons; // @synthesize polygons=_polygons;
@property(readonly, nonatomic) unsigned long long coastlinesCount; // @synthesize coastlinesCount=_coastlinesCount;
@property(readonly, nonatomic) CDStruct_ffa96740 *coastlines; // @synthesize coastlines=_coastlines;
...
@property(readonly, nonatomic) CDStruct_ffa96740 *lines; // @synthesize lines=_lines;
- (CDStruct_8f1ffc8e *)transitSystemInfoForFeatureID:(unsigned long long)arg1;
- (CDStruct_289bebd0 *)transitAccessPointForFeatureID:(unsigned long long)arg1;
...
- (CDStruct_ffa96740 *)multiSectionFeatureForGeoID:(unsigned long long)arg1;
...
- (void)forEachJunctionInRoad:(CDStruct_ffa96740 *)arg1 visitor:(CDUnknownBlockType)arg2;
- (void)forEachEdgeInRoad:(CDStruct_ffa96740 *)arg1 visitTwice:(BOOL)arg2 visitor:(CDUnknownBlockType)arg3;
...
- (BOOL)_decodeLabelTextPlacementsFromStream:(CDStruct_8bf61218 *)arg1 count:(unsigned long long)arg2 firstFeature:(CDStruct_3dff2f81 *)arg3 featureStride:(unsigned long long)arg4 tilePrecision:(unsigned char)arg5;
