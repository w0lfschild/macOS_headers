...
@interface GEOVectorTile : NSObject
{
    ...
    CDStruct_5c67342b *_venueComponents;
    ...
    CDStruct_19a6ad5e *_transitAccessPoints;
...
@property(readonly, nonatomic) CDStruct_19a6ad5e *transitAccessPoints; // @synthesize transitAccessPoints=_transitAccessPoints;
...
@property(readonly, nonatomic) CDStruct_ad4dbe06 *pois; // @synthesize pois=_pois;
...
@property(readonly, nonatomic) CDStruct_dcb4d614 *hiResBuildingFootprints; // @synthesize hiResBuildingFootprints=_hiResBuildingFootprints;
...
@property(readonly, nonatomic) CDStruct_5c67342b *venueComponents; // @synthesize venueComponents=_venueComponents;
...
@property(readonly, nonatomic) CDStruct_b89018e8 *venues; // @synthesize venues=_venues;
...
- (CDStruct_19a6ad5e *)transitAccessPointForFeatureID:(unsigned long long)arg1;
...
- (BOOL)_decodeLabelTextPlacementsFromStream:(CDStruct_8bf61218 *)arg1 count:(unsigned long long)arg2 firstFeature:(CDStruct_ad4dbe06 *)arg3 featureStride:(unsigned long long)arg4 tilePrecision:(unsigned char)arg5;
...
- (BOOL)_readOldVenues:(CDStruct_effb527d *)arg1 key:(const struct _GEOTileKey *)arg2;
