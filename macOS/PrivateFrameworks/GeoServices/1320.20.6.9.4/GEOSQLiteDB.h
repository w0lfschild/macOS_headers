...
@class NSError, NSMapTable, NSMutableArray, NSString, NSURL;
...
- (id)description;
- (id)initWithQueueName:(const char *)arg1 log:(id)arg2 databaseFileURL:(id)arg3 sqliteFlags:(int)arg4 setupBlock:(CDUnknownBlockType)arg5;
