...
- (void)proxy:(id)arg1 willGoToNetworkForTiles:(id)arg2 inBatch:(int)arg3;
...
- (void)proxy:(id)arg1 failedToLoadTiles:(id)arg2 inBatch:(int)arg3 error:(id)arg4;
- (void)proxy:(id)arg1 loadedTile:(id)arg2 forKey:(const struct _GEOTileKey *)arg3 inBatch:(int)arg4 info:(id)arg5;
- (void)_removeUsageDataForKey:(const struct _GEOTileKey *)arg1;
- (void)_decodeTileForKey:(struct _GEOTileKey)arg1 preliminary:(BOOL)arg2 quickly:(BOOL)arg3 tileDecoder:(id)arg4 data:(id)arg5 disburseTile:(CDUnknownBlockType)arg6;
- (void)_loadedTile:(id)arg1 forKey:(const struct _GEOTileKey *)arg2 inBatch:(int)arg3 info:(id)arg4;
