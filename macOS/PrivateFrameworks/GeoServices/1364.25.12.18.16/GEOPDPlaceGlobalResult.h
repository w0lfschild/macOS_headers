...
@property(retain, nonatomic) GEOPDBatchCategoryLookupResult *batchCategoryLookupResult; // @synthesize batchCategoryLookupResult=_batchCategoryLookupResult;
@property(retain, nonatomic) GEOPDBatchSpatialLookupResult *batchSpatialLookupResult; // @synthesize batchSpatialLookupResult=_batchSpatialLookupResult;
