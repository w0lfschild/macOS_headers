...
#import "GEOPDPlaceCacheManifestInfoProviding.h"
#import "GEOPDPlaceCacheSchedulingDelegate.h"

@class GEOSQLiteDB, NSArray, NSMutableDictionary, NSMutableOrderedSet, NSObject<OS_dispatch_source>;
