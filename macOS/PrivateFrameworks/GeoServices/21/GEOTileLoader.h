...
@class GEOTileLoaderConfiguration, GEOTileLoaderInternal, GEOTileLoaderUsage, GEOTileServerProxy, NSHashTable, NSMutableArray, NSMutableSet, NSObject<OS_dispatch_queue>, NSString, geo_isolater;
