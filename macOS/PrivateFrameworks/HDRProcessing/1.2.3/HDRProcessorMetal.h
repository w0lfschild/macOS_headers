...
- (void)processFrameInternalWithLayer0:(struct __IOSurface *)arg1 layer1:(struct __IOSurface *)arg2 outout:(struct __IOSurface *)arg3 metadata:(id)arg4 commandbuffer:(id)arg5 msrContext:(CDStruct_3af1b874 *)arg6 histogram:(struct RgbHistogram_t *)arg7;
- (long long)generateMSRColorConfig:(CDStruct_3af1b874 *)arg1 withInputSurface:(struct __IOSurface *)arg2 outputSurface:(struct __IOSurface *)arg3 metadata:(id)arg4 histogram:(struct RgbHistogram_t *)arg5;
