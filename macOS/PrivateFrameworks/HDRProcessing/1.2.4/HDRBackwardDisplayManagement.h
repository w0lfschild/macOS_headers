...
@interface HDRBackwardDisplayManagement : NSObject
{
    ...
    id <MTLRenderPipelineState> _BKDM_3Plane_2Pixel_Linear[8];
    id <MTLRenderPipelineState> _BKDM_3Plane_1Pixel_Linear[8];
    id <MTLRenderPipelineState> _BKDM_3Plane_1Pixel_Gamma[8];
    id <MTLRenderPipelineState> _BKDM_3Plane_1Pixel_Gamma_Scaled[8];
    id <MTLRenderPipelineState> _BKDM_3Plane_1Pixel_Video_Scaled[8];
    id <MTLRenderPipelineState> _BKDM_3Plane_2Pixel_Gamma_Scaled[8];
    id <MTLRenderPipelineState> _BKDM_3Plane_2Pixel_Video_Scaled[8];
    id <MTLRenderPipelineState> _BKDM_SDRUIOnly[8];
    id <MTLRenderPipelineState> _BKDM_SDRVideoOnly[8];
    id <MTLRenderPipelineState> _BKDM_SDRVideoUIBlending[8];
    id <MTLRenderPipelineState> _BKDM_SDRUIBlending[8];
    id <MTLRenderPipelineState> _colorfill1[8];
    id <MTLRenderPipelineState> _colorfill2[8];
    id <MTLRenderPipelineState> _fillUI1ForHDR[8];
    id <MTLRenderPipelineState> _fillUI1SDR24[8];
    id <MTLRenderPipelineState> _fillUI2ForHDR[8];
...
- (BOOL)updateConfigFromMetadata:(CDStruct_bd0e21b1 *)arg1 uiScaleFactor:(float)arg2 width:(int)arg3 background:(CDStruct_d2b197d1 *)arg4 hdrVideoOnly:(BOOL)arg5 hdr10TV:(BOOL)arg6 sdrOnly:(BOOL)arg7;
- (void)updateUniformUIScaleForVideo:(BOOL)arg1 forTV:(BOOL)arg2;
...
- (void)createBuffers;
- (void)fillScalingTable_YUVTM:(CDStruct_bd0e21b1 *)arg1 targetwhite:(float)arg2 targetblack:(float)arg3 satBoost:(float)arg4 scalingFactor:(BOOL)arg5 sdrOnly:(BOOL)arg6;
- (void)fillScalingTable_SDR2HDR:(CDStruct_bd0e21b1 *)arg1 target_White:(float)arg2 target_Black:(float)arg3;
...
- (void)createSamplers;
- (void)createKernels;
- (id)createRenderPipeLineWithVertexName:(id)arg1 fragmentName:(id)arg2 colorFormat:(unsigned long long)arg3 useCustomMatrix:(BOOL)arg4 p3CSC:(BOOL)arg5;
- (void)setupMetal;
