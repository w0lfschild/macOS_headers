...
- (void).cxx_destruct;
- (void)attatchInfoFrame:(CDStruct_096ecdcf *)arg1 toOutputSurface:(struct __IOSurface *)arg2;
...
- (void)createBuffers;
- (void)fillScalingTable_YUVTM:(CDStruct_096ecdcf *)arg1 targetwhite:(float)arg2 targetblack:(float)arg3 satBoost:(float)arg4 scalingFactor:(BOOL)arg5 sdrOnly:(BOOL)arg6;
- (void)fillScalingTable_SDR2HDR:(CDStruct_096ecdcf *)arg1 target_White:(float)arg2 target_Black:(float)arg3;
- (void)fillInverseScalingFactorTableFromDMConfig:(CDStruct_096ecdcf *)arg1;
