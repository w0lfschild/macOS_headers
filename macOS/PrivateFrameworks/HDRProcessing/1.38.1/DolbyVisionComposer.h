...
- (void)createScalingFactorTableFromDMConfig:(CDStruct_445791a7 *)arg1 useHLGGammaCurve:(BOOL)arg2 hdrCtrl:(CDStruct_8b021bd8 *)arg3;
- (BOOL)configChanged:(CDStruct_445791a7 *)arg1;
- (void)fillInScalingTable_YUVTM:(CDStruct_445791a7 *)arg1 target_White:(float)arg2 target_Black:(float)arg3 source_White:(float)arg4 source_Black:(float)arg5 satBoost:(float)arg6 scalingFactor:(BOOL)arg7;
...
- (void)macSetupEncoderForCommandBuffer:(id)arg1 hdrControl:(CDStruct_8b021bd8 *)arg2 DMData:(CDStruct_f4857302 *)arg3 dmConfig:(id)arg4 isHdr10OnMac:(BOOL)arg5 isHlgOnMac:(BOOL)arg6 onHDR10TV:(BOOL)arg7 lldovi:(BOOL)arg8;
- (void)macSetupToneMappingWithContent:(BOOL)arg1 Output:(struct __IOSurface *)arg2 DMData:(CDStruct_f4857302 *)arg3 tcControl:(struct ToneCurve_Control *)arg4 hdrControl:(CDStruct_8b021bd8 *)arg5 hdr10InfoFrame:(CDStruct_52986d3b *)arg6 dmConfig:(CDStruct_445791a7 *)arg7 hdr10OnMac:(BOOL)arg8 hlgOnMac:(BOOL)arg9 onHDR10TV:(BOOL)arg10;
...
- (void)embeddedSetupToneMappingWithContent:(BOOL)arg1 Output:(struct __IOSurface *)arg2 DMData:(CDStruct_f4857302 *)arg3 tcControl:(struct ToneCurve_Control *)arg4 hdrControl:(CDStruct_8b021bd8 *)arg5 hdr10InfoFrame:(CDStruct_52986d3b *)arg6 dmConfig:(CDStruct_445791a7 *)arg7 hdr10OnPad:(BOOL)arg8 onHDR10TV:(BOOL)arg9;
- (void)encodeSingleLayerToCommandBuffer:(id)arg1 BL:(struct __IOSurface *)arg2 Output:(struct __IOSurface *)arg3 ComposerData:(CDStruct_895ff2bf *)arg4 DMData:(CDStruct_f4857302 *)arg5 tcControl:(struct ToneCurve_Control *)arg6 hdrControl:(CDStruct_8b021bd8 *)arg7 hdr10InfoFrame:(CDStruct_52986d3b *)arg8;
