...
- (void)encodeToCommandBuffer:(id)arg1 Input:(struct __IOSurface *)arg2 Output:(struct __IOSurface *)arg3 MetaData:(CDStruct_f4857302 *)arg4 tcControl:(struct ToneCurve_Control *)arg5 hdrControl:(CDStruct_8b021bd8 *)arg6;
- (void)setupMetal;
