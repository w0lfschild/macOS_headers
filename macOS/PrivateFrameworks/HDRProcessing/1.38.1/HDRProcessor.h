...
@interface HDRProcessor : NSObject
{
    ...
    CDStruct_d33f0da6 _edrMetaData[2];
...
- (void)setCSCMatrixInHDRControl:(CDStruct_8b021bd8 *)arg1 forIndex:(unsigned int)arg2;
- (void)setHDRControl:(CDStruct_8b021bd8 *)arg1 withRUP:(BOOL)arg2;
...
- (long long)processPixelsWithLayer0:(struct __IOSurface *)arg1 layer1:(struct __IOSurface *)arg2 output:(struct __IOSurface *)arg3 metaData:(CDStruct_d33f0da6 *)arg4 tcControl:(struct ToneCurve_Control *)arg5 hdrControl:(CDStruct_8b021bd8 *)arg6 hdr10InfoFrame:(CDStruct_52986d3b *)arg7 commandbuffer:(id)arg8;
