...
- (void)createLUTFromDMConfig:(CDStruct_73ebd679 *)arg1 TCControl:(struct ToneCurve_Control *)arg2 HDRControl:(CDStruct_d76a58a8 *)arg3 ApplyExtraAdaptation:(_Bool)arg4 AdaptationLut:(float *)arg5 NumOfEntryOfAdaptationLut:(int)arg6;
- (void)dovi_tm_updateLUT;
- (void)dovi_tm_createLUTFromDMConfig:(CDStruct_73ebd679 *)arg1 ApplyExtraAdaptation:(_Bool)arg2 AdaptationLu:(float *)arg3 NumOfEntryOfAdaptationLut:(int)arg4;
- (void)dovi_tm_reserveConfig:(CDStruct_73ebd679 *)arg1;
- (BOOL)dovi_tm_configChanged:(CDStruct_73ebd679 *)arg1;
- (void)dovi_createLUTFromDMConfig:(CDStruct_73ebd679 *)arg1 ApplyExtraAdaptation:(_Bool)arg2 AdaptationLut:(float *)arg3 NumOfEntryOfAdaptationLut:(int)arg4;
...
- (BOOL)hdr10_tm_configChanged:(CDStruct_73ebd679 *)arg1 TMParam:(struct _HDR10TMParam *)arg2 AmbAdaptationParam:(struct _HDR10AmbAdaptationParam *)arg3;
- (void)hdr10_createLUTFromDMConfig:(CDStruct_73ebd679 *)arg1 TMParam:(struct _HDR10TMParam *)arg2 AmbAdaptationParam:(struct _HDR10AmbAdaptationParam *)arg3;
- (void)fillInScalingTable_YUVTM:(CDStruct_73ebd679 *)arg1 target_White:(float)arg2 target_Black:(float)arg3 source_White:(float)arg4 source_Black:(float)arg5 satBoost:(float)arg6 scalingFactor:(BOOL)arg7;
...
- (void)macSetupToneMappingWithContent:(BOOL)arg1 Output:(struct __IOSurface *)arg2 DMData:(CDStruct_f4857302 *)arg3 tcControl:(struct ToneCurve_Control *)arg4 hdrControl:(CDStruct_d76a58a8 *)arg5 hdr10InfoFrame:(CDStruct_52986d3b *)arg6 dmConfig:(CDStruct_73ebd679 *)arg7 hdr10OnMac:(BOOL)arg8 hlgOnMac:(BOOL)arg9 onHDR10TV:(BOOL)arg10;
...
- (void)embeddedSetupToneMappingWithContent:(BOOL)arg1 Output:(struct __IOSurface *)arg2 DMData:(CDStruct_f4857302 *)arg3 tcControl:(struct ToneCurve_Control *)arg4 hdrControl:(CDStruct_d76a58a8 *)arg5 hdr10InfoFrame:(CDStruct_52986d3b *)arg6 dmConfig:(CDStruct_73ebd679 *)arg7 hdr10OnPad:(BOOL)arg8 useYUVScalingTable:(BOOL)arg9;
