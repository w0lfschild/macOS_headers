...
- (void)createLUTFromDMConfig:(CDStruct_78732a63 *)arg1 TCControl:(struct ToneCurve_Control *)arg2 HDRControl:(CDStruct_d76a58a8 *)arg3 ApplyExtraAdaptation:(_Bool)arg4 AdaptationLut:(float *)arg5 NumOfEntryOfAdaptationLut:(int)arg6;
- (void)dovi_tm_updateLUT;
- (void)dovi_tm_createLUTFromDMConfig:(CDStruct_78732a63 *)arg1 ApplyExtraAdaptation:(_Bool)arg2 AdaptationLu:(float *)arg3 NumOfEntryOfAdaptationLut:(int)arg4;
- (void)dovi_tm_reserveConfig:(CDStruct_78732a63 *)arg1;
...
- (BOOL)hdr10_tm_configChanged:(CDStruct_78732a63 *)arg1 TMParam:(struct _HDR10TMParam *)arg2 AmbAdaptationParam:(struct _HDR10AmbAdaptationParam *)arg3;
- (void)hdr10_createLUTFromDMConfig:(CDStruct_78732a63 *)arg1 TMParam:(struct _HDR10TMParam *)arg2 AmbAdaptationParam:(struct _HDR10AmbAdaptationParam *)arg3;
- (void)fillInScalingTable_YUVTM:(CDStruct_78732a63 *)arg1 target_White:(float)arg2 target_Black:(float)arg3 source_White:(float)arg4 source_Black:(float)arg5 satBoost:(float)arg6 scalingFactor:(BOOL)arg7;
