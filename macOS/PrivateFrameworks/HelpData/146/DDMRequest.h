...
+ (id)topicRequestWithID:(id)arg1 ddmBookID:(id)arg2 language:(id)arg3 product:(id)arg4 platform:(id)arg5 version:(id)arg6;
...
- (id)initWithType:(unsigned int)arg1 ddmID:(id)arg2 ddmBookID:(id)arg3 language:(id)arg4 product:(id)arg5 platform:(id)arg6 version:(id)arg7;
