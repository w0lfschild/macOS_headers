...
@property(readonly) NSString *resourcesRootPath; // @dynamic resourcesRootPath;
@property(readonly) NSString *localizedDocumentRootPath; // @dynamic localizedDocumentRootPath;
