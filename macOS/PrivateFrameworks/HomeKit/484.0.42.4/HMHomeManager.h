...
@class HMAccessory, HMApplicationData, HMDelegateCaller, HMFMessageDispatcher, HMHome, HMHomeManagerConfiguration, HMPendingRequests, HMThreadSafeMutableArrayCollection, HMXpcClient, NSArray, NSNumber, NSOperationQueue, NSString, NSUUID, _HMLocationHandler;
