...
- (id)initWithMediaProfiles:(id)arg1 playbackState:(long long)arg2 volume:(id)arg3 options:(long long)arg4 playbackArchive:(id)arg5;
- (id)initWithMediaProfiles:(id)arg1 playbackState:(long long)arg2 volume:(id)arg3 options:(long long)arg4 playbackArchive:(id)arg5 uuid:(id)arg6;
