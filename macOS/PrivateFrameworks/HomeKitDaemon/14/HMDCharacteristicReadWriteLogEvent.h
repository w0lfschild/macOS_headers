...
@interface HMDCharacteristicReadWriteLogEvent : HMDLogEvent <HMDAWDLogEvent>
{
    ...
    unsigned long long _timeIntervalSinceFirstFailure;
}
...
+ (id)uuid;
- (void).cxx_destruct;
@property(nonatomic) unsigned long long timeIntervalSinceFirstFailure; // @synthesize timeIntervalSinceFirstFailure=_timeIntervalSinceFirstFailure;
