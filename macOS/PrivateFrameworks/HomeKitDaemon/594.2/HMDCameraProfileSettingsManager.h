...
@class HMDCameraProfileSettingsDerivedPropertiesModel, HMDCameraProfileSettingsModel, HMDDatabaseZoneManager, HMDHAPAccessory, HMFMessageDispatcher, NSNotificationCenter, NSNumber, NSObject, NSString, NSUUID;
...
- (void)_handleUpdatedCurrentAccessMode:(unsigned long long)arg1;
