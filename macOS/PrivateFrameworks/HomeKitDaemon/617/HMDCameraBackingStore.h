...
@class HMBCloudZone, HMBLocalZone, HMDCameraClipsQuotaManager, HMDCameraProfile, HMDCloudShareMessenger, HMDCloudShareParticipantsManager, HMFTimer, NSHashTable, NSMapTable, NSObject<OS_dispatch_queue>, NSSet, NSString, NSUUID;
...
- (void)_handleNewSignificantEventNotificationModel:(id)arg1 withHeroFrameAssetURL:(id)arg2 forClipModel:(id)arg3;
