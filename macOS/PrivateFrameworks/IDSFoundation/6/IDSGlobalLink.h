...
@class IDSCommnatManager, IDSGLSessionManager, IDSGlobalLinkBlocks, IDSTCPLink, IDSUDPLink, NSData, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_source>, NSString;
