...
#import <IMAP/IMAPMailboxDelegate-Protocol.h>
#import <IMAP/IMAPMessageDataSource-Protocol.h>
#import <IMAP/MCMailbox-Protocol.h>

@class IMAPAccountProxy, IMAPCommandPipeline, IMAPDownloadCache, IMAPMailbox, IMAPMailboxSyncEngine, NSLock, NSMutableArray, NSMutableSet, NSOperationQueue, NSString;
...
@property __weak IMAPAccountProxy *account; // @synthesize account=_account;
- (void).cxx_destruct;
