...
@class NSMutableArray, NSString, PKInstallRequest, PKPackageSourceManager;
...
- (void)dealloc;
- (id)initWithDestinationPath:(id)arg1 displayName:(id)arg2 displayVersion:(id)arg3 sourceManager:(id)arg4 sandboxPath:(id)arg5 installingOS:(BOOL)arg6 isFNI:(BOOL)arg7 minTrustLevel:(int)arg8 restartAction:(int)arg9;
- (id)logDescription;
- (id)description;
