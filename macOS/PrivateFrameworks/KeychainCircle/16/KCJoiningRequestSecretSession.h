...
@class KCAESGCMDuplexSession, KCSRPClientContext, NSData, NSMutableDictionary, NSObject<KCJoiningRequestSecretDelegate>, NSString, OTControl, OTJoiningConfiguration;
