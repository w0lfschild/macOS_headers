...
@class LPCaptionBarPresentationProperties, LPCaptionBarView, LPComponentView, LPImage, LPLinkMetadata, LPMetadataProvider, LPTextView, LPTheme, LPVideo, LPiTunesPlaybackInformation, NSColor, NSMutableArray, NSString, NSURL;
