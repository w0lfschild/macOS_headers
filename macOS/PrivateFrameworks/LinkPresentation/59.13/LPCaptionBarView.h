...
@class LPCaptionBarAccessoryView, LPCaptionBarPresentationProperties, LPCaptionBarStyle, LPImageView, LPVerticalTextStackView, LPiTunesPlayButtonView, LPiTunesPlaybackInformation, NSString, NSView;
