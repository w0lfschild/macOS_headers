...
+ (unsigned char)handleTrustPolicy:(struct __SecTrust *)arg1 policy:(struct OpaqueSecPolicyRef *)arg2 requestType:(struct __CFString *)arg3 host:(struct __CFString *)arg4 error:(struct __CFError **)arg5;
