...
@class IMAPCommandPipeline, IMAPDownloadCache, IMAPLocalMessageAction, IMAPMessage, IMAPMessageDetails, IMAPServerInterface, NSArray, NSDate, NSDictionary, NSError, NSIndexSet, NSMutableDictionary, NSNumber, NSSet, NSString;
