...
+ (id)defaultFactory;
@property(retain, nonatomic) NSString *attachmentFormatString; // @synthesize attachmentFormatString=_attachmentFormatString;
@property(retain, nonatomic) NSString *emailContentType; // @synthesize emailContentType=_emailContentType;
