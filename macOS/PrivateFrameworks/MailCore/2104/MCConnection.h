...
@class MCSaslClient, MCSocket, NSData, NSFileHandle, NSString;
@protocol MCAccount;
...
- (BOOL)_startTLS;
- (void)_setupSocketWithSecurityLayer:(long long)arg1 disableEphemeralDiffieHellmanCiphers:(BOOL)arg2;
