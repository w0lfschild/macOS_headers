...
#import <MarkupUI/NSTouchBarProvider-Protocol.h>
#import <MarkupUI/NSWindowDelegate-Protocol.h>

@class AKController, MUCGPDFReader, MUContentBorderView, NSData, NSStackView, NSString, NSTouchBar, NSUndoManager, NSView;
@protocol MUContentViewControllerProtocol><MUContentViewControllerAKControllerSubdelegate;

@interface MarkupViewController : NSViewController <NSTouchBarProvider, NSTouchBarDelegate, AKControllerDelegateProtocol, NSWindowDelegate>
{
