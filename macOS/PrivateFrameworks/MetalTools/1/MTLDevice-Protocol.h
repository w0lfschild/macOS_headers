...
- (CDStruct_dbea1aba)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;
- (CDStruct_dbea1aba)heapTextureSizeAndAlignWithDescriptor:(MTLTextureDescriptor *)arg1;
