...
@class NSData, NSObject<NFContactlessPaymentSessionCallbacks>, NSObject<NFContactlessSessionCallbacks>, NSObject<NFECommercePaymentSessionCallbacks>, NSObject<NFFieldDetectSessionCallbacks>, NSObject<NFHardwareManagerCallbacks>, NSObject<NFHostEmulationSessionCallbacks>, NSObject<NFNdefTagSessionCallbacks>, NSObject<NFPeerPaymentSessionCallbacks>, NSObject<NFReaderSessionCallbacks>, NSObject<NFSecureElementAndHostCardEmulationSessionCallbacks>, NSObject<NFSecureElementManagerSessionCallbacks>, NSObject<NFSessionInterface>, NSObject<NFTrustSessionCallbacks>, NSUUID;
