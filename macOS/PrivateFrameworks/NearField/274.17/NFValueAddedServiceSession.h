...
#import <NearField/NFValueAddedServiceSessionCallbacks-Protocol.h>

@class NFWeakReference, NSString;
@protocol NFValueAddedServiceSessionDelegate;
...
- (void)endSession;
@property id <NFValueAddedServiceSessionDelegate> delegate;
- (void)dealloc;
