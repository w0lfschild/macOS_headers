...
@property(readonly, nonatomic) BOOL hasExpressAccessMode; // @synthesize hasExpressAccessMode=_hasExpressAccessMode;
@property(readonly, nonatomic) BOOL hasExpressTransitMode; // @synthesize hasExpressTransitMode=_hasExpressTransitMode;
