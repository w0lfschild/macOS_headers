...
- (oneway void)queueNdefTagSession:(NSObject<NFNdefTagSessionCallbacks> *)arg1 callback:(void (^)(NSObject<NFNdefTagSessionInterface> *, BOOL, NSError *))arg2;
...
- (oneway void)isExpressModeSupported:(void (^)(BOOL, BOOL, NSError *))arg1;
