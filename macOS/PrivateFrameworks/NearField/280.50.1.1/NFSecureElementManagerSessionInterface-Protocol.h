...
- (oneway void)execRemoteAdminScript:(NSDictionary *)arg1 whitelist:(NSArray *)arg2 seid:(NSString *)arg3 willCheckWhitelist:(BOOL)arg4 callback:(void (^)(NSDictionary *, long long, NSError *))arg5;
