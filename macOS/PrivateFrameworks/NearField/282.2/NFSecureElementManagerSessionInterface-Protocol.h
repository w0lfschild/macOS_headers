...
@class NFApplet, NFPeerPaymentEnrollmentRequest, NSArray, NSData, NSDictionary, NSSet, NSString;
...
- (oneway void)expressModesInfo:(void (^)(BOOL, NSArray *, NSArray *))arg1;
...
- (oneway void)execRemoteAdminScript:(NSDictionary *)arg1 whitelist:(NSArray *)arg2 seid:(NSString *)arg3 willCheckWhitelist:(BOOL)arg4 selectFirstAIDFromWhitelist:(BOOL)arg5 callback:(void (^)(NSDictionary *, long long, NSError *))arg6;
