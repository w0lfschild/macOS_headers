...
+ (void)copyTexture:(id)arg1 toSurfaceImage:(id)arg2 atPoint:(CDStruct_912cb5d2)arg3 withContext:(id)arg4;
+ (void)copySurface:(id)arg1 toSurfaceImage:(id)arg2 atPoint:(CDStruct_912cb5d2)arg3;
...
+ (void)copyPixelsToImage:(id)arg1 atPoint:(CDStruct_912cb5d2)arg2 fromBuffer:(id)arg3;
