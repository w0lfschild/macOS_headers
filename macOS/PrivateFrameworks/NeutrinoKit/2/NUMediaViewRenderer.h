...
#import "NUMediaPlayer.h"

@class AVComposition, NSArray, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSString, NSView, NUAVPlayerController, NUCoalescer, NUColorSpace, NUComposition, NULivePhotoRenderClient, NUMediaView, NUObservatory, NUPixelFormat, NUResponse, NUSurfaceRenderClient, NUVideoRenderClient;
