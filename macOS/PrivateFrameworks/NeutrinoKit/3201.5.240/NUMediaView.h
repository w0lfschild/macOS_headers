...
- (void)_viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2 insets:(struct NSEdgeInsets)arg3;
- (struct NSEdgeInsets)_edgeInsetsForImageSize:(struct CGSize)arg1 inFrame:(struct CGRect)arg2;
