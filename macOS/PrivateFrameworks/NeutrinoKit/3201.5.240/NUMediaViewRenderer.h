...
@class NSArray, NSView, NUAVPlayerController, NUCoalescer, NUColorSpace, NULivePhotoRenderClient, NUMediaView, NUPriority, NURenderClient, NUResponse, NUSurfaceRenderClient, NUVideoRenderClient;
