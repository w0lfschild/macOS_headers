...
@class AVComposition, NSArray, NSView, NUAVPlayerController, NUCoalescer, NUColorSpace, NULivePhotoRenderClient, NUMediaView, NUPixelFormat, NUPriority, NURenderClient, NUResponse, NUSurfaceRenderClient, NUVideoRenderClient;
