...
+ (id)defaultPDFHardPaywallWithLandingPageArticleID:(id)arg1 temporaryAccessEnabled:(BOOL)arg2;
+ (id)defaultMagazineFeedSoftPaywallLargePaywallWithLandingPageArticleID:(id)arg1 temporaryAccessEnabled:(BOOL)arg2;
+ (id)defaultMagazineFeedSoftPaywallMediumPaywallWithLandingPageArticleID:(id)arg1 temporaryAccessEnabled:(BOOL)arg2;
+ (id)defaultMagazineFeedSoftPaywallSmallPaywallWithLandingPageArticleID:(id)arg1 temporaryAccessEnabled:(BOOL)arg2;
+ (id)defaultChannelSoftPaywallWithLandingPageArticleID:(id)arg1 temporaryAccessEnabled:(BOOL)arg2;
+ (id)defaultArticleSharedSoftPaywallWithLandingPageArticleID:(id)arg1 temporaryAccessEnabled:(BOOL)arg2;
+ (id)defaultArticleSoftPaywallWithLandingPageArticleID:(id)arg1 temporaryAccessEnabled:(BOOL)arg2;
+ (id)defaultArticleSharedHardPaywallWithLandingPageArticleID:(id)arg1 temporaryAccessEnabled:(BOOL)arg2;
+ (id)defaultArticleHardPaywallWithLandingPageArticleID:(id)arg1 temporaryAccessEnabled:(BOOL)arg2;
