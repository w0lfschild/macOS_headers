...
- (id)initWithArticle:(id)arg1 adProvider:(id)arg2 adControllerFactory:(id)arg3 adMetadataFactory:(id)arg4 device:(id)arg5 layoutOptionsFactory:(id)arg6 subscriptionAdContextProvider:(id)arg7;
