...
#import <Notes/ICNFMCConnectionLogging-Protocol.h>

@class ICNFMCSaslClient, ICNFMCSocket, NSArray, NSData, NSFileHandle, NSString;
...
@property(retain, nonatomic) ICNFMCSocket *socket; // @synthesize socket=_socket;
@property(retain, nonatomic) ICNFMCSaslClient *saslClient; // @synthesize saslClient=_saslClient;
