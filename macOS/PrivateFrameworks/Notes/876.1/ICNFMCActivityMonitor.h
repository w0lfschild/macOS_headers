...
#import <Notes/NSMachPortDelegate-Protocol.h>

@class ICNFMCError, NSArray, NSInvocation, NSMachPort, NSMutableSet, NSString;
...
@interface ICNFMCActivityMonitor : NSObject <NSMachPortDelegate>
{
    ...
    // Error parsing type: Ai, name: _changeCount
