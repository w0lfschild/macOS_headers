...
#import "ICManagedObjectContextUpdaterDelegate.h"
#import "ICNoteContainer.h"

@class ICAccount, ICAccountUtilities, ICFolderCustomNoteSortType, ICManagedObjectContextUpdater, ICNote, ICNotesCrossProcessChangeCoordinator, ICPersistentContainer, NSArray, NSData, NSDictionary, NSError, NSManagedObjectContext, NSObject<OS_dispatch_queue>, NSString, NSTimer;
