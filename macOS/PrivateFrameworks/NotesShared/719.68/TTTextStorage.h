...
@interface TTTextStorage : NSTextStorage <TTMergeableStringDelegate>
{
    ...
    BOOL _isChaingingTypingAttributeFontByFontPanel;
...
+ (id)bulletTextAttributesWithTextFont:(struct NSFont *)arg1 paragraphStyle:(id)arg2 letterpress:(BOOL)arg3;
...
@property(nonatomic) BOOL isChaingingTypingAttributeFontByFontPanel; // @synthesize isChaingingTypingAttributeFontByFontPanel=_isChaingingTypingAttributeFontByFontPanel;
