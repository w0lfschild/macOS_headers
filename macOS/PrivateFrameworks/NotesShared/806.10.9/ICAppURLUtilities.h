...
+ (id)urlForQuickNoteLaunchedByPencil:(BOOL)arg1 showList:(BOOL)arg2 noteIdentifier:(id)arg3 contentOffsetValue:(id)arg4;
+ (id)urlForQuickNoteLaunchedByPencil:(BOOL)arg1 showList:(BOOL)arg2 noteIdentifier:(id)arg3;
