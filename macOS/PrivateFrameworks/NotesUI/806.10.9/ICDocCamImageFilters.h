...
+ (struct NSImage *)perspectiveCorrectedImageFromImage:(struct NSImage *)arg1 normalizedImageQuad:(id)arg2 context:(id)arg3;
+ (struct NSImage *)perspectiveCorrectedImageFromImage:(struct NSImage *)arg1 imageQuad:(id)arg2 context:(id)arg3;
