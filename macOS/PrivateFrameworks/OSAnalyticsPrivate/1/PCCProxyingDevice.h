...
#import <OSAnalyticsPrivate/NSXPCListenerDelegate-Protocol.h>
#import <OSAnalyticsPrivate/OSASyncProxyServices-Protocol.h>

@class NSDate, NSMutableDictionary, NSString, PCCEndpoint;
