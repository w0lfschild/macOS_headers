...
@class NSArray, NSDate, SUAppStoreUpdateController, SUOSUClient, SUOSUMajorProduct, SUOSUNotificationManagerController, SUOSUUpdateController, SUPowerAssertionManager;
