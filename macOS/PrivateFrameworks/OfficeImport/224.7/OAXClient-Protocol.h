...
@class CXNamespace, NSString, OADDrawable, OADGroup, OADHyperlink, OADImage, OADParagraph, OADShape, OADTextField, OAXDrawingState, OCPPackageRelationship, ODDDiagram;
