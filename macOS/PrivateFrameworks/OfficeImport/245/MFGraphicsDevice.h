...
- (int)alphaBlend:(int)arg1:(int)arg2:(int)arg3:(int)arg4:(id)arg5:(int)arg6:(int)arg7:(int)arg8:(int)arg9:(unsigned char)arg10:(BOOL)arg11:(struct CGAffineTransform *)arg12:(unsigned int)arg13;
