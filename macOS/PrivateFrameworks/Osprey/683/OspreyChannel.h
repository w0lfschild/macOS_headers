...
@class NSData, NSError, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSString, NSURL, NSURLSessionConfiguration, OspreyAbsintheAuthenticator, OspreyGRPCChannel;
