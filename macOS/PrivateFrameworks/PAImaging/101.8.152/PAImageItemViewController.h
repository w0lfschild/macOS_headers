...
#import <PAImaging/PAImageActivityController-Protocol.h>
...
- (BOOL)zoomToFit;
- (void)setZoomToFit:(BOOL)arg1;
- (double)zoomFactor;
- (void)setZoomFactor:(double)arg1;
- (void)replaceCustomAnimation:(id)arg1 forKey:(id)arg2 view:(id)arg3;
- (id)panAnimation;
- (void)_withZoomAnimation:(CDUnknownBlockType)arg1;
- (void)_setZoomFactor:(double)arg1 center:(struct CGPoint)arg2;
- (void)setZoomFactor:(double)arg1 center:(struct CGPoint)arg2 animate:(BOOL)arg3;
