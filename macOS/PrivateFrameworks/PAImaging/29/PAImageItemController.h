...
#import "PAUnadjustedCompositionProvider.h"

@class NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_group>, NSString, PADescriptionEditController, PAImageItem;
