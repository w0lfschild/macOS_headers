...
- (id)initWithKCDataStackshotThread:(const struct thread_snapshot_v2 *)arg1 withName:(id)arg2 andLeafUserFrame:(id)arg3 andLeafKernelFrame:(id)arg4 andMachTimebase:(struct mach_timebase_info)arg5 andWaitInfo:(id)arg6;
