...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, PABinaryLocator, PAGenealogyTracker, PAImageInfo, PAMountStatusTracker, PASampleTimeInsensitiveTaskData, PASymbolDataStore, PAWSUpdateDataStore;
