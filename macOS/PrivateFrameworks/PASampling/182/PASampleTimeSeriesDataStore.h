...
- (BOOL)addKCDataThreadV4:(const struct thread_snapshot_v4 *)arg1 orKCDataThreadV2:(const struct thread_snapshot_v2 *)arg2 orDeltaThread:(const struct thread_delta_snapshot_v2 *)arg3 withStack:(id)arg4 andName:(const char *)arg5 andWaitInfo:(const struct stackshot_thread_waitinfo *)arg6 toTask:(id)arg7 withCurrentThreads:(id)arg8 withPreviousThreads:(id)arg9;
