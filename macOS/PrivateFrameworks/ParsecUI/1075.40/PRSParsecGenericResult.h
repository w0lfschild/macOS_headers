...
#import <ParsecUI/PRSGenericResult-Protocol.h>

@class NSArray, NSDictionary, NSImage, NSString, NSURL, PRSActionButton, SFPunchout, SFSearchResult;
...
@interface PRSParsecGenericResult : PRSParsecResult <PRSGenericResult>
{
    ...
    NSString *footnote;
    NSImage *thumbnail;
    unsigned long long title_maxlines;
    unsigned long long title_size;
    unsigned long long title_weight;
    NSURL *card_url;
...
@property(nonatomic) unsigned long long title_weight; // @synthesize title_weight;
@property(nonatomic) unsigned long long title_size; // @synthesize title_size;
@property(nonatomic) unsigned long long title_maxlines; // @synthesize title_maxlines;
@property int thumbnail_align; // @synthesize thumbnail_align;
