...
#import <ParsecUI/PRSMoviesSliceView.h>

@class NSImageView, NSLayoutConstraint, NSTextField, PRSTextView;
...
@interface PRSThreeMoviesSliceView : PRSMoviesSliceView
{
    ...
    PRSTextView *_subtitleTextView1;
    PRSTextView *_subtitleTextView2;
    PRSTextView *_subtitleTextView3;
...
@property PRSTextView *subtitleTextView3; // @synthesize subtitleTextView3=_subtitleTextView3;
@property PRSTextView *subtitleTextView2; // @synthesize subtitleTextView2=_subtitleTextView2;
@property PRSTextView *subtitleTextView1; // @synthesize subtitleTextView1=_subtitleTextView1;
