...
+ (void)baselineAlignBottomView:(id)arg1 toTopView:(id)arg2 spacing:(double)arg3 minimum:(BOOL)arg4;
...
+ (id)alignView:(id)arg1 attribute:(long long)arg2 toView:(id)arg3 attribute:(long long)arg4 constant:(double)arg5 isMaximumSpacing:(BOOL)arg6;
...
+ (id)alignLeadingView:(id)arg1 toTrailingView:(id)arg2 spacing:(double)arg3 isMaximumRequiredSpacing:(BOOL)arg4;
