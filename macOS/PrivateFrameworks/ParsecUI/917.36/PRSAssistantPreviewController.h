...
@interface PRSAssistantPreviewController : PRSPreviewController <PRSPreviewControllerDelegate, NSTableViewDelegate, NSTableViewDataSource>
{
...
- (void)userDidEngageWithSlice:(id)arg1 actionType:(unsigned long long)arg2 URL:(id)arg3;
