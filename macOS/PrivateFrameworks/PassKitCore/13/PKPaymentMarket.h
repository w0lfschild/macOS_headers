...
@interface PKPaymentMarket : NSObject <NSSecureCoding>
{
    ...
    BOOL _shouldConsiderCelluarRegion;
    long long _type;
...
- (void).cxx_destruct;
@property(readonly) BOOL shouldConsiderCelluarRegion; // @synthesize shouldConsiderCelluarRegion=_shouldConsiderCelluarRegion;
