...
@class CLGeocoder, CLLocationManager, NSDictionary, NSMutableArray, NSMutableSet, NSObject<OS_dispatch_source>, NSString, PKMerchantCategoryCodeMap, PKUsageNotificationServer;
