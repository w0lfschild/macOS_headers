...
@class PKOpenGLContext, PKOpenGLView;

@interface PKOpenGLLayer : CAOpenGLLayer
{
    PKOpenGLContext *_glContext;
    PKOpenGLView *_view;
...
@property(nonatomic) __weak PKOpenGLView *view; // @synthesize view=_view;
- (void).cxx_destruct;
