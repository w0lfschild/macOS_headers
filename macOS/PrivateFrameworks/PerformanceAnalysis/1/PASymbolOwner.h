...
- (id)initWithCSSymbolOwnerRef:(struct _CSTypeRef)arg1 andPath:(const char *)arg2;
- (id)initWithUUID:(id)arg1 andPath:(const char *)arg2;
- (void)incorporateDataFromPACSSymbolOwner:(id)arg1;
- (void)incorporateDataFromCSSymbolOwner:(struct _CSTypeRef)arg1 andPath:(const char *)arg2;
