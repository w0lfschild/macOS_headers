...
@property(readonly) unsigned long long totalLeakedNodes; // @synthesize totalLeakedNodes;
@property(readonly) unsigned long long totalLeakedBytes; // @synthesize totalLeakedBytes;
