...
@property(nonatomic) unsigned int lastValidIteration; // @synthesize lastValidIteration;
@property(nonatomic) unsigned int firstValidIteration; // @synthesize firstValidIteration;
