...
- (id)initWithMutableAggregatedItem:(id)arg1 scoringDate:(id)arg2 overrideDecayRate:(BOOL)arg3 decayRateOverride:(float)arg4 sourceStats:(id)arg5 calendar:(id)arg6 strictFiltering:(BOOL)arg7;
