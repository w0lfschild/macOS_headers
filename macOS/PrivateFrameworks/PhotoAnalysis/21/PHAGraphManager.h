...
@class NSConditionLock, NSMutableSet, PFDirectMessagingMulticaster<PHAGraphManagerClientMessagesMulticaster>, PFSerialQueue, PFWeakContainer, PGGraphUpdateManager, PGManager, PHAManager;
