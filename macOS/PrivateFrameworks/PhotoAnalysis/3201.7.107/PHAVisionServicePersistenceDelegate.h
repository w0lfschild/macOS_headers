...
- (BOOL)_completePersonBuildingWithPersonsToUpdate:(id)arg1 facesToRemoveByPerson:(id)arg2 facesToAddByPerson:(id)arg3 updateFaceGroup:(id)arg4 mergeCandidatePairsToAdd:(id)arg5 mergeCandidatePairsToRemove:(id)arg6 faceByCSN:(id)arg7 personCache:(id)arg8 keyFaceUpdateBlock:(CDUnknownBlockType)arg9 canceler:(id)arg10 context:(id)arg11 error:(id *)arg12;
...
- (void)_getTrainingFacesByPerson:(id *)arg1 confirmedFaceCSNs:(id *)arg2 faceCSNsByPerson:(id *)arg3 faceCSNsByMigratedPerson:(id *)arg4 mergeCandidates:(id *)arg5 invalidMergeCandidates:(id *)arg6 faceByCSN:(id *)arg7 inFaces:(id)arg8 personCache:(id)arg9 canceler:(id)arg10;
...
- (id)_facesInPerson:(id)arg1;
- (BOOL)recordNeedToPersonBuildOnFaceGroupContainingFace:(id)arg1 error:(id *)arg2;
- (BOOL)deleteEmptyGroupsAndReturnError:(id *)arg1;
- (BOOL)deleteFaceGroupsAndResetClusterSequenceNumberOfFaces:(id *)arg1;
- (BOOL)persistChangesToAlgorithmicFaceGroups:(id)arg1 facesToUpdate:(id)arg2 canceler:(id)arg3 clusterSequenceNumbersOfFacesNotPersisted:(id)arg4 toBeReclusteredFaceLocalIdentifiers:(id)arg5 persistenceHandlerBlock:(CDUnknownBlockType)arg6 error:(id *)arg7;
...
- (id)fetchResultForFacesFromFaceGroupWithMostNumberOfFacesOnPerson:(id)arg1 options:(id)arg2 error:(id *)arg3;
...
- (BOOL)unclusterFaces:(id)arg1 error:(id *)arg2;
