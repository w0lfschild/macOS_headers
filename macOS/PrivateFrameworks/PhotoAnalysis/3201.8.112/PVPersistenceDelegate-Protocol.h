...
- (BOOL)persistChangesToAlgorithmicFaceGroups:(NSDictionary *)arg1 facesToUpdate:(NSDictionary *)arg2 canceler:(PVCanceler *)arg3 clusterSequenceNumbersOfFacesNotPersisted:(NSMutableSet *)arg4 toBeReclusteredFaceLocalIdentifiers:(NSMutableSet *)arg5 persistenceHandlerBlock:(void (^)(void))arg6 error:(id *)arg7;
...
- (BOOL)unclusterFaces:(NSArray *)arg1 error:(id *)arg2;
