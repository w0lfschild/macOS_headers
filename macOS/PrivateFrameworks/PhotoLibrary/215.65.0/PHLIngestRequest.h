...
- (id)initWithMasterAsset:(id)arg1 renderedAsset:(id)arg2 thumbnailAsset:(id)arg3 miniThumbnailAsset:(id)arg4 adjustments:(id)arg5 metadataProperties:(id)arg6 userInfo:(id)arg7 options:(long long)arg8;
