...
@property(readonly, nonatomic) LiRidList *modelIds; // @synthesize modelIds=_modelIds;
- (void).cxx_destruct;
...
- (id)initWithReplyStatus:(unsigned char)arg1 forRequest:(id)arg2 modelIds:(id)arg3;
