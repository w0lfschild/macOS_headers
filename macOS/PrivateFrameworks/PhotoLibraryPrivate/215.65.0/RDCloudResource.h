...
+ (void)deleteAllCloudResourcesWithIdentifiers:(id)arg1 fromDatabase:(id)arg2 withReason:(unsigned int)arg3 completionHandler:(CDUnknownBlockType)arg4;
+ (id)derivativeVideoResourceTypes;
+ (id)derivativeImageResourceTypes;
+ (id)findFirstCloudResource:(id)arg1 withTypes:(id)arg2;
+ (id)findFirstCloudResourceForModel:(id)arg1 withTypes:(id)arg2;
...
+ (void)deleteCloudResourceWithDatabase:(id)arg1 reason:(unsigned int)arg2 option:(unsigned char)arg3 completionHander:(CDUnknownBlockType)arg4;
