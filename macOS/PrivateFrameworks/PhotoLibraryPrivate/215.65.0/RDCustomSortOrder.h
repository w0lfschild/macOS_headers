...
+ (id)removeUuids:(id)arg1 fromDatabase:(id)arg2 withReason:(unsigned int)arg3;
+ (id)containersWithCustomOrdersContainingAnyOfUuids:(id)arg1 fromDatabase:(id)arg2;
+ (void)removeFromAllCustomOrders:(id)arg1 fromDatabase:(id)arg2 withReason:(unsigned int)arg3;
...
- (id)removeUuids:(id)arg1 withReason:(unsigned int)arg2;
...
- (void)renumberOrder;
- (void)deleteCustomOrderWithReason:(unsigned int)arg1;
- (BOOL)loadCustomOrder;
- (id)resetCustomOrderTo:(id)arg1 withReason:(unsigned int)arg2;
