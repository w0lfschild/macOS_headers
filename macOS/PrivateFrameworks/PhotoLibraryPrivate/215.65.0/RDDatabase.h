...
@class LiSearchKitIndex, NSString, PFBSMResourceIdentifier, PFCache, PFMulticaster, RDPhotoModelClient, RDQueryResultMgr, RDVolumeCache;
...
@interface RDDatabase : RDLibrary <PFBSMResourceIdentification>
{
    ...
    RDQueryResultMgr *_queryResultMgr;
...
@property(readonly, nonatomic) RDQueryResultMgr *queryResultMgr; // @synthesize queryResultMgr=_queryResultMgr;
...
- (unsigned long long)countOfUnsupportedImagesInMoments;
