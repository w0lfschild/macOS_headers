...
+ (void)deleteFolders:(id)arg1 withReason:(unsigned int)arg2;
+ (id)trashFolderForDatabase:(id)arg1;
+ (id)removeFromTrash:(id)arg1 recoverVersions:(BOOL)arg2 recoverChildren:(BOOL)arg3 withReason:(unsigned int)arg4;
...
- (id)setParentFolder:(id)arg1 skipCustomOrderFixup:(BOOL)arg2;
- (id)setParentFolder:(id)arg1;
- (void)changeParentFolderTo:(id)arg1 from:(id)arg2 changes:(id)arg3;
- (id)folderNotInTrash;
...
- (id)_deleteFolder;
- (void)deleteFolderWithReason:(unsigned int)arg1;
