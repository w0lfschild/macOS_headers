...
@interface RDPlaceForVersionTable : RDTable
{
    LiKeyPath *_versionIdKeyPath;
    LiKeyPath *_placeIdKeyPath;
}
...
+ (id)modelName;
+ (Class)modelClass;
@property(readonly, nonatomic) LiKeyPath *placeIdKeyPath; // @synthesize placeIdKeyPath=_placeIdKeyPath;
...
- (void)createPlaceForVersionForPlaceId:(id)arg1 versionId:(id)arg2;
