...
@class LiRidList, NSArray, NSMutableArray, RDAlbum, RDDatabase, RDLibrarySearch, RDMemory;
...
@interface RDLibrarySearchResult : NSObject
{
    ...
    LiRidList *_lowConfidenceAssets;
...
- (void).cxx_destruct;
- (unsigned long long)highConfidenceResultCount;
- (BOOL)containsLowConfidenceSceneResults;
...
- (void)addVersion_locked:(id)arg1 isHighConfidence:(BOOL)arg2;
