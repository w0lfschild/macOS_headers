...
+ (void)loadMasterForReadOnlyVersions:(id)arg1 count:(unsigned long long)arg2 database:(id)arg3 withProperties:(id)arg4 sync:(BOOL)arg5;
+ (void)loadImageProxyStateForReadOnlyVersions:(id)arg1 count:(unsigned long long)arg2 database:(id)arg3 withProperties:(id)arg4 sync:(BOOL)arg5;
...
- (void).cxx_destruct;
- (void)didInsertIntoTransactionContext;
...
- (void)insertAnalysisState:(int)arg1 lastIgnoredDate:(id)arg2 ignoreUntilDate:(id)arg3 workerType:(short)arg4 workerFlags:(int)arg5;
- (void)insertAnalysisStates;
...
- (id)copyImageFileWithoutVideoComplementMetadataFromURL:(id)arg1 error:(id *)arg2;
...
- (void)obtainWriteAccessToFaceTile:(unsigned long long)arg1 toURLWithHandler:(CDUnknownBlockType)arg2;
- (void)obtainWriteAccessToFaceTileForFaceLocalIdentifier:(id)arg1 toURLWithHandler:(CDUnknownBlockType)arg2;
- (void)obtainReadAccessToFaceTileForFace:(id)arg1 toURLWithHandler:(CDUnknownBlockType)arg2;
- (void)obtainReadAccessToFaceTileForFaceLocalIdentifier:(id)arg1 toURLWithHandler:(CDUnknownBlockType)arg2;
