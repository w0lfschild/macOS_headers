...
+ (id)arrangedBuiltInMediaTypeAlbumUUIDs;
...
+ (id)queryAlbumFromDatabase:(id)arg1 uuid:(id)arg2 folder:(id)arg3 queryType:(int)arg4 key:(id)arg5 qualifier:(int)arg6 firstValue:(id)arg7 secondValue:(id)arg8;
+ (id)versionQueryFromDatabase:(id)arg1 uuid:(id)arg2 key:(id)arg3 qualifier:(int)arg4 firstValue:(id)arg5 secondValue:(id)arg6;
