...
@interface RDPersonInvalidMergeCandidatePersonTable : RDTable
{
    LiKeyPath *_personIdKeyPath;
    LiKeyPath *_invalidMergeCandidatePersonIdKeyPath;
}
...
+ (id)modelName;
+ (Class)modelClass;
@property(readonly, nonatomic) LiKeyPath *invalidMergeCandidatePersonIdKeyPath; // @synthesize invalidMergeCandidatePersonIdKeyPath=_invalidMergeCandidatePersonIdKeyPath;
