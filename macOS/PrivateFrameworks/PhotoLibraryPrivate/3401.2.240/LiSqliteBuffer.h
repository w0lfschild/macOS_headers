...
- (long long)optimisticLockForRow:(unsigned long long)arg1 locality:(struct BufferSegment *)arg2;
- (long long)rowForModelId:(unsigned long long)arg1;
- (long long)modelIdForRow:(unsigned long long)arg1 locality:(struct BufferSegment *)arg2;
- (const char *)getBytesForRow:(unsigned long long)arg1 forColumn:(unsigned long long)arg2 length:(unsigned long long *)arg3 isNull:(char *)arg4 locality:(struct BufferSegment *)arg5;
- (id)getDataForRow:(unsigned long long)arg1 forColumn:(unsigned long long)arg2 locality:(struct BufferSegment *)arg3;
- (id)getStringForRow:(unsigned long long)arg1 forColumn:(unsigned long long)arg2 locality:(struct BufferSegment *)arg3;
- (const char *)getCharsForRow:(unsigned long long)arg1 forColumn:(unsigned long long)arg2 length:(unsigned long long *)arg3 locality:(struct BufferSegment *)arg4;
- (double)getDoubleForRow:(unsigned long long)arg1 forColumn:(unsigned long long)arg2 isNull:(char *)arg3 locality:(struct BufferSegment *)arg4;
- (long long)getIntegerForRow:(unsigned long long)arg1 forColumn:(unsigned long long)arg2 isNull:(char *)arg3 locality:(struct BufferSegment *)arg4;
- (id)objectForRow:(unsigned long long)arg1 forColumn:(unsigned long long)arg2 stringMapper:(Class)arg3 locality:(struct BufferSegment *)arg4;
- (BOOL)isNullForRow:(unsigned long long)arg1 forColumn:(unsigned long long)arg2 locality:(struct BufferSegment *)arg3;
- (struct BufferSegment *)currentBufferLocality;
- (struct BufferSegment *)bufferLocality;
...
- (BOOL)moveBufferLocality:(struct BufferSegment **)arg1 toRow:(unsigned long long)arg2;
