...
#import <PhotoLibraryPrivate/RDMemoryExtendedCuratedVersionModel.h>

@class NSString;

@interface RDMemoryExtendedCuratedVersion : RDMemoryExtendedCuratedVersionModel
{
}
...
+ (id)setVersionIds:(id)arg1 forMemory:(id)arg2;
