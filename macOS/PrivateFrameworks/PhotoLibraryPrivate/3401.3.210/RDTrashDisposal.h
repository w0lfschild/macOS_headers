...
+ (void)emptyTrashForDatabase:(id)arg1 withReason:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;
+ (void)emptyTrashItemsImmediatelyForModelIds:(id)arg1 option:(unsigned char)arg2 withReason:(unsigned short)arg3 completionHandler:(CDUnknownBlockType)arg4;
+ (double)trashDisposalPolicyTimeInterval;
+ (unsigned long long)trashDisposalPolicyDays;
+ (void)emptyTrashForDatabase:(id)arg1 andModelIds:(id)arg2 option:(unsigned char)arg3 withReason:(unsigned short)arg4 completionHandler:(CDUnknownBlockType)arg5;
+ (void)serviceEmptyTrashForDatabase:(id)arg1 withReason:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;
+ (void)serviceEmptyTrashItemsImmediatelyForDatabase:(id)arg1 andModelIds:(id)arg2 option:(unsigned char)arg3 withReason:(unsigned short)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void).cxx_destruct;
- (id)init;
- (void)putModelIdsInTrash:(id)arg1 table:(id)arg2 isInTrashKeyPath:(id)arg3 inTrashDateKeyPath:(id)arg4 lastModifiedDateKeyPath:(id)arg5 withReason:(unsigned short)arg6;
- (void)finishWithReason:(unsigned short)arg1;
- (void)executeWithReason:(unsigned short)arg1;
- (void)prepareWithReason:(unsigned short)arg1;
