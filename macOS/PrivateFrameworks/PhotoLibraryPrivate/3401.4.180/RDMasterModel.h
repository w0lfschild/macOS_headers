...
+ (Class)tableClass;
@property(nonatomic) long long cloudImportedBy;
@property(copy, nonatomic) NSString *groupingUuid;
@property(nonatomic) BOOL isCloudQuarantined;
@property(nonatomic) BOOL hasCheckedMediaGroupId;
@property(copy, nonatomic) NSString *mediaGroupId;
...
@property(readonly, copy, nonatomic) NSString *streamAssetId;
