...
@interface RDFaceGroupTable : RDTable
{
    ...
    LiKeyPath *_personBuilderStateKeyPath;
}
...
+ (id)modelName;
+ (Class)modelClass;
@property(readonly, nonatomic) LiKeyPath *personBuilderStateKeyPath; // @synthesize personBuilderStateKeyPath=_personBuilderStateKeyPath;
