...
- (void).cxx_destruct;
@property(retain) NSString *sceneTaxonomyHash;
...
@property long long unverifiedFaceCountThreshold;
...
@property(retain) NSString *sceneLocale;
@property(retain) NSString *lastLocale;
...
@property BOOL faceCropIsEnabled;
