...
+ (BOOL)canSubtypeBeUsedAsPreview:(unsigned short)arg1;
...
- (id)metadataAccessFile:(BOOL)arg1 updateMediaProperties:(BOOL)arg2;
- (id)metadata;
- (id)oldestVersion;
- (id)oldestVersionFromVersions:(id)arg1;
- (id)alternateMaster;
- (long long)nextVersionNumber;
- (id)allVersionsIncludingAlternateMasterWithPropertyKeys:(id)arg1;
...
- (id)extension;
- (void)initializePropertiesWithMetadata:(id)arg1 withFilePath:(id)arg2;
...
- (id)newReferencedVideoComplementWithURL:(id)arg1 volumeId:(long long)arg2 error:(id *)arg3;
- (id)newManagedVideoComplementWithURL:(id)arg1 hardLink:(BOOL)arg2 error:(id *)arg3;
- (id)newManagedVideoComplementWithError:(id *)arg1;
- (id)newVideoComplementMetadataWithModelResource:(id)arg1 updateModels:(BOOL)arg2;
