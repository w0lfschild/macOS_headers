...
- (id)newPlaceholderImageForFormat:(unsigned short)arg1 photoImageSize:(struct CGSize)arg2;
...
- (id)_cacheKeyForFormat:(id)arg1 photoImageSize:(struct CGSize)arg2 photoImageColor:(id)arg3;
- (id)init;
