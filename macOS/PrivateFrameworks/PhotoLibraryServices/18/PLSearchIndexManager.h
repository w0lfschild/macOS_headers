...
@class NSCountedSet, NSDictionary, NSHashTable, NSMutableDictionary, NSObject<OS_dispatch_queue>, PLClientServerTransaction, PLPhotoLibrary, PLPhotoLibraryPathManager, PLSearchIndexDateFormatter, PLSearchMetadataStore, PLThrottleTimer, PLZeroKeywordStore, PSIDatabase;
