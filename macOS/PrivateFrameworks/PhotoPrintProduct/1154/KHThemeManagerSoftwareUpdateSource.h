...
#import "KHThemeManagerCatalogedSource.h"

@class KHThemeManager, NSCache, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, NSURL, NSXPCConnection;
