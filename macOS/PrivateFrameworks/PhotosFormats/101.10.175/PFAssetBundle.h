...
- (id)initWithOriginalVideoURL:(id)arg1 fullSizeRenderedVideoURL:(id)arg2 adjustmentBaseVideoURL:(id)arg3 adjustmentsURL:(id)arg4 originalAdjustmentsURL:(id)arg5 mediaSubtypes:(unsigned long long)arg6 playbackStyle:(long long)arg7;
- (id)initWithOriginalPhotoURL:(id)arg1 alternatePhotoURL:(id)arg2 fullSizePhotoURL:(id)arg3 adjustmentBaseFullSizePhotoURL:(id)arg4 originalPairedVideoURL:(id)arg5 fullSizePairedVideoURL:(id)arg6 adjustmentBaseFullSizePairedVideoURL:(id)arg7 fullSizeVideoURL:(id)arg8 adjustmentsURL:(id)arg9 originalAdjustmentsURL:(id)arg10 mediaSubtypes:(unsigned long long)arg11 playbackStyle:(long long)arg12 playbackVariation:(unsigned long long)arg13;
- (id)initWithOriginalPhotoURL:(id)arg1 alternatePhotoURL:(id)arg2 fullSizePhotoURL:(id)arg3 adjustmentBaseFullSizePhotoURL:(id)arg4 adjustmentsURL:(id)arg5 originalAdjustmentsURL:(id)arg6 mediaSubtypes:(unsigned long long)arg7 playbackStyle:(long long)arg8 playbackVariation:(unsigned long long)arg9;
