...
@property(nonatomic, getter=isScreenSupported) BOOL screenSupported; // @synthesize screenSupported=_screenSupported;
...
- (void)_updateScreenSupportedIfNeeded;
- (void)_invalidateScreenSupported;
