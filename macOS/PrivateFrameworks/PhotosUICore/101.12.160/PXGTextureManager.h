...
@class NSArray, NSDictionary, NSHashTable, NSIndexSet, NSMapTable, NSMutableDictionary, NSObject<OS_dispatch_queue>, PXGTextureManagerPreheatingStrategy, PXGViewEnvironment;
