...
@interface PXCuratedLibrarySettings : PXSettings
{
    ...
    BOOL _showSectionSelectAllButtons;
...
@property(nonatomic) BOOL showSectionSelectAllButtons; // @synthesize showSectionSelectAllButtons=_showSectionSelectAllButtons;
