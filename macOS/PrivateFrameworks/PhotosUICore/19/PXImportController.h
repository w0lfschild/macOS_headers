...
#import "PXImportAssetsDataSourceManagerDelegate.h"
#import "PXMutableImportController.h"

@class NSArray, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<PXImportControllerImportCompletionDelegate>, NSProgress, NSString, NSTimer, PHAssetCollection, PHImportSource, PHPhotoLibrary, PXImportAssetsDataSourceManager, PXImportDeleteAction, PXImportMediaLoadingCoordinator, PXImportMediaProvider, PXImportSessionInfo, PXPowerController, PXSectionedSelectionManager, PXSelectionSnapshot;
