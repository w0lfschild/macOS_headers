...
@class NSArray, NSDictionary, NSHashTable, NSIndexSet, NSMapTable, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, PXGTextureManagerPreheatingStrategy, PXGViewEnvironment;
