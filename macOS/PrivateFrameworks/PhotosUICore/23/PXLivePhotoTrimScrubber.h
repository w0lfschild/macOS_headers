...
@class AVAsset, AVVideoComposition, NSArray, NSImage, PXLivePhotoTrimScrubberHiddenAnimationHelper, PXLivePhotoTrimScrubberLoupeView, PXLivePhotoTrimScrubberSpec, PXTrimScrubberLayoutHelper, UXImageView, UXView<PXLivePhotoTrimScrubberFilmStripView>;
