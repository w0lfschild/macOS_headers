...
#import "PXGImageRequestPerformer.h"

@class NSArray, NSMapTable, NSMutableDictionary, NSMutableIndexSet, NSObject<OS_dispatch_queue>, NSString, PXGAssetImageCache, PXGImageRequestQueue, PXGThumbnailRequestQueue, PXMediaProvider;
