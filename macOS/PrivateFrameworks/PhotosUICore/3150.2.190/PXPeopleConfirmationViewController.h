...
@class NSProgressIndicator, NSString, NSTimer, PXAnimatedHeaderView, PXPeopleConfirmationSummaryViewController, PXPeopleSuggestionManager, PXPeopleSuggestionView, UXLabel, UXView;
...
@interface PXPeopleConfirmationViewController : UXViewController <PXPeopleSuggestionManagerDelegate, PXPeopleSummaryDelegate>
{
    ...
    UXLabel *_noneFoundStatusLabel;
    NSProgressIndicator *_initialLoadingIndicator;
...
@property(retain) NSTimer *loadingDelayTimer; // @synthesize loadingDelayTimer=_loadingDelayTimer;
...
@property(retain) NSProgressIndicator *initialLoadingIndicator; // @synthesize initialLoadingIndicator=_initialLoadingIndicator;
@property(retain) UXLabel *noneFoundStatusLabel; // @synthesize noneFoundStatusLabel=_noneFoundStatusLabel;
@property(retain) UXView *loadingStatusView; // @synthesize loadingStatusView=_loadingStatusView;
@property(retain) UXView *loadingView; // @synthesize loadingView=_loadingView;
@property(nonatomic) unsigned long long viewState; // @synthesize viewState=_viewState;
@property(retain) NSProgressIndicator *interimLoadingIndicator; // @synthesize interimLoadingIndicator=_interimLoadingIndicator;
@property(retain) UXLabel *interimLoadingLabel; // @synthesize interimLoadingLabel=_interimLoadingLabel;
