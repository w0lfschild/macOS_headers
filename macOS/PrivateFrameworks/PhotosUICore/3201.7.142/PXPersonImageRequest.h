...
- (void).cxx_destruct;
- (void)cancel;
- (void)requestImageWithTargetSize:(struct CGSize)arg1 cropFactor:(unsigned long long)arg2 cacheResult:(BOOL)arg3 timeout:(double)arg4 withCompletion:(CDUnknownBlockType)arg5;
- (void)dealloc;
