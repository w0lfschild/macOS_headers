...
#import "PXCuratedLibraryAssetsDataSourceManagerDelegate.h"
#import "PXInfoProvider.h"
#import "PXInfoUpdaterObserver.h"
#import "PXMutablePhotosLibraryViewModel.h"

@class NSArray, NSHashTable, NSMutableSet, NSObject<OS_dispatch_queue>, NSSet, NSString, PXAssetReference, PXAssetsDataSource, PXCPLServiceUI, PXCuratedLibraryActionManager, PXCuratedLibraryAllPhotosAlphaAnimator, PXCuratedLibraryAnalysisStatus, PXCuratedLibraryAssetCollectionSkimmingInfo, PXCuratedLibraryAssetsDataSourceManager, PXCuratedLibraryLayoutSpecManager, PXCuratedLibraryStyleGuide, PXInfoUpdater, PXNumberAnimator, PXScrollViewSpeedometer, PXSectionedSelectionManager, PXSelectionSnapshot, PXUpdater, UXBarButtonItem;
...
@interface PXCuratedLibraryViewModel : PXObservable <PXMutablePhotosLibraryViewModel, PXCuratedLibraryAssetsDataSourceManagerDelegate, PXChangeObserver, PXAssetsDataSourceManagerObserver, PXInfoProvider, PXInfoUpdaterObserver>
{
    ...
    BOOL _allPhotosWantsSpaceForHeader;
    BOOL _allPhotosShowsSpaceForHeader;
...
@property(nonatomic) BOOL allPhotosShowsSpaceForHeader; // @synthesize allPhotosShowsSpaceForHeader=_allPhotosShowsSpaceForHeader;
@property(readonly, nonatomic) BOOL allPhotosWantsSpaceForHeader; // @synthesize allPhotosWantsSpaceForHeader=_allPhotosWantsSpaceForHeader;
...
- (void)setAllPhotosWantsSpaceForHeader:(BOOL)arg1;
