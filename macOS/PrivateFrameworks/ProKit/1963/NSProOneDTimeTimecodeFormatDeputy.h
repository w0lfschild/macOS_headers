...
@interface NSProOneDTimeTimecodeFormatDeputy : NSProFormatDeputy <NSCoding, NSCopying>
{
...
- (id)defaultNilSymbol;
- (double)privateScaleOfSegmentWithTag:(long long)arg1 inObjectValue:(id)arg2;
- (double)privateScaleFactorForSegmentTag:(long long)arg1 inObjectValue:(id)arg2;
- (long long)privateTagOfLowestOrderSegmentInObjectValue:(id)arg1;
- (long long)privateFractionalSegmentCount;
- (long long)privateIntegerSegmentCountInObjectValue:(id)arg1;
- (long long)privateIntegerDigitCountInObjectValue:(id)arg1;
- (id)init;
