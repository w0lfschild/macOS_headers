...
#import <ProKit/NSProCommonAssetStorage.h>

@interface NSProMutableCommonAssetStorage : NSProCommonAssetStorage
{
...
- (void)setColor:(struct _rgbquad)arg1 forName:(const char *)arg2 andLook:(struct _themelook *)arg3 excludeFromFilter:(BOOL)arg4;
...
- (void)setValidLook:(unsigned int)arg1;
