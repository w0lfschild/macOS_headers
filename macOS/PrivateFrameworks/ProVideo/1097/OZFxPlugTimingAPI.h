...
-     // Error parsing type: r^{OZSceneSettings=^^?iiIBIdBd{AtomicWorkingGamut={atomic<PCWorkingGamutValue>=Ai}}ii{PCColor={ColorComponents=i[5d]}{PCColorSpaceHandle=^{CGColorSpace}}}iBIIdBBdi{PCString=^{__CFString}}IIdIIIBfiBiBiiBi{FigTime={?=qiIq}}B}16@0:8, name: sceneSettings
