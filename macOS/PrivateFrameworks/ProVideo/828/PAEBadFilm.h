...
-     // Error parsing type: v68@0:8i16i20^d24i32i36i40^{HGBitmap=^^?{atomic<unsigned int>=AI}ii{HGRect=iiii}{HGRect=iiii}QQQ^v^v{HGEdgePolicy=i[4f]}^{HGObject}}44(?=d^{?})52r^{PCMatrix44Tmpl<double>=[4[4d]]}60, name: createDust:scratches:scratchColor:hair:randomSeed:autoRandFreq:buffer:atTime:pixelTransform:
