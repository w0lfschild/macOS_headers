...
- (void)registerImpressionWithPreResponseItems:(id)arg1 language:(id)arg2 isCached:(BOOL)arg3 responseTimePerf:(unsigned long long)arg4 promptMessage:(id)arg5;
