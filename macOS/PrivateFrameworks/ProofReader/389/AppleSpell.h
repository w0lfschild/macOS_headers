...
@interface AppleSpell : NSObject
{
    ...
    struct __CFDictionary *_phraseLexiconDict;
...
- (void)_addLanguageModelCompletionsForPrefix:(id)arg1 languageModel:(void *)arg2 language:(id)arg3 connection:(struct _PR_DB_IO *)arg4 sender:(id)arg5 encoding:(unsigned int)arg6 capitalized:(BOOL)arg7 candidates:(id)arg8;
...
- (struct __CFArray *)phraseLexiconsForLanguage:(id)arg1;
...
- (unsigned int)_tokenIDForString:(id)arg1 languageModel:(void *)arg2 language:(id)arg3 terminatorTokenID:(unsigned int)arg4;
- (unsigned int)_tokenIDForString:(id)arg1 languageModel:(void *)arg2 language:(id)arg3 createIfAbsent:(BOOL)arg4 terminatorTokenID:(unsigned int)arg5;
...
- (void)addSpaceCorrectionForString:(id)arg1 range:(struct _NSRange)arg2 inString:(id)arg3 offset:(unsigned long long)arg4 tagger:(id)arg5 language:(id)arg6 connection:(struct _PR_DB_IO *)arg7 toGuesses:(id)arg8;
...
- (id)spellServer:(id)arg1 suggestCompletionsForKoreanPartialWordRange:(struct _NSRange)arg2 inString:(id)arg3 options:(id)arg4;
