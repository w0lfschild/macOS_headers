...
@class NSArray, NSMutableOrderedSet, NSString, NSXPCConnection, RPCompanionLinkDevice;
...
@property(nonatomic) BOOL reportBTPipe; // @synthesize reportBTPipe=_reportBTPipe;
