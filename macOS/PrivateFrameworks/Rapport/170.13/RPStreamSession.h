...
- (void).cxx_destruct;
- (void)_updateTrafficRegistrationForIP:(const CDUnion_4a4a8072 *)arg1;
...
- (void)_serverUDPNWPathNextWithEndpoint:(id)arg1 selfIPString:(id)arg2 selfMACData:(id)arg3 peerIP:(CDUnion_4a4a8072)arg4 peerMACData:(id)arg5 responseHandler:(CDUnknownBlockType)arg6;
- (void)_serverUDPNWPathStartRequest:(id)arg1 options:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;
- (void)_clientUDPNWPathStartResponse:(id)arg1 options:(id)arg2 localEndpoint:(id)arg3 selfIPString:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)_clientUDPNWPathNextWithEndpoint:(id)arg1 selfIPString:(id)arg2 selfMACData:(id)arg3 completion:(CDUnknownBlockType)arg4;
