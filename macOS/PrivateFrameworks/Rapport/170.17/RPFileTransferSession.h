...
@class CUBonjourAdvertiser, CUBonjourBrowser, CUBonjourDevice, CUTCPServer, CUWiFiManager, NSData, NSString, NSURL, RPConnection, RPFileTransferItem, RPFileTransferProgress, RPFileTransferSendEntry, RPIdentity;
...
- (void)_receivedFileComplete:(unsigned long long)arg1 label:(const char *)arg2;
...
- (void)_sendNextIO:(id)arg1 data:(id)arg2 done:(_Bool)arg3 ioError:(int)arg4 entry:(id)arg5;
