...
- (void)_serverUDPNWPathNextWithEndpoint:(id)arg1 selfAddressString:(id)arg2 peerAddr:(CDUnion_4a4a8072)arg3 responseHandler:(CDUnknownBlockType)arg4;
- (void)_serverUDPNWPathStartRequest:(id)arg1 options:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;
- (void)_clientUDPNWPathStartResponse:(id)arg1 options:(id)arg2 localEndpoint:(id)arg3 selfAddressString:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)_clientUDPNWPathNextWithEndpoint:(id)arg1 selfAddressString:(id)arg2 completion:(CDUnknownBlockType)arg3;
