...
@class CUBLEConnection, CUBluetoothScalablePipe, CUBonjourDevice, CUHomeKitManager, CUNetLinkManager, CUPairingSession, CUPairingStream, CUTCPConnection, NSData, NSDictionary, NSError, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, NSUUID, RPCompanionLinkDevice, RPIdentity, RPIdentityDaemon;
