...
@class CUBonjourAdvertiser, CUBonjourBrowser, CUBonjourDevice, CUCoalescer, CUTCPServer, CUWiFiManager, NSData, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, NSURL, RPConnection, RPFileTransferProgress, RPIdentity;
