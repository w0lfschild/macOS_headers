...
@class CUPairingManager, NSButton, NSProgressIndicator, NSString, NSTableView, NSTextField, RPDeviceDiscovery, RPPairingManagerUIController, RPPairingUIController, RPSession;
