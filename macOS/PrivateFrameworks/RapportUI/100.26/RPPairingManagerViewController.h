...
#import <RapportUI/NSMenuDelegate-Protocol.h>
#import <RapportUI/NSTableViewDataSource-Protocol.h>
#import <RapportUI/NSTableViewDelegate-Protocol.h>

@class CUPairingManager, NSButton, NSProgressIndicator, NSString, NSTableView, NSTextField, RPDevice, RPDeviceDiscovery, RPPairingManagerUIController, RPPairingUIController, RPSession;

__attribute__((visibility("hidden")))
@interface RPPairingManagerViewController : NSViewController <NSMenuDelegate, NSTableViewDataSource, NSTableViewDelegate>
{
...
- (void)handleRemoveMenuItem:(id)arg1;
