...
- (BOOL)_isValidConfigurationResource:(id)arg1 allowedToReachEndpoint:(BOOL)arg2;
- (BOOL)_areConfigurationResourcesValid:(id)arg1 allowedToReachEndpoint:(BOOL)arg2 requestKeys:(id)arg3;
