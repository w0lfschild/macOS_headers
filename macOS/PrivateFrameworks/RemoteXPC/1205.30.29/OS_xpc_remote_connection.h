...
@property(retain) OS_xpc_remote_message *msgq_tail; // @synthesize msgq_tail=_msgq_tail;
@property(retain) OS_xpc_remote_message *msgq_head; // @synthesize msgq_head=_msgq_head;
