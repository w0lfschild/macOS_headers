...
- (void)set9PartImage:(struct CGImage *)arg1 transform:(struct CGAffineTransform)arg2 destinationRect:(struct CGRect)arg3 capInsets:(CDStruct_d2b197d1)arg4 repeat:(BOOL)arg5 interpolation:(int)arg6 tintColor:(CDStruct_0b1c536a)arg7 flags:(unsigned int)arg8;
- (void)setTiledSurface:(id)arg1 transform:(struct CGAffineTransform)arg2 sourceRect:(struct CGRect)arg3 interpolation:(int)arg4 tintColor:(CDStruct_0b1c536a)arg5 flags:(unsigned int)arg6;
...
- (void)setSurface:(id)arg1 transform:(struct CGAffineTransform)arg2 interpolation:(int)arg3 tintColor:(CDStruct_0b1c536a)arg4 flags:(unsigned int)arg5;
