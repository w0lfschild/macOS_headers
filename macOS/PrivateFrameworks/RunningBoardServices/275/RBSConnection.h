...
#import "RBSClientProtocol.h"
#import "RBSServiceLocalProtocol.h"

@class NSHashTable, NSMapTable, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_xpc_object>, RBSAssertionIdentifier, RBSProcessHandle, RBSProcessIdentity;
