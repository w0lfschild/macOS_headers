...
@class FMXPCServiceDescription, FMXPCSession, FMXPCTimer, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, SPMacBeaconConfig, SPMonitorsWrapper;
