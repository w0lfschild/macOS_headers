...
@class NSArray, NSDate, NSDateInterval, NSUUID, SPBeacon, SPCommand;
...
- (oneway void)latestLocationsForIdentifiers:(NSArray *)arg1 fetchLimit:(NSDate *)arg2 completion:(void (^)(NSDictionary *))arg3;
