...
+ (void)beginBookmarkEditSheetWithBookmark:(id)arg1 restrictedToBookmarksBar:(BOOL)arg2 titleOnly:(BOOL)arg3 modalForWindow:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
