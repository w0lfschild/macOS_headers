...
+ (id)cloudTabForBrowserTab:(const struct BrowserTab *)arg1;
+ (BOOL)browserTabQualifiesForUserActivityContinuation:(const struct BrowserTab *)arg1;
+ (BOOL)browserTabQualifiesForCloudTabSyncing:(const struct BrowserTab *)arg1;
