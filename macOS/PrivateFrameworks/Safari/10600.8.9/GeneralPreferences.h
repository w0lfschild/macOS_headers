...
@interface GeneralPreferences : PreferencesModule <BookmarkChooserDelegate>
{
    ...
    struct unique_ptr<Safari::ObjCNotifier, std::__1::default_delete<Safari::ObjCNotifier>> m_notifier;
...
@property(retain, nonatomic) NSLayoutConstraint *launchBehaviorPopupTopSpaceToDefaultBrowserPopupConstraint; // @synthesize launchBehaviorPopupTopSpaceToDefaultBrowserPopupConstraint=_launchBehaviorPopupTopSpaceToDefaultBrowserPopupConstraint;
