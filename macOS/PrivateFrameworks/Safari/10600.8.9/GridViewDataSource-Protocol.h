...
@class GridCellView, GridView, NSArray, NSDictionary, NSDraggingSession, NSURL;
...
- (NSArray *)gridView:(GridView *)arg1 namesOfPromisedFilesDroppedAtDestination:(NSURL *)arg2 forDraggedCellWithIndex:(unsigned long long)arg3;
