...
@class HistoryBookmarkSource, HistorySpotlightDataSource, HistoryTextCache, NSArray, NSMutableDictionary, NSString, NSTimer;
...
+ (id)sharedHistory;
@property(readonly, nonatomic) HistoryBookmarkSource *bookmarkSource; // @synthesize bookmarkSource=_bookmarkSource;
- (id).cxx_construct;
- (void).cxx_destruct;
...
- (void)savePendingChangesBeforeTermination:(CDUnknownBlockType)arg1;
