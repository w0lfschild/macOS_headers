...
@class NSClickGestureRecognizer, NSProgressIndicator, NSString, NSTextField, NSURL, NSView, PagePreviewAnimationController, SearchableWKView, WKView;

__attribute__((visibility("hidden")))
@interface PagePreviewViewController : NSViewController <NSPopoverDelegate>
{
    struct CGSize _mainViewSize;
    NSView *_innerScaledContainerView;
