...
- (struct BrowserContentViewController *)goToURLFromExternalApplication:(id)arg1 forcingHTMLMIMEType:(BOOL)arg2 openInNewPrivateWindowIfNecessary:(BOOL)arg3 preferSelectingExistingTabWithoutReloading:(BOOL)arg4;
