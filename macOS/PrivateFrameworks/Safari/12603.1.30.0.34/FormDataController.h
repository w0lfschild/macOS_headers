...
- (id)test_peopleWithSameFullNameAsPerson:(id)arg1 candidates:(id)arg2;
- (id)test_peopleWithFullNameContainingPrefix:(id)arg1 addressBook:(id)arg2;
- (id)test_peopleWithAddressBookProperty:(id)arg1 containingPrefix:(id)arg2 addressBook:(id)arg3;
...
- (id)_peopleWithSameFullNameAsPerson:(id)arg1 candidates:(id)arg2;
...
- (id)_peopleWithFullNameCompositeContainingPrefix:(id)arg1 addressBook:(id)arg2;
- (id)_peopleWithWBSABProperty:(id)arg1 containingPrefix:(id)arg2 addressBook:(id)arg3;
