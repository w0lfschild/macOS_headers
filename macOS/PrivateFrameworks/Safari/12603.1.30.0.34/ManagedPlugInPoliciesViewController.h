...
@class ManagedPlugIn, NSArray, NSLayoutConstraint, NSMutableSet, NSOutlineView, NSPopUpButton, NSScrollView, NSString, NSTextField, NSView, SegmentedControlWithDynamicWidth;
