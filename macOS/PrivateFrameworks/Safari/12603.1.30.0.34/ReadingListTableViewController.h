...
- (void)_configureContentProviderToDisplayInitialSetOfItemsForSidebarBounds:(struct CGRect)arg1;
...
- (double)_heightOfCellViewForItem:(id)arg1 withWidth:(double)arg2;
