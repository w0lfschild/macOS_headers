...
@class CALayer, CompletionListTableView, DelayedPopUpRolloverImageButton, InteriorUnifiedField, NSButton, NSColor, NSEvent, NSImage, NSImageView, NSString, NSTimer, NSTrackingArea, NSURL, NSView, OneStepBookmarkingButton, RolloverImageButton, TextFieldThatIgnoresClicks, WBSFluidProgressState, WebBookmark;
