...
@class AVFunctionBarScrubber, AccordionHostViewController, ButtonFunctionBarItem, FavoritesPickerFunctionBarProvider, MediaPlaybackControlsHostViewController, NSButton, NSCustomTouchBarItem, NSMutableArray, NSString, NSTouchBar, NSWindow, PopoverTouchBarItemPlus, UnifiedFieldButtonHostViewController, VisualScrubberViewController;
...
- (id)visualScrubberViewController:(id)arg1 viewForItemAtIndex:(unsigned long long)arg2 wantsHugging:(char *)arg3 sizeObservationKey:(id *)arg4;
...
@property(nonatomic) __weak AVFunctionBarScrubber *mediaPlaybackControlsView;
