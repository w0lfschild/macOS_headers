...
@class AVFunctionBarScrubber, WebBookmarkLeaf, WindowFunctionBarProvider;

@protocol WindowFunctionBarProviderDelegate <NSObject>

@optional
- (AVFunctionBarScrubber *)mediaPlaybackControlsViewForFunctionBarProvider:(WindowFunctionBarProvider *)arg1;
