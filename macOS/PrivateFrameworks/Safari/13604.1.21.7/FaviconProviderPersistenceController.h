...
@class FaviconProviderDatabaseController, FaviconProviderRecordCache, NSMutableDictionary, NSString, NSURL, WBSOnDiskDataCache;
...
@interface FaviconProviderPersistenceController : NSObject <WBSDataCacheDelegate, WBSSQLiteStoreDelegate>
{
    ...
    NSMutableDictionary *_iconUUIDToSetOfCompletionsDictionary;
