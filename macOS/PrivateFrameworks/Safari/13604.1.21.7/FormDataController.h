...
@class NSString, WBSFormAutoFillCorrectionManager, WBSFormAutoFillParsecFeedbackProcessor;
...
- (void)_findAllContactsWithSameFullNameAsContact:(id)arg1 andGetValuesForContactFormWithCompletionController:(struct FormCompletionController *)arg2 metadata:(id)arg3 inDomain:(id)arg4 contactLabel:(id)arg5;
