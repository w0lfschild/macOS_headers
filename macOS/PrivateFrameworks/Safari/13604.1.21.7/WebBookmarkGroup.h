...
@interface WebBookmarkGroup : NSObject
{
    ...
    BOOL _cloudKitMergeModeEnabled;
...
@property(nonatomic, getter=isCloudKitMergeModeEnabled) BOOL cloudKitMergeModeEnabled; // @synthesize cloudKitMergeModeEnabled=_cloudKitMergeModeEnabled;
