...
@class FaviconRequestsController, ManagedPlugInPoliciesViewController, ManagedWebGLPoliciesViewController, NSArray, NSBox, NSButton, NSCache, NSDictionary, NSLayoutConstraint, NSOutlineView, NSPopUpButton, NSString, NSTableView, NSTextField, NSView, NotificationPreferencesController;
...
- (double)_maximumWidthOfPreferenceContent;
...
- (void)_cacheFavicon:(id)arg1 forItem:(id)arg2;
