...
@class AnnotatedBookmarksSidebarViewController, AutomaticReadingListSidebarViewController, BookmarkFolderPickerMenuController, BookmarksSidebarViewController, NSMenu, NSString, NSView, ReadingListSidebarViewController, SidebarContainerView, SidebarTopBarView;
