...
@class KeychainEncryptionProvider, NSString, WBSFormAutoFillCorrectionManager, WBSFormAutoFillParsecFeedbackProcessor;
...
- (int)sendAutoFillDataForStandardForm:(id)arg1 inViewController:(struct BrowserContentViewController *)arg2 frame:(const struct Frame *)arg3 usingOnlyAddressBookData:(BOOL)arg4 contactLabel:(id)arg5 multiRoundAutoFillManager:(id)arg6 contact:(id)arg7 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(BOOL)arg8;
