...
#import <Safari/ManagedPlugInDelegate-Protocol.h>
#import <Safari/WebsitesKnownToUsePlugInsControllerDelegate-Protocol.h>

@class ManagedPlugIn, NSMutableDictionary, NSString, WebsitesKnownToUsePlugInsController;

__attribute__((visibility("hidden")))
@interface ManagedPlugInsController : NSObject <WebsitesKnownToUsePlugInsControllerDelegate, ManagedPlugInDelegate>
{
...
- (void)_addPolicyToContextForBothWwwAndNonWwwPrefixedHostname:(id)arg1 policy:(int)arg2 hostname:(id)arg3 plugInIdentifier:(id)arg4 plugInVersion:(id)arg5 context:(struct Context)arg6;
