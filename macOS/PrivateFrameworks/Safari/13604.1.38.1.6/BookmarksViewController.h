...
@class BarBackground, BookmarksSearcher, FaviconRequestsController, NSButton, NSSearchField, NSString, NSTableColumn, NSTextField, OutlineViewPlus, WebBookmark;
...
- (void)_requestImageForCell:(id)arg1 imageURLString:(id)arg2 item:(id)arg3 token:(id)arg4;
