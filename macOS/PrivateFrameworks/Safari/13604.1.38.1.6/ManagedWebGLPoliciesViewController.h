...
@class FaviconRequestsController, NSArray, NSButton, NSLayoutConstraint, NSOutlineView, NSPopUpButton, NSSegmentedControl, NSString, NSTextField, NSView, SegmentedControlWithDynamicWidth;
