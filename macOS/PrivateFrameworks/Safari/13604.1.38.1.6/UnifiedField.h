...
@class CALayer, CompletionListTableView, DelayedPopUpRolloverImageButton, FaviconRequestsController, InteriorUnifiedField, NSButton, NSColor, NSEvent, NSImage, NSImageView, NSString, NSTimer, NSTrackingArea, NSURL, NSView, OneStepBookmarkingButton, RolloverImageButton, TextFieldThatIgnoresClicks, WBSFluidProgressState, WebBookmark;
