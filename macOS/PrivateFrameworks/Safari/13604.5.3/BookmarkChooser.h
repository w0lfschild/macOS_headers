...
@class FaviconRequestsController, NSButton, NSOutlineView, NSSplitView, NSString, NSTableView, NSTextField;
...
@interface BookmarkChooser : NSWindowController <NSOutlineViewDataSource, NSOutlineViewDelegate, NSTableViewDataSource, NSTableViewDelegate>
{
    ...
    FaviconRequestsController *_tableRequestsController;
    FaviconRequestsController *_outlineRequestsController;
