...
@interface CombinedFavoritesController : NSObject
{
    ...
    Vector_ca0b6db7 _frequentlyVisitedSites;
...
@property(readonly, nonatomic) const Vector_ca0b6db7 *frequentlyVisitedSites; // @synthesize frequentlyVisitedSites=_frequentlyVisitedSites;
- (id).cxx_construct;
- (void).cxx_destruct;
...
- (BOOL)_refreshFrequentlyVisitedSitesIfNecessary:(const Vector_ca0b6db7 *)arg1 updateCacheIfChanged:(BOOL)arg2;
