...
@property(readonly, nonatomic) Vector_766715e7 allowedDomainPatterns;
- (id)initWithDictionary:(id)arg1;
- (id)initWithAccessLevel:(int)arg1 allowedDomainPatterns:(Vector_766715e7)arg2 hasInjectedContent:(BOOL)arg3;
