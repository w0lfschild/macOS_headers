...
@class FaviconResponse, NSArray, NSURL, WBSTemplateIconResponse, WBSTouchIconResponse;
...
@interface FavoritesPickerImageResponseState : NSObject
{
    ...
    FaviconResponse *_faviconResponse;
...
@property(retain, nonatomic) FaviconResponse *faviconResponse; // @synthesize faviconResponse=_faviconResponse;
