...
#import <Safari/VoiceOverStateChangeObserver-Protocol.h>
...
- (void)_sortTopSites:(const Vector_ca0b6db7 *)arg1 inVector:(Vector_ca0b6db7 *)arg2 withIndexExchanges:(id)arg3;
