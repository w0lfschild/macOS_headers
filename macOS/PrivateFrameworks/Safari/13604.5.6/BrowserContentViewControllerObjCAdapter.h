...
#import <Safari/SearchableWKViewIconLoadingDelegate-Protocol.h>
...
@class AutoFillFunctionBarProvider, BackgroundLoad, BookmarksView, BookmarksViewController, BrowserTabPersistentState, BrowserTabViewItem, BrowserWindowController, CKContextCompleter, CKContextResponse, ContinuousReadingListPageItem, ContinuousReadingListViewController, DefaultBrowserBanner, FullscreenUnifiedFieldWindowController, JavaScriptDialogSuppressionManager, NSArray, NSDictionary, NSHashTable, NSMutableArray, NSMutableDictionary, NSString, NSTimer, NSURL, NSView, NSWindow, PointerLockBanner, PrintSheetSuppressionManager, PrivateBrowsingExplanationBanner, ReadingListItem, ResponsiveDesignViewController, SearchableWKView, SecIdentitiesCache, StartPageViewController, StatusMessage, TabContentView, TabDialogPresentationManager, TabDialogViewController, UnresponsiveWebProcessHandler, WBSFluidProgressState, WBSFormMetadata, WBSHistoryVisit, WBSMultiRoundAutoFillManager, WBSSameDocumentNavigationToHistoryVisitCorrelator, WebClipBanner, WebCrashBanner, _WKRemoteObjectInterface;
@protocol AppExtensionMessageReceiver, FormAutoFiller, RemoteNotificationStateObserver, WBSCertificateWarningPagePresenter;

__attribute__((visibility("hidden")))
@interface BrowserContentViewControllerObjCAdapter : WebContentController <AppExtensionContentScriptMessageReceiver, AutomaticBugCaptureObserver, FormMetadataObserver, TabDialogPresentationManagerDelegate, WebClipBannerDelegate, RemoteNotificationPermissionHandler, ReaderStateObserver, SearchableWKViewIconLoadingDelegate, WBSCertificateWarningPageHandler, AutoFillFunctionBarProviderDelegate, AuthenticationSheetRequestDelegate, DimmingViewDelegate, ReaderActivationDelegate, ReaderAvailabilityDelegate, SearchableWKViewCancelDelegate, TabDialogPresenter, WBSFluidProgressStateSource>
{
    ...
    int _loadingStatus;
    unsigned int _lastBackgroundTerminationReason;
    int _lastUsedStartPageMode;
    NSString *_authenticationHost;
    BrowserContentViewControllerObjCAdapter *_originatingContentViewControllerWithPossibleJavaScriptAccess;
    ...
    CKContextResponse *_querySuggestionsResponse;
    Vector_95200c29 _ancestorIdentifiers;
}
...
@property(retain) CKContextResponse *querySuggestionsResponse; // @synthesize querySuggestionsResponse=_querySuggestionsResponse;
...
@property(nonatomic) unsigned int lastBackgroundTerminationReason; // @synthesize lastBackgroundTerminationReason=_lastBackgroundTerminationReason;
...
@property(nonatomic) __weak BrowserContentViewControllerObjCAdapter *originatingContentViewControllerWithPossibleJavaScriptAccess; // @synthesize originatingContentViewControllerWithPossibleJavaScriptAccess=_originatingContentViewControllerWithPossibleJavaScriptAccess;
@property(readonly, nonatomic) Vector_95200c29 ancestorIdentifiers; // @synthesize ancestorIdentifiers=_ancestorIdentifiers;
...
@property(readonly, nonatomic) id <RemoteNotificationStateObserver> remoteNotificationStateObserver;
...
- (void)searchableWKView:(id)arg1 didFindIconWithParameters:(id)arg2 downloadHandler:(CDUnknownBlockType)arg3;
...
- (void)didExceedBackgroundResourceLimitWhileInForegroundWithLimit:(unsigned int)arg1;
- (void)hideWebCrashBannerAnimated:(BOOL)arg1;
- (void)_showWebCrashBannerAnimated:(BOOL)arg1 type:(long long)arg2;
- (void)showWebCrashBannerAnimated:(BOOL)arg1 terminationReason:(unsigned int)arg2;
...
- (void)didExtractReaderText:(id)arg1;
...
- (void)filledFormOrFieldWithFormMetadata:(const struct Data *)arg1 withGeneratedPasswordInFrame:(const struct Frame *)arg2;
...
- (void)manualAutoFillButtonClickedInAddressBookAutoFillableFieldMetadata:(const struct Dictionary *)arg1 formMetadata:(const struct Data *)arg2 inFrame:(const struct Frame *)arg3;
- (void)manualAutoFillButtonClickedInPasswordFieldMetadata:(const struct Dictionary *)arg1 formMetadata:(const struct Data *)arg2 inFrame:(const struct Frame *)arg3;
...
- (BOOL)shouldPerformActionInFormTextFieldWithMetadata:(const struct Dictionary *)arg1 formMetadata:(const struct Data *)arg2 inFrame:(const struct Frame *)arg3 uncheckedActionType:(unsigned long long)arg4;
...
- (void)textFieldDidEndEditingInFrame:(const struct Frame *)arg1 textFieldMetadata:(const struct Dictionary *)arg2;
...
- (void)_showHTTPAuthenticationDialogForChallenge:(const struct AuthenticationChallenge *)arg1;
...
@property(readonly, nonatomic) NSURL *unifiedFieldFallbackURLForAboutBlank;
...
- (void)_setSheetRequest:(RefPtr_77557de5 *)arg1;
...
- (void)_setDeferredNavigation:(unique_ptr_c6cdb193)arg1 shouldInformQueuedNavigationController:(BOOL)arg2;
- (void)goNowIfInQueue;
- (void)initiateEnqueuedNavigation;
- (void)clearQueuedNavigation:(struct QueuedNavigation *)arg1;
- (void)enqueueRestoredNavigation:(id)arg1 withTabState:(id)arg2;
...
- (BOOL)_handleCertificateError:(id)arg1 forPage:(const struct Page *)arg2 frameType:(long long)arg3;
...
- (void)didFinishNavigationProgress;
