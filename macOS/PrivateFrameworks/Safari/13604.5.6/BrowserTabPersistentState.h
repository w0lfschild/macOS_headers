...
{
    Vector_95200c29 _ancestorTabIdentifiers;
...
@property(readonly, nonatomic) const Vector_95200c29 *ancestorTabIdentifiers; // @synthesize ancestorTabIdentifiers=_ancestorTabIdentifiers;
