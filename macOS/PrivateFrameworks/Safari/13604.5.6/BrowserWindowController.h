...
@interface BrowserWindowController : WindowController <BackgroundLoadControllerDelegate, BrowserWindowContentSplitViewControllerDelegate, FormTextStatusWatcherDelegate, NSTabViewDelegate, OverlayStatusWindowDelegate, TabDraggingWindowDestination, TabBarViewDelegate, ToolbarControllerDelegate, UnifiedFieldSecurityUIManagerDelegate, VisualTabPickerDelegate, FavoritesPickerVisibilityController, FavoritesPickerVisibilityManagerDataSource, WindowFunctionBarProviderDataSource, WindowFunctionBarProviderDelegate, WBSFluidProgressRocketEffectDelegate, BrowserContentLoaderDelegate, BrowserWindowDelegate, Command1Through9Receiver, ImageHopAnimationDelegate, NSMenuDelegate, NSSplitViewDelegate, ReopensAtLaunch, SearchableWKViewPlaybackControlsPresenter, UnifiedFieldDelegate, WBSFluidProgressControllerWindowDelegate>
{
    ...
    Vector_20dc20dc _extensionBars;
...
- (void)_insertExtensionBars:(const Vector_20dc20dc *)arg1 withAnimation:(BOOL)arg2;
...
- (void)_toggleFullScreenTitlebarViewController:(id)arg1 withAnimation:(BOOL)arg2 isShowing:(BOOL)arg3;
...
- (struct BrowserContentViewController *)_browserContentViewControllerToInstallBookmarksOrHistoryView;
...
- (RefPtr_c76da075)_selectedParsecCompletionListItem;
