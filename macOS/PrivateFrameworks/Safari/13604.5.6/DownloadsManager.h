...
@interface DownloadsManager : NSObject <AuthenticationSheetRequestDelegate, WebDownloadDelegate>
{
...
- (id)_stringForInsufficientDiskSpaceMessageWithFileName:(id)arg1 volumeName:(id)arg2;
...
- (id)_createEntryForRequest:(id)arg1 allowOverwrite:(BOOL)arg2 shouldAvoidPersistingIdentifyingInformation:(BOOL)arg3;
- (id)_createEntryForWKDownload:(const struct Download *)arg1;
- (id)_createEntryForWKDownload:(const struct Download *)arg1 allowOverwrite:(BOOL)arg2 shouldAvoidPersistingIdentifyingInformation:(BOOL)arg3;
...
- (void)setEntry:(id)arg1 forWK2Download:(const struct Download *)arg2;
...
- (void)cancelDownloadForEntry:(id)arg1;
- (void)stopAllDownloads;
- (void)startDownloadForRequest:(id)arg1 mayOpenWhenDone:(BOOL)arg2 allowOverwrite:(BOOL)arg3 shouldAvoidPersistingIdentifyingInformation:(BOOL)arg4 shouldUseRequestURLAsOriginURLIfNecessary:(BOOL)arg5 path:(id)arg6 tags:(id)arg7;
- (void)startDownloadForRequest:(id)arg1 mayOpenWhenDone:(BOOL)arg2 shouldAvoidPersistingIdentifyingInformation:(BOOL)arg3;
