...
+ (BOOL)_atLeastOneCompletionListSectionHasChangedBetweenList:(const Vector_92056f5f *)arg1 list:(const Vector_92056f5f *)arg2;
+ (id)simplifiedURLStringForURLString:(id)arg1;
+ (BOOL)wantsFavoritesViewInCompletionList;
- (void).cxx_destruct;
- (BOOL)_shouldPostAXRefreshNotificationWithOldList:(const Vector_92056f5f *)arg1 newListItems:(const Vector_92056f5f *)arg2;
...
- (void)willUpdateCompletionListFromList:(const Vector_92056f5f *)arg1 toList:(const Vector_92056f5f *)arg2;
