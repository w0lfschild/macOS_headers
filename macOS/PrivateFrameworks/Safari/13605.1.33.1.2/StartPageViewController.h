...
@class BrowserViewController, CombinedFavoritesGridViewController, KeyLoopSplicingContainerView, NSLayoutConstraint, NSString, NSView, TestDriveMigrationBannerViewController, TopSitesViewController;
