...
@class AutoplayPreferenceManager, AutoplayQuirkWhitelistManager, BookmarksMenuController, BrowserSessionPersistentState, BrowserTabViewItem, ClosedTabOrWindowStateManager, ContentBlockersPreferenceManager, DomainWhitelistManager, DownloadAlertsManager, DownloadsManager, ExternalJavaScriptEvaluationPolicyController, FaviconProvider, FormTextStatusWatcher, LaunchTimePerformanceMonitor, ManagedPlugInsController, ManagedPlugInsControllerHistoryListener, NSAlert, NSArray, NSMenu, NSMenuItem, NSMutableArray, NSMutableSet, NSStatusItem, NSString, NSTimer, NSUserActivity, SFAuthorization, SafariAutomationController, TabSnapshotSensitiveDataPurger, WBSAutomaticReaderActivationManager, WBSCoalescedAsynchronousWriter, WBSCyclerConnectionManager, WBSFormAutoFillCorrectionsHistoryObserver, WBSQuickWebsiteSearchController, WBSSiteMetadataManager, WBSTabDialogManager, WKPreferences, WKProcessPool, WKUserContentController, ZoomPreferenceManager;
...
@property(readonly, nonatomic) WKPreferences *contentPreferences;
