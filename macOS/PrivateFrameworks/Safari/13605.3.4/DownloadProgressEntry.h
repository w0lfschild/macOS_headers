...
@class BrowserWindowController, DownloadFile, DownloadFileUnarchiver, NSArray, NSDate, NSDictionary, NSError, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSProgress, NSSet, NSString, NSTimer, NSURL, NSURLDownload, NSURLRequest, NSURLResponse, WBSCoalescedAsynchronousWriter;
@protocol DownloadProgressEntryDelegate, OS_dispatch_queue, WebDownloadDelegate;
