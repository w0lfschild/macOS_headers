...
@class DownloadProgressEntry, NSDate, NSString, NSURLDownload;
...
- (void)downloadProgressEntry:(DownloadProgressEntry *)arg1 didResumeWithDownload:(NSURLDownload *)arg2;
@end
