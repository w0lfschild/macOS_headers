...
@class AuthorizationRequest, CreditCardNumberFieldEditor, NSArray, NSButton, NSLayoutConstraint, NSMutableSet, NSString, NSTextField;
...
@interface CreditCardDataEditor : SheetWithTableController <PanelPlusDelegate, CreditCardDataEditorCellViewDelegate, NSTableViewDataSource, NSTableViewDelegate>
{
    ...
    NSMutableSet *_hasFullCardNumberVirtualCardsSet;
    BOOL _skipFirstResponderCheck;
