...
- (void)willSubmitFormContainingCreditCardData:(id)arg1 lastFilledCreditCardData:(id)arg2 toFrame:(const struct Frame *)arg3 fromFrame:(const struct Frame *)arg4 finishedSavingFormDataHandler:(struct ScopeExitHandler *)arg5;
