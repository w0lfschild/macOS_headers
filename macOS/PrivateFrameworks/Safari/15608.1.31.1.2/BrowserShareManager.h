...
- (BOOL)_removeSharingServiceWithName:(id)arg1 fromArray:(id)arg2;
- (BOOL)_sharingService:(id)arg1 supportsPDFForURL:(id)arg2;
...
- (id)_browserSharingServiceForService:(id)arg1 items:(id)arg2 isForRecentsSection:(BOOL)arg3 handler:(CDUnknownBlockType)arg4;
