...
- (id)_safari_roamingCachesDirectory;
- (id)_safari_localCachesDirectory;
...
- (BOOL)safari_applyQuarantineSandboxAndDownloadFlagsToFileAtPath:(id)arg1;
- (BOOL)safari_setQuarantineInformationForFilePath:(id)arg1 originURL:(id)arg2 dataURL:(id)arg3 shouldSetPrivacySensitiveQuarantineProperties:(BOOL)arg4;
- (BOOL)safari_setQuarantineInformationForFilePath:(id)arg1 downloadRequest:(id)arg2 shouldSetPrivacySensitiveQuarantineProperties:(BOOL)arg3 shouldUseRequestURLAsOriginURLIfNecessary:(BOOL)arg4;
- (BOOL)safari_setQuarantineInformationForFilePath:(id)arg1 downloadRequest:(id)arg2 shouldSetPrivacySensitiveQuarantineProperties:(BOOL)arg3;
