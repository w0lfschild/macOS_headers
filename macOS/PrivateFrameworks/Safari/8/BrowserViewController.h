...
- (void)_printFrame:(const struct Frame *)arg1 withPrintInfo:(id)arg2;
- (void)_printFrame:(const struct Frame *)arg1;
...
- (BOOL)_isHTMLPage;
- (id)_printHelper;
- (void)_showPrintSheetBlockedDialogForFrame:(const struct Frame *)arg1;
- (void)_handleNextPrintRequest;
- (void)printFrameHandle:(id)arg1 isUserInitiated:(BOOL)arg2;
- (void)printFrame:(const struct Frame *)arg1 isUserInitiated:(BOOL)arg2;
