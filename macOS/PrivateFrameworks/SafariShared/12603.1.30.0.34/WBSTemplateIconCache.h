...
- (void)_requestFallbackIconForHostIfNeeded:(id)arg1;
...
- (void)_updateTemplateIconsDataForHost:(id)arg1 image:(id)arg2 themeColor:(id)arg3 isFallback:(BOOL)arg4;
...
- (void)_saveTemplateIconToDisk:(id)arg1 withThemeColor:(id)arg2 forHost:(id)arg3 isFallback:(BOOL)arg4;
- (void)saveTemplateIconToDisk:(id)arg1 withThemeColor:(id)arg2 forHost:(id)arg3;
- (void)saveTemplateIconAtURL:(id)arg1 withThemeColor:(id)arg2 forHost:(id)arg3;
...
- (void)_requestTemplateIconForHost:(id)arg1;
