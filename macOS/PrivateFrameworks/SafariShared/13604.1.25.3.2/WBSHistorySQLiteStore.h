...
@protocol OS_dispatch_queue, WBSFileLock, WBSFileLockFactory, WBSHistoryStoreDelegate;
...
@interface WBSHistorySQLiteStore : NSObject <WBSHistoryLoaderDelegate, WBSHistoryStore, WBSHistoryLoader>
{
    ...
    id <WBSFileLockFactory> _databaseLockFactory;
    id <WBSFileLock> _databaseLock;
