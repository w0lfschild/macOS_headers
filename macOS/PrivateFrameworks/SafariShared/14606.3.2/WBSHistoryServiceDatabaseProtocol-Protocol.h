...
- (void)addAutocompleteTrigger:(NSString *)arg1 forItem:(long long)arg2 completionHandler:(void (^)(NSError *))arg3;
...
- (void)clearHistoryItems:(NSSet *)arg1 afterDate:(NSDate *)arg2 beforeDate:(NSDate *)arg3 insertTombstone:(BOOL)arg4 completionHandler:(void (^)(NSError *))arg5;
