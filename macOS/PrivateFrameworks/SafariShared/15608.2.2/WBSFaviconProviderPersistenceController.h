...
#import "WBSDataCacheDelegate.h"
#import "WBSSQLiteStoreDelegate.h"

@class NSObject<OS_dispatch_queue>, NSString, NSURL, WBSFaviconProviderDatabaseController, WBSFaviconProviderPrivateCache, WBSFaviconProviderRecordCache, WBSOnDiskDataCache;
