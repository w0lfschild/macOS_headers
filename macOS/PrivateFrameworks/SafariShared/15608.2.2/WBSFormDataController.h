...
@class NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, WBSAutoFillQuirksManager, WBSKeychainCredentialNotificationMonitor, WBSPair, WBSURLCredentialCache;
