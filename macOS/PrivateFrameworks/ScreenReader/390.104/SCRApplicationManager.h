...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, SCRApplication, SCRCThreadKey, SCRDictationApplication, SCRSystemUIServerApplication;
...
- (void)_registerApplicationWithPSN:(struct ProcessSerialNumber)arg1;
...
- (id)_threadKey;
- (id)stop;
- (void)startWithTargetApplications:(id)arg1;
- (void)dealloc;
