...
#import <ScreenReader/SCRGuideViewMenuDataSourceProtocol-Protocol.h>
#import <ScreenReader/SCRGuideViewMenuDelegateProtocol-Protocol.h>
...
@interface SCRGuide : NSObject <SCRGuideViewMenuDataSourceProtocol, SCRGuideViewMenuDelegateProtocol>
{
    NSString *_title;
    SCRGuide *_subguide;
...
- (BOOL)shouldUseDefaultHeightForGuideViewMenu:(id)arg1;
