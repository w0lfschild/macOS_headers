...
+ (int)nativeSafariSearchForEvent:(id)arg1;
...
- (id)_createPersistentKeyForFocusedChildAttributesWithURL:(id)arg1;
...
- (BOOL)_outputSelectedTextWithEvent:(id)arg1 request:(id)arg2 webArea:(id)arg3 direction:(int)arg4;
