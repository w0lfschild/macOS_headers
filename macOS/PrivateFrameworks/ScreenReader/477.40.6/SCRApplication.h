...
@class NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSURL, SCRBrailleLineManager, SCRCTargetSelectorTimer, SCRCThreadKey, SCREvent, SCRMenu, SCROutputSharedFocusManager, SCRUIElement;
...
- (id)_remoteElementsForContainerUIElement:(id)arg1 withSearchKeys:(id)arg2 limit:(unsigned long long)arg3 startResult:(id)arg4 searchText:(id)arg5;
