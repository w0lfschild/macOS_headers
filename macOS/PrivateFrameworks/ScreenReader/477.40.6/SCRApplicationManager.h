...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, SCRApplication, SCRCThreadKey, SCRDFRAgentApplication, SCRDFRUIServerApplication, SCRDictationApplication, SCRNotificationCenterApplication, SCRSystemUIServerApplication;
...
@interface SCRApplicationManager : NSObject
{
    ...
    SCRDFRAgentApplication *_dfrAgentApplication;
    SCRDFRUIServerApplication *_dfrUIServerApplication;
...
- (id)dfrUIServerApplication;
- (id)dfrAgentApplication;
...
- (id)wst_dfrUIServerApplication;
- (id)wst_dfrAgentApplication;
