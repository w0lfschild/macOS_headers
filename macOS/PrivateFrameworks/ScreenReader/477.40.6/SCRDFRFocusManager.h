...
@class NSArray, NSDate, NSString, SCRApplicationManager, SCRElement;
...
@interface SCRDFRFocusManager : NSObject <SCRObserverTarget>
{
    ...
    SCRElement *__functionRowProxyInFocusChain;
    id <SCRAXETimer> __focusValidationTimer;
}

+ (id)sortDFRElements:(id)arg1;
+ (id)validatedChildrenToFocusIntoForElement:(id)arg1;
@property(retain, nonatomic) id <SCRAXETimer> _focusValidationTimer; // @synthesize _focusValidationTimer=__focusValidationTimer;
@property(retain, nonatomic) SCRElement *_functionRowProxyInFocusChain; // @synthesize _functionRowProxyInFocusChain=__functionRowProxyInFocusChain;
...
- (BOOL)_focusOntoElement:(id)arg1 containedInsideFunctionRowProxy:(id)arg2;
...
- (id)_getRemoteElementProxiedByElement:(id)arg1;
...
- (void)_refreshFunctionRowProxies;
