...
#import <ScreenReader/SCRAXETrackingFlickGestureRecognizerDelegate-Protocol.h>
#import <ScreenReader/SCRAXETrackingHoldGestureRecognizerDelegate-Protocol.h>
#import <ScreenReader/SCRAXETrackingSplitTapGestureRecognizerDelegate-Protocol.h>
#import <ScreenReader/SCRAXETrackingTapGestureRecognizerDelegate-Protocol.h>
#import <ScreenReader/SCRAXETrackingTouchInputDeviceDelegate-Protocol.h>

@class NSDate, NSString, SCRAXEDFRDevice, SCRAXETrackingFlickGestureRecognizer, SCRAXETrackingHoldGestureRecognizer, SCRAXETrackingSplitTapGestureRecognizer, SCRAXETrackingTapGestureRecognizer, SCRAXETrackingTouchEvent, SCRApplicationManager, SCRCThreadKey, SCRDFRFocusManager, SCRElement, SCREventFactory, SCROutputManager, SCRThrottler;

__attribute__((visibility("hidden")))
@interface SCRDFRManager : NSObject <SCRAXETrackingTouchInputDeviceDelegate, SCRAXETrackingFlickGestureRecognizerDelegate, SCRAXETrackingHoldGestureRecognizerDelegate, SCRAXETrackingSplitTapGestureRecognizerDelegate, SCRAXETrackingTapGestureRecognizerDelegate>
{
    ...
    SCRAXEDFRDevice *__dfrDevice;
    SCRAXETrackingFlickGestureRecognizer *__flickGestureRecognizer;
    SCRAXETrackingTapGestureRecognizer *__singleTapGestureRecognizer;
    SCRAXETrackingTapGestureRecognizer *__doubleTapGestureRecognizer;
    SCRAXETrackingHoldGestureRecognizer *__singleTapAndHoldGestureRecognizer;
    SCRAXETrackingSplitTapGestureRecognizer *__splitTapGestureRecognizer;
    unsigned long long __currentState;
    SCRElement *__elementUnderFinger;
    NSDate *__lastEmptyHitTimestamp;
    SCRAXETrackingTouchEvent *__lastTapEvent;
...
@property(retain, nonatomic) SCRAXETrackingTouchEvent *_lastTapEvent; // @synthesize _lastTapEvent=__lastTapEvent;
...
@property(retain, nonatomic) SCRAXETrackingSplitTapGestureRecognizer *_splitTapGestureRecognizer; // @synthesize _splitTapGestureRecognizer=__splitTapGestureRecognizer;
@property(retain, nonatomic) SCRAXETrackingHoldGestureRecognizer *_singleTapAndHoldGestureRecognizer; // @synthesize _singleTapAndHoldGestureRecognizer=__singleTapAndHoldGestureRecognizer;
@property(retain, nonatomic) SCRAXETrackingTapGestureRecognizer *_doubleTapGestureRecognizer; // @synthesize _doubleTapGestureRecognizer=__doubleTapGestureRecognizer;
@property(retain, nonatomic) SCRAXETrackingTapGestureRecognizer *_singleTapGestureRecognizer; // @synthesize _singleTapGestureRecognizer=__singleTapGestureRecognizer;
@property(retain, nonatomic) SCRAXETrackingFlickGestureRecognizer *_flickGestureRecognizer; // @synthesize _flickGestureRecognizer=__flickGestureRecognizer;
@property(retain, nonatomic) SCRAXEDFRDevice *_dfrDevice; // @synthesize _dfrDevice=__dfrDevice;
