...
@class NSString, SCRChooserItemResult, SCRUIElement;

__attribute__((visibility("hidden")))
@interface SCRRemoteSearchManager : NSObject
{
    SCRUIElement *_containerElement;
...
@property(retain, nonatomic) SCRUIElement *containerElement; // @synthesize containerElement=_containerElement;
...
- (id)_resultsWithSearchKeys:(id)arg1 containerElement:(struct __AXUIElement *)arg2 searchDirection:(id)arg3 limit:(id)arg4 startResult:(id)arg5 searchText:(id)arg6 immediateDescendantsOnly:(id)arg7;
