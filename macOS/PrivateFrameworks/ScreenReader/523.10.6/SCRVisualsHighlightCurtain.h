...
@interface SCRVisualsHighlightCurtain : NSObject
{
    ...
    char *_blackCurtainCoveringAllScreensEnabled;
...
@property(nonatomic) char *blackCurtainCoveringAllScreensEnabled; // @synthesize blackCurtainCoveringAllScreensEnabled=_blackCurtainCoveringAllScreensEnabled;
