...
@interface SCROutputBrailleComponent : SCROutputTextDisplayComponent
{
    ...
    int _lineFocus;
    unsigned long long _toggledBrailleModifierKeys;
}

@property(nonatomic) unsigned long long toggledBrailleModifierKeys; // @synthesize toggledBrailleModifierKeys=_toggledBrailleModifierKeys;
