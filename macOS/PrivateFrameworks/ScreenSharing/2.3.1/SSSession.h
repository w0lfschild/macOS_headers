...
@class MessageTracerInfo, NSArray, NSDate, NSImage, NSMutableArray, NSMutableDictionary, NSRecursiveLock, NSSet, NSString, NSThread, NSTimer, SSAddress, SSConnectionOptions, SSFrameBuffer, SSScreenConfiguration, SSScreenInfo, SenderThread;
@protocol OS_dispatch_source, SSDragDelegate, SSSessionDelegate;
...
@property(retain) NSObject<SSSessionDelegate> *delegate; // @synthesize delegate=mDelegate;
