...
@property(retain) NSMatrix *askOrLoginRadioButtons; // @synthesize askOrLoginRadioButtons;
@property(retain) NSTextField *waitingMessageTextField; // @synthesize waitingMessageTextField;
@property(retain) NSButton *waitingButton; // @synthesize waitingButton;
@property(retain) NSProgressIndicator *waitingForAnswerProgress; // @synthesize waitingForAnswerProgress;
@property(retain) NSWindow *waitingForAnswerSheet; // @synthesize waitingForAnswerSheet;
