...
#import <ScreenSharing/SSAddressResolutionObserver-Protocol.h>
#import <ScreenSharing/SSConnectionProgressViewControllerDelegate-Protocol.h>
...
@property(nonatomic) BOOL assistModeWithMouseUp; // @synthesize assistModeWithMouseUp=_assistModeWithMouseUp;
