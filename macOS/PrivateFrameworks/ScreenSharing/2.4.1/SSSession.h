...
@protocol OS_dispatch_source, SSDragDelegate, SSSessionDelegate><IDSSessionDelegate;
...
- (void)stCorePostMouseEventWithX:(unsigned short)arg1 withY:(unsigned short)arg2 withButtonMask:(unsigned char)arg3 withFrameBufferCoords:(struct SSPoint)arg4 active:(BOOL)arg5;
