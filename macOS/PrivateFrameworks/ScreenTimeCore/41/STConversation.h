...
@class CNContactStore, CNDowntimeWhitelist, DMFCommunicationPolicyMonitor, DMFEmergencyModeMonitor, NSMapTable, NSObject<OS_dispatch_queue>, NSString, STManagementState;
