...
@class NSAnimation, NSButton, NSDictionary, NSImageView, NSObject<OS_dispatch_group>, NSString, NSTextField, STBlockingBackdropView, STHourglassView, STLockoutAlertController, STLockoutPolicyController;
