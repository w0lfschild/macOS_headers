...
@class NSAnimation, NSButton, NSObject<OS_dispatch_group>, NSString, NSTextField, STBlockingBackdropView, STHourglassView, STLockoutAlertController, STLockoutPolicyController;
