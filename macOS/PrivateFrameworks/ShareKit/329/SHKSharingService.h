...
+ (id)sharingServicesWithIdentifier:(id)arg1 attributes:(id)arg2 itemTypes:(id)arg3 matchingDictionary:(id)arg4 attributeStore:(id)arg5 invokedByPicker:(BOOL)arg6;
+ (id)sharingServicesWithIdentifier:(id)arg1 attributes:(id)arg2 itemTypes:(id)arg3 matchingDictionary:(id)arg4 attributeStore:(id)arg5;
...
@property(nonatomic) id <SHKSharingServiceDelegate> delegate; // @synthesize delegate=_delegate;
