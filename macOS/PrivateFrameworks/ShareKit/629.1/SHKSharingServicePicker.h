...
@class NSArray, NSDictionary, NSMenu, NSMutableArray, NSOperationQueue, NSSharingServicePicker, NSString, SHKSharingService, SHKSharingServicePickerMenuLatencyMetric;
