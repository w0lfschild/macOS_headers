...
@class CBCentralManager, CURetrier, NSArray, NSData, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSSet, NSString, WPAWDL, WPNearby, WPPairing;
