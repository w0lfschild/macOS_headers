...
#import <Sharing/NSUserNotificationCenterDelegate-Protocol.h>
#import <Sharing/SFXPCInterface-Protocol.h>

@class NSDictionary, NSString, NSURL, NSUserNotification, NSUserNotificationCenter, NSXPCConnection, SDXPCServer;
@protocol OS_dispatch_queue;

@interface SFUserNotification : NSObject <NSUserNotificationCenterDelegate, NSSecureCoding, SFXPCInterface>
{
