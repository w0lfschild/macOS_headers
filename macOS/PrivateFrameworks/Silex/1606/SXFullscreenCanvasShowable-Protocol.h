...
@class SXFullscreenCanvasController, SXFullscreenCaption, SXImageView, UIGestureRecognizer, UIView, UIViewController;
...
- (UIViewController *)fullScreenCanvasController:(SXFullscreenCanvasController *)arg1 canvasViewControllerForShowable:(id <SXFullscreenCanvasShowable>)arg2 completionBlock:(void (^)(void))arg3;
