...
@class NSString, SXDOMObjectProvider, SXLayoutBlueprintProvider, SXLayoutOptions;
@protocol SXLayoutCoordinatorDelegate, SXLayoutInstructionFactory, SXLayoutIntegrator, SXLayoutInvalidationManager, SXLayoutPipeline;
...
- (void).cxx_destruct;
- (void)startLayoutForOptions:(id)arg1 layoutBlueprint:(id)arg2 instructions:(id)arg3;
...
- (id)initWithPipeline:(id)arg1 integrator:(id)arg2 instructionFactory:(id)arg3 invalidationManager:(id)arg4 blueprintProvider:(id)arg5 DOMObjectProvider:(id)arg6;
