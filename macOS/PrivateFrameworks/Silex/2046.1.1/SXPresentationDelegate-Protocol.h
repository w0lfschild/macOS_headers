...
@class SXComponentAnimationController, SXComponentBehaviorController, SXComponentView, SXFullscreenCanvasController, SXFullscreenVideoPlaybackManager, SXMediaPlaybackController, SXPresentationAttributes, SXTangierController, UIView, UIViewController;
