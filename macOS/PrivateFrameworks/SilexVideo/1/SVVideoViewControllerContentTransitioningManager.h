...
@class NSString;
@protocol SVPlayerProviding, SVScrubbingPolicyHandling, SVVideoPlaybackProgressObserverFactory, SVVideoPlaybackProgressObserving, SVVideoPlaybackSeekerFactory, SVVideoPlaybackSeeking, SVVideoQueueProviding, SVVideoSkipLockObserverFactory, SVVideoSkipLockObserving, SVVideoVisiblePercentageManager, SVVisibilityReporting, SVVisiblePercentageReporting;
