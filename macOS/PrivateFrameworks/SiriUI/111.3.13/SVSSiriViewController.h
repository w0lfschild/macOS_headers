...
@class AFConversationStore, AFManagedStorageConnection, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString, NSTimer, SVSAceCommandRecords, SiriUIRequestOptions, SiriUISiriLanguage;
@protocol AFUISiriSession, AFUISpeechSynthesis, OS_dispatch_source, SVSSiriViewControllerHosting, SiriUIPresentation;
