...
@interface AFUISiriViewController : NSViewController <SiriUISiriViewDelegate, AFUISiriSessionLocalDataSource, AFUISiriSessionLocalDelegate, AFUIDelayedActionCommandCacheDelegate, AFMyriadDelegate>
{
    BOOL _active;
...
@property BOOL sendDidAppear; // @synthesize sendDidAppear=_sendDidAppear;
