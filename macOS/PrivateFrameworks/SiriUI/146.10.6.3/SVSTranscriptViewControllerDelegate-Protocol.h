...
@class AFUserUtteranceSelectionResults, AceObject, NSArray, NSBundle, NSString, NSURL, NSUUID, NSView, NSViewController, SASSpeechRecognized, SVSTranscriptViewController, SiriUICard;
