...
@class AFMyriadCoordinator, AFUIDelayedActionCommandCache, AFUISiriSession, NSNumber, NSObject, NSString, NSTimer, NSTrackingArea, SVSSiriViewController, SiriUIConfiguration, SiriUIRequestOptions, SiriUISiriView;
