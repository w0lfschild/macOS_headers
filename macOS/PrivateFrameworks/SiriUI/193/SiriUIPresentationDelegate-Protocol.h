...
@class AFUserUtteranceSelectionResults, AceObject<SAAceCommand>, NSArray, NSBundle, NSDictionary, NSIndexPath, NSString, NSURL, NSUUID, NSViewController, SASSpeechRecognized, SiriUICard, SiriUIRequestOptions;
