...
@class AFUserUtteranceSelectionResults, AceObject<SAAceCommand>, NSArray, NSBundle, NSIndexPath, NSString, NSURL, NSUUID, NSView, NSViewController, SASSpeechRecognized, SVSTranscriptStackViewController, SiriUICard;
