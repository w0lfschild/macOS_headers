...
#import <SocialUI/SOBuddyOutlineViewControllerDelegate-Protocol.h>

@class CNContactPicker, NSButton, NSLayoutConstraint, NSString, NSTextField, SOBuddyOutlineViewController, SOChatDetailsPopoverController, SOHeaderView, SOProgressBarViewController, SORecipientBarView, SOTokenFieldController;
