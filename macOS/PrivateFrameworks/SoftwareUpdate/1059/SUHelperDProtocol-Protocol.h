...
- (NSString *)prepAtomicUpdatesDirectory:(NSString *)arg1;
- (BOOL)armBaseSystemUpdates:(NSString *)arg1 productKey:(NSString *)arg2 error:(id *)arg3;
- (NSURLCredential *)lookupURLCredentialInSystemKeychainForHost:(NSString *)arg1 port:(long long)arg2;
- (BOOL)configureProgressPhases:(NSDictionary *)arg1;
...
- (BOOL)makeQueues;
- (BOOL)registerProductFile:(NSString *)arg1 forProductKey:(NSString *)arg2 firmware:(BOOL)arg3 trustLevel:(int *)arg4 keepOriginal:(BOOL)arg5 inForeground:(BOOL)arg6;
