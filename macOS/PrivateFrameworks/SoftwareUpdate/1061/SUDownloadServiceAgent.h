...
@property(readonly) NSObject<OS_dispatch_queue> *updateStatusQueue; // @synthesize updateStatusQueue=_updateStatusQueue;
@property(readonly) NSObject<OS_dispatch_queue> *downloadQueue; // @synthesize downloadQueue=_downloadQueue;
