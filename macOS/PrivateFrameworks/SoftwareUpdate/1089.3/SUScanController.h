...
@class NSArray, NSDate, NSDictionary, NSError, NSMutableArray, NSMutableDictionary, NSURL, SUScan;
...
@interface SUScanController : NSObject
{
    ...
    NSDictionary *_macBuddyEligibleUpdateProductInfoDict;
}

+ (id)sharedScanController;
@property(retain) NSDictionary *macBuddyEligibleUpdateProductInfoDict; // @synthesize macBuddyEligibleUpdateProductInfoDict=_macBuddyEligibleUpdateProductInfoDict;
...
- (void)refreshAvailableProductsInForegroundForMacbuddyEligibleUpdatesLimitedToProductTypes:(id)arg1 distributionEnvironment:(id)arg2 distributionEvalutionMetainfo:(id)arg3 installedPrinters:(id)arg4 preferredLocalizations:(id)arg5 finish:(CDUnknownBlockType)arg6;
...
- (id)getMacBuddyEligibleUpdateProductInfo;
