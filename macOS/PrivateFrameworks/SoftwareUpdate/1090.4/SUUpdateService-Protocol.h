...
- (void)refreshAvailableUpdatesForCurrentConfigurationLimitedToProductTypes:(NSArray *)arg1 distributionEnvironment:(NSDictionary *)arg2 distributionEvalutionMetainfo:(NSDictionary *)arg3 installedPrinters:(NSDictionary *)arg4 mdmInitiated:(BOOL)arg5 preferredLocalizations:(NSArray *)arg6 replyWhenDone:(void (^)(NSDictionary *, NSError *))arg7;
