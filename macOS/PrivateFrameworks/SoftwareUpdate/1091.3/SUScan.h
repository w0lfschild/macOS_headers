...
@class NSArray, NSDictionary, NSError, NSMutableArray, NSMutableDictionary, NSURL;
...
@interface SUScan : NSObject
{
    ...
    NSMutableDictionary *_macBuddyEligibleUpdateProductInfo;
}

+ (long long)_resultCodeFromScan:(id)arg1;
@property(retain) NSMutableDictionary *macBuddyEligibleUpdateProductInfo; // @synthesize macBuddyEligibleUpdateProductInfo=_macBuddyEligibleUpdateProductInfo;
