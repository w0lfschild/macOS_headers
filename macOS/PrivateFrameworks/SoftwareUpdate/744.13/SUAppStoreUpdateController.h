...
- (void)_stashLoginCredentialsEnablingFLO:(BOOL)arg1;
...
- (id)startInstallingUpdates:(id)arg1 notifyOn:(struct dispatch_queue_s *)arg2 usingForeground:(BOOL)arg3 progress:(CDUnknownBlockType)arg4 finish:(CDUnknownBlockType)arg5;
- (id)_dictFromUpdateStatus:(id)arg1;
- (id)_startSessionForUpdates:(id)arg1 withInstall:(BOOL)arg2 usingForeground:(BOOL)arg3 notifyOn:(struct dispatch_queue_s *)arg4 progress:(CDUnknownBlockType)arg5 finish:(CDUnknownBlockType)arg6;
