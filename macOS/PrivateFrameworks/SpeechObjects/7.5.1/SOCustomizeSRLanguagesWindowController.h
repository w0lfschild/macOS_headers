...
- (void)_rebuildList;
- (void)close;
- (void)showSheetForWindow:(id)arg1 networkSupportedLocaleIdentifiers:(id)arg2 requiredLocaleIdentifier:(id)arg3 supportDownloads:(BOOL)arg4 showOnlyNetworkSupportedItems:(BOOL)arg5;
- (void)dealloc;
