...
@class NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSString, PRSRankingConfiguration, PRSResult, SFStartLocalSearchFeedback, SPMetadataQuery, SPWebHistoryQuery;
