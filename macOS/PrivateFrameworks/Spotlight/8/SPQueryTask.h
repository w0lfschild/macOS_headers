...
@class NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSObject<SPQueryTaskDelegate>, NSString, PRSRankingConfiguration, SFMutableResultSection, SFSearchResult_SpotlightExtras, SFStartLocalSearchFeedback, SPApplicationQuery, SPMetadataQuery;
