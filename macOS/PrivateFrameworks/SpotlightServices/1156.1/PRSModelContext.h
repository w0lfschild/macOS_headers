...
@class NSString, PRSDirectivesManager, PRSMLKitInterface;

@interface PRSModelContext : NSObject
{
    unsigned long long _type;
    PRSMLKitInterface *_model;
...
@property(retain, nonatomic) PRSMLKitInterface *model; // @synthesize model=_model;
