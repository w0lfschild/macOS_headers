...
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 description:(id)arg3 title_weight:(unsigned long long)arg4 title_align:(unsigned long long)arg5 glyphs:(id)arg6 rt_glyph:(id)arg7 rt_text:(id)arg8 rt_newline:(BOOL)arg9 rating:(float)arg10 text:(id)arg11 image:(id)arg12 auxiliary_info:(id)arg13 action_button:(id)arg14 action_button_align:(unsigned long long)arg15 buy_buttons:(id)arg16;
