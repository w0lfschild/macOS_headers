...
@class SSMessageTracingSearchSession;

@interface SSMessageTracing : NSObject
{
    BOOL _queryIsBeingRequested;
    BOOL _resultIsBeingDisplayed;
    SSMessageTracingSearchSession *_currentSearchSession;
}
...
@property(readonly, nonatomic) SSMessageTracingSearchSession *currentSearchSession; // @synthesize currentSearchSession=_currentSearchSession;
- (void).cxx_destruct;
