...
- (void)blockRestoreDisk:(id)arg1 fromDiskImageFileURL:(id)arg2 volumeUUID:(id)arg3 creatingNewVolume:(BOOL)arg4 handlingProgress:(CDUnknownBlockType)arg5 withCompletionBlock:(CDUnknownBlockType)arg6;
...
- (void)blockRestoreDisk:(id)arg1 fromDisk:(id)arg2 volumeUUID:(id)arg3 creatingNewVolume:(BOOL)arg4 handlingProgress:(CDUnknownBlockType)arg5 withCompletionBlock:(CDUnknownBlockType)arg6;
...
- (void)volumesForDiskImageFileURL:(id)arg1 handlingProgress:(CDUnknownBlockType)arg2 withCompletionBlock:(CDUnknownBlockType)arg3;
