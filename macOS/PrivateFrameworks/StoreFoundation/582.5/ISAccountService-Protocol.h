...
- (void)deleteKey:(void (^)(NSError *))arg1;
- (void)signTouchIDChallenge:(NSString *)arg1 caller:(id)arg2 completion:(void (^)(NSString *, NSString *, NSError *))arg3;
- (void)getTouchIDAttestationBlob:(void (^)(NSString *, NSError *))arg1;
- (void)getTouchIDPublicKey:(void (^)(NSString *, NSError *))arg1;
- (void)getTouchIDPreferenceLastEnabledDateWithReplyBlock:(void (^)(NSDate *))arg1;
- (void)getTouchIDPreferenceWithReplyBlock:(void (^)(BOOL, ISStoreAccount *, NSError *))arg1;
- (void)setTouchIDPreference:(BOOL)arg1 replyBlock:(void (^)(BOOL, ISStoreAccount *, NSError *))arg2;
- (void)updateTouchIDSettingsForDSID:(NSNumber *)arg1 replyBlock:(void (^)(BOOL, NSError *))arg2;
- (void)getTouchIDStateForDSID:(NSNumber *)arg1 replyBlock:(void (^)(long long))arg2;
...
- (void)signOut;
- (void)signInWithContext:(ISAuthenticationContext *)arg1 replyBlock:(void (^)(BOOL, ISStoreAccount *, NSError *))arg2;
