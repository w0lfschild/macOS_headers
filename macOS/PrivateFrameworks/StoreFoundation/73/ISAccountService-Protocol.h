...
- (void)processURLResponse:(NSURLResponse *)arg1 forRequest:(NSURLRequest *)arg2 dsID:(NSNumber *)arg3;
...
- (void)dictionaryForDSID:(NSNumber *)arg1 withReplyBlock:(void (^)(NSDictionary *))arg2;
- (void)dictionaryWithReplyBlock:(void (^)(NSDictionary *))arg1;
- (void)isValidWithReplyBlock:(void (^)(BOOL))arg1;
- (void)regexWithKey:(NSString *)arg1 dsID:(NSNumber *)arg2 matchesString:(NSString *)arg3 replyBlock:(void (^)(BOOL))arg4;
...
- (void)needsSilentADIActionForURL:(NSURL *)arg1 dsID:(NSNumber *)arg2 withReplyBlock:(void (^)(BOOL))arg3;
- (void)needsSilentADIActionForURL:(NSURL *)arg1 withReplyBlock:(void (^)(BOOL))arg2;
- (void)urlIsTrustedByURLBag:(NSURL *)arg1 dsID:(NSNumber *)arg2 withReplyBlock:(void (^)(BOOL))arg3;
- (void)urlIsTrustedByURLBag:(NSURL *)arg1 withReplyBlock:(void (^)(BOOL))arg2;
- (void)valueForURLBagKey:(NSString *)arg1 dsID:(NSNumber *)arg2 withReplyBlock:(void (^)(id))arg3;
