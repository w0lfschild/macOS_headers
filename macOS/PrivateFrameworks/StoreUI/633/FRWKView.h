...
@class CKSigningSession, CKStoreClient, FRJSRootObject, FRStoreWebViewController, NSData, NSLock, NSMutableArray, NSString, NSURL;
...
- (BOOL)_isAccountCreationURL:(id)arg1;
