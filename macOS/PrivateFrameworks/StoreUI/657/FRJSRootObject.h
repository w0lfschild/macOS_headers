...
@class CKStoreClient, FRJSAppleAccountStore, FRWKView, NSObject, NSString;
...
- (BOOL)_shouldDisplayPrivacyLink:(id)arg1;
- (void)_signOut:(id)arg1;
- (void)_presentPrivacyViewController:(id)arg1;
...
- (void)_acknowledgePrivacyLink:(id)arg1;
