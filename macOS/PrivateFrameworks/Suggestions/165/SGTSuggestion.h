...
- (id)initWithAttributeNames:(id)arg1 displayName:(id)arg2 values:(id)arg3 additionalAttributes:(id)arg4 representedObject:(id)arg5 score:(double)arg6 lastWordMatched:(BOOL)arg7 alignmentScore:(unsigned long long)arg8;
- (id)initWithAttributeNames:(id)arg1 displayName:(id)arg2 values:(id)arg3 additionalAttributes:(id)arg4 representedObject:(id)arg5 score:(double)arg6 lastWordMatched:(BOOL)arg7;
