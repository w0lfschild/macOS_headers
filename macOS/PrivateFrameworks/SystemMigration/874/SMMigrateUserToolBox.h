...
+ (BOOL)migrateRootUserFrom:(id)arg1 toDestinationSystem:(id)arg2;
...
+ (BOOL)migrateUserEntry:(id)arg1 andGroup:(BOOL)arg2 andDeletePrevious:(BOOL)arg3 toDestinationSystem:(id)arg4;
+ (BOOL)createUser:(id)arg1 andCorrespondingGroup:(id)arg2 inDB:(id)arg3 onDestinationSystem:(id)arg4;
