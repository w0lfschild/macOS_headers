...
@interface SMSystemScanner : NSObject <SKManagerListener>
{
    ...
    NSMutableDictionary *_cloudSystems;
    NSObject<OS_dispatch_queue> *_cloudSystemsListQueue;
...
@property(retain) NSObject<OS_dispatch_queue> *cloudSystemsListQueue; // @synthesize cloudSystemsListQueue=_cloudSystemsListQueue;
@property(retain) NSMutableDictionary *cloudSystems; // @synthesize cloudSystems=_cloudSystems;
