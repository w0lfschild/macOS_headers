...
@class NSDictionary, NSMutableArray, NSMutableOrderedSet, NSNetService, NSNetServiceBrowser, NSNumber, NSSet, NSString, SMNConnection;
@protocol OS_dispatch_queue, SMNNetworkSessionDelegateProtocol;
