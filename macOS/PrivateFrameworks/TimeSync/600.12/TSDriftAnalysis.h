...
@interface TSDriftAnalysis : NSObject
{
...
- (void)dealloc;
- (BOOL)exportDriftToPath:(id)arg1;
- (BOOL)exportDriftToDirectoryURL:(id)arg1 withFilename:(id)arg2;
- (BOOL)exportDriftToDirectoryURL:(id)arg1;
@property(readonly, copy, nonatomic) NSArray *timeErrors;
@property(readonly, copy, nonatomic) NSArray *drift; // @dynamic drift;
- (void)calculateDriftFromStartOffset:(long long)arg1 toEndOffset:(long long)arg2 withThreadingOption:(long long)arg3;
- (void)calculateDriftFromStartOffset:(long long)arg1 toEndOffset:(long long)arg2;
- (void)calculateDriftWithThreadingOption:(long long)arg1;
- (void)calculateDrift;
- (void)_processDriftFromStartOffset:(long long)arg1 atIndex:(long long)arg2 withCount:(long long)arg3;
