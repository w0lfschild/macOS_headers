...
@class NSArray, NSCollectionView, NSMutableArray, NSObject<OS_dispatch_queue>, NSOrderedSet, NSString, NSUUID, _NSDataSourceSnapshotter, _NSDiffableDataSourceViewUpdater;
