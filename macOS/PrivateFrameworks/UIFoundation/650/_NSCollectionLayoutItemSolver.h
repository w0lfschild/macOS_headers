...
- (void)_solve;
- (void)_solveForContainer:(id)arg1 traitCollection:(id)arg2 maxFrameCount:(long long)arg3 layoutRTL:(BOOL)arg4 preferredSizes:(id)arg5 solutionRecursionDepth:(long long)arg6;
...
- (void)solveForContainer:(id)arg1 traitCollection:(id)arg2 maxFrameCount:(long long)arg3 layoutRTL:(BOOL)arg4 preferredSizes:(id)arg5;
- (void)solveForContainer:(id)arg1 traitCollection:(id)arg2 maxFrameCount:(long long)arg3 layoutRTL:(BOOL)arg4;
- (BOOL)canAccomodateItemWithSize:(struct CGSize)arg1;
- (id)copyWithZone:(struct _NSZone *)arg1;
- (id)initWithItem:(id)arg1 supplementaryEnroller:(id)arg2;
- (id)initWithItem:(id)arg1;
- (id)initWithItem:(id)arg1 supplementaryEnroller:(id)arg2 container:(id)arg3 traitCollection:(id)arg4 maxFrameCount:(long long)arg5 layoutRTL:(BOOL)arg6 preferredSizes:(id)arg7 solverResult:(id)arg8 solutionRecursionDepth:(long long)arg9;
