...
- (void)_wrappedProcessTraitCollectionDidChange:(const struct _UIViewTraitCollectionChangeDescription *)arg1 forceNotification:(BOOL)arg2;
...
- (void)_snipDangliesWithForce:(BOOL)arg1;
...
- (BOOL)_beginDragWithSourceIndex:(unsigned long long)arg1 touches:(id)arg2 orInitialCentroid:(struct CGPoint)arg3 fromInteraction:(BOOL)arg4 accessibilityEndpoint:(id)arg5;
...
@property(copy, nonatomic, getter=_sharedItemsForServicesMenu, setter=_setSharedItemsForServicesMenu:) NSArray *_sharedItemsForServicesMenu;
- (BOOL)canPerformAction:(SEL)arg1 withSender:(id)arg2;
- (void)doesNotRecognizeSelector:(SEL)arg1;
- (void)_providePasteboardItemsToServicesMenu:(id)arg1 touchLocation:(struct CGPoint)arg2;
...
@property(readonly, nonatomic) BOOL _hasPasteboardItemsForServicesMenu;
- (BOOL)_la_isVisible;
