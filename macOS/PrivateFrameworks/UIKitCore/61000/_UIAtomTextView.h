...
#import <UIKitCore/__UIAtomFieldEditorDelegate-Protocol.h>
...
@protocol UITextInputDelegate, UITextInputSuggestionDelegate, UITextInputTokenizer, _UIAtomTextViewDelegate, _UIAtomTextViewDelegateInternal;
...
@property(readonly, nonatomic, getter=_fieldEditor) __UIAtomFieldEditor *fieldEditor;
- (void)dealloc;
