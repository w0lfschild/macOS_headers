...
- (double)_computeUsageForApplications:(id)arg1 webDomains:(id)arg2 categories:(id)arg3 applicationUsageEvents:(id)arg4 webUsageEvents:(id)arg5 nowPlayingEvents:(id)arg6 categoryByBundleIdentifier:(id)arg7 categoryByWebDomain:(id)arg8 interval:(id)arg9 referenceDate:(id)arg10;
...
- (void)_computeUsageWithDisplayBacklitEvents:(id)arg1 applicationUsageEvents:(id)arg2 webUsageEvents:(id)arg3 nowPlayingEvents:(id)arg4 notificationEvents:(id)arg5 categoryByBundleIdentifier:(id)arg6 categoryByWebDomain:(id)arg7 interval:(id)arg8 partitionInterval:(double)arg9 referenceDate:(id)arg10 completionHandler:(CDUnknownBlockType)arg11;
