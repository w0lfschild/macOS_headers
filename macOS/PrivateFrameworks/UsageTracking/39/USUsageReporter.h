...
- (void).cxx_destruct;
- (void)fetchReportsForUsageType:(unsigned long long)arg1 interval:(id)arg2 partitionInterval:(double)arg3 focalOnly:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
