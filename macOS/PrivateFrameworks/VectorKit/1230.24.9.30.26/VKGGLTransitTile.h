...
- (void)addTransitLinesInRect:(const Box_3d7e3c2c *)arg1 toSet:(unordered_set_e09f79ea *)arg2;
- (void)willDisappear;
- (void)willAppear;
...
- (void)updateLineStylesInContext:(struct LayoutContext *)arg1 lineMergingDisabled:(unsigned char)arg2 forceMeshCreation:(_Bool)arg3;
