...
@class GEOMapRegion, GEOResourceManifestConfiguration, NSArray, NSString, VKClassicGlobeCanvas, VKLabelMarker, VKMapCameraController, VKMapCanvas, VKMemoryObserver, VKNavCameraController, VKNavContext, VKPolylineOverlay, VKPuckAnimator, VKSceneConfiguration, VKTimedAnimation;
