...
- (void)buildMeshesWithDevice:(struct Device *)arg1 triangulator:(id)arg2 prepareExtrusion:(BOOL)arg3;
@property(readonly, nonatomic) const vector_2e22b445 *polygonGroups;
- (void)dealloc;
- (id)initWithKey:(const struct VKTileKey *)arg1 modelTile:(id)arg2 prepareExtrusion:(BOOL)arg3 styleManager:(shared_ptr_a3c46825)arg4 sharedResources:(id)arg5 contentScale:(double)arg6 device:(struct Device *)arg7;
