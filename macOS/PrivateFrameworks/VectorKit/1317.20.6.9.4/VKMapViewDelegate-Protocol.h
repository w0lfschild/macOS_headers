...
@class NSError, NSString, VKARScene, VKLabelMarker, VKMapView, VKVenueBuildingFeatureMarker, VKVenueFeatureMarker;
...
- (void)mapLayer:(VKMapView *)arg1 didExitARScene:(VKARScene *)arg2;
- (void)mapLayer:(VKMapView *)arg1 willExitARScene:(VKARScene *)arg2;
- (void)mapLayer:(VKMapView *)arg1 didEnterARScene:(VKARScene *)arg2;
- (void)mapLayer:(VKMapView *)arg1 willEnterARScene:(VKARScene *)arg2;
