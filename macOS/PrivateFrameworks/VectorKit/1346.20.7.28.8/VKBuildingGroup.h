...
- (BOOL)addPointyRoofForBuilding:(CDStruct_42db872d *)arg1 buildingModel:(unsigned char)arg2 scaleThreshold:(float)arg3 styleIndex:(float)arg4;
- (BOOL)canConstructPointyRoofForPolygon:(CDStruct_b82ef747 *)arg1 building:(CDStruct_42db872d *)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4;
- (void)addExtrusionForBuilding:(CDStruct_42db872d *)arg1 index:(unsigned long long)arg2 ofTotal:(unsigned long long)arg3 triangulator:(id)arg4;
- (void)addBuilding:(CDStruct_42db872d *)arg1 index:(unsigned long long)arg2 ofTotal:(unsigned long long)arg3 accessor:(struct ResourceAccessor *)arg4 triangulator:(id)arg5 prepareExtrusion:(BOOL)arg6 forRoofStyle:(unsigned char)arg7 scaleThreshold:(float)arg8;
- (void)didFinishAddingData;
- (void)willAddDataWithAccessor:(struct ResourceAccessor *)arg1;
- (void)prepareForBuilding:(CDStruct_42db872d *)arg1 forRoofStyle:(unsigned char)arg2 scaleThreshold:(float)arg3;
...
- (vector_2cb66512 *)styleQueriesForPointyRoofs:(_Bool)arg1 selected:(_Bool)arg2;
