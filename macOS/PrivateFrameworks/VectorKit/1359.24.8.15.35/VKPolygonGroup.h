...
- (void)addPolygon:(CDStruct_3d2b1092 *)arg1 hasNonWaterStyle:(BOOL)arg2 accessor:(struct ResourceAccessor *)arg3 triangulator:(id)arg4;
...
- (void)prepareForPolygon:(CDStruct_3d2b1092 *)arg1 hasNonWaterStyle:(BOOL)arg2;
- (unsigned int)createStrokePointStyleList:(CDStruct_3d2b1092 *)arg1 section:(unsigned long long)arg2 outPointStyles:(vector_0496561e *)arg3;
