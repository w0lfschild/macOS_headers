...
- (id)artworkForStyleAttributeKey:(unsigned int)arg1 attributeValue:(unsigned int)arg2 withResourceNames:(id)arg3 style:(struct Style *)arg4 extraStyle:(struct ExtraStyle *)arg5 contentScale:(double)arg6 size:(long long)arg7 hasText:(_Bool)arg8;
...
- (id)artworkForName:(id)arg1 withResourceNames:(id)arg2 style:(struct Style *)arg3 extraStyle:(struct ExtraStyle *)arg4 contentScale:(double)arg5 size:(long long)arg6 hasText:(_Bool)arg7;
