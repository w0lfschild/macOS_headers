...
- (BOOL)addPointyRoofForBuilding:(CDStruct_6afc0c60 *)arg1 buildingModel:(unsigned char)arg2 scaleThreshold:(float)arg3 styleIndex:(float)arg4;
- (BOOL)canConstructPointyRoofForPolygon:(CDStruct_dce90927 *)arg1 building:(CDStruct_6afc0c60 *)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4;
- (void)addExtrusionForBuilding:(CDStruct_6afc0c60 *)arg1 index:(unsigned long long)arg2 ofTotal:(unsigned long long)arg3;
- (void)addBuilding:(CDStruct_6afc0c60 *)arg1 index:(unsigned long long)arg2 ofTotal:(unsigned long long)arg3 accessor:(struct ResourceAccessor *)arg4 triangulator:(Triangulator_edf345a1 *)arg5 prepareExtrusion:(BOOL)arg6 forRoofStyle:(unsigned char)arg7 scaleThreshold:(float)arg8;
- (void)didFinishAddingData;
- (void)willAddDataWithAccessor:(struct ResourceAccessor *)arg1;
- (void)prepareForBuilding:(CDStruct_6afc0c60 *)arg1 forRoofStyle:(unsigned char)arg2 scaleThreshold:(float)arg3;
