...
@class NSAccessibilityRemoteUIElement, NSObject<NSRemoteViewDelegate>, NSRemoteViewMarshal, NSString, NSUUID, NSXPCConnection, NSXPCInterface, NSXPCListenerEndpoint;
