...
@interface NSRemoteView : NSView <NSXPCListenerDelegate, NSVBXPCConnectionClient, HasAuxiliaryConnection, AuxiliaryCallsHost, NSVBDeallocOnAppKitThread>
{
...
- (void)_positionAccessoryWindow:(id)arg1;
- (void)_logPositionAccessoryWindow:(struct CGPoint)arg1 willDid:(const char *)arg2;
...
- (void)_copyViewServiceMarshalReply:(const CDStruct_f2cafd34 *)arg1;
...
- (BOOL)_willBecomeAssociatedWithHostWindow:(unsigned int)arg1 withKeyness:(BOOL)arg2 atLevel:(long long)arg3 withBlock:(CDUnknownBlockType)arg4;
- (BOOL)_willBecomeAssociatedWithHostWindow:(unsigned int)arg1 withKeyness:(BOOL)arg2 withBlock:(CDUnknownBlockType)arg3;
...
- (void)_remoteViewBecameFirstResponderOnBehalfOf:(unsigned char)arg1;
...
- (void)_remoteViewGeometryDidChange:(struct CGRect)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_showTouchBarPopover:(id)arg1 fromItem:(id)arg2 wthOverlayIdentifier:(id)arg3 withCloseButton:(BOOL)arg4 withControlStrip:(BOOL)arg5;
