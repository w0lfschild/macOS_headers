...
@class NSArray, NSData, NSDictionary, NSNumber, NSObject, NSString;
@protocol NSSecureCoding;

@protocol NSRemoteViewMarshal
- (void)hideTouchBarPopover:(NSString *)arg1;
- (void)showTouchBarPopover:(NSDictionary *)arg1 fromItem:(NSString *)arg2 wthOverlayIdentifier:(NSString *)arg3 withCloseButton:(BOOL)arg4 withControlStrip:(BOOL)arg5;
