...
@class NSAccessibilityRemoteUIElement, NSArray, NSCFRunLoopObserver, NSColor, NSDictionary, NSLayoutConstraint, NSResponder, NSServiceViewController, NSString, NSVB_ViewServiceBehaviorProxy, NSViewBridge, NSXPCConnection, NSXPCInterface;
@protocol NSObject;
...
@interface NSViewServiceMarshal : NSView <NSXPCListenerDelegate, NSVBXPCConnectionClient, AuxiliaryCallsService, NSViewServiceMarshal, NSXPCConnectionDelegate>
{
    ...
    struct CGPoint _mostRecentlyReportedAccessoryViewOrigin;
...
- (void)remoteViewBackingScaleFactorDidChange:(double)arg1 reply:(CDUnknownBlockType)arg2;
- (BOOL)remoteViewBackingScaleFactorDidChange:(double)arg1;
...
- (void)beginRemoteModalSession:(id)arg1 title:(id)arg2 size:(struct CGSize)arg3 withReply:(CDUnknownBlockType)arg4;
...
- (void)bootstrap:(CDStruct_43e9a6c1)arg1 withReply:(CDUnknownBlockType)arg2;
- (id)_bootstrap:(CDStruct_43e9a6c1)arg1 replyData:(CDStruct_f2cafd34 *)arg2;
- (void)connectToAuxiliaryService:(id)arg1 isMidTunnel:(BOOL)arg2;
...
- (void)hostWindowChangedEdgeResizingRects:(id)arg1;
- (void)hostWindowResignedKeyInActiveApp:(BOOL)arg1 isContentView:(BOOL)arg2 reply:(CDUnknownBlockType)arg3;
- (void)hostWindowBecameKeyInActiveApp:(BOOL)arg1 isContentView:(BOOL)arg2 reply:(CDUnknownBlockType)arg3;
- (void)hostWindowKeynessChangeInProgress:(CDUnknownBlockType)arg1;
- (void)hostWindowChangedEdgeResizingRectsMainThread:(id)arg1;
- (void)hostWindowBecameKey;
- (void)hostWindowResignedKey;
...
- (struct CGPoint)_remoteViewGeometryDidChange:(id)arg1 serviceWindowSize:(struct CGSize *)arg2;
- (struct CGPoint)remoteViewGeometryDidChangeInProgress:(id)arg1 serviceWindowSize:(struct CGSize *)arg2;
- (BOOL)shouldAllowAnimationForDefaultResizeBehavior;
- (struct CGPoint)accessoryViewOriginRelativeToFrame:(id)arg1;
...
- (void)_willBecomeAssociatedWithHostWindow:(unsigned int)arg1 atLevel:(long long)arg2;
...
- (void)becomeKeyBecauseHostWindow:(const char *)arg1;
