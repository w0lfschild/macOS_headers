...
@class NSAccessibilityRemoteUIElement, NSArray, NSCFRunLoopObserver, NSColor, NSDictionary, NSLayoutConstraint, NSMutableArray, NSProxy, NSResponder, NSServiceViewController, NSString, NSVB_ViewServiceBehaviorProxy, NSViewBridge, NSXPCConnection, NSXPCInterface;
