...
#import "VCUserNotificationManagerDelegate.h"
#import "WFOutOfProcessWorkflowControllerDelegate.h"

@class NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, VCDaemonXPCEventHandler, VCUserNotificationManager, WFConfiguredTrigger, WFDatabase, WFOutOfProcessWorkflowController, WFWorkflowRunEvent;
