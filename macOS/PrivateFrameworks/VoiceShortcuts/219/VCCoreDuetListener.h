...
@class NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, VCDaemonXPCEventHandler, VCUserNotificationManager, WFDatabase, WFOutOfProcessWorkflowController, WFWorkflowRunEvent;
