...
@class NSArray, NSMapTable, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSString, NSXPCListener, WPDAdvertisingManager, WPDClient, WPDObjectDiscoveryManager, WPDPipeManager, WPDScanManager, WPDState, WPDStatsManager, WPDZoneManager;
