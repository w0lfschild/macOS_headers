...
#import <WebDriver/WDApplicationProvider-Protocol.h>
...
@interface WDHTTPService : NSObject <RWIManagerDelegate, RWIDriverInterfaceDelegate, WDSessionProvider, WDApplicationProvider, NSXPCListenerDelegate, WDXPCService>
{
