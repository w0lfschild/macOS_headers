...
- (void).cxx_destruct;
- (void)_handlePostSessionAttachDebugger:(id)arg1 response:(id)arg2;
- (void)_handlePostSessionPermissions:(id)arg1 response:(id)arg2;
- (void)_handleGetSessionPermissions:(id)arg1 response:(id)arg2;
