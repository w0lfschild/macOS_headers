...
- (void)createBasicDiagnosticsReportUsingTemporaryDirectory:(NSString *)arg1 interfaceName:(NSString *)arg2 authorizationData:(NSData *)arg3 reply:(void (^)(NSError *, NSArray *))arg4;
