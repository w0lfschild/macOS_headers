...
@class ICApp, NSArray, NSAttributedString, NSDate, NSDictionary, NSHashTable, NSImage, NSMutableDictionary, NSProgress, NSSet, NSString, WFActionParameterSummary, WFContentCollection, WFParameter, WFResourceManager, WFWorkflow;
...
- (void)processParametersWithInput:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)processParameterStates:(id)arg1 withInput:(id)arg2 skippingHiddenParameters:(BOOL)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
@property(readonly, nonatomic) NSImage *keyImage;
@property(readonly, nonatomic) NSImage *outputIcon;
