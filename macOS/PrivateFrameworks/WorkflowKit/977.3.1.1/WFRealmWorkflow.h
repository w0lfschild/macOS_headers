...
+ (id)primaryKey;
+ (id)className;
@property long long lastMigratedClientVersion; // @synthesize lastMigratedClientVersion=_lastMigratedClientVersion;
...
@property long long minimumClientVersion; // @synthesize minimumClientVersion=_minimumClientVersion;
