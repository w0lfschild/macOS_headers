...
@class ICDBRContainerCache, ICDBRFileObjectID, ICDBRMangledID, NSData, NSDate, NSDictionary, NSNumber, NSObject<OS_dispatch_queue>, NSPurgeableData, NSSet, NSString, NSURL;

@interface ICDBRContainer : NSObject <NSSecureCoding>
{
...
+ (id)containerForMangledID:(id)arg1 containerCache:(id)arg2 rootFileObjectID:(id)arg3 documentsFileObjectID:(id)arg4;
+ (void)unregisterCurrentProcessAsPriorityHint;
@property(readonly, nonatomic) ICDBRFileObjectID *documentsFileObjectID; // @synthesize documentsFileObjectID=_documentsFileObjectID;
@property(readonly, nonatomic) ICDBRFileObjectID *rootFileObjectID; // @synthesize rootFileObjectID=_rootFileObjectID;
...
- (id)description;
- (id)initWithContainerCache:(id)arg1 mangledID:(id)arg2 rootFileObjectID:(id)arg3 documentsFileObjectID:(id)arg4 dataRepresentation:(id)arg5;
- (id)initWithContainerCache:(id)arg1 mangledID:(id)arg2 rootFileObjectID:(id)arg3 documentsFileObjectID:(id)arg4;
- (id)init;
...
- (id)bestFittingImageDataForSize:(struct CGSize)arg1 shouldTransformToAppIcon:(char *)arg2;
- (id)iconURLs;
