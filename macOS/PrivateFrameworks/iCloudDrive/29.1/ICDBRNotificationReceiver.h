...
#import <iCloudDrive/ICDBRItemNotificationReceiving-Protocol.h>

@class BRXPCAutomaticErrorProxy, ICDBRNotificationQueue, NSMutableDictionary;
@protocol ICDBRItemNotificationSending, ICDBRNotificationReceiverDelegate, NSObject, OS_dispatch_queue, OS_dispatch_source;
