...
@class ICDBRFileObjectID, NSArray;

@interface ICDBRProgressUpdate : NSObject <NSSecureCoding, NSCopying>
{
    ICDBRFileObjectID *_folderID;
...
@property(copy, nonatomic) ICDBRFileObjectID *folderID; // @synthesize folderID=_folderID;
@property(copy, nonatomic) NSArray *parentFileObjectIDs; // @synthesize parentFileObjectIDs=_parentFileObjectIDs;
- (void).cxx_destruct;
