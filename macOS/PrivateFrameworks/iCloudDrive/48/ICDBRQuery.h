...
#import "ICDBRNotificationReceiverDelegate.h"

@class ICDBRNotificationReceiver, ICDFileTree, NSArray, NSMetadataQuery, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSOperationQueue, NSPredicate, NSString;
