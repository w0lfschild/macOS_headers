...
@class BRCDeadlineScheduler, BRCDeadlineSource, BRCFairScheduler, NSDate, NSDictionary, NSMutableDictionary, NSMutableSet, NSString, icd_pacer;

__attribute__((visibility("hidden")))
@interface BRCFSUploader : BRCFSTransferScheduler <BRCModule>
{
    NSMutableDictionary *_thumbnailsOperations;
    NSMutableSet *_boostedRowIDs;
    NSMutableDictionary *_stampForRowID;
    BRCFairScheduler *_fairScheduler;
    BRCDeadlineSource *_retryQueueSource;
    icd_pacer *_globalQuotaStateUpdatePacer;
    BOOL _quotaFetchScheduled;
...
- (void).cxx_destruct;
- (void)pauseForADay;
- (void)resumePauseForADay;
- (id)_readPauseDateInPrefs;
- (BOOL)isPausedForADay;
- (void)scheduleQuotaFetchIfNeededForOwner:(id)arg1;
- (void)_registerQuotaFetchXPCActivity;
- (void)scheduleQuotaStateUpdateForOwner:(id)arg1;
- (void)ownerDidReceiveOutOfQuotaError:(id)arg1;
- (void)_scheduleQuotaFetchForDefaultOwnerWithXPCActivity:(id)arg1;
...
- (void)_updateRecord:(id)arg1 jobID:(id)arg2 syncContext:(id)arg3 thumbnailsDictionary:(id)arg4 thumbnailMetadata:(id)arg5 stageID:(id)arg6;
- (void)_updateRecord:(id)arg1 item:(id)arg2 syncContext:(id)arg3 thumbnailsDictionary:(id)arg4 thumbnailMetadata:(id)arg5 stageID:(id)arg6;
...
- (void)removeBoostedRowID:(id)arg1;
- (void)boostRowID:(id)arg1 item:(id)arg2;
