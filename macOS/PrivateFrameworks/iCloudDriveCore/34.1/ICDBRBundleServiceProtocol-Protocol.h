...
- (void)extractMetadataForContainerID:(NSString *)arg1 bundleID:(NSString *)arg2 minimumBundleVersion:(NSString *)arg3 reply:(void (^)(NSDictionary *, NSDictionary *, NSArray *, NSError *))arg4;
@end
