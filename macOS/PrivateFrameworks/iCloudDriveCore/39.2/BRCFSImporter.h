...
- (id)importNewItemAtURL:(id)arg1 logicalName:(id)arg2 parentItem:(id)arg3 templateItem:(id)arg4 fields:(unsigned long long)arg5 options:(unsigned long long)arg6 extension:(id)arg7 isExistingItem:(char *)arg8 appLibraryDocumentsFolder:(id *)arg9 error:(id *)arg10;
