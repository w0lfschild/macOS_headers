...
@interface BRCItemAggregatedProperties : NSObject
{
    ...
    unsigned long long _sharedByMeCount;
    unsigned long long _sharedToMeCount;
}

+ (id)aggregatedPropertiesForRowID:(long long)arg1 db:(id)arg2;
@property(nonatomic) unsigned long long sharedToMeCount; // @synthesize sharedToMeCount=_sharedToMeCount;
@property(nonatomic) unsigned long long sharedByMeCount; // @synthesize sharedByMeCount=_sharedByMeCount;
