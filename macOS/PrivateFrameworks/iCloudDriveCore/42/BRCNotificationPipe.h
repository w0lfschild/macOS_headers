...
#import <iCloudDriveCore/ICDBRItemNotificationSending-Protocol.h>

@class BRCDataOrDocsScopeGatherer, BRCItemGlobalID, BRCListDirectoryContentsOperation, BRCNotificationManager, BRFrameworkClient, ICDBRFileObjectID, ICDBRNotificationQueue, NSHashTable, NSMutableDictionary, NSMutableSet, NSSet, NSString;
@protocol BRCNotificationPipeDelegate, ICDBRItemNotificationReceiving, OS_dispatch_group, OS_dispatch_queue;
