...
@property(readonly, nonatomic) long long serverSearchMatchLimit;
@property(readonly, nonatomic) BOOL should2PhasePCSChain;
@property(readonly, nonatomic) long long fpfsMigrationCleanupBatchSize;
...
@property(readonly, nonatomic) long long minimumPackageSizeForTwoPhase;
...
@property(readonly, nonatomic) NSObject<OS_xpc_object> *powerLogReportActivity;
...
@property(readonly, nonatomic) unsigned long long workingSetBatchSize;
...
@property(readonly, nonatomic) NSObject<OS_xpc_object> *goodQuotaXPCActivity;
@property(readonly, nonatomic) NSObject<OS_xpc_object> *outOfQuotaXPCActivity;
