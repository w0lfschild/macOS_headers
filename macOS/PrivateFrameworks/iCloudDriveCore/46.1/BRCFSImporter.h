...
- (BOOL)itemChanged:(id)arg1 baseVersion:(id)arg2 changedFields:(unsigned long long)arg3 newValues:(id)arg4 contents:(id)arg5 extension:(id)arg6 clearCKInfoOnSyncUp:(BOOL)arg7 error:(id *)arg8;
