...
- (void)brc_close;
- (void)brc_closeCrashingOnFailure:(BOOL)arg1;
...
- (id)fetchWithSlowStatementRadar:(id)arg1 objectWithConstructor:(CDUnknownBlockType)arg2 sql:(id)arg3;
