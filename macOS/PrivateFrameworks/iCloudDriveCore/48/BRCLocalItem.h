...
@class BRCAccountSession, BRCAppLibrary, BRCClientZone, BRCDirectoryItem, BRCDirectoryItem<BRCFSRooted>, BRCDocumentItem, BRCFinderBookmarkItem, BRCItemID, BRCLocalItem<BRCShareAcceptationFault>, BRCLocalItem<BRCSharedToMeTopLevel>, BRCLocalItem<BRCTopLevelShareable>, BRCLocalStatInfo, BRCPQLConnection, BRCServerZone, BRCSymlinkItem, BRCUserRowID, BRCZoneRowID, BRFieldCKInfo, ICDBRFileObjectID, NSDictionary, NSError, NSFileProviderManager, NSNumber, NSString;
