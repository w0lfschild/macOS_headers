...
@class BRCAcceptShareOperation, BRCAccountSession, BRCAppLibrary, BRCClientZone, BRCItemID, CKRecordID, CKShareMetadata, ICDBRFileObjectID, NSArray, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSString, NSURL;
