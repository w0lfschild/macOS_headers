...
@class BRCAccountSession, BRCClientPrivilegesDescriptor, BRFileProviderExtension, ICDBRMangledID, NSCountedSet, NSObject<OS_dispatch_queue>, NSOperationQueue, NSSet, NSString, NSXPCConnection, brc_task_tracker;
