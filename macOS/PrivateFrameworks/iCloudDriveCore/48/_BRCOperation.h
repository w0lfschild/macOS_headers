...
@class BRCSyncContext, BRCThrottle, CKOperationGroup, NSDate, NSError, NSHashTable, NSMutableArray, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSObject<OS_os_activity>, NSObject<OS_os_transaction>, NSUUID;
...
@interface _BRCOperation : NSOperation
{
    ...
    NSObject<OS_dispatch_group> *_highPriorityWaitGroup;
...
- (void)blockOnHighPriorityOperation:(id)arg1;
