...
@interface SMProcessController : NSObject <SMAuthProgressProtocol, NSWindowDelegate, NSToolbarDelegate, NSTableViewDelegate, NSOutlineViewDataSource, NSOutlineViewDelegate, NSTouchBarProvider, NSTouchBarDelegate, AssetCacheServicesManagerEventsProtocol>
{
    ...
    SMGPUHistoryController *_gpuHistoryController;
    SMAfterburnerHistoryController *_afterburnerHistoryController;
