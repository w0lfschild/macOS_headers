...
@class NSEvent, NSMenu, NSMenuItem, NSScreen, NSView;
...
- (void)menu:(NSMenu *)arg1 didFailToOpenInView:(NSView *)arg2;
- (void)menu:(NSMenu *)arg1 prepareForLocation:(struct CGPoint)arg2 inView:(NSView *)arg3;
