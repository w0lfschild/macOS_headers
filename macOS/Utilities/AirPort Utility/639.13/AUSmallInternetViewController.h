...
@class AUInternetModel, NSLayoutConstraint, NSTextField;
...
@interface AUSmallInternetViewController : NSViewController
{
    ...
    NSLayoutConstraint *_contraintBottomSpace;
}

@property NSLayoutConstraint *contraintBottomSpace; // @synthesize contraintBottomSpace=_contraintBottomSpace;
