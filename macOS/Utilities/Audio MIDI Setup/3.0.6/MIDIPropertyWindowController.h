...
@class IconView, MIDIChannelMatrixView, MIDIDeviceWidget, MessageView, NSButton, NSColorWell, NSComboBox, NSMatrix, NSMutableArray, NSMutableDictionary, NSStepper, NSString, NSTabView, NSTabViewItem, NSTableView, NSTextField, NSView, NSWindow;
