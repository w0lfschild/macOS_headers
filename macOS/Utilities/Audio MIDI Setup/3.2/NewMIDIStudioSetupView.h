...
@class CALayer, CAShapeLayer, CATextLayer, MIDIDeviceWidget, MIDIEndpointWidget, MIDISetupManager, MIDIToolTipLayer, NSDate, NSMutableArray, NSMutableDictionary, NSString, SelectionManager;

@interface NewMIDIStudioSetupView : NSView <CALayerDelegate>
{
