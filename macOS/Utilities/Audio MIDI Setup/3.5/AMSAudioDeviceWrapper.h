...
- (void)setBalanceValue:(float)arg1 forChannel:(unsigned int)arg2;
- (float)balanceValueForChannel:(unsigned int)arg1;
- (BOOL)isBalanceControlSettableForChannel:(unsigned int)arg1;
- (BOOL)hasBalanceControlForChannel:(unsigned int)arg1;
...
- (void)updateMuteControlForOutputChannel:(unsigned int)arg1 scalarValue:(float)arg2;
- (void)updateMasterMuteControlForInput:(BOOL)arg1;
