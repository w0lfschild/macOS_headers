...
@class IOBluetoothOBEXSession, IOBluetoothTransferProgressUI, IOBluetoothUserNotification, NSArray, NSButton, NSImageView, NSMutableArray, NSPanel, NSPathControl, NSProgressIndicator, NSString, NSTableView, NSTextField, NSTimer, NSToolbar, NSToolbarItem, NSView, NSWindow, OBEXFileTransferServices, ObjectPusherAppController;
...
@interface FileTransferClientWindow : NSWindowController <IOBluetoothRFCOMMChannelDelegate, NSOpenSavePanelDelegate, NSToolbarDelegate, NSFilePromiseProviderDelegate>
{
    ...
    NSToolbarItem *mNewFolderToolbarItem;
