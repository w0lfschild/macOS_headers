...
+ (BOOL)isVolumeEmpty:(id)arg1;
+ (BOOL)doWindowsFilesExist:(id)arg1 filesToSearch:(id)arg2;
+ (BOOL)shouldRemoveWindowsPartition:(struct __DADisk *)arg1;
+ (id)getWindowsPartitions:(struct __DADisk *)arg1;
