...
@interface _TtC19Boot_Camp_Assistant13SnapshotPurge : _TtCs12_SwiftObject <DMAsyncDelegate>
{
    // Error parsing type: , name: purgeDelegate
    // Error parsing type: , name: dm
    // Error parsing type: , name: dmDisk
    // Error parsing type: , name: listOfSnapshotUUIDsToDelete
    // Error parsing type: , name: currentSnapshotBeingDeleted
