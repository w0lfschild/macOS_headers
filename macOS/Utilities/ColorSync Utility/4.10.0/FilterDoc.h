...
@class FilterDocExportAccessoryView, FilterDocPDEController, FilterDocProfile, FilterImageCorrection, FilterPageView, FilterPageViewMatte, FilterToolbarPageFieldView, NSBox, NSButton, NSMenu, NSMenuItem, NSMutableArray, NSMutableDictionary, NSPanel, NSPopUpButton, NSPrintInfo, NSScrollView, NSString, NSTextField, NSWindow, QuartzFilter;
