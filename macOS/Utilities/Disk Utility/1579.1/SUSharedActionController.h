...
@class NSTextField, NSWindow, SKDisk, SUChangePasswordDialog, SUChecksumImageController, SUConvertImageController, SUCreateImageFromFolderController, SUCreateNewImageController, SUEraseSheetController, SUFirstAidSheetController, SUImageSheetController, SUPartitionSheetController, SURAIDAssistantWindowController, SUResizeImageController, SURestoreSheetController, SUScanImageController, SUVerifyImageController;
