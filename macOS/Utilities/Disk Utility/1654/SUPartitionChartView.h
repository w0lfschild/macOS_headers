...
- (struct CGPoint)_infoPointForPercentageStart:(double)arg1 end:(double)arg2 radiusPercentage:(double)arg3;
- (struct CGPoint)_infoPointForPartition:(id)arg1 radiusPercentage:(double)arg2;
