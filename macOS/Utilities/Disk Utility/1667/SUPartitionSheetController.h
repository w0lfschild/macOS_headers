...
@class NSBox, NSButton, NSImageView, NSLayoutConstraint, NSMenuItem, NSMutableArray, NSPopUpButton, NSPopover, NSSegmentedControl, NSString, NSTextField, NSView, NSWindow, SKDisk, SUBaseProgressSheet, SUPartitionChartView, SUPartitionModelController, SUPasswordEntryDialog;
...
- (void).cxx_destruct;
- (void)applyStatusSubheading:(id)arg1 logMessage:(id)arg2;
