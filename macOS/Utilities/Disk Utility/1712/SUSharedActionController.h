...
- (BOOL)_diskCanBeMounted:(id)arg1;
- (BOOL)_diskCanBeUnmounted:(id)arg1 withError:(id *)arg2;
- (BOOL)_diskCanBeUnmounted:(id)arg1;
...
- (void)unmountOrMountClicked:(id)arg1;
- (void)mountOrUnmountClicked:(id)arg1;
- (void)performUnmountOrMount:(id)arg1;
- (void)performMountOrUnmount:(id)arg1;
- (void)performMountOrUnlock:(id)arg1;
