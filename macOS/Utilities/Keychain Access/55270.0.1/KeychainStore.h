...
{
    struct __SecKeychain *_secKeychainRef;
...
+ (BOOL)isRemoteKeychainRef:(struct __SecKeychain *)arg1;
+ (id)iconForKeychainRef:(struct __SecKeychain *)arg1;
+ (id)displayNameForKeychainRef:(struct __SecKeychain *)arg1;
+ (BOOL)isSystemKeychainRef:(struct __SecKeychain *)arg1;
+ (void)removeStoreFromCache:(id)arg1;
+ (id)registerAvailableStore:(id)arg1;
+ (id)cachedStore:(id)arg1;
+ (id)storeForSearchString:(id)arg1;
+ (id)storeForKeychainRef:(struct __SecKeychain *)arg1;
+ (BOOL)isStoreForKeychainRefInCache:(struct __SecKeychain *)arg1;
+ (id)secSearchToStoreHandle:(id)arg1;
+ (id)secKeychainRefToStoreHandle:(struct __SecKeychain *)arg1;
+ (void)initialize;
...
- (struct __SecIdentity *)_getIdentityRefForKeychainItem:(id)arg1;
