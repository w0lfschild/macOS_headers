...
@class NSFont, NSString, NSURL, TTLogicalScreen, TTPane, TTProfile, TTShell, TTSplitView, TTTabViewItem;
...
- (void)writeLineDirectToScreen:(id)arg1 withAttributes:(CDStruct_45ade667)arg2;
...
- (id)title;
- (id)_titleIncludingTab:(BOOL)arg1 includingProcess:(BOOL)arg2;
