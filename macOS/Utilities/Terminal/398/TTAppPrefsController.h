...
@class NSArrayController, NSLayoutConstraint, NSMatrix, NSMenuItem, NSPathControl, NSPopover, NSString, NSTabView, NSTableView, NSTextField, NSUndoManager, NSView, TTLogicalScreen, TTTableView, TTView;

@interface TTAppPrefsController : NSWindowController <NSWindowDelegate, NSPathControlDelegate>
{
    NSTabView *_tabView;
    NSTabView *_profileTabView;
    ...
    NSLayoutConstraint *_backgroundImagePathControlWidthConstraint;
    NSPopover *_helpPopoverSetWorkingDirectoryURL;
    NSPopover *_helpPopoverSetRepresentedURLs;
    NSPopover *_helpPopoverSetTabTitle;
