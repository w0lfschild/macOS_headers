...
@class NSButton, NSScroller, NSScrollerImpPair, NSString, NSView, NSVisualEffectView, TTLogicalScreen, TTResizeView, TTSplitView, TTTabController, TTView;

@interface TTPane : TTAccessibleView <NSTextFinderBarContainer, NSScrollerImpPairDelegate>
{
    TTView *view;
    NSVisualEffectView *_controlsVisualEffectView;
    NSScroller *scroller;
    ...
    NSVisualEffectView *controlsVisualEffectView;
}
...
@property(retain) NSVisualEffectView *controlsVisualEffectView; // @synthesize controlsVisualEffectView;
