...
@class NSColor, NSMutableArray, NSMutableIndexSet, NSString, NSURL, TTActiveTextStorage, TTLogicalScreenAttributedString, TTLogicalScreenString, TTProfile, TTScrollbackTextStorage;
...
@property(retain) NSMutableArray *colorTable; // @synthesize colorTable=_colorTable;
...
- (void)resetColors;
- (void)_resetDynamicAndSpecialColors;
- (void)resetColorTable;
- (void)_resetColorTableArray;
- (id)customTableColorAtIndex:(unsigned long long)arg1;
- (void)setColor:(id)arg1 atIndex:(unsigned long long)arg2;
- (id)colorAtIndex:(unsigned long long)arg1;
- (id)_profileKeyForColorTableANSIIndex:(unsigned long long)arg1;
@property(copy, nonatomic) NSColor *boldColor;
@property(copy, nonatomic) NSColor *selectionColor;
@property(copy, nonatomic) NSColor *cursorColor;
@property(copy, nonatomic) NSColor *backgroundColor;
@property(copy, nonatomic) NSColor *foregroundColor;
- (void)setScrollRange:(struct _NSRange)arg1;
- (struct _NSRange)scrollRange;
- (BOOL)autoWrap;
- (void)setAutoWrap:(BOOL)arg1;
@property(readonly) NSString *mainScreenWorkingDirectoryURLString;
@property(readonly) NSString *mainScreenRepresentedURLString;
