...
- (void)saveTextOnlySelection:(BOOL)arg1;
...
- (void)drawInsertionPoint:(struct CGPoint)arg1;
- (void)drawCursor:(struct CGPoint)arg1 inMarkedText:(BOOL)arg2 wide:(BOOL)arg3;
...
- (void)screenDidChangeColorTable:(id)arg1;
