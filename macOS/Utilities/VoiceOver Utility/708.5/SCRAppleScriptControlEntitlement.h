...
+ (id)entitlement;
@property(readonly, nonatomic) SCRUserUtilities *userUtility; // @synthesize userUtility=_userUtility;
@property(readonly, nonatomic) NSFileManager *fileManager; // @synthesize fileManager=_fileManager;
@property(readonly, nonatomic) AdminAuthenticator *authenticator; // @synthesize authenticator=_authenticator;
- (void).cxx_destruct;
