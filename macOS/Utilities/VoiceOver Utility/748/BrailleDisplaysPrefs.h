...
@class AddRemoveBar, BrailleDisplayBluetoothTabController, BrailleDisplayNoDisplayTabController, BrailleDisplayTabController, IOBluetoothDeviceSelectorController, InputTableView, NSMutableArray, NSMutableSet, NSNumber, NSSound, NSString, NSTabView, NSTabViewItem, NSTableView, NSTimer, NSWindow, SCROBrailleDisplayInputManager;
...
@interface BrailleDisplaysPrefs : BraillePrefs <NSWindowDelegate, NSSoundDelegate>
{
    ...
    IOBluetoothDeviceSelectorController *__deviceSeletor;
}

- (void).cxx_destruct;
@property(retain, nonatomic) IOBluetoothDeviceSelectorController *_deviceSeletor; // @synthesize _deviceSeletor=__deviceSeletor;
