...
@class ActivitiesSitesPrefs, AddRemoveBar, NSArray, NSBox, NSButton, NSMenu, NSMutableArray, NSPopUpButton, NSPopUpButtonCell, NSString, NSTableView, NSTextField, NSView, NSWindow, _TtC17VoiceOver_Utility14SideBarElement;
...
@interface ActivitiesPrefs : PrefsBase <ActivitiesSitesPrefsDelegate, NSTableViewDelegate, NSTableViewDataSource>
{
    ...
    _TtC17VoiceOver_Utility14SideBarElement *_activitySideBarElement;
...
+ (id)_activityDescriptionForMask:(long long)arg1 activityName:(id)arg2;
- (void).cxx_destruct;
