...
- (id)initWithPreviousParser:(id)arg1 additionalStoreItemMetadataResponse:(id)arg2 options:(CDStruct_12f05b9c)arg3 sectionBuilder:(id)arg4 contentItemBuilder:(id)arg5;
- (id)initWithRawResponseOutput:(id)arg1 options:(CDStruct_12f05b9c)arg2 sectionBuilder:(id)arg3 contentItemBuilder:(id)arg4;
