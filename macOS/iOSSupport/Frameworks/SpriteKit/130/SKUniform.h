...
- (void)setFloatMatrix4Value:(union _GLKMatrix4)arg1;
- (void)setFloatMatrix3Value:(union _GLKMatrix3)arg1;
- (void)setFloatMatrix2Value:(union _GLKMatrix2)arg1;
- (void)setFloatVector4Value:(union _GLKVector4)arg1;
- (void)setFloatVector3Value:(union _GLKVector3)arg1;
- (void)setFloatVector2Value:(union _GLKVector2)arg1;
- (union _GLKMatrix4)floatMatrix4Value;
- (union _GLKMatrix3)floatMatrix3Value;
- (union _GLKMatrix2)floatMatrix2Value;
- (union _GLKVector4)floatVector4Value;
- (union _GLKVector3)floatVector3Value;
- (union _GLKVector2)floatVector2Value;
