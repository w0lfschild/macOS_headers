...
#import <HomeUI/HUContentSizeOverriding-Protocol.h>
...
@interface HUCardViewController : UIViewController <HFItemManagerDelegate, UIGestureRecognizerDelegate, HUQuickControlViewControllerCoordinatorDelegate, UIScrollViewDelegate, HUContentSizeOverriding>
{
    BOOL _hideControls;
    BOOL _hideSettings;
