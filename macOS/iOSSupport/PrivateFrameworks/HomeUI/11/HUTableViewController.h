...
@protocol HUContentSizeOverriding;
...
@interface HUTableViewController : UITableViewController <HUResizableCellDelegate>
{
    ...
    id <HUContentSizeOverriding> _contentSizeOverrider;
}

@property(nonatomic) __weak id <HUContentSizeOverriding> contentSizeOverrider; // @synthesize contentSizeOverrider=_contentSizeOverrider;
