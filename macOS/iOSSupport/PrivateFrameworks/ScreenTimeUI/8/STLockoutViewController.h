...
@class NSDictionary, NSObject, NSString, STHourglassView, STLockoutPolicyController, UIAlertController, UIButton, UIImageView, UILabel, UIResponder, UIVisualEffectView;
