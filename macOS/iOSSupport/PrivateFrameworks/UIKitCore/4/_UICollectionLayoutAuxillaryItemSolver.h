...
- (struct CGSize)_computeContentSizeForEmptyHostContentSizeForContainer:(id)arg1 hostContentSize:(struct CGSize)arg2 layoutAxis:(unsigned long long)arg3 supplementaryFrames:(id)arg4 preferredSizes:(id)arg5 layoutRTL:(BOOL)arg6 supplementaryKind:(long long)arg7;
