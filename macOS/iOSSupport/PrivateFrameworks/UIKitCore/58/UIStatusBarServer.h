...
+ (CDStruct_005814a2 *)getStatusBarOverrideData;
+ (const CDStruct_facf4ffc *)getStatusBarData;
+ (void)permanentizeStatusBarOverrideData;
+ (void)postStatusBarOverrideData:(CDStruct_005814a2 *)arg1;
...
+ (void)postStatusBarData:(const CDStruct_facf4ffc *)arg1 withActions:(int)arg2;
...
- (void)_receivedStatusBarData:(CDStruct_facf4ffc *)arg1 actions:(int)arg2 animated:(BOOL)arg3;
