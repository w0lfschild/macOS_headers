...
+ (id)presentWithParameter:(id)arg1 state:(id)arg2 variableProvider:(id)arg3 variableUIDelegate:(id)arg4 processing:(BOOL)arg5 sourceView:(id)arg6 sourceRect:(struct CGRect)arg7 viewController:(id)arg8 selectionHandler:(CDUnknownBlockType)arg9 tintColor:(id)arg10;
