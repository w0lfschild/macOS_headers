...
+ (id)modelForEditingAction:(id)arg1 withWorkflowTypes:(id)arg2 hideConfiguration:(BOOL)arg3 customConfigurationClass:(Class)arg4 removeAction:(CKTypedComponentAction_aa963706)arg5 variableUIDelegate:(id)arg6 indentationProvider:(id)arg7;
